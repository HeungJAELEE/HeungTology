---
Basic:
  id: "grinding-process-and-abrasive-machining-physics"
...
Object:
  object_type: "Entity"
  tier: 1
  description: "An abrasive machining process that uses a grinding wheel as the cutting tool to remove material (Grinding) and the physical study of micro-cutting, plowing, and sliding at the abrasive grain interface (Abrasive Machining Physics)."
  physical_model: "N/A"
Semantic:
  tags: '["grinding", "abrasive-machining", "precision-manufacturing", "specific-energy", "tribology", "surface-finish", "chip-formation", "physics"]'
  is_part_of: []
  related_to: []
Dynamic:
  ...
  diagnostic_protocol:
    - 'Machining_Fidelity_Audit: Evaluate the ''Specific Energy'' ($e_s$) to identify if high-fidelity ''Wheel Loading'' (clogging) or ''Dulling'' is increasing the friction without effective cutting.'
    - 'Thermal_Integrity_Check: Analyze the high-fidelity ''Grinding Burn'' risk by monitoring the surface temperature profile, ensuring it stays below the phase transformation point.'
    - 'Surface_Fidelity_Scan: Monitor the high-fidelity ''Wheel Dressing'' interval to verify that the abrasive grains remain sharp, maintaining the target Ra/Rz surface roughness.'
Trust Metrics:
  T_static: 1.0
  T_dynamic: 1.0
  T_init: 1.0
