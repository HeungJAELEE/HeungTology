---
Basic:
  id: "cylinder-liner-and-tribological-honing-physics"
...
Object:
  object_type: "Entity"
  tier: 1
  description: "A thin-walled cylindrical part placed in an engine block to form the inner wall of a cylinder (Cylinder Liner) and the physical study of creating precise cross-hatch surface patterns to retain oil and minimize friction between the piston ring and the wall (Tribological Honing Physics)."
  physical_model: "N/A"
Semantic:
  tags: '["cylinder-liner", "honing", "tribology", "engine-mechanics", "surface-finish", "lubrication", "precision-machining"]'
  is_part_of: []
  related_to: []
Dynamic:
  ...
  diagnostic_protocol:
    - 'Tribological_Fidelity_Audit: Evaluate the ''Cross-hatch Angle'' and surface roughness ($R_k$) to identify if the oil retention capacity is sufficient to prevent ''Scuffing'' (metal-to-metal contact) at top dead center.'
    - 'Structural_Integrity_Check: Analyze the cylinder ''Roundness'' and ''Cylindricity'' under thermal load to ensure the piston ring seal is maintained, preventing blow-by and oil consumption.'
    - 'Manufacturing_Fidelity_Scan: Monitor the honing stone pressure and speed to verify that the ''Plateau'' finish (smooth tops, deep valleys) is achieved for rapid engine break-in.'
Trust Metrics:
  T_static: 1.0
  T_dynamic: 1.0
  T_init: 1.0
...
# 🏎️ Cylinder Liner and Tribological Honing Physics
...
**[인간적 해석]**: "전쟁터의 방패 두께"입니다. 이 막이 1마이크로미터($\mu m$)만 유지되어도 금속끼리 직접 닿지 않습니다. 우리는 이 수식을 통해 "고속 회전 중에도 기름막이 터지지 않도록" 라이너의 매끄러움 정도를 설계하는 **'윤활의 무결성 설계'**를 수행합니다.
...
| **Roundness** | ~ 10 | < 2 (Ultra-precise) | $\mu m$ | Geometry |
