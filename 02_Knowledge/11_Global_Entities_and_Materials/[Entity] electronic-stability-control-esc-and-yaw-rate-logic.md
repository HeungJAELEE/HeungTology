---
Basic:
  id: "electronic-stability-control-esc-and-yaw-rate-logic"
...
Object:
  object_type: "Entity"
  tier: 1
  description: "A computerized technology that improves a vehicle's stability by detecting and reducing loss of traction (Electronic Stability Control) and the control logic that uses individual wheel braking and engine torque reduction to correct understeer and oversteer (Yaw Rate Logic)."
  physical_model: "N/A"
Semantic:
  tags: '["esc", "esp", "stability-control", "yaw-rate", "safety-system", "active-braking", "vehicle-dynamics"]'
  is_part_of: []
  related_to: []
Dynamic:
  ...
  diagnostic_protocol:
    - 'Stability_Fidelity_Audit: Evaluate the ''Yaw Rate Error'' against the tire friction circle limits to identify if the vehicle is entering an ''Unrecoverable Spin'' (Oversteer) or ''Plow-out'' (Understeer) state.'
    - 'Actuation_Integrity_Check: Analyze the individual brake pressure modulations to ensure the hydraulic unit is responding within 50ms to the ''Differential Braking'' command.'
    - 'Sensor_Fidelity_Scan: Monitor the steering angle and lateral-G sensors to verify that the ''Driver Intention'' is accurately mapped to the vehicle''s actual high-fidelity trajectory.'
Trust Metrics:
  T_static: 1.0
  T_dynamic: 1.0
  T_init: 1.0
...
# 🛡️ Electronic Stability Control (ESC) and Yaw Rate Logic
