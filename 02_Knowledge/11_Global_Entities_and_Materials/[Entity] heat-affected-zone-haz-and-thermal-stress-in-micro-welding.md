---
Basic:
  id: "heat-affected-zone-haz-and-thermal-stress-in-micro-welding-entity"
...
Object:
  ...
  physical_model: "N/A"
Semantic:
  tags: '["#Entity", "#Welding", "#HAZ", "#Thermal_Stress", "#Micro_welding", "#Materials_Science", "#Metallurgy", "#Physics", "#Manufacturing", "#HDS_Gold_v6_1"]'
...
| :--- | :--- | :--- | :--- |
| **HAZ Width** | Width of the material affected by heat | $< 100 \text{ \mu m}$ | 상처 부위를 머리카락 굵기로 좁힘을 입증하는 물리 |
...
| **Distortion L.** | Warping or twisting of the part | $< 10 \text{ \mu m}$ | 열을 받아도 모양은 그대로임을 보여주는 정보 단계 |
