...
object:
  description: '[Entity] data-sovereignty-and-decentralized-intelligence-networks에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  centralized_uptime_sla_pct: 99.9
  data_value_model_formula: integral(Utility(d) * e^(sigma * Privacy(d)) dD)
  node_distribution_entropy_warning_threshold: 2.5
  owner_control_ratio_critical_threshold: 0.9
  sovereignty_compliance_pass_threshold: 100.0
  sovereignty_index_formula: C_access * C_proc * C_storage
semantic:
  alternative_parents: []
