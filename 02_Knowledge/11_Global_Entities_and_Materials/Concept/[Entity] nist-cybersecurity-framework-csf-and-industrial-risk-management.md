...
lineage:
  ...
  original_hash: 670d1c68a061b9b3ab60cf0ac9215e79be5b67b34621b03325bcf9e445535d65
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] nist-cybersecurity-framework-csf-and-industrial-risk-management에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  asset_visibility_threshold: 0.9
  critical_vulnerability_threshold: 0
  defense_in_depth_success_probability_formula: 1 - product(1 - p_i)
  framework_alignment_threshold: 0.8
  mttr_threshold_hours: 24
  risk_calculation_formula: threat * vulnerability * impact
semantic:
  alternative_parents: []
