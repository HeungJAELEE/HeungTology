...
object:
  description: '[Entity] product-design-and-design-for-manufacturing-dfm-optimization에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  assembly_efficiency_formula: eta_assembly = (N_min * t_ideal) / T_total
  critical_assembly_efficiency_threshold: 20.0
  excessive_fastener_variety_threshold: 10
  long_design_cycle_threshold_days: 90
  minimum_target_yield_rate_pct: 99.5
  optimized_assembly_time_pct_range: 40-60
  optimized_part_count_range: 30-50
  target_fastener_variety_range: 1-2
  total_manufacturing_cost_formula: C_total = C_material + C_process + C_assembly
semantic:
  alternative_parents: []
