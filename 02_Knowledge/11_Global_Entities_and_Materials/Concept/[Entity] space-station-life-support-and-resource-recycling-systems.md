...
object:
  description: '[Entity] space-station-life-support-and-resource-recycling-systems에
    관한 고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  audit_status_fidelity: Life-Safe-v2026-Fidelity
  co2_concentration_limit: <5000 ppm
  humidity_control_range: 40-60%
  oxygen_purity_target: 21-24%
  system_mtbf_threshold: '>50000 hours'
  water_recovery_rate: '>95-98%'
semantic:
  alternative_parents: []
