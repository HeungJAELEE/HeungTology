...
object:
  description: '[Entity] precision-mold-design-and-injection-molding-physics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  audit_fidelity_version: Plastic-Origin-v2026-Fidelity
  cooling_eff_threshold: '> 90%'
  cycle_time_threshold: < 15 sec
  dimen_accu_threshold: < 10 um
  injec_press_range: 50 - 150 MPa
  mold_life_threshold: '> 1,000,000'
  surface_finish_threshold: < 0.1 um
