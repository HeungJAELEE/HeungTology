...
object:
  ...
  tier: 1
properties:
  case_hardening_temperature_threshold_c: 180.0
  drying_rate_formula: R = - (Ws/A) * (dX/dt)
  exit_moisture_critical_threshold_pct: 12.0
  high_inlet_humidity_warning_threshold_pct: 85.0
  humidity_ratio_formula: omega = 0.622 * (Pv / (P - Pv))
  min_heat_recovery_efficiency_threshold_pct: 40.0
  spray_drying_version: V6.3.7
semantic:
  alternative_parents: []
