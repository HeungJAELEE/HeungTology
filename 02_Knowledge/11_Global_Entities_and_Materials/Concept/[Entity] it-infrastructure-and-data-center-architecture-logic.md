...
object:
  description: '[Entity] it-infrastructure-and-data-center-architecture-logic에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  availability_formula: 1 - (1 - A_main) * (1 - A_backup)
  pue_formula: Total Facility Power / IT Equipment Power
  pue_inefficiency_threshold: 1.8
  thermal_critical_threshold_celsius: 27.0
  tier_iv_annual_downtime_limit_min: 26
  tier_iv_availability_target_pct: 99.995
  tier_iv_pue_target_range: 1.1 - 1.2
  tier_iv_redundancy_spec: 2(N+1)
  ups_load_strain_threshold_pct: 85.0
semantic:
  alternative_parents: []
