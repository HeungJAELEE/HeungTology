...
lineage:
  ...
  original_hash: 054005a27cf800ca8c156b435437d9af54f3f58b8b1367e8b26ae8ca9067752c
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] industrial-robotics-and-multi-axis-kinematics-physics에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  degrees_of_freedom: 6-7
  max_payload_kg: 2300
  motor_torque_warning_threshold_pct: 95.0
  position_error_critical_threshold_mm: 0.5
  repeatability_mm: 0.01-0.05
  service_life_hours: 50000
  servo_lag_notice_threshold_ms: 10.0
  tcp_speed_m_s: 10.0
semantic:
  alternative_parents: []
