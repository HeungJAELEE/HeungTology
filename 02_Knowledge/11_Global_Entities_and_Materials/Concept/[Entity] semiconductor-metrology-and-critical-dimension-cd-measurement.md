...
lineage:
  ...
  original_hash: 8718e2789ca054998e7c0c37cf808ce13abe33b51dfdc50c35d009f9e5300f00
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] semiconductor-metrology-and-critical-dimension-cd-measurement에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  cd_precision_3sigma_target_nm: 0.1
  cd_precision_tolerance_nm: 0.02
  cpk_critical_threshold: 1.67
  external_data_endpoint: semiconductor-metrology-precision-and-p2p-log-v2026
  measurement_speed_target_sec_per_site: 0.5
  measurement_speed_tolerance_sec_per_site: 0.05
  overlay_accuracy_target_nm: 1.0
  overlay_accuracy_tolerance_nm: 0.1
  repeatability_precision_limit_nm: 0.05
  sampling_rate_min_sites_per_wafer: 50
  sem_beam_energy_ev_range: 300-1000
  sem_beam_energy_tolerance_ev: 10
  target_yield_threshold: 0.95
semantic:
  alternative_parents: []
