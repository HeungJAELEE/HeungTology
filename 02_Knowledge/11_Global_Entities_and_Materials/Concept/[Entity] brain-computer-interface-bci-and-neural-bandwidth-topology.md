...
object:
  description: '[Entity] brain-computer-interface-bci-and-neural-bandwidth-topology에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  biocompatibility_lifespan_min_years: 10
  channel_count_range: 1024-16384
  decoding_latency_max_ms: 20
  external_data_endpoint: Data bci-neural-bandwidth-and-decoding-latency-v2026
  neural_bandwidth_mbps: 10-100
  sampling_rate_khz: 20-40
  snr_critical_threshold_db: 10.0
  snr_warning_threshold_db: 15.0
  target_decoding_accuracy: 0.99
semantic:
  alternative_parents: []
