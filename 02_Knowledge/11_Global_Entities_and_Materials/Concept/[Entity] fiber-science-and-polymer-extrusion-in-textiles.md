...
object:
  description: '[Entity] fiber-science-and-polymer-extrusion-in-textiles에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  crystallinity_range: 30-60%
  denier_definition: mass(g) / 9000m
  draw_ratio_range: 3-6
  fiber_diameter_range: 10-50 um
  max_shrinkage: 5%
  min_crystallinity_threshold: 40%
  min_orientation_factor: '0.8'
  min_tenacity_threshold: 5 g/den
  orientation_factor_formula: f = (3 * cos^2(theta) - 1) / 2
  power_law_fluid_model: tau = K * gamma_dot^n
  tenacity_range: 3-10 g/den
semantic:
  alternative_parents: []
