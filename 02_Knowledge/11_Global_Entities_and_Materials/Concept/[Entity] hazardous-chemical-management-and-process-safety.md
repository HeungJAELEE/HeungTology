...
object:
  description: '[Entity] hazardous-chemical-management-and-process-safety에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  ...
  flammable_le_limit_percent: 10
  secondary_containment_ratio_threshold: 1.1
  toxic_detection_precision_ppm: 1
semantic:
  alternative_parents: []
