...
object:
  description: '[Entity] global-mineral-reserve-tracking-and-autonomous-mining-ops에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  autonomous_digging_precision_max: 0.1
  autonomous_efficiency_min: 95
  autonomous_latency_max: 20
  max_ore_grade_deviation_threshold: 0.15
  min_autonomous_fleet_nodes: 100
  min_fleet_availability_threshold: 90.0
  min_tailings_dam_stability_threshold: 0.95
  strategic_depletion_threshold_years: 3
semantic:
  alternative_parents: []
