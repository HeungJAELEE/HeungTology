...
lineage:
  ...
  original_hash: fec074b8c0c9b78f70f156d73f30965768428752343155f453b0b7180c3e99e4
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] plastic-flow-analysis-and-mold-flow-simulation-theory에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  audit_status_id: Digital-Flow-v2026-Fidelity
  clamping_force_min: '> 200 tons'
  end_fill_pressure_max: < 100 MPa
  fill_time_range: 1.0-5.0 sec
  governing_equation: Navier-Stokes
  simul_accuracy_threshold: '> 95%'
  thermal_imbalance_threshold: 5 deg C
  volume_shrinkage_range: 2-8%
semantic:
  alternative_parents: []
