...
lineage:
  ...
  original_hash: ef787cdb97d4bbe204daa177b170eeb748c4c1a712c1fbaed7b583f1becf9c4f
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] blockchain-for-industrial-supply-chain-traceability에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  compliance_audit_pass_pct: 100
  data_integrity_uptime_pct: 99.999
  external_data_log_reference: Data supply-chain-traceability-precision-and-audit-log-v2026
  forgery_prevention_probability: 0.999
  iot_api_success_pct_min: 99.9
  max_data_latency_sec: 3600
  traceability_depth_tiers_min: 5
  traceability_precision_step: 0.1
  verification_query_time_sec_max: 1
semantic:
  alternative_parents: []
