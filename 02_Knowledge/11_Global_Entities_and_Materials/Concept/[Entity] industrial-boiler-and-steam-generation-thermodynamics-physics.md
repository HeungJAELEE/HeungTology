...
lineage:
  ...
  original_hash: 7be0fd4082422e6dcd3a996980cf55eeb3e0c37eead634426cd2170c53b8a2a0
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] industrial-boiler-and-steam-generation-thermodynamics-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  boiler_version: V6.3.7
  industrial_boiler_efficiency_range_pct: 92-96
  industrial_boiler_pressure_range_bar: 50-250
  industrial_boiler_temp_range_celsius: 300-600
  oxygen_trim_threshold_pct: 5.0
  safety_control_standard: sil-3
  water_quality_standard: ultrapure_deionized
semantic:
  alternative_parents: []
