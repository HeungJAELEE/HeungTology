...
object:
  description: '[Entity] flood-control-and-stormwater-management-governance에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  design_storm_return_periods_yr:
  - 10
  - 50
  - 100
  impervious_ratio_threshold_pct: 80.0
  low_water_level_threshold_m: 0.5
  rainfall_intensity_threshold_mm_hr: 50.0
semantic:
  alternative_parents: []
