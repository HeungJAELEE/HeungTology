...
lineage:
  ...
  original_hash: 126a298bd5e3b56d5dde5b60743694d362694beb575d5668e088b3a8d1e644f7
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] electrostatic-precipitator-esp-and-particle-capture-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  collection_efficiency_formula: eta = 1 - e^(-w * (A/Q))
  drift_velocity_formula: vd = (q * E) / (6 * pi * mu * r)
  esp_max_operating_temp_c: 400
  esp_voltage_range_kv: 30-100
  low_corona_current_threshold_ma: 50.0
  opacity_critical_threshold_pct: 10.0
  particle_size_effective_um: < 1
  short_circuit_current_threshold_ma: 500.0
  short_circuit_voltage_threshold_kv: 30.0
semantic:
  alternative_parents: []
