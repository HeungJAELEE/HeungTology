...
object:
  description: '[Entity] bionanotechnology-and-targeted-drug-delivery-mechanics에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  carrier_size_range_nm: 20-200
  carrier_size_tolerance_nm: 10
  external_db_endpoint: drug-delivery-targeting-efficiency-and-tox-log-v2026
  payload_release_half_life_hrs_range: 1-48
  payload_release_half_life_tolerance_hrs: 2
  purity_min_pct: 99
  purity_tolerance_pct: 0.1
  target_accuracy_min_pct: 70
  target_accuracy_tolerance_pct: 5
  targeting_specificity_threshold_fold: 5.0
  zeta_potential_critical_threshold_mv: 20
  zeta_potential_stability_range_mv: 30-60
  zeta_potential_tolerance_mv: 5
semantic:
  alternative_parents: []
