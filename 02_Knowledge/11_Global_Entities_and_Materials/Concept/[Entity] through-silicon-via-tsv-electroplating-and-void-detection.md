...
object:
  description: '[Entity] through-silicon-via-tsv-electroplating-and-void-detection에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  high_ar_aspect_ratio: '10:1'
  high_ar_via_diameter_um: 5
  min_void_detection_resolution_um: 1
  power_aspect_ratio: '3:1'
  power_via_diameter_um: 30
  standard_aspect_ratio: '5:1'
  standard_fill_ratio_threshold: 0.9999
  standard_via_diameter_um: 10
  through_glass_aspect_ratio: '8:1'
  ultra_fine_aspect_ratio: '15:1'
  ultra_fine_via_diameter_um: 2
  void_volume_fraction_critical_threshold: 0.1
semantic:
  alternative_parents: []
