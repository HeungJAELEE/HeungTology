...
lineage:
  ...
  original_hash: 54e49b34906464a56f75bf99c7e9c5ce3d6c43f7cc22a933f116a3a4683b4560
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] industrial-robotic-arms-precision-kinematics-and-payload-dynamics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  backlash_simulation_threshold: 0.1 deg
  max_joint_torque: 100 Nm
  repeatability_threshold: 0.01 mm
  robot_sensor_fusion_log_endpoint: robot-sensor-fusion-log-v2026
  settling_time_threshold: 50 ms
  target_spec_version: V6.3.7
semantic:
  alternative_parents: []
