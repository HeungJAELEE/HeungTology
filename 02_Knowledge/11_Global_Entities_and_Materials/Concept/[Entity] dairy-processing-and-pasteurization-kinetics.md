...
lineage:
  ...
  original_hash: ea70d09a611441de7f325cd750c5c7ef6aafad1cb32f03c120a747827aecf7aa
metadata:
  date: '2026-05-16'
...
object:
  ...
  tier: 1
properties:
  d_value_formula: D = 2.303 / k
  htst_duration_sec_max: 20
  htst_duration_sec_min: 15
  htst_temp_c_max: 75
  htst_temp_c_min: 72
  ltlt_duration_min: 30
  ltlt_temp_c: 63
  max_fat_globule_size_um: 2.0
  microbial_decay_formula: N(t) = N0 * exp(-kt)
  min_holding_time_sec: 15.0
  pmo_safety_temp_limit_c: 71.7
semantic:
  alternative_parents: []
