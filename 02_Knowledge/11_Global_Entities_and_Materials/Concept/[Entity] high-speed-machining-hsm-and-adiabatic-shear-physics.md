...
object:
  description: '[Entity] high-speed-machining-hsm-and-adiabatic-shear-physics에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  chatter_vibration_threshold_um: 20.0
  hsm_cutting_speed_max_m_min: 5000
  hsm_cutting_speed_min_m_min: 500
  hsm_heat_distribution_chip_percent: 90
  hsm_spindle_speed_max_rpm: 60000
  hsm_spindle_speed_min_rpm: 15000
  hsm_surface_finish_ra_max_um: 0.8
  hsm_surface_finish_ra_min_um: 0.1
  sub_optimal_rpm_threshold: 20000
semantic:
  alternative_parents: []
