...
object:
  description: '[Entity] last-mile-delivery-swarms-and-urban-air-mobility-uam에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  airway_congestion_threshold: 0.8
  drone_swarm_cruise_speed_kmh: 50-100
  drone_swarm_noise_level_db: 50-60
  drone_swarm_payload_kg: 1-5
  drone_swarm_range_km: 5-20
  fleet_uptime_threshold_pct: 95.0
  uam_cruise_speed_kmh: 150-300
  uam_noise_level_db: 60-70
  uam_payload_kg: 200-500
  uam_range_km: 50-200
semantic:
  alternative_parents: []
