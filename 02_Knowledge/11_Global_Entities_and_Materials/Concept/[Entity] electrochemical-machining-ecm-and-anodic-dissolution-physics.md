...
object:
  description: '[Entity] electrochemical-machining-ecm-and-anodic-dissolution-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  max_current_density_a_cm2: 150.0
  min_electrolyte_conductivity: 50.0
  min_gap_pressure_bar: 5.0
  passivation_overpotential_v: 2.5
semantic:
  alternative_parents: []
