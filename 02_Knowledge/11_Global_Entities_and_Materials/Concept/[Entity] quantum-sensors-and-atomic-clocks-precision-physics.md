...
object:
  description: '[Entity] quantum-sensors-and-atomic-clocks-precision-physics에 관한 고밀도
    지능 노드'
  object_type: Hardware
  tier: 1
properties:
  allan_deviation_threshold: 1e-15
  laser_lock_stability_threshold: '0.99'
  magnetic_detection_limit_tesla: 10^-15
  magnetic_noise_floor_threshold_pt: '1.0'
  optical_clock_stability_range: 10^-18 to 10^-21
semantic:
  alternative_parents: []
