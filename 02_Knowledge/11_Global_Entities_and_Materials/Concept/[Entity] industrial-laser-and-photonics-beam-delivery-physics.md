...
lineage:
  ...
  original_hash: c646a8d8bc95d44f11e653f5efdb85f670f61091f7cbf3992887f8909666a582
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] industrial-laser-and-photonics-beam-delivery-physics에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  back_reflection_threshold_w: 50.0
  beam_waist_w0: w0
  focus_drift_threshold_mm: 0.5
  m2_degradation_threshold: 1.5
  power_density_w_cm2: 10^6 to 10^12
  power_loss_threshold_ratio: 0.95
  precision_mm: 0.001
  rayleigh_range_zr: zr
  scanning_speed_m_s: 10.0
  wavelength_green_nm: 532
  wavelength_ir_nm: 1064
  wavelength_uv_nm: 355
semantic:
  alternative_parents: []
