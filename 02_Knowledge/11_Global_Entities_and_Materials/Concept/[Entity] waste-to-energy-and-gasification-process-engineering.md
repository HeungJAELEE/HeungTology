...
lineage:
  ...
  original_hash: fcd6bb07a12f00581f1eaa46250ecb99f7646faa4e4bd1d73c0de7c05bd3bb1c
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] waste-to-energy-and-gasification-process-engineering에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  cold_gas_efficiency_formula: (LHV_syngas * V_syngas) / (LHV_feedstock * M_feedstock)
  critical_reactor_temp_threshold_celsius: 1000.0
  gasification_efficiency_range_pct: 30-40
  gasification_temp_range_celsius: 1000-1400
  h2_content_notice_threshold_pct: 20.0
  mass_burn_temp_range_celsius: 850-1000
  steam_reforming_stoichiometry: CnHm + nH2O -> nCO + (n + m/2)H2
  tar_concentration_warning_threshold_mg_nm3: 100.0
semantic:
  alternative_parents: []
