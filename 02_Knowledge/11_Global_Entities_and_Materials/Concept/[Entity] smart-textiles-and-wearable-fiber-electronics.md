...
object:
  description: '[Entity] smart-textiles-and-wearable-fiber-electronics에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  conductivity_min_s_per_m: 10000
  durability_resistance_increase_limit_percent: 10
  flexibility_max_mg_cm: 50
  linear_resistance_max_ohm_per_m: 10
  snr_min_db: 30
  wash_cycles_min: 50
semantic:
  alternative_parents: []
