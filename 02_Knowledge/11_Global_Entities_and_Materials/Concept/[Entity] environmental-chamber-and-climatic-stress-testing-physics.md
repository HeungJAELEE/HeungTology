...
lineage:
  ...
  original_hash: fd367c76673fd298ac670607276f54d6396a702bc2b47acb83aa5324eafe67bd
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] environmental-chamber-and-climatic-stress-testing-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  acceleration_factor_formula: exp(Ea/k * (1/T_use - 1/T_test))
  deep_freeze_threshold_c: -50.0
  humidity_drift_threshold: 5.0
  humidity_range_max_pct: 98
  humidity_range_min_pct: 10
  ramp_rate_max_k_min: 30
  ramp_rate_min_k_min: 15
  stability_precision_k: 0.1
  temp_range_max_c: 180
  temp_range_min_c: -70
  thermal_non_uniformity_threshold: 3.0
  thermal_ramp_rate_formula: Q = m * Cp * dT/dt
semantic:
  alternative_parents: []
