...
object:
  description: '[Entity] magnetohydrodynamics-mhd-and-plasma-flow-physics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  active_force: Lorentz Force (J x B)
  applicable_fluids: Liquid Metal / Plasma
  confinement_method: Magnetic Confinement
  confinement_target_pressure: target_confinement
  density_limit: greenwald_limit
  energy_conversion_mode: Direct Electrical (MHD Gen)
  flow_stability_parameter: Hartmann Number (Ha)
  instability_threshold: safe_threshold
semantic:
  alternative_parents: []
