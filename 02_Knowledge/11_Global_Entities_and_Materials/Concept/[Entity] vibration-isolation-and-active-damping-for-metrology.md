...
lineage:
  ...
  original_hash: ad17b8b3a81819a89efcd836f8cac08819410ec49053add730217c49019ba735
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] vibration-isolation-and-active-damping-for-metrology에 관한
    고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  active_isolation_start_hz: 0.5-1.0
  active_isolation_version: V6.3.7
  active_response_time_ms: 1-5
  passive_isolation_start_hz: 5-10
  threshold_isolation_efficiency_pct: 90.0
  threshold_settling_time_ms: 100
  threshold_vibration_velocity_rms_ums: 0.1
  vibration_velocity_unit: um/s
semantic:
  alternative_parents: []
