...
object:
  description: '[Entity] composite-materials-and-advanced-manufacturing에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  curing_degree_threshold: '> 98%'
  darcy_law: v = -(K/mu) * gradP
  fiber_volume_fraction_threshold: '> 60%'
  ilss_shear_threshold: '> 80 MPa'
  rule_of_mixtures: Ec = Ef * Vf + Em * Vm
  void_content_threshold: < 1%
semantic:
  alternative_parents: []
