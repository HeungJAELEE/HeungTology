...
lineage:
  ...
  original_hash: e31188706ec58528369ec9eb0b7a2d7cb9da042a2fee8cffe1ff77b2361181e9
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] electroplating-process-and-electrodeposition-kinetics에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  current_density_critical_threshold_asd: 15.0
  min_brightness_threshold: 0.7
  min_cathode_efficiency_pct: 85.0
  optimal_bath_temperature_c: 55.0
  target_thickness_mm: 0.01
  temperature_drift_tolerance_c: 5.0
semantic:
  alternative_parents: []
