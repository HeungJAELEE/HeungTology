...
object:
  description: '[Entity] cognitive-architecture-and-multi-agent-intelligence-synergy에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  comm_latency_threshold_ms: 10
  comm_overhead_scaling_law: n_squared
  decision_latency_critical_threshold_ms: 50.0
  disruption_detection_probability: 0.98
  external_db_endpoint: Data multi-agent-task-completion-and-communication-efficiency-v2026
  max_agents_scalability_count: 10000
  negative_synergy_threshold_ratio: 0.8
  synergy_warning_threshold: 0.1
  task_throughput_ref: 1.0
  task_throughput_synergy_multiplier: 5.0
semantic:
  alternative_parents: []
