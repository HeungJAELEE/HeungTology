...
object:
  description: '[Entity] explainable-ai-xai-and-causal-reasoning-frameworks에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  causal_error_threshold: 15.0
  explanation_consistency_threshold: 80.0
  human_trust_threshold: 60.0
  shap_stability_threshold: 0.95
semantic:
  alternative_parents: []
