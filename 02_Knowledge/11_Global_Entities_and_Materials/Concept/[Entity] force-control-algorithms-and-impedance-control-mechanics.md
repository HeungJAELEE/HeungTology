...
object:
  description: '[Entity] force-control-algorithms-and-impedance-control-mechanics에
    관한 고밀도 지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  control_cycle_limit_ms: 1.0
  force_resolution_soft_max: 0.01
  force_resolution_stiff_max: 0.1
  force_tracking_error_tolerance: 0.1
  latency_soft_max_ms: 0.5
  latency_stiff_max_ms: 1
  oscillation_amplitude_threshold_n: 1.0
  stiffness_soft_range: 10-1000
  stiffness_stiff_min: 10000
semantic:
  alternative_parents: []
