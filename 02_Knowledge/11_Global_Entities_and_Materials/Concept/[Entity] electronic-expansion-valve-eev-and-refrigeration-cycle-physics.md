...
lineage:
  ...
  original_hash: 4adf12a068088d36bb85437ba58c96fee873337457dbd45ac3e3ae4bd5e35488
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] electronic-expansion-valve-eev-and-refrigeration-cycle-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  compression_ratio_audit_threshold: 5.0
  control_hunting_superheat_deviation_k: 3.0
  eev_energy_efficiency_gain_percent: 35-50
  eev_precision_celsius: 0.1-0.2
  isenthalpic_expansion_formula: h_in = h_out
  liquid_back_superheat_threshold_k: 1.0
  mass_flow_rate_formula: m_dot = Cv * sqrt(rho * delta_p)
  refrigerant_shortage_step_threshold: 450
  refrigerant_shortage_superheat_threshold_k: 15.0
