...
object:
  description: korea-tax-law-reference ontology pack에 기초한 대한민국 세법(소득세, 법인세) 및 누진 과세
    수리 모델 노드
  object_type: Algorithm
  tier: 1
properties:
  corporate_tax_brackets_krw:
  - 200000000
  - 20000000000
  - 300000000000
  external_db_endpoint: Global-Dataset-Inventory-Hub
  individual_tax_brackets_krw:
  - 14000000
  - 50000000
  - 88000000
  - 150000000
  ...
  - 500000000
  - 1000000000
  max_corporate_marginal_rate: 0.24
  max_individual_marginal_rate: 0.45
  ontology_pack_id: korea-tax-law-reference
  tax_year: 2026
semantic:
  alternative_parents: []
