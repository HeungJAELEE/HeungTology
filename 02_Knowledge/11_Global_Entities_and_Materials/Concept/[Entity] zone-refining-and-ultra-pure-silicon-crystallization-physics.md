...
lineage:
  ...
  original_hash: 49f06d074677567f6f4df135b3ad8bb808d4a5fc75ab9fa1bdb617588a5cddfb
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] zone-refining-and-ultra-pure-silicon-crystallization-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  ideal_pull_rate_mm_hr: 1.0
  impurity_threshold_ppb: 0.1
  max_oxygen_content_ppma: 10-20
  melt_temp_stability_threshold_c: 0.5
  pull_rate_tolerance_mm_hr: 0.2
  standard_ingot_diameter_mm: 200-300
  target_dislocation_density_cm2: '0'
  target_purity: 99.999999999%
semantic:
  alternative_parents: []
