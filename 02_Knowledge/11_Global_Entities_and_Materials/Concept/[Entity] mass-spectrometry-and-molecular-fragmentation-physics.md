...
lineage:
  ...
  original_hash: 1e10617ac4c4f1098f38264b8453dad018b8d55ce775539c527f98e39c0edef9
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] mass-spectrometry-and-molecular-fragmentation-physics에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  identification_unit: Da
  lorentz_force_formula: q(E + v x B)
  low_sensitivity_threshold_ion_counts: 100
  m_z_ratio_formula: 2V / v^2
  over_fragmentation_threshold_ev: 100.0
  sensitivity_range: ppt to ppq
  vacuum_degradation_threshold_torr: 1e-5
  vacuum_requirement_torr: 1e-7
semantic:
  alternative_parents: []
