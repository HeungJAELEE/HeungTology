...
lineage:
  ...
  original_hash: b963f50e2797b7ad9c1000fcb45fd8e66a72d483723abb5792129d850de8fb13
metadata:
  date: '2026-05-16'
...
object:
  ...
  tier: 1
properties:
  column_separation_cycles_range: 20-100+
  max_purity_potential_pct: 99.99
  min_reflux_ratio_threshold: 0.5
  operating_line_formula: y = (R/(R+1))x + (1/(R+1))xD
  purity_critical_threshold_pct: 98.0
  reboiler_fouling_threshold_coeff: 500
  reflux_ratio_formula: R = L/D
  reflux_ratio_typical_range: 0.5-10.0
  target_purity_pct: 99.9
  tray_pressure_drop_warning_mbar: 10.0
semantic:
  alternative_parents: []
