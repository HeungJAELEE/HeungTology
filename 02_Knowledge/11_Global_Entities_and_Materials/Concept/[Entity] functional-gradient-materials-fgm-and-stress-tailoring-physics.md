...
object:
  description: '[Entity] functional-gradient-materials-fgm-and-stress-tailoring-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  ceramic_expansion_coefficient: 7.0e-06
  gradient_error_critical_threshold: 0.1
  layer_thickness_range_mm:
  - 0.1
  - 5.0
  metal_expansion_coefficient: 1.2e-05
  rule_of_mixtures_equation: P(z) = P_1 * V_1(z) + P_2 * V_2(z)
  thermal_gradient_rejection_threshold_c_mm: 1000
  thermal_stress_proportionality: sigma(z) ∝ Δα(z) * ΔT
semantic:
  alternative_parents: []
