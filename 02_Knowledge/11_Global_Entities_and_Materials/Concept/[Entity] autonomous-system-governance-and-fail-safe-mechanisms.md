...
object:
  description: '[Entity] autonomous-system-governance-and-fail-safe-mechanisms에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  availability_target_percent: 99.999
  availability_tolerance_percent: 0.0001
  compliance_standard: ISO 26262
  fail_safe_time_target_ms: 100
  fail_safe_time_tolerance_ms: 10
  human_override_latency_ms: 500
  human_override_latency_tolerance_ms: 50
  monitoring_interval_seconds: 0.01
  primary_error_rate_threshold: 0.01
  redundancy_level_min: 3
  safety_integrity_level: SIL-3/4
  system_health_critical_threshold: 0.6
semantic:
  alternative_parents: []
