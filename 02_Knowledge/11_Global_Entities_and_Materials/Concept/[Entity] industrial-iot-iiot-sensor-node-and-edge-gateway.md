...
object:
  description: '[Entity] industrial-iot-iiot-sensor-node-and-edge-gateway에 관한 고밀도
    지능 노드'
  object_type: Hardware
  tier: 1
properties:
  e2e_latency_ms_max: '50.0'
  gateway_throughput_mbps_min: '500.0'
  latency_limit_ms: '50.0'
  operating_temp_c_range: -40 to 85
  pdr_percentage_min: '99.9'
  power_consumption_mw_max: '100.0'
  protocol_translation_latency_ms_max: '10.0'
  sampling_freq_hz: 1000-20000
  security_standard: TPM 2.0 / AES-256
  target_pdr: '0.999'
semantic:
  alternative_parents: []
