...
lineage:
  ...
  original_hash: 5f90581a38443110ef9cb8c657c2ae071e6d53dcac84edcc33155548b932eb09
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] process-automation-and-scada-system-architecture에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  control_hierarchy_standard: ISA-95
  legacy_relay_response_time_min_ms: 1000
  logic_execution_cycle_warning_threshold_ms: 50.0
  modern_scada_response_time_max_ms: 10
  network_jitter_notice_threshold_ms: 10.0
  packet_loss_critical_threshold: 0.5
  scada_version: 6.3.7
semantic:
  alternative_parents: []
