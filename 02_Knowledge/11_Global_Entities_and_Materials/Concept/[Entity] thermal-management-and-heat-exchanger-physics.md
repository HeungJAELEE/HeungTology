...
lineage:
  ...
  original_hash: e2645156510547ac42220d03c13fab72491f7ea37055e2bc3ba5413e90c55d4e
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] thermal-management-and-heat-exchanger-physics에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  air_cooling_max_heat_flux: 0.1
  coolant_pressure_drop_threshold: 2.0
  critical_temperature_threshold: 85.0
  heat_transfer_efficiency_threshold: 0.7
  liquid_cooling_max_heat_flux: 1000
  liquid_cooling_min_heat_flux: 10
  tim_thermal_resistance_threshold: 0.5
semantic:
  alternative_parents: []
