...
object:
  description: '[Entity] crystallization-kinetics-and-crystal-growth-mechanics에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  avrami_exponent_n: n
  avrami_rate_constant_k: k
  crystallization_control_version: V6.3.7
  gibbs_free_energy_driving_force_delta_g_v: delta_g_v
  max_cooling_rate_c_hr: 10.0
  min_crystal_size_mm: 0.1
  min_polymorph_purity_pct: 95.0
  supersaturation_limit: 2.5
  surface_tension_gamma: gamma
semantic:
  alternative_parents: []
