...
lineage:
  ...
  original_hash: 311ed49b2087864d681740a17d0d0452af20cf54689328d4944ec953f3d95919
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] industrial-robot-kinematics-and-trajectory-planning에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  cycle_time_precision_s: < 0.4
  cycle_time_standard_s: 0.8 ~ 1.2
  dof_precision: 7
  dof_standard: 6
  max_joint_torque_threshold_pct: 95.0
  path_deviation_limit_mm: 0.1
  path_speed_precision_ms: '> 5.0'
  path_speed_standard_ms: 1.0 ~ 2.0
  payload_precision_kg_range: 2 ~ 2,000+
  payload_standard_kg_range: 10 ~ 100
  quintic_polynomial_order: 5
  repeatability_precision_mm: 0.01
  repeatability_standard_mm: 0.05
  singularity_proximity_threshold: 0.9
semantic:
  alternative_parents: []
