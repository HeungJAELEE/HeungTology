...
object:
  description: '[Entity] magnetic-resonance-imaging-mri-and-spin-precession-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  bloch_equation_formula: dM/dt = M x gamma B - Relaxation Terms
  field_homogeneity_critical_threshold_ppm: 10.0
  gradient_linearity_error_threshold: 0.05
  helium_level_critical_threshold_pct: 50.0
  larmor_frequency_formula: omega_0 = gamma * B_0
  mri_field_strength_range_tesla: 1.5 - 7.0+
  mri_resolution_unit: mm
