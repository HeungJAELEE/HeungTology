...
object:
  description: '[Entity] it-governance-and-enterprise-risk-management-erm-logic에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  compliance_gap_threshold: 5.0
  global_regulations: GDPR, SOX
  governance_frameworks: COBIT, COSO, ISO 31000
  investment_value_formula: Benefits - (Costs + Risks)
  residual_risk_formula: Inherent_Risk - Control_Effectiveness
  strategic_alignment_threshold: 70.0
semantic:
  alternative_parents: []
