...
lineage:
  ...
  original_hash: af27becc06a7cfc3163e552a877ae11517471a51cf1ade4cac762bc0227a59e5
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] advanced-materials-and-nanotechnology-systems에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  energy_band_gap_precision_ev: 0.01
  grain_size_max_nm: 100
  hall_petch_formula: sigma_y = sigma_0 + k_y * d^(-1/2)
  mfg_yield_min_percent: 90
  schrodinger_equation: H psi = E psi
  surface_to_volume_ratio_formula: 3/r
  thermal_conductivity_min_wmk: 2000
  yield_strength_min_mpa: 2000
semantic:
  alternative_parents: []
