...
lineage:
  ...
  original_hash: 8f7b791bba251c80c27d90c507d4c71d8ced8bb34beddd8095ab7569c85817c8
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] cyber-physical-system-cps-industrial-digital-twin에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  data_throughput_range: 10 GB/hr - 10 TB/hr
  edge_fft_processing_interval: 1 ms
  l1_fidelity_threshold: 60%
  l1_sync_interval: 1-10 s
  l2_fidelity_threshold: 75%
  l2_sync_interval: 100 ms
  l3_fidelity_threshold: 85%
  l3_sync_interval: 10 ms
  l4_fidelity_threshold: 95%
  l4_sync_interval: 1 ms
  l5_fidelity_threshold: 99%
  l5_sync_interval: < 1 ms
  max_network_packet_loss_rate: < 0.01%
  min_simulation_speedup_factor: 10x
  multi_physics_computational_overhead_factor: 1000x
  recommended_sync_latency: < 50 ms
  stability_latency_threshold_ratio: '0.1'
  target_model_fidelity_rmse: < 5%
semantic:
  alternative_parents: []
