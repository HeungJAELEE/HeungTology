...
lineage:
  ...
  original_hash: e40090263c51f5f3148707fe1d248b5ded9ced13dae0268b97439a18b967bbb0
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] mobile-robotics-slam-simultaneous-localization-and-mapping-physics에
    관한 고밀도 지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  graph_slam_accuracy_m: 0.02
  lidar_slam_accuracy_m: 0.05
  localization_drift_threshold_m: 1.0
  map_loop_closure_error_threshold_m: 0.5
  min_feature_density_threshold: 50
  sensor_update_rate_threshold_hz: 10
  visual_slam_accuracy_m: 0.1-0.5
semantic:
  alternative_parents: []
