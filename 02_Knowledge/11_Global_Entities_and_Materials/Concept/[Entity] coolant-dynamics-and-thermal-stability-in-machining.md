...
lineage:
  ...
  original_hash: 0867fee685dacce3529f02805c3c1a98af2295806ed042dc29e328e24c093e8e
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] coolant-dynamics-and-thermal-stability-in-machining에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  data_endpoint_id: coolant-flow-rate-and-tool-temperature-v2026
  filter_rating_flood_um: 50-100
  filter_rating_high_um: < 10
  flow_rate_flood_range_l_min: 10-50
  flow_rate_high_range_l_min: 20-100
  max_temp_threshold_c: 25.0
  min_oil_concentration_pct: 5.0
  min_ph_threshold: 8.5
  oil_concentration_flood_pct: 5-10
  oil_concentration_high_pct: 5-12
  pressure_flood_range_mpa: 0.1-0.5
  pressure_high_range_mpa: 7.0-10.0
  target_dimension_error_um: 5
  temp_control_high_c: 20 ± 0.5
semantic:
  alternative_parents: []
