...
lineage:
  ...
  original_hash: fa0ab47d210aa61f6c82a4e473b75a64af5f0989789a4f2d424a9143654bf5d8
metadata:
  date: '2026-05-16'
  domain: 11_Global_Entities_and_Materials
  id: '[[[Entity] senolytic-therapy-and-cellular-senescence-mechanics]]'
  last_updated: '2026-05-17T22:59:20+09:00'
  project: Vault_Modernization
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: '[Entity] senolytic-therapy-and-cellular-senescence-mechanics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  apoptosis_accuracy_threshold: '> 99%'
  audit_status: CERTIFIED
  audit_version: Senolytic-v2026-Fidelity
  key_survival_protein: BCL-2
  off_target_toxicity_threshold: < 1.0%
  sasp_reduction_rate_threshold: '> 70%'
  senolytics_efficiency_threshold: '> 85%'
  systemic_inflammation_marker: C-reactive protein (CRP)
semantic:
  alternative_parents: []
