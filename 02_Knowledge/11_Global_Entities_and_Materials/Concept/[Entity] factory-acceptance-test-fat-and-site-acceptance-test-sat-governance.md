...
lineage:
  ...
  original_hash: bc7eeb865c9e1c05b3712ccf694e7a2eaa0d634c72bd0d1d52c179fd7b9e5ae7
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] factory-acceptance-test-fat-and-site-acceptance-test-sat-governance에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  compliance_ratio_formula: T_passed / T_total
  fat_compliance_threshold: 95.0
  max_commissioning_days: 30
  max_open_punch_items: 10
  residual_risk_index_formula: sum(severity * likelihood)
  sat_version: V6.3.7
semantic:
  alternative_parents: []
