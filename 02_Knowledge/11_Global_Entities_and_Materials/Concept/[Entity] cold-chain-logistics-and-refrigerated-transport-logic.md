...
object:
  description: '[Entity] cold-chain-logistics-and-refrigerated-transport-logic에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  ...
  - GDP
  - HACCP
  critical_deviation_threshold_c: 5.0
  critical_duration_threshold_min: 30
  delta_t: temperature_difference
  k_decay_constant: thermal_decay_rate
  stability_deviation_threshold_c: 1.0
  temp_range_max_c: 8
  temp_range_min_c: -80
  u_coefficient: insulation_coefficient
  warning_deviation_threshold_c: 2.0
semantic:
  alternative_parents: []
