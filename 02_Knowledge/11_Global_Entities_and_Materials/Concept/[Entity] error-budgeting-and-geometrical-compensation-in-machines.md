...
lineage:
  ...
  original_hash: 56847b5181220dfa8964fa9124e1052a73311b523f1a784e77bb8b7c6b1cd577
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] error-budgeting-and-geometrical-compensation-in-machines에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  abbe_principle_formula: delta_x = epsilon * l
  error_summation_method: root_sum_squared
  rss_formula: delta_total = sqrt(delta_geometric^2 + delta_thermal^2 + delta_dynamic^2)
  standard_reference_temperature_c: 20.0
  thermal_stability_threshold_c: 2.0
  ultra_precision_positioning_accuracy_um: 1.0
  ultra_precision_repeatability_um: 0.2
  ultra_precision_scale_resolution_nm: 10.0
  ultra_precision_spindle_runout_um: 0.1
  ultra_precision_thermal_drift_um_per_c: 1.0
semantic:
  alternative_parents: []
