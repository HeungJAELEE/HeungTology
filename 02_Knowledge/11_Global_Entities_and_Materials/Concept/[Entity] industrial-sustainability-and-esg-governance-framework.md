...
lineage:
  ...
  original_hash: 392f08b023e9c92f8f39e5e6a85522a19a93a6c4adade8e7aee627e743cd5c42
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] industrial-sustainability-and-esg-governance-framework에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  board_oversight_min_frequency_per_year: 12
  carbon_intensity_threshold: < 0.1 tCO2e/$1K
  carbon_limit_tons: 100000.0
  disclosure_rate_min_pct: 98.0
  energy_efficiency_index_min: 1.2
  esg_linked_finance_ratio_min_pct: 30.0
  esg_rating_target_msci: AAA ~ AA
  ethical_source_score_min: 90.0
  recycling_rate_min_pct: 80.0
  target_ethical_score: 90.0
semantic:
  alternative_parents: []
