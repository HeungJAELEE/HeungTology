...
object:
  description: '[Entity] transportation-planning-and-traffic-engineering에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  congestion_index_max_threshold: 1.5
  k_j: jam_density
  l: total_lost_time
  los_target_grade: C
  optimal_density_ratio: k_j / 2
  q_relationship: q = k * v
  v_f: free_flow_speed
  y_i: critical_traffic_flow_ratio
semantic:
  alternative_parents: []
