...
properties:
  ...
  energy_density_range_wh_kg: 150-300
  lcos_definition: CAPEX + sum(OPEX_t / (1+r)^t) / sum(E_out_t / (1+r)^t)
  response_time_max_ms: 100
  round_trip_efficiency_threshold: 0.85
  soc_control_precision_percent: 1
semantic:
  alternative_parents: []
