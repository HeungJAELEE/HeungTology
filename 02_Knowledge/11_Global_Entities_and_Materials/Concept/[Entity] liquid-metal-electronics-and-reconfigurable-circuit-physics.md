...
lineage:
  ...
  original_hash: 1e75b87f2d07fd37ac48c3469215274cedb3e1c6e17f20bc4213abd9604d40f4
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] liquid-metal-electronics-and-reconfigurable-circuit-physics에
    관한 고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  electrical_conductivity: 3e6 S/m
  encapsulation_purity_threshold: 0.999
  liquid_transition_temperature: 15.5C
  oxide_skin_thickness: 1-3 nm
  oxide_stability_index_threshold: 0.8
  primary_material: EGaIn (Ga 75%, In 25%)
  reconfiguration_speed_threshold_ms: 500
  resistance_variance_threshold_pct: 10.0
  stretchability_limit: 300%
  viscosity: 2.0 mPa.s
semantic:
  alternative_parents: []
