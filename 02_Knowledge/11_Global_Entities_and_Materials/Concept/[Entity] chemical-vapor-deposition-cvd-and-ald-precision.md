...
object:
  description: '[Entity] chemical-vapor-deposition-cvd-and-ald-precision에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  ald_conformality_min_pct: 99
  ald_growth_rate_a_max: 10
  ald_growth_rate_a_min: 1
  ald_temp_window_c: 150-450
  ald_thickness_control_a: < 1
  ald_uniformity_max_pct: 1
  conformality_reject_threshold_pct: 95.0
  cvd_conformality_pct: 50-80
  cvd_growth_rate_a_max: 1000
  cvd_growth_rate_a_min: 100
  cvd_temp_window_c: 400-900
  cvd_thickness_control_a: 10-50
  cvd_uniformity_max_pct: 3
  external_db_endpoint: cvd-ald-film-thickness-and-conformality-v2026
  gpc_deviation_threshold: 0.05
  uniformity_warning_threshold_pct: 1.5
semantic:
  alternative_parents: []
