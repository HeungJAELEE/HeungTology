...
object:
  description: '[Entity] heavy-duty-ev-drivetrain-and-multi-speed-transmissions에 관한
    고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  drivetrain_efficiency_high_eff_pct: 94
  drivetrain_efficiency_typical_pct: 85-90
  gear_shift_time_threshold_ms: 800
  inverter_temp_threshold_c: 85.0
  max_torque_high_eff_min_nm: 50000
  max_torque_typical_range_nm: 30000-45000
  motor_power_high_eff_min_kw: 800
  motor_power_typical_range_kw: 400-600
  regeneration_efficiency_threshold_pct: 15.0
  torque_error_threshold: 0.05
  transmission_steps_high_eff: 4-6
  transmission_steps_typical: 2-4
semantic:
  alternative_parents: []
