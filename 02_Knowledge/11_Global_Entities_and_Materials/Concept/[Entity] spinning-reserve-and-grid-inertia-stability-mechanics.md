...
lineage:
  ...
  original_hash: c36da411d4a5be910577e31d091aedbe7f15cf1007d8e203b782923e3d1cf153
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] spinning-reserve-and-grid-inertia-stability-mechanics에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  frequency_nadir_limit: '59.2'
  grid_frequency_base: '60.0'
  inverter_rocof_tolerance: '0.5'
  rocof_critical_threshold: '1.0'
  spinning_reserve_min_mw: '500.0'
  thermal_rocof_tolerance: '2.0'
semantic:
  alternative_parents: []
