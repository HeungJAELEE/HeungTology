...
object:
  description: '[Entity] data-science-and-predictive-analytics-for-business에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  critical_mape_threshold_percent: 20.0
  feature_count_max: 100
  feature_count_min: 10
  mape_target_threshold_percent: 10
  max_inference_latency_ms: 100
  min_feature_stability_threshold_percent: 80.0
  model_decay_drift_threshold: 0.4
  r_squared_target_threshold: 0.75
  training_update_frequency: weekly_monthly
semantic:
  alternative_parents: []
