...
object:
  description: '[Entity] deep-space-communication-and-interplanetary-networking-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  earth_mars_distance_km_range: 5.4e7 - 4e8
  mars_latency_min_range: 3 - 22
  min_snr_threshold_db: 15
  optical_antenna_size_m: 0.5 - 1
  optical_beam_width_deg: 0.001
  optical_data_rate_mbps: 100 - 1000
  optical_frequency_ghz: 193000
  optical_wavelength_nm: 1550
  packet_loss_warning_threshold_pct: 20.0
  pointing_precision_threshold_arcsec: 1.0
  x_band_antenna_size_m: 34 - 70
  x_band_beam_width_deg: 0.5
  x_band_data_rate_mbps: 0.5 - 6
  x_band_frequency_ghz: 8.4
semantic:
  alternative_parents: []
