...
object:
  description: '[Entity] drywall-manufacturing-and-gypsum-dehydration-kinetics에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  adhesion_score_threshold: 0.9
  arrhenius_equation: k(T) = A * exp(-Ea / (R * T))
  calcination_temp_range_c: 140-160
  drywall_density_g_cm3_range: 0.6-0.8
  line_speed_m_min_range: 50-150
  moisture_limit_pct: 1.0
  natural_gypsum_density_g_cm3: 2.3
  rapid_setting_threshold_sec: 120
  setting_time_min_range: 2-5
  under_calcination_threshold_c: 135.0
semantic:
  alternative_parents: []
