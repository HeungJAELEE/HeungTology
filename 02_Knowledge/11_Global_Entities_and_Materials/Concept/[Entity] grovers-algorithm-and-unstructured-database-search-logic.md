...
lineage:
  ...
  original_hash: 0eb5fe3f1007b862427382417e2ca42ab272256137a1f976de95be157259ba1d
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] grovers-algorithm-and-unstructured-database-search-logic에
    관한 고밀도 지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  classical_complexity: O(N)
  grover_complexity: O(sqrt(N))
  max_gate_error_rate_threshold: 0.001
  min_decoherence_time_us_threshold: 100
  min_state_overlap_threshold: 0.95
  min_success_probability_threshold: 0.9
semantic:
  alternative_parents: []
