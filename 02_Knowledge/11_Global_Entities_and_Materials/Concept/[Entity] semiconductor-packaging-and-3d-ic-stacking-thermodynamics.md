...
lineage:
  ...
  original_hash: 6399b54981d108223c14143f5059bc9f0c92cf381e20e949784d08e8409a1765
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] semiconductor-packaging-and-3d-ic-stacking-thermodynamics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  ambient_temperature_default: 25C
  external_db_endpoint: packaging-thermal-resistance-and-warpage-log-v2026
  hybrid_bonding_pitch_max: 1.0 um
  interconnect_pitch_range: 5-20 um
  max_warpage_limit: 100 um
  thermal_conductivity_range: 150-400 W/m·K
  tsv_density_min: 1000 count/mm^2
  warpage_stress_empirical_limit: '500'
semantic:
  alternative_parents: []
