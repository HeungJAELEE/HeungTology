...
lineage:
  ...
  original_hash: 975b244f3adda3fdae521f5490649f8872e4e8b2f32258d97b6d95d6f454753d
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] deformation-processing-and-dislocation-mechanics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  cold_working_temp_threshold_factor: 0.4
  dislocation_density_annealed_cm2: 1000000.0
  dislocation_density_cold_worked_cm2: 1000000000000.0
  hot_working_rate_threshold: 0.1
  hot_working_temp_threshold_factor: 0.6
  iron_melting_point_c: 1538
  max_grain_size_um: 100.0
  orowan_equation: gamma_dot = rho * b * v
  rolling_force_limit_kn: 5000.0
  taylor_hardening_formula: sigma = sigma_0 + alpha * G * b * sqrt(rho)
semantic:
  alternative_parents: []
