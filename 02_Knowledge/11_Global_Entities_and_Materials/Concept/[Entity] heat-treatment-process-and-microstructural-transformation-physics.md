...
object:
  description: '[Entity] heat-treatment-process-and-microstructural-transformation-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  avrami_equation: f = 1 - e^(-k * t^n)
  critical_quench_rate: threshold
  grain_growth_law: d^n - d_0^n = k * t
  max_soak_time: threshold
  min_tempering_temp_c: 150.0
  quenching_version: V6.3.7
  target_ac3: threshold
semantic:
  alternative_parents: []
