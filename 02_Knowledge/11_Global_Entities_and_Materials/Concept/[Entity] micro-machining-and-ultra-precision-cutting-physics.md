...
object:
  description: '[Entity] micro-machining-and-ultra-precision-cutting-physics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  minimum_cut_scale_um: 0.1
  spindle_speed_rpm: 100000
  surface_degradation_threshold_nm: 10.0
  temp_control_stability_c: 0.01
  thermal_drift_threshold_c: 0.05
  tool_material: single_crystal_diamond
  tool_wear_alert_threshold_nm: 50.0
  ultra_precision_surface_finish_ra_um: 0.005
  ultra_precision_tolerance_um: 0.01
semantic:
  alternative_parents: []
