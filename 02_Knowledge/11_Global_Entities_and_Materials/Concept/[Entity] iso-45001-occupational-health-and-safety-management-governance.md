...
lineage:
  ...
  original_hash: 93585814a9701e7476f70eddd0b8a548452a869dba2d182b457315ae27a91220
metadata:
  date: '2026-05-16'
  domain: 11_Global_Entities_and_Materials
  id: '[[[Entity] iso-45001-occupational-health-and-safety-management-governance]]'
  last_updated: '2026-05-17T22:59:20+09:00'
  project: Vault_Modernization
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: '[Entity] iso-45001-occupational-health-and-safety-management-governance에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  iso_45001_version: V6.3.7
  logic_fidelity_engine_parameters:
  - fatal_incident_count
  - near_miss_reporting_rate
  - ppe_compliance_pct
  near_miss_warning_threshold_pct: 5.0
  ppe_compliance_notice_threshold_pct: 95.0
  risk_rating_function: f(likelihood, severity)
  safety_index_formula: 1 / (unsafe_acts + unsafe_conditions)
semantic:
  alternative_parents: []
