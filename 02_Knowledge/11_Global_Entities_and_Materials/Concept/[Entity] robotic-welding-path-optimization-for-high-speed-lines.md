...
object:
  description: '[Entity] robotic-welding-path-optimization-for-high-speed-lines에 관한
    고밀도 지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  acceleration_limit: '> 2.0 G'
  audit_version: Robot-Dance-v2026-Fidelity
  cycle_time: < 30 sec
  path_accuracy: < 50 um
  robot_sync_time: < 5 ms
  vibration_level: < 0.1 G
semantic:
  alternative_parents: []
