...
object:
  description: '[Entity] hardenability-and-jominy-end-quench-metallurgy-physics에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  critical_alloy_elements: Cr, Ni, Mo, Mn, B
  extreme_surface_dist_threshold_mm: 2.0
  extreme_surface_hrc_threshold: 60
  hardenability_standard: ASTM A255
  hardness_standard: ISO 6508
  low_hardenability_dist_threshold_mm: 15
  low_hardenability_hrc_threshold: 35
semantic:
  alternative_parents: []
