...
lineage:
  ...
  original_hash: 31aee50d952e5b746a972234a4d444298fca3670979885ccb99025449149e1d1
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] climate-disaster-resilience-and-global-warning-system에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  data_endpoint: climate-disaster-frequency-and-economic-impact-v2026
  max_warning_latency_threshold_min: 10.0
  min_infrastructure_health_threshold: 0.7
  min_prediction_accuracy_threshold_percent: 75.0
  prediction_accuracy_target_percent: 85
  prediction_accuracy_tolerance_percent: 5
  recovery_time_target_hours: 12
  recovery_time_tolerance_hours: 2
  resilience_index_target_ratio: 0.9
  resilience_index_tolerance_ratio: 0.05
  risk_formula: H * V * E
  system_uptime_target_percent: 99.999
  warning_lead_time_target_hours: 72
  warning_lead_time_tolerance_hours: 2
semantic:
  alternative_parents: []
