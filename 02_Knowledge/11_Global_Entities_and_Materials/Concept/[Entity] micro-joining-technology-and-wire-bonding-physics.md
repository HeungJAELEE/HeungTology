...
lineage:
  ...
  original_hash: 60fe73ce576329b27ef99a70c670cb254623a9ad6de857f41599be7e9bc1e632
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] micro-joining-technology-and-wire-bonding-physics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  ball_bonding_gold_freq_khz: 60-140
  ball_bonding_gold_temp_range_c: 150-250
  bond_pull_force_threshold_g: 3.0
  capillary_wear_limit_cycles: 500000
  imc_coverage_threshold_pct: 60.0
  imc_growth_formula: x = sqrt(D * t)
  loop_height_tolerance_um: 20
  wedge_bonding_al_freq_khz: 60-120
  wedge_bonding_al_temp_range_c: Ambient-150
semantic:
  alternative_parents: []
