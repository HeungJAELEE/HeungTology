...
object:
  description: '[Entity] advanced-piezoelectric-materials-and-energy-harvesting-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  curie_temp_min_c: 350
  d33_min_pc_n: 600
  epsilon_r_min_dielectric: 1500
  fatigue_resistance_min_cycles: 1000000000
  g33_min_v_m_n: 0.025
  k33_min_coupling_factor: 0.7
  power_density_min_mw_cm3: 10.0
  qm_min_quality_factor: 1000
  standard_specification: HDS-Gold V6.3.7
  system_efficiency_target: 0.2
semantic:
  alternative_parents: []
