...
lineage:
  ...
  original_hash: be4363189c01951c26e20980ad91cbf295dc0a43becde8223f959a8484d412ef
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] freight-forwarding-and-logistics-network-governance에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  critical_container_dwell_threshold_hr: 72
  customs_clearance_delay_threshold_hr: 24
  freight_forwarding_version: 6.3.7
  minimum_route_reliability_threshold_pct: 85.0
  network_efficiency_index_formula: eta_net = sum(Q_delivered) / (T_lead * C_net)
  total_logistics_cost_formula: C_total = sum(C_trans + C_inv + C_order + C_risk)
semantic:
  alternative_parents: []
