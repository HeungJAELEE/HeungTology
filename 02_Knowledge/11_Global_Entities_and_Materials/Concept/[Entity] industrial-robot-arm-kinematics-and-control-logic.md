...
object:
  description: '[Entity] industrial-robot-arm-kinematics-and-control-logic에 관한 고밀도
    지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  control_loop_cycle_time_ms: 1-2
  fidelity_engine_cycle_time_tolerance_ms: 0.1
  fidelity_engine_joint_velocity_tolerance_rad_s: 0.05
  fidelity_engine_path_accuracy_tolerance_mm: 0.01
  fidelity_engine_payload_tolerance_kg: 0.5
  fidelity_engine_repeatability_tolerance_mm: 0.001
  kinematic_deformation_threshold_mm: 0.05
  manipulability_index_threshold: 0.001
  max_joint_velocity_rad_s: 3.0
  path_accuracy_target_mm: 0.1
  payload_capacity_kg: 10-500+
  repeatability_target_mm: 0.01
semantic:
  alternative_parents: []
