...
object:
  description: '[Entity] epigenetic-regulation-and-gene-expression-topology에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  acetylation_chemical_marker: -COCH3
  chromatin_openness_low_threshold: 0.2
  chromatin_openness_upper_bound: 1.0
  methylation_chemical_marker: -CH3
  methylation_critical_threshold: 80.0
  stress_marker_warning_threshold: 100
semantic:
  alternative_parents: []
