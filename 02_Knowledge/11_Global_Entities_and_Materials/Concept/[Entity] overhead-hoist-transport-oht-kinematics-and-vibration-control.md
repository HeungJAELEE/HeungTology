...
lineage:
  ...
  original_hash: 0bfe6d0b297bc34d7b4da4faf9a2a7885d555ec5add0b027dd37ee3138912b66
metadata:
  date: '2026-05-16'
  domain: 11_Global_Entities_and_Materials
  id: '[[[Entity] overhead-hoist-transport-oht-kinematics-and-vibration-control]]'
  last_updated: '2026-05-17T22:59:20+09:00'
  project: Vault_Modernization
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: '[Entity] overhead-hoist-transport-oht-kinematics-and-vibration-control에
    관한 고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  critical_vibration_threshold_g: '0.1'
  notice_sway_settling_time_threshold: '2.0'
  power_loss_threshold_energy_per_meter: '5.0'
  stop_accuracy_mm: '0.5'
  transport_speed_max: 10.0 m/s
  transport_speed_min: 5.0 m/s
  vibration_limit_g: '0.05'
  warning_stop_accuracy_threshold_mm: '1.0'
semantic:
  alternative_parents: []
