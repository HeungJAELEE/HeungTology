...
lineage:
  ...
  original_hash: b6db0dd45476943fc8e40159783910ac4c7c238e4115e89ce8e14644b664610a
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] human-robot-interaction-hri-social-robotics-and-affective-computing에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  intimate_distance_m_max: 0.45
  personal_distance_m_range:
  - 0.45
  - 1.2
  social_distance_m_range:
  - 1.2
  - 3.6
  target_emotion_accuracy_pct: 90.0
  target_gaze_alignment_pct: 85.0
  target_human_trust_score: 4.2
  target_interact_latency_ms: 200.0
  target_pad_score_accuracy: 0.85
semantic:
  alternative_parents: []
