...
object:
  description: '[Entity] bio-mimetic-structural-colors-and-photonic-crystal-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  angle_shift_max_nm_deg: 1.0
  bandgap_width_range_pct: 5-15
  bandgap_width_tolerance_pct: 1
  color_purity_critical_threshold_pct: 60
  data_endpoint_id: structural-color-reflectance-and-viewing-angle-v2026
  design_error_monitoring_step_nm: 5
  iridescence_warning_threshold_nm_10deg: 5.0
  lattice_constant_nm: 150-300
  lattice_constant_tolerance_nm: 5
  reflectance_peak_min_pct: 80
  reflectance_peak_tolerance_pct: 5
  refractive_index_range: 1.4-2.5
  refractive_index_tolerance: 0.01
  target_color_implementation_success_rate: 0.98
semantic:
  alternative_parents: []
