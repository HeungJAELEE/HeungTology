...
lineage:
  ...
  original_hash: 77490cf440d939fd66c906f30445d8d33b1cd8b515f5070376c89078fc7b6050
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] cyber-physical-systems-cps-and-industrial-iot-iiot에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  critical_sync_error_threshold_pct: 5.0
  data_throughput_min_gbps: 10
  device_density_min_devices_per_node: 1000
  latency_hard_rt_ms: 1
  reject_sensor_drift_threshold_pct_month: 2.0
  reliability_min_packet_delivery_pct: 99.999
  sync_accuracy_max_us: 1
  warning_jitter_threshold_ms: 10.0
semantic:
  alternative_parents: []
