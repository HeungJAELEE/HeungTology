...
object:
  description: '[Entity] cd-sem-metrology-and-electron-beam-interaction-physics에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  beam_energy_v_acc_ev_range: 300-1000
  engine_beam_drift_warning_threshold_percent: 2.0
  engine_charging_reject_threshold: 0.5
  engine_precision_critical_threshold_nm: 0.2
  external_data_endpoint: cd-sem-resolution-and-measurement-precision-v2026
  max_edge_roughness_ler_nm: 1.0
  min_throughput_wph: 30
  target_measurement_precision_3sigma_nm: 0.1
  target_pixel_size_nm_range: 0.5-1.0
semantic:
  alternative_parents: []
