...
object:
  ...
  tier: 1
properties:
  cooling_rate_t8_5_range: 5 - 50 s
  heat_input_range: 0.5 - 3.0 kJ/mm
  joint_efficiency_min: '1.0'
  marangoni_flow_status: controlled
  penetration_requirement: full_penetration
  preheat_temperature_range: 50 - 250 °C
  residual_stress_threshold: < 0.8 sigma_y
  weld_defect_target: zero_defect
semantic:
  alternative_parents: []
