...
object:
  description: '[Entity] global-resource-balance-and-circular-economy-governance에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  carbon_footprint_reject_limit_kg_co2e: 5.0
  current_human_circularity_rate_limit: 0.1
  product_refurbishment_notice_limit: 20.0
  waste_to_landfill_warning_limit: 1000
semantic:
  alternative_parents: []
