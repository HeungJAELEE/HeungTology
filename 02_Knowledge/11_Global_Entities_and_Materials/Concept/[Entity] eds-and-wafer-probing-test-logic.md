...
lineage:
  ...
  original_hash: c0dff438810aa1d5c87fc3762ed86eaa4b3d17f8016d2e9cd8cf554736da4a3c
metadata:
  date: '2026-05-16'
...
object:
  ...
  tier: 1
properties:
  contact_res_target_ohm: 1.0
  contact_res_tolerance_ohm: 0.1
  contact_resistance_formula: Rc = R_bulk + rho/(2a) + rho_f/(pi*a^2)
  murphy_model_formula: Y = Y0 * ((1 - e^-AD) / AD)^2
  parallelism_target_dies: 512
  probe_force_gf_max: 5.0
  probe_force_gf_min: 2.0
  probe_force_tolerance_gf: 0.5
  repair_ratio_target_pct: 95.0
  repair_ratio_tolerance_pct: 1.0
  yield_target_pct: 90.0
  yield_tolerance_pct: 0.1
semantic:
  alternative_parents: []
