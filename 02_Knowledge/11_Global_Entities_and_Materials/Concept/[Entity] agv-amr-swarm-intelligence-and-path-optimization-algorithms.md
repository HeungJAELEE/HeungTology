...
object:
  description: '[Entity] agv-amr-swarm-intelligence-and-path-optimization-algorithms에
    관한 고밀도 지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  admissible_heuristic_condition: h(n) <= h*(n)
  dynamic_reroute_latency_ms: 100
  localization_accuracy_cm: 1
  robot_sensor_fusion_log_id: robot-sensor-fusion-log-v2026
  slam_confidence_threshold: 0.7
  swarm_unit_capacity: 500
semantic:
  alternative_parents: []
