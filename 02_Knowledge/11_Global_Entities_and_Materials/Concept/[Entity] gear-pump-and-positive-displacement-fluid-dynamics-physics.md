...
lineage:
  ...
  original_hash: 97d546c9cac6c6b6cb91e82e6fe63c80b321a8f27b615ba9230759ebbb082662
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] gear-pump-and-positive-displacement-fluid-dynamics-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  critical_efficiency_threshold: 0.7
  diagnostic_engine: FactoryFidelityEngine
  low_speed_threshold_rpm: 100
  max_pressure_bar: 300
  theoretical_flow_formula: Q_theoretical = V_d * n
  volumetric_efficiency_formula: eta_vol = Q_actual / Q_theoretical
semantic:
  alternative_parents: []
