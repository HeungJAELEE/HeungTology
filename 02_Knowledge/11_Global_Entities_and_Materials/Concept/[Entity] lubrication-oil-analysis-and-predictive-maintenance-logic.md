...
object:
  description: '[Entity] lubrication-oil-analysis-and-predictive-maintenance-logic에
    관한 고밀도 지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  detection_method: Atomic Spectroscopy (ICP)
  fe_critical_threshold: '100.0'
  monitoring_metric: TAN
  viscosity_drift_threshold: '10.0'
  water_limit: '100'
  water_warning_threshold: '500.0'
  wear_metals_early_warning: '1.0'
semantic:
  alternative_parents: []
