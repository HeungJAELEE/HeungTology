...
lineage:
  ...
  original_hash: e452b7bee2b5b7b1c18b012da4e52bc0c5dac120a624f7f03c100c413ce4c02f
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] cnc-machining-kinematics-and-multi-axis-control-logic에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  critical_deviation_threshold_mm: 0.005
  external_data_log_id: cnc-machining-precision-and-tool-wear-log-v2026
  high_precision_axis_count_range: 5-9
  high_precision_pos_accuracy_mm: 0.001
  high_precision_repeatability_mm: 0.0005
  high_precision_spindle_speed_rpm: 50000
  high_precision_surface_roughness_um: 0.1
  reject_spindle_load_threshold_pct: 90.0
  warning_roughness_threshold_um: 0.4
semantic:
  alternative_parents: []
