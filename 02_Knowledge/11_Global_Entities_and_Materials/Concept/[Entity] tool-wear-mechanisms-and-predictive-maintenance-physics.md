...
lineage:
  ...
  original_hash: 6931468968fdbcecb4f0e4e115cbf6b215c689d8e39880dfcb6707a889c0c5e9
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] tool-wear-mechanisms-and-predictive-maintenance-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  audit_status_id: Edge-Life-v2026-Fidelity
  coating_hardness_min_hv: 3000
  knowledge_hub_endpoint: MOC 128_precision-mold-die-and-cnc-machining-engineering-hub
  predictive_accuracy_min_percent: 98
  taylor_law_model: velocity_vs_life_correlation
  tool_life_threshold_hours: 50
  wear_rate_max_um_min: 5
semantic:
  alternative_parents: []
