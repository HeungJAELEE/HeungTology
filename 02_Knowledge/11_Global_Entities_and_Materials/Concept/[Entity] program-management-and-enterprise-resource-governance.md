...
object:
  description: '[Entity] program-management-and-enterprise-resource-governance에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  governance_transparency_threshold: 0.8
  program_management_version: 6.3.7
  resource_overload_threshold_pct: 120.0
