...
lineage:
  ...
  original_hash: 7b412255687e2d07b9e5d91f78633d56d8084a1af065656351ad9f62d727034a
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] gas-chromatography-gc-and-molecular-separation-physics에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  carrier_gases: He_H2_N2
  column_length_max_m: 100
  column_length_min_m: 10
  minimum_pressure_ratio: 0.8
  noise_critical_threshold: 50.0
  sensitivity_range: ppm_to_ppb
  tailing_factor_rejection_limit: 1.5
  temperature_instability_threshold: 0.5
semantic:
  alternative_parents: []
