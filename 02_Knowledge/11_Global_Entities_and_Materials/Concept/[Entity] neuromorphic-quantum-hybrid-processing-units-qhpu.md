...
object:
  description: '[Entity] neuromorphic-quantum-hybrid-processing-units-qhpu에 관한 고밀도
    지능 노드'
  object_type: Hardware
  tier: 1
properties:
  energy_efficiency_improvement: 10^6x
  max_spike_mapping_error: 0.1
  min_algorithmic_fidelity: 0.9
  min_quantum_coherence_time_us: 50
  min_qubit_entanglement_ratio: 0.5
  neuron_count_hardware_range: 10M-1B
  qubit_count_logical_range: 100-1,000
semantic:
  alternative_parents: []
