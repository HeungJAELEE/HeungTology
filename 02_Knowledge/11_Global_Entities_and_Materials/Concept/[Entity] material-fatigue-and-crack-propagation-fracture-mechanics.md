...
object:
  description: '[Entity] material-fatigue-and-crack-propagation-fracture-mechanics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  critical_crack_length_parameter: critical_a
  damage_mode: progressive_cracking
  detection_method: ndt_ultrasonic_eddy
  failure_limit_metric: fatigue_limit
  fatigue_cycle_limit: fatigue_limit_n
  fracture_toughness_parameter: fracture_toughness
  life_prediction_logic: cycle_counting
  observation_scale: microscopic_striations
  paris_law_formula: da/dN = C(delta_K)^m
  stress_intensity_factor_formula: K_I = sigma * sqrt(pi * a) * Y
semantic:
  alternative_parents: []
