...
object:
  description: '[Entity] ethics-by-design-and-moral-machine-logic-gates에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  accountability_index_notice_threshold: 0.9
  algorithmic_bias_warning_threshold: 0.1
  bias_variance_disparate_impact_limit: 0.05
  privacy_loss_epsilon_dp_limit: 1.0
  safety_gate_bypass_chance_target: 0
  safety_gate_integrity_critical_threshold: 100.0
  traceability_decision_log_target: 100
semantic:
  alternative_parents: []
