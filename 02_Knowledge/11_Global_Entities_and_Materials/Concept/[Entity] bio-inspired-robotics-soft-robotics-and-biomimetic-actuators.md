...
lineage:
  ...
  original_hash: fac787d6938584f59e76368895e6cb3d9a28d613a406de6a2728d2ee587ea904
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] bio-inspired-robotics-soft-robotics-and-biomimetic-actuators에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  actuation_pressure_range_mpa: 0.1-0.5
  external_data_endpoint: soft-actuator-force-vs-deformation-log-v2026
  failure_prediction_probability: 0.98
  linearity_error_threshold: 0.15
  max_payload_threshold_n: 20
  max_strain_pct: 300
  power_density_min_w_kg: 50
