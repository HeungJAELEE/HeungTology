...
object:
  description: '[Entity] multimodal-transport-sync-and-unified-ticketing-protocol에
    관한 고밀도 지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  data_sync_rate_seconds: 1
  protocol_version: V6.3.7
  settlement_error_threshold: 0.001
  token_validation_threshold_ms: 500
  transfer_miss_threshold: 0.15
semantic:
  alternative_parents: []
