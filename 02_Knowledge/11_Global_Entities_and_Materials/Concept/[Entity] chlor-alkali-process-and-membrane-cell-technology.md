...
object:
  description: '[Entity] chlor-alkali-process-and-membrane-cell-technology에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  brine_impurity_threshold_ppb: 20.0
  h2_cl2_explosion_threshold_pct: 4.0
  high_cell_resistance_threshold_v: 3.2
  membrane_cell_current_density_ka_m2: 4-8
  membrane_cell_energy_consumption_kwh_t: 2200-2500
  membrane_cell_product_concentration_pct: 32-35
  mercury_cell_current_density_ka_m2: 5-10
  mercury_cell_energy_consumption_kwh_t: 3100-3400
  min_current_efficiency_threshold_pct: 94.0
  nernst_equation_variables: E, E0, R, T, n, F, Q
semantic:
  alternative_parents: []
