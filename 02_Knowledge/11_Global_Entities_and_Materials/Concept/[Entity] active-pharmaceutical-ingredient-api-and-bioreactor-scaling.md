...
object:
  description: '[Entity] active-pharmaceutical-ingredient-api-and-bioreactor-scaling에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  api_purity_warning_threshold: 98.0
  biomass_density_high_threshold: 100.0
  industrial_api_yield_min_pct: 95.0
  industrial_scale_volume_max_l: 50000
  industrial_scale_volume_min_l: 5000
  kla_critical_threshold: 50.0
  lab_scale_volume_max_l: 5.0
  lab_scale_volume_min_l: 0.1
semantic:
  alternative_parents: []
