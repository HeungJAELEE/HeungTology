...
object:
  description: '[Entity] planetary-resource-governance-and-deep-sea-mining-ethics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  benefit_sharing_ratio_threshold: 0.5
  biodiversity_impact_threshold: 0.15
  mineral_grade_deep_sea_max: 7.0
  mineral_grade_deep_sea_min: 3.0
  mineral_grade_terrestrial_max: 1.0
  mineral_grade_terrestrial_min: 0.5
  recycled_content_threshold_pct: 30.0
semantic:
  alternative_parents: []
