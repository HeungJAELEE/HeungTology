...
lineage:
  ...
  original_hash: 6fa7ce31e78e12082d7ff8f2e82530be9a406c270e32e9101a6359f0a0ca6588
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] electrophoretic-deposition-epd-and-colloidal-stability-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  critical_zeta_potential_threshold_mv: 25.0
  epd_voltage_range_v: 10-500
  hamaker_law_mass_variable: w
  hamaker_law_time_variable: t
  hamaker_law_viscosity_variable: mu
  hamaker_law_voltage_variable: V
  hamaker_law_zeta_potential_variable: zeta
  low_deposition_current_threshold_ua: 5.0
  particle_depletion_turbidity_threshold: 10.0
  zeta_potential_required_min_mv: 30.0
semantic:
  alternative_parents: []
