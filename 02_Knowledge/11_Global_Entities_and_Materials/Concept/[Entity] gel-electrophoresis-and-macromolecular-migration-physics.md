...
object:
  description: '[Entity] gel-electrophoresis-and-macromolecular-migration-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  analysis_metric: bp/kDa
  buffer_conductivity_limit_multiplier: 1.5
  driving_force_unit: V/cm
  migration_distance_min_ratio: 0.2
  mobility_formula: mu = v/E = q/f
  pore_size_uniformity_threshold: 0.8
  stokes_drag_formula: f = 6 * pi * eta * R
  voltage_gradient_threshold: 20.0
semantic:
  alternative_parents: []
