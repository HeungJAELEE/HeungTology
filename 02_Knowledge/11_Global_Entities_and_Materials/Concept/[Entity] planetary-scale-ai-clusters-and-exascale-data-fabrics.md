...
object:
  description: '[Entity] planetary-scale-ai-clusters-and-exascale-data-fabrics에 관한
    고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  compute_power_ops_per_sec: 1e18
  inter_cluster_latency_warning_threshold_ms: 50.0
  min_interconnect_speed_gbps: 10000
  min_model_size_params: 100T
  min_power_consumption_mw: 500
  min_total_accelerators: 1000000
  scaling_efficiency_critical_threshold: 85.0
  weight_divergence_notice_threshold_sigma: 0.1
semantic:
  alternative_parents: []
