...
lineage:
  ...
  original_hash: 473405b7926973587e167f7ac7f3fa4e14f4969801088295a630cdeaf7a9c1a1
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] meta-materials-and-photonic-crystal-light-steering에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  max_device_thickness_um: 1.0
  max_lidar_angular_res_deg: 0.1
  max_scattering_noise_pct: 10.0
  max_steering_error_deg: 0.5
  min_bandgap_extinction_db: 40.0
  min_lidar_points_per_sec: 1000000
  min_transmission_efficiency_pct: 80
  steering_angle_min_deg: 120
  steering_speed_regime: ns
semantic:
  alternative_parents: []
