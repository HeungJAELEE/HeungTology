...
lineage:
  ...
  original_hash: 38601cd1b6c343b3f24960abdf238e5d0b69b30c5e9679988fb6461a3afd90b0
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] advanced-materials-and-nanotechnology-engineering에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  braggs_law: n * lambda = 2 * d * sin(theta)
  defect_density_max: 10^10 cm-2
  elec_mobility_min: '200000'
  nano_size_deviation_max: 5%
  nano_size_range_nm: 1-100
  quantum_confinement_energy: En = (n^2 * h^2) / (8 * m * L^2)
  quantum_yield_min: 90%
  surface_area_min: 2500 m2/g
  surface_to_volume_ratio: 3/r
  thermal_conductivity_min: 5000 W/mK
semantic:
  alternative_parents: []
