...
lineage:
  ...
  original_hash: c8cee0a773af2a0382060a573fb4ff18f01168de1d476f51bdbd75fc6eb5ac2e
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] inkjet-printing-and-microfluidic-drop-formation-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  drop_velocity_range_m_s: 5-10
  drop_volume_range_pl: 1-50
  firing_frequency_range_khz: 10-100
  nozzle_density_range_dpi: 300-1200
  velocity_critical_threshold_m_s: 4.0
  volume_inconsistency_threshold_multiplier: 1.2
  z_number_optimal_range: 1-10
semantic:
  alternative_parents: []
