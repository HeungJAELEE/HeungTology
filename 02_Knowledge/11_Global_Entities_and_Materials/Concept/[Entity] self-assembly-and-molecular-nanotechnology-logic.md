...
lineage:
  ...
  original_hash: b122fc24104a7038295e1561c35da934a1748e90e6d54918fc04813e15d4055e
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] self-assembly-and-molecular-nanotechnology-logic에 관한 고밀도
    지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  critical_micelle_concentration_unit: mM
  design_error_precision_threshold: 10^-6
  dna_melting_temp_c: 40-90
  external_data_log_endpoint: chemical-synthesis-reaction-yield-and-purity-log-v2026
  interaction_energy_hb_kj_mol: 5-30
  self_assembly_time_mins: 10-120
  structural_precision_nm: <0.5
  thermal_stability_critical_margin: 5.0
  thermal_stability_warning_margin: 15.0
semantic:
  alternative_parents: []
