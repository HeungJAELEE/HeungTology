...
object:
  description: '[Entity] friction-stir-welding-fsw-for-battery-housing-and-cooling에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  axial_force_range: 5-50 kN
  leak_test_pressure_threshold: 5.0 bar
  max_aluminum_temp_threshold: 550 C
  max_porosity_level: '0.01'
  tool_rotation_speed_range: 500-2000 RPM
  weld_depth_range: 1.0-10.0 mm
  welding_speed_range: 100-1000 mm/min
semantic:
  alternative_parents: []
