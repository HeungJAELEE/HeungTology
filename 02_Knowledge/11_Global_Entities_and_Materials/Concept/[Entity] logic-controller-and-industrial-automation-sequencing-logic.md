...
lineage:
  ...
  original_hash: 9f8e4bddf1d7238f89845c47189c8fd5864349b55bedb3b1dd72e4df156d2ee3
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] logic-controller-and-industrial-automation-sequencing-logic에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  alarm_threshold: 5
  fsm_logic_model: Output = f(Input_current, State_previous)
  io_error_threshold: 0
  plc_max_response_ms: 1.0
  scan_cycle_formula: T_scan = T_read + T_exec + T_write
  t_scan_critical_threshold_ms: 20.0
semantic:
  alternative_parents: []
