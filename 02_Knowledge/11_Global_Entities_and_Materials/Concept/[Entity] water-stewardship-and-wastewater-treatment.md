...
lineage:
  ...
  original_hash: bac9e7ba17059558964906a8b3f911b77be3f3ac01785886524503445f07f6c1
metadata:
  date: '2026-05-16'
...
object:
  ...
  tier: 1
properties:
  catchment_water_stress_level_range: 1-5
  primary_treatment_efficiency_range: 40-60%
  primary_treatment_tss_threshold: 50 mg/L
  secondary_treatment_bod_threshold: 10 mg/L
  secondary_treatment_efficiency_range: 80-95%
  tertiary_treatment_cod_threshold: 5 mg/L
  tertiary_treatment_efficiency_range: 90-99%
  water_intensity_unit: m^3/unit
  water_recycling_rate_formula: sum(V_recycled) / (sum(V_recycled) + sum(V_withdrawal))
  zld_efficiency_range: 95-100%
  zld_tds_threshold: 0 mg/L
semantic:
  alternative_parents: []
