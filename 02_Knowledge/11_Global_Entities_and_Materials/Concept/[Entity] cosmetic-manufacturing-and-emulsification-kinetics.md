...
lineage:
  ...
  original_hash: b3ab16709e5365b306cfbd8932481cf6a75b957e70cfb9c85ae160992917e744
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] cosmetic-manufacturing-and-emulsification-kinetics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  critical_droplet_size_threshold_nm: 5000
  hlb_mix_formula: sum(f_i * hlb_i)
  preservative_efficacy_reject_threshold: 0.95
  skin_neutral_ph_range: 4.5-5.5
  stability_score_warning_threshold: 0.9
  stokes_law_variables:
  - r
  - rho_p
  - rho_f
  - g
  - eta
  target_droplet_size_um: 0.1-2.0
  target_stability_life_years: 2-3
  viscosity_notice_threshold_cp: 500
semantic:
  alternative_parents: []
