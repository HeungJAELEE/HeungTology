...
object:
  description: '[Entity] cryogenic-air-separation-and-distillation-physics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  argon_boiling_point_c: -185.8
  heat_exchanger_dt_critical_threshold: 5.0
  hydrocarbon_content_danger_threshold_ppb: 100
  nitrogen_boiling_point_c: -195.8
  oxygen_boiling_point_c: -183.0
  oxygen_energy_intensity_kwh_nm3: 0.3-0.5
  oxygen_purity_warning_threshold: 99.5
  turbine_isentropic_efficiency_threshold_pct: 80.0
semantic:
  alternative_parents: []
