...
object:
  description: '[Entity] battery-thermal-runaway-physics-and-fire-suppression-mechanisms에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  cathode_decomp_temp_range: 180-220
  critical_cell_voltage_v: 2.5
  critical_temp_rise_rate_k_min: 20.0
  data_endpoint: thermal-runaway-propagation-speed-and-gas-composition-v2026
  hazardous_gas_concentration_ppm: 500
  lfp_oxygen_release_temp_c: 310
  ncm_oxygen_release_temp_c: 210
  sei_decomp_temp_range: 70-110
  separator_melt_temp_range: 130-160
  thermal_runaway_temp_threshold: '>250'
  venting_pressure_bar: 5-15
  warning_temp_rise_rate_k_min: 5.0
semantic:
  alternative_parents: []
