...
lineage:
  ...
  original_hash: aa0418b977dfbad18f81703911324acad363d14742e2ae8ac10d6e035c0a31b4
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] fire-protection-and-emergency-response-system에 관한 고밀도 지능
    노드'
  object_type: Hardware
  tier: 1
properties:
  active_suppression_reliability: 98.5%
  detection_reliability: 99.9%
  detection_response_time: < 30 sec
  ert_response_time: < 5 min
  evacuation_time_limit: < 8 min
  fire_growth_model: Q = alpha * t^2
  fire_growth_rate_alpha: kW/s^2
  incident_command_fidelity_range: 0 to 1
  passive_protection_reliability: 100.0%
semantic:
  alternative_parents: []
