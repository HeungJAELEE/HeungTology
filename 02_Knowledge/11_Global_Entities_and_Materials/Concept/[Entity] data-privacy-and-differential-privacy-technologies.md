...
lineage:
  ...
  original_hash: 1a182fb6d983d4b7ad9cc2546f84f8feb28558a1cea6990591b20fe481d9214e
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] data-privacy-and-differential-privacy-technologies에 관한 고밀도
    지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  epsilon_high_utility_range: 1.0 - 10.0
  epsilon_strong_privacy_range: 0.01 - 0.1
  max_accuracy_loss_warning_pct: 15.0
  min_attack_resistance_required: 0.95
  reid_risk_high_utility_limit: < 0.1
  reid_risk_strong_limit: < 0.001
  sensitivity_count_value: 1
  sensitivity_sum_value_threshold: 10
  variance_high_utility_limit: < 0.1
  variance_strong_privacy_limit: < 1
semantic:
  alternative_parents: []
