...
object:
  description: '[Entity] forging-process-and-grain-refinement-metallurgy-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  critical_grain_size_threshold_um: 50.0
  fatigue_life_multiplier: 2-3x
  hall_petch_formula: sigma_y = sigma_0 + k * d^(-1/2)
  minimum_forging_temperature_c: 900.0
  strength_loss_threshold_pct: 30.0
  zener_hollomon_parameter_formula: ln(Z) = ln(epsilon_dot) + Q/(RT)
semantic:
  alternative_parents: []
