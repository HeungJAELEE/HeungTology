...
object:
  ...
  tier: 1
properties:
  emg_mapping_parameters:
  - alpha
  - d
  impedance_control_parameters:
  - M
  - B
  - K
  intent_accuracy_threshold_percent: 95
  max_device_weight_kg: 5
  metabolic_reduction_threshold_percent: 15
  sync_error_threshold_ms: 20
semantic:
  alternative_parents: []
