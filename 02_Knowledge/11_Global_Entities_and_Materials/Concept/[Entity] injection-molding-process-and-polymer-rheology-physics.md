...
lineage:
  ...
  original_hash: 3ba37788485990680f98661dc0f51b04558782321fee1fc35cedcb2cf2b84bd6
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] injection-molding-process-and-polymer-rheology-physics에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  clamping_force_range_ton: 50-4000
  cycle_time_range_sec: 5-60
  dimensional_tolerance_mm: 0.05
  injection_pressure_range_bar: 500-2000
  material_state: viscoelastic
  pressure_drop_relation: delta_p proportional to (eta * Q) / R^4
  shear_thinning_model: eta = eta_0 / (1 + (lambda * gamma_dot)^n)
  short_shot_risk_threshold_factor: 1.5
semantic:
  alternative_parents: []
