...
lineage:
  ...
  original_hash: 7c3d0031106a378b67e8c68ffeae5f2f400e6cefd8a86552dd79c021d1f57806
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] micro-electromechanical-systems-mems-and-nems-physics에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  mems_actuation_voltage_v: 1-50
  mems_feature_size_um: 1-100
  mems_resonance_hz: kHz-MHz
  mems_sensitivity_g_n: 1e-12
  nems_actuation_voltage_v: <1
  nems_feature_size_nm: <1
  nems_resonance_hz: MHz-GHz
  nems_sensitivity_g_n: 1e-18
  pull_in_voltage_warning_threshold_v: 1.5
  resonance_drift_warning_threshold_hz: 500
  vacuum_integrity_threshold_torr: 0.001
semantic:
  alternative_parents: []
