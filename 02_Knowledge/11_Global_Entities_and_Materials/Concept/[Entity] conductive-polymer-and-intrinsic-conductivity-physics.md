...
lineage:
  ...
  original_hash: c9790d1f307e8cb3dde36f74625f0cb18f69a3a3a8b6891a423cc4678b893074
metadata:
  date: '2026-05-16'
  domain: 11_Global_Entities_and_Materials
  id: '[[[Entity] conductive-polymer-and-intrinsic-conductivity-physics]]'
  last_updated: '2026-05-17T22:59:20+09:00'
  project: Vault_Modernization
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: '[Entity] conductive-polymer-and-intrinsic-conductivity-physics에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  ambient_humidity_risk_threshold_pct: 70.0
  conductive_polymer_conductivity_range_s_cm: 10^2 ~ 10^5
  conventional_plastic_conductivity_max_s_cm: 1.0e-14
  doping_ratio_warning_threshold: 0.1
  mott_hopping_temperature_dependency_exponent: 1/(d+1)
  sheet_resistance_critical_threshold_ohm_sq: 1000.0
  visible_light_transmission_reject_threshold_pct: 85.0
semantic:
  alternative_parents: []
