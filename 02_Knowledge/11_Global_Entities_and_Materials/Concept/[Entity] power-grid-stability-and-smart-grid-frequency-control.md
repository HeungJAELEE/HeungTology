...
lineage:
  ...
  original_hash: 22cc60e33473b49820e3d3d140e966e5d04cb5d07b64da36923183477b070018
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] power-grid-stability-and-smart-grid-frequency-control에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  freq_tolerance_conventional: 0.2 Hz
  freq_tolerance_smart_grid: 0.05 Hz
  operating_frequency: 50 or 60 Hz
  reactive_power_reserve_warning_threshold: 100 MVAR
  rocof_critical_threshold: 0.5 Hz/s
  smart_load_participation_notice_threshold: 10.0%
semantic:
  alternative_parents: []
