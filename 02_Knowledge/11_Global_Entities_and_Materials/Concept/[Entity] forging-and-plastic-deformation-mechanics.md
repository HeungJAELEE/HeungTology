...
object:
  ...
  tier: 1
properties:
  closed_die_dimensional_accuracy: ±0.1~0.5_mm
  closed_die_press_force_range: 10,000~80,000_tons
  closed_die_strain_rate_range: 10~500_s-1
  hot_forging_temp_max: 1250
  hot_forging_temp_min: 900
  max_die_closure_error_threshold: 0.5
  min_steel_temp_threshold: 900
  open_die_dimensional_accuracy: ±2~5_mm
  open_die_press_force_range: 1,000~10,000_tons
  open_die_strain_rate_range: 1~100_s-1
  von_mises_yield_criterion: sigma_eff = sqrt(0.5 * ((s1-s2)^2 + (s2-s3)^2 + (s3-s1)^2))
  work_hardening_equation: sigma = K * epsilon^n
semantic:
  alternative_parents: []
