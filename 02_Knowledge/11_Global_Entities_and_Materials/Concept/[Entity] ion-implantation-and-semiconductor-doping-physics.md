...
object:
  description: '[Entity] ion-implantation-and-semiconductor-doping-physics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  beam_current_stability_threshold: 0.95
  concentration_profile_distribution: gaussian
  conductivity_logic_formula: sigma = q * (n * mu_e + p * mu_h)
  implant_energy_range_kev:
  - 10
  - 1000
  sheet_resistance_warning_threshold: 1.1
semantic:
  alternative_parents: []
