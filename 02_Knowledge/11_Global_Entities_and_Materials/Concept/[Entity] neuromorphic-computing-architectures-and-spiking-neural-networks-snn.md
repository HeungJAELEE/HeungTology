...
lineage:
  ...
  original_hash: 464b05ab8c4fa2c4d8f203f15c751de8fdd22c870393004ee4193b7b72b009d2
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] neuromorphic-computing-architectures-and-spiking-neural-networks-snn에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  energy_per_op_joules: 10^-14 to 10^-15
  g_ij: synaptic_conductance
  inference_latency_congestion_threshold_us: 1000
  neuromorphic_version: V6.3.7
  precision_bit_range: 1 to 8
  r_m: membrane_resistance
  spike_sparsity_critical_threshold_pct: 50.0
  stdp_success_rate_minimum: 0.8
  tau_m: membrane_time_constant
  v_m: membrane_voltage
  v_rest: resting_membrane_potential
  weight_drift_warning_threshold_sigma: 0.15
semantic:
  alternative_parents: []
