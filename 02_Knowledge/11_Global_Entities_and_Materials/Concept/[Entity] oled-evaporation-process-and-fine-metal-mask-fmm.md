...
lineage:
  ...
  original_hash: aca49421be756bd50777bb5ebb4ccfe2bd176d9412523f621c1bef7463ce6709
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] oled-evaporation-process-and-fine-metal-mask-fmm에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  deposition_rate_stability_target_angstrom_per_sec: 0.03
  fidelity_engine_tolerance_angstrom_per_sec: 0.01
  high_end_alignment_accuracy_um: 0.5
  high_end_shadow_distance_limit_um: 1.0
  knudsen_number_target_min: 15
  low_end_alignment_accuracy_um: 3.0
  low_end_shadow_distance_min_um: 5.0
  mask_thickness_max_um: 15
  mask_thickness_min_um: 10
  mask_thickness_tolerance_um: 0.5
  min_target_ppi: 800
  pixel_displacement_limit_um: 0.3
  shadow_blur_limit_um: 0.2
  standard_alignment_accuracy_um: 1.0
  standard_shadow_distance_max_um: 3.0
  standard_shadow_distance_min_um: 1.5
  vacuum_level_purity_max_pa: 1.0e-07
  vacuum_level_tolerance_pa: 1.0e-08
semantic:
  alternative_parents: []
