...
object:
  description: '[Entity] ai-trism-ai-trust-risk-and-security-management-standards에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  adversarial_robustness_min: 0.99
  audit_cycle_min_per_year: 4
  bias_metric_delta_max: 0.05
  explainability_score_min: 0.85
  model_drift_detection_mode: real-time
  privacy_protection_mechanism: DP/TEE
  risk_mitigation_efficiency_min: 0.9
  user_trust_index_min: 4.5
semantic:
  alternative_parents: []
