...
object:
  description: '[Entity] pumped-hydro-and-compressed-air-energy-storage-caes-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  audit_status_fidelity: Giant-Safe-v2026-Fidelity
  compression_mechanism: adiabatic_compression
  discharge_duration_threshold_hours: '> 10'
  potential_energy_formula: mgh
  ramp_rate_threshold_mw_min: '> 100'
  round_trip_efficiency_range: 70-80%
  storage_capacity_threshold_gwh: '> 10'
semantic:
  alternative_parents: []
