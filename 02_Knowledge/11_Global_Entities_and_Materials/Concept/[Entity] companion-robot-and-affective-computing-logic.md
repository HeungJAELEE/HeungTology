...
object:
  description: '[Entity] companion-robot-and-affective-computing-logic에 관한 고밀도 지능
    노드'
  object_type: Algorithm
  tier: 1
properties:
  battery_life_active_social: '> 8h'
  data_endpoint: companion-robot-emotional-engagement-and-response-accuracy-v2026
  emotion_accuracy_target: '> 90%'
  emotion_recognition_critical_threshold: 80.0%
  emotional_malfunction_probability_limit: 0.1%
  face_tracking_landmarks: 68-128
  social_norms_violation_rate_limit: < 0.01%
  social_response_warning_latency: 1000ms
  voice_tone_latency_target: < 500ms
semantic:
  alternative_parents: []
