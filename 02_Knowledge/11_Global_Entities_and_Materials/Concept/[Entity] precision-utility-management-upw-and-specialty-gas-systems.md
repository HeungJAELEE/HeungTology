...
lineage:
  ...
  original_hash: 9af5c1ba7e60a13f5bf4b5da213050417fc0d8dc5e1836499ad71d2c6ddaf408
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] precision-utility-management-upw-and-specialty-gas-systems에
    관한 고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  diagnostic_resistivity_critical_threshold: 18.1 MOmega*cm
  diagnostic_toc_warning_threshold: 2.0 ppb
  dissolved_oxygen_limit_ppb: '1'
  gas_pressure_delta_notice_threshold: '0.5'
  specialty_gas_purity_6n: 99.9999%
  toc_limit_ppb: '1'
  upw_microorganism_limit: < 1 per 100 mL
  upw_particle_limit: < 1 per mL (>0.05um)
  upw_resistivity_standard: 18.2 MOmega*cm
semantic:
  alternative_parents: []
