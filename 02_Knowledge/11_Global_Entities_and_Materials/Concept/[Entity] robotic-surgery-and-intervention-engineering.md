...
lineage:
  ...
  original_hash: 337e6accae11088df825e87dc3c9eb5c49c6600e5ae8dd9f9d91e3edddcaf2cf
metadata:
  date: '2026-05-16'
...
object:
  ...
  tier: 1
properties:
  collision_detection_threshold: < 5 ms
  dof_count_threshold: '> 7'
  force_sensitivity_threshold: < 10 mN
  haptic_delay_threshold: < 1 ms
  haptic_transmission_fidelity: '> 95%'
  pos_accuracy_threshold: < 10 um
  recovery_time_reduction_threshold: '> 50%'
  success_rate_threshold: '> 99.5%'
  tip_vibration_threshold: < 5 um
semantic:
  alternative_parents: []
