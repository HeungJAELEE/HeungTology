...
lineage:
  ...
  original_hash: 3d9ed0e3e75d7159a1aaed25b962c9afc31cf72e3a9012485506909f04d78477
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] supervisory-control-and-data-acquisition-scada-and-hmi-mechanics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  alarm_accuracy: 100%
  availability: '> 99.99%'
  client_capacity: '> 200 Users'
  cyber_integrity_level: LEVEL 4 (IEC)
  data_resolution: 32-64 bit
  data_throughput: '> 100,000 Tags/s'
  history_log_duration: '> 10 Years'
  ui_latency: < 100 ms
semantic:
  alternative_parents: []
