...
lineage:
  ...
  original_hash: 82dfe9279b350b7e0c4fe9e60bfc09ae9aa4017fbbf0281365252e946c205cf9
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] planetary-energy-budget-and-earth-radiation-balance-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  albedo_degradation_threshold: -0.01
  co2_concentration_threshold_ppm: 450
  effective_temperature_celsius: -18
  forcing_efficiency_wm2: 5.35
  net_energy_imbalance_wm2: 0.5-1.0
  ocean_heat_uptake_rate_threshold: 0.8
  planetary_albedo_alpha: 0.3
  radiative_imbalance_critical_threshold: 1.5
  solar_constant_s0: 1361
