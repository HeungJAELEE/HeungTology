...
object:
  description: '[Entity] lithium-ion-battery-and-electrochemistry-physics에 관한 고밀도
    지능 노드'
  object_type: Hardware
  tier: 1
properties:
  cell_voltage_v: 3.6-3.8
  charge_speed_80_percent_min: 15-30
  critical_temperature_threshold_c: 60.0
  cycle_life: 2000+
  deep_discharge_voltage_threshold_v: 2.5
  energy_density_wh_kg: 250+
  lithium_plating_index_threshold: 0.1
