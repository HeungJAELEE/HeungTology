...
lineage:
  ...
  original_hash: 94b3df85f5ec756fe35a754a11abc892a6f7ae42abc5630ff8bb324f7aaf0d8a
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] lithium-sulfur-battery-electrochemistry-and-polysulfide-shuttle-kinetics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  critical_anode_impedance_threshold: 100
  critical_capacity_retention_threshold: 0.7
  critical_polysulfide_solubility_threshold: 0.1
  critical_self_discharge_threshold_percent_day: 5.0
  li_ion_energy_density_wh_kg: 250
  min_sulfur_loading_mg_cm2: 5.0
  rd_target_capacity_mah_g_range: 800-1200
  rd_target_cycle_life_cycles_range: 300-1000
  rd_target_energy_density_wh_kg_range: 400-600
  target_voltage_v_range: 2.1-2.2
  theoretical_capacity_mah_g: 1675
  theoretical_cycle_life_cycles: 10000
  theoretical_energy_density_wh_kg: 2600
  theoretical_voltage_v: 2.15
semantic:
  alternative_parents: []
