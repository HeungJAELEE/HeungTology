...
lineage:
  ...
  original_hash: 4f096285c4d0108589e99c18ee6d3ac463fb8f4c92d2936e00588ed3d1854a6b
metadata:
...
object:
  description: '[Entity] stochastic-calculus-and-financial-derivative-pricing-logic에
    관한 고밀도 지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  arbitrage_opportunity_threshold: 0.05
  delta_hedge_error_threshold: 0.1
  implied_volatility_error_threshold: 0.02
  logic_base: stochastic_calculus_pde
  risk_measure_method: greeks
  stochastic_pricing_version: V6.3.7
semantic:
  alternative_parents: []
