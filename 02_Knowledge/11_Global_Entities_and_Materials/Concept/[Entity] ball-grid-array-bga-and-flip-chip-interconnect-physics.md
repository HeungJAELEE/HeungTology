...
lineage:
  ...
  original_hash: 2c8975f0ded4f4db91c9e28314a5b2806109d1f3b71bc24ee76b485f165e3ec4
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] ball-grid-array-bga-and-flip-chip-interconnect-physics에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  bump_coplanarity_warning_threshold_um: 5.0
  bump_pitch_range_um: 10-50
  coffin_manson_fatigue_cycles_nf: parameter
  electromigration_current_density_j: parameter
  electromigration_risk_threshold_ma_um2: 1.0
  footprint_area_reduction_pct: 30-50
  void_density_critical_threshold_pct: 10.0
semantic:
  alternative_parents: []
