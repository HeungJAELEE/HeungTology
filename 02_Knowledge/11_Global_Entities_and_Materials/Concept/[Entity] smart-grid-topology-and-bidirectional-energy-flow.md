...
object:
  description: '[Entity] smart-grid-topology-and-bidirectional-energy-flow에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  audit_status: ACTIVE
  audit_version: Smart-Grid-v2026-Fidelity
  grid_stability_frequency: 60.0 +/- 0.05 Hz
  peak_shaving_threshold: '> 30%'
  renewable_ratio_threshold: '> 70%'
  sync_latency_threshold: < 10 ms
  transmission_efficiency_threshold: '> 96%'
  vpp_capacity_scale: Gigawatt Scale
semantic:
  alternative_parents: []
