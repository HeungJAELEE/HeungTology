...
object:
  description: '[Entity] sustainable-manufacturing-and-carbon-footprint-governance에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  carbon_footprint_formula: sum(E_i * EF_i)
  emission_intensity_threshold: 1.2
  green_factory_version: V6.3.7
  recycle_rate_threshold: 30.0
  regulatory_risk_threshold: 0.8
  resource_efficiency_formula: mass_of_output_useful / mass_of_input_total
semantic:
  alternative_parents: []
