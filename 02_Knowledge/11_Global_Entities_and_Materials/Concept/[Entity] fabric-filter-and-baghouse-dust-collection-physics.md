...
lineage:
  ...
  original_hash: ba048ab575aed687031e7b3f5015e8bd8d6456838603c0a8b7e07dacaeb90eb7
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] fabric-filter-and-baghouse-dust-collection-physics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  delta_p_notice_threshold_pa: 100.0
  delta_p_warning_threshold_pa: 2500.0
  fabric_filter_efficiency_max_pct: 99.99
  fabric_filter_efficiency_min_pct: 99.0
  min_pulse_jet_air_pressure_bar: 4.0
  stack_opacity_critical_threshold_pct: 10.0
semantic:
  alternative_parents: []
