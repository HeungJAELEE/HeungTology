...
lineage:
  ...
  original_hash: 15c5ca9fc54c621b3b2cb1b69062c62d2e846abeb7b5474a45db1f3b764b5ce4
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] body-in-white-biw-and-automotive-stamping-mechanics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  accuracy_tolerance_mm: 0.5-1.0
  die_wear_limit_cycles: 500000
  forming_force_range_tons: 1000-10000
  material_type: AHSS
  material_usage_efficiency_pct: 60-80
  panel_thinning_critical_threshold_pct: 30.0
  springback_error_threshold_mm: 1.5
  strain_hardening_exponent: n
  takt_time_max_sec: 60
  weld_nugget_min_size_mm: 4.5
  weld_points_range: 3000-5000
semantic:
  alternative_parents: []
