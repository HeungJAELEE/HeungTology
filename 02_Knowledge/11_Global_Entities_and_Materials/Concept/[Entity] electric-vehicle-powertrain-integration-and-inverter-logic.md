...
object:
  description: '[Entity] electric-vehicle-powertrain-integration-and-inverter-logic에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  audit_status_id: EV-Drive-v2026-Fidelity
  conversion_efficiency_target: '> 98%'
  power_density_target: '> 30 kW/L'
  switching_frequency_range: 10-20 kHz
  torque_response_threshold: < 10 ms
semantic:
  alternative_parents: []
