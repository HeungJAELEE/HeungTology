...
lineage:
  ...
  original_hash: f240ee6fc89c8106c780291136c047e5a4d4e7f1d89e35dac281e25063b8b422
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] medical-imaging-and-diagnostic-systems-engineering에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  ai_false_negative_rate_threshold: 0.001
  ct_resolution_limit_mm: 0.5
  mri_resolution_limit_mm: 1.0
  oct_resolution_range_um: 1-10
  pet_resolution_range_mm: 4-6
  radiation_dose_limit_msv: 20.0
  snr_threshold: 20.0
  spatial_resolution_threshold_mm: 2.0
  ultrasound_resolution_range_mm: 1-5
semantic:
  alternative_parents: []
