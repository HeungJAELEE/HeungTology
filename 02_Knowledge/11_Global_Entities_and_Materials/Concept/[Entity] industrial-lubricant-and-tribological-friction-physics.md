...
object:
  description: '[Entity] industrial-lubricant-and-tribological-friction-physics에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  cleanliness_standard: ISO 4406
  iron_particle_critical_threshold_ppm: '50.0'
  lambda_ratio_full_lubrication_threshold: '3'
  oxidation_resistance_lifespan_hours: '10000'
  temperature_stability_range_c: -40-300
  thermal_overload_threshold_c: '100.0'
  viscosity_deviation_warning_threshold: '0.15'
  viscosity_index_range: 100-200
semantic:
  alternative_parents: []
