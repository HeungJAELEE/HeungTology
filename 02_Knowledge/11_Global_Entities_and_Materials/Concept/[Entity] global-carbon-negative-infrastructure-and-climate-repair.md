...
lineage:
  ...
  original_hash: 246499394ef2381b5c090ec940ab6663b82746cd6b94395dc350a8be4e564d98
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] global-carbon-negative-infrastructure-and-climate-repair에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  beccs_permanence_threshold: 1000
  biochar_permanence_range: 100-500
  dac_energy_cost_kwh_per_ton: 200-600
  dac_permanence_threshold: 10000
  delta_co2_formula: Emissions - (Natural Sinks + Engineered Sequestration)
  ecosystem_impact_warning_threshold: 0.4
  efficiency_critical_threshold_ton_mwh: 1.0
  energy_requirement_formula: m_dot * delta_h_adsorption
  leak_rate_rejection_threshold: 0.0001
  ocean_alk_permanence_threshold: 100000
semantic:
  alternative_parents: []
