...
object:
  description: '[Entity] blind-quantum-computing-and-private-delegated-computation에
    관한 고밀도 지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  communication_complexity_order: linear
  compute_fidelity_target_percent: 99
  information_leakage_tolerance_bits: 1.0e-10
  privacy_leakage_audit_threshold_bits: 1.0e-06
  trap_qubit_ratio_max_percent: 20
  trap_qubit_ratio_min_percent: 10
  verification_probability_min_ratio: 0.999
semantic:
  alternative_parents: []
