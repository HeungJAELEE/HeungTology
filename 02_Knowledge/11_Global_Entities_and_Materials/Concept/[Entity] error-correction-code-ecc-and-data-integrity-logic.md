...
lineage:
  ...
  original_hash: 31ce85e510de2d8642905cf7a7fb250174a54a895dc28341675a065b43fc9279
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] error-correction-code-ecc-and-data-integrity-logic에 관한 고밀도
    지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  bit_error_rate_threshold: 0.0001
  code_rate_formula: R = k/n
  ecc_reliability_pct: 99.999
  hamming_distance_formula: d_min >= 2t + 1
  max_correctable_errors_per_sec: 1000
  max_overhead_pct: 30.0
  parity_reliability_pct: 90.0
semantic:
  alternative_parents: []
