...
object:
  description: '[Entity] collaborative-robot-cobot-safety-and-force-torque-sensing에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  adaptive_speed_dist_mm: 1000
  collision_warning_threshold_n: 50
  data_endpoint: cobot-collision-force-and-response-time-log-v2026
  force_sensitivity_n: 0.1
  max_contact_force_n: 140
  payload_max_kg: 20
  payload_min_kg: 3
  proximity_hazard_dist_mm: 500
  response_time_ms: 100
  safe_mode_speed_mm_s: 250
  sensor_drift_monitoring_n: 0.1
semantic:
  alternative_parents: []
