...
lineage:
  ...
  original_hash: 907cc520335ed9d0cd7b25b1ea908ce5d8817ee7cd2524c49cff5e97ed009365
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] autonomous-nuclear-material-tracking-and-safety-audit에 관한
    고밀도 지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  anomaly_detection_latency_ms: 100.0
  audit_rate_target: 100.0
  decay_constant_calculation: ln(2) / half_life
  decay_formula: N(t) = N0 * e^(-lambda * t)
  isotopic_signature_threshold: 99.9
  storage_stability_years: 10000
  system_mtbf_hours: 50000
  tracking_fidelity_target: 100.0
semantic:
  alternative_parents: []
