...
lineage:
  ...
  original_hash: 7b3a2a6ffc548af38cb17ca5d6a5fb7fb702bdae2037919a0bd92dadbae0a09e
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] cyber-security-risk-management-and-mitigation에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  compliance_audit_score_threshold_percent: 95
  critical_vulnerability_threshold: 50
  mttd_threshold_hours: 2
  mttr_threshold_hours: 4
  patch_latency_threshold_hours: 24
  phishing_rate_threshold_percent: 1
  reject_employee_awareness_threshold: 70.0
  warning_incident_response_time_threshold_min: 120
semantic:
  alternative_parents: []
