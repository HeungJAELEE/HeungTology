...
object:
  description: '[Entity] multi-modal-robotic-perception-and-sensor-fusion-logic에 관한
    고밀도 지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  fusion_uncertainty_threshold: '0.5'
  modality_conflict_threshold: '0.7'
  occlusion_recovery_threshold_s: '2.0'
  sensor_time_drift_threshold_ms: '50'
semantic:
  alternative_parents: []
