...
lineage:
  ...
  original_hash: 278aca9c1a94aaf84fdf86b7a4f9416eb5282c3ea8f5a58a891faa8eeb561e70
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] smart-city-digital-twin-and-urban-operating-system에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  audit_status: active
  audit_version: Urban-OS-v2026-Fidelity
  data_privacy_fidelity: maximum
  decision_accuracy: '> 98%'
  emergency_response_reduction: -40%
  resource_efficiency: '> 30%'
  sensor_density: '> 10,000 per km^2'
  sync_latency: < 500 ms
  system_sync_status: full
semantic:
  alternative_parents: []
