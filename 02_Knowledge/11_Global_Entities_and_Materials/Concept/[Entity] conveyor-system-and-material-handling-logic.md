...
object:
  ...
  tier: 1
properties:
  conveyor_speed_range_m_s: 0.5 - 4.0
  euler_eytelwein_formula: T1 = T2 * exp(mu * theta)
  mass_flow_rate_formula: m_dot = rho * A * v
  motor_current_threshold_amp: 25.0
  sensor_blocked_threshold_sec: 10.0
  starvation_speed_threshold_m_s: 0.2
semantic:
  alternative_parents: []
