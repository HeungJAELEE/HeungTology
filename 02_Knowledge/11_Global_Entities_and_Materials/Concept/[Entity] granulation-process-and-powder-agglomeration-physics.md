...
lineage:
  ...
  original_hash: 8461856b00294445323fb29f11ab3cd1da2e0efcb0c8d286805c60efd241d081
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] granulation-process-and-powder-agglomeration-physics에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  capillary_force_formula: 2 * pi * R * gamma * cos(theta)
  granulated_product_version: V6.3.7
  minimum_moisture_threshold_pct: 1.0
  over_granulation_power_multiplier: 1.5
  potential_void_power_multiplier: 0.8
  stokes_number_formula: m * v / (R^2 * eta)
