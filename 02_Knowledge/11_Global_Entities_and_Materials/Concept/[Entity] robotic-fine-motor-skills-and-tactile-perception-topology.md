...
lineage:
  ...
  original_hash: bf564d7d9fefd38ae180f7a4cda0f96da61a7f2c00140523a30a4b5f238bd614
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] robotic-fine-motor-skills-and-tactile-perception-topology에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  grip_control_error: < 0.1 N
  hand_degrees_of_freedom: '> 20'
  manipulation_precision: < 10 um
  neural_coding_fidelity: high
  pressure_sensitivity: < 1 Pa
  slip_detection_latency: < 1 ms
  tactile_resolution: '> 100 nodes/cm2'
  texture_recognition_accuracy: '> 98%'
semantic:
  alternative_parents: []
