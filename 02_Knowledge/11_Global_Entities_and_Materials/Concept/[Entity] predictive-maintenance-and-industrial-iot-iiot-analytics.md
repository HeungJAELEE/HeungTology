...
object:
  description: '[Entity] predictive-maintenance-and-industrial-iot-iiot-analytics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  bearing_defect_frequency_formula: (n/2) * f_r * [1 +/- (d/D) * cos(alpha)]
  critical_anomaly_score_threshold: 0.8
  data_latency_notice_threshold_ms: 1000
  predictive_maintenance_cost_saving_min_pct: 30
  rul_formula: t_failure - t_current
  rul_prediction_error_warning_threshold_pct: 15.0
  spectral_peak_coherence_rejection_threshold: 0.7
semantic:
  alternative_parents: []
