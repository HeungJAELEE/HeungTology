...
object:
  description: '[Entity] in-situ-resource-utilization-isru-chemical-engineering에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  lunar_isru_yield_mass_ratio: 10-20
  lunar_oxygen_extraction_process: FeO + H2 -> Fe + H2O -> O2 + H2
  lunar_payload_save_mass_ratio: 1:10-20
  mars_isru_yield_per_day_range: 200-500
  mars_payload_save_mass_ratio: 1:30-50
  max_thermal_loss_threshold_watts: 500.0
  min_chemical_conversion_threshold_pct: 85.0
  min_leverage_ratio_threshold: 5.0
  min_resource_purity_threshold_pct: 99.5
  sabatier_reaction_stoichiometry: CO2 + 4H2 -> CH4 + 2H2O
semantic:
  alternative_parents: []
