...
object:
  ...
  tier: 1
properties:
  ductile_iron_elongation_pct_range: 5-18
  ductile_iron_tensile_strength_mpa_range: 400-800
  hall_petch_relationship: sigma_uts = sigma_0 + k * d^-1/2
  max_chill_depth_threshold_mm: 5.0
  max_pearlite_ratio_threshold_pct: 80.0
  min_nodularity_threshold_pct: 80.0
  min_residual_magnesium_threshold_pct: 0.03
  nodularity_index_formula: 4 * pi * R^2 / A
semantic:
  alternative_parents: []
