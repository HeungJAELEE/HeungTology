...
lineage:
  ...
  original_hash: 1c5dd973cd866af6d2a4af7585733819e842809bcd0a8bbd57b05c4980a0c53a
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] inventory-management-and-economic-order-quantity-eoq-logic에
    관한 고밀도 지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  data_source: real_time_erp_iot_data
  eoq_formula: sqrt(2 * D * S / H)
  eoq_management_version: 6.3.7
  overstock_notice_threshold: eoq * 3.0
  rop_formula: (daily_demand * lead_time) + safety_stock
  stockout_critical_threshold: demand * 1.0
semantic:
  alternative_parents: []
