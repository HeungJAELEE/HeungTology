...
lineage:
  ...
  original_hash: 8e98b99f9415b39fa0d7ca0c0656196cb0e085fb5789e55e9b1c4342724dc182
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] electromagnetic-casting-and-liquid-metal-shaping에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  critical_metal_level_mm: 150.0
  field_frequency_range_hz: 1000-5000
  lorentz_force_formula: J x B
  magnetic_pressure_formula: B^2 / (2 * mu_0)
  minimum_inductor_current_a: 500.0
  minimum_stirring_velocity_m_s: 0.1
  surface_roughness_warning_um: 50.0
semantic:
  alternative_parents: []
