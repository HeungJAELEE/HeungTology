...
lineage:
  ...
  original_hash: d69ba2c324b30a256571f86c6b98a9b8cdb1d4d4e6973817595a926c1e25034e
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] manufacturing-execution-system-mes-and-shop-floor-logic에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  cycle_time_jitter_threshold_multiplier: 1.1
  mes_version: V6.3.7
  oee_critical_threshold: 80.0
  oee_formula: A * P * Q
  standard_reference: ISA-95
  wip_bottleneck_threshold_multiplier: 1.2
  wip_formula: lambda * T
semantic:
  alternative_parents: []
