...
object:
  description: '[Entity] ball-milling-and-mechanochemical-synthesis-mechanics에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  ball_to_powder_ratio: 5:1-20:1
  energy_dose_kj_g: 1-10
  energy_index_reject_threshold: 5
  energy_index_warning_threshold: 50
  external_data_endpoint: ball-milling-energy-density-and-yield-log-v2026
  grinding_media_diameter_mm: 0.1-10
  milling_time_hrs: 1-100
  particle_size_threshold_um: 1.0
  prediction_accuracy_target: 0.99
  rotational_speed_rpm: 100-1000
semantic:
  alternative_parents: []
