...
object:
  description: '[Entity] 5g-6g-industrial-iot-and-massive-mimo-physics에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  beam_pointing_error_threshold_deg: 10.0
  connection_density_6g_devices_km2: 10000000
  critical_latency_threshold_ms: 10.0
  frequency_band_6g: terahertz
  latency_6g_ms: 0.1
  packet_loss_threshold: 0.001
  peak_data_rate_6g_gbps: 1000
  reliability_6g_percent: 99.99999
  warning_snr_threshold_db: 5.0
semantic:
  alternative_parents: []
