...
lineage:
  ...
  original_hash: 560006387c4bfe5811d3a256486818a213df1bae94cabf27a11aa057b1b509ec
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] carbon-fiber-and-composite-materials-engineering에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  critical_void_content_threshold_percent: '2.0'
  data_endpoint_id: carbon-fiber-tensile-strength-and-weight-reduction-v2026
  delamination_area_reject_threshold_mm2: '10.0'
  density_g_cm3: 1.5-2.0
  fiber_volume_percent: 55-65
  low_fiber_fraction_warning_percent: '50'
  target_void_content_percent: <1.0
  tensile_modulus_gpa: 230-600
  tensile_strength_mpa: 3500-7000
semantic:
  alternative_parents: []
