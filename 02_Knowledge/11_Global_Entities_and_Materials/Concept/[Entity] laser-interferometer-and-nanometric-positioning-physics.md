...
lineage:
  ...
  original_hash: 2a65ae7ee7d0c29c31cda00fba59fc9398bf163a58e38679e3ad35081ea6b614
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] laser-interferometer-and-nanometric-positioning-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  air_pressure_deviation_threshold_hpa: 50.0
  displacement_calculation: N * (lambda / 2)
  doppler_frequency_shift: 2v / lambda
  laser_accuracy_limit_ppb: 1.0
  laser_intensity_min_threshold_pct: 20.0
  laser_max_range_m: 80.0
  laser_max_speed_ms: 10.0
  laser_resolution_limit_nm: 0.01
  reference_air_pressure_hpa: 1013.25
  servo_error_max_threshold_nm: 1.0
semantic:
  alternative_parents: []
