...
object:
  description: '[Entity] ultrasonic-welding-physics-for-battery-tab-joining에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  critical_low_amplitude_threshold_um: 20.0
  material_thickness_foil_mm: 0.01-0.2
  max_process_speed_s: 0.5
  notice_long_cycle_threshold_ms: 400
  reject_insufficient_peel_strength_n: 50.0
  resonant_frequency_formula: (1 / (2 * L)) * sqrt(E / rho)
  ultrasonic_frequency_range_khz: 20-40
  warning_excessive_power_threshold_w: 2500.0
  welding_energy_formula: P * t_weld
semantic:
  alternative_parents: []
