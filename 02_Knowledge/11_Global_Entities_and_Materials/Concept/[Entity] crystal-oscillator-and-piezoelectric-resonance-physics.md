...
object:
  description: '[Entity] crystal-oscillator-and-piezoelectric-resonance-physics에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  critical_drift_threshold_ppm: 20.0
  crystal_oscillator_stability_ppm: 0.1 - 50
  crystal_q_factor_range: 10000 - 1000000
  overdrive_current_threshold_ma: 10.0
  piezoelectric_effect_formula: Vout = dij * sigma_jk
  rc_oscillator_stability_ppm: '10000'
  rc_q_factor: '100'
  series_resonance_frequency_formula: 1 / (2 * pi * sqrt(Lm * Cm))
  temperature_stability_threshold: 10.0
  warning_q_factor_threshold: 20000
semantic:
  alternative_parents: []
