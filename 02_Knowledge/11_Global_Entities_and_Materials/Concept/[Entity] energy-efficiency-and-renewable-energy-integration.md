...
lineage:
  ...
  original_hash: 2c980f8fb5fca4c0a9c63a694a868b07438f7f4468cfe07f535d50bf7b7d690a
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] energy-efficiency-and-renewable-energy-integration에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  eei_delta_e_formula: sum(P_base_i * T_i) - sum(P_eff_i * T_i)
  ems_energy_savings_range: 5-15%
  ems_payback_period_years: 1-2
  energy_intensity_unit: kWh/unit
  ess_payback_period_years: 7-10
  grid_independence_score_range: 0-1
  heat_recovery_energy_savings_range: 10-25%
  heat_recovery_payback_period_years: 3-5
  pue_target_value: 1.0
  solar_pv_payback_period_years: 5-7
  solar_pv_renewable_ratio_range: 20-50%
  vfd_inverter_energy_savings_range: 20-40%
  vfd_inverter_payback_period_years: 1-3
semantic:
  alternative_parents: []
