...
object:
  description: '[Entity] confectionery-manufacturing-and-sugar-crystallization에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  critical_boiling_temp_threshold_c: 140.0
  fondant_boiling_temp_range_c: 115-120
  fondant_crystal_size_um: 10-30
  fondant_water_content_percent: 10-12
  hard_candy_boiling_temp_range_c: 145-155
  hard_candy_water_content_percent: 1-3
  notice_viscosity_threshold_pa_s: 50.0
  reject_glass_transition_temp_c: 40.0
  supersaturation_ratio_formula: (C - C_sat) / C_sat
  warning_crystallization_count_threshold: 1000000
  water_activity_formula: ln(aw) = -(Mw * phi * nu * ms) / 1000
semantic:
  alternative_parents: []
