...
lineage:
  ...
  original_hash: 312578541ac762647c3546cd0aff845a2962b81904de2c2cc2b2728aecce5092
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] food-science-and-process-engineering-technology에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  cold_chain_storage_temp_c: 0-4
  commercial_sterility_log_reduction: '12'
  freeze_drying_temp_c: < -40
  nutrient_loss_threshold_pct: '30.0'
  pasteurization_holding_time_sec: '15'
  pasteurization_temp_c: '72'
  sterilization_holding_time_min: 15-20
  sterilization_temp_c: '121'
  uht_holding_time_sec: 2-5
  uht_temp_c: 135-150
semantic:
  alternative_parents: []
