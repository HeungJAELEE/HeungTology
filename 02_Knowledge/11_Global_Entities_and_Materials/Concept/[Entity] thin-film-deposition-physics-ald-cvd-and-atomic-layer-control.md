...
lineage:
  ...
  original_hash: 9669abb809552dc9d99eb87aefdeab7c53d3423be90763902b4219eb85101d88
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] thin-film-deposition-physics-ald-cvd-and-atomic-layer-control에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  audit_status_id: Atom-Grow-v2026-Fidelity
  film_density_target: MAXIMUM
  growth_rate_target: OPTIMAL
  precursor_purity_threshold: '> 99.9999%'
  step_coverage_threshold: '> 99%'
  system_resilience_target: High
  thickness_control_threshold: < 1 A
