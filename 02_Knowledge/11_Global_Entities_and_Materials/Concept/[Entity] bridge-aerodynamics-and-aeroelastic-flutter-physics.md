...
object:
  description: '[Entity] bridge-aerodynamics-and-aeroelastic-flutter-physics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  critical_wind_speed_max: 100.0
  critical_wind_speed_min: 80.0
  flutter_amplitude_threshold: 500.0
  flutter_equation_of_motion: m*h'' + c*h' + k*h = L_ae
  flutter_wind_threshold: 40.0
  min_damping_ratio: 0.01
  strouhal_frequency_formula: f_s = (St * V) / D
  viv_amplitude_threshold: 200.0
semantic:
  alternative_parents: []
