...
lineage:
  ...
  original_hash: d5e940333a659ade11e5a3763f7c3467713edc8aae7271667e3db6fa301c09f7
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] molecular-machines-and-synthetic-motor-topologies에 관한 고밀도
    지능 노드'
  object_type: Hardware
  tier: 1
properties:
  alkene_fatigue_life_cycles: 10^3-10^6
  alkene_rotational_speed_mhz: 1-1000
  alkene_size_nm: 1-5
  directionality_ratio_threshold: 0.95
  min_quantum_yield_threshold: 0.1
  min_rotational_frequency_mhz: 10.0
  min_transport_speed_nm_s: 1.0
  rotaxane_fatigue_life_cycles: 10^2-10^4
  rotaxane_size_nm: 5-20
semantic:
  alternative_parents: []
