...
object:
  description: '[Entity] global-satellite-internet-constellation-and-orbital-mesh에
    관한 고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  geo_altitude_km: 35786
  geo_latency_max_ms: 700
  geo_latency_min_ms: 500
  isl_error_rate_threshold: 0.01
  latency_performance_threshold_ms: 50
  leo_altitude_max_km: 1200
  leo_altitude_min_km: 340
  leo_altitude_nominal_km: 550
  leo_latency_max_ms: 40
  leo_latency_min_ms: 20
  orbital_deviation_threshold_m: 50
  spectral_interference_threshold_db: -80
semantic:
  alternative_parents: []
