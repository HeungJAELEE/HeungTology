...
object:
  description: '[Entity] vqe-variational-quantum-eigensolver-and-molecular-simulation에
    관한 고밀도 지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  chemical_precision: sub-angstrom
  energy_accuracy_threshold: < 1 kcal/mol
  hamiltonian_fidelity_threshold: '> 99.5%'
  mapping_method: Jordan-Wigner transformation
  molecular_size_limit_active_electrons: '> 50'
  optimization_principle: variational principle
  process_time_limit_h2o_co2: < 1 hr
  qubit_requirement_per_orbital: 1-2
semantic:
  alternative_parents: []
