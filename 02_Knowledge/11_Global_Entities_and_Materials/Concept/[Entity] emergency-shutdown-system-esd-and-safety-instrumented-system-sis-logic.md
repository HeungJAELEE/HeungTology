...
object:
  description: '[Entity] emergency-shutdown-system-esd-and-safety-instrumented-system-sis-logic에
    관한 고밀도 지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  pfd_avg_threshold_sil3: 0.001
  safety_response_time_threshold_s: 5.0
  sis_version: V6.3.7
  spurious_trip_limit_annual: 2.0
semantic:
  alternative_parents: []
