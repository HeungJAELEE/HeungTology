...
lineage:
  ...
  original_hash: 9f92d5b3bedb9d0b335e7d8d535cd892cddce188745872703fbb3eab420f04f6
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] metabolic-pathway-engineering-and-flux-balance-analysis에
    관한 고밀도 지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  biomass_growth_goal: maximize_initially
  carbon_balance_threshold: '> 95%'
  enzyme_activity_target: vmax_optimized
  flux_balance_equation: S * v = 0
  product_yield_threshold: '> 0.5 g/g'
  stoichiometry_representation: Matrix S
semantic:
  alternative_parents: []
