...
lineage:
  ...
  original_hash: e42b88472501aa7e27e8da3204f05aae7e3b96881de388a307b4b0e76d73f04d
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] recurrent-neural-neural-network-rnn-and-lstm-for-time-series에
    관한 고밀도 지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  basic_rnn_rmse: 10-20%
  basic_rnn_sequence_length: <50
  bi_lstm_rmse: 0.5-3%
  bi_lstm_sequence_length: 200-2,000
  gru_rmse: 2-6%
  gru_sequence_length: 50-500
  lstm_attn_rmse: <1%
  lstm_attn_sequence_length: 1,000+
  lstm_rmse: 1-5%
  lstm_sequence_length: 100-1,000
  multivariate_accuracy_improvement: 30%
semantic:
  alternative_parents: []
