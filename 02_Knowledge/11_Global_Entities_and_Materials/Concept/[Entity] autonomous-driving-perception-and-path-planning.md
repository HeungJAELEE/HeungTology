...
object:
  description: '[Entity] autonomous-driving-perception-and-path-planning에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  control_lateral_error_cm: 10
  critical_detection_confidence_threshold: 0.85
  data_log_endpoint: av-perception-accuracy-and-planning-latency-log-v2026
  detection_range_m: 250
  perception_latency_ms: 50
  planning_jerk_limit_m_s3: 2.0
  planning_update_rate_hz: 20
  reject_lateral_error_threshold_cm: 20
  warning_planning_latency_threshold_ms: 100
semantic:
  alternative_parents: []
