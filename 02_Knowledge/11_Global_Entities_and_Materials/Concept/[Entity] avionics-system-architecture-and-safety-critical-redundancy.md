...
object:
  description: '[Entity] avionics-system-architecture-and-safety-critical-redundancy에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  bit_flip_threshold: 100
  bus_load_threshold_pct: 80.0
  certification_standards:
  - DO-178C
  - DO-254
  data_bus_standard: AFDX
  os_type: RTOS
  redundancy_modes:
  - Triplex
  - Quadruplex
  reliability_target_dal_a: 1.0e-09
  sync_error_threshold_ms: 50.0
semantic:
  alternative_parents: []
