...
lineage:
  ...
  original_hash: 5f19daafaf7c73e66b6c7b1e05b89ab9d3dca8f426ac972b199317f38e141e2e
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] autonomous-underwater-vehicle-auv-and-sonar-navigation-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  auv_position_accuracy_m: 10-100
  hull_integrity_critical_state: CRITICAL
  min_sonar_snr_db: 10.0
  navigation_drift_threshold_m_hr: 50.0
  sonar_equation_formula: SNR = SL - TL - (NL - DI)
  speed_of_sound_formula: c = sqrt(K/rho)
semantic:
  alternative_parents: []
