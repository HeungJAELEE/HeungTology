...
lineage:
  ...
  original_hash: 8ab38ffdebcbec3d66d13f58449ed1e2709c8b114ec1a82435dc48e6fda32bd5
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] semiconductor-lithography-theory-and-nanometer-patterning에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  arf_immersion_max_na: 1.35
  arf_immersion_resolution_nm: 38
  arf_immersion_wavelength_nm: 193
  dof_margin_critical_factor: 2.0
  euv_high_na_max_na: 0.55
  euv_high_na_resolution_nm: 8
  euv_resolution_warning_threshold_nm: 20
  euv_std_max_na: 0.33
  euv_std_resolution_nm: 13
  euv_std_wavelength_nm: 13.5
  external_data_endpoint: lithography-resolution-and-k1-factor-log-v2026
  overlay_threshold_nm: 1.0
  throughput_threshold_wph: 150
semantic:
  alternative_parents: []
