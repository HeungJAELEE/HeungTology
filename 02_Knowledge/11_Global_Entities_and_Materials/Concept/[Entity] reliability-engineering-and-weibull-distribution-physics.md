...
object:
  description: '[Entity] reliability-engineering-and-weibull-distribution-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  infant_mortality_beta_threshold: 1.0
  mtbf_constant_failure_formula: 1/lambda
  mtbf_wearout_failure_formula: eta * gamma(1 + 1/beta)
  rapid_aging_beta_threshold: 4.0
