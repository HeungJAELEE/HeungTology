...
object:
  description: 피터 린치의 PEG 가치평가 모델 및 알렉산더 엘더의 트리플 스크린 기술적 퀀트 트레이딩 시스템을 융합하는 고밀도 금융
    지식 노드
  object_type: Algorithm
  tier: 2
properties:
  first_screen_metric: weekly_macd_histogram_slope
  gordon_growth_model_formula: P0 = D1 / (r - g)
  macd_slow_span: 26
  overbought_threshold: 70.0
  oversold_threshold: 30.0
  peg_formula: P/E / G
  second_screen_metric: daily_stochastic_k_percent
  stochastic_period: 14
  third_screen_trigger: previous_day_high_plus_1_tick
semantic:
  alternative_parents: []
