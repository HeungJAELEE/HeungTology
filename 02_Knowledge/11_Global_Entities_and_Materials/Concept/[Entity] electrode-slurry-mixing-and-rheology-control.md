...
object:
  ...
  tier: 1
properties:
  degassing_requirement: vacuum
  flow_index_n_limit: < 0.5
  particle_size_d50_limit_um: < 10
  power_law_model: tau = K * gamma^n
  shear_rate_range_s_inv: 1-1000
  solid_content_target_range_percent: 50-75
  viscosity_target_range_cp: 1000-10000
