...
object:
  description: '[Entity] green-hydrogen-electrolysis-and-water-splitting-thermodynamics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  ael_current_density_a_cm2: 0.2-0.4
  ael_efficiency_lhv_pct: 60-70
  ael_pressure_bar_max: 30
  ael_stack_life_hours: 60000-90000
  cell_voltage_formula: e_cell = e0 + eta_activation + eta_ohmic + eta_concentration
  critical_energy_threshold_kwh_kg: 55.0
  gibbs_free_energy_formula: delta_g = delta_h - t * delta_s
  min_renewables_curtailment_avoided_mwh: 10
  notice_degradation_threshold_uv_h: 5.0
  pem_current_density_a_cm2: 1.0-2.0
  pem_efficiency_lhv_pct: 70-80
  pem_pressure_bar_max: 70
  pem_stack_life_hours: 20000-40000
  warning_crossover_threshold_pct: 2.0
semantic:
  alternative_parents: []
