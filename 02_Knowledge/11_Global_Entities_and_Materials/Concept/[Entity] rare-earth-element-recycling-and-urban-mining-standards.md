...
lineage:
  ...
  original_hash: 86801e63d7a8120ac0606bc66cfa371f6d032956d66bcc8f079e944381510672
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] rare-earth-element-recycling-and-urban-mining-standards에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  collection_coverage_target: 0.8
  collection_coverage_tolerance: 0.05
  intelligence_version: V6.3.7
  mineral_purity_target: 0.999
  mineral_purity_tolerance: 0.0001
  recovery_efficiency_target: 0.95
  recovery_efficiency_tolerance: 0.01
  recycling_cost_reduction_target: 0.3
  recycling_cost_tolerance: 0.05
  separation_factor_formula: alpha_A/B = D_A/D_B
  toxicity_leakage_rate_threshold: 0.0
semantic:
  alternative_parents: []
