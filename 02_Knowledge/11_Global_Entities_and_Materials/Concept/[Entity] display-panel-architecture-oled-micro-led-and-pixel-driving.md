...
object:
  description: '[Entity] display-panel-architecture-oled-micro-led-and-pixel-driving에
    관한 고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  burnin_risk_threshold_hours: 30000
  micro_led_l80_lifetime_min_hours: 100000
  micro_led_peak_brightness_min_nits: 10000
  oled_driving_circuit_topology: 2T1C ~ 7T1C
  oled_l80_lifetime_max_hours: 50000
  oled_l80_lifetime_min_hours: 10000
  oled_peak_brightness_max_nits: 3000
  oled_peak_brightness_min_nits: 1000
  pixel_current_density_warning_threshold_am2: 100
  vth_shift_critical_threshold_mv: 100
semantic:
  alternative_parents: []
