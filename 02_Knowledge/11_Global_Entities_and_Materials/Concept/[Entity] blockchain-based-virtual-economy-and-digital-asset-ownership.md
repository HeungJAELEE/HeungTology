...
object:
  description: '[Entity] blockchain-based-virtual-economy-and-digital-asset-ownership에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  critical_wash_trade_index_threshold: 0.4
  detection_probability_percent: 99
  external_data_endpoint: virtual-asset-transaction-volume-and-liquidity-v2026
  low_liquidity_volume_threshold: 100
  max_minting_cost_usd_l2: 5
  max_transaction_latency_sec: 5
  metadata_storage_method: IPFS / Arweave
  royalty_rate_percent: 1.0 - 10.0
  token_standard: ERC-721 / 1155
  transaction_tracking_precision_percent: 0.1
semantic:
  alternative_parents: []
