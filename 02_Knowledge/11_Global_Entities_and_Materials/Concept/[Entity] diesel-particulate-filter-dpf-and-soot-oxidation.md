...
lineage:
  ...
  original_hash: 44d1f4d8f8a176887b98fb3a2271b8fd7add3c780b04df63bc28f0a096b7ad26
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] diesel-particulate-filter-dpf-and-soot-oxidation에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  ash_accumulation_limit_g: 50.0
  diff_pressure_limit_kpa: 15.0
  dpf_filtration_efficiency_max_percent: 99.9
  dpf_filtration_efficiency_min_percent: 95.0
  dpf_operating_temp_max_c: 700.0
  dpf_operating_temp_min_c: 200.0
  max_regeneration_temp_threshold_c: 850.0
  passive_regeneration_min_temp_c: 250.0
semantic:
  alternative_parents: []
