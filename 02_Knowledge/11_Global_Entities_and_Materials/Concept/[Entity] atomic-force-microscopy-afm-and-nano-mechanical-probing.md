...
object:
  description: '[Entity] atomic-force-microscopy-afm-and-nano-mechanical-probing에
    관한 고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  cantilever_spring_k_range_n_m: 0.01 ~ 100
  data_endpoint: afm-surface-roughness-and-nano-indentation-v2026
  force_sensitivity_limit_pn: < 10
  imaging_limit_noise_threshold_ratio: 0.1
  lateral_resolution_range_nm: 0.1 ~ 1.0
  mechanical_reliability_target: 0.99
  tip_condition_sharpness_threshold: 0.7
  tip_radius_range_nm: 2 ~ 10
  vertical_resolution_limit_nm: < 0.01
semantic:
  alternative_parents: []
