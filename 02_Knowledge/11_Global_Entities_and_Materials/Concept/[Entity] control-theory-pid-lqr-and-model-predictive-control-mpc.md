...
lineage:
  ...
  original_hash: 1723b1b68c98fe380642310c11e634c92d0bfbdc390439d4caebefbcc73d5de4
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] control-theory-pid-lqr-and-model-predictive-control-mpc에
    관한 고밀도 지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  actuator_effort_limit_n: 1000
  energy_efficiency_improvement_threshold: 0.3
  external_data_endpoint: control-algorithm-performance-and-error-minimization-v2026
  max_control_failure_probability: 0.001
  settling_time_threshold_multiplier: 1.5
  steady_state_error_limit: 0.05
semantic:
  alternative_parents: []
