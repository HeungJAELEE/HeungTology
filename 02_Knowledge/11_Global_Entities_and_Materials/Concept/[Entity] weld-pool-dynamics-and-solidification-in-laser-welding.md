...
object:
  description: '[Entity] weld-pool-dynamics-and-solidification-in-laser-welding에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  audit_status_fidelity: Melt-Flow-v2026-Fidelity
  cooling_rate_threshold: '> 10^5 K/s'
  fluid_velocity_threshold: '> 1.0 m/s'
  grain_size_max: < 10 um
  marangoni_number_status: HIGH
  porosity_max: < 0.1 %
  solidification_morphology_target: FINE EQUIAXED
