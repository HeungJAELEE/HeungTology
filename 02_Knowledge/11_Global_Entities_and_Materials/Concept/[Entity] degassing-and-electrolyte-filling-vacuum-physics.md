...
lineage:
  ...
  original_hash: c0c5409baf54cd3e27bf6e95e7a7925bbf3e886bf25af4d35eb6d519d6319409
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] degassing-and-electrolyte-filling-vacuum-physics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  critical_dosage_error_pct: 0.5
  critical_moisture_ppm: 50
  degas_pressure_bar_max: 2.0
  degas_pressure_bar_min: 0.5
  filling_precision_pct: 0.2
  insufficient_vacuum_threshold_mbar: 1.0
  minimum_wetting_saturation_pct: 95.0
  moisture_threshold_ppm: 20
  vacuum_level_target_mbar: 0.1
  wetting_time_hours_max: 48
  wetting_time_hours_min: 24
semantic:
  alternative_parents: []
