...
object:
  description: '[Entity] bio-security-2-0-and-autonomous-pathogen-containment에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  containment_breach_threshold_pa: -30
  countermeasure_design_time_max_hrs: 24
  countermeasure_design_time_tolerance_hrs: 2
  detection_speed_target_hrs: 4
  detection_speed_tolerance_hrs: 0.5
  hepa_rate_min_changes_hr: 15
  hepa_rate_tolerance_changes_hr: 1
  negative_pressure_max_pa: -50
  negative_pressure_min_pa: -100
  negative_pressure_tolerance_pa: 5
  r0_forecast_accuracy_target_pct: 95
  r0_forecast_accuracy_tolerance_pct: 2
  sequence_homology_risk_threshold: 0.9
  target_pandemic_probability_max_pct: 0.01
semantic:
  alternative_parents: []
