...
lineage:
  ...
  original_hash: 88553ac7e8ca9bae97c9f59b3ba8c7f1b9b170dc5c2b39cc3d537d7a3e7b0924
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] electrolyte-formulation-and-ion-transport-kinetics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  additive_concentration_range: 1-5%
  audit_status_reference: Fluid-Flow-v2026-Fidelity
  flash_point_threshold: '> 150 °C'
  ion_transfer_fraction_threshold: '> 0.5'
  ionic_conductivity_threshold: '> 12 mS/cm'
  viscosity_threshold: < 5 cP
  voltage_window_threshold: '> 4.8 V'
semantic:
  alternative_parents: []
