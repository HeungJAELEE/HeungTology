...
object:
  description: '[Entity] brain-inspired-computing-and-synaptic-plasticity-mechanics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  energy_per_op_target_fj: 10
  energy_warning_threshold_fj: 100
  human_brain_power_watts: 20
  inference_latency_target_ms: 1
  stdp_stagnation_threshold: 0.7
  synaptic_density_target_per_mm2: 1000000000
  target_learning_error_rate: 0.01
  weight_precision_min_bits: 8
semantic:
  alternative_parents: []
