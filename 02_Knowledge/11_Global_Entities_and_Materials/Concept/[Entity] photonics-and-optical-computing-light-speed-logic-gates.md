...
lineage:
  ...
  original_hash: 8120631b4de554f51b921004adb0d56cdb05389e470dc6b7fca6256c87a884c4
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] photonics-and-optical-computing-light-speed-logic-gates에
    관한 고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  bandwidth_density_target: '> 100 Tbps/mm^2'
  bandwidth_density_tolerance: 2 Tbps
  energy_per_bit_target: < 1 fJ/bit
  energy_per_bit_tolerance: 0.1 fJ
  extinction_ratio_target: '> 25 dB'
  extinction_ratio_tolerance: 1 dB
  insertion_loss_target: < 0.5 dB
  insertion_loss_tolerance: 0.05 dB
  mzi_output_intensity_formula: I_out = (I_in / 2) * (1 + cos(delta_phi))
  switching_speed_target: < 100 fs
  switching_speed_tolerance: 5 fs
semantic:
  alternative_parents: []
