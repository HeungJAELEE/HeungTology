...
lineage:
  ...
  original_hash: 723268c99731221dba12eaa32fcfe5355a968d2ccb0eee3aa6781e9b4cfdd0dd
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] ion-implantation-and-dopant-diffusion-profiles-in-silicon에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  anneal_temperature_celsius: 900 ~ 1100
  dose_uniformity_critical_threshold_pct: 1.0
  high_energy_dose_atoms_cm2: 10^11 ~ 10^14
  high_energy_implant_energy_range_kev: 100 ~ 3000
  high_energy_projected_range_nm: 200 ~ 2000
  high_energy_throughput_wafers_per_hr: 50 ~ 100
  junction_depth_deviation_warning_threshold_nm: 5.0
  lattice_repair_defect_density_reject_threshold: 1000
  low_energy_dose_atoms_cm2: 10^11 ~ 10^16
  low_energy_implant_energy_range_kev: 0.2 ~ 10
  low_energy_projected_range_nm: 5 ~ 50
  low_energy_throughput_wafers_per_hr: 100 ~ 200
semantic:
  alternative_parents: []
