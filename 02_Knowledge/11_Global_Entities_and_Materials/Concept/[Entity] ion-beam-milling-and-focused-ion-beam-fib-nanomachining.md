...
object:
  description: '[Entity] ion-beam-milling-and-focused-ion-beam-fib-nanomachining에
    관한 고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  accel_voltage_max_kv: 30
  accel_voltage_min_kv: 1
  beam_current_max_na: 100
  beam_current_min_pa: 1
  beam_current_stability_threshold_pct: 1.0
  beam_resolution_max_nm: 5
  beam_resolution_min_nm: 2
  ion_source_lifetime_threshold_h: 100
  max_amorphous_layer_thickness_nm: 20
  milling_rate_max_um3_per_min: 50
  milling_rate_min_um3_per_min: 0.1
semantic:
  alternative_parents: []
