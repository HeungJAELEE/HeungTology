...
object:
  description: '[Entity] industrial-safety-standards-and-machine-guarding-logic에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  hand_speed_k_m_s: 1.6
  max_dual_channel_sync_error_ms: 100
  max_measured_stop_time_ms: 500
  max_test_interval_h: 24
  min_diagnostic_coverage_pct: 90.0
  p_le_pfh_d_range: 10^-8 to 10^-7
  pl_c_pfh_d_range: 10^-6 to 3*10^-6
  pl_d_pfh_d_range: 10^-7 to 10^-6
semantic:
  alternative_parents: []
