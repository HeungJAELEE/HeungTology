...
lineage:
  ...
  original_hash: 5c6570bc19ead292eda19574c30bc82360e64725589828de8afad97ad4abb91c
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] electromagnetic-pulse-emp-and-high-power-microwave-defense에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  emp_waveform_equation: E(t) = E_0 (e^{-alpha t} - e^{-beta t})
  ground_impedance_notice_ohm: 1.0
  hemp_e1_peak_field_strength_v_m: 50000
  hpm_frequency_coverage_ghz: 40
  hpm_power_density_threshold: 1000.0
  induced_surge_equation: I_induced = (A/R)(dB/dt)
  se_critical_threshold_db: 80.0
  shielding_se_military_max_db: 120
  shielding_se_military_min_db: 80
  surge_clamping_warning_v: 1000.0
semantic:
  alternative_parents: []
