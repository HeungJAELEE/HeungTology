...
object:
  description: '[Entity] cryptography-and-secure-communication-protocols에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  aes_min_key_size_bits: 256
  cert_expiry_warning_days: 7
  deprecated_protocols:
  - TLS 1.0
  - TLS 1.1
  - SSLv3
  ecc_min_key_size_bits: 256
  min_secure_entropy_bits: 128
  rsa_min_key_size_bits: 3072
  sha_min_key_size_bits: 256
  tls_standard_version: '1.3'
semantic:
  alternative_parents: []
