...
lineage:
  ...
  original_hash: 2c8bef1da82a5476ae78704187a3f554eb3e3275acaaf44f720bbe26fddf29a2
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] ceramic-capacitor-and-mlcc-manufacturing-physics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  acoustic_echo_defect_threshold: 0.2
  dielectric_thickness_breakdown_limit_um: 0.4
  insulation_resistance_notice_threshold_ohm: 1000000000.0
  layer_misalignment_warning_threshold_nm: 500.0
  mlcc_dielectric_thickness_max_um: 1.0
  mlcc_dielectric_thickness_min_um: 0.5
  mlcc_layer_count_max: 1000
  mlcc_layer_count_min: 300
  sintering_shrinkage_precision_percent: 0.1
semantic:
  alternative_parents: []
