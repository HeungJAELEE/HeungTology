...
lineage:
  ...
  original_hash: f580eecc5019c43a42ea5f5eb55f40db4059558106bc3f676060439ce4a73c70
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] finite-element-analysis-fea-and-structural-mechanics-logic에
    관한 고밀도 지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  fea_simulation_version: V6.3.7
  max_mesh_convergence_error: 0.1
  min_factor_of_safety: 1.2
  stiffness_matrix_equation: '[K]{u} = {F}'
  von_mises_stress_formula: sqrt(((s1-s2)^2 + (s2-s3)^2 + (s3-s1)^2)/2)
  yield_strength_threshold_ratio: 0.8
semantic:
  alternative_parents: []
