...
object:
  description: '[Entity] precision-spindle-dynamics-and-low-runout-mechanisms에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  asynch_error_threshold: < 5 nm
  audit_status_fidelity: Spin-Truth-v2026-Fidelity
  axial_stiffness_n_um: '> 200 N/um'
  dynamic_balance_grade: G0.4
  max_speed_rpm: '> 50,000'
  synchro_error_threshold: < 10 nm
  total_runout_threshold: < 100 nm
semantic:
  alternative_parents: []
