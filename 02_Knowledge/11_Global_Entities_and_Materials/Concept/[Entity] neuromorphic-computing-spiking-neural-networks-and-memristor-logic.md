...
lineage:
  ...
  original_hash: 788d6132010090350c997c2bcf376b511e263bf7b0792aafcfc52ea7f3e08d93
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] neuromorphic-computing-spiking-neural-networks-and-memristor-logic에
    관한 고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  brain_power_consumption: 20W
  device_endurance_cycles: '> 10^12'
  energy_per_synaptic_update_target: < 10 fJ
  energy_per_synaptic_update_tolerance: ± 1 fJ
  membrane_dynamics_model: tau_m * dVm/dt = -(Vm - Vrest) + R * Isyn(t)
  memristor_on_off_ratio_target: '> 100'
  memristor_on_off_ratio_tolerance: ± 10
  neuron_density_target: '> 10^5 /mm^2'
  neuron_density_tolerance: ± 5 %
  spike_latency_limit: < 1 ns
  spike_latency_tolerance: ± 0.1 ns
  target_power_reduction_ratio: 1/1000
semantic:
  alternative_parents: []
