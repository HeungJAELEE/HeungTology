...
object:
  description: '[Entity] micro-led-display-architecture-and-mass-transfer-technology에
    관한 고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  brightness_max_cd_m2: 1000000
  brightness_min_cd_m2: 10000
  longevity_min_hours: 100000
  max_bonding_resistance_ohm: 100
  max_pixel_dead_count: 5
  max_placement_error_um: 1.5
  min_redundancy_activation_rate: 0.99
  pixel_size_max_um: 50
  response_time_max_ms: 0.001
  transfer_speed_min_chips_per_hour: 100000000
semantic:
  alternative_parents: []
