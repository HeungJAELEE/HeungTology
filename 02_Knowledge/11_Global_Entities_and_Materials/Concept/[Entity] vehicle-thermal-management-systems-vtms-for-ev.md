...
lineage:
  ...
  original_hash: 5da53d916ff751e5c844a53398f53152fb80019777fb23c6544fd91f39ce1fe1
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] vehicle-thermal-management-systems-vtms-for-ev에 관한 고밀도 지능
    노드'
  object_type: Hardware
  tier: 1
properties:
  critical_battery_temp_c: '45.0'
  glycol_water_ratio_tolerance: '0.1'
  heating_cop_legacy: '1.0'
  heating_cop_modern_range: 2.0-4.0
  min_heat_pump_cop_threshold: '1.5'
  min_valve_position_threshold: '0.9'
  refrigerant_types: R134a, R1234yf, R744
  target_glycol_water_ratio: '0.5'
  winter_range_loss_legacy_pct: 30-40
  winter_range_loss_modern_pct: 10-20
semantic:
  alternative_parents: []
