...
object:
  description: '[Entity] jig-and-fixture-design-and-kinematic-constraint-logic에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  clamping_stability_formula: f_clamping > f_cutting / mu
  kinematic_constraint_principle: 3-2-1
  positioning_error_critical_threshold_um: 10.0
  repeatability_precision_mm: 0.001_to_0.01
  tool_clearance_minimum_threshold_mm: 2.0
