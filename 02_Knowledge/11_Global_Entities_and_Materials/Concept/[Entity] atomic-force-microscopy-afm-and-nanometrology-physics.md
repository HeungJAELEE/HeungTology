...
object:
  description: '[Entity] atomic-force-microscopy-afm-and-nanometrology-physics에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  adhesion_force_rejection_threshold_nn: 10.0
  afm_xy_resolution_max_nm: 1.0
  afm_xy_resolution_min_nm: 0.1
  afm_z_resolution_max_nm: 0.01
  cantilever_deflection_delta_z: delta_z
  hamaker_constant_h: H
  noise_critical_threshold_pm: 50.0
  scanner_linearity_threshold_pct: 99.0
  separation_distance_z: z
  spring_constant_k: k
  tip_bluntness_threshold_nm: 20.0
  tip_radius_r: R
semantic:
  alternative_parents: []
