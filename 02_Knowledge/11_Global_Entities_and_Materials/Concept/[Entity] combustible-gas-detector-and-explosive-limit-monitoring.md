...
lineage:
  ...
  original_hash: eb5f7d1bc5db5d1c25051e8ae02483597b21a3d0d8d5d745527f7d88b354580a
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] combustible-gas-detector-and-explosive-limit-monitoring에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  calibration_interval_days: 180
  catalytic_sensor_life_years_range: 2-3
  drift_threshold_pct: 5.0
  lel_critical_threshold_pct: 25.0
  ndir_sensor_life_years_range: 5-10
  t90_response_time_threshold_sec: 30.0
semantic:
  alternative_parents: []
