...
object:
  ...
  tier: 1
properties:
  ael_current_density: 0.2-0.4 A/cm2
  ael_temp_range: 60-90C
  aem_current_density: 0.4-0.8 A/cm2
  aem_temp_range: 40-60C
  iridium_reduction_threshold: 90%
  pem_current_density: 1.0-2.0 A/cm2
  pem_dynamic_response_range: 10-100%
  pem_temp_range: 50-80C
  soec_current_density: 0.5-1.5 A/cm2
  soec_temp_range: 700-850C
  target_specific_energy_consumption: 45-55 kWh/kg
semantic:
  alternative_parents: []
