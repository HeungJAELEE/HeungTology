...
object:
  description: '[Entity] autonomous-spacecraft-navigation-and-deep-space-autonomy에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  attitude_precision_deg: 0.001
  comm_latency_mars_min: 20
  delta_v_precision_m_s: 0.01
  fault_recovery_time_sec: 1
  navigation_log_endpoint: spacecraft-navigation-precision-and-fuel-margin-log-v2026
  positional_accuracy_km: 1
  radiation_bit_flip_warning_threshold: 5
  target_mission_failure_probability: 0.001
  trajectory_drift_critical_threshold_km: 10.0
semantic:
  alternative_parents: []
