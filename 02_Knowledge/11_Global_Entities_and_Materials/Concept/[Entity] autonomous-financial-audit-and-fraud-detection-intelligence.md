...
object:
  description: '[Entity] autonomous-financial-audit-and-fraud-detection-intelligence에
    관한 고밀도 지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  aml_cluster_size_threshold: 50
  amount_deviation_multiplier: 10
  audit_coverage_target_percent: 100
  false_positive_rate_target_percent: 0.1
  false_positive_rate_tolerance_percent: 0.02
  fraud_detection_precision_target_percent: 98
  fraud_detection_precision_tolerance_percent: 0.5
  graph_depth_target_hops: 5
  risk_score_critical_threshold: 0.8
  risk_score_warning_threshold: 0.5
  transaction_latency_target_ms: 50
  transaction_latency_tolerance_ms: 5
  velocity_threshold_per_hour: 5
semantic:
  alternative_parents: []
