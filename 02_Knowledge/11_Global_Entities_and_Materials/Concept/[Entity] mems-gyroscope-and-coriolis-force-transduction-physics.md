...
lineage:
  ...
  original_hash: f2154b3f33eb2b0e6bfaeea70533ad20fb03120616bb147b279b28e63661c885
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] mems-gyroscope-and-coriolis-force-transduction-physics에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  bias_instability_tactical_range_deg_hr: 1.0 - 10.0
  coriolis_force_formula: -2m(Omega x v)
  drive_mode_oscillation_formula: A sin(omega_d * t)
  imu_axes: 6
  mems_gyroscope_version: V6.3.7
  quadrature_error_threshold_mv: 50.0
  resonant_frequency_mismatch_threshold_hz: 100.0
  shock_resistance_max_g: 10000
semantic:
  alternative_parents: []
