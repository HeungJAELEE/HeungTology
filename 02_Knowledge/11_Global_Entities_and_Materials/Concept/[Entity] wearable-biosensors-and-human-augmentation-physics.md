...
object:
  description: '[Entity] wearable-biosensors-and-human-augmentation-physics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  biocompatibility_grade: Grade VI
  breathability_threshold_mg_cm2h: 20
  data_encryption_standard: Military Grade
  intent_prediction_lead_time_ms: 50
  intent_prediction_probability: 0.98
  interface_impedance_limit_kohm: 10
  min_bending_radius_mm: 1
