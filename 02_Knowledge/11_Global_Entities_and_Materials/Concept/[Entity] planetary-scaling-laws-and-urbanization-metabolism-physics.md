...
object:
  description: '[Entity] planetary-scaling-laws-and-urbanization-metabolism-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  infrastructure_underutilization_threshold: 0.7
  innovation_stagnation_threshold: 1.0
  metabolic_inefficiency_threshold: 1.1
  scaling_exponent_corporate_lifespan: 0.9
  scaling_exponent_sub_linear: 0.85
  scaling_exponent_super_linear: 1.15
semantic:
  alternative_parents: []
