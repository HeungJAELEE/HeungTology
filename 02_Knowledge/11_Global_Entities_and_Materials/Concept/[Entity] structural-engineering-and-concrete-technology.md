...
lineage:
  ...
  original_hash: 457120a0e5ae43bdcf09686ecb99740b3c19e04fe8921645a11a76942acbe360
metadata:
  date: '2026-05-16'
  domain: 11_Global_Entities_and_Materials
  id: '[[[Entity] structural-engineering-and-concrete-technology]]'
  last_updated: '2026-05-17T22:59:20+09:00'
  project: Vault_Modernization
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: '[Entity] structural-engineering-and-concrete-technology에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  carbonation_coefficient_k: '1.5'
  collapse_probability_threshold: 1e-6
  concrete_compressive_strength_range: 40-120 MPa
  concrete_modulus_of_elasticity_formula: 4700 * sqrt(f'_c)
  concrete_poissons_ratio: '0.20'
  data_endpoint: road-bridge-structural-health-and-load-test-log-v2026
  max_deflection_ratio: 1/360
  standard_cover_depth: 40.0 mm
  steel_rebar_tensile_strength_range: 400-600 MPa
semantic:
  alternative_parents: []
