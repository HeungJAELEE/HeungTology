...
object:
  description: '[Entity] industrial-internet-of-things-iiot-and-edge-computing-mechanics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  bandwidth_savings_percent_min: 90.0
  battery_life_yr_min: 5.0
  comm_reliability_percent_min: 99.999
  data_reduction_ratio_min: '100:1'
  edge_inference_speed_fps_min: 60.0
  min_reduction_ratio_default: 50.0
  node_density_per_m2_min: 1000
  proc_latency_limit_ms: 5.0
  sync_latency_ms_limit: 10.0
semantic:
  alternative_parents: []
