...
lineage:
  ...
  original_hash: 470d97be17187adf9b0c0219496441334987942484976800becdc9a5ac03fdb0
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] customer-experience-cx-and-journey-mapping-logic에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  ces_target_threshold: 2.0
  churn_rate_target_percent: 2.0
  churn_risk_threshold_percent: 20.0
  clv_components:
  - annual_contribution_margin
  - retention_rate
  - discount_rate
  csat_target_threshold: 4.5
  fcr_target_percent: 85
  friction_warning_threshold: 0.6
  nps_critical_threshold: 30.0
  nps_target_threshold: 50
semantic:
  alternative_parents: []
