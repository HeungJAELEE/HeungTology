...
object:
  description: '[Entity] medical-device-manufacturing-and-regulatory-logic에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  cleanroom_class_range: 5 to 8
  cleanroom_class_standard: ISO 14644-1
  iec_62304_classes: A, B, C
  iso_10993_requirement: Non-toxic, Non-pyrogenic
  iso_13485_standard: ISO 13485:2016
  logic_fidelity_engine_capa_threshold: 5
  logic_fidelity_engine_traceability_threshold: 0.999
  risk_score_formula: Severity * Probability
  rpn_formula: S * P * Detectability
  sal_target: 1.0e-06
  udi_tracking_target: 1.0
  yield_validated_formula: P_IQ * P_OQ * P_PQ
semantic:
  alternative_parents: []
