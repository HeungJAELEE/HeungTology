...
lineage:
  ...
  original_hash: 46064103d31360b8f75d5751eab4c4fb0c83c750805667d6a7c7ed1f737453b9
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] alloy-design-and-computational-thermodynamics-calphad에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  calphad_version: V6.3.7
  gibbs_free_energy_formula: G = sum x_i G_i^0 + RT sum x_i ln x_i + G^ex
  max_gibbs_energy_error_threshold: 0.05
  max_impurity_tolerance_ppm: 50
  min_phase_fraction_threshold: 0.3
  min_solidus_temperature_c: 1200.0
  phase_transformation_condition: delta_G <= 0
semantic:
  alternative_parents: []
