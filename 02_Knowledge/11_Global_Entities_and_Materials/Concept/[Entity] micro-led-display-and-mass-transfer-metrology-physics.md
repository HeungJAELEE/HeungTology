...
lineage:
  ...
  original_hash: 45cfef6eeb5ff2ad0fd2b3d12cd56bdec07284bedbe028bcc31324323ffc4ab4
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] micro-led-display-and-mass-transfer-metrology-physics에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  brightness_micro_led_nits: 10000
  dead_pixel_threshold: 100
  delta_x: placement error
  misplacement_error_threshold_um: 2.0
  n_success: successfully placed chips
  n_total: total number of chips
  p_transfer: transfer yield ratio
  sigma: standard deviation of placement error
  target_yield_six_nines: 0.999999
semantic:
  alternative_parents: []
