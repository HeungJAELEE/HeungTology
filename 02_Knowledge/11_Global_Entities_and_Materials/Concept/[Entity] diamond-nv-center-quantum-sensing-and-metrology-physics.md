...
object:
  description: '[Entity] diamond-nv-center-quantum-sensing-and-metrology-physics에
    관한 고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  coherence_time_t2_us: 100-1000
  fidelity_engine_contrast_threshold_pct: 5.0
  fidelity_engine_noise_threshold_nt: 10.0
  fidelity_engine_t2_threshold_us: 10.0
  gyromagnetic_ratio_mhz_mt: 28
  laser_power_excitation_mw: 10-100
  magnetic_sensitivity_target_nt_sqrt_hz: 1
  spatial_resolution_nm: 10-100
  temperature_sensitivity_precision_mk_sqrt_hz: 10
