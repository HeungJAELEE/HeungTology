...
lineage:
  ...
  original_hash: ead04949131f87a8d41a03f1416a044e2929c04d18b82364172d915981bef660
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] asynchronous-motor-and-variable-frequency-drive-vfd-control에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  critical_slip_threshold: 0.1
  dol_start_current_range_pct: 600-800
  high_thd_threshold_pct: 5.0
  high_vibration_threshold_mm_s: 7.0
  low_frequency_threshold_hz: 10.0
  slip_ratio_formula: s = (n_s - n) / n_s
  synchronous_speed_formula: n_s = (120 * f) / P
  vfd_energy_saving_range_pct: 30-60
  vfd_start_current_pct: '100'
  vfd_version: 6.3.7
semantic:
  alternative_parents: []
