...
object:
  description: '[Entity] neutral-atom-quantum-computing-and-rydberg-blockade에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  blockade_radius_threshold_um: 5.0
  filling_fraction_threshold_pct: 98.0
  gate_error_rate_threshold: 0.05
  neutral_atom_gate_fidelity_range:
  - 0.99
  - 0.995
  neutral_atom_qubit_count_range:
  - 256
  - 1000
  tweezer_position_error_threshold_nm: 50
  vdw_interaction_power_law_exponent: 6
semantic:
  alternative_parents: []
