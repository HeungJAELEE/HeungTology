...
object:
  description: '[Entity] just-in-time-jit-and-lean-manufacturing-logistics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  batch_size_strategy: single-piece flow
  changeover_target: minutes
  inventory_strategy: pull_system
  lean_version: V6.3.7
  littles_law_formula: L = lambda * W
  optimal_synchronization_threshold: 1.0
  takt_time_formula: Available Work Time / Customer Demand
  waste_tolerance: zero
semantic:
  alternative_parents: []
