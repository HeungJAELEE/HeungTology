...
lineage:
  ...
  original_hash: c18bf749ade8abc1eb6bfc16aeca6776278352ca95ca46e68bc59d437508af9f
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] cast-iron-metallurgy-and-graphitization-physics에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  carbon_equivalent_formula: '%C + (%Si + %P)/3'
  critical_ce_threshold: 3.5
  ductile_iron_elongation_pct: 2-20
  ductile_iron_tensile_strength_mpa: 400-800
  gray_cast_iron_elongation_limit_pct: < 1
  gray_cast_iron_tensile_strength_mpa: 150-300
  high_pearlite_threshold_pct: 90.0
  minimum_nodularity_threshold_pct: 80.0
  nucleation_rate_formula: A * exp(-delta_G_star / (k * T))
  optimal_carbon_equivalent_target: 4.3
  ultrasonic_void_signal_threshold: 0.3
semantic:
  alternative_parents: []
