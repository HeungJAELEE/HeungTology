...
object:
  description: '[Entity] semiconductor-packaging-and-system-in-package-sip-mechanics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  bump_yield_threshold_pct: 99.5
  junction_temp_critical_c: 105.0
  warpage_threshold_um: 150.0
semantic:
  alternative_parents: []
