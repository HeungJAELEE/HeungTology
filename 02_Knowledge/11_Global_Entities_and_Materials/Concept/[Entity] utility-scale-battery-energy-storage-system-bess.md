...
object:
  description: '[Entity] utility-scale-battery-energy-storage-system-bess에 관한 고밀도
    지능 노드'
...
properties:
  ...
  cycle_life_min: '5000'
  insulation_resistance_threshold: '10'
  ramp_rate_min_threshold: '100'
  response_time_max: 100ms
  rte_max: 90%
  rte_min: 85%
  soh_warning_threshold: '80.0'
  thermal_runaway_temp_threshold: '55.0'
semantic:
  alternative_parents: []
