...
lineage:
  ...
  original_hash: bf0131ea923726a1de1b156e9168917cbf9c1e1df4e639b61729c2c37e96d6aa
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] autonomous-vehicle-v2x-coordination-and-safety-standards에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  asil_d_error_rate_threshold: 1.0e-08
  comm_range_m_max: 1000
  comm_range_m_min: 300
  comm_range_tolerance_m: 50
  emergency_evasion_response_limit_s: 0.02
  emergency_response_ttc_ratio: 0.8
  external_data_endpoint: v2x-latency-and-safety-critical-message-success-v2026
  functional_safety_grade: ASIL-D
  max_coordination_velocity_kmh: 150
  message_reliability_min_pct: 99.9
  message_reliability_tolerance_pct: 0.05
  v2x_latency_max_ms: 20
  v2x_latency_tolerance_ms: 5
semantic:
  alternative_parents: []
