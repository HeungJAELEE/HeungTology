...
object:
  description: '[Entity] combined-cycle-gas-turbine-ccgt-and-brayton-rankine-physics에
    관한 고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  co2_emission_pct: 40
  efficiency_critical_threshold: 55.0
  gas_inlet_temp_max: 1600
  gas_inlet_temp_min: 1400
  load_notice_threshold: 50.0
  pinch_point_warning_threshold: 15.0
  startup_time_max: 60
  startup_time_min: 30
  total_efficiency_max: 64
  total_efficiency_min: 58
semantic:
  alternative_parents: []
