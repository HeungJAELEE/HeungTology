...
lineage:
  ...
  original_hash: 04746205688ff0885868e64370d598597dece084c98b84c8ffeb762c5dfd1779
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] bionic-skin-and-multi-modal-tactile-sensing-topology에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  data_analysis_resolution_ms: 0.1
  data_integrity_guarantee_pct: 99.9
  durability_limit_cycles: 100000
  external_db_endpoint: e-skin-sensor-density-and-response-linearity-v2026
  human_skin_youngs_modulus_mpa: 1
  hysteresis_warning_threshold_pct: 5.0
  linearity_error_critical_threshold: 0.1
  max_response_time_ms: 1
  max_stretchability_pct: 50
  pressure_sensitivity_threshold_pa: 10
  sensor_density_nodes_per_cm2: 10-100
  temp_sensitivity_threshold_c: 0.1
semantic:
  alternative_parents: []
