...
object:
  description: '[Entity] digital-transformation-dx-and-ai-integration-strategy에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  adoption_rate_notice_threshold: 50.0
  ai_impact_formula: data_quality * intelligence^2 * human_adoption
  ai_portfolio_penetration_high_pct: 80
  data_integration_warning_threshold: 60.0
  innovation_yield_reject_threshold: 5.0
  maturity_critical_threshold: 40.0
  roi_dx_profitability_high_pct: 25
  v_dx_formula: sum(delta_e_process + delta_r_innovation - c_transition)
semantic:
  alternative_parents: []
