...
object:
  description: '[Entity] anisotropic-conductive-film-acf-and-cob-packaging-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  bonding_temp_range_c: 150-190
  critical_deformation_ratio_threshold: 0.3
  max_bonding_time_sec: 5
  notice_horizontal_insulation_gohm: 1.0
  operating_temp_range_c: -20 to 80
  particle_size_range_um: 3-5
  pitch_range_um: 10-50
  warning_contact_resistance_mohm: 500.0
semantic:
  alternative_parents: []
