...
lineage:
  ...
  original_hash: 330171ebf00647ca07d19ecfa857c5c10e0744ed1fdad7ff55ee91671d9d4fee
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] industrial-dust-collector-and-particle-filtration-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  air_flow_capacity_cmm: 2000
  darcy_law_variables:
  - delta_p
  - mu
  - v
  - l
  - kappa
  diff_pressure_high_resistance_pa: 1500.0
  diff_pressure_low_bypass_pa: 200.0
  filtration_efficiency_percent: 99.9
  max_operating_temperature_c: 250
  opacity_critical_threshold_pct: 5.0
  target_particle_size_um: 0.3
semantic:
  alternative_parents: []
