...
lineage:
  ...
  original_hash: 322cf3dcc803524ffe738a53d92a8533053c38cb373d96a8ded55ae4e3a532ee
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] lathe-machine-and-rotational-subtractive-manufacturing-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  cnc_precision_mm: 0.001
  cutting_force_formula: Ks * a * f
  cutting_speed_formula: pi * D * n / 1000
  high_speed_spindle_rpm: 10000
  manual_lathe_precision_mm: 0.05
  surface_roughness_threshold_um: 3.2
  tool_temperature_threshold_c: 800.0
semantic:
  alternative_parents: []
