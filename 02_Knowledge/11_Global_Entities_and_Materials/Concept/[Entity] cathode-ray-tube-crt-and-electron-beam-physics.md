...
object:
  description: '[Entity] cathode-ray-tube-crt-and-electron-beam-physics에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  anode_voltage_notice_threshold_kv: 20.0
  beam_spot_size_warning_threshold_um: 500.0
  crt_operating_voltage_max_v: 30000
  crt_operating_voltage_min_v: 15000
  crt_response_time_max_ms: 0.001
  phosphor_uniformity_reject_threshold_pct: 80.0
  richardson_law_temperature_exponent: 2
  vacuum_critical_threshold_torr: 1.0e-05
semantic:
  alternative_parents: []
