...
object:
  description: '[Entity] precision-measurement-and-metrology-for-tooling-audit에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  audit_status_fidelity: Truth-Meter-v2026-Fidelity
  compliance_rate: '> 99.9%'
  inspection_time: < 60 min
  measurement_uncertainty: < 1 µm
  probe_force: < 0.01 N
  resolution: '> 10 nm'
semantic:
  alternative_parents: []
