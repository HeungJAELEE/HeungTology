...
object:
  description: '[Entity] tire-mechanics-and-autonomous-vehicle-dynamics에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  braking_response_human_ms: '500'
  braking_response_system_ms: 10-50
  control_logic: Model Predictive Control (MPC)
  critical_friction_threshold_mu: '0.3'
  low_tire_pressure_threshold_psi: '25.0'
  nonlinear_slip_angle_threshold_deg: '5.0'
  tire_data_modality: Pressure / Temp / Wear / Strain
semantic:
  alternative_parents: []
