...
lineage:
  ...
  original_hash: 054609ac0f9d82cd1b9d57c083803aea58ee1a8b92ed4a2b262bf37dc1eb84c2
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] carbon-nanotubes-cnt-and-graphene-synthesis-logic에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  battery_additive_conductivity_min_s_m: 10000
  electrical_conductivity_threshold_s_m: 1000000
  electrical_conductivity_tolerance_s_m: 10000
  external_db_endpoint: carbon-nanomaterial-purity-and-conductivity-log-v2026
  fet_channel_sheet_resistance_max_ohm_sq: 500
  purity_critical_threshold: 20
  purity_excellent_threshold: 100
  raman_g_d_ratio_threshold: 50
  raman_g_d_ratio_tolerance: 10
  specific_surface_area_max_m2_g: 2600
  specific_surface_area_min_m2_g: 500
  specific_surface_area_tolerance_m2_g: 100
  thermal_conductivity_max_wmk: 5000
  thermal_conductivity_min_wmk: 3000
  thermal_conductivity_tolerance_wmk: 500
  youngs_modulus_tolerance_tp_a: 0.1
  youngs_modulus_tp_a: 1.0
semantic:
  alternative_parents: []
