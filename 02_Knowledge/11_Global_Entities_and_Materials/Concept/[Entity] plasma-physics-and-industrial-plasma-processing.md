...
lineage:
  ...
  original_hash: f1a51cf3f0bde540a1369b48f56d937f688e2a0514e6b2b67650622fcfa6fe0b
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] plasma-physics-and-industrial-plasma-processing에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  electron_temp_range_ev: 1-5
  ion_density_range_cm3: 1e9-1e12
  max_dc_bias_threshold_v: '500'
  max_etch_rate_variance_pct: '5.0'
  min_electron_density_threshold: 1e9
  min_etch_selectivity_threshold: '10.0'
  plasma_etching_resolution_nm: < 10
  pressure_range_mtorr: 0.1-100
semantic:
  alternative_parents: []
