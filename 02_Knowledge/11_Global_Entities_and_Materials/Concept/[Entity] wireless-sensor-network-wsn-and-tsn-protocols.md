...
lineage:
  ...
  original_hash: 5eba2bfc48b80a4188fae9e35736274d5798f43a86b86ba13b96ce9fc11412cf
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] wireless-sensor-network-wsn-and-tsn-protocols에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  lorawan_max_bandwidth_mbps: 0.05
  pdr_multi_path_improvement_threshold: 0.2
  tsn_bandwidth_range_mbps: 1000-10000
  tsn_clock_accuracy_unit: ns
  tsn_latency_max_ms: 0.1
  urllc_latency_range_ms: 1.0-5.0
  wirelesshart_bandwidth_mbps: 0.25
  zigbee_bandwidth_mbps: 0.25
semantic:
  alternative_parents: []
