...
object:
  description: '[Entity] business-ethics-and-anti-corruption-governance에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  critical_fraud_risk_threshold: 0.4
  fraud_detection_recall_rate_target_percent: 95
  fraud_detection_recall_rate_tolerance_percent: 2
  investigation_closure_time_max_days: 30
  investigation_closure_time_tolerance_days: 5
  iso_certification_standard: 37001 / 37301
  reporting_latency_max_hrs: 24
  reporting_latency_tolerance_hrs: 2
  suboptimal_compliance_threshold: 90
  target_compliance_rate_percent: 100
  target_corruption_probability_limit: 0.0001
semantic:
  alternative_parents: []
