...
lineage:
  ...
  original_hash: bc530387a85891c184fb57a41389dd1c10bd9418a40ff782414b6cfa57ad23d6
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] crispr-cas9-gene-editing-and-precision-genomics에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  cell_survival_threshold_pct: 95.0
  cell_viability_limit: 0.9
  edit_success_threshold_pct: 92.0
  hdr_fidelity_score_threshold: 0.85
  hds_gold_spec_version: V6.3.7
  indel_accuracy_threshold_pct: 90.0
  off_target_rate_threshold_pct: 0.001
  systemic_outreach_threshold_pct: 80.0
  target_hdr_rate: 0.8
semantic:
  alternative_parents: []
