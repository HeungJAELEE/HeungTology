...
object:
  description: '[Entity] belt-conveyor-dynamics-and-bulk-material-handling-logic에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  max_cleated_slope_deg: 30.0
  max_distance_per_flight_km: 50.0
  max_idler_vibration_mm_s: 8.0
  max_motor_load_pct: 95.0
  max_tracking_error_mm: 50.0
  min_belt_tension_kn: 5.0
semantic:
  alternative_parents: []
