...
lineage:
  ...
  original_hash: 2a35230a8bae1bacfe3e09a02aa10f6de62c1f6ec883b247eccfe291ca0c02ab
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] nanomedicine-and-targeted-drug-delivery-kinetics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  dendrimer_max_size_nm: 10
  gold_np_size_range_nm: 10-100
  liposome_size_range_nm: 50-150
  magnetic_np_size_range_nm: 10-50
  max_burst_release_pct: 30.0
  max_inflammatory_response_index: 0.4
  min_circulation_half_life_hr: 2.0
  min_target_uptake_ratio: 5.0
  polymeric_np_size_range_nm: 20-200
semantic:
  alternative_parents: []
