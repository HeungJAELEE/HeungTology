...
lineage:
  ...
  original_hash: d2e16044919a9e94b254fbcb342b4ac0b19607cc80dbef3cad3348c0651f2c5e
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] energy-dispersive-x-ray-spectroscopy-eds-and-microanalysis-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  dead_time_warning_threshold_pct: 50.0
  eds_resolution_ev_typical: 120-135
  eds_sensitivity_ppm_typical: 1000
  element_overlap_risk_threshold: 0.8
  moseley_law_k: K
  moseley_law_sigma: sigma
  resolution_failure_threshold_ev: 145.0
  signal_to_noise_notice_threshold: 10.0
  zaf_k_ratio: k_ratio
semantic:
  alternative_parents: []
