...
lineage:
  ...
  original_hash: 230d76497d914ca1be6a66b5f90768a9f68915769fb538166a1807102e952928
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] aspheric-lens-fabrication-and-precision-glass-molding에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  aspheric_surface_equation: z(r) = (cr^2) / (1 + sqrt(1 - (1+k)c^2r^2)) + sum(alpha_i
    * r^(2i))
  cooling_stress_threshold_mpa: 20.0
  profile_error_critical_threshold_pv_nm: 300.0
  profile_error_target_pv_nm: 100-200
  surface_roughness_target_ra_nm: 1-5
  surface_roughness_warning_threshold_ra_nm: 10.0
  thermo_optic_effect_formula: delta_n = (partial_n / partial_T) * delta_T
semantic:
  alternative_parents: []
