...
lineage:
  ...
  original_hash: ff3cbd6751e5bf1eb0d9dedfa9f471b210843f06355b741158bf4af3799559d1
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] iso-9001-quality-management-systems-and-continuous-improvement에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  critical_audit_findings_threshold: 10
  notice_corrective_action_closure_threshold: 100.0
  pdca_cycle_proportionality: quality_enhancement_proportional_to_pdca_frequency
  reject_risk_mitigation_rate_threshold: 0.9
  risk_formula: probability_of_failure_times_impact_of_failure
  warning_customer_complaint_rate_threshold: 0.05
semantic:
  alternative_parents: []
