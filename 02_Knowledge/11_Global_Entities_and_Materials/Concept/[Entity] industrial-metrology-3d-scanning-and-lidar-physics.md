...
lineage:
  ...
  original_hash: 7a375e92a8d59ce7eeff2c7e62a7f4998946159eeed7ddf61d99c8da1016fcee
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] industrial-metrology-3d-scanning-and-lidar-physics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  max_mesh_curvature_error_threshold: 0.05
  min_point_cloud_density_pts_cm2: 100
  precision_error_formula: sigma_d = c / (2 * SNR * sqrt(B))
