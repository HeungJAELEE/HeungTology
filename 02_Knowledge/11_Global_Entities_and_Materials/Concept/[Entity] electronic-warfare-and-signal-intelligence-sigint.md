...
lineage:
  ...
  original_hash: 87dc8f419f8bd1aaef97fcdaf0867aa34c3acd57dfc6b83b4352854b64b663fc
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] electronic-warfare-and-signal-intelligence-sigint에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  dynamic_range_db: 70
  dynamic_range_tolerance_db: 2
  external_db_endpoint: electronic-warfare-and-signal-intelligence-sigint-log-v2026
  frequency_range_max_ghz: 40.0
  frequency_range_min_ghz: 0.5
  frequency_range_tolerance_ghz: 0.001
  instantaneous_bandwidth_min_ghz: 2.0
  jamming_to_signal_ratio_target_db: 10
  signal_processing_latency_max_us: 1.0
semantic:
  alternative_parents: []
