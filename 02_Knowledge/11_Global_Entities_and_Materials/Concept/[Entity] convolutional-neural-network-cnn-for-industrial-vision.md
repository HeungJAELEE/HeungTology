...
lineage:
  ...
  original_hash: 1cf33eb6ffdc541485901150bf135bb3b32c1331d2519ebde8336d7e105a6d9f
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] convolutional-neural-network-cnn-for-industrial-vision에 관한
    고밀도 지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  cnn_escape_rate_max_pct: 0.01
  cnn_f1_score_min_pct: 99.5
  cnn_false_call_rate_max_pct: 0.1
  cnn_inspection_speed_min_ppm: 600
  cnn_resolution_max_um: 1
  external_data_reference: industrial-cnn-inspection-accuracy-and-false-call-rate-v2026
  logic_fidelity_precision_reject_threshold_pct: 95.0
  logic_fidelity_recall_critical_threshold_pct: 99.9
semantic:
  alternative_parents: []
