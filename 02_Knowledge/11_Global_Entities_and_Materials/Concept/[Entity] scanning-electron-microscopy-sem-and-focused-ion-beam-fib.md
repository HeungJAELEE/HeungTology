...
lineage:
  ...
  original_hash: 78178f79195346fe57469cd1638403b147fece0dcada6adce4240ce000c66caf
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] scanning-electron-microscopy-sem-and-focused-ion-beam-fib에
    관한 고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  beam_stability_threshold_notice: 0.99
  fib_depth_error_threshold_reject_pct: 10.0
  operating_vacuum_level_torr: 1.0e-06
  rayleigh_criterion_constant: 0.61
  resolution_threshold_warning_nm: 5.0
  sem_fib_max_magnification: 1000000
  sem_fib_resolution_range_nm: 0.5-1.0
  vacuum_threshold_critical_torr: 0.0001
semantic:
  alternative_parents: []
