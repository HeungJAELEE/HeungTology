...
lineage:
  ...
  original_hash: 1b2803c3a2d61b8e8c6eb897c01b8d086c3c18f46e1db445a5a000dcb0eb762b
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] power-electronics-and-wide-bandgap-wbg-semiconductors에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  ...
  bandgap_si_ev: 1.1
  bandgap_sic_ev: 3.2
  breakdown_field_gan_mv_cm: 3.3
  breakdown_field_si_mv_cm: 0.3
  breakdown_field_sic_mv_cm: 2.5
  critical_junction_temp_threshold_c: 175.0
  max_op_temp_gan_c: 200
  max_op_temp_si_c: 150
  max_op_temp_sic_c: 600
  max_switching_noise_threshold_db: -40.0
  min_efficiency_threshold_pct: 95.0
  min_voltage_safety_margin: 0.2
  thermal_conductivity_gan_w_cm_k: 1.3
  thermal_conductivity_si_w_cm_k: 1.5
  thermal_conductivity_sic_w_cm_k: 4.9
semantic:
  alternative_parents: []
