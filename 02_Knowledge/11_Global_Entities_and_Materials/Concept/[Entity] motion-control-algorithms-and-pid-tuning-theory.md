...
lineage:
  ...
  original_hash: 3b719c64c4b63540aa062505b6edbf2969bdd1a63491762a866b3c2f39ecaa39
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] motion-control-algorithms-and-pid-tuning-theory에 관한 고밀도 지능
    노드'
  object_type: Algorithm
  tier: 1
properties:
  damping_ratio_critical: 0.707
  diagnostic_overshoot_critical_pct: 10.0
  diagnostic_settling_time_warning_ms: 300
  diagnostic_tracking_error_notice_um: 5.0
  isa_95_level: 2
  loop_rate_cnc_hz: 2000
  loop_rate_high_speed_hz: 16000
  overshoot_cnc_pct: 2.0
  overshoot_high_speed_pct: 0.5
  settling_time_cnc_range_sec: 0.5-1.5
  settling_time_high_speed_sec: 0.02
  tracking_error_cnc_mm: 0.005
  tracking_error_high_speed_mm: 5.0e-05
semantic:
  alternative_parents: []
