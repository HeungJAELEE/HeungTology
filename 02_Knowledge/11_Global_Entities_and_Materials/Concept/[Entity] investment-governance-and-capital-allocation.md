...
object:
  ...
  tier: 1
properties:
  capital_allocation_optimization_objective: maximize_sum_weighted_npv
  growth_rd_target_margin_above_wacc: 0.05
  investment_hurdle_rate_notice_threshold: 10.0
  post_audit_variance_warning_threshold: 0.3
  related_party_transaction_limit: 0
  roic_wacc_spread_critical_threshold: 0.0
  sharpe_ratio_formula: (rp - rf) / sigma_p
semantic:
  alternative_parents: []
