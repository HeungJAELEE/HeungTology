...
lineage:
  ...
  original_hash: 0695570dfff8ce84999e6f707dd5efe16202386152ea6ed06d75617e21b9bede
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] heat-treatment-and-material-hardening-for-mold-durability에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  audit_fidelity_standard: Metal-Soul-v2026-Fidelity
  heating_temperature_threshold: 1000 C
  max_grain_size_um: '10'
  target_case_depth_mm: 0.1-1.0
  target_hardness_hrc: 50-65
  target_quench_rate_c_per_sec: 50-100
  temper_brittleness_temp_range_c: 300-500
semantic:
  alternative_parents: []
