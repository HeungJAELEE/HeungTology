...
object:
  description: '[Entity] chemical-reaction-engineering-and-reactor-design에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  ...
  cstr_design_equation: V_CSTR = (F_A0 * X) / (-r_A)
  frequency_factor: A
  gas_constant: R
  pfr_design_equation: V_PFR = F_A0 * integral(0 to X) (dX / -r_A)
  target_selectivity: maximized
  thiele_modulus_equation: phi = L * sqrt((k * C_n_minus_1) / D_eff)
semantic:
  alternative_parents: []
