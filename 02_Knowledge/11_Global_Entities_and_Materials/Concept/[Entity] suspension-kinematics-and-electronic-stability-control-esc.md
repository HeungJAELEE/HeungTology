...
lineage:
  ...
  original_hash: 8b346a9705dc3c81cb5c8719aee2b737849526799132bfa28b1d8ab016cce7ce
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] suspension-kinematics-and-electronic-stability-control-esc에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  audit_status_fidelity: Chassis-Balance-v2026-Fidelity
  camber_adjustment_limit: ± 5 deg
  damping_force_mode: VARIABLE
  esc_response_threshold_ms: < 20 ms
  pitch_angle_threshold: < 1 deg
  roll_angle_threshold: < 2 deg
  system_resilience_level: High
  tire_contact_minimum_percentage: '> 95%'
semantic:
  alternative_parents: []
