...
lineage:
  ...
  original_hash: 061ab97417b9b0194da8509d2ecba9d93768b504a1019dc213d5c13d66756d97
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] space-based-solar-power-and-wireless-energy-transmission-microwaves에
    관한 고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  antenna_diameter_min: 1,000 m
  beaming_efficiency_min: 50%
  max_safe_energy_density: 250 W/m^2
  microwave_freq_range: 2.45-5.8 GHz
  path_loss_threshold: 200 dB
  pointing_accuracy_max: 0.1 arcsec
  rectenna_efficiency_min: 85%
  specific_power_min: 500 W/kg
  trans_distance_geo: 35,786 km
semantic:
  alternative_parents: []
