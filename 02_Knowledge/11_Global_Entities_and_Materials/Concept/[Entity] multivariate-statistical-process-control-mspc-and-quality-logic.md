...
object:
  description: '[Entity] multivariate-statistical-process-control-mspc-and-quality-logic에
    관한 고밀도 지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  mspc_version: v6.3.7
  q_residual_limit: limit_q
  ucl_95: 95_percent_confidence_threshold
  ucl_99: 99_percent_confidence_threshold
semantic:
  alternative_parents: []
