...
object:
  description: '[Entity] quantitative-investment-and-algorithmic-trading-foundations에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  execution_slippage_threshold_bps: 10.0
  execution_speed: microseconds
  max_drawdown_threshold: 15.0
  min_sharpe_ratio_threshold: 1.0
  version: V6.3.7
semantic:
  alternative_parents: []
