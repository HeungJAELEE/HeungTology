...
object:
  description: '[Entity] fabric-manufacturing-and-knitting-weaving-technology에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  air_permeability_error_margin: 5%
  defect_rate_max: 0.1%
  elastic_recovery_min: 90%
  fabric_density_range: 40-200 EPI/PPI
  production_speed_min: 1000 m/min
  tearing_strength_min: 50 N
  tensile_strength_min: 500 N
  thickness_range: 0.1-5.0 mm
semantic:
  alternative_parents: []
