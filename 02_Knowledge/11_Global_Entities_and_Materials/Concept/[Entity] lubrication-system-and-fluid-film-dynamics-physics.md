...
lineage:
  ...
  original_hash: d04661c342eeef61b33404a0009ee2479596ea57d02d52088a2f75dfa5f6ae41
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] lubrication-system-and-fluid-film-dynamics-physics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  diagnostic_engine_name: FactoryFidelityEngine
  filtration_micron_limit: 3
  hagene_poiseuille_formula: Q = (pi * d^4 * delta_p) / (128 * mu * L)
  iso_filtration_standard: ISO 4406
  nominal_system_pressure_bar: 200
  pressure_viscosity_formula: h = h_min * exp(-alpha * P)
semantic:
  alternative_parents: []
