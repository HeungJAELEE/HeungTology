...
lineage:
  ...
  original_hash: 2eb22d9513aaf0e20f9d2c1cacbcd6e9528e5032d73de2e8ef668baa3b475a92
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] aeronautical-engineering-and-supersonic-flight-physics에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  critical_heating_mach_threshold: 1.2
  critical_heating_temp_threshold: 250.0
  excessive_wave_drag_threshold_pct: 50.0
  mach_angle_formula: sin(mu) = 1/M
  mach_number_formula: v/a
  sonic_boom_overpressure_limit_psf: 2.0
  subsonic_cruise_speed_range: Mach 0.7 - 0.85
  subsonic_skin_temp_max: 100
  supersonic_cruise_speed_range: Mach 1.6 - 2.2
  supersonic_skin_temp_range: 150 - 300+
semantic:
  alternative_parents: []
