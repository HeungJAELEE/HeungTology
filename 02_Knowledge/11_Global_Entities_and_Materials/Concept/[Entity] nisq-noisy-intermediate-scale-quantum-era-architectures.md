...
object:
  description: '[Entity] nisq-noisy-intermediate-scale-quantum-era-architectures에
    관한 고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  depth_safety_divisor: 10
  error_mitigated_gain_threshold: 1.5
  gate_fidelity_threshold_pct: 99.0
  nisq_error_rate_max_pct: 1.0
  nisq_error_rate_min_pct: 0.1
  nisq_qubit_count_max: 1000
  nisq_qubit_count_min: 50
  t2_coherence_threshold_us: 20
semantic:
  alternative_parents: []
