...
lineage:
  ...
  original_hash: 1cf7d45d8338c15e3823e700e33cc205d4a517aade83c835ec5eec59017dfb2d
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] display-driver-ic-ddic-architecture-and-high-speed-interface에
    관한 고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  bandwidth_formula: H * V * f * bit * (1 + overhead)
  dynamic_power_formula: alpha * C * V_dd^2 * f
  eye_height_warning_threshold_mv: 100
  it_tv_channel_count_range: 2000-4000
  it_tv_max_data_rate_gbps: 5.0-12.5
  it_tv_power_limit_mw: 500
  mobile_oled_channel_count_range: 1000-2000
  mobile_oled_max_data_rate_gbps: 2.5-6.5
  mobile_oled_power_limit_mw: 150
  thermal_overload_threshold_c: 85
semantic:
  alternative_parents: []
