...
lineage:
  ...
  original_hash: b8a89f93c6fda7591b385ddd73d29f0abd30e9c23becf4a9156bca219ecab111
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] environmental-protection-and-sustainability-engineering에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  carbon_footprint_intensity_max_kg_co2eq: 50
  carbon_intensity_rejection_threshold: 100
  emission_regulatory_threshold_ratio: 0.9
  energy_efficiency_improvement_min_pct_per_year: 5
  pm10_purity_limit_ug_m3: 25
  pm25_purity_limit_ug_m3: 10
  resource_efficiency_notice_threshold_ratio: 0.7
  waste_to_value_recovery_min_pct: 90
  water_circularity_warning_threshold_pct: 60.0
  water_recycle_rate_min_pct: 80
semantic:
  alternative_parents: []
