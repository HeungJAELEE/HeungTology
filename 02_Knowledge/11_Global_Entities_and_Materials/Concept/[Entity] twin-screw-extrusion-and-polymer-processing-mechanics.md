...
lineage:
  ...
  original_hash: 268aa0f942302c1f3f36e04b7e47dde3cd385c811fa95c57db307d9f7bc9c0b1
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] twin-screw-extrusion-and-polymer-processing-mechanics에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  critical_torque_threshold_pct: 90.0
  drag_flow_coefficient: alpha
  flow_behavior_index: n
  notice_melt_pressure_threshold_bar: 50.0
  power_law_consistency_index: K
  pressure_flow_coefficient: beta
  twin_screw_version: V6.3.7
  warning_sme_threshold_kwh_kg: 0.4
semantic:
  alternative_parents: []
