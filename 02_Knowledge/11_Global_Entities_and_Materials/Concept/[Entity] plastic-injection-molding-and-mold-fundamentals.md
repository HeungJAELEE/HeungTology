...
lineage:
  ...
  original_hash: 3ae30df71d09d97d5f30e24ac6d71279393bb7f5a1c8d1d10d2e796e3ac757d8
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] plastic-injection-molding-and-mold-fundamentals에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  clamping_force_condition: Force (kN) > Separating Force
  cooling_error_max_k: 1.0
  cooling_metric: Cooling Rate (K/s)
  dwelling_metric: Packing Pressure (MPa)
  ejection_metric: Ejection Force (N)
  fourier_law_equation: q = -k * A * (dT/dx)
  gate_balance_metric: Gate Balance (%)
  hagen_poiseuille_equation: delta_p = (8 * mu * L * Q) / (pi * R^4)
  injection_metric: Fill Time (s) vs Viscosity
  pressure_deviation_max_mpa: 0.1
  pvt_model_equation: V(P, T) = V0(T) * [1 - C * ln(1 + P/B(T))]
  venting_metric: Gas Pressure (kPa)
semantic:
  alternative_parents: []
