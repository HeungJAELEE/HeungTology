...
lineage:
  ...
  original_hash: c83116383d0c6d7513aa23e290cfa234993f4852b9d5ffca0b0d02ab61dda604
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] micro-and-nano-robotics-actuation-and-fabrication-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  actuation_force_range: 1-100 nN
  biocompatibility_requirement: non-toxic
  fabrication_resolution_threshold: < 50 nm
  magnetic_force_model: F_m = (m . grad) B
  magnetic_torque_model: T_m = m x B
  operating_medium_viscosity: viscous
  positional_precision_threshold: < 100 nm
  power_supply_mode: wireless
  propulsion_velocity_threshold: '> 50 um/s'
  scale_range: 1-100 um
  stokes_drag_model: F_d = 6pi eta r v
semantic:
  alternative_parents: []
