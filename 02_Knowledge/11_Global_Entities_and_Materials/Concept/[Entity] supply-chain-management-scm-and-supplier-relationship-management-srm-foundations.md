...
lineage:
  ...
  original_hash: 0b6f93af0c42be514a65dee93a3cc93897414db9253532f51b8432d8daea3ac9
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] supply-chain-management-scm-and-supplier-relationship-management-srm-foundations에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  eoq_annual_demand: D
  eoq_fixed_cost_per_order: S
  eoq_holding_cost_per_unit: H
  external_endpoint_apics: https://www.ascm.org/learning-development/apics-dictionary/
  external_endpoint_kraljic_hbr: https://hbr.org/1983/09/purchasing-must-become-supply-management
  safety_stock_demand_volatility: sigma_D
  safety_stock_lead_time: L
  safety_stock_service_factor: Z
  supplier_scorecard_performance: P_i
  supplier_scorecard_weight: w_i
semantic:
  alternative_parents: []
