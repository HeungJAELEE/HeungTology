...
lineage:
  ...
  original_hash: a9bbdae2f009ee05e1c83419afc8686c8277860c3f34c310d950bd1f2a15d3c7
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] crispr-cas9-gene-editing-kinetics-and-off-target-mechanics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  cleavage_rate_min_inv: 0.1
  dissociation_constant_kd_nm: 1.0
  editing_success_threshold_pct: 80.0
  hamming_distance_threshold: 3
  hds_gold_specification: V6.3.7
  off_target_rate_max_pct: 0.1
  transient_expression_window_hr: 12.0-24.0
semantic:
  alternative_parents: []
