...
lineage:
  ...
  original_hash: 5ffd8c9c09d54674fd5a03f9bc417dbeb7baef5927fc91dc1eb0b5470decb309
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] disaster-recovery-dr-and-business-continuity-planning-bcp에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  availability_gold_threshold_percent: 99.99
  availability_math_formula: mtbf / (mtbf + mttr)
  availability_silver_threshold_percent: 99.5
  geo_separation_gold_km: 500
  geo_separation_silver_km: 100
  rpo_gold_threshold_hours: 0.1
  rpo_silver_threshold_hours: 12
  rto_gold_threshold_hours: 1
  rto_silver_threshold_hours: 24
  test_frequency_gold: quarterly
  test_frequency_silver: annually
semantic:
  alternative_parents: []
