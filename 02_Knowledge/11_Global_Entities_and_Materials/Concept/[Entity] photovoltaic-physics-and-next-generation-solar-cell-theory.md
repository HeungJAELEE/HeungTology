...
lineage:
  ...
  original_hash: 02f2076d85a3370462ca47e6eb19b3610501d07c8b2826d8f06d0045e32185ee
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] photovoltaic-physics-and-next-generation-solar-cell-theory에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  bandgap_tolerance_ev: 0.2
  crystalline_silicon_efficiency_limit: 29.4%
  ideal_bandgap_energy_ev: 1.34
  iii_v_multi_junction_efficiency_limit: '>47.0%'
  max_series_resistance_ohm: 5.0
  min_carrier_diffusion_length_um: 10.0
  min_internal_quantum_efficiency: 0.9
  perovskite_tandem_efficiency_limit: '>40.0%'
  quantum_dot_efficiency_limit: 20.0%
  shockley_queisser_limit: 33.7%
  theoretical_max_efficiency: 86.0%
  thin_film_efficiency_limit: 30.0%
semantic:
  alternative_parents: []
