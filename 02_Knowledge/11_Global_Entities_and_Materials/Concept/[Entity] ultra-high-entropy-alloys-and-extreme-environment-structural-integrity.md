...
object:
  description: '[Entity] ultra-high-entropy-alloys-and-extreme-environment-structural-integrity에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  fracture_toughness_threshold: 50.0
  lattice_distortion_threshold: 0.05
  min_component_count: 5
  peak_temp_threshold: 1200.0
semantic:
  alternative_parents: []
