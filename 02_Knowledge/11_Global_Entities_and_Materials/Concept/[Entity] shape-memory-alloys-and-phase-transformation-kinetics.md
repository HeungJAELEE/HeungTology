...
object:
  description: '[Entity] shape-memory-alloys-and-phase-transformation-kinetics에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  fatigue_life_min: 100,000
  hysteresis_max: 10 C
  output_force_min: 500 MPa
  recov_strain_threshold: '> 8%'
  superelasticity_strain_min: 10%
  transf_temp_range: -50 to 150 C
semantic:
  alternative_parents: []
