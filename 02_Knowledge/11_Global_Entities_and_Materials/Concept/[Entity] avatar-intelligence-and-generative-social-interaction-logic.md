...
object:
  description: '[Entity] avatar-intelligence-and-generative-social-interaction-logic에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  animation_frame_rate_min: 60
  critical_latency_threshold_ms: 1000
  emotion_accuracy_min_pct: 90
  emotional_fidelity_min_score: 0.8
  face_sync_precision_min_pct: 95
  interaction_latency_limit_ms: 300
  jitter_warning_threshold_ms: 100
  persona_stability_min_pct: 98
semantic:
  alternative_parents: []
