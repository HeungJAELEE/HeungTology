...
object:
  description: '[Entity] environmental-social-and-governance-esg-strategy에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  audit_quality_target: 100%
  board_independence_notice_threshold: 50.0
  board_independence_target: '> 50%'
  carbon_compliance_warning_threshold: 80.0
  carbon_intensity_target: < 20% Reduction (YoY)
  dei_index_target: '> 80'
  esg_integration_target: 100% (AUM)
  esg_score_critical_threshold: 50.0
semantic:
  alternative_parents: []
