...
lineage:
  ...
  original_hash: 20746b8f5285c7bc20f6a133ed8e617f870c6be8c1719cec98dce8547df95f05
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] energy-storage-systems-and-battery-management에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  bms_response_latency_threshold: < 10 ms
  cell_voltage_deviation_max: 10 mV
  charge_rate_threshold: '> 2 C'
  cycle_life_threshold: '> 5,000 cycles'
  energy_density_threshold: '> 300 Wh/kg'
  round_trip_efficiency_threshold: '> 90%'
  soc_accuracy_threshold: '> 98%'
  soc_estimation_error_max: 2%
  soh_prediction_accuracy_threshold: '> 95%'
semantic:
  alternative_parents: []
