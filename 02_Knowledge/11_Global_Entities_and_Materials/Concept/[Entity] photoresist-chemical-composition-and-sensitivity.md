...
object:
  description: '[Entity] photoresist-chemical-composition-and-sensitivity에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  acid_diffusion_reject_threshold_nm: 5.0
  car_ler_nm: 2
  car_resolution_nm: 10
  dnq_ler_nm: 5
  dnq_resolution_nm: 300
  dose_critical_threshold_mj: 50.0
  dose_formula: Intensity * Time
  ler_warning_threshold_nm: 3.0
  resist_contrast_formula: '[log(D100/D0)]^-1'
  shelf_life_notice_threshold_days: 10
semantic:
  alternative_parents: []
