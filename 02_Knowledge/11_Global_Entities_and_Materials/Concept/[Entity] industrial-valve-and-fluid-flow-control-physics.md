...
lineage:
  ...
  original_hash: 0a57f842e213a0909792d09929cb4251f657bebbb6d3b0094857684faa6a13b3
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] industrial-valve-and-fluid-flow-control-physics에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  bernoulli_energy_conservation_formula: P1 + 0.5*rho*v1^2 = P2 + 0.5*rho*v2^2 + Loss
  control_valve_leakage_class: Class VI
  control_valve_max_pressure_class: 400 bar
  flow_coefficient_formula: Q = Cv * sqrt(delta_p / SG)
  obstruction_flow_ratio_threshold: 0.8
  obstruction_pos_threshold: 90.0
  seat_leakage_pos_threshold: 0.0
semantic:
  alternative_parents: []
