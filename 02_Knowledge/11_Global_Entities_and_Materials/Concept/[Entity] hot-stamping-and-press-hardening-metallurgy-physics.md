...
object:
  description: '[Entity] hot-stamping-and-press-hardening-metallurgy-physics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  blank_temperature_range_c: 900-950
  coating_type: Al-Si
  critical_cooling_rate_min_c_per_s: 27
  cycle_time_range_s: 8-15
  max_die_inlet_temp_c: 35.0
  max_transfer_time_s: 8.0
  min_hrc_hardness: 45.0
  uts_target_mpa: 1500
semantic:
  alternative_parents: []
