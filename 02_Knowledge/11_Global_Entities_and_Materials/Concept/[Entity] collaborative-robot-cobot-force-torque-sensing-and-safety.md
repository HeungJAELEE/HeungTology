...
lineage:
  ...
  original_hash: e6e4f606b2e7c85e42cc7d1795c4da43c578e7e88aacb6e0757393c7c6953723
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] collaborative-robot-cobot-force-torque-sensing-and-safety에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  calibration_error_threshold: 2.0
  critical_torque_threshold_nm: 10.0
  external_data_endpoint: cobot-force-sensitivity-and-collision-stop-latency-v2026
  force_limit_max_n: 150
  force_sensitivity_target_n: 5
  safety_stop_time_target_ms: 50
  sensor_drift_limit_pct_fs: 0.5
  torque_resolution_target_nm: 0.1
  warning_torque_threshold_nm: 5.0
  warning_velocity_threshold_mms: 250
semantic:
  alternative_parents: []
