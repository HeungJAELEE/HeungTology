...
object:
  description: '[Entity] it-service-management-itsm-and-itil-framework-logic에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  availability_formula: MTBF / (MTBF + MTTR) * 100%
  change_failure_rate_threshold: 10.0
  itil_framework_version: V6.3.7
