...
object:
  description: '[Entity] aluminum-smelting-and-hall-heroult-process-electrolysis에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  anode_effect_limit: 2
  critical_bath_temp_threshold: 980.0
  current_density_advanced_range: 1.0 - 1.5 A/cm^2
  impurity_threshold_ppm: 500
  minimum_current_efficiency_threshold: 90.0
  process_temp_advanced_range: 900 - 950 °C
  specific_energy_advanced_range: 11.5 - 12.5 kWh/kg
  voltage_balance_formula: V_cell = E_rev + eta_anode + eta_cathode + IR_bath
semantic:
  alternative_parents: []
