...
lineage:
  ...
  original_hash: 4d561b11de038b06d72d77389c1e80f2012528f5e30ca5e78fa6915fd1aabdd3
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] cross-linked-polyethylene-xlpe-and-insulation-physics에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  conductor_thermal_limit_c: 95.0
  minimum_gel_content_pct: 75.0
  pd_critical_threshold_pc: 5.0
  tan_delta_warning_threshold: 0.005
  xlpe_dielectric_strength_kv_mm: 30
  xlpe_max_operating_temp_c: 90
  xlpe_short_circuit_temp_c: 250
semantic:
  alternative_parents: []
