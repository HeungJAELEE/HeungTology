...
lineage:
  ...
  original_hash: 8dec8bf32f59c0a33eae3f4cccc7bac6e9c8ed95a6181a745e138f663e3cebb7
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] mechanical-vapor-recompression-mvr-and-evaporation-physics에
    관한 고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  bpe_critical_threshold: 15.0 K
  energy_reduction_rate: 90%
  mee_specific_energy: 200 kWh/ton
  mvr_specific_energy: 20 kWh/ton
  thermal_drive_threshold_offset: 3.0 K
semantic:
  alternative_parents: []
