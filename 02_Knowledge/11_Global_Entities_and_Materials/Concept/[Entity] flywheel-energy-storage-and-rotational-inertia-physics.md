...
lineage:
  ...
  original_hash: 24eb68c135d82003a3429ba3a711e14173f9aed6de363d845850beb15c7df641
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] flywheel-energy-storage-and-rotational-inertia-physics에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  centrifugal_stress_formula: rho * r^2 * omega^2
  flywheel_cycle_life_max: 1000000
  flywheel_cycle_life_min: 100000
  flywheel_efficiency_max: 95
  flywheel_efficiency_min: 90
  kinetic_energy_formula: 1/2 * I * omega^2
  position_error_instability_threshold_nm: 500
  rpm_mechanical_limit_threshold: 50000
  vacuum_warning_threshold_torr: 0.1
  vibration_critical_threshold_um: 20.0
semantic:
  alternative_parents: []
