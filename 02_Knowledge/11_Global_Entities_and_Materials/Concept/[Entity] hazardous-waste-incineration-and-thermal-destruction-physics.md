...
lineage:
  ...
  original_hash: 0f09bfe8ae4d7e3ea97df5ef73515f91a35dea2241dc78f2a5eb717a4455807e
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] hazardous-waste-incineration-and-thermal-destruction-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  co_threshold_ppm: 50.0
  critical_temp_threshold_c: 1100.0
  max_dre_required_percentage: 99.9999
  max_operating_temp_c: 1300.0
  max_residence_time_s: 4.0
  min_dre_required_percentage: 99.99
  min_operating_temp_c: 1100.0
  min_residence_time_s: 2.0
semantic:
  alternative_parents: []
