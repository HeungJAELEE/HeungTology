...
object:
  description: '[Entity] reaction-kinetics-and-catalytic-reactor-design에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  conversion_threshold: '> 95%'
  damkohler_number_regime: Da << 1 or Da >> 1
  residence_time_error_tolerance: 1%
  selectivity_threshold: '> 99%'
  turnover_frequency_min: 100 s^-1
semantic:
  alternative_parents: []
