...
object:
  description: '[Entity] flowchart-and-process-mapping-standardization-logic에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  automation_format: XML
  bpmn_2_0_standard: BPMN 2.0
  hierarchy_levels: L1-L5
  iso_5807_standard: ISO 5807
  pce: (sum(t_va) / t_total) * 100
  pce_critical_threshold: 5.0
  t_total: sum(t_va + t_nva)
semantic:
  alternative_parents: []
