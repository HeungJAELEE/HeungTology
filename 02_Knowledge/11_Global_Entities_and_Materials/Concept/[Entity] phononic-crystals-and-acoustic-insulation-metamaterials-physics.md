...
lineage:
  ...
  original_hash: 9f5e6f52a9b0c6dd3d3168de2678456af274537485895c29e26319f4c8cbdda7
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] phononic-crystals-and-acoustic-insulation-metamaterials-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  attenuation_threshold_db: 40.0
  bandgap_frequency_tolerance_hz: 100
  max_attenuation_db: 60
  metamaterial_version: V6.3.7
  structural_defect_threshold: 0.05
  target_bandgap_center_hz: 1000
  vibration_isolation_min_pct: 95.0
semantic:
  alternative_parents: []
