...
lineage:
  ...
  original_hash: b05c34536cc50641d7bd7a705812cf04c8d4e81034eed6a3f4d9d0a03e012b1e
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] emulsion-polymerization-and-colloidal-synthesis-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  coagulation_threshold_nm: 500.0
  induction_period_solid_content_pct: 10.0
  particle_size_range_nm: 50-500
  target_reactor_temperature_c: 80.0
  temperature_deviation_threshold_c: 5.0
  zeta_potential_stability_threshold_mv: 30.0
semantic:
  alternative_parents: []
