...
object:
  ...
  tier: 1
properties:
  ambient_temp_delta_threshold: 40
  battery_critical_threshold_pct: 15.0
  battery_high_consumption_threshold_pct: 30.0
  chilled_grade_insulation_r: 3.0
  chilled_grade_target_temp: 2 to 8
  chilled_grade_tolerance: 1.0
  frozen_grade_insulation_r: 5.0
  frozen_grade_target_temp: -25 to -15
  frozen_grade_tolerance: 2.0
  pharma_grade_insulation_r: 4.0
  pharma_grade_target_temp: 15 to 25
  pharma_grade_tolerance: 0.5
  target_waste_rate_limit: 0.01
semantic:
  alternative_parents: []
