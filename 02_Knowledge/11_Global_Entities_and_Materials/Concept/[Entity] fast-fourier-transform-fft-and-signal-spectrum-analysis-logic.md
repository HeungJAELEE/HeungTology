...
lineage:
  ...
  original_hash: 0d04dab705af9974026680e7d2bb2388fa13cdf519969142cde3d4dd3ed24839
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] fast-fourier-transform-fft-and-signal-spectrum-analysis-logic에
    관한 고밀도 지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  fft_computational_complexity: O(N log N)
  frequency_resolution_formula: fs/N
  max_spectral_leakage_score: 0.8
  min_max_freq_hz: 1000.0
  min_snr_db: 20.0
  nyquist_limit: fs/2
semantic:
  alternative_parents: []
