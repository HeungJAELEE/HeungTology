...
lineage:
  ...
  original_hash: cf210b57fbed25c461e60be3597fe0605e9d82fadc22496c968f1ad5427817ac
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] cancer-immunotherapy-and-car-t-cell-engineering에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  cell_viability_target_pct: 90
  complete_remission_target_pct: 70
  cytokine_level_crs_warning_threshold_pg_ml: 500
  expansion_factor_range_fold: 100-1000
  external_data_endpoint: car-t-cell-expansion-and-tumor-reduction-v2026
  sterility_bioburden_cfu: 0
  t_cell_expansion_critical_threshold_fold: 10
  target_treatment_success_rate_pct: 80
  transduction_efficiency_target_pct: 30
  tumor_burden_optimal_threshold: 0.5
semantic:
  alternative_parents: []
