...
object:
  description: '[Entity] corporate-social-responsibility-csr-and-philanthropy에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  admin_overhead_warning_threshold: 25.0
  admin_ratio_target_pct: 15.0
  admin_ratio_tolerance: 2.0
  csr_spend_revenue_ratio_target: 1.0
  csr_spend_tolerance: 0.2
  external_data_endpoint: csr-investment-and-social-impact-metrics-v2026
  impact_scope_beneficiaries_target: 10000
  social_malfunction_probability_max: 0.01
  sroi_critical_threshold: 1.5
  sroi_target_ratio: 3.0
  sroi_tolerance: 0.5
  stakeholder_trust_rejection_threshold: 60.0
  volunteerism_participation_target_pct: 40.0
  volunteerism_participation_tolerance: 5.0
semantic:
  alternative_parents: []
