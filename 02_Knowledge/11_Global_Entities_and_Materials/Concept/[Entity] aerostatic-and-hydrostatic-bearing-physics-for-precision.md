...
lineage:
  ...
  original_hash: bc0aaf7bf14a41dd72db22cb5d3526be0a5036cd705c0099fdef62d3caf3507d
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] aerostatic-and-hydrostatic-bearing-physics-for-precision에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  air_viscosity_mu: 1.8e-05
  discharge_coefficient_cd: 0.6-0.8
  film_thickness_um: 10.0-20.0
  hds_gold_spec: V6.3.7
  max_load_n: 10000
  motion_error_nm: 5.0
  nrro_nm: 2.0
  static_stiffness_n_um: 500
  supply_pressure_bar: 5.0-200.0
semantic:
  alternative_parents: []
