...
object:
  description: '[Entity] distributed-control-system-dcs-and-large-scale-process-automation에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  large_scale_availability_pct: 99.999
  large_scale_io_points_max: 1000000
  large_scale_io_points_min: 10000
  large_scale_network_speed_mbps: 1000
  large_scale_scan_rate_max_ms: 100
  large_scale_scan_rate_min_ms: 10
  large_scale_sil_level: 3
  loop_latency_threshold_ms: 500
  network_jitter_threshold_ms: 50
  sis_activation_time_threshold_ms: 100
semantic:
  alternative_parents: []
