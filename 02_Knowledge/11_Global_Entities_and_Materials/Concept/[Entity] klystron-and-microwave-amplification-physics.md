...
lineage:
  ...
  original_hash: aaf52d50e3a648c11a6c2d04db006f5ea8af5ad73ef327726acde2622ec0b2a6
metadata:
  date: '2026-05-16'
...
object:
  ...
  tier: 1
properties:
  amplification_efficiency_formula: P_out = eta * P_beam
  cooling_method: water_forced_convection
  current_depletion_threshold_ratio: '0.9'
  frequency_range: ghz_to_thz
  klystron_efficiency_nominal: '0.60'
  power_output_scale: megawatts
  vacuum_threshold_torr: 1e-6
  velocity_modulation_formula: v = v_0 * sqrt(1 + (V1/V0) * sin(omega * t))
semantic:
  alternative_parents: []
