...
lineage:
  ...
  original_hash: 939ffdaf1723e9d872bdff2c4187b8a525d06467ae1e95e81000149424951f20
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] sodium-ion-battery-sib-chemistry-and-mechanism에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  aluminum_density_g_cm3: 2.7
  anode_hard_carbon_capacity_mah_g:
  - 250
  - 350
  anode_hard_carbon_cycle_life_min: 3000
  anode_hard_carbon_voltage_v:
  - 0.0
  - 0.2
  cathode_layered_capacity_mah_g:
  - 120
  - 160
  cathode_layered_cycle_life:
  - 1000
  - 3000
  cathode_layered_voltage_v:
  - 3.2
  - 4.0
  cathode_prussian_capacity_mah_g:
  - 140
  - 170
  cathode_prussian_cycle_life:
  - 2000
  - 5000
  cathode_prussian_voltage_v:
  - 3.0
  - 3.6
  copper_density_g_cm3: 8.96
  hard_carbon_d002_min_nm: 0.37
  lithium_ionic_radius_a: 0.76
  low_temp_capacity_retention_threshold: 0.9
  low_temp_ref_temp_c: -20
  operating_temp_range_c:
  - -40
  - 80
  sodium_ionic_radius_a: 1.02
  specific_energy_wh_kg_range:
  - 100
  - 160
  target_cost_reduction_percent: 30
  theoretical_cost_advantage_percent:
  - 30
  - 40
  weight_reduction_via_al_percent: 10
semantic:
  alternative_parents: []
