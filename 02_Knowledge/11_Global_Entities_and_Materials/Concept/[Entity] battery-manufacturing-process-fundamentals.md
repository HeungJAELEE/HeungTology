...
object:
  ...
  tier: 1
properties:
  alignment_error_threshold: 0.5mm
  bruggeman_parameters:
  - tau
  - epsilon
  - D_eff
  - D
  ...
  - T
  - eta
  capacity_accuracy_unit: mAh
  contact_resistivity_unit: uOhm
  electrode_loading_unit: mg/cm^2
  fick_second_law_parameters:
  - C
  - t
  - D
  - x
  formation_current_unit: C-rate
  ocv_variation_unit: mV
  peel_strength_unit: N/m
  porosity_control_error_margin: 1%
  porosity_target_range: 25-30%
  wetting_rate_unit: mm/s
semantic:
  alternative_parents: []
