...
lineage:
  ...
  original_hash: eb98b2f619386e69e64136714b7169efddfa8f401805267325502171ca3b5534
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] high-voltage-direct-current-hvdc-transmission-and-vsc-technology에
    관한 고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  break_even_distance_overhead_km: 600-800
  break_even_distance_submarine_km: '50'
  lcc_loss_pct_range: 0.7-1.0
  lcc_power_rating_min_mw: '10000'
  max_converter_loss_threshold_pct: '2.0'
  max_fault_recovery_threshold_ms: '100'
  max_harmonic_distortion_threshold_pct: '3.0'
  max_leakage_current_threshold_ua: '50.0'
  vsc_loss_pct_range: 1.0-1.5
  vsc_power_rating_range_mw: 1000-3000
semantic:
  alternative_parents: []
