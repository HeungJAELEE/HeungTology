...
lineage:
  ...
  original_hash: 4e915bf6abe273ddb605351f4a2e2625d6f186c935712aa949bd42293b57e9f5
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] planetary-bio-defense-and-global-pathogen-surveillance-network에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  detection_speed_target_hr: 24
  node_uptime_threshold_pct: 95.0
  outbreak_alert_latency_threshold_hr: 48
  pathogen_match_accuracy_threshold_pct: 99.0
  quarantine_leak_rate_threshold: 0.01
semantic:
  alternative_parents: []
