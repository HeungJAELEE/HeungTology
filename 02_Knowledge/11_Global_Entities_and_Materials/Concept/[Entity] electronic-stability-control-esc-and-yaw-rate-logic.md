...
object:
  description: '[Entity] electronic-stability-control-esc-and-yaw-rate-logic에 관한 고밀도
    지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  abs_response_time_ms: 100
  critical_error_threshold: 8.0
  esc_response_time_ms: 50
  esc_version: V6.3.7
  fatality_reduction_percent: 30
  high_lateral_g_threshold: 0.8
  intent_modeling_coefficient: 0.12
  mild_error_threshold: 2.0
semantic:
  alternative_parents: []
