...
object:
  description: '[Entity] gas-engine-and-otto-cycle-thermodynamics-physics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  compression_pressure_warning_threshold_factor: 0.8
  compression_ratio_standard_max: 12.0
  compression_ratio_standard_min: 8.0
  critical_knock_intensity_threshold: 0.8
  max_exhaust_temp_c: 650.0
  min_spark_coil_voltage_kv: 15.0
  thermal_efficiency_high_max: 0.4
  thermal_efficiency_high_min: 0.3
semantic:
  alternative_parents: []
