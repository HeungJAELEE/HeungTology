...
object:
  description: '[Entity] logistics-and-supply-chain-systems-engineering에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  inventory_turn_min: '12'
  logistics_cost_revenue_ratio_max: '0.05'
  on_time_delivery_threshold: '0.99'
  order_fill_rate_threshold: '0.98'
  warehouse_utilization_min: '0.85'
semantic:
  alternative_parents: []
