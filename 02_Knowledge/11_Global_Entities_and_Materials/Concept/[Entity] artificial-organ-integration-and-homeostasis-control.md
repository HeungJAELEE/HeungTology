...
object:
  description: '[Entity] artificial-organ-integration-and-homeostasis-control에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  autonomy_years_threshold: 15.0
  data_fidelity_percent: 100.0
  hemolysis_index_threshold: 0.05
  homeostat_index_threshold: 0.998
  infection_rate_threshold: 0.1
  output_vs_baseline_threshold: 0.95
  pid_kp_gain: 0.5
  response_latency_ms_threshold: 100
