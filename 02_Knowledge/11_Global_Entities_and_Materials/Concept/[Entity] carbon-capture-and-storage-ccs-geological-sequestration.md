...
object:
  description: '[Entity] carbon-capture-and-storage-ccs-geological-sequestration에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  darcy_permeability_k: k
  darcy_viscosity_mu: mu
  injection_pressure_risk_ratio: 1.5
  leakage_critical_threshold_ppm: 500.0
  low_reservoir_pressure_bar: 100.0
  sequestration_depth_max_m: 3000
  sequestration_depth_min_m: 800
  storage_density_rho: rho_co2
  storage_porosity_phi: phi
  storage_water_saturation: S_water
semantic:
  alternative_parents: []
