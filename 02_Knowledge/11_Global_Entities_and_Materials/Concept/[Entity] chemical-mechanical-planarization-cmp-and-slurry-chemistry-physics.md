...
lineage:
  ...
  original_hash: d6637fd0b4262ed345429c4aa383bf7fbfc78fbe815e1a9f59d1e16c5095c1e5
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] chemical-mechanical-planarization-cmp-and-slurry-chemistry-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  abrasive_d50_nm_metal: 30-100
  abrasive_d50_nm_oxide: 50-150
  external_db_endpoint: cmp-slurry-ph-stability-and-removal-selectivity-v2026
  max_abrasive_size_scratch_limit_nm: 500
  metal_ph_range: 3-6
  min_selectivity_audit_threshold: 30.0
  oxide_ph_range: 10-12
  ph_drift_tolerance: 0.5
  removal_rate_angstrom_min_metal: 5000-8000
  removal_rate_angstrom_min_oxide: 2000-4000
  selectivity_ratio_metal_min: 50
  selectivity_ratio_oxide_min: 100
  solids_content_wt_percent_metal: 1-5
  solids_content_wt_percent_oxide: 10-30
semantic:
  alternative_parents: []
