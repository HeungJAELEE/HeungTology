...
object:
  ...
  tier: 1
properties:
  judder_vibration_threshold_ghz: 0.1
  low_friction_threshold_mu: 0.25
  mean_radius_formula: Rm = (2/3) * (ro^3 - ri^3) / (ro^2 - ri^2)
  thermal_overload_threshold_c: 250.0
  torque_capacity_formula: T = n * mu * F * Rm
  weak_clamping_force_threshold_kn: 5.0
semantic:
  alternative_parents: []
