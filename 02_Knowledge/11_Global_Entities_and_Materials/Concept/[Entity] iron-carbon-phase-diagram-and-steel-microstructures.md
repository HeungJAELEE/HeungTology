...
lineage:
  ...
  original_hash: d9effb9f0871a0140c3ecf8ade537e31d3d764a8e996cc89ae34676523fc0381
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] iron-carbon-phase-diagram-and-steel-microstructures에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  austenite_max_carbon_solubility_pct: 2.14
  cementite_carbon_solubility_pct: 6.7
  critical_grain_size_astm: 5
  critical_quenching_rate_threshold_c_s: 100
  ferrite_max_carbon_solubility_pct: 0.022
  gibbs_phase_rule: F = C - P + 2
  high_martensite_warning_threshold_pct: 95.0
  lever_rule: W_alpha = (C_gamma - C_0) / (C_gamma - C_alpha)
  optimal_pearlite_spacing_threshold_nm: 100
  pearlite_eutectoid_carbon_pct: 0.76
semantic:
  alternative_parents: []
