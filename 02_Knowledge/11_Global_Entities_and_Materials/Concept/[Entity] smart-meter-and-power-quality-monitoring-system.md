...
lineage:
  ...
  original_hash: 338ceaae9512a2e5125ea15ab411306108a592c5cc4ee7bbcdd84754863a0f58
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] smart-meter-and-power-quality-monitoring-system에 관한 고밀도 지능
    노드'
  object_type: Hardware
  tier: 1
properties:
  critical_voltage_sag_duration: 0.1s
  high_speed_pqa_error: ±0.1%
  industrial_class_error: ±0.5%
  industrial_sampling_rate: 64-128 S/cycle
  iot_sampling_rate: 8-16 S/cycle
  iot_smart_plug_error: ±2.0%
  pqa_sampling_rate: 1024+ S/cycle
  revenue_class_error: ±0.2%
  revenue_sampling_rate: 128-512 S/cycle
  sub_meter_class_error: ±1.0%
  sub_meter_sampling_rate: 16-32 S/cycle
  system_standard_frequency: 50/60 Hz
  voltage_sag_swell_threshold: 10-90%
semantic:
  alternative_parents: []
