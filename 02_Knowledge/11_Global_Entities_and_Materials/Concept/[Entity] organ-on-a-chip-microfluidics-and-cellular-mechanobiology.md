...
lineage:
  ...
  original_hash: 0eda2fa287ac6193267fdb19fd6ef655c957918eaa3f1515ecb0159188feb1ac
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] organ-on-a-chip-microfluidics-and-cellular-mechanobiology에
    관한 고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  mechanical_strain_range: 5-15%
  microscale_dimension_range: 10-100 um
  min_shear_force_threshold: 0.1
  reynolds_number_laminar_threshold: 10
  shear_stress_physiological_range: 1-10 dyne/cm2
  strain_accuracy_minimum_threshold: 90.0
  turbulence_critical_threshold: 2000
semantic:
  alternative_parents: []
