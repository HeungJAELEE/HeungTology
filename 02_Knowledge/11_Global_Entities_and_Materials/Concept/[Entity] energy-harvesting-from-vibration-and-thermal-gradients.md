...
object:
  description: '[Entity] energy-harvesting-from-vibration-and-thermal-gradients에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  audit_fidelity_version: Energy-Scavenge-v2026-Fidelity
  audit_status: MAXIMUM
  conversion_efficiency_range: 10% ~ 30%
  device_footprint_max: 1cm^2
  power_output_range: 10uW ~ 10mW
  system_resilience_level: High
  temp_gradient_threshold: 1K ~ 10K
  vibration_frequency_range: 10Hz ~ 100Hz
  voltage_regulation_requirement: HIGH
semantic:
  alternative_parents: []
