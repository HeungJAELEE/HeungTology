...
object:
  description: '[Entity] dashboard-design-and-data-visualization-principles에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  color_count_max: 5
  color_count_min: 3
  data_ink_ratio_min_target: 0.8
  data_ink_ratio_warning_threshold: 0.6
  insight_time_max_sec: 5
  lie_factor_critical_high: 1.1
  lie_factor_critical_low: 0.9
  lie_factor_max_target: 1.05
  lie_factor_min_target: 0.95
  pre_attentive_processing_time_sec: 0.2
  refresh_rate_max_ms: 500
  usability_reject_threshold_sec: 10
semantic:
  alternative_parents: []
