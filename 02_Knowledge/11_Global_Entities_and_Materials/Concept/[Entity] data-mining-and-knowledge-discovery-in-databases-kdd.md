...
object:
  description: '[Entity] data-mining-and-knowledge-discovery-in-databases-kdd에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  classification_accuracy_target_pct: 85
  clustering_silhouette_target_index: 0.5
  dirty_data_noise_threshold_pct: 10.0
  low_predictive_power_accuracy_threshold_pct: 75.0
  noise_robustness_max_err_rate_pct: 5
  pattern_lift_target_ratio: 2.0
  processing_scalability_complexity: O(n log n)
  spurious_correlation_lift_threshold: 1.1
semantic:
  alternative_parents: []
