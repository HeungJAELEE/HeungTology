...
lineage:
  ...
  original_hash: 6bd2393ad47a7754e9ace85665f10d2be41f8ac285a3e1db0a2c1bae25b788db
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] industrial-wastewater-treatment-and-chemical-precipitation-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  industrial_ph_range_max: 12.0
  industrial_ph_range_min: 2.0
  k_sp: solubility_product_constant
  optimal_ph_max: 10.0
  optimal_ph_min: 9.0
  stokes_law_velocity: vs
  target_removal_rate: 0.999
  turbidity_threshold_ntu: 50.0
semantic:
  alternative_parents: []
