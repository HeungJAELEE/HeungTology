...
lineage:
  ...
  original_hash: 946441cc5eba5707ac7be2d66ad14833fdcebab7052086a5bfaf04213136c4be
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] flexible-and-foldable-display-materials-and-mechanical-integrity에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  bending_strain_formula: epsilon = y / rho
  cpi_bend_radius_mm: 1.0-2.0
  cpi_durability_cycles: 300000
  cpi_hardness_mohs: 3-5
  cpi_thickness_um: 50-150
  cpi_transmittance_pct: 88
  elastic_stress_formula: sigma = E * epsilon
  max_crease_depth_um: 50
  min_peeling_force_threshold: 10.0
  utg_bend_radius_mm: 1.5-3.0
  utg_durability_cycles: 200000
  utg_hardness_mohs: 9
  utg_thickness_um: 30-100
  utg_transmittance_pct: 90
semantic:
  alternative_parents: []
