...
lineage:
  ...
  original_hash: b99d3b7ec3a6b56f7a9a3c65b0fd93fa87b1fb38e51ae9326313119bef03bccd
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] aviation-fuel-chemistry-and-sustainable-aviation-fuel-saf에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  fuel_freezing_threshold_celsius: -40.0
  jet_a1_energy_density_mj_kg: 43.1
  jet_a1_freezing_point_celsius: -47
  max_saf_blend_ratio_pct: 50.0
  max_sulfur_content_ppm: 3000
  min_energy_density_threshold_mj_kg: 42.0
  saf_carbon_reduction_pct: 70-80
  saf_energy_density_mj_kg_range: 42.8-43.5
semantic:
  alternative_parents: []
