...
lineage:
  ...
  original_hash: fc184d46905a90b5e37f4e14acf983f25be3fa32273eb98223069ab926a57432
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] high-performance-computing-and-cuda-architecture-fundamentals에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  compute_bound_comp_util_threshold: 90.0%
  low_warp_occupancy_threshold: 50.0%
  memory_bound_comp_util_threshold: 30.0%
  memory_bound_mem_util_threshold: 90.0%
  modern_cuda_compute_capability_threshold: '8.0'
semantic:
  alternative_parents: []
