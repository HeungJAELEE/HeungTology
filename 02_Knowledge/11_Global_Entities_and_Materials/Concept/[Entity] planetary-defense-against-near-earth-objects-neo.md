...
object:
  description: '[Entity] planetary-defense-against-near-earth-objects-neo에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  asteroid_porosity_threshold_pct: 50
  city_killer_diameter_range_m: 50-140
  detection_target_pct: 90.0
  global_extinction_diameter_min_m: 10000
  ideal_warning_time_years: 10
  regional_killer_diameter_range_m: 140-1000
  response_readiness_threshold_months: 24
  sky_coverage_threshold_pct: 90.0
  target_response_time_range_years: 2-5
  tracking_accuracy_threshold_arcsec: 0.01
semantic:
  alternative_parents: []
