...
lineage:
  ...
  original_hash: 42da61cb1f426bdd1f58b208d0f59dcad3bb4806a0be6225fac998f12b1a5556
metadata:
  date: '2026-05-16'
...
object:
  ...
  tier: 1
properties:
  crystallinity_formula: chi_c = ((rho_sample - rho_amorphous) / (rho_crystalline
    - rho_amorphous)) * 100
  draw_ratio_range: 4-8
  fiber_diameter_range: 10-50 um
  hermans_orientation_formula: f = (3*cos^2(theta) - 1) / 2
  min_crystallinity: 50%
  min_orientation_f: '0.9'
  min_tenacity: 20 g/den
  tenacity_formula: T = Breaking Load / Linear Density
semantic:
  alternative_parents: []
