...
object:
  description: '[Entity] robot-kinematics-and-autonomous-visual-slam-mechanics에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  dh_parameters: theta, d, a, alpha
  joint_backlash_threshold_deg: 0.05
  min_feature_count: 20
  slam_pose_drift_threshold_mm: 50.0
semantic:
  alternative_parents: []
