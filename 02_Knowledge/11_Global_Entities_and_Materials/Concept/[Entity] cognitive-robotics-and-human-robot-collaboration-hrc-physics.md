...
lineage:
  ...
  original_hash: a0f537db41ed415ec5c9321dcc8da1c257d855dc3f723d0823569cd255a77369
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] cognitive-robotics-and-human-robot-collaboration-hrc-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  cobot_payload_range_kg: 5-20
  hrc_force_limit_n: 150
  hrc_speed_limit_mms: 250
  intent_prediction_accuracy_min: 0.95
  interaction_warning_distance_mm: 500
  interaction_warning_speed_mms: 250
  proximity_speed_limit_mms: 50
  proximity_zone_threshold_mm: 200
  safe_stop_response_time_ms: 1
  target_incident_probability: 1.0e-05
semantic:
  alternative_parents: []
