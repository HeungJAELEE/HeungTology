...
object:
  description: '[Entity] computer-vision-for-robotic-scene-understanding-and-object-segmentation에
    관한 고밀도 지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  diagnostic_diversity_notice_threshold: 50
  diagnostic_fps_warning_threshold: 15.0
  diagnostic_miou_critical_threshold: 75.0
  external_db_endpoint: robotic-vision-segmentation-accuracy-and-iou-metrics-v2026
  high_precision_boundary_error_px: 1
  high_precision_class_diversity_threshold: 150
  high_precision_fps_threshold: 5
  high_precision_input_resolution: 2048x2048
  high_precision_miou_threshold: 85
  realtime_boundary_error_px: 5
  realtime_class_diversity_range: 10-50
  realtime_fps_threshold: 30
  realtime_input_resolution: 512x512
  realtime_miou_threshold: 65
semantic:
  alternative_parents: []
