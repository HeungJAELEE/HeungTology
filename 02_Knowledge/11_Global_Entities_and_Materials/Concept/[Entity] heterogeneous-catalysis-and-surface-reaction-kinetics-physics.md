...
object:
  description: '[Entity] heterogeneous-catalysis-and-surface-reaction-kinetics-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  catalyst_bed_fouling_factor: 2.0
  catalyst_deactivation_threshold_factor: 0.8
  isotherm_model: langmuir
  max_temp_range_celsius: 1000
  primary_quality_metric: specific_surface_area
  purity_threshold_pct: 99.0
  reaction_rate_model: langmuir_hinshelwood
semantic:
  alternative_parents: []
