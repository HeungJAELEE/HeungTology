...
object:
  description: '[Entity] embedded-system-and-real-time-operating-system-rtos-logic에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  critical_latency_threshold_us: 50.0
  notice_jitter_threshold_ns: 1000
  rms_utilization_bound: n(2^(1/n)-1)
  rtos_version_reference: V6.3.7
  warning_cpu_load_threshold_pct: 85.0
semantic:
  alternative_parents: []
