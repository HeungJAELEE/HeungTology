...
object:
  description: '[Entity] reentry-heat-shield-physics-and-ablation-materials에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  audit_fidelity_code: Fire-Proof-v2026-Fidelity
  heat_flux_threshold_mw_m2: 10
  insulation_efficiency_min_percent: 99
  peak_temp_threshold_c: 2000
