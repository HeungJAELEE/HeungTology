...
lineage:
  ...
  original_hash: 24ed40ed5c96833a4dc4b9410b7cbcadfad1089d892f98e17571b9220afdd67c
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] computer-architecture-and-high-performance-computing에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  memory_tech_standard: HBM3/HBM3e
  min_hardware_utilization_threshold: 0.3
  min_hpc_memory_bandwidth_gbps: 500
  min_parallel_efficiency_threshold: 0.7
  supercomputer_energy_efficiency_gflops_w: '> 50'
  supercomputer_interconnect_bandwidth_gbps: '> 400'
  supercomputer_peak_fp64_tflops: '> 1,000,000'
  supercomputer_total_nodes_cores: '> 100,000'
semantic:
  alternative_parents: []
