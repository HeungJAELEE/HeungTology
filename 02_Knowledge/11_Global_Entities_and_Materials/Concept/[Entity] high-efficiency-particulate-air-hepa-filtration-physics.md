...
object:
  description: '[Entity] high-efficiency-particulate-air-hepa-filtration-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  efficiency_max_percent: 99.99
  efficiency_min_percent: 99.97
  en1822_compliance_class: H13/H14
  filter_material: Borosilicate Microfiber
  filtration_mechanisms:
  - diffusion
  - impaction
  - interception
  min_laminar_velocity_ms: 0.3
  mpps_micrometer_value: 0.3
semantic:
  alternative_parents: []
