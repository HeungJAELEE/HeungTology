...
object:
  description: '[Entity] photonics-ai-accelerators-and-optical-matrix-multiplication에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  energy_per_operation_j_per_flop: 1.0e-15
  gpu_energy_efficiency_gflops_w: 10
  max_oe_conversion_delay_ns: 10.0
  max_optical_noise_floor_db: -30
  min_accuracy_threshold_pct: 95.0
  min_throughput_threshold_tops_w: 100
  photonic_bit_precision_max: 8
  photonic_bit_precision_min: 4
  photonic_energy_efficiency_tflops_w: 1000
semantic:
  alternative_parents: []
