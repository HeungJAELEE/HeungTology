...
object:
  description: '[Entity] gradient-descent-and-optimization-calculus-logic에 관한 고밀도
    지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  brute_force_complexity: 2^n
  convergence_loss_threshold: '0.001'
  gradient_descent_complexity: polynomial
  learning_rate_range: 0.001-0.1
  loss_explosion_multiplier: '1.5'
