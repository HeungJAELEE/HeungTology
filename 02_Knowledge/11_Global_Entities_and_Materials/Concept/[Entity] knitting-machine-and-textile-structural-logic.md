...
lineage:
  ...
  original_hash: 802fecd71ada16e6aa6581b9d2caa80fdfbf41ff03a3c590754f099e0815854d
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] knitting-machine-and-textile-structural-logic에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  capstan_equation_formula: F_tension = mu * theta * e^(mu * alpha)
  diagnostic_engine_name: FactoryFidelityEngine
  high_density_needle_count: 4000
  max_industrial_speed_stitches_min: 2000000
  precision_tolerance_mm: 0.01
  stitch_length_formula: 4w + 2d + 3.14t
semantic:
  alternative_parents: []
