...
object:
  description: '[Entity] polymer-science-and-plastic-manufacturing-processes에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  glass_transition_temp_range: 50-200
  melt_flow_index_range: 0.1-100
  min_process_temperature: '180.0'
  min_tensile_strength_mpa: '40.0'
  pdi_critical_threshold: '5.0'
  thermal_stability_offset_min: '20.0'
semantic:
  alternative_parents: []
