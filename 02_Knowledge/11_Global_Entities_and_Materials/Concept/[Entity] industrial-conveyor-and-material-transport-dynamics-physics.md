...
lineage:
  ...
  original_hash: d50e5c2443a380fe70342a62c76133d67eb7add49b215aff8e85a461d4c490dc
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] industrial-conveyor-and-material-transport-dynamics-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  belt_friction_logic: euler_eytelwein
  drive_logic: vfd_s_curve_acceleration
  friction_control_method: active_tensioning_hydraulic
  industrial_conveyor_capacity_units_hr: 10000+
  industrial_conveyor_speed_range_ms: 1.0-5.0
  motor_overload_threshold_multiplier: 1.2
  velocity_drop_threshold_multiplier: 0.9
semantic:
  alternative_parents: []
