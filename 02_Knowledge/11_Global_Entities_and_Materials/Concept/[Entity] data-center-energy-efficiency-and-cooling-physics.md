...
object:
  description: '[Entity] data-center-energy-efficiency-and-cooling-physics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  critical_inlet_temp: 35.0
  delta_t_advanced: 15-25
  delta_t_traditional: 10-15
  min_cooling_redundancy: 1.0
  pue_advanced_range: 1.05-1.15
  pue_critical_threshold: 1.8
  pue_ideal: 1.0
  pue_traditional_range: 1.6-2.0
  rack_density_advanced: 50-100
  rack_density_traditional: 5-10
  wue_advanced: < 0.2
  wue_traditional: '> 1.5'
semantic:
  alternative_parents: []
