...
lineage:
  ...
  original_hash: e24d8061b71d76bf01f3395e214d906a781d6cd15687785d3afb1332d07110f5
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] quantum-dot-synthesis-and-size-quantization-physics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  brus_equation_relationship: E_qd ~ 1/R^2
  core_shell_min_layers: 2
  fwhm_max_nm: 30
  heisenberg_uncertainty_principle: delta_p * delta_x >= h_bar / 2
  lifetime_ns_range: 10-100
  particle_diameter_range_nm: 2-10
  quantum_yield_min_percent: 90
semantic:
  alternative_parents: []
