...
lineage:
  ...
  original_hash: e1814987bc982c9cc5085de746d36c7e0184ba60f99f7c230f9905b21c88b5dc
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] sustainable-construction-materials-and-green-building에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  building_lifespan_threshold: 100 years
  embodied_carbon_reduction_target: 30%
  leed_certification_target: GOLD/PLATINUM
  operational_energy_threshold: 50 kWh/m^2y
  recycled_content_threshold: 20%
  u_value_threshold: 0.15 W/m^2K
  water_recycle_threshold: 40%
semantic:
  alternative_parents: []
