...
object:
  description: '[Entity] isolated-and-non-isolated-systems-in-thermodynamics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  energy_conservation_equation: dE_sys/dt = Q_dot - W_dot + sum(m_in * theta_in) -
    sum(m_out * theta_out)
  exergy_calculation_model: A = U + P0V - T0S
  hds_gold_standard: V6.3.7
  steady_flow_entropy_delta: 0
semantic:
  alternative_parents: []
