...
object:
  description: '[Entity] organizational-culture-and-leadership-governance에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  compliance_drift_threshold: 0.95
  governance_version: V6.3.7
  integrity_violation_critical_threshold: 0
  leadership_impact_formula: sum(w_i * trust_i * communication_i)
  leadership_pipeline_readiness_threshold: 0.7
  strategic_fit_index_formula: sum(goal_individual * goal_corporate) / N
  trust_index_high_fidelity_threshold: 0.85
  trust_index_toxic_threshold: 0.4
  trust_warning_threshold: 0.6
  turnover_rate_healthy_threshold: 0.05
  turnover_rate_toxic_threshold: 0.2
semantic:
  alternative_parents: []
