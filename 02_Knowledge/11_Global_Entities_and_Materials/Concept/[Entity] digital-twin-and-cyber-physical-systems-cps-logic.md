...
object:
  description: '[Entity] digital-twin-and-cyber-physical-systems-cps-logic에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  critical_drift_error_threshold_pct: 5.0
  data_points_autonomous_count_range: 10^5-10^7
  data_points_monitoring_count: 100
  fidelity_error_autonomous_max_pct: 0.1
  fidelity_error_monitoring_max_pct: 10
  high_latency_warning_threshold_ms: 100
  low_predictive_fidelity_threshold_pct: 90.0
  sensor_reliability_min_threshold: 0.99
  sync_latency_autonomous_max_ms: 10
  sync_latency_monitoring_max_ms: 1000
semantic:
  alternative_parents: []
