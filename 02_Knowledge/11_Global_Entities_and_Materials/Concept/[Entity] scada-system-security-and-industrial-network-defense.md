...
object:
  description: '[Entity] scada-system-security-and-industrial-network-defense에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  ...
  ot_device_lifespan_max_years: 30
  ot_device_lifespan_min_years: 10
  packet_latency_threshold_ms: 50.0
  risk_formula: threat * vulnerability * impact
  scada_security_version: V6.3.7
