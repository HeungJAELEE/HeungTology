...
object:
  description: '[Entity] digital-twin-architecture-and-cps-integration에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  data_throughput_threshold: 1GB/s
  energy_optimization_threshold: '0.15'
  fidelity_formula: 1 - (||P(t) - D(t)|| / ||P(t)||)
  interoperability_protocols: OPC-UA, MQTT
  latency_formula: t_d - t_p
  model_fidelity_threshold: '0.95'
  prediction_accuracy_threshold: '0.90'
  sync_latency_threshold: 10ms
  virtual_commissioning_reduction_rate: '0.80'
semantic:
  alternative_parents: []
