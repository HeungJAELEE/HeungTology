...
lineage:
  ...
  original_hash: 096a0c0731e78a45539358bbfee19ca699b44af34f9e5915ce234340d31d5955
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] crystal-plasticity-and-dislocation-dynamics-at-micro-scale에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  annealed_state_threshold: 1e9 m^-2
  burgers_vector_range: 0.2 to 0.3 nm
  critical_stress_multiplier: 1.5
  dislocation_density_range: 10^10 to 10^14 m^-2
  dislocation_saturation_threshold: 1e15 m^-2
  hardening_coefficient_range: 0.1 to 0.5
  peierls_stress_range: 1 to 100 MPa
  shear_modulus_range: 20 to 200 GPa
semantic:
  alternative_parents: []
