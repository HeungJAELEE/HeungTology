...
lineage:
  ...
  original_hash: fb4646c15785a705e7a6ecd218eecb687bbf13db837ec122a25e2f8b385a9031
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] flexible-printed-circuit-fpc-and-polyimide-substrate-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  end_of_dynamic_life_cycles: 200000
  fpc_max_temp_celsius: 400
  fpc_thickness_mm: 0.05 - 0.1
  min_bend_radius_formula: t / (2 * epsilon_max)
  neutral_axis_stress_formula: sigma = E * (y / rho)
  peel_strength_warning_threshold_n_mm: 0.6
  resistance_increase_critical_pct: 10.0
semantic:
  alternative_parents: []
