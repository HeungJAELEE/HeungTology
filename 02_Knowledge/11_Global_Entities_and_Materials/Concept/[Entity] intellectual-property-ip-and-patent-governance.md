...
object:
  description: '[Entity] intellectual-property-ip-and-patent-governance에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  fto_risk_critical_threshold: 0.6
  ip_value_formula: sum(Net Cash Flow from IP / (1+r)^t)
  litigation_vulnerability_notice_threshold: 0.5
  patent_efficiency_formula: Granted Patents / R&D Investment
  portfolio_strength_warning_threshold: 40.0
