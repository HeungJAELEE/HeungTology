...
lineage:
  ...
  original_hash: f1fa208a8c3d3a11339fa04f1a35b2dd3ac4b84e9c7739eae8127e87f4fb7a6a
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] international-standards-and-global-compliance-iso-iec-etc에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  certification_expiry_warning_days: 30
  compliance_index_formula: sum(w_i * score_i)
  critical_non_compliance_threshold: 3
  efficiency_proportionality_factor: 1 / diversity_of_local_standards
  minimum_standard_sync_rate: 1.0
  suboptimal_audit_readiness_threshold: 80.0
semantic:
  alternative_parents: []
