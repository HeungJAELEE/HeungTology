...
object:
  description: '[Entity] cyclone-separator-and-centrifugal-particle-dynamics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  centrifugal_force_formula: F_c = m * v^2 / r
  cut_off_diameter_formula: d_pc = sqrt((9 * mu * B) / (2 * pi * N * v * (rho_p -
    rho_g)))
  hopper_blockage_velocity_threshold_m_s: 18.0
  inlet_velocity_critical_threshold_m_s: 15.0
  pressure_drop_warning_threshold_pa: 2500.0
  target_particle_size_micron: 5.0
  vortex_finder_wear_threshold_mm: 5.0
semantic:
  alternative_parents: []
