...
object:
  description: '[Entity] fluid-catalytic-cracking-fcc-and-petroleum-refining-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  critical_sintering_temp_c: 750.0
  fcc_octane_range:
  - 85
  - 95
  fcc_pressure_max_bar: 2
  fcc_temp_range_c:
  - 500
  - 550
  gasoline_yield_fcc_max_pct: 60
  gasoline_yield_fcc_min_pct: 45
  lean_catalyst_c_to_o_threshold: 5.0
  low_conversion_rot_threshold_c: 510.0
semantic:
  alternative_parents: []
