...
object:
  description: '[Entity] incoterms-2020-and-international-trade-governance에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  cip_min_insurance_coverage: 110.0
  landed_cost_formula: invoice_price + incoterm_adjusted_logistics_cost
  sea_transport_modes:
  - Sea
  - Inland Water
semantic:
