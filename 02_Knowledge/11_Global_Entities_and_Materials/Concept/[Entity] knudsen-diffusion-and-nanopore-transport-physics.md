...
lineage:
  ...
  original_hash: 06e5b73a4d63dbfc6bead99ca289ae84d8fd1af5b717c29c9c2cba8989ddf79f
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] knudsen-diffusion-and-nanopore-transport-physics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  flow_regime: knudsen_molecular
  flux_clogging_threshold_ratio: 0.7
  kn_threshold_optimal_diffusion: 10.0
  kn_threshold_selectivity_loss: 0.1
  knudsen_diffusion_coefficient_formula: d/3 * sqrt(8RT / (pi * M))
  knudsen_number_formula: lambda / d
  pore_size_range_um: 0.001 ~ 0.1
semantic:
  alternative_parents: []
