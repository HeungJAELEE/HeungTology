...
lineage:
  ...
  original_hash: e0b5c0630578a34304abaf4e6c23f51658150b9337505918ebfb18a9b5616d9a
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] robot-sensor-fusion-lidar-imu-and-extended-kalman-filter-ekf에
    관한 고밀도 지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  covariance_convergence_status: stable
  estimation_error_threshold: < 10 cm
  extrinsic_calibration_threshold: < 0.1 deg
  fusion_latency_threshold: < 10 ms
  information_gain_status: maximized
  outlier_rejection_threshold: '> 99 %'
  sensor_sync_threshold: < 100 us
  update_rate_threshold: '> 100 Hz'
semantic:
  alternative_parents: []
