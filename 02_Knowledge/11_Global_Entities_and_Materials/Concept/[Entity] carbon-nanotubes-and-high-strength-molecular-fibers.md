...
object:
  description: '[Entity] carbon-nanotubes-and-high-strength-molecular-fibers에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  aramid_density_gcm3: 1.44
  aramid_tensile_modulus_gpa_range: 70-130
  aramid_tensile_strength_gpa_max: 3.5
  aramid_tensile_strength_gpa_min: 2.5
  cnt_density_gcm3: 1.3
  cnt_tensile_modulus_gpa: 1000
  cnt_tensile_strength_gpa_max: 100
  cnt_tensile_strength_gpa_min: 50
  crystallinity_critical_threshold_pct: 70.0
  elongation_pct_range: 2-5
  external_db_endpoint: molecular-fiber-tensile-modulus-and-crystallinity-v2026
  steel_density_gcm3: 7.8
  steel_tensile_modulus_gpa: 210
  steel_tensile_strength_gpa_max: 2.0
  steel_tensile_strength_gpa_min: 1.0
  theoretical_strength_modulus_ratio: 0.1
  thermal_degradation_warning_threshold_c: 120.0
  uhmwpe_density_gcm3: 0.97
  uhmwpe_tensile_modulus_gpa: 120
  uhmwpe_tensile_strength_gpa_max: 4.0
  uhmwpe_tensile_strength_gpa_min: 3.5
semantic:
  alternative_parents: []
