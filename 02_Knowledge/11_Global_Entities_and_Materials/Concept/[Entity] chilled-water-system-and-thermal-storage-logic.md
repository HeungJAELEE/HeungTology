...
lineage:
  ...
  original_hash: 0499334a3f3ee02d465879049e05cf98a5892bc4be8a2f0c2a8a44eb2a9cc135
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] chilled-water-system-and-thermal-storage-logic에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  air_cooled_cop_range: 2.5-3.5
  air_cooled_lifespan_years: 10-15
  central_chilled_water_cop_range: 5.0-7.0
  central_chilled_water_lifespan_years: 20-30
  chilled_water_delta_t_threshold: 3.0
  optimal_delta_t_range: 5-7
  phase_change_uniformity_threshold: 0.85
  plant_cop_threshold: 4.0
  storage_reserve_pct_threshold: 10.0
semantic:
  alternative_parents: []
