...
object:
  description: '[Entity] big-data-analytics-for-predictive-factory-optimization에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  data_quality_threshold_pct: 99.9
  engine_confidence_threshold: 0.85
  false_alarm_threshold_pct: 1.0
  inference_latency_threshold_ms: 10.0
  ingest_latency_threshold_ms: 100.0
  insight_to_action_threshold_min: 5.0
  predict_fidelity_threshold_pct: 95.0
  specification_standard: HDS-Gold V6.3.7
  yield_gain_threshold_pct: 3.0
semantic:
  alternative_parents: []
