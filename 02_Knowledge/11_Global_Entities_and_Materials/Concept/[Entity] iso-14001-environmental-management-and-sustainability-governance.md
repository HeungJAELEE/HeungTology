...
lineage:
  ...
  original_hash: 188ad8e91181848649acf32c5b7fa634f195890bc4ebb263e0391051d494fb4b
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] iso-14001-environmental-management-and-sustainability-governance에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  e_impact_formula: sum(resource_usage * impact_factor)
  iso_governance_version: 6.3.7
  logic_fidelity_engine_parameters:
  - carbon_emission_ton
  - water_recycling_rate_pct
  - regulatory_violation_count
  regulatory_violation_threshold: 0
  water_recycling_threshold_pct: 60.0
semantic:
  alternative_parents: []
