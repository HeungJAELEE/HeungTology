...
object:
  description: '[Entity] industrial-control-system-ics-cybersecurity-architecture에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  max_network_jitter_ms: 10.0
  max_shadow_rule_count: 5
  patch_compliance_threshold_pct: 90.0
  risk_calculation_formula: threat * vulnerability * impact
  unauthorized_access_threshold: 0
semantic:
  alternative_parents: []
