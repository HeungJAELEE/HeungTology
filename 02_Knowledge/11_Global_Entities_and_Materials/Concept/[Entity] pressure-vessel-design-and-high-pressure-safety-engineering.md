...
lineage:
  ...
  original_hash: 431c768b056ab59e9b315526945fd29b532f1c4964af4bfed154dc7b6fd144f8
metadata:
  date: '2026-05-16'
  domain: 11_Global_Entities_and_Materials
  id: '[[[Entity] pressure-vessel-design-and-high-pressure-safety-engineering]]'
  last_updated: '2026-05-17T22:59:20+09:00'
  project: Vault_Modernization
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: '[Entity] pressure-vessel-design-and-high-pressure-safety-engineering에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  burst_pressure_formula: sigma_u * ln(Ro / Ri)
  critical_stress_threshold_mpa: 250
  design_code_standard: ASME BPVC Section VIII
  high_pressure_joint_efficiency: 1.0
  high_pressure_range_bar: 100 ~ 1,000+
  high_pressure_safety_factor: 3.5 ~ 4.0
  hoop_stress_formula: P * D / (2 * t)
  max_prv_set_point_bar: 110.0
  min_corrosion_allowance_mm: 1.0
  min_design_metal_temp_c: -20
semantic:
  alternative_parents: []
