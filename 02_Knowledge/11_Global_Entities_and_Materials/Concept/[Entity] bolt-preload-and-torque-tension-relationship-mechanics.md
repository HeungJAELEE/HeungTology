...
lineage:
  ...
  original_hash: f8379407095d6714a3e6c0372782e5bb7e8a0c0dbf7da94bf0427b839103b5cf
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] bolt-preload-and-torque-tension-relationship-mechanics에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  k_factor_critical_threshold: 0.3
  k_factor_warning_threshold: 0.1
  nominal_environmental_temp_c: 20.0
  thermal_expansion_deviation_threshold_c: 40.0
  torque_controlled_energy_transfer_pct: 10-15
  torque_controlled_friction_loss_pct: 85-90
  torque_controlled_preload_accuracy_pct: 10-25
  torque_to_tension_efficiency_ratio: 0.1
semantic:
  alternative_parents: []
