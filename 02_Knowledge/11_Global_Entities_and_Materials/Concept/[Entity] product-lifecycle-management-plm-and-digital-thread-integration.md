...
lineage:
  ...
  original_hash: ac0347c78e1228cb01e20294e1e131d2458a8d50b29171875dd9efe5278a1579
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] product-lifecycle-management-plm-and-digital-thread-integration에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  bom_mismatch_threshold: 0
  data_continuity_score_threshold: 0.95
  data_fidelity_formula: product(1 - epsilon_step)
  eco_cycle_time_threshold_days: 14
  plm_version: V6.3.7
  time_to_market_formula: T_design + T_mfg + T_cert
semantic:
  alternative_parents: []
