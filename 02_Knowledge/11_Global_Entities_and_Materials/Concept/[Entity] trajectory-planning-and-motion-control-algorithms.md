...
object:
  description: '[Entity] trajectory-planning-and-motion-control-algorithms에 관한 고밀도
    지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  interp_cycle_max: 1 ms
  max_acceleration_min: 20 m/s^2
  max_jerk_status: limiter_active
  max_torque_constraint: tau_max
  max_velocity_range: 1.0-5.0 m/s
  path_smoothness_type: C2 continuity
  tracking_error_max: 5 um
  voltage_limit_constraint: V_max
semantic:
  alternative_parents: []
