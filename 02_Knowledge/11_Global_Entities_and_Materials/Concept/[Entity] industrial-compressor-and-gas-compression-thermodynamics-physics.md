...
object:
  description: '[Entity] industrial-compressor-and-gas-compression-thermodynamics-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  isentropic_efficiency_benchmark: 0.85
  isentropic_work_formula: W = (k/(k-1)) * P1 * V1 * ((P2/P1)^((k-1)/k) - 1)
  low_pressure_threshold_factor: 0.9
  pressure_ratio_fan_blower_max: 1.1
  pressure_ratio_industrial_range: 2.0-20.0+
  supported_mediums:
  - air
  - n2
  - h2
  - natural_gas
  temperature_rise_formula: T2 = T1 * (P2/P1)^((k-1)/k)
  thermal_critical_threshold_c: 110.0
semantic:
  alternative_parents: []
