...
object:
  description: '[Entity] flame-retardant-material-and-thermal-decomposition-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  activation_energy: Ea
  char_yield_warning_threshold_pct: 20.0
  gas_constant: R
  hrr_critical_threshold_kw_m2: 200.0
  loi_threshold_self_extinguishing: 27
  smoke_toxicity_index_threshold: 1.5
semantic:
  alternative_parents: []
