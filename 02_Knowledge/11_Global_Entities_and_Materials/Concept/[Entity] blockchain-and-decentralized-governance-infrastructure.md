...
object:
  description: '[Entity] blockchain-and-decentralized-governance-infrastructure에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  bias_monitoring_precision_percent: 0.1
  block_time_latency_max_sec: 12
  block_time_tolerance_sec: 2
  data_source_ref: blockchain-node-distribution-and-governance-participation-v2026
  gini_coefficient_critical_threshold: 0.6
  min_active_nodes: 10000
  node_distribution_warning_threshold: 0.3
  quorum_threshold_min_percent: 15
  quorum_threshold_tolerance_percent: 2
  throughput_tps_min: 2000
  voting_period_days_max: 7
  voting_period_days_min: 3
  voting_period_tolerance_days: 0.5
semantic:
  alternative_parents: []
