...
object:
  description: '[Entity] global-supply-chain-and-logistics-management-system에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  bottleneck_jitter_sigma_threshold: 3.0
  bullwhip_amplification_limit: 1.1
  logistics_cost_ratio_threshold: 0.07
  on_time_delivery_threshold: 0.99
  optimized_lead_time_days: 20
  real_time_tracking_threshold: 0.995
  recovery_time_threshold_hours: 48
  visibility_integrity_threshold: 0.95
semantic:
  alternative_parents: []
