...
lineage:
  ...
  original_hash: dc5ab0cd608983a34e525908e972d3d77ffca0b66581d8bfe23467e5cb7bf39d
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] molecular-beam-epitaxy-mbe-and-atomic-layer-precision-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  interface_roughness_threshold_nm: 0.3
  layer_coverage_theta_formula: integral(J/N dt)
  mbe_growth_rate_max_um_hr: 1.0
  mbe_growth_rate_min_um_hr: 0.01
  mbe_vacuum_level_max_torr: 1.0e-10
  mbe_vacuum_level_min_torr: 1.0e-11
  molecular_beam_flux_j_formula: P / sqrt(2 * pi * m * k_B * T)
  rheed_oscillation_stability_threshold: 0.8
  shutter_latency_threshold_ms: 50
  vacuum_pressure_critical_threshold_torr: 1.0e-09
semantic:
  alternative_parents: []
