...
lineage:
  ...
  original_hash: b1c65b19f7de482e33c3e4d140459a8674ed1299b4a4623f3ffe59adec073727
metadata:
  date: '2026-05-16'
...
object:
  ...
  tier: 1
properties:
  operating_temperature_target: 15mK
  operating_temperature_tolerance: 1mK
  performance_audit_method: Randomized Benchmarking
  readout_fidelity_target: 99.5%
  readout_fidelity_tolerance: 0.05%
  state_dynamics_model: Lindblad Master Equation
  t1_relaxation_time_target: 300us
  t1_relaxation_time_tolerance: 10us
  t2_coherence_time_target: 200us
  t2_coherence_time_tolerance: 5us
  two_qubit_gate_fidelity_target: 99.9%
  two_qubit_gate_fidelity_tolerance: 0.01%
semantic:
  alternative_parents: []
