...
lineage:
  ...
  original_hash: 6279ddd81c987aab42611f7c597f46bfc2aeab9714a89ea6374243f3425720f7
metadata:
  date: '2026-05-16'
...
object:
  ...
  tier: 1
properties:
  abrahams_law_formula: f'_c = A / B^{w/c}
  avrami_kinetics_formula: alpha(t) = 1 - exp(-kt^n)
  critical_hydration_heat_threshold: 70.0
  critical_wc_threshold: 0.6
  hpc_compressive_strength_mpa: 60-120
  hpc_wc_ratio_range: 0.2-0.35
  lean_compressive_strength_mpa: 15-25
  lean_wc_ratio_range: 0.6-0.7
  min_maturity_index: 400
  min_slump_value_mm: 50
semantic:
  alternative_parents: []
