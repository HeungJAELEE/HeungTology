...
object:
  description: '[Entity] heat-exchanger-design-and-thermal-management-systems에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  effectiveness_min: '0.8'
  fin_efficiency_min: '0.9'
  fouling_factor_max: 0.0005 m^2K/W
  fuel_cost_saving_threshold: 40%
  overall_heat_transfer_coefficient_min: 500 W/m^2K
  pressure_drop_max: 10 psi
semantic:
  alternative_parents: []
