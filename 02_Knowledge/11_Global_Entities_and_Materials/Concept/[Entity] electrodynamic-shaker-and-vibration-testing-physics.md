...
object:
  description: '[Entity] electrodynamic-shaker-and-vibration-testing-physics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  critical_coil_temperature_c: 130.0
  electrodynamic_acceleration_g: 100+
  electrodynamic_frequency_range_hz: 5 - 5,000
  forced_vibration_equation: M x'' + c x' + k x = F(t)
  g_level_deviation_threshold: 2.0
  high_load_temperature_threshold_c: 100.0
  lorentz_force_formula: F = B I L
  specimen_failure_transmissibility_ratio_threshold: 10.0
semantic:
  alternative_parents: []
