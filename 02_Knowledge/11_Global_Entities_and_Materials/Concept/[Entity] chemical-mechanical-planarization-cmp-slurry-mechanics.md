...
object:
  description: '[Entity] chemical-mechanical-planarization-cmp-slurry-mechanics에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  abrasive_size_range_nm: 30-100
  dishing_erosion_threshold_nm: 20
  planarity_step_threshold_nm: 10
  preston_equation: RR = Kp * P * V
  removal_rate_error_threshold_percent: 5
  removal_rate_range_nm_min: 200-500
  selectivity_ratio_threshold: 100
  slurry_ph_status: strictly_controlled
  wiwnu_target_percent: 1
semantic:
  alternative_parents: []
