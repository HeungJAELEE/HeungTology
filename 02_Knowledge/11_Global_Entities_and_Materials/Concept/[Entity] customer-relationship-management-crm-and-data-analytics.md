...
lineage:
  ...
  original_hash: 64ef84ef0499f21d4258624b0c651bf561cd6895012efd3beabdd5204b1e2a5c
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] customer-relationship-management-crm-and-data-analytics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  analytics_latency_max_hours: 1
  conversion_uplift_min_multiplier: 3.0
  customer_match_rate_warning_threshold: 90.0
  data_accuracy_critical_threshold: 95.0
  db_records_min: 1000000
  rfm_f_coefficient: 10
  rfm_m_coefficient: 1
  rfm_r_coefficient: 100
  roi_min_percent: 500
  sync_rate_min_percent: 98
semantic:
  alternative_parents: []
