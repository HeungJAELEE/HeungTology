...
lineage:
  ...
  original_hash: 0a91673f1aebfe27cad4d713125f3bc4a6052f9c135b59c4acffe80a9ad4e3f6
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] gas-turbine-and-brayton-cycle-thermodynamics-physics에 관한
    고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  cdp_fouling_threshold: 0.9 * target
  combined_cycle_efficiency_min: 60%
  critical_vibration_threshold: 12.0mm/sec
  firing_temperature_range: 1200-1600C
  gas_turbine_efficiency_range: 35-45%
  tit_warning_threshold: 1500.0C
semantic:
  alternative_parents: []
