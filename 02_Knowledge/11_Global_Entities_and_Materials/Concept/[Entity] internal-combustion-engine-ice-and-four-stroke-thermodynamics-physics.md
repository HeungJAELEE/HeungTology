...
object:
  description: '[Entity] internal-combustion-engine-ice-and-four-stroke-thermodynamics-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  compression_ratio_param: r
  high_exhaust_temp_threshold_c: 950.0
  max_rpm_ice: 6000
  rich_mixture_lambda_threshold: 0.9
  specific_heat_ratio_param: k
  thermal_efficiency_ice_max_percent: 50
  thermal_efficiency_ice_min_percent: 35
semantic:
  alternative_parents: []
