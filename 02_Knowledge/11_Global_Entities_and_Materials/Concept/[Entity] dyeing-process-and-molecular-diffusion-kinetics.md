...
object:
  description: '[Entity] dyeing-process-and-molecular-diffusion-kinetics에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  dyeing_temp_range_celsius: 60-130
  max_delta_e_tolerance: 1.0
  max_safe_temp_celsius: 135.0
  optimal_ph_level: 4.5
  ph_deviation_threshold: 1.0
  polyester_min_diffusion_temp_celsius: 95.0
semantic:
  alternative_parents: []
