...
lineage:
  ...
  original_hash: eef608dd2a0d68cb3e4c77ec63f3b33ed2e64f598aec3cb7297387884b2285e3
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] magnetorheological-fluid-mr-fluid-and-adaptive-damping-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  bingham_rheology_model: tau = tau_y(H) + eta * gamma_dot
  critical_thermal_degradation_threshold_c: 130
  field_induced_yielding_model: tau_y(H) = alpha * H^beta
  iron_particle_size_um: 3-5
  magnetic_saturation_threshold_t: 2.1
  operating_temp_range_c: -40 to 150
  power_consumption_max_w: 50
  response_time_max_ms: 10
  sedimentation_detection_threshold_ratio: 0.8
  yield_strength_range_kpa: 50-100
semantic:
  alternative_parents: []
