...
lineage:
  ...
  original_hash: 443b9778ddb6f6adc20ed77569708276a0d3a880605f48ca834bfc334ef216f8
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] smart-factory-automation-standard-and-connectivity에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  cyber_security_standard: IEC 62443
  data_latency_threshold: < 20 ms
  interoperability_standard: OPC-UA/VGR
  jitter_threshold: < 5 ms
  node_density_threshold: '> 1,000/km2'
  oee_target: '> 85%'
  packet_loss_threshold: < 0.01%
  throughput_threshold: '> 100 Mbps'
  urllc_latency_threshold: < 10 ms
semantic:
  alternative_parents: []
