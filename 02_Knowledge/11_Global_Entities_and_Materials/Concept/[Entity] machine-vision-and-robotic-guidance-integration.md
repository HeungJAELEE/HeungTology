...
object:
  description: '[Entity] machine-vision-and-robotic-guidance-integration에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  angular_precision_degree: 0.1
  calibration_drift_error_threshold: 0.8
  control_loop_latency_threshold_ms: 50
  coordinate_latency_max_ms: 30
  pose_accuracy_3d_mm: 0.05
  pose_variance_warning_threshold: 0.15
  reprojection_error_max_pixel: 0.5
  robustness_ambient_min_percent: 98
  sync_jitter_max_ms: 2
semantic:
  alternative_parents: []
