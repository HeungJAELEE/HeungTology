...
object:
  ...
  tier: 1
properties:
  anaerobic_residency_time_days: 15-30
  critical_ph_threshold: 6.5
  h2s_corrosion_threshold_ppm: 500
  low_methane_threshold_pct: 50.0
  methane_yield_m3_kg_vs: 0.2-0.5
  methanogenesis_reaction: CH3COOH -> CH4 + CO2
  monod_kinetics_formula: mu = mu_max * (S / (Ks + S))
  warning_vfa_tic_ratio_threshold: 0.4
semantic:
  alternative_parents: []
