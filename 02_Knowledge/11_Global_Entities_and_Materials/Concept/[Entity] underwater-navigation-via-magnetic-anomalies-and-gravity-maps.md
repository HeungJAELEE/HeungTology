...
lineage:
  ...
  original_hash: 9a5f73484e1447119bd9950603df3551b8e5005956e402709b069b268d08c559
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] underwater-navigation-via-magnetic-anomalies-and-gravity-maps에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  audit_status: Abyss-Nav-v2026-Fidelity
  map_resolution: < 10 m
  navigation_drift: < 1 m/hr
  positioning_accuracy: < 5 m
  signal_sensitivity: < 0.1 nT
  system_uptime: 100%
  target_specification_version: V6.3.7
  terrain_matching_fidelity: 0.994
semantic:
  alternative_parents: []
