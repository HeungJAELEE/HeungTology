...
object:
  description: '[Entity] global-cyber-defense-and-autonomous-threat-neutralization에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  analysis_throughput_logs_per_sec: '> 10,000,000'
  detection_latency_ms: < 10
  false_positive_rate_pct: < 0.001
  max_neutralization_latency_ms: 500
  min_detection_accuracy_pct: 99.9
  min_self_healing_success_rate_pct: 95.0
  neutralization_mttn_sec: < 1
  trust_model: Zero-Trust (V6.3.7)
semantic:
  alternative_parents: []
