...
lineage:
  ...
  original_hash: 9f7c442b277779935d42bdb40c839c5c417134a604b454c521d8782ae83d9faf
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] virtual-power-plants-vpp-and-ai-driven-demand-response-systems에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  aggregate_capacity_min: 100 MW
  convergence_time_max: 500 ms
  data_throughput_min: 1 TB
  dispatch_efficiency_min: 99%
  economic_benefit_min_increase: 20%
  forecasting_accuracy_mape_max: 3%
  participation_rate_min: 95%
  real_time_calculation_target: 100 ms
  response_latency_max: 1 s
semantic:
  alternative_parents: []
