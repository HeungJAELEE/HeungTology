...
object:
  description: '[Entity] expansion-joint-and-thermal-displacement-compensation-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  expected_expansion_coefficient: 0.012
  fatigue_life_max_cycles: 1000000
  fatigue_life_min_cycles: 10000
  joint_design_limit_mm: 50.0
  joint_seizure_threshold_mm: 5.0
  joint_spring_force_formula: F = k_joint * delta_x
  linear_thermal_expansion_formula: delta_L = alpha * L0 * delta_T
semantic:
  alternative_parents: []
