...
lineage:
  ...
  original_hash: d0512c5747aea158b62c61eb7b45b8a79f4e47792d49ab6f1a1fc99fdd6e5056
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] electrolytic-cell-and-faradays-laws-of-electrolysis에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  critical_efficiency_threshold_pct: 70.0
  electrolytic_cell_efficiency_max_pct: 85.0
  electrolytic_cell_efficiency_min_pct: 60.0
  faradays_first_law_formula: m = (I * t * M) / (z * F)
  galvanic_cell_efficiency_pct: 90.0
  gibbs_free_energy_formula: delta_g = -n * F * e_cell
  high_current_density_threshold_a: 5000.0
  moderate_efficiency_threshold_pct: 90.0
semantic:
  alternative_parents: []
