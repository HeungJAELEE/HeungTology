...
lineage:
  ...
  original_hash: 91374f37ed45c78da9899b0db16db1217e7313e32772a9345932ed46aed4c8ba
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] physical-vapor-deposition-pvd-and-sputtering-yield-mechanics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  evaporation_vacuum_level_torr: 1e-6 to 1e-7
  low_sputter_rate_threshold_nm_s: 0.1
  mean_free_path_formula: kT / (sqrt(2) * pi * d^2 * P)
  sputtering_atom_energy_ev: 1.0 - 10.0
  sputtering_vacuum_level_torr: 1e-2 to 1e-3
  sputtering_yield_formula: Atoms Ejected / Incident Ions
  step_coverage_rejection_threshold_ratio: 0.5
  thickness_uniformity_threshold_pct: 3.0
  vacuum_integrity_threshold_torr: 1.0e-06
semantic:
  alternative_parents: []
