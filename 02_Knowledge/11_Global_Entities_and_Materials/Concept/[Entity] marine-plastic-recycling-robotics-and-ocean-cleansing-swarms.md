...
lineage:
  ...
  original_hash: 280e055963a9f971279d4e02d7e0baf60d22278919da58b9557c9792bb59663e
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] marine-plastic-recycling-robotics-and-ocean-cleansing-swarms에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  collection_rate_efficiency_eta: eta
  deep_ocean_collection_cap_kg: 500-2000
  deep_ocean_sorting_accuracy_min: 0.95
  deep_ocean_swarm_size_range: 100-1000
  efficiency_threshold_kg_kwh: 0.5
  interceptor_collection_cap_kg: 10000-50000
  interceptor_sorting_accuracy_min: 0.99
  interceptor_swarm_size_range: 1-5
  material_purity_threshold: 0.9
  plastic_concentration: C_plastic
  swarm_velocity: v_swarm
  sweep_width: W_sweep
semantic:
  alternative_parents: []
