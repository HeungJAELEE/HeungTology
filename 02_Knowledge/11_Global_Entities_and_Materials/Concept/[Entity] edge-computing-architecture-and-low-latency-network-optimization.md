...
lineage:
  ...
  original_hash: 28808d05e56abc366710776d08e6b5ca65f1c1439230f53f981ff2e98935c3f7
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] edge-computing-architecture-and-low-latency-network-optimization에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  bandwidth_saving_threshold: '> 70%'
  data_locality_min: '> 90%'
  edge_power_min: 10 TFLOPS
  latency_reduction_threshold: '> 80%'
  offload_success_rate_min: 99.9%
  response_time_max: 10 ms
  speed_of_light: 3e8 m/s
  system_reliability_target: 99.999%
semantic:
  alternative_parents: []
