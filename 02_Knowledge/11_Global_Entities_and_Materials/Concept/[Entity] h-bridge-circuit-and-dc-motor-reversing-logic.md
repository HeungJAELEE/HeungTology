...
lineage:
  ...
  original_hash: 69cc3371f6c9545c8335f7ecd6398361c4d8883073159cd42241d09f308510bd
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] h-bridge-circuit-and-dc-motor-reversing-logic에 관한 고밀도 지능
    노드'
  object_type: Hardware
  tier: 1
properties:
  average_voltage_formula: V_avg = D * V_cc
  control_quadrants: 4
  dead_time_threshold_ns: 100
  min_state_transition_time_ms: 1.0
  motor_speed_logic: omega proportional to V_avg - IR
  num_transistors: 4
