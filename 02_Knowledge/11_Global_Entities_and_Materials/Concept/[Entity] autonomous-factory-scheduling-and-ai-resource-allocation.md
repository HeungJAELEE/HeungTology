...
lineage:
  ...
  original_hash: 1948676a672608c7bb00d8c9cfbd93eece15c3a9eb55852040b3805902423b24
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] autonomous-factory-scheduling-and-ai-resource-allocation에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  bottleneck_queue_limit: 50
  bottleneck_slack_max_percent: 5
  data_endpoint_log: factory-throughput-and-bottleneck-analysis-log-v2026
  inventory_turn_min_times_per_year: 12
  machine_utilization_min_percent: 90
  oee_critical_threshold: 65
  oee_warning_threshold: 85
  scheduling_latency_max_sec: 1
