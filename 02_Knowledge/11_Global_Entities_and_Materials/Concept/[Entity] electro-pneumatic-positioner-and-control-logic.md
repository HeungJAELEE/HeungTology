...
lineage:
  ...
  original_hash: 1bc7b231f9dbf4909248463976cbbc225917d591b6e78ba4f13efd47f242e5a4
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] electro-pneumatic-positioner-and-control-logic에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  actuator_dynamics_equation: m*y'' + c*y' + k*y = A*delta_P
  control_logic_equation: P_out = K * (I_in - I_feedback)
  critical_error_threshold_pct: 2.0
  hysteresis_detection_threshold_pct: 0.5
  input_signal_range_ma: 4-20
  low_supply_pressure_warning_psi: 60.0
  positioner_precision_pct: 0.1-0.5
semantic:
  alternative_parents: []
