...
lineage:
  ...
  original_hash: 2f439de5b5cf83eaeeec2fa8bd995eeb9ad50eb72aeb6b8951caf98317cba663
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] project-management-body-of-knowledge-pmbok-and-agile-frameworks에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  agile_velocity_formula: sum(story_points) / sprint
  scope_change_rate_threshold: 0.3
  spi_critical_threshold: 0.8
  total_duration_formula: sum(W_i / P_i)
  velocity_stability_threshold: 0.7
semantic:
  alternative_parents: []
