...
lineage:
  ...
  original_hash: 5d727db8d69051aed12111fce1e5f3a3f1dc7b1c7325a2b62bed58e1836338d6
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] end-to-end-encryption-e2ee-and-cryptographic-protocol-logic에
    관한 고밀도 지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  e2ee_version: V6.3.7
  ecc_recommended_upgrade_bits: 384
  ecc_standard_key_strength_bits: 256
  max_handshake_latency_ms: 500
  rsa_min_key_strength_bits: 2048
  rsa_recommended_upgrade_bits: 4096
semantic:
  alternative_parents: []
