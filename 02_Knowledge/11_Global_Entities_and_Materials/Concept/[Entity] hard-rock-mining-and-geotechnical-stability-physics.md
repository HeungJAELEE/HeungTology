...
lineage:
  ...
  original_hash: 710237644bff5d186b559d7d63467550864f73b191ed0dcf738552ad187095bd
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] hard-rock-mining-and-geotechnical-stability-physics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  a: fracture_parameter_a
  bolt_tension_degradation_threshold: 0.7
  c: cohesion
  critical_convergence_rate_mm_day: 5.0
  m_b: fracture_parameter_mb
  max_depth_m: 4000
  phi: friction_angle
  s: fracture_parameter_s
  seismic_event_warning_threshold: 50
  sigma_ci: unconfined_compressive_strength
semantic:
  alternative_parents: []
