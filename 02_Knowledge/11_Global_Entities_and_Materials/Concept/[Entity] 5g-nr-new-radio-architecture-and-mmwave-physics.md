...
object:
  description: '[Entity] 5g-nr-new-radio-architecture-and-mmwave-physics에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  connection_density_units_per_km2: 1000000
  coverage_radius_m_range: 100-500
  energy_efficiency_improvement_factor: 100
  max_mobility_speed_kmh: 500
  operating_frequency_range_ghz: 24-100
  path_loss_model_formula: L = 20log10(d) + 20log10(f) + 20log10(4pi/c)
  peak_user_throughput_gbps: 20
  shannon_hartley_capacity_formula: C = W * log2(1 + SNR)
  spectral_efficiency_bps_hz: 30
  urllc_latency_threshold_ms: 1
semantic:
  alternative_parents: []
