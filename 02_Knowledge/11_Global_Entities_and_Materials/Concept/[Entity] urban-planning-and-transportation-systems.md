...
lineage:
  ...
  original_hash: 404bbf323bd74083c6b1a17fafa8f151205387c86a9dd5219eb0cd702e312731
metadata:
  date: '2026-05-16'
...
object:
  ...
  tier: 1
properties:
  commute_time_max_min: 30
  fundamental_diagram_formula: q = k * v
  greenshields_model_formula: v = v_f * (1 - k / k_j)
  los_target_range: A-C
  public_space_min_percent: 15
  smart_connectivity_min_percent: 90
  throughput_design_capacity_threshold: 0.9
  transit_access_min_percent: 80
semantic:
  alternative_parents: []
