...
object:
  description: '[Entity] iterative-design-and-agile-product-development에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  rework_ratio_threshold: 0.3
  time_to_market_threshold_days: 90
  user_feedback_adoption_threshold: 0.6
