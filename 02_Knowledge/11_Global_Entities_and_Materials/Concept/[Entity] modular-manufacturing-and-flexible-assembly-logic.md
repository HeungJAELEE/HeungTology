...
object:
  description: '[Entity] modular-manufacturing-and-flexible-assembly-logic에 관한 고밀도
    지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  cost_integration: integration cost
  cost_module: cost per module
  interoperability_standard: OPC-UA
  line_balance_efficiency_threshold: 0.7
  module_compatibility_threshold_pct: 95.0
  p_possible: number of possible products
  setup_time_threshold_min: 60.0
  t_setup: setup time for new products
semantic:
  alternative_parents: []
