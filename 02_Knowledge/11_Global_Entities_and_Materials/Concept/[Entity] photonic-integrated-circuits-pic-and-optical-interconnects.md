...
lineage:
  ...
  original_hash: c8004b21753eee0eb59edfada45507dc9e77b313a50ca90db0cc4f2e5806bced
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] photonic-integrated-circuits-pic-and-optical-interconnects에
    관한 고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  bandwidth_density_electrical: 100 Gbps/mm
  bandwidth_density_optical: 1000 Gbps/mm
  critical_insertion_loss_threshold_db: '10.0'
  energy_consumption_electrical: 5 pJ/bit
  energy_consumption_optical: 1 pJ/bit
  max_phase_error_deg: '10'
  max_ring_resonance_drift_nm: '0.1'
  min_modulation_extinction_ratio: '5.0'
semantic:
  alternative_parents: []
