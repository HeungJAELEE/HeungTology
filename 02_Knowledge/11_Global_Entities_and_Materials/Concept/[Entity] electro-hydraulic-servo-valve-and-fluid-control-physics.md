...
lineage:
  ...
  original_hash: 82ba6007dd3f0424d9fc6852e6ce5caf83907f345525f974577dea44e577c0a5
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] electro-hydraulic-servo-valve-and-fluid-control-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  control_signal_range_ma: 4-20
  critical_leakage_threshold_lpm: 1.5
  linearity_deviation_threshold: 0.15
  minimum_bandwidth_hz: 50
  notice_leakage_threshold_lpm: 0.5
  oil_cleanliness_standard: ISO 4406 14/11
  orifice_discharge_coefficient: Cd
  servo_valve_fluid_purity_nas: 5
  servo_valve_hysteresis_max_percent: 1.0
  servo_valve_response_time_ms: 2-10
  spool_damping_coefficient: c
  spool_spring_constant: k
semantic:
  alternative_parents: []
