...
lineage:
  ...
  original_hash: 6ac4d0d22c0e4a00ea287e0cccbb97a942872c231c4d4eff6c1b4641b78af3e7
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] autonomous-shipping-lanes-and-unmanned-vessel-control에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  autonomy_level: AL-4
  collision_critical_threshold_nm: 1.0
  collision_warning_threshold_nm: 2.0
  comm_latency_sat_ms: < 500
  fuel_efficiency_audit_threshold_factor: 1.2
  fuel_saving_target_pct: 15-25
  navigation_accuracy_gnss_cm: < 10
  perception_range_nm: '> 10'
  target_accident_reduction_rate: 0.9
semantic:
  alternative_parents: []
