...
object:
  description: '[Entity] drag-conveying-and-bulk-material-transport-mechanics에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  chain_tension_low_threshold_kn: 5.0
  max_belt_incline_deg: 20
  max_drag_incline_deg: 90
  min_trough_thickness_mm: 3.0
  motor_current_overload_threshold_amps: 50.0
  vibration_excessive_threshold_mm_s: 10.0
semantic:
  alternative_parents: []
