...
object:
  description: '[Entity] kaizen-and-continuous-improvement-philosophy-logic에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  growth_formula: Performance_{n+1} = Performance_n + Delta
  improvement_pct_threshold: 0.1
  kaizen_version: V6.3.7
  standard_adherence_threshold: 80.0
  suggestion_threshold: 2.0
semantic:
  alternative_parents: []
