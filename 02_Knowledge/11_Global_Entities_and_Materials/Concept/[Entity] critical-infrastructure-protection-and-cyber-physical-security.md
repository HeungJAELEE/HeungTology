...
lineage:
  ...
  original_hash: 39d5d67390d46b677c4327bd6f8de3f555a7bcc3e24b0ab9f225367fabb789e0
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] critical-infrastructure-protection-and-cyber-physical-security에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  anomaly_score_critical_threshold: 0.8
  ids_false_positive_threshold_percent: 0.01
  isolation_level_warning_threshold: 3
  mttr_max_sec: 600
  network_latency_ot_control_max_ms: 10
  redundancy_hardware_requirement: N+1 or N+2
  resilience_target_value: 1.0
semantic:
  alternative_parents: []
