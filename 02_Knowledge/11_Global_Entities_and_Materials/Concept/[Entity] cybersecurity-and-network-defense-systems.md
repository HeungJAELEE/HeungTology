...
object:
  ...
  tier: 1
properties:
  detection_target_percent: 99.9
  fidelity_engine_fp_tolerance_percent: 0.001
  fidelity_engine_latency_tolerance_us: 50
  fidelity_engine_throughput_tolerance_gbps: 1
  fidelity_engine_tp_tolerance_percent: 0.05
  latency_limit_ms: 0.5
  signature_db_update_frequency_hours: 1
  target_false_positive_rate_percent: 0.01
  target_inspection_latency_us: 500
  target_throughput_gbps: 100
  target_true_positive_rate_percent: 99.9
  version: V6.3.7
  z_score_parameter_mu: mean
  z_score_parameter_sigma: standard_deviation
semantic:
  alternative_parents: []
