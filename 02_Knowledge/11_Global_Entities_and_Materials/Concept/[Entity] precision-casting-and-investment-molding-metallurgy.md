...
object:
  description: '[Entity] precision-casting-and-investment-molding-metallurgy에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  investment_casting_surface_finish_ra: 1.6 to 3.2
  investment_casting_tolerance_mm: 0.05 to 0.1
  investment_casting_wall_thickness_mm: < 1.0
  max_withdrawal_rate_mm_min: 10.0
  min_mold_preheat_temp_c: 1000.0
  min_shell_permeability_index: 5.0
  porosity_critical_threshold_pct: 0.1
semantic:
  alternative_parents: []
