...
lineage:
  ...
  original_hash: e81f781c8c07671161dee935a0e7b47311cdd6a4ded4cc78de8281e32c6fcc0e
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] hydrogen-economy-infrastructure-and-global-supply-chain에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  carbon_intensity_green_kgco2_kgh2: <1.0
  carbon_intensity_grey_kgco2_kgh2: 9-12
  compression_energy_limit_kwh_kg: 15.0
  critical_boil_off_rate_threshold_pct: 0.5
  lcoh_green_range_usd_kg: 4.0-7.0
  lcoh_grey_range_usd_kg: 1.5-2.5
  liquid_h2_storage_density_kg_m3: 71
  purity_iso_standard: ISO 14687
  purity_warning_threshold_pct: 99.97
semantic:
  alternative_parents: []
