...
lineage:
  ...
  original_hash: af3cbd402bc272ca8b5acdd08728a0ead2b65f3c647b1e1cbb146c6c0185d087
metadata:
  date: '2026-05-16'
...
object:
  ...
  tier: 1
properties:
  cathodic_protection_critical_threshold_mv: -800
  coastal_depth_range_m: 0-200
  coastal_design_life_years: 15-25
  deepwater_depth_range_m: 200-3000+
  deepwater_design_life_years: 25-50
  drag_force_formula: Fd = 0.5 * rho * v^2 * Cd * A
  hydrostatic_pressure_formula: P = rho * g * h
  pipeline_pressure_drop_reject_threshold: 20.0
  rov_defect_notice_threshold: 5
  structural_fatigue_warning_threshold: 0.85
semantic:
  alternative_parents: []
