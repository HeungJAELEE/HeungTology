...
object:
  description: '[Entity] yield-management-and-defect-metrology-in-wafer-processing에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  fidelity_engine_d0_tolerance: 0.005
  fidelity_engine_particle_tolerance_nm: 1
  fidelity_engine_yield_tolerance: 0.005
  min_particle_sensitivity_nm: 10
  target_cpk_index: 1.67
  target_defect_density_d0: 0.05
  target_prime_yield: 0.9
  type_i_error_threshold: 0.001
  type_i_error_tolerance: 0.0001
semantic:
  alternative_parents: []
