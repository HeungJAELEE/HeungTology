...
lineage:
  ...
  original_hash: 7edf87376cf8cd58c0adb22fcb9aba3ddf958196314ac35d6f70410f4b81702f
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] automated-high-speed-rail-and-maglev-infrastructure에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  comm_latency_hsr_ms: 50
  comm_latency_maglev_ms: 10
  external_data_endpoint: hsr-and-maglev-safety-and-speed-log-v2026
  levitation_gap_target_mm: 100
  levitation_gap_warning_mm: 80
  max_speed_hsr_kmh: 300-350
  max_speed_maglev_kmh: 500-600
  power_velocity_relationship: P proportional to v^3
  safety_integrity_level: SIL-4
  stopping_precision_hsr_cm: 10
  stopping_precision_maglev_cm: 5
  vibration_critical_threshold_g: 0.15
semantic:
  alternative_parents: []
