...
lineage:
  ...
  original_hash: ce962360afaeaf113b07a0fb5131e26b660dae7ae2efc4c3c5f2509c71612756
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] electric-vehicle-to-grid-v2g-and-bi-directional-charging-protocols에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  bidirectional_power_range: 7-50 kW
  charging_efficiency_min: '> 92%'
  communication_standard: ISO 15118-20
  encryption_standard: TLS 1.3 / PKI
  optimal_soc_range: 40-60%
  participation_rate_target: '> 60%'
  reactive_power_support: ENABLED
  response_time_max: < 2 s
  soh_impact_limit_per_cycle: < 0.01%
semantic:
  alternative_parents: []
