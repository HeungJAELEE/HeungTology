...
lineage:
  ...
  original_hash: 6bcb42911b9f372b5dd7a2f1382d4c3dff87a289a8efa916812cc2989d0f0590
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] global-integrated-digital-currency-and-unified-settlement에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  double_spend_limit: 0
  liquidity_slippage_threshold_pct: 0.5
  max_integrated_settlement_time_sec: 5
  min_integrated_throughput_tps: 100000
  min_integrated_transaction_cost_pct: 0.01
  monetary_velocity_formula: M * V = P * Y
  opportunity_cost_formula: integral(Capital * r dt)
  settlement_finality_threshold_sec: 10
semantic:
  alternative_parents: []
