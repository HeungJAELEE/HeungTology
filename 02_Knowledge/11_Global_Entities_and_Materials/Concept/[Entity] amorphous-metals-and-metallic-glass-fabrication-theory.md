...
lineage:
  ...
  original_hash: 429ab1480b1721f00a344a89c9aeeb9eb31894481064057bc6bdd0b987b84156
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] amorphous-metals-and-metallic-glass-fabrication-theory에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  atomic_size_difference_min: 12%
  cooling_rate_range: 1 to 10^6 K/s
  elastic_limit_min: 2.0%
  gfa_index_min: '0.4'
  glass_transition_temp_range: 300 to 600 C
  hardness_min: 800 HV
  max_cast_thickness_min: 50.0 mm
  min_element_count: '3'
  mixing_enthalpy_sign: negative
  poisson_ratio_range: 0.35 to 0.40
  yield_strength_min: 2.0 GPa
semantic:
  alternative_parents: []
