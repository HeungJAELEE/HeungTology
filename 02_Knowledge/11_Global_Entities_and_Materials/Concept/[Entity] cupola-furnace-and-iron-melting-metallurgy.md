...
lineage:
  ...
  original_hash: d807399a060f11697ad6bf1b6c80575b92ef5df596a250db15b5ad2aad668c76
metadata:
  date: '2026-05-16'
...
object:
  ...
  tier: 1
properties:
  carbon_pickup_formula: c_final = c_initial + delta_c_pickup
  high_blast_pressure_threshold_kpa: 15.0
  low_melt_temp_threshold_c: 1450.0
  max_sulfur_content_pct: 0.15
  thermal_efficiency_formula: eta_thermal = (m * cp * delta_t) / (m_coke * lhv)
semantic:
  alternative_parents: []
