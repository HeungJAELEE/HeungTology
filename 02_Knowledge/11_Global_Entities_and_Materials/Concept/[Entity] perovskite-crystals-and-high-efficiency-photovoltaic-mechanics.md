...
lineage:
  ...
  original_hash: a4d8ac72892c488cdc53ac5b0fed89d57721ed48d4860caf94a64b164b554368
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] perovskite-crystals-and-high-efficiency-photovoltaic-mechanics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  bandgap_mismatch_threshold_ev: 0.1
  lab_efficiency_perovskite_pct: 26.1
  lab_efficiency_silicon_pct: 26.7
  min_crystal_grain_size_nm: 100
  optimal_bandgap_ev: 1.55
  perovskite_bandgap_range_ev: 1.2-2.3
  silicon_bandgap_ev: 1.1
  t80_lifetime_threshold_hours: 1000
  tandem_current_mismatch_threshold_pct: 5.0
  tandem_efficiency_potential_pct: 30.0
semantic:
  alternative_parents: []
