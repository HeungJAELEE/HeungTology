...
lineage:
  ...
  original_hash: 4e407ceabec1ad43f71d81a742bd5b932dd5e76b7a2d27e9aab1eb782e36e12e
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] integrated-circuit-ic-packaging-and-thermal-management-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  advanced_thermal_conductivity_w_mk: 400
  automotive_reliability_standard: AEC-Q100
  critical_junction_temperature_threshold_c: 105.0
  high_thermal_resistance_threshold_kw: 0.5
  junction_temperature_formula: T_j = T_a + P * theta_ja
  max_advanced_packaging_thickness_mm: 1.0
  thermal_resistance_formula: theta_th = L / (k * A)
semantic:
  alternative_parents: []
