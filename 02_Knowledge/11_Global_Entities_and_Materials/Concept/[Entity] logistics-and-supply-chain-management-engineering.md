...
lineage:
  ...
  original_hash: 17a1cf4d4848a3071593d8960683b2ad70d6ab1b73cb9e8e48641ac7db25930e
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] logistics-and-supply-chain-management-engineering에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  bullwhip_effect_coefficient: W = Variance of Orders / Variance of Demand
  cold_chain_integrity_threshold: 0.999
  eoq_formula: Q* = sqrt((2 * D * S) / H)
  lead_time_reduction_threshold: 0.2
  on_time_delivery_threshold: 0.99
  transportation_problem_objective: Minimize Z = sum(sum(c_ij * x_ij))
  warehouse_utilization_threshold: 0.9
semantic:
  alternative_parents: []
