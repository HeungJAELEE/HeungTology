...
lineage:
  ...
  original_hash: 8a8cef0105c5a4868beef8d6b8c07928a2670e2b40461604e6fb96ef66961324
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] photolithography-mask-design-and-optical-proximity-correction-opc에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  audit_status: Mask-Master-v2026-Fidelity
  correct_accuracy_residual_error: < 0.5 nm
  defect_sensitivity: maximum
  mask_cd_uniformity: < 1 nm
  opc_computation_time: < 24 hours
  pattern_fidelity_threshold: '> 0.99'
  phase_error_deviation: < 2 degrees
