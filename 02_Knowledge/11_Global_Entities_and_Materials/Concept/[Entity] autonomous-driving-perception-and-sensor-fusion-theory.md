...
lineage:
  ...
  original_hash: 7d173070966ae12ff0378d566478cc7b5e399e514ae7d1fd573ced820e0519b7
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] autonomous-driving-perception-and-sensor-fusion-theory에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  default_lidar_weight: 0.7
  default_radar_weight: 0.3
  detection_accuracy_threshold_percent: 99.9
  detection_range_min_m: 250
  fov_coverage_degrees: 360.0
  fusion_latency_max_ms: 30.0
  lidar_throughput_min_pts_per_s: 1000000
  range_resolution_max_cm: 3.0
  safety_standard: ASIL-D
  tracking_fidelity_min: 0.98
semantic:
  alternative_parents: []
