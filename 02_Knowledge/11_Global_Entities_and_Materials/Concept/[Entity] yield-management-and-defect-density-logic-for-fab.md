...
lineage:
  ...
  original_hash: 214a46c614f8c43b50fe5b64a2763df2b943993ebb35ec92c594932a5d9f79f4
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] yield-management-and-defect-density-logic-for-fab에 관한 고밀도
    지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  cluster_index_notice_threshold: 0.2
  defect_density_warning_threshold: 0.1
  mass_production_defect_density: 0.01-0.05 defects/cm2
  mass_production_yield_target: 95-98%
  standard_wafer_size: 300mm
  systematic_error_reject_threshold: 0.8
  yield_critical_threshold: 0.85
semantic:
  alternative_parents: []
