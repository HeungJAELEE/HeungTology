...
lineage:
  ...
  original_hash: cc83c060ae267e714f52dca65654338d84d58023d0966b3778ac994e1f44b6d0
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] haptic-feedback-and-teleoperation-force-feedback-mechanics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  dynamic_range_max: 50N
  dynamic_range_min: 0.01N
  feedback_latency_max: 5ms
  force_reflectance_min: 0.95
  rendering_rate_min: 1kHz
  tactile_resolution_min: 100dpi
  target_transparency_index: 0.98
  transparency_bw_min: 1000Hz
  user_perception_min: 9.0
semantic:
  alternative_parents: []
