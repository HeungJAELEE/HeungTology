...
object:
  description: '[Entity] molecular-beam-epitaxy-mbe-and-crystal-growth-kinetics에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  cell_temp_stability_threshold: '0.1'
  growth_rate_precision: 1 atomic layer/s
  interface_abruptness_limit: 0.5 nm
  monitoring_method: rheed
  rheed_osc_contrast_threshold: '0.2'
  vacuum_integrity_threshold: 1e-9 torr
  vacuum_level_ultra_high: 1e-11 torr
semantic:
  alternative_parents: []
