...
lineage:
  ...
  original_hash: 983d30a1067f202b39f843c37759f9c0dc54a69f525af83edba1e84ba78aa536
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] kinematic-linkage-and-four-bar-mechanism-physics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  four_bar_mechanism_dof: 1
  grashof_law_formula: s + l <= p + q
  joint_clearance_warning_threshold_um: 50.0
  transmission_angle_critical_max_deg: 140.0
  transmission_angle_critical_min_deg: 40.0
  transmission_angle_recommended_max_deg: 135.0
  transmission_angle_recommended_min_deg: 45.0
  vector_loop_closure_formula: sum(l) = 0
semantic:
  alternative_parents: []
