...
object:
  description: '[Entity] geographic-information-system-gis-and-spatial-analysis-logic에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  attribute_completeness_threshold_pct: 90.0
  coordinate_precision_threshold_m: 1.0
  gis_version: V6.3.7
  projection_area_error_threshold: 0.05
semantic:
  alternative_parents: []
