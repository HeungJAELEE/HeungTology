...
object:
  description: '[Entity] human-robot-interaction-hri-and-cobot-safety-standards에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  impact_detection_sensitivity_threshold: '0.95'
  max_force_pfl: 140 N
  max_pressure_range: 10-30 N/cm2
  max_stop_time: 100 ms
  peak_contact_force_limit: 140.0 N
  safety_response_latency_limit: 150 ms
  standard_collaborative: ISO/TS 15066
  standard_industrial: ISO 10218
semantic:
  alternative_parents: []
