...
lineage:
  ...
  original_hash: 15bb31d59a374c4791b2dfb1ab53cc25faacfe2f10d17a8dab826554412a45b7
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] electromagnetic-brake-and-eddy-current-retardation-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  critical_rotor_temp_threshold_c: 450.0
  emergency_stop_latency_limit_ms: 100.0
  heat_fade_temp_threshold_c: 300.0
  low_efficiency_current_threshold_a: 50.0
  low_efficiency_torque_threshold_nm: 100.0
semantic:
  alternative_parents: []
