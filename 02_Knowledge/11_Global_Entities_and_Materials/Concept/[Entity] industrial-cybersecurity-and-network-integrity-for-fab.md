...
lineage:
  ...
  original_hash: 48e270f3bf7329468f4ab99ebecff3c7223e412e0c7989d36b82570aa6fe0ebd
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] industrial-cybersecurity-and-network-integrity-for-fab에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  entropy_threshold: '0.85'
  isolation_ratio_logical: 100%
  latency_baseline_ms: '0.2'
  mttd_critical_threshold: 1.0 min
  mttd_tolerance: 0.1 min
  network_jitter_critical_threshold: 0.5 ms
  network_jitter_tolerance: 0.05 ms
  packet_entropy_baseline_deviation: 5%
  packet_entropy_tolerance: 1%
semantic:
  alternative_parents: []
