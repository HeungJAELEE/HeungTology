...
lineage:
  ...
  original_hash: ebaa8454d90b1ff56a0325419f14a4ce2750a8eb5399d41d5c7b1df2b30bcb02
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] bio-hybrid-robotics-and-neuromuscular-actuation-mechanics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  contraction_speed_target_l0_s: 0.1-1.0
  contraction_speed_tolerance_l0_s: 0.1
  external_data_endpoint: neuromuscular-junction-latency-and-force-output-v2026
  fatigue_index_warning_threshold: 0.6
  firing_frequency_target_hz: 1-100
  firing_frequency_tolerance_hz: 5
  force_per_unit_target_mn_mm2: 5-50
  force_per_unit_tolerance_mn_mm2: 5
  joint_efficiency_target_pct: '>45'
  joint_efficiency_tolerance_pct: 5
  max_control_error_pct: 1.0
  synaptic_degradation_threshold_ms: 3.0
  synaptic_gap_nm: 20
  synaptic_latency_target_ms: 0.5-2.0
  synaptic_latency_tolerance_ms: 0.2
semantic:
  alternative_parents: []
