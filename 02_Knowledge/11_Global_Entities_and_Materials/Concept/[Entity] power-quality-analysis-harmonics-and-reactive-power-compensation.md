...
lineage:
  ...
  original_hash: db331c44ad38caf4fb3a4931bc3f648086f8f0d9411a7a95e0303c73ac536f13
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] power-quality-analysis-harmonics-and-reactive-power-compensation에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  critical_thd_limit_pct: 15.0
  pf_premium_min: 0.98
  pf_warning_limit: 0.9
  sag_depth_limit_pct: 30.0
  sag_duration_limit_ms: 20.0
  thd_target_pct: 5.0
  voltage_thd_premium_max_pct: 1.5
  voltage_thd_unsafe_min_pct: 10.0
  voltage_unbalance_limit_pct: 3.0
semantic:
  alternative_parents: []
