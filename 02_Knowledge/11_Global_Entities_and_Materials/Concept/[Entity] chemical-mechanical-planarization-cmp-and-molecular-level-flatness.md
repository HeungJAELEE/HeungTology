...
lineage:
  ...
  original_hash: 2ffbfeafb25e9be478d53a6ac33e018b886a77f06c62b4ea16972beed82ba4bb
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] chemical-mechanical-planarization-cmp-and-molecular-level-flatness에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  defect_density_limit_counts_per_cm2: 0.05
  diagnostic_error_threshold: 0.1
  diagnostic_uniformity_critical_pct: 5.0
  dishing_depth_limit_angstrom: 100
  pad_life_eol_hrs: 200
  removal_rate_range: 100-5000 A/min
  surface_roughness_target_angstrom: 2
  uniformity_target_pct: 3
semantic:
  alternative_parents: []
