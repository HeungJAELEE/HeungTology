...
object:
  description: '[Entity] magnetic-bearing-and-active-position-control-physics에 관한
    고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  air_gap_tolerance_mm: 0.1
  friction_level: zero
  magnetic_force_formula: k * (I^2 / x^2)
  max_dn_speed: 4.0M
  orbital_vibration_threshold_um: 50.0
  rotor_dynamics_equation: m*x'' + c*x' + ks*x = Fext + Fm
  target_air_gap_mm: 0.5
semantic:
  alternative_parents: []
