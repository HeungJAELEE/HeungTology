...
object:
  description: '[Entity] network-slicing-and-quality-of-service-qos-in-5g-systems에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  b_allocated: physical frequency resource
  embb_latency_ms:
  - 10
  - 100
  eta_spectral: spectral efficiency
  inter_slice_leakage_threshold: 0.1
  l_core: core network latency
  l_processing: processing latency
  l_radio: radio latency
  max_edge_processing_latency_ms: 5
  mmtc_latency_ms:
  - 100
  - 1000
  resource_utilization_threshold: 0.95
  urllc_latency_ms:
  - 1
  - 10
  urllc_reliability: 0.99999
  v2x_latency_ms:
  - 5
  - 20
semantic:
