...
object:
  description: '[Entity] coffee-roasting-and-maillard-reaction-kinetics에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  agtron_dark_limit: 25
  agtron_light_limit: 95
  crack_timing_threshold_sec: 600
  excessive_weight_loss_pct: 20.0
  green_bean_moisture_content_pct: 10-12
  maillard_reaction_temp_range_celsius: 150-200
  roasted_bean_moisture_content_pct: 1-3
  ror_critical_high_c_min: 15.0
  ror_critical_low_c_min: 2.0
semantic:
  alternative_parents: []
