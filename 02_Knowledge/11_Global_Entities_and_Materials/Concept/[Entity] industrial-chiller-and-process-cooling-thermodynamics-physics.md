...
lineage:
  ...
  original_hash: 6e7d2642f3629ecdd7e4f92b0b9b2e165897deafb37bb9bea1f7b2bc74b80d0f
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] industrial-chiller-and-process-cooling-thermodynamics-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  chiller_life_cycle_years_range: 20-30
  cop_efficiency_threshold: 0.7
  suction_pressure_limit: 3.0
  temp_deviation_threshold_celsius: 1.0
  temp_precision_celsius: 0.1
