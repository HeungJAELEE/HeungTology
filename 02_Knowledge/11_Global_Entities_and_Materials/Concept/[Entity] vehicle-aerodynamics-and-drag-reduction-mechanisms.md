...
object:
  description: '[Entity] vehicle-aerodynamics-and-drag-reduction-mechanisms에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  aero_power_loss_formula: 0.5 * rho * v^3 * Cd * A
  cd_luxury_sedan_ev_range: 0.20-0.24
  cd_suv_range: 0.35-0.45
  drag_critical_threshold_multiplier: 1.1
  drag_force_formula: 0.5 * rho * v^2 * Cd * A
  shutter_low_opening_threshold: 0.2
  wind_noise_decibel_threshold: 65.0
semantic:
  alternative_parents: []
