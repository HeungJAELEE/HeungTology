...
object:
  description: '[Entity] compact-disc-cd-and-optical-data-storage-physics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  cd_audio_capacity_min: 80
  cd_data_capacity_mb: 700
  cd_laser_wavelength_nm: 780
  cd_sampling_rate_khz: 44.1
  cd_track_pitch_um: 1.6
  critical_bler_threshold: 220
  diffraction_limit_coefficient: 1.22
  focus_instability_threshold_mv: 500
  warning_jitter_threshold_ns: 35.0
semantic:
  alternative_parents: []
