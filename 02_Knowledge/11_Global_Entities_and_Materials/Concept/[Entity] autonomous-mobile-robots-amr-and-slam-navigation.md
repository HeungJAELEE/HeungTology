...
lineage:
  ...
  original_hash: 4b77079c07a020f18bb27a16eeaaf4881998ed47160b679b47ef18e0c8dd690d
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] autonomous-mobile-robots-amr-and-slam-navigation에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  drift_rate_deg_hr: 0.1
  dynamic_environment_change_threshold_pct: 40.0
  fidelity_engine_drift_tolerance_deg: 0.01
  fidelity_engine_latency_tolerance_ms: 5
  fidelity_engine_localization_tolerance_cm: 0.1
  fidelity_engine_mapping_tolerance_mm: 1.0
  fidelity_engine_velocity_tolerance_m_s: 0.1
  lidar_detection_range_m: 10.0
  localization_pose_deviation_cm: 2.0
  loop_closure_consistency_threshold_pct: 99.9
  mapping_grid_resolution_mm: 10.0
  max_safety_velocity_m_s: 2.0
  obstacle_safety_margin_m: 0.3
  path_latency_ms: 50
  scan_matching_fidelity_threshold: 0.95
semantic:
  alternative_parents: []
