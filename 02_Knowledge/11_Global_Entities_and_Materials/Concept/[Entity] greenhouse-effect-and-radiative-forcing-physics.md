...
object:
  description: '[Entity] greenhouse-effect-and-radiative-forcing-physics에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  albedo_collapse_threshold: 0.28
  anthropogenic_radiative_forcing_wm2: 2.72
  co2_ppm_safety_threshold: 450.0
  co2_radiative_forcing_constant: 5.35
  earth_albedo_value: 0.3
  earth_mean_surface_temp_celsius: 15
semantic:
  alternative_parents: []
