...
lineage:
  ...
  original_hash: 98cd3f797298503b03c06a6a1f3df69ba348efff94ce9b5fbe68432c55130e7c
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] satellite-communications-and-non-terrestrial-networks-ntn에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  coverage_angle_min: 45 deg
  frequency_band_range: 12-50 GHz
  geo_propagation_latency_min: 240 ms
  isl_bandwidth_min: 100 Gbps
  leo_orbital_altitude_range: 300-1,200 km
  leo_propagation_latency_max: 30 ms
  link_margin_threshold: 3-5 dB
  satellite_constellation_count_range: 10^3-10^4
