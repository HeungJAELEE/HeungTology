...
object:
  description: '[Entity] biosensors-and-molecular-diagnostics-kinetics에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  cross_reactivity_threshold: 0.05
  lod_limit: < 1.0 pM/fM
  misdiagnosis_rate_target: 0.001
  pcr_ct_variation_max: 0.5
  response_time_limit: < 5 min
  selectivity_ratio_min: 100
  shelf_life_min_months: 6
  snr_threshold: 3.0
semantic:
  alternative_parents: []
