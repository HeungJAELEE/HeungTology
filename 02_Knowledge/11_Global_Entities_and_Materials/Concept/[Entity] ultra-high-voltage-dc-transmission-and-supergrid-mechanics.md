...
object:
  description: '[Entity] ultra-high-voltage-dc-transmission-and-supergrid-mechanics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  hvac_distance_max_km: 500
  hvac_voltage_kv: 765
  max_converter_thd_threshold_percent: 5.0
  max_insulator_leakage_threshold_ua: 100
  min_transmission_efficiency_threshold: 0.9
  peek_law_delta_coefficient: 30
  peek_law_radial_constant: 0.3
  uhvdc_distance_min_km: 2000
  uhvdc_voltage_max_kv: 1100
  uhvdc_voltage_min_kv: 800
semantic:
  alternative_parents: []
