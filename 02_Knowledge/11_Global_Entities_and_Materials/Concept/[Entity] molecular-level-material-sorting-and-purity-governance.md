...
lineage:
  ...
  original_hash: 3c56f848c05e4bda8e54ec073eca1acacf0588cd9b478cd0abfa2a61f83ba188
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] molecular-level-material-sorting-and-purity-governance에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  critical_impurity_limit_ppb: 1.0
  isotopic_precision_tolerance: 1.0e-05
  max_sorting_loss_rate: 0.15
  min_chain_of_custody_integrity: 0.98
  molecular_recognition_energy_condition: delta_g_recognition < 0
  purity_2n_threshold: 0.99
  purity_6n_threshold: 0.999999
  purity_9n_threshold: 0.999999999
semantic:
  alternative_parents: []
