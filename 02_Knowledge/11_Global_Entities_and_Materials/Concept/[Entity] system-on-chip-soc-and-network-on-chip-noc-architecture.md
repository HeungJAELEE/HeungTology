...
object:
  description: '[Entity] system-on-chip-soc-and-network-on-chip-noc-architecture에
    관한 고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  low_utilization_threshold: 10.0
  noc_congestion_threshold: 0.7
  noc_version: V6.3.7
  packet_latency_critical_limit: 100
  thermal_throttle_limit: 5
semantic:
  alternative_parents: []
