...
lineage:
  ...
  original_hash: bed2d0c9013bc0b80cc7501e4ec0ae9c8507ea7b919ca720c1a3d8608cae3933
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] inductive-heating-and-electromagnetic-induction-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  coupling_efficiency_threshold_ratio: 0.7
  faradays_law_formula: curl(E) = -dB/dt
  flame_heating_efficiency_range: 20-30%
  induction_heating_efficiency_range: 80-90%
  skin_depth_formula: sqrt(2 / (omega * mu * sigma))
semantic:
  alternative_parents: []
