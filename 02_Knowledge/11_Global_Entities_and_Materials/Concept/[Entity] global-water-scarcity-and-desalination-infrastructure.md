...
object:
  description: '[Entity] global-water-scarcity-and-desalination-infrastructure에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  absolute_temperature: T
  critical_salt_rejection_threshold_pct: 99.5
  gas_constant: R
  high_energy_consumption_threshold_kwh_m3: 4.5
  max_brine_discharge_salinity_pct: 70.0
  membrane_fouling_pressure_drop_threshold_bar: 3.0
  permeability_coefficient: A
  ro_energy_consumption_kwh_m3_range: 2.5-4.0
  ro_recovery_efficiency_pct_range: 40-50
  ro_salt_rejection_min_pct: 99.8
  solute_concentration: C
  van_t_hoff_factor: i
semantic:
  alternative_parents: []
