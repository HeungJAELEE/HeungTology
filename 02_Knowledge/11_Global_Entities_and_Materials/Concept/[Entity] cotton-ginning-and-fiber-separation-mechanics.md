...
lineage:
  ...
  original_hash: e7a80e01c5a67fda6e590e20fbd4a4e12119b859c87590838bdca30d1301c2e3
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] cotton-ginning-and-fiber-separation-mechanics에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  drag_force_variables:
  - cd
  - rho
  - v
  - a
  gin_stand_vibration_warning_threshold_mm_s: 7.0
  ginning_efficiency_formula: m_lint / m_seed_cotton * 100
  hand_gin_throughput_bales_hr: 0.5
  lint_moisture_critical_threshold_pct: 6.0
  neps_count_reject_threshold_per_gram: 200
  saw_gin_throughput_range_bales_hr: 15-20
  trash_content_notice_threshold_pct: 2.0
semantic:
  alternative_parents: []
