...
object:
  description: '[Entity] gamma-ray-spectroscopy-and-nuclear-decay-physics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  background_counts_threshold: 50.0
  calibration_drift_threshold: 5.0
  co60_energy_kev: '1173'
  cs137_energy_kev: '662'
  dead_time_threshold_pct: 20.0
  energy_range_max: 10 MeV
  energy_range_min: 10 keV
  peak_resolution_threshold: 2.5
semantic:
  alternative_parents: []
