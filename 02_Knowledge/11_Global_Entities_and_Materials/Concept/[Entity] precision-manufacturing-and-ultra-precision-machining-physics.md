...
object:
  description: '[Entity] precision-manufacturing-and-ultra-precision-machining-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  cutting_force_fluctuation_reject_threshold_mn: 5.0
  ra_calculation_formula: f^2 / (32 * R_tool)
  spindle_error_notice_threshold_nm: 20.0
  surface_roughness_warning_threshold_nm: 10.0
  temp_fluctuation_critical_threshold_c: 0.1
  thermal_expansion_formula: alpha * L * delta_T
  ultra_precision_feedback_resolution_um: 0.001
  ultra_precision_positioning_accuracy_um: 0.01
  ultra_precision_surface_finish_um: 0.005
semantic:
  alternative_parents: []
