...
lineage:
  ...
  original_hash: 66ee63da06b7bc89de68d21abba15f71b31e58bed5d51447c92571f2c9258902
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] transformer-physics-and-magnetic-flux-management에 관한 고밀도
    지능 노드'
  object_type: Hardware
  tier: 1
properties:
  diagnostic_core_loss_threshold_watts: 2000.0
  diagnostic_gas_threshold_ppm: 500.0
  diagnostic_temp_threshold_c: 105.0
  diagnostic_voltage_accuracy_threshold_pct: 98.0
  efficiency_conventional_range: 98.0-99.5%
  efficiency_smart_min: 99.8%
  lifespan_conventional_years: 30-50
  lifespan_electronic_years: 20-30
  magnetic_flux_conventional_tesla: 1.5-1.7
  magnetic_flux_high_freq_tesla: 0.2-0.5
semantic:
  alternative_parents: []
