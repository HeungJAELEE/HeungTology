...
lineage:
  ...
  original_hash: 8550fdd5a4d81baf970c5922f710bf5f079240d823c5ec48667a47eb90685227
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] silicon-carbide-sic-and-high-efficiency-inverter-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  bandgap_energy: 3.26 eV
  critical_field_limit: '> 3.0 MV/cm'
  defect_density_threshold: < 0.1 cm^-2
  heat_sink_volume_reduction_target: '> 50%'
  inverter_efficiency_target: '> 99%'
  lifespan_extension_factor: 5x
  mohs_hardness: '9.5'
  operating_temperature_limit: '> 250 C'
  switching_loss_reduction_vs_si: 70%
  system_voltage_standard: 800V
  thermal_conductivity_target: '> 450 W/mK'
semantic:
  alternative_parents: []
