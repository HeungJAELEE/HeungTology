...
object:
  description: '[Entity] rapid-thermal-processing-rtp-and-annealing-kinetics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  junction_depth_max: < 20 nm
  oxygen_level_max: < 10 ppm
  peak_temperature_range: 1000-1300 C
  ramp_up_rate_min: '> 200 C/s'
  soak_time_max: < 1 s
  temperature_uniformity_max: < 2 C
semantic:
  alternative_parents: []
