...
object:
  description: '[Entity] synchronous-machine-dynamics-and-power-factor-control에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  critical_load_angle_deg: 75.0
  maximum_excitation_temperature_c: 90.0
  maximum_fault_clearing_time_ms: 100.0
  minimum_power_factor_threshold: 0.8
semantic:
  alternative_parents: []
