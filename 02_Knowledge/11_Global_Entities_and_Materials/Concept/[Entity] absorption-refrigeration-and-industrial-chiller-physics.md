...
object:
  description: '[Entity] absorption-refrigeration-and-industrial-chiller-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  cop_absorption_range_max: 1.2
  cop_absorption_range_min: 0.7
  cop_suboptimal_threshold: 0.6
  li_br_crystallization_threshold_pct: 65.0
  purge_tank_pressure_warning_threshold_mmhg: 10.0
  refrigerant_conductivity_rejection_threshold_us_cm: 50.0
  vacuum_loss_capacity_drop_pct: 40.0
semantic:
  alternative_parents: []
