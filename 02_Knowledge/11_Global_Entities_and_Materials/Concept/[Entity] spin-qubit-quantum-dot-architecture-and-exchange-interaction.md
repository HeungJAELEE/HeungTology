...
object:
  description: '[Entity] spin-qubit-quantum-dot-architecture-and-exchange-interaction에
    관한 고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  charging_energy_threshold_mev: '10'
  coherence_time_ms: 10-100
  dephasing_time_natural_si_us: '1'
  exch_coupling_range_mhz: 1-100
  operating_temp_range_k: 1-4
  qubit_pitch_nm: 50-100
  readout_sensitivity_resolution: sub-electron
  valley_splitting_threshold_mev: '0.5'
semantic:
  alternative_parents: []
