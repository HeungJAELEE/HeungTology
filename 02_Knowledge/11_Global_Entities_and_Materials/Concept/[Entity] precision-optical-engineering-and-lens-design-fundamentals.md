...
lineage:
  ...
  original_hash: c0325acc66ae3223b9e4cb8681a46256db137a41bc47c3d8c9a2347db5e13a80
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] precision-optical-engineering-and-lens-design-fundamentals에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  centering_error_notice_um: 1.0
  centration_accuracy_um: 0.1
  coating_reflectivity_reject_pct: 0.5
  mtf_theoretical_limit: 0.9
  mtf_warning_threshold: 0.4
  surface_accuracy_threshold_nm: 1.0
  wavefront_error_diffraction_limit: lambda/50
  wavefront_error_rms_critical: 0.07
semantic:
  alternative_parents: []
