...
lineage:
  ...
  original_hash: 1cca534be45ede938f05355f4743773bdccda6dfcbdbd800a8a6b35fefad6293
metadata:
  date: '2026-05-16'
...
object:
  ...
  tier: 1
properties:
  barrier_thickness_max: 3.0 nm
  barrier_thickness_tolerance: 0.1 nm
  blacks_equation: MTTF = A * J^-n * exp(Ea/kT)
  cu_resistivity: 1.68 uOhm-cm
  cu_resistivity_tolerance: 0.05 uOhm-cm
  current_density_threshold: 10^6 A/cm^2
  current_density_tolerance: 5%
  low_k_constant_max: '2.5'
  low_k_constant_tolerance: '0.05'
  mttf_target: 100,000 hr
  mttf_tolerance: 1,000 hr
  rc_delay_formula: tau = R * C
semantic:
  alternative_parents: []
