...
object:
  description: '[Entity] synthetic-biology-and-genetic-circuit-design-logic에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  circuit_response_time_notice_threshold_min: 120.0
  genetic_circuit_version: V6.3.7
  metabolic_burden_critical_threshold_pct: 40.0
  mutation_rate_rejection_threshold_per_generation: 1.0e-05
  signal_leakage_warning_threshold_pct: 15.0
semantic:
  alternative_parents: []
