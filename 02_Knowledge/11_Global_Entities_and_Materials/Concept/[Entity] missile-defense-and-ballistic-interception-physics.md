...
lineage:
  ...
  original_hash: e1edfd32446ac9e29db3c60d4e88cf4bddfcc3e120aad58820d48f2a93e787fd
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] missile-defense-and-ballistic-interception-physics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  altitude_strategic_km: '> 100'
  altitude_tactical_km: < 20
  closing_velocity_strategic_m_s: 5000-10000+
  closing_velocity_tactical_m_s: 1000-3000
  critical_miss_distance_threshold_m: 0.5
  low_divert_resource_delta_v: 50
  min_impact_energy_tj: 1.0
  navigation_constant_n: N
  radar_range_strategic_km: 1000-5000
  radar_range_tactical_km: 100-300
  radar_track_error_threshold_m: 10.0
  target_speed_strategic_mach: 15-25+
  target_speed_tactical_mach: 2-5
semantic:
  alternative_parents: []
