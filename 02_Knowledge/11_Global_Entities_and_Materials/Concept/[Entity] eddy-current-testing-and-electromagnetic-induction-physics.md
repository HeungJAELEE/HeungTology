...
lineage:
  ...
  original_hash: e18d2af3053391275ffcd0684e127aaef0075869b39fa411435ce27f52560d71
metadata:
  date: '2026-05-16'
  domain: 11_Global_Entities_and_Materials
  id: '[[[Entity] eddy-current-testing-and-electromagnetic-induction-physics]]'
  last_updated: '2026-05-17T22:59:20+09:00'
  project: Vault_Modernization
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: '[Entity] eddy-current-testing-and-electromagnetic-induction-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  detection_mode: electromagnetic_sub_surface
  lift_off_warning_threshold: 0.5
  low_frequency_threshold_khz: 10.0
  phase_noise_threshold: 5.0
  skin_depth_formula: 1 / sqrt(pi * f * mu * sigma)
  target_material: conductive_metals
semantic:
  alternative_parents: []
