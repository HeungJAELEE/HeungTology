...
object:
  description: '[Entity] feedwater-treatment-and-boiler-corrosion-prevention-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  conductivity_treated_limit_us_cm: 1.0
  dissolved_oxygen_critical_threshold_ppb: 20.0
  dissolved_oxygen_limit_ppb: 7.0
  hardness_treated_limit_ppm: 1.0
  iron_content_notice_threshold_ppb: 10.0
  iron_oxidation_reaction: Fe + 2H2O -> Fe(OH)2 + H2
  lsi_formula: pH - pH_s
  ph_target_max: 9.5
  ph_target_min: 8.5
  ph_warning_threshold: 8.0
  silica_reject_threshold_ppm: 0.05
  silica_treated_limit_ppm: 0.02
semantic:
  alternative_parents: []
