...
lineage:
  ...
  original_hash: 57edc3e9687429d1ee7b5fba8516e05c16436c81604036d88ac2f57ffc1574b5
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] isochoric-and-isobaric-thermodynamic-processes에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  degrees_of_freedom_default: 3
  first_law_of_thermodynamics: dU = Q - W
  gas_constant_r: 8.314
  ideal_gas_law: PV = nRT
  isobaric_heat_transfer: n * Cp * delta_T
  isochoric_heat_transfer: n * Cv * delta_T
  isochoric_work: 0
  mayers_relation: Cp = Cv + R
