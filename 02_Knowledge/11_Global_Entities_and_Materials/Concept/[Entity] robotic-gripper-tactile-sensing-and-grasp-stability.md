...
lineage:
  ...
  original_hash: ada0eaebd3cbb003561da2911e863c4a0954500f0e77af280a046874da35a968
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] robotic-gripper-tactile-sensing-and-grasp-stability에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  friction_cone_inequality: sqrt(fx^2 + fy^2) <= mu * fz
  grasp_stability_metric: GWS
  gripping_force_parallel_n: 10~500
  slip_detection_lead_time_ms: 10
  tactile_resolution_gel_sight_mm: <0.1
semantic:
  alternative_parents: []
