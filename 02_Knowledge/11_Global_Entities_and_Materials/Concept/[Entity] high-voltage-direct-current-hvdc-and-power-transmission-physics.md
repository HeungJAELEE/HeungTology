...
lineage:
  ...
  original_hash: 4fae5f34f99991c381d4ef36b9680a047e528dcbb9f66cb9b00def630c927935
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] high-voltage-direct-current-hvdc-and-power-transmission-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  ac_transmission_distance_limit_km: 600
  harmonic_thd_critical_threshold_pct: 5.0
  joule_heating_formula: P_loss = I^2 * R
  rectifier_voltage_logic: V_dc ∝ cos(alpha)
  voltage_drop_warning_threshold: 0.95
semantic:
  alternative_parents: []
