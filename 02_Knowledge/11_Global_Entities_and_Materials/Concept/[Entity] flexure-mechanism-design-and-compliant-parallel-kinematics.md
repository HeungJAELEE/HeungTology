...
lineage:
  ...
  original_hash: 2b58b3a8688a8e53d1db9946bebb2dd52620153d9289ed525b3954107d01f156
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] flexure-mechanism-design-and-compliant-parallel-kinematics에
    관한 고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  hysteresis_error_threshold_nm: 5.0
  leaf_flexure_fatigue_life_cycles: 10^7
  leaf_flexure_linearity_percent: 0.1
  leaf_flexure_max_stroke_mm: 1-5
  leaf_flexure_resolution_nm: <1
  min_resonant_frequency_hz: 100
  notch_flexure_fatigue_life_cycles: 10^8
  notch_flexure_linearity_percent: 0.01
  notch_flexure_max_stroke_mm: 0.1-0.5
  notch_flexure_resolution_nm: <0.1
  parasitic_motion_threshold_nm: 10.0
  stiffness_drift_threshold: 0.05
semantic:
  alternative_parents: []
