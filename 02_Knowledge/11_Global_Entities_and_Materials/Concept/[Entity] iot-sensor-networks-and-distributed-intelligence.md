...
object:
  description: '[Entity] iot-sensor-networks-and-distributed-intelligence에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  ble_data_rate_mbps: 2
  ble_range_m: 10-50
  dead_node_ratio_threshold: 0.1
  latency_threshold_ms: 500
  lorawan_max_data_rate_kbps: 50
  lorawan_range_km: 5-15
  nbiot_data_rate_kbps: 200
  nbiot_range_km: 1-10
  packet_loss_threshold_rate: 0.05
  sensor_drift_threshold_pct: 5.0
  urllc_min_data_rate_gbps: 1
  zigbee_data_rate_kbps: 250
  zigbee_range_m: 10-100
semantic:
  alternative_parents: []
