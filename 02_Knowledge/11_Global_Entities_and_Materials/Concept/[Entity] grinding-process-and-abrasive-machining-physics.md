...
lineage:
  ...
  original_hash: a696011a951149c1e3da3e56ac1d438a6fdf36dc48b87ec381e20c955394a084
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] grinding-process-and-abrasive-machining-physics에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  coolant_temp_rise_threshold: 10.0
  hardness_limit_hrc: 70+
  nominal_load_threshold_multiplier: 1.2
  specific_grinding_energy_formula: P_total / MRR
  surface_finish_ra_range: 0.1-0.8 um
  surface_temp_rise_proportionality: e_s * v_w * a_e^(3/4)
  workpiece_heat_distribution_ratio: 0.8
semantic:
  alternative_parents: []
