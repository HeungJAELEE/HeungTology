...
lineage:
  ...
  original_hash: 7a9879270b51eae286e2d225fc30c1d39c9215a3f56091400f059507567f01a2
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] water-electrolysis-and-proton-exchange-membrane-pem-stack에
    관한 고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  critical_voltage_deviation_threshold: 0.1
  electrolysis_efficiency_formula: eta = (HHV_H2 * n_dot_H2) / P_electric
  faradays_law_formula: m = (Q/F) * (M/z)
  notice_purity_drop_threshold: 99.99
  pem_current_density_range: 1.0-3.0 A/cm^2
  pem_hydrogen_purity_spec: 99.999
  pem_pressure_range: 30-80 bar
  reject_feed_water_conductivity_threshold: 1.0
  target_efficiency_range: 0.7-0.8
  warning_specific_energy_consumption_threshold: 55.0
semantic:
  alternative_parents: []
