...
lineage:
  ...
  original_hash: 468cd22e68e8eebc3f097c2cb292ed07b8bd7c58738cd03aaa9993673bacca19
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] hard-disk-drive-hdd-and-magnetic-recording-physics에 관한 고밀도
    지능 노드'
  object_type: Hardware
  tier: 1
properties:
  atmosphere_type: helium_sealed
  bit_error_rate_threshold: 0.0001
  critical_fly_height_threshold_nm: 0.5
  fly_height_range_nm: 1-3
  platter_speed_max_rpm: 15000
  platter_speed_min_rpm: 5400
  read_sensor_technology: tunneling_magnetoresistive_tmr
  recording_method: perpendicular_magnetic_recording_pmr
  spindle_vibration_threshold_um: 0.1
semantic:
  alternative_parents: []
