...
object:
  description: '[Entity] metamaterials-and-negative-refractive-index-optics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  feature_scale_a_limit: lambda / 10
  feature_scale_a_tolerance: 1 nm
  imaging_limit_max: lambda / 20
  imaging_limit_tolerance: 5 nm
  intelligence_version: v6.3.7
  loss_tangent_limit: 0.01
  loss_tangent_tolerance: 0.001
  n_eff_tolerance: 0.05
  target_n_eff: -1.0
  visibility_reduction_min: 0.99
  visibility_reduction_tolerance: 0.001
semantic:
  alternative_parents: []
