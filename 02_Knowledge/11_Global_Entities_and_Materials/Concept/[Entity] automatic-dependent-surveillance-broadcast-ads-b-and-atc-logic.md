...
object:
  description: '[Entity] automatic-dependent-surveillance-broadcast-ads-b-and-atc-logic에
    관한 고밀도 지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  ads_b_update_rate_s: 1.0
  conflict_warning_threshold: 5
  gps_accuracy_range_m: 10-30
  latency_warning_threshold_s: 2.0
  nac_p_critical_threshold: 7
  target_max_latency_s: 0.1
semantic:
  alternative_parents: []
