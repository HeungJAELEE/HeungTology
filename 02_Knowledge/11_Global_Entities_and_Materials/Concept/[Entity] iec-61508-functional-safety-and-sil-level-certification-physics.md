...
object:
  description: '[Entity] iec-61508-functional-safety-and-sil-level-certification-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  high_failure_rate_threshold: 1.0e-06
  pfd_avg_calculation: lambda * (ti / 2)
  rrf_calculation: 1 / pfd_avg
  sil_1_rrf_range: 10-100
  sil_2_rrf_range: 100-1000
  sil_3_rrf_range: 1000-10000
  sil_4_rrf_range: 10000-100000
  software_audit_threshold: 0.95
semantic:
  alternative_parents: []
