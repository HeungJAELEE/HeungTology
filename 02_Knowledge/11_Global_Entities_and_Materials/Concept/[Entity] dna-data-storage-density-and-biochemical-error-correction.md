...
lineage:
  ...
  original_hash: 03ebea6e3e87eae57e009d8407aa56df203880b6826baff737f3a52bc30a0d8c
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] dna-data-storage-density-and-biochemical-error-correction에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  data_density_threshold: '> 400 PB/g'
  error_correction_overhead_limit: < 15%
  gc_content_range: 40-60%
  half_life_minimum: '> 1,000 years'
  homopolymer_limit_max: < 4 bases
  sequencing_fidelity_threshold: '> 99.9%'
  storage_cost_target: < 1 $/GB
  synthesis_speed_target: '> 10 Mbps'
semantic:
  alternative_parents: []
