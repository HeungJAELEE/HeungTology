...
lineage:
  ...
  original_hash: f86baf2ade26dbbcea86997eba50777a525190d4987506f61e6b37086e053973
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] film-deposition-and-chemical-vapor-deposition-cvd-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  arrhenius_reaction_model: k_r = A * exp(-E_a / (R * T))
  critical_trench_aspect_ratio: 20
  cvd_spec_version: V6.3.7
  deposition_rate_formula: R_dep = (k_r * C_g) / (1 + k_r / h_g)
  high_pressure_warning_threshold_torr: 10.0
  low_deposition_rate_warning_threshold_factor: 0.8
  uniformity_breach_threshold_pct: 5.0
semantic:
  alternative_parents: []
