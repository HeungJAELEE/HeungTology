...
object:
  description: '[Entity] process-analytical-technology-pat-and-real-time-quality-control에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  cqa_deviation_reject_threshold: 5.0
  model_drift_notice_threshold: 2.0
  prediction_confidence_warning_threshold: 0.9
  sensor_snr_critical_threshold: 20.0
