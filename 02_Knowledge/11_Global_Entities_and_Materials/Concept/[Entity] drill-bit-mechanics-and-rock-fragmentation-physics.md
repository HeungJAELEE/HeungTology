...
lineage:
  ...
  original_hash: e9a6d5e78e18f4c8dcd1c5cc5fc5bb1ca038e16d7c3afd5a520d99ab32d5cb70
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] drill-bit-mechanics-and-rock-fragmentation-physics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  high_mechanical_energy_rpm_threshold: 120
  high_mechanical_energy_wob_threshold_t: 30.0
  low_cutting_efficiency_torque_threshold_k_nm: 5.0
  low_cutting_efficiency_wob_threshold_t: 10.0
  mohr_coulomb_shear_strength_formula: tau = c + sigma * tan(phi)
  rop_formula: ROP = (K * WOB * RPM) / (D^2 * S_rock)
  stalling_rpm_threshold: 40
  stalling_torque_threshold_k_nm: 25.0
  vibration_rejection_threshold_g: 15.0
semantic:
  alternative_parents: []
