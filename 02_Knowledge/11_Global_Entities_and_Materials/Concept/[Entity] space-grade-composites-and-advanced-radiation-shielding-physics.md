...
object:
  description: '[Entity] space-grade-composites-and-advanced-radiation-shielding-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  cte_target: 0
  external_db_endpoint: manufacturing-utility-log-v2026
  outgassing_rate_max_percent: 0.1
  shielding_efficiency_threshold_db: 20
  specific_strength_threshold_knm_kg: 2000
  thermal_delta_celsius: 200
  whipple_shield_min_velocity_kms: 10
  whipple_shield_optimal_s_d_ratio: 15
semantic:
  alternative_parents: []
