...
object:
  description: '[Entity] underwater-acoustic-communication-and-blue-laser-links에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  acoustic_data_rate_mbps: < 0.1
  acoustic_propagation_speed_kms: 1.5
  acoustic_range_km: 1-100
  ber_threshold: 0.001
  blue_laser_data_rate_mbps: 100-1000
  blue_laser_propagation_speed_kms: 225000
  blue_laser_range_km: 0.1-0.2
  critical_snr_threshold_db: 10.0
  critical_turbidity_threshold_ntu: 50.0
  doppler_compensation_error_threshold_hz: 50.0
semantic:
  alternative_parents: []
