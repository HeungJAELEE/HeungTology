...
object:
  description: '[Entity] brick-manufacturing-and-ceramic-firing-kinetics에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  arrhenius_reaction_rate_model: k = A * e^(-Ea / (R * T))
  compressive_strength_range_mpa: 20-100
  efflorescence_salt_threshold_ppm: 500
  excessive_shrinkage_threshold_pct: 10.0
  firing_temperature_range_celsius: 900-1200
  kiln_temp_non_uniformity_threshold_pct: 20.0
  sintering_shrinkage_model: delta_l/l0 = (K * gamma * omega * D / (k * T * r^p))^m
    * t^m
  under_fired_absorption_threshold_pct: 12.0
  water_absorption_target_pct: < 10
semantic:
  alternative_parents: []
