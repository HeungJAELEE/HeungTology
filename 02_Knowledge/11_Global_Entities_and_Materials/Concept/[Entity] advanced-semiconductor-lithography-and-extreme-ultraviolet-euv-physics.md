...
lineage:
  ...
  original_hash: 591812090dc6eddb487723cfede0c6e8443dc56b25d980d64c823c9c45ff601a
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] advanced-semiconductor-lithography-and-extreme-ultraviolet-euv-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  euv_arf_photon_energy_ratio: 14
  euv_wavelength_nm: 13.5
  high_end_overlay_limit_nm: 0.8
  high_na_na: 0.55
  high_na_resolution_limit_nm: 8.0
  source_power_threshold_w: 250
  standard_euv_na: 0.33
  standard_euv_resolution_limit_nm: 13.0
  standard_overlay_limit_nm: 1.5
semantic:
  alternative_parents: []
