...
lineage:
  ...
  original_hash: 73919e63f69e25df4a02898a10b970cf0c96ec3892fb12b16ad16645e1398512
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] transmission-control-protocol-tcp-and-industrial-ethernet-sync에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  industrial_ethernet_latency_max_ms: 1.0
  industrial_ethernet_sync_accuracy_us: 1
  jitter_formula: abs(l_i - l_avg)
  jitter_threshold_critical: 100.0
  retransmission_rate_threshold_notice: 0.01
  sync_offset_threshold_warning: 500
  throughput_formula: window_size / rtt
semantic:
  alternative_parents: []
