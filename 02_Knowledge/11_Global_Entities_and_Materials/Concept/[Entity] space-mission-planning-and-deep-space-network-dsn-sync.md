...
lineage:
  ...
  original_hash: cef7d03e1e0746b1a9d1bebf69271db394dadfca2fe33dd1cb74313d8d177835
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] space-mission-planning-and-deep-space-network-dsn-sync에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  clock_drift_threshold_ms: 10.0
  downlink_snr_threshold_db: 5.0
  dsn_antenna_max_m: 70
  dsn_antenna_min_m: 34
  frequency_band_deep_space: Ka-band / Optical
  navigation_method_deep_space: Delta-DOR / VLBI
  orbital_insertion_error_threshold_km: 100.0
semantic:
  alternative_parents: []
