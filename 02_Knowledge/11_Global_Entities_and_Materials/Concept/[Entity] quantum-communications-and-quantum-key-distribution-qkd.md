...
lineage:
  ...
  original_hash: f344de6a6d1b0db3f6d9372e790d2308994a2f012220dfa1ecfc46cf6a966667
metadata:
  date: '2026-05-16'
  domain: 11_Global_Entities_and_Materials
  id: '[[[Entity] quantum-communications-and-quantum-key-distribution-qkd]]'
  last_updated: '2026-05-17T22:59:20+09:00'
  project: Vault_Modernization
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: '[Entity] quantum-communications-and-quantum-key-distribution-qkd에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  qber_threshold_limit: 11%
  target_detector_efficiency: '> 30%'
  target_key_gen_rate: '> 10 kbps'
  target_photon_count: < 1.0
  target_qber: < 3%
  target_sifting_efficiency: 50%
  target_trans_distance: '> 100 km'
semantic:
  alternative_parents: []
