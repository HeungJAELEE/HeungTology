...
object:
  description: '[Entity] bio-digital-convergence-and-silico-biological-computing에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  bit_per_base_standard: 2.0
  computation_efficiency_target_fj_op: 1.0e-12
  data_density_target_bits_nm3: 1000000000.0
  logic_gate_count_per_cell_target: 100
  retention_years_target: 1000
  signal_threshold_db: 20.0
  specification_version: HDS-Gold V6.3.7
  synthesis_error_threshold: 1.0e-09
  transfer_efficiency_target_percent: 95.0
semantic:
  alternative_parents: []
