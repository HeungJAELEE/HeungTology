...
lineage:
  ...
  original_hash: ca93685fc7a56edb185a874b8d998a5104ead7e9dfefd5a8e3dc3ec69575b7d5
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] fluidized-bed-combustion-fbc-and-heat-transfer-physics에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  critical_low_temp_c: 750.0
  defluidization_velocity_multiplier: 1.5
  fbc_temp_range_c: 800-900
  nox_surge_temp_c: 950.0
  optimal_nox_temp_c: 850.0
  sox_emission_limit_ppm: 50.0
  u_mf_formula: d_p^2 * (rho_s - rho_g) * g / (150 * mu)
semantic:
  alternative_parents: []
