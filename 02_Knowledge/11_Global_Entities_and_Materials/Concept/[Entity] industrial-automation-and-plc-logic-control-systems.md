...
object:
  description: '[Entity] industrial-automation-and-plc-logic-control-systems에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  cpu_overload_threshold_pct: 85.0
  iec_standard: IEC 61131
  network_jitter_threshold_ms: 1.0
  plc_version: V6.3.7
  scan_cycle_range_ms: 1-10
  sequential_logic_formula: f(input, state_prev)
  t_scan_formula: t_read + t_exec + t_write + t_overhead
semantic:
  alternative_parents: []
