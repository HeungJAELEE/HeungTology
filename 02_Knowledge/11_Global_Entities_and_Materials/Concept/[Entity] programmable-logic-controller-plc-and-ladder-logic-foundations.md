...
lineage:
  ...
  original_hash: 634ea9ec9ac36864987e9baf3464bc8a0349c284f5ddee170d554de6bda744d0
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] programmable-logic-controller-plc-and-ladder-logic-foundations에
    관한 고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  boolean_logic_formula: Y = (A * B) + NOT C
  ipc_mtbf_hours: 50000
  max_jitter_threshold_ms: 5.0
  max_scan_time_threshold_ms: 50.0
  plc_mtbf_hours: 200000
  programming_standard: IEC 61131-3
  scan_time_formula: T_scan = T_read + T_execute + T_write
semantic:
  alternative_parents: []
