...
object:
  description: '[Entity] swr-and-agv-fleet-coordination-and-path-planning에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  audit_status_id: Ant-Fleet-v2026-Fidelity
  battery_utilization_target: maximum
  collision_rate_target: '0'
  fleet_size_min: 500 units
  localization_accuracy_max: 1 cm
  path_efficiency_min: 95%
