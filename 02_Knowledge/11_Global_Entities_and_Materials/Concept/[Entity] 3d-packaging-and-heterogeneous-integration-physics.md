...
object:
  description: '[Entity] 3d-packaging-and-heterogeneous-integration-physics에 관한 고밀도
    지능 노드'
  object_type: Hardware
  tier: 1
properties:
  die_interface_temp_threshold_c: '95.0'
  footprint_reduction_percentage: 20-30
  latency_reduction_percentage: 10-20
  package_warpage_threshold_um: '50.0'
  tsv_resistance_threshold_ohm: '1.0'
semantic:
  alternative_parents: []
