...
lineage:
  ...
  original_hash: c067d5c4af93f33a5cb62c1b3561a254c4a5e8aa087c058ee624b8fa01ed368c
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] supercapacitor-and-fast-charging-energy-storage에 관한 고밀도 지능
    노드'
  object_type: Hardware
  tier: 1
properties:
  capacitance_range: 100-5000 F
  cycle_life_min: 500,000
  energy_density_range: 5-20 Wh/kg
  eol_c_retention_threshold: '0.8'
  eol_esr_increase_threshold: '2.0'
  esr_max: 1.0 mOhm
  external_dataset_endpoint: supercapacitor-charge-discharge-cycles-and-esr-log-v2026
  power_density_range: 10,000-50,000 W/kg
  system_reliability_target: 99%
  warning_c_retention_threshold: '0.9'
  warning_esr_increase_threshold: '1.5'
semantic:
  alternative_parents: []
