...
lineage:
  ...
  original_hash: 940ed07c8a45a1109dc12d33fca0b774a94abb29ea2752512f781ca87e18d709
metadata:
  date: '2026-05-16'
...
object:
  ...
  tier: 1
properties:
  critical_permeate_conductivity_us: 500
  fouling_flux_recovery_pct_threshold: 40.0
  fouling_pressure_threshold_bar: 70.0
  low_feed_pressure_threshold_bar: 50.0
  min_erd_efficiency_pct: 90.0
  msf_energy_intensity_kwh_m3: 10-15
  msf_salt_rejection_pct: 99.9+
  osmotic_pressure_formula: Pi = iMRT
  ro_energy_intensity_kwh_m3: 2.5-4.0
  ro_salt_rejection_pct: 99.5-99.8
  typical_operating_pressure_bar: 60-80
  water_flux_formula: Jw = A(Delta P - Delta Pi)
semantic:
  alternative_parents: []
