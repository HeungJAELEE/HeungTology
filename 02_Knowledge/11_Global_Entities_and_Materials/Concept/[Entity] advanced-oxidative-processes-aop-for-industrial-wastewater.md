...
object:
  description: '[Entity] advanced-oxidative-processes-aop-for-industrial-wastewater에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  h2o2_warning_threshold_ppm: 50.0
  toc_critical_threshold_pct: 80.0
  uv_low_intensity_threshold_mw: 15.0
semantic:
  alternative_parents: []
