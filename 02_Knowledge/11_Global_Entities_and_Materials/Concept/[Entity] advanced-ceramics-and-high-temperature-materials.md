...
object:
  description: '[Entity] advanced-ceramics-and-high-temperature-materials에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  creep_rate_model_parameters:
  - A
  - sigma
  - n
  - Q
  - R
  - T
  creep_rate_target: < 10^-9 s^-1
  fracture_toughness_integrity_min: 5 MPa·m^1/2
  fracture_toughness_k1c_target: 3-15 MPa·m^1/2
  grain_size_target: < 1 μm
  griffith_criterion_parameters:
  - E
  - gamma_s
  - a
  hardness_hv_target: '> 1,500 HV'
  operating_temperature_target: '> 1,500 °C'
  sintering_density_target: '> 99%'
  thermal_shock_resistance_target: '> 200 °C'
semantic:
  alternative_parents: []
