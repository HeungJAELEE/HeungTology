...
object:
  description: '[Entity] data-governance-and-enterprise-information-management에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  critical_completeness_threshold_pct: 90.0
  dqi_accuracy_weight: w_a
  dqi_completeness_weight: w_c
  dqi_uniqueness_weight: w_u
  max_access_breach_count: 0
  target_data_lineage_pct: 95.0
  target_master_data_accuracy_pct: 99.5
  target_metadata_coverage_pct: 100.0
  target_stewardship_pct: 90.0
  warning_lineage_threshold_pct: 80.0
semantic:
  alternative_parents: []
