...
lineage:
  ...
  original_hash: a9ef7ab480e9117a8ee2ea25bd06b4c04fd7b09ea6f10a112269002e5f0f72bc
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] light-emitting-diode-led-and-quantum-efficiency-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  flux_degradation_threshold: 0.9
  lifespan_led: 50,000+ hr
  luminous_efficacy_led: 200+ lm/W
  response_time: ns
  thermal_droop_threshold_c: 100.0
  voltage_degradation_threshold: 1.1
semantic:
  alternative_parents: []
