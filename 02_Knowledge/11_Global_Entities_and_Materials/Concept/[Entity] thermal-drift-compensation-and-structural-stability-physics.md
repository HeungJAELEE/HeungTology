...
lineage:
  ...
  original_hash: 390bd019add4ace7000bd5cc2f5779d59878f710f8db190cbddefe7589993b03
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] thermal-drift-compensation-and-structural-stability-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  audit_fidelity_id: Heat-Shield-v2026-Fidelity
  compensation_accuracy_target: '> 90%'
  cte_invar_limit: < 1 ppm/K
  structural_stiffness_limit: '> 200 N/um'
  target_version: V6.3.7
  temp_stability_limit: < 1 mK
  thermal_drift_limit: < 10 nm/hour
semantic:
  alternative_parents: []
