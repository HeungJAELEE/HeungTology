...
lineage:
  ...
  original_hash: 6c0aed4e5a9b20e8a4a3856544a60f717491721c89e26254d384306e1a3c3215
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] governor-and-centrifugal-speed-regulation-physics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  centrifugal_force_formula: m * r * omega^2
  critical_speed_error_threshold: 0.1
  governor_saturation_angle_threshold: 85.0
  max_linkage_backlash_mm: 2.0
  optimal_speed_error_threshold: 0.01
  watt_governor_height_formula: g / omega^2
semantic:
  alternative_parents: []
