...
object:
  description: '[Entity] flotation-process-and-mineral-bubble-attachment-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  bubble_size_range_mm: 0.5-2.0
  grade_selectivity_threshold: 0.7
  max_impeller_speed_rpm: 1200
  min_air_hold_up_pct: 10.0
  min_pulp_ph: 8.5
  particle_size_range_um: 10-100
  recovery_rate_pct: 90-98
semantic:
  alternative_parents: []
