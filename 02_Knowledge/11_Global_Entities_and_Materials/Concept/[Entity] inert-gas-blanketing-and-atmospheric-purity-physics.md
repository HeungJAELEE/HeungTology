...
object:
  description: '[Entity] inert-gas-blanketing-and-atmospheric-purity-physics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  critical_oxygen_threshold_factor: '0.8'
  dalton_law_formula: Ptotal = Pinert + Poxygen + Pvapor
  dilution_purging_formula: Ct = C0 * e^(-Qt/V)
  excessive_flow_threshold_factor: '2.0'
  low_pad_pressure_threshold_mbar: '2.0'
  oxygen_concentration_limit_pct: < 1.0
  primary_blanketing_gases: Nitrogen (N2), Argon (Ar)
  tank_pressure_range_mbar: 5-50
semantic:
  alternative_parents: []
