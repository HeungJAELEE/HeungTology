...
object:
  description: '[Entity] flame-spectroscopy-and-atomic-absorption-aas-physics에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  aas_flame_temp_range_k: 2300-3000
  aas_sensitivity: ppb
  aas_version: V6.3.7
  absorbance_saturation_threshold: 1.5
  beer_lambert_law: A = epsilon * c * l
  boltzmann_distribution: N_j/N_0 = (g_j/g_0) * exp(-Delta_E / kT)
  fuel_ratio_tolerance: 0.2
  lamp_current_limit_ma: 12.0
  phosphate_interference_threshold: 100
semantic:
  alternative_parents: []
