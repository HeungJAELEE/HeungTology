...
object:
  description: '[Entity] agricultural-robotics-and-autonomous-harvesting-vision에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  apple_damage_threshold_n: 8.0
  depth_resolution_mm: 1.0
  external_data_endpoint: agri-robot-harvesting-yield-and-vision-accuracy-log-v2026
  grasping_force_max_n: 4.0
  grasping_force_min_n: 1.5
  harvesting_cycle_time_limit_sec: 15.0
  localization_accuracy_limit_m: 0.05
  min_detection_confidence_threshold: 0.85
  object_detection_map: 0.94
  strawberry_damage_threshold_n: 2.5
  target_cost_reduction_ratio: 0.4
  target_efficiency_index_threshold: 0.8
  target_harvest_success_rate: 0.95
  tomato_damage_threshold_n: 5.0
semantic:
  alternative_parents: []
