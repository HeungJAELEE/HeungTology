...
lineage:
  ...
  original_hash: 95e17fdb9bd4de517c3c6f6101d4b6a1d1101b5f57c01e3bb4b5fb4a143f3564
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] surface-mount-technology-smt-and-pick-and-place-robotics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  cph_formula: (3600 * N) / T_cycle
  nozzle_vacuum_warning_threshold_kpa: -60.0
  placement_accuracy_formula: sqrt(delta_mech^2 + delta_vision^2)
  placement_offset_critical_threshold_um: 30.0
  reflow_peak_temp_nominal_celsius: 245.0
  reflow_temp_tolerance_celsius: 10.0
  smt_cph_max: 200000
  smt_cph_min: 50000
  smt_placement_accuracy_max_mm: 0.03
  smt_placement_accuracy_min_mm: 0.01
  solder_paste_volume_accuracy_threshold_pct: 90.0
semantic:
  alternative_parents: []
