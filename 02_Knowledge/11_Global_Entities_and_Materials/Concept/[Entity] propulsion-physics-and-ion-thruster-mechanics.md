...
lineage:
  ...
  original_hash: 7affbbd56d26f7136a4688ddd7a1e61c6198783c0db138da2e5948105244d322
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] propulsion-physics-and-ion-thruster-mechanics에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  acceleration_max_ion_thruster: 0.01_g
  beam_current_min_threshold_amp: '1.0'
  chamber_pressure_max_threshold_torr: 1e-4
  efficiency_min_ion_thruster: '0.70'
  grid_leakage_critical_threshold_ma: '50.0'
  isp_range_ion_thruster: 2000-10000_sec
  min_propellant_reserve_xenon_kg: '5.0'
semantic:
  alternative_parents: []
