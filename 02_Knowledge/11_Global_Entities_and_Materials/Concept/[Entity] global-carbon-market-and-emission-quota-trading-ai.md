...
lineage:
  ...
  original_hash: 3ac73bc2ed9f7cdba4aaa6a4f44bbd1683c27416fa198e8aea2820dda5713738
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] global-carbon-market-and-emission-quota-trading-ai에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  eu_ets_carbon_cost_max: 100
  eu_ets_carbon_cost_min: 80
  eu_ets_industry_scope_min_percent: 40
  eu_ets_reduction_target_2030_percent: -55
  min_audit_transparency_threshold: 0.9
  min_price_signal_threshold_usd: 30.0
  voluntary_market_carbon_cost_max: 20
  voluntary_market_carbon_cost_min: 5
  voluntary_market_industry_scope_max_percent: 10
semantic:
  alternative_parents: []
