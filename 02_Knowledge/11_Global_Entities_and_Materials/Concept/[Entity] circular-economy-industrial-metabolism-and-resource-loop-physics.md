...
lineage:
  ...
  original_hash: 1ca065ca48b347c29b1ff1de73f8947bb3768ee1f7885dc92c6935f6dea504ee
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] circular-economy-industrial-metabolism-and-resource-loop-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  carbon_intensity_tier1_max_ratio: 0.3
  data_source_endpoint: industrial-resource-loop-efficiency-and-waste-reduction-v2026
  landfill_rate_tier1_max_pct: 5
  loop_efficiency_tier1_min_pct: 85
  recycled_content_tier1_min_pct: 50
  resource_lifetime_tier1_min_multiplier: 3.0
  sustainability_engine_critical_recovery_threshold_pct: 80.0
  sustainability_engine_notice_content_threshold_pct: 30.0
  sustainability_engine_warning_waste_threshold_pct: 10.0
  target_waste_elimination_pct: 95
semantic:
  alternative_parents: []
