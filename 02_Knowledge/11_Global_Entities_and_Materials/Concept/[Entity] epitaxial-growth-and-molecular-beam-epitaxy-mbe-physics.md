...
object:
  description: '[Entity] epitaxial-growth-and-molecular-beam-epitaxy-mbe-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  nominal_substrate_temp_c: '600.0'
  shutter_transition_time_limit_ms: '100'
  substrate_temp_tolerance_c: '10.0'
  vacuum_contamination_threshold_torr: 1e-9
  vacuum_level_mbe_torr: 1e-11
semantic:
  alternative_parents: []
