...
object:
  description: '[Entity] autonomous-vehicle-navigation-path-planning-and-obstacle-avoidance에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  a_star_cost_function: f(n) = g(n) + h(n)
  heuristic_type: euclidean_distance
  path_optimality_target: 0.95
  planning_latency_max_ms: 50
  resource_usage_limit_percent: 20
  safety_distance_max_m: 2.0
  safety_distance_min_m: 0.5
