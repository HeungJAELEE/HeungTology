...
lineage:
  ...
  original_hash: 62ca867f8b380f7727a0b39fa1a18af866c1628903230f7e34b5bcb2e33f000b
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] metal-forming-and-plastic-deformation-physics에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  critical_forming_limit_margin: 0.1
  material_usage_efficiency_percent: 100
  metal_forming_version: V6.3.7
  springback_warning_threshold_mm: 1.0
  von_mises_stress_formula: sqrt(0.5 * ((sigma_1-sigma_2)^2 + (sigma_2-sigma_3)^2
    + (sigma_3-sigma_1)^2))
  work_hardening_formula: sigma = K * epsilon^n
semantic:
  alternative_parents: []
