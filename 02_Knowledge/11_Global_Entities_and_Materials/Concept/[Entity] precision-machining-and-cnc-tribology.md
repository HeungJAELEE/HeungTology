...
lineage:
  ...
  original_hash: 85cc4594e4776d92d9f544dd82820faf39a74fe10cca98ecdf2a42c3119d96f0
metadata:
  date: '2026-05-16'
...
object:
  ...
  tier: 1
properties:
  amontons_law_formula: F_f = mu * F_n
  critical_speed_formula: omega_c = sqrt(k/m)
  precision_positioning_resolution: 0.01 um
  precision_spindle_speed_range: 40,000 to 100,000 RPM
  precision_tolerance_range: 0.1 to 1.0 um
  threshold_backlash_error_reject: 5.0
  threshold_lubricant_temp_notice: 50.0
  threshold_spindle_runout_critical: 2.0
  threshold_tool_vibration_warning: 0.5
semantic:
  alternative_parents: []
