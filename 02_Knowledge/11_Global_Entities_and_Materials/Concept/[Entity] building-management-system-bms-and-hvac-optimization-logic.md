...
lineage:
  ...
  original_hash: 06f60417e1bfcc37bd7464a2383a4083514c9ce4a9d44e0eae4f3d56d597003b
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] building-management-system-bms-and-hvac-optimization-logic에
    관한 고밀도 지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  bms_version: V6.3.7
  chiller_efficiency_energy_impact_ratio: 0.15
  max_co2_ppm: 1000
  max_system_latency_s: 10.0
  min_chiller_cop: 3.5
  optimized_energy_consumption_pct: 70-85
  pmv_comfort_threshold: 1.0
semantic:
  alternative_parents: []
