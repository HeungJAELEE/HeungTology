...
object:
  description: '[Entity] heat-exchanger-and-thermal-efficiency-physics에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  effectiveness_warning_threshold: '0.6'
  fouling_critical_threshold: '0.7'
  heat_exchanger_types: shell_and_tube, plate, fin
  max_heat_recovery_rate: 95%
  optimal_flow_direction: counter-current
semantic:
  alternative_parents: []
