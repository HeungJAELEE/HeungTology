...
object:
  description: '[Entity] micro-electro-mechanical-systems-mems-and-transduction-physics에
    관한 고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  frequency_shift_threshold_khz: '1.0'
  power_consumption: microwatts
  pull_in_voltage: voltage_threshold_for_instability
  resonant_freq_khz: system_resonant_frequency
  response_time: microseconds
  size: microns
  stiction_force_un: static_friction_force
semantic:
  alternative_parents: []
