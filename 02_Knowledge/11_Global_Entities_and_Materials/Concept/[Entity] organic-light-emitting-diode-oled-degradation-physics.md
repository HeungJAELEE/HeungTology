...
object:
  description: '[Entity] organic-light-emitting-diode-oled-degradation-physics에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  activation_energy_min_ev: 1.0
  burn_in_index_max: 0.1
  decay_parameters: tau_beta
  early_degradation_ratio_threshold: 0.9
  eol_luminance_ratio_threshold: 0.5
  epa_collision_probability: gamma_epa
  eqe_target_percent: 20
  luminance_t50_target_hrs: 50000
  voltage_drift_warning_v: 0.8
  voltage_shift_max_v: 0.2
semantic:
  alternative_parents: []
