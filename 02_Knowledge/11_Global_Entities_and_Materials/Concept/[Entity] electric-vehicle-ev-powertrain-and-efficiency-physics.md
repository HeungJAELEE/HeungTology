...
object:
  description: '[Entity] electric-vehicle-ev-powertrain-and-efficiency-physics에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  battery_soc_low_threshold_pct: 10.0
  ev_component_count_approx: 20
  ev_efficiency_range_pct: 85-95
  ice_component_count_approx: 2000
  ice_efficiency_range_pct: 25-35
  inverter_thermal_limit_c: 105.0
  motor_efficiency_min_pct: 85.0
semantic:
  alternative_parents: []
