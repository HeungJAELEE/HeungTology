...
lineage:
  ...
  original_hash: e4d23fe86b54c78551430b6adb01129ec63792836ccb1d9f403f743f3424be8d
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] filtration-process-and-liquid-solid-separation-physics에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  cake_blinding_pressure_threshold_bar: 6.0
  critical_turbidity_threshold_ntu: 5.0
  flow_rate_critical_ratio: 0.5
  low_pressure_threshold_bar: 0.5
  pressure_filtration_max_particle_size_um: 100.0
  pressure_filtration_min_particle_size_um: 0.1
  pressure_filtration_version: V6.3.7
semantic:
  alternative_parents: []
