...
lineage:
  ...
  original_hash: e8317255c56d921571d2b7afdc69f16503a1d446e95164f3770bd4633ec812cd
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] chemical-vapor-deposition-cvd-and-thin-film-growth-kinetics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  cvd_operating_temp_range_celsius: 300-900
  cvd_version: V6.3.7
  high_chamber_pressure_notice_threshold_torr: 10.0
  low_deposition_rate_warning_threshold_nm_s: 0.1
  mass_transfer_flux_formula: J = h_g(C_g - C_s)
  min_trench_fill_ratio_threshold: 0.95
  overall_growth_rate_formula: RR = (k_s * h_g / (k_s + h_g)) * (C_g / rho)
  thickness_uniformity_critical_threshold_pct: 5.0
semantic:
  alternative_parents: []
