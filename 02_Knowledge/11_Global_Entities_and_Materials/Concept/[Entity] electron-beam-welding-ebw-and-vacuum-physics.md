...
object:
  ...
  tier: 1
properties:
  ebw_energy_density_w_cm2_range: 10^6 - 10^8
  ebw_max_penetration_mm: 300
  ebw_target_vacuum_torr: 10^-5
  electron_kinetic_energy_formula: e * Va = 0.5 * m * v^2
  high_current_threshold_ma: 200.0
  keyhole_pressure_balance_formula: P_keyhole = (2 * gamma / r) + rho * g * h
  low_voltage_threshold_kv: 60.0
  seam_misalignment_threshold_um: 100.0
  vacuum_failure_threshold_torr: 0.001
semantic:
  alternative_parents: []
