...
object:
  description: '[Entity] autonomous-underwater-vehicles-auv-and-swarm-surveillance에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  acoustic_loss_warning_threshold: 0.3
  comm_bandwidth_range_kbps: 0.1-10
  critical_depth_error_threshold_m: 5.0
  data_log_endpoint: auv-swarm-coordination-and-depth-control-log-v2026
  endurance_range_hrs: 24-72
  max_depth_range_m: 1000-6000
  navigation_accuracy_dvl_percent: 1
  speed_of_sound_m_s: 1500
  swarm_size_range_units: 10-100
  swarm_stability_probability_target: 0.95
semantic:
  alternative_parents: []
