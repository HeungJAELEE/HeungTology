...
lineage:
  ...
  original_hash: 957a4023f1c7533012506b3c07a8c1f054d68fc9bc4987e9225bea7051d10d40
metadata:
  date: '2026-05-16'
...
object:
  ...
  tier: 1
properties:
  bod_decay_constant: k
  bod_removal_threshold: '> 95%'
  energy_consumption_threshold: < 0.5 kWh/m3
  membrane_flux_range: 15-30 LMH
  pathogen_reduction_threshold: '> 4-log'
  ro_flux_variables:
  - A
  - delta_p
  - delta_pi
  ...
  - rho_f
  - mu
  tss_concentration_threshold: < 10 mg/L
  water_recovery_threshold: '> 80%'
semantic:
  alternative_parents: []
