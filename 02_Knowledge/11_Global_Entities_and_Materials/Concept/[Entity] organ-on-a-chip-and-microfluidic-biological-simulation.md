...
object:
  description: '[Entity] organ-on-a-chip-and-microfluidic-biological-simulation에 관한
    고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  drug_response_sensitivity_threshold: 0.7
  nutrient_saturation_threshold_notice: 90.0
  shear_stress_error_threshold_warning: 15.0
  teer_threshold_critical: 500
  version: V6.3.7
semantic:
  alternative_parents: []
