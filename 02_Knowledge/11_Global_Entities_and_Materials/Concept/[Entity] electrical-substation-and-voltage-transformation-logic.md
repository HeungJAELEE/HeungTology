...
lineage:
  ...
  original_hash: 4d596f933a232156fa68291fc88b923b300c95b943a7a0e94bab7d2f6ad117ce
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] electrical-substation-and-voltage-transformation-logic에 관한
    고밀도 지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  differential_current_a_fault_threshold: 10.0
  distribution_transformer_capacity_mva: 10 - 100
  distribution_voltage_levels_kv: 22.9, 6.6
  hydrogen_ppm_critical_threshold: 100
  oil_temp_c_warning_threshold: 85.0
  transformer_efficiency_formula: eta = Pout / (Pout + Piron + Pcopper)
  transmission_transformer_capacity_mva: 100 - 1,000+
  transmission_voltage_levels_kv: 154, 345, 765
  turns_ratio_formula: Vp/Vs = Np/Ns = a
  voltage_deviation_pct_notice_threshold: 5.0
semantic:
  alternative_parents: []
