...
lineage:
  ...
  original_hash: f79f03069517ce4b18042e04fcafbd9c90eef9fc49324cfc709f92c065310299
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] high-altitude-pseudo-satellites-haps-and-stratospheric-platforms에
    관한 고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  critical_battery_soc_pct: 10
  haps_altitude_max_km: 25
  haps_altitude_min_km: 18
  haps_coverage_radius_km: 50
  max_night_descent_rate_m_s: 0.5
  min_snr_db: 15
  min_solar_yield_w: 500
  stratosphere_air_density_ratio: 0.07
semantic:
  alternative_parents: []
