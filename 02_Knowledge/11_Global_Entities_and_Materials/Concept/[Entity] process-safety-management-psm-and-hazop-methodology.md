...
object:
  description: '[Entity] process-safety-management-psm-and-hazop-methodology에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  high_risk_mitigation_threshold_pct: 95.0
  moc_compliance_threshold_rate: 1.0
  pfd_avg_formula: 1 - exp(-lambda * t)
  psm_version: V6.3.7
  risk_formula: severity * probability
  sil_reliability_range: 1-4
  sis_test_overdue_threshold_days: 30
semantic:
  alternative_parents: []
