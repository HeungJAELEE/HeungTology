...
object:
  description: '[Entity] renewable-energy-integration-and-microgrid-governance에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  critical_frequency_deviation_hz: 0.5
  ess_soc_low_threshold_pct: 10.0
  high_energy_curtailment_threshold_mwh: 5.0
  microgrid_version: V6.3.7
