...
object:
  description: '[Entity] electromagnetic-interference-emi-shielding-and-signal-integrity에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  characteristic_impedance_formula: sqrt(L/C)
  critical_shielding_breach_threshold_db: 40.0
  emi_emission_failure_threshold_dbuv: 60.0
  impedance_error_warning_threshold_pct: 10.0
  max_frequency_range_ghz: 100.0
  safe_emi_margin_db: 20.0
  shielding_effectiveness_formula: A + R + B
  signal_rise_time_notice_threshold_ps: 50.0
  target_bit_error_rate: 1.0e-12
semantic:
  alternative_parents: []
