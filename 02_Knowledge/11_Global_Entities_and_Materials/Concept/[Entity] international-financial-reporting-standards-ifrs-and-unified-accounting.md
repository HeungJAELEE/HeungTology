...
lineage:
  ...
  original_hash: 682610c57b0ded49fb54169689df400bf203f24e7da94f3254a642517218adf3
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] international-financial-reporting-standards-ifrs-and-unified-accounting에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  accounting_equation: assets = liabilities + equity
  accounting_error_threshold: 0.01
  disclosure_completeness_threshold: 1.0
  ifrs_15_model: 5_step_model
  ifrs_16_focus: on_balance_sheet_leases
  ifrs_17_focus: market_consistency
  ifrs_9_focus: expected_credit_loss
  impairment_loss_accuracy_threshold: 0.95
  revenue_recognition_adherence_threshold: 1.0
semantic:
  alternative_parents: []
