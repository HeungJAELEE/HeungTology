...
object:
  description: '[Entity] agricultural-robotics-and-autonomous-harvesting-mechanics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  detection_speed_sec: 0.5
  grip_force_formula: F_grip = mu * P_contact * A
  gripper_types:
  - Soft-actuator
  - Vacuum
  impact_energy_formula: E_impact = 0.5 * m * v^2
  max_damage_threshold_pct: 5.0
  max_nav_error_cm: 10.0
  min_success_rate_threshold_pct: 85.0
  navigation_modes:
  - SLM
  - RTK-GPS
  picking_accuracy_pct: 96.5
  ripeness_false_positive_limit: 10
  robot_work_hours_hrs: 24
  target_bruise_rate_pct: 1.5
semantic:
  alternative_parents: []
