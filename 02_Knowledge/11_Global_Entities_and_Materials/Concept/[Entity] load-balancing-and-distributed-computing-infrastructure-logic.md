...
lineage:
  ...
  original_hash: 51a468ea9f145595fef6043570dc1ac27d9f34f887d59b94a5bdb8876fdbe590
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] load-balancing-and-distributed-computing-infrastructure-logic에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  availability_target: 99.999%
  cpu_utilization_threshold: 85.0
  error_rate_threshold: 1.0
  latency_spike_threshold_multiplier: 2.0
  queuing_theory_formula: W = (rho / (1 - rho)) * (1 / mu)
  utilization_formula: rho = lambda / (n * mu)
semantic:
  alternative_parents: []
