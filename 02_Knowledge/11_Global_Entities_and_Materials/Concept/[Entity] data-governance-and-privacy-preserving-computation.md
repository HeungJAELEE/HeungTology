...
lineage:
  ...
  original_hash: 07a248c649a4c90c5f0f7387171cad62f798c5a8dcae60a4cfb4d9baa815b0ad
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] data-governance-and-privacy-preserving-computation에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  computation_overhead_multiplier: multiplier of computing resources required compared
    to plaintext
  data_sovereignty_index_range: 0 to 1 scale of data owner control
  differential_privacy_utility_loss_pct: 5-15%
  encryption_latency_ms: time required for encryption and decryption processes
  federated_learning_overhead_multiplier: 2x
  federated_learning_utility_loss_pct: 1-5%
  homomorphic_encryption_overhead_multiplier: 100x+
  k_anonymity_threshold: minimum number of non-identifiable records required for anonymity
  privacy_budget_epsilon: upper bound of information exposure (lower is higher security)
  smpc_overhead_multiplier: 10x
  tee_overhead_multiplier: 1.1x
  utility_loss_ratio: ratio of model accuracy or computation error due to privacy
    techniques
semantic:
  alternative_parents: []
