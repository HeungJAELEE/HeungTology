...
lineage:
  ...
  original_hash: 610504113bab0e93514ebe80418aa6e3cfab8abe8a8e582bb3a2db75fad5d22e
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] glass-manufacturing-and-viscous-flow-thermodynamics-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  factory_fidelity_engine_logic: diagnose_glass_health
  glass_transition_parameter: Tg
  vft_viscosity_parameters:
  - A
  - B
  - T
  - T0
  viscosity_critical_low_threshold: 10.0
  viscosity_stiffness_high_threshold: 1000.0
  viscosity_unit: Pa*s
  viscous_shear_parameters:
  - tau
  - eta
  - gamma
semantic:
