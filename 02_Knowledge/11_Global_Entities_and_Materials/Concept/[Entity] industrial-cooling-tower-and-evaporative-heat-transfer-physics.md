...
object:
  description: '[Entity] industrial-cooling-tower-and-evaporative-heat-transfer-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  approach_threshold_celsius: 7.0
  cooling_limit_metric: wet_bulb_temp
  cooling_range_threshold_ratio: 0.7
  evaporative_heat_loss_formula: Q = m_evap * Lv
  merkels_theory_parameter: KaV/L
  water_conductivity_limit_microsiemens: 2000.0
semantic:
  alternative_parents: []
