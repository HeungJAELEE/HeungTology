...
object:
  description: '[Entity] wind-turbine-aerodynamics-and-offshore-structure-mechanics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  ...
  betz_limit: 0.593
  blade_mass_5mw_kg: 25000
  design_life_years_min: 25
  floating_min_depth_m: 50
  mmpa_endpoint: mmpa.org
  monopile_max_depth_m: 30
  nrel_endpoint: nrel.gov
  optimal_tip_speed_ratio: 6 ~ 7
  peak_wave_load_resistance_kn: 12500
  standard_tip_speed_ratio: 6.5
  tower_natural_frequency_hz: 0.22 ~ 0.3
  verified_power_coefficient_range: 0.35 ~ 0.48
semantic:
  alternative_parents: []
