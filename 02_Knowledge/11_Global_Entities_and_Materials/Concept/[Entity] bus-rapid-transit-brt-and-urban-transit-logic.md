...
object:
  description: '[Entity] bus-rapid-transit-brt-and-urban-transit-logic에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  brt_peak_capacity_pax_h_range: 10000-40000
  brt_specification_version: V6.3.7
  brt_speed_kmh_range: 25-35
  dwell_time_warning_threshold_seconds: 30.0
  headway_bunching_threshold_seconds: 60.0
  infrastructure_cost_ratio_to_metro: 0.1
  signal_priority_degradation_threshold_percent: 80.0
semantic:
  alternative_parents: []
