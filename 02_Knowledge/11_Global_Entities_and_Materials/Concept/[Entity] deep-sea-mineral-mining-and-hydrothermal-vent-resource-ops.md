...
lineage:
  ...
  original_hash: b68eb9fdbc211332f671a05222a6e5d0e5cab79d2c02d7d5b24871c1a549e611
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] deep-sea-mineral-mining-and-hydrothermal-vent-resource-ops에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  audit_fidelity_id: Abyss-Gold-v2026-Fidelity
  audit_status: MAXIMUM
  mining_efficiency_min: 0.82
  ore_recovery_target_tons_hr: 50
  positioning_accuracy_max_cm: 5
  safety_margin_landslide: 0.25
  swarm_coordination_min: 0.996
  thermal_stability_max_k: 673
  thermal_stability_min_k: 273
semantic:
  alternative_parents: []
