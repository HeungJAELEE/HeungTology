...
lineage:
  ...
  original_hash: b385c1086c45095ca3ed5ddd636026a3ef94df4b8b36bf0421a6ec03b2938bd3
metadata:
  date: '2026-05-16'
...
object:
  ...
  tier: 1
properties:
  casting_yield_threshold: '> 90 %'
  chvorinov_rule_formula: t = B * (V/A)^2
  cooling_rate_range: 1 ~ 1,000 K/s
  data_endpoint: casting-yield-and-defect-rate-log-v2026
  grain_size_range: 10 ~ 500 μm
  porosity_limit_threshold: < 0.5 %
  pouring_temp_target: T_L + (50 ~ 150) °C
  pouring_temp_tolerance: ±10 °C
  superheat_warning_threshold: 30
semantic:
  alternative_parents: []
