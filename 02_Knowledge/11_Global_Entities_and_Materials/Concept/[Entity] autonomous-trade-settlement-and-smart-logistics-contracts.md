...
object:
  description: '[Entity] autonomous-trade-settlement-and-smart-logistics-contracts에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  auditability_trace_history_percent: 100
  document_error_rate_threshold_max: 0.01
  oracle_reliability_threshold_min: 99.99
  quality_score_penalty_threshold: 0.95
  settlement_speed_threshold_min: 10
  sync_log_endpoint: Data trade-settlement-speed-and-error-reduction-log-v2026
  target_error_margin_percent: 0.001
  transaction_cost_threshold_max: 0.1
semantic:
  alternative_parents: []
