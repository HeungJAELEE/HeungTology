...
object:
  description: '[Entity] anomaly-detection-autoencoder-and-isolation-forest에 관한 고밀도
    지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  anomaly_rate_warning_threshold: 0.1
  data_log_endpoint: Data anomaly-detection-precision-and-recall-log-v2026
  f1_score_tier_1_threshold: 0.95
  max_processing_latency_ms: 10
  min_isolation_spread_threshold: 0.1
  target_detection_accuracy: 0.99
semantic:
  alternative_parents: []
