...
object:
  description: '[Entity] electric-vehicle-powertrain-and-motor-control에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  max_operating_rpm_target: 20000
  max_operating_rpm_tolerance: 10
  power_density_target_kw_kg: 6.0
  power_density_tolerance_kw_kg: 0.1
  switching_frequency_max_khz: 100
  switching_frequency_min_khz: 20
  switching_frequency_tolerance_khz: 1
  system_efficiency_target_pct: 92.0
  system_efficiency_tolerance_pct: 0.5
  torque_response_limit_ms: 1.0
  torque_response_tolerance_ms: 0.1
semantic:
  alternative_parents: []
