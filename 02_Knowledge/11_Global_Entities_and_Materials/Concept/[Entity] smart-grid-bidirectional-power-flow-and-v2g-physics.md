...
object:
  description: '[Entity] smart-grid-bidirectional-power-flow-and-v2g-physics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  grid_sync_latency_max: 20ms
  inverter_thd_max: 3%
  peak_shaving_min: 15%
  power_efficiency_min: 92%
  response_time_max: 2sec
  voltage_drop_defense_threshold: 5%
  vpp_capacity_mw: 50MW
  vpp_control_interval: 10ms
  vpp_ev_count: '1000'
semantic:
  alternative_parents: []
