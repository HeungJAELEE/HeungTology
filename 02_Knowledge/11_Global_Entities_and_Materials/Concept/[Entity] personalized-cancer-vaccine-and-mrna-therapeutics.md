...
lineage:
  ...
  original_hash: aca7363957bd982176e0f5180141f00fabd5adbed376464685a8afccd17663e7
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] personalized-cancer-vaccine-and-mrna-therapeutics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  development_time_weeks: 4-6
  fidelity_rate_min: 0.999
  lnp_encapsulation_efficiency_threshold: 0.9
  mutation_load_score_threshold: 10
  neoantigen_specificity_threshold: 99.0
  system_version: V6.3.7
  t_cell_activation_rate_threshold: 0.1
semantic:
  alternative_parents: []
