...
object:
  description: '[Entity] climate-engineering-and-planetary-thermostat-mechanics에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  albedo_excessive_cooling_threshold_percent: 3.0
  carbon_cost_limit_usd_per_ton: 100
  cdr_removal_gt_co2_yr: 5-10
  external_db_endpoint: geoengineering-impact-on-albedo-and-global-temp-v2026
  implementation_latency_years_limit: 10
  radiative_forcing_target_w_m2: -1.0 to -4.0
  side_effect_index_critical_threshold: 0.6
  srm_albedo_increase_percent: 1-2
semantic:
  alternative_parents: []
