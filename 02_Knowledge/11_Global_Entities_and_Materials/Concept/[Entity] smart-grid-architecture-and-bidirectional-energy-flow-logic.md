...
object:
  description: '[Entity] smart-grid-architecture-and-bidirectional-energy-flow-logic에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  audit_status: Grid-Connect-v2026-Fidelity
  comm_uptime: '> 99.9%'
  energy_loss_reduction: '> 10%'
  frequency_stability: < +/- 0.1 Hz
