...
object:
  description: '[Entity] occupational-health-and-ergonomics-governance에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  anthropometric_range: 5th-95th percentile
  cumulative_trauma_formula: integral(Force(t) * Repetition(t) dt)
  erg_training_coverage_threshold: 0.95
  governance_version: 6.3.7
  high_risk_task_threshold: 0.2
  msd_incident_rate_threshold: 0.05
  rwl_formula: LC * HM * VM * DM * AM * FM * CM
semantic:
  alternative_parents: []
