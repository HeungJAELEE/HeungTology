...
object:
  description: '[Entity] underground-utility-tunnels-and-robotic-maintenance에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  audit_os_version: Underground-OS-v2026-Fidelity
  audit_status: ACTIVE
  inspection_coverage: 100%
  leak_sensitivity: ppm level
  maintenance_latency: < 1 hr
