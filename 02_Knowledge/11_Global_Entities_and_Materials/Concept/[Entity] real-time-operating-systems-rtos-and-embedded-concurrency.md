...
object:
  description: '[Entity] real-time-operating-systems-rtos-and-embedded-concurrency에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  deadline_violation_threshold: 0
  heap_fragmentation_warning_pct: 30.0
  latency_formula: T_interrupt + T_switch + T_dispatch
  latency_warning_threshold_us: 100.0
  rms_utilization_bound: n(2^(1/n)-1)
  rtos_version: V6.3.7
semantic:
  alternative_parents: []
