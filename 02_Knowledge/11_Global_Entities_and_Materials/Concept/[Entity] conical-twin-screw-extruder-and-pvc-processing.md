...
object:
  description: '[Entity] conical-twin-screw-extruder-and-pvc-processing에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  melt_pressure_critical_threshold_bar: 450.0
  screw_torque_warning_threshold_pct: 90.0
  surface_gloss_minimum_index: 70
  vacuum_degassing_limit_mbar: -200
semantic:
  alternative_parents: []
