...
lineage:
  ...
  original_hash: fde88189715f8d3daff3af443ec043254c4495f48133ac6bc2964ff62364efaa
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] ar-vr-near-eye-display-optics-and-waveguide-design에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  data_log_endpoint: waveguide-display-efficiency-and-fov-log-v2026
  eye_box_size_mm: 15x15
  fov_range_deg: 50-90
  grating_pitch_nm: 300-500
  min_optical_efficiency_pct: '>10'
  refractive_index_range: 1.7-2.0
semantic:
  alternative_parents: []
