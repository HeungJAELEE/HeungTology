...
object:
  description: '[Entity] iso-iec-42001-artificial-intelligence-management-system-aims에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  ai_trust_formula: alpha * D + beta * R + gamma * O
  bias_index_formula: '|P(Success|Group A) - P(Success|Group B)|'
  bias_threshold: 0.05
  max_safety_incidents: 0
  xai_min_threshold: 0.7
semantic:
  alternative_parents: []
