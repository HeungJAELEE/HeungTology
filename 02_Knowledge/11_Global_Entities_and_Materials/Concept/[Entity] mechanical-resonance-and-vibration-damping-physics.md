...
object:
  description: '[Entity] mechanical-resonance-and-vibration-damping-physics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  damped_vibration_equation: m*x'' + c*x' + k*x = F(t)
  min_damping_ratio_zeta: 0.05
  natural_frequency_formula: omega_n = sqrt(k/m)
  resonance_threshold_hz: 2.0
semantic:
  alternative_parents: []
