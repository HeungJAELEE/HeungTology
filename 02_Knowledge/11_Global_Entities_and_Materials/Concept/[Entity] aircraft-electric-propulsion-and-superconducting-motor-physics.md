...
lineage:
  ...
  original_hash: f7ae8da0f15d3cd63e519da3c48e2b7ed4ca4629e3d6682108addd88d3fc1fa3
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] aircraft-electric-propulsion-and-superconducting-motor-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  high_magnetic_flux_threshold_t: 5.0
  insufficient_thrust_power_density_threshold_kw_kg: 15.0
  lorentz_force_formula: F = B I L sin θ
  operating_temperature_k: 77
  propulsive_efficiency_formula: η_prop = 2 / (1 + v_j/v_0)
  quench_risk_temperature_threshold_k: 80.0
  superconducting_motor_efficiency_range_percent: 90-95
  superconducting_motor_power_density_range_kw_kg: 20-30
semantic:
  alternative_parents: []
