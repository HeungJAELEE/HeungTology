...
lineage:
  ...
  original_hash: 5e3e11f83e7c3a9b49dc531a5b0dee94f6bab1e153edf4aa4255373d9e375b94
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] material-handling-and-automated-storage-retrieval-system-asrs-logic에
    관한 고밀도 지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  asrs_accuracy_pct: 99.99
  asrs_max_height_m: 40
  asrs_max_speed_m_per_min: 200
  cycle_time_formula: 2 * max(X, Y, Z) / V_avg
  retrieval_time_warning_multiplier: 1.5
  storage_saturation_threshold_pct: 95.0
  throughput_formula: N_units / T_total
semantic:
  alternative_parents: []
