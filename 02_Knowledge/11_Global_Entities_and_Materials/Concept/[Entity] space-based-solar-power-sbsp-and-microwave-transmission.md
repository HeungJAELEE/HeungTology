...
object:
  description: '[Entity] space-based-solar-power-sbsp-and-microwave-transmission에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  audit_status_fidelity: Solar-Orbital-v2026-Fidelity
  beam_pointing_precision_max: 10 urad
  harvest_efficiency_min: 45%
  interference_suppression_min: 80 dB
  rectenna_conversion_efficiency_min: 92%
  sbsp_array_size_min: 1.5 km
  system_uptime_target: 99.99%
  transmission_loss_max: 2.0%
semantic:
  alternative_parents: []
