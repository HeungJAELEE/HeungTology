...
lineage:
  ...
  original_hash: b4c2e83f1e7c51a84b3d6a257518eed491e0f7cfdc7834ab38066cd8d8fdc1f3
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] crispr-cas9-gene-editing-and-molecular-scissors-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  binding_affinity_dg_range: -15 to -20 kcal/mol
  cleavage_latency_ms_threshold: < 100.0
  dna_bending_angle_deg: 30 to 60
  melting_temp_threshold_c: '> 55'
  misbinding_probability_threshold: < 10^-6
  r_gas_constant: 0.001987
  specification_standard: HDS-Gold V6.3.7
  standard_temperature_k: 310.15
  target_dg_default: -18.0
  unwinding_torque_threshold_pn_nm: '> 10.0'
semantic:
  alternative_parents: []
