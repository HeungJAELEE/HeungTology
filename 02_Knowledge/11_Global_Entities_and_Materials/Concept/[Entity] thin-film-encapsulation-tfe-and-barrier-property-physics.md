...
lineage:
  ...
  original_hash: 1502e3da07e6d9a8e87cb3005bca2bc26d1564d8e1d2b43fb2b3a4a20e787d61
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] thin-film-encapsulation-tfe-and-barrier-property-physics에
    관한 고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  max_layer_thickness: < 10 um
  min_adhesion_strength: '> 5 J/m^2'
  min_flexibility_cycles: '> 200,000'
  min_thermal_stability: '> 100 C'
  min_transparency: '> 90%'
  otr_threshold: < 10^-4 cc/m^2/day
  pinhole_density_tolerance: zero
  wvtr_threshold: < 10^-6 g/m^2/day
semantic:
  alternative_parents: []
