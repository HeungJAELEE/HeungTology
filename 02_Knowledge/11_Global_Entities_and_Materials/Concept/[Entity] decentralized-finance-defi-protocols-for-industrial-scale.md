...
lineage:
  ...
  original_hash: a8b5815a402f1c9376853c478b795eab7b712526eaf57a5eb60262eb63dc5dbd
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] decentralized-finance-defi-protocols-for-industrial-scale에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  amm_invariant_constant: x * y = k
  high_liquidation_risk_ltv_threshold_pct: 85.0
  impermanent_loss_formula: 2*sqrt(r)/(1+r) - 1
  industrial_gas_cost_max_usd: 0.01
  industrial_ltv_range_pct: 30-50
  industrial_oracle_latency_max_sec: 1
  industrial_slippage_max_pct: 0.1
  industrial_tvl_min_usd: 10000000000
  liquidity_crisis_tvl_outflow_threshold_pct: -30.0
  oracle_manipulation_risk_threshold_pct: 5.0
semantic:
  alternative_parents: []
