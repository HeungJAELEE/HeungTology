...
lineage:
  ...
  original_hash: 49bb956a52b2c649bb6590c78bd7c66f496c275dd56637a750db7188f0d3539f
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] electron-beam-melting-ebm-and-additive-manufacturing-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  cp: specific_heat_capacity
  eta: efficiency_parameter
  high_power_current_threshold_ma: 50.0
  k: thermal_conductivity
  lack_of_fusion_focus_threshold: 5.0
  p: beam_power
  process_temp_max_c: 1000
  process_temp_min_c: 600
  rb: beam_focus_radius
  rho: material_density
  smoking_phenomenon_temp_threshold_c: 600.0
  vacuum_pressure_mbar: 0.0001
semantic:
  alternative_parents: []
