...
object:
  ...
  tier: 1
properties:
  contact_mechanics_formula: F = k * x
  haptic_latency_warning_threshold_ms: 20
  high_end_force_range_n: 0.01-50.0
  high_end_frequency_range_hz: 1-1000
  high_end_latency_threshold_ms: <10
  sensor_drift_rejection_threshold_n: 0.1
  smartphone_force_range_n: 0.1-2.0
  smartphone_frequency_range_hz: 50-300
  smartphone_latency_ms: 50-100
  tactile_resolution_critical_threshold_mm: 2.0
  vibration_purity_notice_threshold: 0.8
  vibrotactile_acceleration_formula: a = ω^2 * A * sin(ωt)
semantic:
  alternative_parents: []
