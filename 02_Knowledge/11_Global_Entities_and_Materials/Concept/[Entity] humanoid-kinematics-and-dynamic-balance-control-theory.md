...
lineage:
  ...
  original_hash: 87abc4f7938bacfc5446aedd9721f790c27ecd76076bb6c0a43e5db5821ee470
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] humanoid-kinematics-and-dynamic-balance-control-theory에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  advanced_battery_life_hours: 4
  advanced_control_freq_hz: 1000
  advanced_dof_range: 40-60+
  advanced_max_velocity_kmh: 5.0
  advanced_payload_kg: 20
  com_height_variance_threshold: 50.0
  peak_grf_threshold_n: 2000.0
  torque_saturation_threshold_pct: 90.0
  zmp_formula: x_zmp = x_com - (z_com / g) * x_com_double_dot
semantic:
  alternative_parents: []
