...
object:
  description: '[Entity] massive-mimo-and-beamforming-mathematics-in-wireless-networks에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  antenna_count_5g_max: 256
  antenna_count_5g_min: 64
  beam_pointing_error_threshold_deg: 5.0
  csi_feedback_latency_threshold_ms: 10.0
  latency_5g_max_ms: 1.0
  min_spectral_efficiency_bps_hz: 30.0
  multi_user_interference_threshold_db: -10.0
  spectral_efficiency_5g_max: 100
  spectral_efficiency_5g_min: 50
semantic:
  alternative_parents: []
