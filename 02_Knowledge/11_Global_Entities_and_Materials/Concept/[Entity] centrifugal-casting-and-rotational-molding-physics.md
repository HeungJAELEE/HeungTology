...
lineage:
  ...
  original_hash: b97bb77705a19143b24fb548ac7a761296b4d70c79dca88f873442292041dec2
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] centrifugal-casting-and-rotational-molding-physics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  centrifugal_casting_yield_pct: 92.5
  centrifugal_force_formula: Fc = m * r * omega^2
  cooling_rate_limit_c_min: 100.0
  g_factor_critical_threshold: 60.0
  g_factor_formula: G = (r * omega^2) / g
  g_factor_operational_range: 60-120
  minimum_sintering_temp_c: 200.0
  mold_vibration_limit_mm: 0.5
  sand_casting_yield_pct: 60.0
semantic:
  alternative_parents: []
