...
lineage:
  ...
  original_hash: 83f443cacb19766f430f7e3b6cbe3e888f0f1e6b63bca765478c12ea49a24c13
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] ethical-robotics-and-autonomous-decision-making-frameworks에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  decision_latency_max_ms: 50
  explainability_target_percent: 95
  explainability_warning_threshold: 85.0
  fail_safe_mode_percent: 100
  human_override_notice_threshold: 10.0
  safety_weight_min: 0.99
  social_norm_compliance_min: 0.99
semantic:
  alternative_parents: []
