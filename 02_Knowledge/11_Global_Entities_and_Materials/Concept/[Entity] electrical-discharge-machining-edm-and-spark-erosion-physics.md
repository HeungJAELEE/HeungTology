...
object:
  description: '[Entity] electrical-discharge-machining-edm-and-spark-erosion-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  edm_precision_tolerance_um_max: 5
  edm_precision_tolerance_um_min: 1
  excessive_pulse_on_time_threshold_us: 500.0
  milling_precision_tolerance_um: 10
  open_circuit_voltage_threshold_v: 80.0
  poor_dielectric_resistivity_threshold: 5.0
  short_circuit_voltage_threshold_v: 15.0
semantic:
  alternative_parents: []
