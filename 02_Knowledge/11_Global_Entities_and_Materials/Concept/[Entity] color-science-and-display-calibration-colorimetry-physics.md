...
lineage:
  ...
  original_hash: 87e04c2e5fb3e69d4b1cd21aa44354e5ce19a5c0379c4c17a4ba7960d04820dc
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] color-science-and-display-calibration-colorimetry-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  delta_e_critical_threshold: 3.0
  delta_e_target_max: 1.0
  external_db_endpoint: display-color-accuracy-and-delta-e-metrics-v2026
  gamma_target_curves:
  - '2.2'
  - '2.4'
  - BT.1886
  gamut_coverage_reject_threshold: 85.0
  max_color_distortion_probability: 0.001
  peak_luminance_max_cd_m2: 4000
  peak_luminance_min_cd_m2: 1000
  rec2020_gamut_min_pct: 90
  white_point_d65_x: 0.3127
  white_point_d65_y: 0.329
  white_point_drift_threshold: 0.005
semantic:
  alternative_parents: []
