...
lineage:
  ...
  original_hash: f63bf47e03250262e4d01aec333cbfc887cfcdca0182e580b1a5c45a4c79d75a
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] food-processing-and-thermal-pasteurization-kinetics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  d_value_formula: log(N/N0) = -t/D
  f_value_formula: F = integral(10^((T-Tref)/Z) dt)
  htst_pathogen_kill_log: 6
  htst_temperature_range_c: 72-75
  htst_time_range_sec: 15-20
  ltlt_pathogen_kill_log: 5
  ltlt_temperature_range_c: 63-65
  ltlt_time_min: 30
  overprocessing_temp_threshold_max_c: 78.0
  safety_temp_threshold_min_c: 71.7
  safety_time_threshold_min_sec: 15.0
semantic:
  alternative_parents: []
