...
lineage:
  ...
  original_hash: 54fd17c28cecacca94902495bbf8159e88369278cdfff68f896a12aea99a90ab
metadata:
  date: '2026-05-16'
...
object:
  description: '[Entity] industrial-robot-actuator-design-and-precision-gearing에 관한
    고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  critical_backlash_threshold_arcmin: 1.5
  critical_motor_temp_threshold_c: 95.0
  cycloidal_rv_backlash_limit: < 1 Arc-min
  cycloidal_rv_reduction_ratio: 30:1 ~ 300:1
  harmonic_drive_backlash_limit: < 1 Arc-min
  harmonic_drive_reduction_ratio: 50:1 ~ 160:1
  minimum_lifespan_hours: 20000
  planetary_backlash_range: 3 ~ 10 Arc-min
  planetary_reduction_ratio: 3:1 ~ 100:1
  torque_ripple_threshold_pct: 5.0
  transmission_efficiency_range: 70 ~ 90%
  vibration_rms_threshold_g: 2.5
semantic:
  alternative_parents: []
