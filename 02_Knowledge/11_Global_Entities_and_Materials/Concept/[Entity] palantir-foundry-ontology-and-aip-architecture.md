...
object:
  description: '[Entity] palantir-foundry-ontology-and-aip-architecture에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  action_safety_score: 1.0
  aip_grounding_model: gamma_aip = reasoning(ontology_context) * governed_action
  framework_architecture: ola
  object_match_min: 0.98
  operational_intelligence_model: psi_operational = f(o, l, a)
  version: v6.3.7
semantic:
  alternative_parents: []
