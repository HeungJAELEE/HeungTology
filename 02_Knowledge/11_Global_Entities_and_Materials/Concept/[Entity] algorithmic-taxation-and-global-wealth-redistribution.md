...
object:
  description: '[Entity] algorithmic-taxation-and-global-wealth-redistribution에 관한
    고밀도 지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  audit_trail_transparency_target: 100.0
  compliance_threshold_param: 0.95
  economic_buffer_threshold: 15.0
  evasion_recall_threshold: 98.0
  fiscal_pivot_latency_max: 1.0
  gini_improvement_threshold: 0.25
  redistribution_index_threshold: 0.99
  target_gini_param: 0.3
  tax_fidelity_target: 100.0
  wellbeing_multiplier_effect: 1.2
semantic:
  alternative_parents: []
