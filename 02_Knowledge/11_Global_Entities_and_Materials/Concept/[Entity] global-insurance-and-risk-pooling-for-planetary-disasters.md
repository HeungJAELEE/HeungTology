...
object:
  description: '[Entity] global-insurance-and-risk-pooling-for-planetary-disasters에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  black_swan_probability: 0.0001
  cat_bond_return_period_years: 250
  climate_fund_return_period_years: 100
  critical_solvency_ratio_percent: 150
  cyber_pool_return_period_years: 50
  high_correlation_threshold: 0.7
  max_settlement_hours: 24
  min_sensor_fidelity_score: 0.95
  min_solvency_ratio_percent: 200
  pandemic_r0_threshold: 2
semantic:
  alternative_parents: []
