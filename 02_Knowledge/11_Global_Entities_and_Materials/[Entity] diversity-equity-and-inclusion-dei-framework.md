---
Basic:
  id: "diversity-equity-and-inclusion-dei-framework"
...
Object:
  object_type: "Entity"
  tier: 1
  description: "The strategic organizational framework designed to promote the fair treatment and full participation of all people (DEI), especially groups that have been historically underrepresented or subject to discrimination."
  physical_model: "N/A"
Semantic:
  tags: '["dei", "corporate-culture", "inclusion", "equity", "social-governance", "esg"]'
  is_part_of: []
  related_to: []
Dynamic:
  ...
  diagnostic_protocol:
    - 'Representation_Audit: Analyze the demographic distribution across all organizational levels (Entry to Executive).'
    - 'Pay_Equity_Check: Evaluate compensation structures to identify and mitigate unexplained wage gaps based on gender or ethnicity.'
    - 'Inclusion_Safety_Scan: Monitor employee engagement and psychological safety metrics to assess the ''lived experience'' of inclusion.'
Trust Metrics:
  T_static: 1.0
  T_dynamic: 1.0
  T_init: 1.0
