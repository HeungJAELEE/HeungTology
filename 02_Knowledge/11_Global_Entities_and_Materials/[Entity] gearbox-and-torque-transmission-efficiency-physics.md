---
Basic:
  id: "gearbox-and-torque-transmission-efficiency-physics"
...
Object:
  object_type: "Entity"
  tier: 1
  description: "A mechanical device utilized to provide speed and torque conversions from a rotating power source to another device using gear ratios (Gearbox) and the physical study of friction, churning losses, and mechanical power transfer (Torque Transmission Efficiency Physics)."
  physical_model: "N/A"
Semantic:
  tags: '["gearbox", "torque-transmission", "mechanical-efficiency", "lubrication", "thermal-loss", "industrial-drive", "physics", "mechanical-engineering"]'
  is_part_of: []
  related_to: []
Dynamic:
  ...
  diagnostic_protocol:
    - 'Efficiency_Fidelity_Audit: Evaluate the ''Power Loss'' ($\\Delta P$) to identify if high-fidelity ''Churning'' (oil resistance) is consuming excessive energy at high speeds.'
    - 'Thermal_Integrity_Check: Analyze the high-fidelity ''Oil Temperature'' rise to ensure that the heat dissipation rate matches the mechanical loss, preventing lubricant film breakdown.'
    - 'Vibration_Fidelity_Scan: Monitor the high-fidelity ''G-load'' on the casing to verify that gear mesh misalignment or bearing wear is not reducing the high-fidelity transmission efficiency.'
Trust Metrics:
  T_static: 1.0
  T_dynamic: 1.0
  T_init: 1.0
