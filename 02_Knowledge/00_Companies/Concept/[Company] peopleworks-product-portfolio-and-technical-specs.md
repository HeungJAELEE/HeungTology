...
object:
  description: '[Company] peopleworks-product-portfolio-and-technical-specs에 관한 고밀도
    지능 노드'
  object_type: Organization
  tier: 1
properties:
  bms_accuracy_limit_mv: '1.0'
  bms_isolation_voltage_kv: '2.5'
  bms_voltage_accuracy_verified_mv: '0.9'
  ecu_operating_temp_max_c: '125'
  ecu_operating_temp_min_c: '-40'
  smt_component_size_limit_mm: 0.4x0.2
  smt_placement_tolerance_verified_um: '12'
  wireless_charging_efficiency_target_pct: '85'
  wireless_charging_efficiency_verified_pct: '86.5'
semantic:
  alternative_parents: []
