---
Basic:
  id: "MOB-SDV-2026-V6.3.7"
  domain: "Global_Mobility_and_SDV_Architecture_Intelligence"
...
Object:
  ...
  physical_model: "N/A"
Semantic:
  tags: '["#SDV", "#Zonal_Architecture", "#SOA", "#Vehicle_OS", "#Hypervisor", "#OTA", "#FidelityEngine", "#Sovereignty"]'
...
Trust Metrics:
  ...
  T_dynamic: 1.0
  T_init: 1.0
  source: "Mobility_SDV_RAG_V6.3.7_Tiered"
  isolation_index: 0.0
---

# [Mobility] Mobility SDV Software-Defined Vehicle Architecture: The Digital Soul
...
| **Virtualization** | Hypervisor Latency| $< 10 \text{ \mu s}$ | 안전(Safety)과 편의(General) OS 간의 격리 무결성 |
