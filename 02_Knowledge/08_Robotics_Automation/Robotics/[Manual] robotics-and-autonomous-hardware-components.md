---
Basic:
  id: "MOB-ROB-HW-2026-V6.3.7"
  domain: "Mobility_Robotics_Hardware"
...
Object:
  ...
  physical_model: "N/A"
Semantic:
  tags: '["#Robotics", "#Mobility", "#ADCU", "#HarmonicDrive", "#Servo", "#Hardware", "#InWheelMotor", "#FidelityEngine"]'
  is_part_of: '["MOC 08_Mobility_Robotics", "SDV", "6-Axis-Robot"]'
  related_to: []
Dynamic:
...
Trust Metrics:
  ...
  T_dynamic: 1.0
  T_init: 1.0
  source: "Mobility_Hardware_RAG_V6.3.7_Deterministic_Linkage"
  isolation_index: 0.0
---

# [Manual] robotics-and-autonomous-hardware-components
