---
Basic:
  id: "ROBOT-KINEMAT-2026-V6.3.7"
  domain: "Robotics_Motion_Intelligence"
...
Object:
  ...
  physical_model: "N/A"
Semantic:
  tags: '["#Kinematics", "#InverseKinematics", "#Jacobian", "#PrecisionTiering", "#FidelityEngine", "#SingularityAvoidance", "#Robotics"]'
  is_part_of: []
  related_to: []
Dynamic:
...
Trust Metrics:
  ...
  T_dynamic: 1.0
  T_init: 1.0
  source: "Robotics_Dynamics_RAG_V6.3.7_Tiered"
  isolation_index: 0.0
---

# [Robot] Forward & Inverse Kinematics: Geometric Mastery of Motion
