...
lineage:
  ...
  original_hash: a3c4d1d131b4d49ca77cd2078aa8f597b03ee1deb90daf9e9216119713fc28fd
metadata:
  date: '2026-05-16'
...
object:
  description: '[Robotics] agri-robot-harvesting-yield-and-vision-accuracy-log-v2026에
    관한 고밀도 지능 노드'
  object_type: Data
  tier: 1
properties:
  bruise_rate_threshold: 0.005
  gripper_pressure_range_n: 2.0-5.0
  harvest_success_rate_target: 0.985
  min_success_rate_threshold: 0.98
  path_deviation_limit_cm: 3.0
  processing_delay_limit_ms: 150
  ripeness_fidelity_target: 0.972
  throughput_target_units_hour: 850
  vision_map_iou_05_threshold: 0.96
  yield_prediction_model: Y = integral(eta * Ps * dt)
semantic:
  alternative_parents: []
