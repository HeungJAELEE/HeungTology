---
Basic:
  id: "DATA-ROBO-SURGERY-PRECISION-LOG-2026-V6"
...
# [[[Data] surgical-robot-precision-and-haptic-fidelity-audit-log-v2026
...
|:---|:---|:---:|:---|
| **Targeting Err.**| TRE ($\mu m$) | $< 80$ | 목표 등록 오차 (혈관 문합 등 미세 수술 무결성 지표) |
...
3. **Target Registration Error** (TRE)를 $50\mu m$ 이하로 유지하기 위해 필요한 **Optical Tracking System**의 **Sampling Rate**와 **Inverse Kinematics** 계산량 간의 수리적 트레이드오프는?
