...
| **Thickness** | Tissue ($\mu\text{m}$) | $100 \sim 300$ | 영양분 확산을 고려한 최적 조직 두께 (Necrosis 방지) |
...
2. 조직 두께가 **Diffusion Limit** (확산 한계)인 $200\mu\text{m}$를 초과했을 때, 내부 중심부 세포의 **Metabolic Waste** 축적이 **Force Decay**에 미치는 수리적 영향은?
