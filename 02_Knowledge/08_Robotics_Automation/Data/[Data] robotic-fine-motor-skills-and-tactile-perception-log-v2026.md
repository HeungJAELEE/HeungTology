---
Basic:
  id: "robotic-fine-motor-skills-and-tactile-perception-log-v2026-data"
...
Object:
  ...
  physical_model: "N/A"
Semantic:
  tags: '["#DataLog", "#Robotics", "#Dexterity", "#Tactile_Sensing", "#Fine_Motor_Skills", "#Grip_Control", "#Manipulation", "#HDS_Gold_v6_1", "#Cybernetics"]'
  is_part_of: '["MOC 26_autonomous-systems-and-robotics-hub", "MOC 54_robotics-and-autonomous-system-intelligence-hub", "SOP robotic-dexterity-training-and-tactile-mapping-manual"]'
  related_to: []
Dynamic:
...
# [[[Data] robotic-fine-motor-skills-and-tactile-perception-log-v2026
...
| :--- | :---: | :---: | :---: | :--- |
| **Manip. Error** | $12.5 \text{ \mu m}$ | **ULTIMATE** | $< 20.0 \text{ \mu m}$ | 손가락 끝 위치 제어의 반복 정밀 무결성 |
...
| **Joint Backlash**| $4.2 \text{ \mu m}$ | **SOLID** | $< 5.0 \text{ \mu m}$ | 관절 기어의 유격으로 인한 기계적 불확실성 |
