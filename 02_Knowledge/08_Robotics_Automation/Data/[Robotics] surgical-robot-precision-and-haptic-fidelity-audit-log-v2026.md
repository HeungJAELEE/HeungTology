...
object:
  description: '[Robotics] surgical-robot-precision-and-haptic-fidelity-audit-log-v2026에
    관한 고밀도 지능 노드'
  object_type: Data
  tier: 1
properties:
  control_latency_threshold: 4.0ms
  critical_latency_phase_margin: 10ms
  force_resolution_threshold: 10mN
  friction_to_resistance_ratio_limit: '0.05'
  impedance_threshold: '0.98'
  joint_friction_threshold: 0.1N
  rms_tracking_error_threshold: 0.05mm
  safety_stop_threshold: 1.0ms
  spec_version: HDS-Gold V6.3.7
  tre_threshold: 80um
  tremor_suppression_threshold: 99.9%
semantic:
  alternative_parents: []
