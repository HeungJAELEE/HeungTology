...
lineage:
  ...
  original_hash: 46b12ea31dae433ad7cdc994514c8f90cd6edae0955c970f97ff23d6926f5c6c
metadata:
  date: '2026-05-16'
...
object:
  description: '[Robotics] autonomous-mobile-robot-amr-navigation-and-obstacle-avoidance에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  auto_recovery_rate_pct: '> 99.0'
  battery_autonomy_hrs: '> 8'
  dwa_objective_function: G(v, w) = sigma(alpha * heading(v, w) + beta * dist(v, w)
    + gamma * vel(v, w))
  load_capacity_kg: 100 ~ 1,500
  max_linear_velocity_m_s: 1.0 ~ 2.0
  nav_fidelity_engine_spec: HDS-Gold V6.3.7
  safety_zone_radius_m: 0.5 ~ 2.0
  stopping_accuracy_cm: < 1.0
semantic:
  alternative_parents: []
