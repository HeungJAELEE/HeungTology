...
lineage:
  ...
  original_hash: 8db126ed93161be3bd14ce5aba4ac0476efc0a43a3d51154fb96d0175934057b
metadata:
  date: '2026-05-16'
...
object:
  description: '[Robotics] logistics-automated-warehouse-and-picking-robots에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  amr_acceleration_limit_ms2: 1.5
  amr_latency_ms: 10.0
  amr_max_speed_ms: 2.0 - 4.0
  energy_reduction_per_bin_move_percent: 60.0
  grip_precision_mm: 0.5
  picking_cycle_time_seconds: 15 - 45
  picking_latency_ms: 2.0
  picking_success_rate_structured: 0.999
  picking_success_rate_unstructured: 0.94
  placement_accuracy_mm: 1.0
  sim_to_real_transfer_gap_percent: 5.0
  storage_density_multiplier: 4.0x - 6.0x
  visual_perception_latency_s: 0.1
semantic:
  alternative_parents: []
