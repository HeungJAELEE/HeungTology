...
object:
  description: '[Robotics] exoskeleton-robotics-and-human-machine-synergy에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  antagonist_muscle_activity_increase_limit: 15%
  assistance_ratio_target: 30-80%
  battery_life_minimum: '> 8h'
  data_source_torque_metabolic_log: exoskeleton-assistive-torque-and-metabolic-log-v2026
  emg_snr_degradation_limit: 10dB
  gait_sync_error_threshold: < 3deg
  intention_latency_threshold: < 50ms
  joint_torque_threshold: '> 60Nm'
  metabolic_efficiency_improvement_target: 5%
  metabolic_optimization_timing_adjustment: 20ms
  metabolic_reduction_threshold: '> 20%'
  system_weight_limit: < 5kg
  transparency_impedance_threshold: < 0.5Nm/rad
semantic:
  alternative_parents: []
