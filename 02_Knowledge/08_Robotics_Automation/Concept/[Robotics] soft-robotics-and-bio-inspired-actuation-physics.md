...
object:
  description: '[Robotics] soft-robotics-and-bio-inspired-actuation-physics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  actuation_stress: '> 2.0 MPa'
  actuator_data_log_endpoint: robotics-soft-actuator-strain-and-force-log-v2026
  bending_radius: < 2 mm
  end_effector_precision_target: 0.5 mm
  energy_density: '> 100 kJ/m^3'
  healing_efficiency: '> 95%'
  hysteresis_loss: < 5%
  max_strain: '> 600%'
  response_time: < 30 ms
  sensing_resolution: < 10 Pa
semantic:
  alternative_parents: []
