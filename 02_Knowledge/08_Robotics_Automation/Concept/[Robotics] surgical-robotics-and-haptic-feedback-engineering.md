...
lineage:
  ...
  original_hash: a70470d9d1ed59f9fac1c8907b79c63474f6affda7a892f871d90b666b3a3424
metadata:
  date: '2026-05-16'
...
object:
  description: '[Robotics] surgical-robotics-and-haptic-feedback-engineering에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  backlash_error_um: 200
  control_latency_max_ms: 10
  end_effector_precision_max_um: 100
  force_resolution_max_n: 0.01
  haptic_force_resolution_n: 0.1
  haptic_transparency_min_pct: 90
  motion_precision_data_endpoint: surgical-robot-motion-precision-v2026
  motion_scaling_ratio: 1:1 to 1:10
  reliability_mtbf_min_hours: 10000
  safety_boundary_threshold_mm: 1
  virtual_fixture_stiffness_min_nm: 5000
  wrist_dof: 7
semantic:
  alternative_parents: []
