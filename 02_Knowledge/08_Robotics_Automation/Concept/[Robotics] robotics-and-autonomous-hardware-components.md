...
object:
  description: '[Robotics] robotics-and-autonomous-hardware-components에 관한 고밀도 지능
    노드'
  object_type: Hardware
  tier: 1
properties:
  adcu_compute_tops: 250
  adcu_power_limit_w: 100
  harmonic_drive_gear_ratio_max: 160
  harmonic_drive_gear_ratio_min: 50
  imu_g_range: 16
  imu_max_bias_stability_deg_hr: 10
  in_wheel_motor_max_torque_nm: 1000
  in_wheel_motor_min_efficiency_percent: 95
  position_error_threshold_deg: 0.005
  servo_driver_max_latency_us: 100
  servo_driver_min_control_loop_hz: 20000
  stiffness_metric_threshold: 100
semantic:
  alternative_parents: []
