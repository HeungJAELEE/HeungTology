...
object:
  description: '[Robotics] autonomous-shipping-and-smart-port-intelligence에 관한 고밀도
    지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  degrees_of_freedom: 6
  docking_precision_threshold_cm: 10
  path_following_error_threshold_m: 5
  port_crane_ops_threshold_per_hour: 40
  port_wait_time_threshold_s: 30
  sat_com_latency_threshold_ms: 500
  sensor_fusion_range_km: 10
semantic:
  alternative_parents: []
