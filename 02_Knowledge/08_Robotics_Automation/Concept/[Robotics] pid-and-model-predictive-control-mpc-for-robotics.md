...
object:
  description: '[Robotics] pid-and-model-predictive-control-mpc-for-robotics에 관한 고밀도
    지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  disturbance_rejection_threshold_db: 40
  hds_gold_standard_version: V6.3.7
  kd_default: 0.1
  ki_default: 1.0
  kp_default: 10.0
  phase_margin_threshold_deg: 45.0
  prediction_horizon_max_steps: 50
  prediction_horizon_min_steps: 10
  settling_time_threshold_ms: 100
  steady_state_error_threshold_percent: 0.01
semantic:
  alternative_parents: []
