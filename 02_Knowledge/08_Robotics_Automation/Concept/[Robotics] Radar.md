...
object:
  ...
  tier: 1
properties:
  antenna_technology: Massive MIMO
  beamforming_method: Digital Beamforming
  detection_algorithm: CFAR (Constant False Alarm Rate)
  imaging_dimensions: 4D (Range, Azimuth, Elevation, Velocity)
  operating_frequencies: 77GHz, 79GHz
  signal_processing_pipeline: 2D-FFT -> CFAR -> AoA Estimation -> Kalman Filter
  tracking_algorithm: Kalman Filter
  velocity_calculation_formula: v = (c * delta_f) / (2 * f0 * cos(theta))
semantic:
  alternative_parents: []
