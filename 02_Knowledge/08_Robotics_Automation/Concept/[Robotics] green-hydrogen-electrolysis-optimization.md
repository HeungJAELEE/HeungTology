...
object:
  ...
  tier: 1
properties:
  ai_hardware_base: RTX 4060
  alk_response_time: minutes
  current_density_pem_threshold: '> 2.0 A/cm^2'
  degradation_rate_threshold: < 10 uV/hr
  doe_ref: Hydrogen Program
  gas_purity_min: 99.999%
  irena_ref: Green Hydrogen 2024
  lcoh_target_max: $2.0/kg
  pem_response_time: 1-10 sec
  ramp_rate_min: 10%/sec
  stack_efficiency_threshold: '> 75%'
  stack_life_extension_target: 30%
  v_cell_equation: V_cell = V_rev + iR + eta_act + eta_conc
semantic:
  alternative_parents: []
