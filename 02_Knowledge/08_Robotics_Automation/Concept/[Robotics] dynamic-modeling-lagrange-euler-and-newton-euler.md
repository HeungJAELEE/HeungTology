...
lineage:
  ...
  original_hash: 53b6f0f9a3c6833845b849c55b4ff9806ead2293d670158aee2163eaac6468ff
metadata:
  date: '2026-05-16'
...
object:
  description: '[Robotics] dynamic-modeling-lagrange-euler-and-newton-euler에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  default_inertia_m: 10.0
  dynamic_update_rate_hz: '> 1,000'
  equation_of_motion: M(q)q'' + C(q, q')q' + g(q) = tau
  gravity_constant: 9.81
  inertia_matrix_property: positive_definite
  max_payload_capacity_kg: 5.0 ~ 200
  parameter_identification_accuracy_percent: '> 95.0'
