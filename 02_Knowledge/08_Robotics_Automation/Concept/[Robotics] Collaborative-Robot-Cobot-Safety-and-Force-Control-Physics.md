...
lineage:
  ...
  original_hash: 010a76a51e36093382290ec635afc59e84cbde9c81a1892a0675ff9d3960f619
metadata:
  date: '2026-05-16'
...
object:
  description: '[Robotics] Collaborative-Robot-Cobot-Safety-and-Force-Control-Physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  collision_detection_delay_ms: 4.85
  compliance_human_interaction_ratio: 0.85
  emergency_stop_braking_time_ms: 172
  external_db_endpoint: robotics-cobot-safety-and-force-control-integrity-log-v2026
  force_control_precision_n: 2.15
  iso_15066_impact_limit_n: 140.0
  max_impact_force_n: 118
  ssm_deceleration_distance_m: 0.82
  ssm_reduction_speed_mm_s: 250
  ssm_slowdown_distance_m: 1.0
  ssm_stop_distance_m: 0.5
  torque_sensor_resolution_nm: 0.24
semantic:
  alternative_parents: []
