...
lineage:
  ...
  original_hash: bb22db1333a8218ee986c62cd0d4265570ee0bd7893f6598f078ceccbaada0bc
metadata:
  date: '2026-05-16'
...
object:
  description: '[Robotics] mobility-autonomous-shipping-and-smart-port에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  agv_transit_speed_kmh: 25-30
  berth_utilization_pct: 92
  crane_cycle_time_range_s: 80-100
  dynamic_positioning_precision_m: 0.1-0.5
  fuel_efficiency_improvement_pct: 12
  max_cross_track_error_m: 2
  max_e2e_control_loop_latency_ms: 150
  max_obstacle_detection_latency_ms: 50
  min_sensor_fusion_frequency_hz: 20
  predictive_modeling_horizon_s: 300
  quantization_format: INT8
  target_relative_speed_kn: 20
semantic:
  alternative_parents: []
