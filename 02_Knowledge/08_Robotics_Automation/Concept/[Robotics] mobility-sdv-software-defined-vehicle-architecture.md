...
lineage:
  ...
  original_hash: c7cb1cefea5ab555467a38b532a8f97a805d64aa0d446d7e51b46f1c26f86328
metadata:
  date: '2026-05-16'
...
object:
  description: '[Robotics] mobility-sdv-software-defined-vehicle-architecture에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  central_hpc_count_range: 3-5
  max_hypervisor_latency_us: 10
  min_ai_inference_tops: 2000
  min_automotive_ethernet_bandwidth_gbps: 10
  min_ota_throughput_gbps: 1
  safety_resource_violation_threshold_pct: 5
  service_latency_formula: tau_service = tau_req + tau_proc + tau_res + tau_HAL
  service_latency_limit_ms: 10
semantic:
  alternative_parents: []
