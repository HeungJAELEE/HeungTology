...
object:
  description: '[Robotics] forward-and-inverse-kinematics-for-manipulators에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  backlash_error_tolerance_deg: 0.001
  high_end_ik_solve_time_ms: 0.5
  high_end_repeatability_threshold_mm: 0.01
  low_end_ik_solve_time_ms_min: 10
  low_end_repeatability_threshold_mm: 1.0
  manipulability_fidelity_tolerance: 0.05
  manipulability_index_threshold: 0.8
  max_backlash_error_deg: 0.005
  mechanical_wear_detection_threshold_mm: 0.05
  singularity_determinant_threshold: 0.0001
  singularity_determinant_tolerance: 1.0e-05
  standard_ik_solve_time_ms_range: 1-5
  standard_repeatability_threshold_mm: 0.1
  target_dof_range: 6-7
semantic:
  alternative_parents: []
