...
object:
  description: '[Robotics] Autonomous-Mobile-Robot-AMR-Navigation-and-SLAM-Logic에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  braking_stopping_distance_verified_cm: 42
  collision_avoidance_success_rate_pct: 99.2
  ekf_corrected_drift_limit_cm: 5
  encoder_drift_per_100m_m: 1.5
  fidelity_delay_critical_ms: 150.0
  fidelity_loc_limit_cm: 5.0
  loop_closure_success_rate_verified_pct: 94.5
  low_light_threshold_lux: 10
  max_driving_speed_verified_ms: 1.85
  min_obstacle_clearance_cm: 20
  obstacle_detection_distance_verified_m: 8.2
  path_replan_delay_verified_ms: 78
  pedestrian_speed_ms: 1.5
  positioning_accuracy_verified_cm: 2.45
  visual_odometry_error_multiplier_low_light: 3
semantic:
  alternative_parents: []
