...
lineage:
  ...
  original_hash: 7cfb9a2d4aaa73b9fb076502e4137d968439cab9f77f860d579c38db2fb18458
metadata:
  date: '2026-05-16'
...
object:
  description: '[Robotics] force-and-impedance-control-for-human-robot-interaction에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  collision_detection_time: < 10 ms
  constant_force_error: < 1.0 %
  default_target_damping: 20.0
  default_target_stiffness: 100.0
  engine_specification: HDS-Gold V6.3.7
  force_sensing_resolution: < 0.1 N
  impedance_model_equation: M_d*e_ddot + B_d*e_dot + K_d*e = F_ext
  safety_standard: ISO 10218
  variable_stiffness_range: 0.1 ~ 10,000 N/m
semantic:
  alternative_parents: []
