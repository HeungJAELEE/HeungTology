...
lineage:
  ...
  original_hash: d1ba992724250cd44804bfe6735578cf30f1cf013f4dafe9bb68bb1700ab7a19
metadata:
  date: '2026-05-16'
  domain: 09_SmartFactory_Production
  id: '[[[Infrastructure] additive-manufacturing-metal-3d-printing-structural-integrity-log-v2026]]'
  last_updated: '2026-05-17T22:59:20+09:00'
  project: Vault_Modernization
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: '[Infrastructure] additive-manufacturing-metal-3d-printing-structural-integrity-log-v2026에
    관한 고밀도 지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  max_oxygen_level_ppm: 100
  surface_roughness_ra_um:
  - 5.0
  - 15.0
  ti_6al_4v_hardness_hv:
  - 350
  - 450
  ved_calculation_formula: P / (v * h * t)
  ved_optimal_range_j_mm3:
  - 60
  - 80
  yield_strength_range_mpa:
  - 950
  - 1100
semantic:
  alternative_parents: []
...
# [Infrastructure] additive-manufacturing-metal-3d-printing-structural-integrity-log-v2026
...
|:---|:---:|:---:|:---:|:---:|:---|
| **AM-M-101** | $99.98 \%$ | $< 5 \mu\text{m}$ | $120 MPa$ | $65.5$ | **Class A**: Aerospace Grade |
| **AM-M-205** | $98.50 \%$ | $45 \mu\text{m}$ | $450 MPa$ | $42.0$ | **Class C**: Thermal Stress High |
| **AM-M-309** | $99.65 \%$ | $12 \mu\text{m}$ | $210 MPa$ | $58.2$ | **Class B**: Industrial Standard |
| **AM-M-FAIL**| $94.20 \%$ | $150 \mu\text{m}$ | $580 MPa$ | $35.0$ | **Fail**: Lack of Fusion |
| **Hardness** | HV (Vickers) | $350 \sim 450$ | Surface | Internal | 소재 강도 분포 (Ti-6Al-4V 기준) |
| **Roughness**| Ra ($\mu\text{m}$) | $5.0 \sim 15.0$ | As-built | Polished | 적층 표면의 기하학적 거칠기 |
