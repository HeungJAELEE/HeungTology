...
object:
  description: '[Infrastructure] smart-factory-equip-b-error-log-v2026에 관한 고밀도 지능
    노드'
  object_type: Data
  tier: 1
properties:
  e_102_monthly_occurrences: 15
  e_102_mttr_minutes: 45
  e_201_monthly_occurrences: 2
  e_201_mttr_minutes: 120
  e_305_monthly_occurrences: 42
  e_305_mttr_minutes: 5
  e_501_monthly_occurrences: 8
  e_501_mttr_minutes: 20
  mtbf_formula: Total Operating Time / Number of Failures
  recovery_rate_percentage: 92
  rpn_formula: S * O * D
semantic:
  alternative_parents: []
