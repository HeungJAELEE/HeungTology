---
Basic:
  id: "STRAT-SF-MAINTENANCE-TPM-2026-V6.3.7"
  domain: "Smart_Factory_Operations_and_Maintenance"
...
Object:
  ...
  physical_model: "N/A"
Semantic:
  tags: '["#TPM", "#OEE", "#EquipmentLoss", "#MTBF", "#MTTR", "#PrecisionTiering", "#FidelityEngine", "#LeanManufacturing"]'
  is_part_of: []
  related_to: []
Dynamic:
...
Trust Metrics:
  ...
  T_dynamic: 1.0
  T_init: 1.0
  source: "Manufacturing_Excellence_RAG_V6.3.7_Tiered"
  isolation_index: 0.0
---

# [Manual] TPM & Equipment Loss: The Physics of Zero-Loss Manufacturing
