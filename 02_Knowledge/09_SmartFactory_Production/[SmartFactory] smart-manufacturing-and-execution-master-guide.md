---
Basic:
  id: "SMF-EXEC-MASTER-2026-V6.3.7"
  domain: "Smart_Factory_Execution_Governance"
...
Object:
  ...
  physical_model: "N/A"
Semantic:
  tags: ["#Smart_Factory", "#MES", "#Scheduling", "#OEE", "#Traceability", "#Autonomous_Manufacturing", "#v6.3.7"]
  is_part_of: ["MOC Smart-Manufacturing-Hub", "MOC 01_Semiconductor", "MOC 02_Battery"]
  related_to: []
Dynamic:
