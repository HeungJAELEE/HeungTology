...
object:
  description: '[Infrastructure] Automated-Storage-and-Retrieval-System-ASRS-Physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  abc_cycle_time_reduction_pct: 42
  collision_risk_increase_pct: 15
  energy_recovery_ideal_pct: 30.0
  energy_recovery_verified_pct: 22.4
  external_log_db_endpoint: logistics-asrs-throughput-and-load-handling-log-v2026
  fork_deflection_at_1000kg_mm: 3.2
  horizontal_speed_ideal_m_min: 240
  horizontal_speed_verified_m_min: 215
  mast_amplitude_limit_cm: 15
  max_load_ideal_kg: 1500
  max_load_verified_kg: 1420
  max_safe_acceleration_m_s2: 1.5
  settling_time_delay_ms: 1.2
  stop_precision_ideal_mm: 2.0
  stop_precision_verified_mm: 4.5
  target_throughput_goal_pal_hr: 40.0
  throughput_ideal_pal_hr: 45
  throughput_verified_pal_hr: 38.2
  vertical_speed_ideal_m_min: 60
  vertical_speed_verified_m_min: 52.4
semantic:
  alternative_parents: []
