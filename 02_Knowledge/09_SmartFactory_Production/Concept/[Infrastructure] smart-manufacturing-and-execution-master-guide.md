...
lineage:
  ...
  original_hash: dea6cc2e8db3548cf2b0b07c9f3c0a74fce7806838e7b9d6675388587eca5bd2
metadata:
  date: '2026-05-16'
...
object:
  description: '[Infrastructure] smart-manufacturing-and-execution-master-guide에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  changeover_time_threshold_min: 10
  decision_latency_target_ms: 100
  decision_latency_threshold_sec: 1
  oee_integrity_threshold: 0.85
  sync_jitter_threshold_ms: 10
  target_oee: 0.92
  version: v6.3.7
semantic:
  alternative_parents: []
