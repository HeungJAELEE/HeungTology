...
object:
  description: '[Infrastructure] Industrial-IoT-IIoT-and-Edge-Computing-Intelligence에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  bandwidth_bottleneck_improvement: 85 %
  clock_sync_precision_verified: 2.45 us
  data_matching_accuracy_threshold: 99.9 %
  data_update_cycle_verified: 72 Hz
  edge_data_reduction_rate_verified: 84.5 %
  edge_inference_delay_verified: 14.2 ms
  network_fidelity_latency_limit: 5.0 ms
  packet_loss_rate_verified: 0.015 %
  protocol_conversion_delay_limit: 5 ms
  robot_sync_precision_limit: 10 um
  tsn_jitter_limit: 2.5 us
  tsn_transfer_delay_verified: 1.85 ms
  verified_log_endpoint: smart-factory-iiot-and-edge-computing-performance-log-v2026
semantic:
  alternative_parents: []
