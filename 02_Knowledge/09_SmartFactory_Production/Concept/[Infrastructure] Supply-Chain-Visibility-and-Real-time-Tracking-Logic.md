...
lineage:
  ...
  original_hash: 4be9082b8af78fcea54b03d48bbf4613779f6bb7ce04f7a6b4a39d00f42c31ee
metadata:
  date: '2026-05-16'
...
object:
  description: '[Infrastructure] Supply-Chain-Visibility-and-Real-time-Tracking-Logic에
    관한 고밀도 지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  data_update_cycle_ideal_min: 15.0
  data_update_cycle_tolerance_min: 10.0
  data_update_cycle_verified_min: 45.2
  eta_limit_hr: 2.0
  eta_prediction_error_ideal_hr: 1.0
  eta_prediction_error_tolerance_hr: 1.0
  eta_prediction_error_verified_hr: 4.2
  external_log_endpoint: logistics-scm-visibility-and-real-time-tracking-log-v2026
  fidelity_eta_score_weight: 0.4
  fidelity_visibility_weight: 0.6
  inventory_accuracy_rtls_ideal_pct: 99.9
  inventory_accuracy_rtls_tolerance_pct: 0.5
  inventory_accuracy_rtls_verified_pct: 98.4
  lead_time_variability_ideal_pct: 5.0
  lead_time_variability_tolerance_pct: 2.0
  lead_time_variability_verified_pct: 12.8
  logistics_visibility_index_ideal_pct: 99.0
  logistics_visibility_index_tolerance_pct: 2.0
  logistics_visibility_index_verified_pct: 92.5
  out_of_stock_limit_pct: 0.5
  risk_detection_golden_time_ideal_min: 30.0
  risk_detection_golden_time_tolerance_min: 10.0
  risk_detection_golden_time_verified_min: 54.0
  safety_stock_reduction_target_pct: 18.0
semantic:
  alternative_parents: []
