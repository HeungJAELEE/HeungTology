...
lineage:
  ...
  original_hash: dffb95812d003c8010a73582b21a2c9930c5893e63fa3b0accacbcdba4ca739b
metadata:
  date: '2026-05-16'
  domain: 09_SmartFactory_Production
  id: '[[[Infrastructure] battery-manufacturing-intelligence]]'
  last_updated: '2026-05-17T22:59:20+09:00'
  project: Vault_Modernization
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: '[Infrastructure] battery-manufacturing-intelligence에 관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  apc_precision_tolerance: ± 0.5%
  cpk_formula: (USL-LSL)/(6*sigma)
  cpk_target: '> 1.67'
  data_latency_max: < 10ms
  fpy_target: '> 95%'
  mes_traceability_log_endpoint: manufacturing-mes-lot-traceability-log-v2026
  mtbf_min: '> 500 hrs'
  oee_formula: Availability * Performance * Quality
  oee_target: '> 85%'
  ramp_up_time_reduction_target: -50%
  semiconductor_fab_ramp_up_log_endpoint: semiconductor-fab-yield-ramp-up-log-v2026
  vc_fidelity_min: '> 99%'
  vision_resolution_max: < 50um
semantic:
  alternative_parents: []
...
# [Infrastructure] battery-manufacturing-intelligence
...
| **Vision Res.** | Defect Detection Resolution | $< 50 \mu\text{m}$ | 고속 웹 주행 중에도 미세 결함을 실시간 탐지하는 지능형 비전 성능 |
