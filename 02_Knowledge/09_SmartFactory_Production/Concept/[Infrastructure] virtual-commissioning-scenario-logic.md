...
lineage:
  ...
  original_hash: 361c61f89abfd6fdb230044e7e514a2e7c252d1d1d2da5224208e8f2488742c2
metadata:
  date: '2026-05-16'
  domain: 09_SmartFactory_Production
  id: '[[[Infrastructure] virtual-commissioning-scenario-logic]]'
  last_updated: '2026-05-17T22:59:20+09:00'
  project: Vault_Modernization
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: '[Infrastructure] virtual-commissioning-scenario-logic에 관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  collision_sensitivity: <0.1mm
  cycle_time_accuracy: <2.0%
  external_log_endpoint: semiconductor-fab-yield-ramp-up-log-v2026
  fault_coverage: '>90%'
  io_tag_capacity: '>5000 tags'
  jitter_margin: <1ms
  physics_frequency: '>500Hz'
  rt_factor: 1.0 (+/- 0.01)
  sync_interval: 1-10ms
semantic:
  alternative_parents: []
...
# [Infrastructure] virtual-commissioning-scenario-logic
