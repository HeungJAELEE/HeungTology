...
lineage:
  ...
  original_hash: 52e67fb1c4648371a2775fb25f5d7d4809860bcea5986577b4fdb2078bcd4418
metadata:
  date: '2026-05-16'
...
object:
  description: '[Infrastructure] hot-runner-system-and-valve-gate-control-intelligence에
    관한 고밀도 지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  heater_mtbf_shots: 2000000
  pressure_drop_runner_loss_percent: 15
  pressure_surge_formula: p_surge = rho * a * delta_v
  sealing_force_thermal_preload_mpa: 2.0-5.0
  software_version: V6.3.7
  temp_accuracy_zone_variation_c: 1.0
  thermal_expansion_formula: delta_l = alpha * l * (t_hot - t_cold)
  valve_switching_time_limit_ms: 50
semantic:
  alternative_parents: []
