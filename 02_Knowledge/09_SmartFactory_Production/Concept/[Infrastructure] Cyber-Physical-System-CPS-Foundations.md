...
object:
  description: '[Infrastructure] Cyber-Physical-System-CPS-Foundations에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  actuation_precision_um: 10
  data_sample_rate_hz_max: 1000
  data_sample_rate_hz_min: 100
  logic_accuracy_min_pct: 98
  model_fidelity_min_pct: 99.5
  network_reliability_min_pct: 99.999
  processing_power_min_tflops: 10
  self_config_accuracy_min_pct: 95
  sync_latency_max_ms: 10
semantic:
  alternative_parents: []
