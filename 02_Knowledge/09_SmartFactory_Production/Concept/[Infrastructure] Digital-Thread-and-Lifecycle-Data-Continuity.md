...
lineage:
  ...
  original_hash: 544d621da80a2f46bf16ebe2b61ffddda801f58589c81f0aea46bad75a3a9f50
metadata:
  date: '2026-05-16'
...
object:
  description: '[Infrastructure] Digital-Thread-and-Lifecycle-Data-Continuity에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  audit_integrity_requirement: immutable
  data_sync_target_percent: 98
  ecm_cycle_max_days: 3
  feedback_loop_period: real-time/daily
  lifecycle_coverage_target_percent: 100
  recall_precision_target_percent: 100
  semantic_match_target_percent: 95
  specification_version: HDS-Gold V6.3.7
  traceability_latency_max_seconds: 5
semantic:
  alternative_parents: []
