...
lineage:
  ...
  original_hash: 3e0665ae6584ec6f420ff6ba031a07f1216b83be43166cab8c366bab2f5df0a6
metadata:
  date: '2026-05-16'
...
object:
  description: '[Infrastructure] Predictive-Maintenance-PdM-and-OEE-Optimization에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  cycle_time_delay_correlation_percent: 15.0
  external_log_db_endpoint: smart-factory-pdm-and-oee-optimization-log-v2026
  minor_stoppage_frequency_verified_per_day: 4.2
  mtbf_ideal_hrs: 500
  mtbf_verified_hrs: 442
  mttr_ideal_hrs: 2.0
  mttr_verified_hrs: 2.45
  oee_target_percent: 85.0
  oee_verified_percent: 82.4
  pdm_accuracy_target_percent: 95.0
  pdm_accuracy_verified_percent: 91.5
  rul_rmse_ideal_percent: 5.0
  rul_rmse_verified_percent: 8.2
  servo_torque_threshold_percent: 80.0
  vibration_anomaly_frequency_khz: 2.5
semantic:
  alternative_parents: []
