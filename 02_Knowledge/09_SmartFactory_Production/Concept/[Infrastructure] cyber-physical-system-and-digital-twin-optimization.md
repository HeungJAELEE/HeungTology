...
object:
  description: '[Infrastructure] cyber-physical-system-and-digital-twin-optimization에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  data_update_frequency_ideal_hz: 10.0
  data_update_frequency_verified_hz: 4.8
  erp_plm_mes_sync_error_threshold_pct: 1.0
  external_log_endpoint: smart-factory-digital-twin-and-cps-synchronization-log-v2026
  grip_force_simulation_gap_pct: 12.0
  installation_time_reduction_pct: 25.0
  latency_limit_ms: 50.0
  network_bandwidth_load_ideal_pct: 40.0
  network_bandwidth_load_verified_pct: 62.5
  physical_model_fidelity_ideal_pct: 99.0
  physical_model_fidelity_verified_pct: 94.2
  position_error_mm_at_40ms_latency: 5.0
  predictive_maintenance_accuracy_ideal_pct: 90.0
  predictive_maintenance_accuracy_verified_pct: 82.4
  process_defect_reduction_pct: 15.0
  sync_latency_ideal_ms: 10.0
  sync_latency_tolerance_ms: 5.0
  sync_latency_verified_ms: 42.5
  virtual_commissioning_accuracy_ideal_pct: 95.0
  virtual_commissioning_accuracy_verified_pct: 88.5
semantic:
  alternative_parents: []
