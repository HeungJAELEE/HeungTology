---
Basic:
  id: "SF-QUALITY-VISION-2026-V6.3.7"
  domain: "Smart_Factory_Vision_AI_and_Quality_Governance"
...
Object:
  ...
  physical_model: "N/A"
Semantic:
  tags: '["#VisionAI", "#AOI", "#DeepLearning", "#OpticalInspection", "#QualityControl", "#PrecisionRecall", "#FidelityEngine", "#Sovereignty"]'
  is_part_of: '["MOC Smart-Manufacturing-Hub"]'
  related_to: []
Dynamic:
...
Trust Metrics:
  ...
  T_dynamic: 1.0
  T_init: 1.0
  source: "Quality_Intelligence_RAG_V6.3.7_Tier0"
  isolation_index: 0.0
---

# [Quality] Vision AI and Automated Optical Inspection: The Visual Intelligence
