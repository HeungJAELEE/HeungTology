...
metadata:
  date: "2026-05-17"
  id: "[[[Concept] plastic-injection-molding-ppap-standard]]"
...
lineage:
  ...
  original_hash: "010f255dbd2dd3bcefd2f67f3f1b8cfc90a8b05255e8ceea90c63cf19ac7844e"
object:
  object_type: "Concept"
  tier: 1
  description: '사출 금형 양산 승인의 최종 게이트로서 다수 캐비티 간 편차(Cavity Balance) 및 연속 생산 300개의 초기 공정 능력 지수($P_{pk} > 1.67$)를 통계적으로 입증하여 양산 주권을 선언하는 표준 지능'
temporal:
...
spo_graph:
  - subject: "plastic-injection-molding-ppap-standard"
    ...
    evidence_coordinate: "[Ref: AIAG PPAP Manual] Section 1"
    evidence_hash: "010f255dbd2d"
...
| **Dimensional Report** | Multi-cavity Full Layout Inspection | $100.0 \%$ in Tolerance | 금형 내 전 캐비티의 삼차원 치수 측정값 합격 증명 |
| **Appearance Report** | A-Surface Sensorial Standards | No Sink/Flow Marks | 고분자 배향 불균일성 및 웰드 융착 강도 육안 무결성 사수 |
| **Control Plan** | Parameter Interlock Lockout | Setup Sheet Match $100\%$ | 양산 시 공정 드리프트를 방지하기 위한 PLC 제어 인자 고정 |
| **Material Report** | IMDS Registration & COA Cert | $100.0 \%$ Traceable | 친환경 규제 및 고분자 화학적 조성 무결성 증명 |
...
*   **$P_{pk} \ge 1.67$**: 공정이 극도로 안정적이며 양산 진입 승인(APPROVED).
...
- `[[ppap-production-part-approval-process]]` (외부자료) : 완성차 부품 승인 제출 규범
- `[[plastic-injection-molding-physics-and-cycle-analysis]]` (외부자료) : 수지 고유의 중량 변동(Weight) 제어

---
**[SPO_Graph: Injection_PPAP -> concept_modernized (Evidence: [Ref: AIAG PPAP Manual] Section 2.2)]**
