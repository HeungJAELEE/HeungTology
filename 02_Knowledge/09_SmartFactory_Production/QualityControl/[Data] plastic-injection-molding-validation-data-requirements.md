...
object:
  object_type: "Data"
  tier: 1
  description: '사출 성형 공정 품질 표준서 6대 규격의 실효성과 무결성을 통계적/물리적으로 증명하기 위해 요구되는 IoT 센서 스트림, Gage R&R, Cpk 및 리스크 상관관계 실측 검수 데이터 요구사항 자산'
measurement:
  value: 100.0
...
spo_graph:
  - subject: "plastic-injection-molding-validation-data-requirements"
    ...
    evidence_coordinate: "[Ref: MES Database] Table IMM_QUAL_2026"
    evidence_hash: "b3ede6600ea5"
    evidence_timestamp: "2026-05-17T22:59:20+09:00"
  - subject: "plastic-injection-molding-validation-data-requirements"
    predicate: "requires_instance"
    object: "Cpk > 1.67"
    evidence_coordinate: "[Ref: Quality Control SOP] Section 4.2"
    evidence_hash: "b3ede6600ea5"
    evidence_timestamp: "2026-05-17T22:59:20+09:00"
trust_metrics:
  T_static: 0.8
...
---
**[SPO_Graph: Injection_Validation_Data -> instance_of_QMS (Evidence: [Ref: MES Database] IMM_QUAL_2026)]**
