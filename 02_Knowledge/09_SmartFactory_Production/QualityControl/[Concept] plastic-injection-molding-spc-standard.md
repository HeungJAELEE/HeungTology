...
metadata:
  date: "2026-05-17"
  id: "[[[Concept] plastic-injection-molding-spc-standard]]"
...
lineage:
  ...
  original_hash: "beac4f2b69da6dcf07ad67e554165c7a4572406eaaa591f40866d65d0d5d2104"
object:
  object_type: "Concept"
  tier: 1
  description: '사출 성형 CTQ 파라미터(압력 피크, 쿠션 위치, 사이클 시간)의 미세 흔들림 변동을 통계적으로 상한/하한 관리한계선($UCL/LCL = \bar{X} \pm 3\sigma$) 내에 구속하여 양산 안정성을 수립하는 SPC 표준 지능'
temporal:
...
spo_graph:
  - subject: "plastic-injection-molding-spc-standard"
    ...
    evidence_coordinate: "[Ref: AIAG SPC Manual] Chapter 1 Section A"
    evidence_hash: "beac4f2b69da"
    evidence_timestamp: "2026-05-17T22:59:20+09:00"
  - subject: "plastic-injection-molding-spc-standard"
    predicate: "has_theoretical_limit"
    object: "Cpk > 1.67"
    evidence_coordinate: "[Ref: AIAG SPC Manual] Chapter 2 Section B"
    evidence_hash: "beac4f2b69da"
    evidence_timestamp: "2026-05-17T22:59:20+09:00"
trust_metrics:
  T_static: 1.0
...
| **Cushion Position** | Stability Limit | $\pm 0.1 \text{ mm}$ | 보압 전환(VP) 시 용융 수지의 잔류 체적 일관성 확보 |
...
- `[[statistical-process-control-spc-and-control-chart-logic]]` (외부자료) : 통계적 관리도 수학 기초
- `[[experimental-design-doe-and-statistical-process-control-spc-logic]]` (외부자료) : 통계 분석 및 분산 제어 SOP

---
**[SPO_Graph: Injection_SPC -> concept_modernized (Evidence: [Ref: AIAG SPC Manual] Chapter 2)]**
