...
lineage:
  ...
  original_hash: a549df88120f3e4e22ad52a385368392639b7fab6bcc9a293f6bc12e68efd46d
metadata:
  ai_modified_date: '2026-05-24'
  ai_status: pending_review
  date: '2026-05-16'
  domain: 25_Infrastructure
  id: '[[[25_Infrastructure] [Strategy] Industrial-Safety-Compliance]]'
...
properties:
  ...
  iso_45001: ohs_management_system_standard
  near_miss_db: near_miss_db_endpoint
  ppe_requirements: helmet_safety_shoes
  safety_logic_principle: fool_proof_interlock
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 25_Infrastructure]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: framework_specification
  object: Concept
  predicate: contains_knowledge_of
  subject: '[Strategy] Industrial-Safety-Compliance'
  weight: 0.9
temporal:
