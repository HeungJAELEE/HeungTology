...
metadata:
  ...
  id: '[[[25_Infrastructure] [Strategy] Energy-Storage-Systems-ESS]]'
...
object:
  ...
  tier: 1
properties:
  cycle_life_threshold: '> 6,000 cycles'
  depth_of_discharge_range: 80-95%
  endpoint_battery_aging_profile: battery-aging-degradation-profile-v2026
  endpoint_grid_frequency_log: grid-frequency-disturbance-log-v2026
  endpoint_market_price_log: global-electricity-market-price-log-v2026
  frequency_adjustment_resolution: 0.1Hz
  lcos_target: < 150 USD/MWh
  optimal_daily_cycle_count: 1.5
  power_density_threshold: '> 2 MW/Container'
  response_time_threshold: < 100ms
  rte_threshold: '> 85%'
  system_availability_threshold: '> 99.5%'
  virtual_inertia_response_limit: 50ms
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: '[Strategy] Energy-Storage-Systems-ESS'
  weight: 0.9
temporal:
