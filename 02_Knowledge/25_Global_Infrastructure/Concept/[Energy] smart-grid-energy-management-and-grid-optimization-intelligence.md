...
lineage:
  ...
  original_hash: 03a6aa4179d80101706209f83b41e2e4e98669b811dd3166b6acac41e0b8c2ec
metadata:
  ai_modified_date: '2026-05-24'
  ai_status: pending_review
  date: '2026-05-16'
  domain: 25_Infrastructure
  id: '[[[25_Infrastructure] [Energy] smart-grid-energy-management-and-grid-optimization-intelligence]]'
  last_updated: '2026-05-24T00:28:00+09:00'
  project: Antigravity_SDF_Core
  revision: r4
  version: v7.9_Enterprise_Node
object:
  description: '[Energy] smart-grid-energy-management-and-grid-optimization-intelligence에
    관한 고밀도 지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  fidelity_engine_freq_tolerance_hz: 0.005
  nominal_grid_frequency_hz: 60.0
  peak_shaving_load_reduction_target_pct: 30
  renewable_integration_cap_target_pct: 60
  tier1_freq_variance_hz: 0.01
  tier1_response_time_ms: 100
  tier1_voltage_stability_pct: 1.0
  tier2_freq_variance_hz: 0.1
  tier2_response_time_ms: 500
  tier2_voltage_stability_pct: 3.0
  tier3_freq_variance_hz: 0.5
  tier3_response_time_ms: 1000
  tier3_voltage_stability_pct: 5.0
  transmission_congestion_threshold_pct: 5
  transmission_efficiency_target_pct: 98
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: '[Energy] smart-grid-energy-management-and-grid-optimization-intelligence'
  weight: 0.9
temporal:
