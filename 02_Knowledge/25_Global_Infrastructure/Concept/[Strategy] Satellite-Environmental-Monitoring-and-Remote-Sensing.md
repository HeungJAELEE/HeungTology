...
metadata:
  ...
  id: '[[[25_Infrastructure] [Strategy] Satellite-Environmental-Monitoring-and-Remote-Sensing]]'
  last_updated: '2026-05-24T00:28:00+09:00'
  project: Antigravity_SDF_Core
  revision: r4
  version: v7.9_Enterprise_Node
object:
  description: '[Strategy] Satellite-Environmental-Monitoring-and-Remote-Sensing에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  observation_resolution: 1cm
  target_gas: CH4
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  intent: knowledge_containment
  object: Concept
  predicate: contains_knowledge_of
  subject: '[Strategy] Satellite-Environmental-Monitoring-and-Remote-Sensing'
  weight: 0.9
temporal:
