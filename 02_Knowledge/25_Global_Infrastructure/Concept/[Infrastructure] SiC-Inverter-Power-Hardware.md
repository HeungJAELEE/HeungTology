...
metadata:
  ...
  id: '[[[25_Infrastructure] [Infrastructure] SiC-Inverter-Power-Hardware]]'
...
object:
  ...
  tier: 1
properties:
  packaging_method: Ag Sintering
  sic_bandgap_ev: '3.26'
  sic_breakdown_field_mv_cm: '3.0'
  sic_max_efficiency: 99.2%
  sic_power_density_kw_l: '100'
  sic_switching_frequency_khz: 100-200
  sic_thermal_conductivity_wmk: '4.9'
  thermal_fatigue_threshold_deg_c: '100'
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: '[Infrastructure] SiC-Inverter-Power-Hardware'
  weight: 0.9
temporal:
