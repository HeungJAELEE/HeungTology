...
lineage:
  ...
  original_hash: 1328b8323338c7841c3a443ae16a956217805293de426398b9586844880efc38
metadata:
  ai_modified_date: '2026-05-24'
  ai_status: pending_review
  date: '2026-05-16'
  domain: 25_Infrastructure
  id: '[[[25_Infrastructure] [Infrastructure] ndt-x-ray-ct-reconstruction-ai]]'
...
object:
  ...
  tier: 1
properties:
  battery_tube_voltage_kv: 130kv
  cnr_threshold: '> 5'
  max_process_time: < 10 min
  recon_accuracy_threshold: '> 99%'
  rotation_runout_limit: < 100 nm
  voxel_resolution_threshold: < 1 um
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 25_Infrastructure]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: conceptual_scope
  object: Concept
  predicate: contains_knowledge_of
  subject: '[Infrastructure] ndt-x-ray-ct-reconstruction-ai'
  weight: 0.95
temporal:
...
| **Rotation Precision** | 에어 베어링 회전축의 **편심(Run-out)** 오차를 $100\ \text{nm}$ 이내로 관리 | **Center of Rotation (COR) Offset**: 회전축이 흔들리면 재구성 시 영상이 이중으로 겹쳐 보이는 블러링 아티팩트가 발생함. | **Recon. Acc > 99%** |
