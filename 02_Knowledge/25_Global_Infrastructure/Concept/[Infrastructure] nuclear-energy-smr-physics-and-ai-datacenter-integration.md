...
metadata:
  ...
  id: '[[[25_Infrastructure] [Infrastructure] nuclear-energy-smr-physics-and-ai-datacenter-integration]]'
  last_updated: '2026-05-24T00:28:00+09:00'
  project: Antigravity_SDF_Core
  revision: r4
  version: v7.9_Enterprise_Node
object:
  description: '[Infrastructure] nuclear-energy-smr-physics-and-ai-datacenter-integration에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  burn_up_rate_gwd_mtu: 45
  dnbr_minimum_margin: 1.3
  hybrid_control_power_adjustment_pct: 10
  load_following_ramp_rate_pct_min: 3 ~ 5
  modularity_ratio_threshold: 0.9
  natural_convection_response_time_sec: 10
  neutron_flux_range_n_cm2s: 10^13 ~ 10^14
  passive_cooling_duration_hours: 72
  power_density_mw_m3: 50 ~ 100
  reactivity_feedback_type: negative
  smr_neutron_flux_log_endpoint: smr-neutron-flux-and-thermal-log-v2026
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 25_Infrastructure]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: knowledge_scope_definition
  object: Concept
  predicate: contains_knowledge_of
  subject: '[Infrastructure] nuclear-energy-smr-physics-and-ai-datacenter-integration'
  weight: 0.7
temporal:
