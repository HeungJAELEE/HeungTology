...
metadata:
  ...
  id: '[[[25_Infrastructure] [Infrastructure] safety-mechanical-design-moc]]'
...
object:
  ...
  tier: 1
properties:
  bms_scanning_period_ms: 10
  safety_compliance_standards:
  - UL 9540A
  - IEC 62619
  simulation_cell_scale_min: 1000
  simulation_hardware_accelerator: RTX 4060
  swelling_pressure_unit: kN
  thermal_onset_threshold_temp: T_onset
  thermal_runaway_threshold_temp: T_tr
semantic:
  alternative_parents: []
