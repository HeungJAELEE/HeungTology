...
metadata:
  ...
  id: '[[[25_Infrastructure] [Infrastructure] Industrial-Chiller-Thermal-Hardware]]'
...
object:
  ...
  tier: 1
properties:
  control_precision: ±0.01°C
  cooling_power_min: 2MW
  cop_min: '6.0'
  fouling_efficiency_drop_limit: 10%
  gwp_index_max: '150'
  response_time_max: 1sec
  superheat_margin_threshold: 5°C
  u_factor_min: 12000W/m2K
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 25_Infrastructure]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: technical_specification_mapping
  object: Concept
  predicate: contains_knowledge_of
  subject: '[Infrastructure] Industrial-Chiller-Thermal-Hardware'
  weight: 0.9
temporal:
