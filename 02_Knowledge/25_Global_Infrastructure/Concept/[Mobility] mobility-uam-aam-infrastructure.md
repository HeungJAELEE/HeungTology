...
lineage:
  ...
  original_hash: 949c4ca07635c06c7b08906edf9c68be8344bd916351be79870f4932b51f5c25
metadata:
  ai_modified_date: '2026-05-24'
  ai_status: pending_review
  date: '2026-05-16'
  domain: 25_Infrastructure
  id: '[[[25_Infrastructure] [Mobility] mobility-uam-aam-infrastructure]]'
...
object:
  ...
  tier: 1
properties:
  ai_inference_framework: OpenVINO
  aviation_safety_reliability_target: 10^-9
  battery_energy_density_threshold: '> 250 Wh/kg'
  cruising_speed_range: 200km/h ~ 320km/h
  emergency_battery_margin: ~ 20%
  fast_charge_power_threshold: '> 500 kW'
  hardware_acceleration_platform: RTX 4060
  landing_precision_error: ± 0.5m
  noise_level_threshold: < 65 dB (at 150m)
  operational_altitude_range: 300m ~ 600m
  path_optimization_time_step: 10ms
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 25_Infrastructure]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: domain_definition
  object: Concept
  predicate: contains_knowledge_of
  subject: '[Mobility] mobility-uam-aam-infrastructure'
  weight: 0.9
temporal:
