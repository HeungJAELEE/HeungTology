...
lineage:
  ...
  original_hash: 66f771aa7de0c1873494be98ad8445d6d62f650e80194301ede64260ce02e2e7
metadata:
  ai_modified_date: '2026-05-24'
  ai_status: pending_review
  date: '2026-05-16'
  domain: 25_Infrastructure
  id: '[[[25_Infrastructure] [Infrastructure] carbon-capture-utilization-and-storage-ccus-physics]]'
  last_updated: '2026-05-24T00:28:00+09:00'
  project: Antigravity_SDF_Core
  revision: r4
  version: v7.9_Enterprise_Node
object:
  description: '[Infrastructure] carbon-capture-utilization-and-storage-ccus-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  capture_recovery_rate_target: '> 95%'
  capture_recovery_rate_tolerance: ± 0.5%
  co2_purity_target: '> 99%'
  co2_purity_tolerance: ± 0.1%
  leakage_rate_threshold: < 0.01%/year
  specific_energy_consumption_target: < 2.5 GJ/t-CO2
  specific_energy_consumption_tolerance: ± 0.1 GJ
  storage_geological_depth_target: '> 800 m'
  storage_geological_depth_tolerance: ± 10 m
  supercritical_pressure_threshold: 73 bar
  supercritical_temp_threshold: 31°C
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: '[Infrastructure] carbon-capture-utilization-and-storage-ccus-physics'
  weight: 1.0
temporal:
