...
metadata:
  ...
  id: '[[[25_Infrastructure] [Energy] wind-turbine-dynamics-and-offshore-energy]]'
...
object:
  ...
  tier: 1
properties:
  cut_in_speed_threshold: < 3m/s
  external_data_endpoint: wind-turbine-vibration-and-power-curve-v2026
  min_blade_length: '> 120m'
  pitch_control_precision: < 0.1deg
  power_coefficient_threshold: '> 0.48'
  rated_power_capacity: '> 15MW'
  structural_life_threshold: '> 30years'
  tip_speed_ratio_range: 7-10
  yaw_error_threshold: < 3deg
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 25_Infrastructure]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: domain_knowledge_definition
  object: Concept
  predicate: contains_knowledge_of
  subject: '[Energy] wind-turbine-dynamics-and-offshore-energy'
  weight: 1.0
temporal:
