...
metadata:
  ...
  id: '[[[25_Infrastructure] [Infrastructure] hyperloop-and-vacuum-tube-transport-physics]]'
  last_updated: '2026-05-24T00:28:00+09:00'
  project: Antigravity_SDF_Core
  revision: r4
  version: v7.9_Enterprise_Node
object:
  description: '[Infrastructure] hyperloop-and-vacuum-tube-transport-physics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  braking_distance_tolerance: 0.1 km
  emergency_braking_distance_max: 5 km
  kantrowitz_ratio_min: '1.4'
  kantrowitz_ratio_tolerance: '0.1'
  max_cruise_velocity: 1000 km/h
  max_vibration_acceleration: 0.1 g
  pressure_target_default: 100.0 Pa
  speed_limit_default: 1000.0 km/h
  speed_of_sound_ref: 1200 km/h
  vacuum_level_range: 100-1000 Pa
  vacuum_level_tolerance: 10 Pa
  velocity_tolerance: 10 km/h
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: '[Infrastructure] hyperloop-and-vacuum-tube-transport-physics'
  weight: 0.9
temporal:
