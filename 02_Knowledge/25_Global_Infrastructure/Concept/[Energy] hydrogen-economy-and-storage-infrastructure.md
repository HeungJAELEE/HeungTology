...
metadata:
  ...
  id: '[[[25_Infrastructure] [Energy] hydrogen-economy-and-storage-infrastructure]]'
...
object:
  ...
  tier: 1
properties:
  boil_off_rate_limit: 0.1 %/day
  carrier_density_target: 100 kg-H2/m3
  compression_work_limit: 3 kWh/kg
  dehydrogenation_temp_threshold: 400 C
  fueling_throughput_target: 100 kg/hour
  leakage_detection_sensitivity: 1%
  liquefaction_temp_threshold: 20 K
  round_trip_efficiency_target: 40%
  scc_pressure_threshold: 200 bar
  storage_density_threshold: 5.5 wt%
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: '[Energy] hydrogen-economy-and-storage-infrastructure'
  weight: 0.9
temporal:
