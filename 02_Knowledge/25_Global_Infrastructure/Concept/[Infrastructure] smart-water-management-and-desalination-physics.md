...
lineage:
  ...
  original_hash: dc0da037403aa1f2520cc72ca9abbc7df97e9cf4c2f5bf2188df016dd32b150a
metadata:
  ai_modified_date: '2026-05-24'
  ai_status: pending_review
  date: '2026-05-16'
  domain: 25_Infrastructure
  id: '[[[25_Infrastructure] [Infrastructure] smart-water-management-and-desalination-physics]]'
  last_updated: '2026-05-24T00:28:00+09:00'
  project: Antigravity_SDF_Core
  revision: r4
  version: v7.9_Enterprise_Node
object:
  description: '[Infrastructure] smart-water-management-and-desalination-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  backwashing_decision_latency_seconds: 0.5
  efficiency_log_endpoint: infrastructure-smart-water-and-desalination-efficiency-log-v2026
  energy_consumption_max_kwh_m3: 3.0
  leak_accuracy_min_percent: 95
  membrane_flux_min_lmh: 20
  recovery_rate_min_percent: 45
  rejection_rate_min_percent: 99.8
  salinity_increase_threshold_percent: 10
  uptime_min_percent: 99.9
  water_purity_max_tds_ppm: 500
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 25_Infrastructure]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: domain_knowledge_specification
  object: Concept
  predicate: contains_knowledge_of
  subject: '[Infrastructure] smart-water-management-and-desalination-physics'
  weight: 0.95
temporal:
