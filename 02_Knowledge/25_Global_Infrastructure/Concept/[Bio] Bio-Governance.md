...
object:
  ...
  tier: 1
properties:
  ai_requirement: explainable_ai_xai
  compliance_version: HIPAA_v2026
  data_security_protocol: end_to_end_encryption_e2ee
  genetic_editing_boundary: somatic_allowed_germline_restricted
  governance_bodies: IRB, FDA, EMA
  phi_handling: strict_de_identification
