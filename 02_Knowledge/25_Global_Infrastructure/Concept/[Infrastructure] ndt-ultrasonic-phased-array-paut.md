...
lineage:
  ...
  original_hash: 60b86aa97ea466d61f070e3b70105734b44130bb7d217e7eb5b8c40c1c868995
metadata:
  ai_modified_date: '2026-05-24'
  ai_status: pending_review
  date: '2026-05-16'
  domain: 25_Infrastructure
  id: '[[[25_Infrastructure] [Infrastructure] ndt-ultrasonic-phased-array-paut]]'
  last_updated: '2026-05-24T00:28:00+09:00'
  project: Antigravity_SDF_Core
  revision: r4
  version: v7.9_Enterprise_Node
object:
  description: '[Infrastructure] ndt-ultrasonic-phased-array-paut에 관한 고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  beam_steering_angle_threshold: ±70°
  defect_sizing_error_threshold: < 10%
  element_pitch_limit: lambda/2
  image_resolution_threshold: < 0.5 mm
  pod_threshold: '> 95%'
  position_error_threshold: < 0.1 mm
  snr_threshold: '> 30 dB'
  step_resolution_interval: 0.1 mm
  waveform_sync_delay_error_limit: 10ns
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: '[Infrastructure] ndt-ultrasonic-phased-array-paut'
  weight: 0.9
temporal:
...
| **Step Resolution** | 엔코더(Encoder)를 사용하여 **스캔 간격**을 $0.1\ \text{mm}$ 단위로 물리적 동기화 | **Spatial Sampling**: 스캔 간격이 너무 넓으면 미세한 균열(Crack) 사이로 빔이 지나가 탐지에 실패할 수 있음. | **POD > 95%** |
