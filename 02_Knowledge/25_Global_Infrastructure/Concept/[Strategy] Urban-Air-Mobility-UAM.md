...
metadata:
  ...
  id: '[[[25_Infrastructure] [Strategy] Urban-Air-Mobility-UAM]]'
...
object:
  ...
  tier: 1
properties:
  disk_loading_range: 30-100 kg/m^2
  energy_density_min: 250-350 Wh/kg
  noise_level_threshold: < 65 dB
  payload_capacity: 400-600 kg
  peak_power_c_rate: 10C-15C
  rtx_4060_inference_latency: < 10 ms
  uatm_latency_threshold: < 50 ms
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: '[Strategy] Urban-Air-Mobility-UAM'
  weight: 1.0
temporal:
