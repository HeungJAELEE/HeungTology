...
lineage:
  ...
  original_hash: 69ead76ce2abce6cd8cbcf88e48cf184feea4e3121554b1cfc4566f3229055b2
metadata:
  ai_modified_date: '2026-05-24'
  ai_status: pending_review
  date: '2026-05-16'
  domain: 25_Infrastructure
  id: '[[[25_Infrastructure] [Infrastructure] infra-mfc-mass-flow-controller]]'
...
properties:
  accuracy: ±0.5% S.P.
  control_range_turndown: '100:1'
  linearity: ±0.2% F.S.
  pid_control_interval: 1ms
  repeatability: ±0.1% F.S.
  response_time_t90: < 0.5 sec
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 25_Infrastructure]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: theoretical_basis
  object: Concept
  predicate: contains_knowledge_of
  subject: '[Infrastructure] infra-mfc-mass-flow-controller'
  weight: 0.9
temporal:
