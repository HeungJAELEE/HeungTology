...
lineage:
  ...
  original_hash: 38738566f530b2ff87c1e85b682a9ad4231bf11994377eea3a0693de57232ff6
metadata:
  ai_modified_date: '2026-05-24'
  ai_status: pending_review
  date: '2026-05-16'
  domain: 25_Infrastructure
  id: '[[[25_Infrastructure] [Infrastructure] plastic-injection-molding-engineering]]'
  last_updated: '2026-05-24T00:28:00+09:00'
  project: Antigravity_SDF_Core
  revision: r4
  version: v7.9_Enterprise_Node
object:
  description: '[Infrastructure] plastic-injection-molding-engineering에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  clamping_force_ton_range: 10-3000
  cooling_time_ratio_pct_high_speed: 40
  hds_gold_ref_energy: 1450.5
  hds_gold_tolerance_threshold: 0.03
  injection_pressure_mpa_general: 80-150
  injection_pressure_mpa_high_speed: 150-200
  injection_pressure_mpa_ultra_precision: '>=250'
  max_cuda_sync_latency_ms: 5
  mold_temp_control_c_ultra_precision: 0.1
  navier_stokes_governance: fluid_dynamics
  rtx_4060_cuda_acceleration: true
  sensor_sampling_rate_hz: 1000
  spec_version: V6.3.7
  spencer_gilmore_pvt_governance: thermal_shrinkage
  target_wall_thickness_mm_range: 0.1-4.0
  tolerance_mm_ultra_precision: 0.005
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: '[Infrastructure] plastic-injection-molding-engineering'
  weight: 0.95
temporal:
