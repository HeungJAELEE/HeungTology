...
lineage:
  ...
  original_hash: 5329ac486341b76aa1ee9352f0fbf5f22a143451d0a36970b75b1fcbe484524a
metadata:
  ai_modified_date: '2026-05-24'
  ai_status: pending_review
  date: '2026-05-16'
  domain: 25_Infrastructure
  id: '[[[25_Infrastructure] [Infrastructure] li-ion-standard-evolution]]'
...
object:
  ...
  tier: 1
properties:
  altitude_test_p_kpa: 11.6
  crush_force_kn: 100
  digital_twin_prediction_accuracy: 0.95
  max_heat_release_rate_kw_m2: 100
  overcharge_v_multiplier: 1.2-1.5
  separator_shutdown_temp_c: 130-140
  thermal_cycle_temp_range_c: -40 to 72
  thermal_runaway_propagation_threshold_c_s: 10
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 25_Infrastructure]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: knowledge_structuring
  object: Concept
  predicate: contains_knowledge_of
  subject: '[Infrastructure] li-ion-standard-evolution'
  weight: 0.9
temporal:
