...
lineage:
  ...
  original_hash: 4176104234cc9bd863984972ebb219fb013ac82ddc1dbfbed4dd65774c290139
metadata:
  ai_modified_date: '2026-05-24'
  ai_status: pending_review
  date: '2026-05-16'
  domain: 25_Infrastructure
  id: '[[[25_Infrastructure] [Infrastructure] inspection-ndt-physics]]'
...
object:
  ...
  tier: 1
properties:
  adr_recall_target: 0.999
  burr_height_limit_um: 10
  hardware_acceleration_unit: RTX 4060
  lambert_beer_law: I = I0 * e^(-mu * x)
  overhang_target_mm: 0.5-2.5
  particle_size_limit_um: 15
  poisson_yield_model: Y = e^(-A * D0 * Omega)
  realtime_scan_rate_fps: 120
  xray_penetration_min_kev: 100
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 25_Infrastructure]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: knowledge_encapsulation
  object: Concept
  predicate: contains_knowledge_of
  subject: '[Infrastructure] inspection-ndt-physics'
  weight: 0.95
temporal:
