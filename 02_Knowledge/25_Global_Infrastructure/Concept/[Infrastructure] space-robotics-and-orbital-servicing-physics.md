...
metadata:
  ...
  id: '[[[25_Infrastructure] [Infrastructure] space-robotics-and-orbital-servicing-physics]]'
  last_updated: '2026-05-24T00:28:00+09:00'
  project: Antigravity_SDF_Core
  revision: r4
  version: v7.9_Enterprise_Node
object:
  description: '[Infrastructure] space-robotics-and-orbital-servicing-physics에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  angular_momentum_error_threshold_nms: 0.001
  arm_positional_accuracy_threshold_mm: 5.0
  docking_safety_velocity_limit_m_s: 0.05
  reaction_wheel_torque_range_nm: 0.1 - 2.0
  relative_docking_velocity_threshold_m_s: 0.03
  robot_arm_data_log_endpoint: robot-arm-joint-torque-and-position-error-log-v2026
  telerobotics_latency_limit_ms_leo: 500
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 25_Infrastructure]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: taxonomy_classification
  object: Concept
  predicate: contains_knowledge_of
  subject: '[Infrastructure] space-robotics-and-orbital-servicing-physics'
  weight: 0.9
temporal:
