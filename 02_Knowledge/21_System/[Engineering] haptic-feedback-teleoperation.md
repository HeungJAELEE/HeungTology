...
metadata:
  ...
  date: '2026-05-16'
  domain: 00_System
  id: '[[[00_System] [Engineering] haptic-feedback-teleoperation]]'
...
object:
  ...
  tier: 1
properties:
  control_logic: PD (Proportional-Derivative)
  lunar_earth_latency: ~ 2.6 s
  max_allowable_latency: < 100 ms
  system_passivity_mechanism: Wave Variable Transformation
  transparency_verified: 0.90 - 0.95
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: '[Engineering] haptic-feedback-teleoperation'
  weight: 1.0
temporal:
...
| :--- | :--- | :--- | :--- |
| **Transparency** | 1.0 [데이터 부재] | 0.90 - 0.95 [데이터 부재] | [데이터 부재] |
| **Max Allowable Latency** | 0 ms [데이터 부재] | < 100 ms [데이터 부재] | [데이터 부재] |
| **Lunar-Earth Latency** | N/A | ~ 2.6 s [데이터 부재] | [데이터 부재] |
| **Feedback Resolution** | $\infty$ | Discrete [데이터 부재] | [데이터 부재] |
...
- **Latency Instability**: System oscillation occurs when communication delay exceeds 100 ms [데이터 부재].
- **Lunar Teleoperation Constraint**: Requirement for predictive visual/haptic modeling due to ~ 2.6 s [데이터 부재] delay.
