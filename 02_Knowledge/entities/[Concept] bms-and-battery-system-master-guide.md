...
semantic:
  expected_queries:
    - "Concept bms-and-battery-system-master-guide 엔티티의 위상적 연결 고리는? [[Concept bms-and-battery-system-master-guide]]"
...
# [Entity] Concept bms-and-battery-system-master-guide (V7.6.2)

## 1. [개요: 위상적 브릿지 (Topological Bridge)]
본 엔티티 노드는 `[Battery] battery-management-system-bms-master-guide.md` 마스터 허브에서 인용되었으나 물리적 파일이 결손되어 있던 링크를 복구하기 위해 **Topology Auto-Healer V7.6.2**에 의해 자동 생성된 지식 앵커(Anchor)입니다. 시스템의 위상적 무결성을 사수하기 위해 구조적으로 생성되었습니다.
