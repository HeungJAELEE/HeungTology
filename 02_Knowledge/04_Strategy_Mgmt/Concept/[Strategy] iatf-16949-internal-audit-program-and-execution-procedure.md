...
object:
  description: '[Strategy] iatf-16949-internal-audit-program-and-execution-procedure에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  audit_cycle_years: 3
  iatf_clause_effectiveness: 9.2.2.3
  iatf_clause_reference: 9.2.2
  required_coverage_pct: 100
  vda_6_3_standard: VDA 6.3
semantic:
  alternative_parents: []
