...
object:
  ...
  tier: 1
properties:
  doc_lead_time_threshold_hours: 24.0
  doc_lead_time_tolerance_hours: 2.0
  hs_code_accuracy_threshold: 0.99
  hs_code_accuracy_tolerance: 0.005
  landed_cost_formula: P_Landed = P_Ex-Works + C_Logistics + C_Insurance + C_Duty
    + C_VAT
  min_insurance_coverage_ratio: 1.1
  risk_transfer_sync_threshold_hours: 1.0
  risk_transfer_sync_tolerance_minutes: 5.0
  sanction_hit_rate_threshold: 0.0
semantic:
  alternative_parents: []
