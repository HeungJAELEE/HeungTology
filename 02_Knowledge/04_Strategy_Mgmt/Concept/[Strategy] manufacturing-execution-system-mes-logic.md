...
lineage:
  ...
  original_hash: af2b814e5289d439c69b3c6c6ecc6845c161357fc8c44794dacf43041d198f62
metadata:
  date: '2026-05-16'
...
object:
  ...
  tier: 1
properties:
  data_latency_target_ms: 50.0
  data_latency_tolerance_ms: 5.0
  data_latency_verified_ms: 38.5
  external_db_endpoint: manufacturing-mes-logic-and-oee-log-v2026
  interoperability_target_percent: 100.0
  interoperability_tolerance_percent: 0.0
  littles_law_formula: L = lambda * W
  oee_target_percent: 85.0
  oee_tolerance_percent: 1.5
  oee_verified_percent: 88.2
  scheduling_accuracy_target_percent: 95.0
  scheduling_accuracy_tolerance_percent: 1.0
  scheduling_accuracy_verified_percent: 97.4
  traceability_time_target_seconds: 10.0
  traceability_time_tolerance_seconds: 1.0
  traceability_time_verified_seconds: 4.5
  wip_stability_target_variance_percent: 5.0
  wip_stability_tolerance_percent: 0.5
  wip_stability_verified_variance_percent: 3.2
semantic:
  alternative_parents: []
