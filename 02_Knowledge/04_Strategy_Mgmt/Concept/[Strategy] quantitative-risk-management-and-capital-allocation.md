...
lineage:
  ...
  original_hash: 9175beb33ea0aaf34a93e8a4a5869c9fbbd9645bbc5a0922fe925eafca1ac800
metadata:
  date: '2026-05-16'
...
object:
  description: '[Strategy] quantitative-risk-management-and-capital-allocation에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  capital_erosion_probability_limit: 0.0002
  de_ratio_verified: 0.82
  expected_shortfall_verified_pct: 7.8
  external_log_ref: enterprise-risk-capital-allocation-log-v2026
  lcr_verified_pct: 134.5
  raroc_verified_pct: 16.8
  stress_test_loss_verified_pct_capital: 12.4
  var_99_10d_verified_pct_capital: 4.25
  wacc_verified_pct: 8.24
semantic:
  alternative_parents: []
