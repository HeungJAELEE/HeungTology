...
object:
  ...
  tier: 1
properties:
  blind_audition_rate: 1.0
  inclusion_index_target: 85.0
  inclusion_index_tolerance: 2.0
  innovation_potential_model: sum(skill_set * cognitive_perspective) * engagement_factor
  pay_gap_limit: 0.01
  representation_ratio_tolerance: 0.05
  voluntary_turnover_tolerance: 0.02
semantic:
  alternative_parents: []
