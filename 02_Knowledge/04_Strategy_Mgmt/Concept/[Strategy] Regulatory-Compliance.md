...
object:
  ...
  tier: 1
properties:
  compliance_risk_formula: sum(probability_i * impact_i * (1 / control_effectiveness_i))
  fidelity_engine_tolerance: zero_tolerance
  filing_accuracy_target: 1.0
  gdpr_ccpa_gap_target: 0
  license_match_rate_target: 1.0
  transaction_audit_coverage_target: 1.0
  version: v6.3.7
semantic:
  alternative_parents: []
