...
lineage:
  ...
  original_hash: c4b6ee9c926712d1b6bafa1519358623d3fa92d4ef35c087f05a17efe57505c8
metadata:
  date: '2026-05-16'
...
object:
  ...
  tier: 1
properties:
  attractiveness_target_default: 7.0
  blue_ocean_min_utility_multiplier: 2.0
  blue_ocean_utility_tolerance: 0.1
  five_forces_alpha_index_tolerance: 0.05
  industry_attractiveness_formula: sum(weight_i * force_score_i) / rivalry_density
  intelligence_min_signal_accuracy: 0.85
  intelligence_signal_accuracy_tolerance: 0.02
  market_fidelity_engine_version: V6.3.7
  pestel_fidelity_tolerance: 0.1
  pestel_risk_scale_range: 1-10
  signal_accuracy_default: 85.0
  swot_linkage_gap_tolerance: 0.0
  swot_min_linkage_threshold: 0.9
semantic:
  alternative_parents: []
