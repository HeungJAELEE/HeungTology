...
lineage:
  ...
  original_hash: e9e1025f5461204d5f55b27b466ffd6a6aaef349e3a73784d694fafcd1525d83
metadata:
  date: '2026-05-16'
...
object:
  description: '[Strategy] industrial-ai-and-predictive-maintenance-master-guide에
    관한 고밀도 지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  acoustic_emission_tolerance_percent: 1.0
  harmonic_distortion_fidelity_tolerance_percent: 0.1
  harmonic_distortion_limit_percent: 3.0
  high_end_false_alarm_rate_threshold: 0.001
  high_end_rul_accuracy_threshold: 0.95
  lead_time_min_days: 14
  standard_rul_accuracy_range:
  - 0.85
  - 0.95
  thermal_delta_limit_k: 5.0
  thermal_fidelity_tolerance_k: 0.1
  v6_3_7_uptime_target: 0.9999
  vibration_fidelity_tolerance_mm_s: 0.01
  vibration_rms_limit_mm_s: 2.8
semantic:
  alternative_parents: []
