...
lineage:
  ...
  original_hash: 6f0699a9adf85508a8ebf550965d6abfd468b39f501e4d6a417f637cd00867b1
metadata:
  date: '2026-05-16'
...
object:
  description: '[Strategy] Circular-Logistics-and-Reverse-Supply-Chain에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  carbon_savings_target_percent: 25.0
  disposition_latency_target_hours: 24
  epr_compliance_target_percent: 100.0
  recovery_value_target_percent: 40.0
  repair_margin: 0.2
  return_rate_target_percent: 10.0
  value_threshold: 0.4
semantic:
  alternative_parents: []
