...
lineage:
  ...
  original_hash: 9f6c43101fa16256f1fda7593dac31bae83c829f4677f83bb402dffc7dd34899
metadata:
  date: '2026-05-16'
  domain: 04_Strategy_Mgmt
  id: '[[[Strategy] crm-customer-relationship-management]]'
  last_updated: '2026-05-17T22:59:20+09:00'
  project: Vault_Modernization
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: '[Strategy] crm-customer-relationship-management에 관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  churn_rate_target: 0.03
  churn_rate_tolerance: 0.001
  clv_equation: sum_{t=1}^{n} (Profit_t - Cost_t) / (1 + i)^t
  conversion_target: 0.15
  conversion_tolerance: 0.005
  nps_target: 60
  nps_tolerance: 2
  retention_rate_target: 0.9
  retention_rate_tolerance: 0.005
  rfm_score_equation: w_R * R + w_F * F + w_M * M
  sentiment_volatility_threshold: 0.2
  voc_resolution_target_hours: 24.0
  voc_resolution_tolerance_hours: 1.0
semantic:
  alternative_parents: []
...
# [Strategy] crm-customer-relationship-management
