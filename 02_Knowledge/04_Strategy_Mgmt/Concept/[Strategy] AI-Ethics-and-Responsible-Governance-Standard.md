...
object:
  description: '[Strategy] AI-Ethics-and-Responsible-Governance-Standard에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  bias_auditor_difference_threshold: 0.2
  compliance_audit_readiness_target: 1.0
  demographic_parity_target_ratio: 0.8
  drift_limit_error_increase: 0.05
  fairness_threshold_ratio: 0.8
  human_intervention_rate_threshold: 0.1
  xai_integrity_coverage_target: 1.0
semantic:
  alternative_parents: []
