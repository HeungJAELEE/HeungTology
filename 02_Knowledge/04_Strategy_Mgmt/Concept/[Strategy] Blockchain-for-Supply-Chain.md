...
object:
  ...
  tier: 1
properties:
  consensus_latency_max_sec: 2
  consensus_latency_tier1_tolerance_sec: 0.1
  data_immutability_target: 1.0
  oracle_conf_code_param: 0.999
  oracle_reliability_min: 0.9999
  oracle_reliability_tier1_tolerance: 0.0001
  smart_contract_audit_success_rate: 1.0
  tps_math_model: Block_Size / (Block_Interval * sum(Node_Latency + Consensus_Overhead))
  tps_min_code_param: 2000
  transaction_tps_min: 2000
  transaction_tps_tier1_tolerance: 100
semantic:
  alternative_parents: []
