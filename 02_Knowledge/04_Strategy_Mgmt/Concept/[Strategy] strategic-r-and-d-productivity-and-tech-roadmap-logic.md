...
object:
  description: '[Strategy] strategic-r-and-d-productivity-and-tech-roadmap-logic에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  horizon_allocation_ratio: 70/20/10
  innovation_premium_min: 20%
  patent_yield_min: 5 per 10M spend
  productivity_critical_threshold: '1.0'
  productivity_warning_threshold: '3.0'
  rd_intensity_tier1: 5-15%
  time_to_market_max: 24 months
  trl_launch_min: '7'
semantic:
  alternative_parents: []
