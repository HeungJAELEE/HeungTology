...
lineage:
  ...
  original_hash: 84a8de658aaaf8931dcaa8f5e03b87eed804eab383d26104cc1f116805c33871
metadata:
  date: '2026-05-16'
...
object:
  description: '[Strategy] advanced-process-control-apc-and-virtual-metrology-vm에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  ewma_lambda_range: 0.1 ~ 0.3
  prediction_error_rmse_threshold: < 1% of target
  sampling_ratio_threshold: < 10%
  sensor_log_endpoint: manufacturing-utility-log-v2026
  vm_prediction_r2_threshold: '> 0.9'
semantic:
  alternative_parents: []
