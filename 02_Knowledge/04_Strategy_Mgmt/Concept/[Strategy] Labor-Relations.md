...
object:
  ...
  tier: 1
properties:
  conflict_signal_source: communication_logs
  engagement_index_source: feedback_surveys
  min_score: fairness_rating_minimum
  system_status: v6.3.7_hds_gold_mandate_activated
  threshold: conflict_negativity_threshold
semantic:
  alternative_parents: []
