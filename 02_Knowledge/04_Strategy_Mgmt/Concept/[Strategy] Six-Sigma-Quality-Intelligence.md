...
lineage:
  ...
  original_hash: 1541c35fee2eeb6cf3fdb958fa02cd960958291ab06fb8e26b1ffd7ba8459aaa
metadata:
  date: '2026-05-16'
...
object:
  ...
  tier: 1
properties:
  cp_formula: (USL - LSL) / (6 * sigma)
  cpk_bottleneck_threshold: 1.33
  cpk_formula: min((USL - mu) / (3 * sigma), (mu - LSL) / (3 * sigma))
  dmaic_max_duration_days: 90
  msa_gauge_rr_max_threshold: 0.1
  project_roi_target_min: 5.0
  six_sigma_target_dpmo: 3.4
  taguchi_loss_function: L(y) = k(y-m)^2
  tier_0_yield_min: 0.9999966
  tier_0_z_score_min: 6.0
  tier_1_z_score_range: 4.5-6.0
  tier_2_z_score_range: 3.0-4.5
  z_score_formula: (USL - mu) / sigma
semantic:
  alternative_parents: []
