...
object:
  ...
  tier: 1
properties:
  iso_25785_1: humanoid_robot_safety_standard
  iso_ts_15066: body_part_pressure_and_force_limits
  pfl_logic: power_and_force_limiting
  safe_buffer: 0.5
  ssm_logic: speed_and_separation_monitoring
  stop_distance_calculation: robot_reaction_time * velocity + braking_distance
semantic:
  alternative_parents: []
