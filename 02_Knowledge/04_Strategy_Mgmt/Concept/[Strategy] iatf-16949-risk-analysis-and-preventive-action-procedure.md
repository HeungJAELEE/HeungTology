...
object:
  description: '[Strategy] iatf-16949-risk-analysis-and-preventive-action-procedure에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  action_effectiveness_threshold: 80
  risk_coverage_threshold: 95
  risk_matrix_formula: severity * probability
semantic:
  alternative_parents: []
