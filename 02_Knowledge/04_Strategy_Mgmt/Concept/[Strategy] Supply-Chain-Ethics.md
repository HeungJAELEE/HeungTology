...
properties:
  ...
  procurement_flow_endpoint: procurement_flow
  risk_intelligence_endpoint: risk_intelligence
  supplier_db_endpoint: supplier_db
  world_risk_map_endpoint: world_risk_map
semantic:
  alternative_parents: []
