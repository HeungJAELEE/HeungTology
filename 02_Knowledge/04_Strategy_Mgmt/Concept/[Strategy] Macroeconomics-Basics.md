...
lineage:
  ...
  original_hash: 9da321cc0f949ccbd5561fb42deae64bbf9a25cb264dc3a01fc82d731d4c70b6
metadata:
  date: '2026-05-16'
...
object:
  ...
  tier: 1
properties:
  engine_version: V6.3.7
  fx_volatility_target_max_pct: 10.0
  fx_volatility_tolerance_pct: 1.0
  gdp_growth_target_min_pct: 2.0
  gdp_growth_tolerance_pct: 0.2
  inflation_target_pct: 2.0
  inflation_tolerance_pct: 0.1
  investment_score_formula: (gdp_growth * pmi) / (real_interest_rate + fx_volatility)
  max_real_rate_limit: 5.0
  pmi_expansion_threshold: 50.0
  pmi_tolerance_units: 0.5
  real_rate_stable_threshold: 0.0
  real_rate_tolerance_pct: 0.1
semantic:
  alternative_parents: []
