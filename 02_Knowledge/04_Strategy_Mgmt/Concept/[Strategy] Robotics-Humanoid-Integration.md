...
object:
  ...
  tier: 1
properties:
  actuator_specification: high_torque_density
  ai_architecture: vision_language_action
  learning_logic: sim_to_real
  operating_system: ros
  safety_mechanism: collaborative_safety
semantic:
  alternative_parents: []
