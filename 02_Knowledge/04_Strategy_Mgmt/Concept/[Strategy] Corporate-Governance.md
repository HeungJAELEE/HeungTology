...
object:
  ...
  tier: 1
properties:
  esg_linked_pay_target_pct_of_sti: 30.0
  governance_health_formula: alpha * Independence + beta * Diversity + gamma * Transparency
  hds_gold_version: V6.3.7
  outside_director_ratio_target_pct: 60.0
  outside_director_ratio_tolerance_pct: 1.0
  reporting_timeliness_max_hours: 24
  shareholder_participation_target_pct: 80.0
  shareholder_participation_tolerance_pct: 2.0
  skill_matrix_coverage_target_pct: 100.0
semantic:
  alternative_parents: []
