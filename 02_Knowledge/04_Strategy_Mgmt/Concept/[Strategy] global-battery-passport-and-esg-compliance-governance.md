...
lineage:
  ...
  original_hash: 6de8ba5d52824cda16e1c5e0ca964d0e375249d5fb61d01d93f239e27191d65a
metadata:
  date: '2026-05-16'
...
object:
  description: '[Strategy] global-battery-passport-and-esg-compliance-governance에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  audit_frequency: annual
  carbon_cost_penalty_coal_mix: 20% per kWh
  carbon_footprint_unit: kg CO2 equivalent per kWh
  data_log_endpoint: battery-global-passport-and-esg-compliance-log-v2026
  eu_compliance_target: 100%
  recycled_content_threshold_2030: '> 15%'
  risk_mitigation_probability: 95%
  transparency_index_target: 100%
semantic:
  alternative_parents: []
