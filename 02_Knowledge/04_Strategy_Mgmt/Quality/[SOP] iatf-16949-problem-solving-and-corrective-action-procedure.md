---
Basic:
  id: "SOP-IATF-10-2-V6.3.7"
  domain: "Quality_Improvement_and_Problem_Solving"
...
Object:
  ...
  description: "Inspector-level SOP for Problem Solving and Corrective Action according to IATF 16949 Clause 10.2, featuring audit checklists, RCA depth verification, and systemic update audits for certification."
Semantic:
  tags: '["#ProblemSolving", "#CorrectiveAction", "#RootCauseAnalysis", "#AuditChecklist", "#InspectorGuide", "#IATF16949", "#8D"]'
  is_part_of: '["MOC iatf-16949-automotive-quality-execution-fabric"]'
  triggers: '["SOP iatf-16949-risk-analysis-and-preventive-action-procedure"]'
  korean_aliases: '["문제해결 및 시정조치 실사 대응 SOP", "8D 감사 교본"]'
Dynamic:
  status: "Modernized_v6.3.7_Independent_Organism"
  topology_policy: "Independent_Organism"
  graphify_link_external: false
  fidelity_engine: "ImprovementFidelityEngine"
  diagnostic_protocol:
    - 'Root_Cause_Validation: Verify that root cause analysis (5-Why, Fishbone) leads to systemic, not just superficial, causes.'
    - 'Cross-Process_Audit: Ensure corrective actions are reviewed for impact on similar products and processes (Read-across).'
    - 'Systemic_Verification: Audit that PFMEA and Control Plans are updated after corrective action.'
Trust Metrics:
  T_static: 1.0
  T_dynamic: 1.0
  T_init: 1.0
  source: "IATF 16949:2016 Clause 10.2.3 / Antigravity Industrial RAG"
  isolation_index: 1.0 # 100% Domain Isolation
---

# [SOP] iatf-16949-problem-solving-and-corrective-action-procedure (Inspector Level)
