---
Basic:
  id: "SOP-IATF-9-2-2-V6.3.7"
  domain: "Quality_Audit_and_Compliance"
...
Object:
  ...
  description: "Inspector-level SOP for Internal Audit Program and Execution (IATF 16949:2016 Clause 9.2.2), focusing on the 3-year audit cycle, risk-based prioritization, and the objectivity of the audit process."
Semantic:
  tags: '["#InternalAudit", "#AuditProgram", "#QMSAudit", "#ProcessAudit", "#ProductAudit", "#IATF16949", "#InspectorGuide"]'
  is_part_of: '["MOC iatf-16949-automotive-quality-execution-fabric"]'
  korean_aliases: '["내부 심사 프로그램 및 실행 절차", "3개년 심사 계획"]'
Dynamic:
  status: "Modernized_v6.3.7_Independent_Organism"
  topology_policy: "Independent_Organism"
  graphify_link_external: false
  fidelity_engine: "AuditCycleFidelityEngine"
  diagnostic_protocol:
    - 'Audit_Coverage_Check: Ensure 100% coverage of QMS and manufacturing processes over the 3-year cycle.'
    - 'Shift_Sampling_Audit: Verify that all shifts (including night shifts) are sampled during process audits.'
    - 'Independence_Verification: Audit that auditors do not audit their own work.'
Trust Metrics:
  T_static: 1.0
  T_dynamic: 1.0
  T_init: 1.0
  source: "IATF 16949:2016 Clause 9.2.2 / Antigravity Industrial RAG"
  isolation_index: 1.0 # 100% Domain Isolation
---

# [SOP] iatf-16949-internal-audit-program-and-execution-procedure (Inspector Level)
