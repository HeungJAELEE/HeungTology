...
Object:
  ...
  description: "Inspector-level SOP for Control of Nonconforming Outputs according to IATF 16949 Clause 8.7, featuring audit checklists, physical segregation audits, and rework verification protocols for certification audits."
Semantic:
  tags: '["#NonconformingOutputs", "#Containment", "#Rework", "#AuditChecklist", "#InspectorGuide", "#IATF16949"]'
  is_part_of: '["MOC iatf-16949-automotive-quality-execution-fabric"]'
  triggers: '["SOP iatf-16949-problem-solving-and-corrective-action-procedure"]'
  korean_aliases: '["부적합품 관리 실사 대응 SOP", "부적합 처리 감사 교본"]'
Dynamic:
  status: "Modernized_v6.3.7_Independent_Organism"
  topology_policy: "Independent_Organism"
  graphify_link_external: false
  fidelity_engine: "NonconformanceFidelityEngine"
  diagnostic_protocol:
    - 'Containment_Verification: Audit that nonconforming products are segregated and identified to prevent unintended use.'
    - 'Rework_Integrity_Check: Ensure reworked products are re-inspected against the original control plan/standard.'
    - 'Suspect_Product_Audit: Verify that unidentified or suspect product is treated as nonconforming.'
Trust Metrics:
  T_static: 1.0
  T_dynamic: 1.0
  T_init: 1.0
  source: "IATF 16949:2016 Clause 8.7 / Antigravity Industrial RAG"
  isolation_index: 1.0 # 100% Domain Isolation
---

# [SOP] iatf-16949-control-of-nonconforming-outputs-procedure (Inspector Level)
