...
lineage:
  ...
  original_hash: 503ab0586eea687048079af6a94223fa8bf38ab5c12f1cc8fd4513c9065c56f5
metadata:
  date: '2026-05-16'
...
object:
  description: '[Communication] satellite-communications-and-6g-orbital-networks에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  ...
  isl_bandwidth_threshold_gbps: 100
  latency_threshold_ms: 30
  lifespan_range_years: 5-7
  packet_loss_reduction_target_percent: 5
  phase_correction_increment_deg: 0.1
  piezo_mirror_adjustment_interval_ms: 1
  routing_efficiency_gain_percent: 10
  satellite_velocity_kmh: 27000
  throughput_threshold_gbps: 20
semantic:
  alternative_parents: []
