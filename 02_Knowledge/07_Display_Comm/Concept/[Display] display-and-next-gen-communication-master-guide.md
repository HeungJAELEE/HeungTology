...
lineage:
  ...
  original_hash: 32ceaf9fe9ffe0f1827664038ef2185e3e2e9fe02241c3255fe91d1a0b5ce437
metadata:
  date: '2026-05-16'
  domain: 07_Display_Comm
  id: '[[[Display] display-and-next-gen-communication-master-guide]]'
  last_updated: '2026-05-17T22:59:20+09:00'
  project: Vault_Modernization
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: '[Display] display-and-next-gen-communication-master-guide에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  bit_error_rate_threshold: 1.0e-06
  oled_l70_lifetime_target_hrs: 50000
  oled_lifetime_tolerance_hrs: 500
  pixel_density_target_ppi: 1000
  qkd_key_rate_target_mbps: 10
  qkd_key_rate_tolerance_mbps: 0.5
  six_g_latency_target_us: 100
  six_g_latency_tolerance_us: 10
  tft_mobility_target_cm2_vs: 50
  tft_mobility_tolerance: 2.0
  wvtr_limit_g_m2_day: 1.0e-06
semantic:
  alternative_parents: []
...
| **6G Latency** | End-to-End | $< 100 \text{ }\mu\text{ s}$ | $\pm 10 \text{ }\mu\text{ s}$ |
