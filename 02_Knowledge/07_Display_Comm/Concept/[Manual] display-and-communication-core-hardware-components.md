...
object:
  ...
  tier: 1
properties:
  aip_signal_loss_max_db: 2
  alignment_fidelity_risk_threshold: 0.9
  evaporation_source_temp_stability_c: 0.1
  fmm_alignment_error_threshold_um: 5
  fmm_pixel_pitch_max_um: 20
  rf_efficiency_risk_threshold: 0.85
  tfe_wvtr_max_g_m2_day: 1.0e-06
  vcsel_min_speed_gbps: 25
semantic:
  alternative_parents: []
