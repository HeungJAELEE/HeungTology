...
object:
  description: '[Display] tft-backplane-manufacturing-and-thin-film-physics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  laser_energy_variation_max: 0.01
  ltps_grain_size_min_nm: 500.0
  ltps_mobility_min_cm2_vs: 100.0
  oxide_leakage_current_max_a: 1.0e-14
  stability_vth_delta_max_v: 0.5
  vth_uniformity_max_v: 0.2
semantic:
  alternative_parents: []
