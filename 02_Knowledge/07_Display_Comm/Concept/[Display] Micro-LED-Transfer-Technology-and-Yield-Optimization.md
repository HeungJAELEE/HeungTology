...
object:
  description: '[Display] Micro-LED-Transfer-Technology-and-Yield-Optimization에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  align_precision_um: 1.45
  avg_panel_repair_time_min: 35
  bump_contact_resistance_mohm: 145
  chip_size_um: 25
  external_log_endpoint: display-micro-led-transfer-yield-and-pixel-integrity-log-v2026
  fluidic_flow_speed_limit_m_s: 0.5
  laser_energy_density_defect_threshold_j_cm2: 1.2
  laser_energy_density_fail_threshold_j_cm2: 0.8
  laser_energy_density_optimal_j_cm2: 1.0
  multi_laser_time_reduction_percent: 60
  repair_time_per_pixel_sec: 0.82
  substrate_inclination_optimal_deg: 15
  transfer_yield_percent: 99.992
  uph_chips_hr: 8200000
semantic:
  alternative_parents: []
