...
lineage:
  ...
  original_hash: 50cf2eaa4fba62282f38e188aa6945200126684f36debc1c40dffdbbdca3f304
metadata:
  date: '2026-05-16'
...
object:
  description: '[Display] liquid-crystal-physics-and-alignment-mechanisms에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  birefringence_delta_n: 0.08 ~ 0.15
  clearing_point_c: '> 80'
  elastic_constant_k: 1.0e-11
  gray_to_gray_time_ms: < 5.0
  hds_gold_spec_version: V6.3.7
  static_contrast_ratio_ips: '> 1,000:1'
  static_contrast_ratio_va: '> 5,000:1'
  threshold_voltage_v: 1.5 ~ 2.5
  viewing_angle_deg: '> 178'
  viscosity_gamma: 0.1
semantic:
  alternative_parents: []
