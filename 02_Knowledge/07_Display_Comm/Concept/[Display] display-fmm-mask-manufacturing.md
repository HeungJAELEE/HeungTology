...
object:
  ...
  tier: 1
properties:
  aperture_ppi_adv_inch_inv: 800 ~ 1200
  aperture_ppi_conv_inch_inv: 400 ~ 550
  aperture_tolerance_delta_a_adv_um: ± 0.8
  aperture_tolerance_delta_a_conv_um: ± 1.5
  chamber_thermal_load_celsius: 80
  hole_taper_angle_theta_t_adv_deg: '> 80'
  hole_taper_angle_theta_t_conv_deg: 60 ~ 70
  mask_sagging_delta_gen6_limit_um: < 10
  mask_sagging_delta_gen8_6_spec_um: < 3
  material_cte_alpha_adv_10_6_k: < 0.5
  material_cte_alpha_conv_10_6_k: 0.8 ~ 1.2
  shadow_effect_width_formula: h * tan(theta_inc)
  thickness_h_adv_um: 10 ~ 15
  thickness_h_conv_um: 20 ~ 30
semantic:
  alternative_parents: []
