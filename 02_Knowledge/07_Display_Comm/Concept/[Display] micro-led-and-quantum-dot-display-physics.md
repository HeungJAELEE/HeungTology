...
object:
  description: 마이크로 LED의 물리적 스케일 다운에 따른 ABC 캐리어 재결합 메커니즘, LIFT 기포 폭발 유도 유효 전사 동역학
    및 퀀텀닷의 3차원 양자 가둠 효과 분광 모델 표준
  object_type: Concept
  tier: 1
properties:
  external_db_log_id: display-microled-transfer-yield-and-qd-efficiency-log-v2026
  fwhm_ideal_nm: 20.0
  fwhm_verified_nm: 22.4
  lift_accuracy_ideal_um: 1.0
  lift_accuracy_verified_um: 1.42
  lift_yield_ideal_percent: 99.9999
  lift_yield_verified_percent: 99.985
  micro_led_chip_size_ideal_um: 10.0
  micro_led_chip_size_verified_um: 8.5
  micro_led_luminance_threshold_nits: 1000000
  n2_gas_pressure_threshold_gpa: 1.0
  plqy_ideal_percent: 98.0
  plqy_tolerance_percent: 1.0
  plqy_verified_percent: 96.2
  qd_fwhm_target_nm: 22.0
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 07_Display_Comm]]'
spo_graph:
- evidence_coordinate: '[데이터 부재] Section 3.2'
  intent: physical_law_dependency
  object: Quantum_Confinement_Energy_Shift
  predicate: governed_by
  subject: Quantum_Dot_Emission
  weight: 0.95
- evidence_coordinate: '[데이터 부재] Section 7.4'
  intent: process_mechanism_driver
