...
lineage:
  ...
  original_hash: e27354a07c1bb41f612b0cbd1157897a10f6081146a0152e4107bed99ff7d1db
metadata:
  date: '2026-05-16'
...
object:
  description: '[Display] quantum-dot-qd-display-and-color-conversion-physics에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  blue_shift_per_nm_reduction: 40 nm
  cadmium_free_compliance_rohs: 100%
  color_gamut_target_dci_p3: '> 110%'
  fwhm_max_nm: < 30 nm
  optical_path_extension_factor: 2.0
  particle_diameter_range_nm: 2-10 nm
  performance_log_endpoint: display-quantum-dot-optical-performance-log-v2026
  quantum_yield_threshold: '> 90%'
  response_time_max_ns: < 100 ns
  trap_state_efficiency_loss: 15%
  trpl_measurement_precision_ns: 0.1
semantic:
  alternative_parents: []
