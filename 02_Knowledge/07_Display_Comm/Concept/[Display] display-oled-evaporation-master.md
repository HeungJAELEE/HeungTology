...
lineage:
  ...
  original_hash: 7fedfd430c1f5da4fab007349d6a15088463d1431f28f9e6a1334dea50f11f35
metadata:
  date: '2026-05-16'
...
object:
  ...
  tier: 1
properties:
  align_accuracy_threshold_um: 1.0
  deposition_rate_angstrom_per_s: 2.0-5.0
  hertz_knudsen_flux_equation: J = alpha * sqrt(M / (2 * pi * R * T)) * (P_sat(T)
    - P)
  ref_iso_1110: ISO-1110
  ref_oled_life_std: OLED-LIFE-STD
  ref_pecvd_man: PECVD-MAN
  ref_semi_m1: SEMI-M1
  shadow_length_threshold_um: 2.0
  target_l70_lifetime_hr: 30000
  tortuous_path_flux_equation: J_H2O = -D * (delta_C / (L * tau))
  vacuum_level_threshold_torr: 1.0e-08
  wvtr_threshold_g_m2_day: 1.0e-06
semantic:
  alternative_parents: []
