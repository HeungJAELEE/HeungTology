...
Semantic:
  ...
  - Write 5 expected queries for searching the provided technical document.
  - Specific and practical (professional/work-oriented).
  - End each query with a '?'.
  - One query per line, total of 5 lines.
  is_part_of: '["Semiconductor nano-intelligence-substrate-and-atomistic-design-master-guide",
    "MOC 01_Semiconductor"]'
  related_to: []
  tags: '["#Entity", "#Semiconductor", "#Etching", "#Plasma", "#Troubleshooting",
