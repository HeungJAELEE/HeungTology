...
lineage:
  ...
  original_hash: cebd47c60ef7a41075fb7fc6e95bb6f9968818584950b227f06da1659cdef5fe
metadata:
  date: '2026-05-16'
...
object:
  ...
  tier: 1
properties:
  barrier_layer_thickness_max: 2.0 nm
  blacks_equation_mtf: MTF = (A / J^n) * exp(Ea / kT)
  cu_standard_resistivity: 1.68 uOhm-cm
  em_current_density_limit: '> 10^6 A/cm^2'
  em_lifetime_mtf_verified: 10^5 hours
  low_k_dielectric_constant: < 2.2
  rc_delay_model: tau = (rho * L / A) * (epsilon * A / d)
  verified_cu_resistivity_range: 2.2-2.5 uOhm-cm
  verified_dielectric_k_range: 2.4-2.6
semantic:
  alternative_parents: []
