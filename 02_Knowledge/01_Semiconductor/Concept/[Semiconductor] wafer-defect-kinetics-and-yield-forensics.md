...
object:
  description: '[Semiconductor] wafer-defect-kinetics-and-yield-forensics에 관한 고밀도
    지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  ebi_detection_limit: 10nm
  edge_ring_defect_ratio_threshold: '0.4'
  edge_ring_radius_threshold: 140mm
  inspection_accuracy_verified: 95%
  yield_correlation_log_endpoint: wafer-defect-map-and-yield-correlation-log-v2026
semantic:
  alternative_parents: []
