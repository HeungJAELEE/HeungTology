...
lineage:
  ...
  original_hash: 55c6e0cac385f2a9543fc3f38395f056c6db33868943ca488acba2da57e7380f
metadata:
  date: '2026-05-16'
...
object:
  description: '[Semiconductor] Wafer-Manufacturing-and-Crystal-Physics에 관한 고밀도 지능
    노드'
  object_type: Hardware
  tier: 1
properties:
  cd_uniformity_drop_threshold: 8%
  edge_exclusion_verified: 1.42 mm
  external_db_endpoint: semiconductor-wafer-manufacturing-and-ingot-purity-log-v2026
  internal_gettering_metal_reduction: 30%
  lpd_ideal_limit: 20 counts/wf
  lpd_verified: 4.2 counts/wf
  oxygen_concentration_ideal: 12 ppma
  oxygen_concentration_verified: 13.5 ppma
  silicon_purity_verified: 12N
  surface_roughness_ideal: 0.1 nm
  surface_roughness_verified: 0.065 nm
  ttv_euv_risk_threshold: 0.2 um
  ttv_ideal_limit: 0.5 um
  ttv_next_gen_target: 0.15 um
  ttv_verified: 0.18 um
  voronkov_criterion_error_margin: 0.5%
semantic:
  alternative_parents: []
