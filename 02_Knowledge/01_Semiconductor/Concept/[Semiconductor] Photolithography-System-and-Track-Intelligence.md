...
object:
  description: '[Semiconductor] Photolithography-System-and-Track-Intelligence에 관한
    고밀도 지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  cd_shift_warning_threshold: 0.5 nm
  cd_temp_sensitivity: 1.2nm/0.1C
  coating_thickness_uniformity_verified: 0.82%
  external_log_endpoint: semiconductor-lithography-track-and-coating-uniformity-log-v2026
  ler_critical_threshold: 1.5 nm
  ler_verified: 1.45 nm
  mor_ler_improvement: 25%
  mor_photon_absorption_multiplier: 3x
  overlay_verified: 0.85 nm
  peb_temp_uniformity_verified: +/- 0.03 C
  pr_selectivity_verified: '85:1'
  stochastic_defect_rate_verified: 0.12%
  target_peb_temp: 110.0 C
semantic:
  alternative_parents: []
