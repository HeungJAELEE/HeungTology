...
object:
  description: '[Semiconductor] photolithography-theory-and-nanometer-patterning에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  cra_incident_angle: 6 degrees
  euv_wavelength: 13.5 nm
  high_na_value: '0.55'
  measured_dof: 85 nm
  measured_resolution: 11.2 nm
  overlay_accuracy: < 1.0 nm
  ref_asml_standard: ASML_Standard
  ref_euv_source_log: EUV-Source-Log-v2026
  ref_high_na_spec: High-NA_Spec
  ref_stochastic_defect_report: Stochastic_Defect_Report
  stochastic_defect_threshold: 10^-9 ppb
  target_dof: < 100 nm
  target_resolution: < 10.0 nm
  target_throughput: '> 160 WPH'
semantic:
  alternative_parents: []
