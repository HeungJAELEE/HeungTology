...
lineage:
  ...
  original_hash: 0320fcd2163ccbbe99d9dd2af1d0cfee154b7eb9e23aa2e06332a9f144d1cec4
metadata:
  date: '2026-05-16'
...
object:
  description: '[Semiconductor & AI] case-palantir-ontology-semiconductor-display-fab-os에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  digital_twin_fidelity: '> 99.9%'
  digital_twin_lag_threshold: < 10 ms
  ingestion_latency_threshold: < 5 seconds
  node_size: sub-2nm
  rca_speed_threshold: < 5 minutes
  traceability_depth_threshold: '> 1,000 steps'
  yield_prediction_accuracy: '> 97%'
semantic:
  alternative_parents: []
