...
lineage:
  ...
  original_hash: 735e323072925f1f5f7b62e2a843fb58e96394ca58c584d5f222ca69ab682c5f
metadata:
  date: '2026-05-16'
...
object:
  description: '[Semiconductor] Thermal-Oxidation-and-Dielectric-Physics에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  breakdown_voltage_ebd: 13.2 MV/cm
  critical_breakdown_voltage_threshold: 12.0 MV/cm
  data_source_log: semiconductor-thermal-oxidation-and-gate-oxide-log-v2026
  interface_charge_density_dit: 2.4e10 /cm2
  linear_growth_constant_b_a: 0.22 um/hr
  oxide_density_sio2: 2.19 g/cm3
  parabolic_growth_constant_b: 0.0108 um2/hr
  silicon_consumption_ratio: '1.0 : 2.18'
  thickness_deviation_threshold: '0.1'
semantic:
  alternative_parents: []
