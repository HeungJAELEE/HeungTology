...
object:
  description: '[Semiconductor] semiconductor-process-metrology-and-inspection-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  ebeam_detection_sensitivity_verified_nm: 8.5
  ebeam_min_dose_electrons_per_pixel: 1000000
  ebeam_stability_verified_percent: 98.4
  external_db_endpoint: semiconductor-advanced-metrology-and-inspection-precision-log-v2026
  false_positive_rate_verified_percent: 0.42
  ler_detection_threshold_nm: 1.0
  ocd_fidelity_target_r2: 0.98
  ocd_resolution_verified_nm: 0.24
  optical_inspection_speed_verified_wph: 0.85
  overlay_precision_verified_nm: 0.82
  overlay_residual_error_limit_nm: 0.8
  overlay_yield_drop_threshold_nm: 1.2
semantic:
  alternative_parents: []
