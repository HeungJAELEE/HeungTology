...
lineage:
  ...
  original_hash: 53b9397c927be669733099bb12726804119c7a7af53a650067f60572d6a29f12
metadata:
  date: '2026-05-16'
...
object:
  ...
  tier: 1
properties:
  glass_cte: 3.0-4.0 ppm/K
  hbm4_pin_count: 2048-bit
  hybrid_bonding_resistance: 10^-3 Ohm
  max_package_size: 100x100 mm
  si_wafer_cte: 2.6 ppm/K
  target_dielectric_constant: <= 2.0
  target_gate_leakage: <= 10^-12 A/um
  target_hbm_bandwidth: '>= 2.0 TB/s'
  target_node_size: 2nm
  target_transistor_density: '>= 300 MTr/mm2'
  target_tsv_pitch: <= 5 um
semantic:
  alternative_parents: []
