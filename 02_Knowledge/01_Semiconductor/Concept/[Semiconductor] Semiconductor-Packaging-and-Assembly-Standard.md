...
object:
  description: '[Semiconductor] Semiconductor-Packaging-and-Assembly-Standard에 관한
    고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  advanced_io_density_threshold: '> 5000 pins'
  advanced_msl: Level 1
  advanced_rdl_layers_range: 2-5
  csp_package_size_reduction: < 20%
  fowlp_io_density_verified: 5000-8000/mm2
  interconnect_pitch_verified: 10-40 um
  mechanical_stress_model: sigma = E * delta_alpha * delta_T
  signal_latency_verified: 10-50 ps
  thermal_resistance_verified: 15-30 K/W
  traditional_io_density_range: 10-500 pins
  traditional_msl: Level 3
semantic:
  alternative_parents: []
