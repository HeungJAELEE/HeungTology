...
lineage:
  ...
  original_hash: a9bc985f36f9bf0ffaab097f8ca6b187292ee03a31c6d55eaac9795a62acef5b
metadata:
  date: '2026-05-16'
...
object:
  description: '[Semiconductor] Thermal-Oxidation-Kinetics-and-Deal-Grove-Physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  crystal_orientation_growth_ratio_111_100: '1.68'
  data_source_endpoint: semiconductor-thermal-oxidation-kinetics-log-v2026
  dielectric_breakdown_field_ebd: 9.2 MV/cm
  dry_oxidation_rate_verified: 0.21 um/hr
  initial_acceleration_thickness_d0: 28.5 nm
  interface_trap_density_dit: 2.4e10 cm^-2/eV
  oxidation_fidelity_tolerance: '0.05'
  thickness_uniformity_wiw: 1.45 %
  wet_oxidation_density_diff_percent: 5.2%
  wet_oxidation_ebd_diff: 1.2 MV/cm
  wet_oxidation_rate_verified: 0.52 um^2/hr
semantic:
  alternative_parents: []
