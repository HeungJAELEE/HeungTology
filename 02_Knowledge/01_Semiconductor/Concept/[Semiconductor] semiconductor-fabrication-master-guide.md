...
lineage:
  ...
  original_hash: 72550d93b96fc6fd5207084c3c51efbd77e783edc27f082e9e6790f6f9380801
metadata:
  date: '2026-05-16'
...
object:
  description: '[Semiconductor] semiconductor-fabrication-master-guide에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  cmp_removal_rate_angstrom_min: 1500-3000
  cmp_uniformity_wiwnu_pct: < 2.0
  dep_conformality_pct: '> 99.9'
  dep_growth_rate_angstrom_cyc: 0.9-1.1
  etch_selectivity_ratio: '> 20:1'
  etch_sidewall_angle_deg: 89.5-90.0
  hbm4_alignment_acc_nm: < 150
  hbm4_bandwidth_tb_s: '2.0'
  learning_index_threshold_b: '0.3'
  litho_epe_nm: '1.8'
  litho_resolution_nm: '8.0'
  pattern_bridge_prediction_precision_nm: '0.1'
  yield_defect_density_per_cm2: < 0.05
  yield_ramp_up_mature_pct: '92'
  yield_target: '0.92'
semantic:
  alternative_parents: []
