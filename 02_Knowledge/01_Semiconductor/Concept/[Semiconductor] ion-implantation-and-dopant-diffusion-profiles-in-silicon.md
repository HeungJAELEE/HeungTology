...
lineage:
  ...
  original_hash: b758449a244d742d6a09153b6d6157ffd6c45aa90401f2aab6c2010c47278479
metadata:
  date: '2026-05-16'
...
object:
  description: '[Semiconductor] ion-implantation-and-dopant-diffusion-profiles-in-silicon에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  activation_rate_verified: 85-95%
  activation_temperature_lsa_c: 1300
  angle_precision_deg: ± 0.01
  beam_purity_ppm: < 1
  distribution_function: Gaussian
  dose_accuracy_variation: < 0.2%
  energy_range_kev: 0.1-2000
  gaa_spec_ref: GAA_SPEC_V7
  junction_depth_gaa_nm: < 7
  lsa_protocol_ref: LSA_PROT_V7
  semi_standard_ref: SEMI E47.1
  theoretical_model: LSS
semantic:
  alternative_parents: []
