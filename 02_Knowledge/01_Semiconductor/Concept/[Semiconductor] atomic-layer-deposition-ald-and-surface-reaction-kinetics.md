...
lineage:
  ...
  original_hash: 1231f7cf99ec9adafd7e29fa0e5a2b59cf3a5d830b70b0758cd1cefd2f4699fb
metadata:
  date: '2026-05-16'
...
object:
  description: '[Semiconductor] atomic-layer-deposition-ald-and-surface-reaction-kinetics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  ...
  al2o3_gpc: 1.02
  al2o3_temp_range: 250-350
  external_log_endpoint: ald-log-v2026
  har_pulse_time_multiplier: 5
  har_threshold_ratio: '100:1'
  hfo2_conformality_min: 99.2
  hfo2_gpc: 0.98
  hfo2_temp_range: 200-300
  pt_conformality_min: 90.0
  pt_gpc_range: 0.4-0.6
  pt_temp_range: 250-300
  purge_efficiency_threshold: 0.95
  sio2_conformality_min: 99.0
  sio2_gpc: 0.75
  sio2_temp_range: 200-400
semantic:
  alternative_parents: []
