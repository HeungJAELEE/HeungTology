...
object:
  description: '[Semiconductor] atomic-layer-deposition-and-surface-engineering에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  ald_window_temp_range: 150-350C
  data_endpoint: semiconductor-vacuum-deposition-log-v2026
  gpc_industrial: 0.84 A/cycle
  impurity_concentration: < 0.08 at%
  leakage_current_density: 4.2e-8 A/cm2
  optimal_purge_time: 5.5s
  process_drift_threshold: 0.5%
  step_coverage_attenuation_coeff: '0.15'
  step_coverage_industrial: 98.5%
  surface_roughness_rms: 0.18 nm
  thickness_uniformity_industrial: 1.25%
semantic:
  alternative_parents: []
