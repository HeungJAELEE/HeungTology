...
lineage:
  ...
  original_hash: b7e63396d6e19cee1b1159bc26253670776b12eb77dcec5011169409971f8139
metadata:
  date: '2026-05-16'
...
object:
  description: '[Semiconductor] High-Bandwidth-Memory-HBM-and-TSV-Packaging-Logic에
    관한 고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  bump_bonding_yield_verified: 99.4%
  data_bandwidth_verified: 1.15 TB/s
  external_db_endpoint: semiconductor-hbm-and-tsv-packaging-integrity-log-v2026
  hbm3e_stack_layers: 12 layers
  hybrid_bonding_pitch_verified: 9.2 um
  particle_contamination_sensitivity_multiplier: '5'
  power_consumption_reduction: 20%
  signal_speed_improvement: 30%
  tsv_aspect_ratio_verified: 12.5:1
  tsv_void_increase_probability: 15%
  tsv_void_limit: 0.5%
  void_free_fill_rate: 99.8%
  warpage_control_limit: 50 um
  warpage_verified: 72 um
semantic:
  alternative_parents: []
