...
lineage:
  ...
  original_hash: cd0a38a8b5ea567ed7302e47c8801a3755237d8ce2afe3edf1f6ef0c993ea66f
metadata:
  date: '2026-05-16'
...
object:
  description: '[Semiconductor] FOUP-and-Automated-Material-Handling-System-AMHS에
    관한 고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  capex_opex_reduction_rate: 70%
  deadlock_avoidance_algorithm: Banker's Algorithm
  fab_general_cleanliness: Class 1000
  mcs_response_latency_max: 100 ms
  mini_environment_cleanliness: Class 1
  n2_purge_efficiency_min: 99.9%
  oht_acceleration_limit: < 1.0 m/s^2
  oht_max_speed: 3.0-5.0 m/s
  path_allocation_algorithm: Dynamic A*
  rh_control_limit: 5.0 %RH
  software_version: HDS-Gold V7.5.3
  stocker_capacity_range: 500-5000 slots
  system_throughput_min: 2000 moves/hour
  vibration_dynamic_load_max: 0.5 G
  wip_optimization_law: Little's Law (L = λ * W)
semantic:
  alternative_parents: []
