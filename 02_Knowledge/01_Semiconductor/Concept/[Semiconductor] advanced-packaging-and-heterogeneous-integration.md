...
lineage:
  ...
  original_hash: d5dfde38414c435ae5aede76cd5bd99418a79fa72f3aae947899b21f00489071
metadata:
  date: '2026-05-16'
...
object:
  description: '[Semiconductor] advanced-packaging-and-heterogeneous-integration에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  bonding_accuracy_verified: 48 nm
  bump_pitch_verified: < 25 um
  bw_density_verified: '> 500 GB/s/mm'
  energy_efficiency_verified: 0.09 pJ/bit
  hbm_thermal_throttling_threshold: 85°C
  hybrid_bonding_rms_threshold: 0.5 nm
  hybrid_bonding_strength_drop: 40%
  io_density_verified: 1.2 x 10^6 /mm2
  kgd_yield_verified: 99.55%
  log_endpoint: semiconductor-advanced-packaging-yield-and-thermal-log-v2026
  thermal_limit: 0.03
  thermal_resistance_verified: 0.055 K/W
  ucie_reflection_loss_threshold: 15%
  warpage_limit: 20.0
  warpage_verified: 28 um
semantic:
  alternative_parents: []
