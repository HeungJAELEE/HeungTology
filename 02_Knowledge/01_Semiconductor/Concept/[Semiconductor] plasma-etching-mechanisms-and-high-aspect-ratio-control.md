...
lineage:
  ...
  original_hash: 522d94443882d2cea26cbb87cc68b8eedf9f7ab4c386b3a51000f4342693a9a5
metadata:
  date: '2026-05-16'
...
object:
  description: '[Semiconductor] plasma-etching-mechanisms-and-high-aspect-ratio-control에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  cryo_chamber_temp_range_celsius: -80 to -120
  cryo_passivation_threshold_celsius: '-100'
  har_aspect_ratio_min: '120:1'
  har_etch_rate_si_min_nm_min: '2000'
  har_profile_angle_range_deg: 89.8-90.2
  har_selectivity_min: '100:1'
  har_wiw_uniformity_max_3sigma: 1.0%
  oes_epd_margin_percent: '10'
  verified_etch_rate_si_angstrom_min: '4500'
  verified_selectivity_si_ox: '25:1'
  verified_sidewall_angle_deg: '89.8'
semantic:
  alternative_parents: []
