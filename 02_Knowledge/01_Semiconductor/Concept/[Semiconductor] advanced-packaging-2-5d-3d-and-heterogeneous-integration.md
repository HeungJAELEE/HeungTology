...
object:
  description: '[Semiconductor] advanced-packaging-2-5d-3d-and-heterogeneous-integration에
    관한 고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  bump_pitch: 18.0 µm
  bw_density: 542.5 GB/s/mm
  cte_mismatch: 8.2 ppm/°C
  kgd_yield: 99.82%
  power_density: 12.4 W/mm²
  ucie_latency: 8.4 ps
semantic:
  alternative_parents: []
