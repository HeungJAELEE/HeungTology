...
object:
  description: '[Semiconductor] carbon-nanotube-cnt-and-graphene-physics에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  carrier_mobility_verified: 184200 cm2/Vs
  elec_conductivity_verified: 1.2e8 S/m
  graphene_thickness_verified: 0.342 nm
  log_endpoint: science-materials-nano-carbon-cnt-graphene-log-v2026
  optimal_chirality_indices: (6, 5), (7, 6)
  purity_verified: 99.94%
  tensile_strength_verified: 94.5 GPa
  thermal_conductivity_verified: 4820 W/mK
  thermal_mobility_barrier_loss: 40%
  zeta_potential_threshold: -45mV
semantic:
  alternative_parents: []
