...
object:
  description: '[Semiconductor] EDS-and-Wafer-Level-Testing-Intelligence에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  contact_resistance_verified: 1.2 Ohm
  external_log_endpoint: semiconductor-wafer-test-and-eds-yield-analysis-log-v2026
  final_yield_enhanced: '0.82'
  initial_yield_baseline: '0.65'
  negative_binomial_alpha: '2.5'
  overdrive_pad_crack_rate: '0.12'
  probe_contact_load_verified: 2.4 gf/pin
  r_film_resistance_contribution: '0.58'
  repair_efficiency_verified: 98.4%
  simultaneous_measurement_pins: 48,200
  test_frequency_verified: 0.95 GHz
  test_temperature_uniformity_verified: 124.2 C
semantic:
  alternative_parents: []
