...
object:
  ...
  tier: 1
properties:
  arsenic_atomic_radius: 120 pm
  boron_atomic_radius: 85 pm
  carbon_atomic_radius: 77 pm
  germanium_atomic_radius: 122 pm
  ionization_source_temperature: 1000 C
  phosphorus_atomic_radius: 110 pm
  sds_max_pressure_threshold: 760 torr
  thermal_activation_energy: 0.05 eV
  verified_donor_ionization_energy: 0.051 eV
  verified_ion_extraction_efficiency: 96.2%
  verified_plasma_density: 1.18e15 cm-3
  verified_sds_pressure_stability: 0.15 torr
semantic:
  alternative_parents: []
