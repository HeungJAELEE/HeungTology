...
lineage:
  ...
  original_hash: 32bb879faf6a678c9d407509616145b82fb234578c6a5866d2560f71ff872b6e
metadata:
  date: '2026-05-16'
...
object:
  description: '[Semiconductor] yield-management-and-defect-density-modeling에 관한 고밀도
    지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  chip_area_range: 0.5-2.5
  cpgd_cost_threshold: 10.0
  critical_layers_range: 60-120
  cycle_time_threshold: 1.5
  defect_density_threshold: 0.05
  killer_defect_impact_ratio: 80% from top 20% layers
  learning_index_min_threshold: 0.3
  learning_index_range: 0.3-0.5
  weekly_yield_target: 92%
  wpm_capacity_range: 10k-100k
  yield_model_formula: Y = e^(-A * D0)
semantic:
  alternative_parents: []
