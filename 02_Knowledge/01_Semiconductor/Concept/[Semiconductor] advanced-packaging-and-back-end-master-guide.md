...
object:
  description: '[Semiconductor] advanced-packaging-and-back-end-master-guide에 관한 고밀도
    지능 노드'
  object_type: Hardware
  tier: 1
properties:
  architecture_version: V7.5.3
  bump_pitch_limit_um: 10
  coplanarity_deviation_threshold_um: 50
  hbm4_throughput_target_tbps: 1.5
  hybrid_bond_align_limit_nm: 100
  resistance_distribution_threshold_sigma: 3
  thermal_resistance_model: R_th_total = sum(t_i / (k_i * A)) + R_interface
  tsv_har_ratio_limit: '15:1'
semantic:
  alternative_parents: []
