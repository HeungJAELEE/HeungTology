...
lineage:
  ...
  original_hash: ee9286f1de3176d60c6244d7a84de5cc8c40d43934c0cf0be348e3fae14d0c49
metadata:
  date: '2026-05-16'
...
object:
  description: '[Semiconductor] Neuromorphic-Computing-and-AI-Accelerator-Architecture에
    관한 고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  brain_energy_efficiency_w: 20
  data_transfer_bandwidth_tb_s: 0.72
  inference_latency_ms: 2.85
  lif_idle_power_uw: 10
  neuron_density_counts: 1200000
  npu_compute_performance_tops_w: 32.4
  performance_log_endpoint: compute-neuromorphic-and-ai-accelerator-performance-log-v2026
  performance_target_tops_w: 30.0
  pim_data_movement_reduction_ratio: 0.9
  pim_power_efficiency_gain_multiplier: 4
  quantization_accuracy_loss_percentage: 12
  quantization_precision_threshold_bit: 4
  snn_energy_efficiency_pj_syn_op: 1.25
  sparsity_percentage: 88.2
  stdp_adaptation_time_ms: 500
semantic:
  alternative_parents: []
