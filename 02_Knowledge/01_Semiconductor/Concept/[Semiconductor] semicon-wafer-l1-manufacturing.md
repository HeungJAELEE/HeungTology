...
object:
  ...
  tier: 1
properties:
  crystal_orientation: <100> or <111>
  defect_control_parameter: v/G
  oxygen_content_ppma: 10-20
  purity_spec: 99.999999999%
  purity_verified: 11N
  segregation_coefficient_relation: Cs = k * Cl
  sfqr_um: < 0.05
  silicon_melting_point_c: '1414'
  ttv_um: < 1.0
semantic:
  alternative_parents: []
