...
object:
  ...
  tier: 1
properties:
  cd_target_tolerance: ±5%
  defect_density_target: <0.1 defects/cm2
  dof_target_threshold: '>50nm'
  endpoint_metrology_cd: semiconductor-metrology-and-critical-dimension-cd-measurement
  endpoint_photoresist_sensitivity: photoresist-sensitivity-log
  endpoint_yield_defect_density: yield-defect-density-log
  ler_target_threshold: <1.5nm
  ovl_target_threshold: <2.0nm
  peb_temp_tolerance: ±0.1°C
  theoretical_cd_variation: ±1.0%
  theoretical_dof: '>100nm'
  theoretical_ler: <0.5nm
  theoretical_ovl_error: <0.5nm
semantic:
  alternative_parents: []
