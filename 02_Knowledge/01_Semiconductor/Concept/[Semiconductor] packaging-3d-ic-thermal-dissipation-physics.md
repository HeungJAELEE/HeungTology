...
object:
  description: '[Semiconductor] packaging-3d-ic-thermal-dissipation-physics에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  dummy_tsv_density_multiplier: 10x
  heat_load_threshold: 500 W/cm^2
  interface_resistance_measured: 1.2e-8 m^2K/W
  junction_to_case_thermal_resistance_max: 0.05 °C/W
  kapitza_resistance_limit: 1e-8 m^2K/W
  max_junction_temperature_range: 105-115 °C
  si_cte_ideal: 2.6e-6 /K
  si_cte_measured: 2.65e-6 /K
  si_thermal_conductivity_ideal: 149 W/m·K
  si_thermal_conductivity_measured: 142 W/m·K
  silicon_specific_heat_capacity: 700-800 J/kg·K
  simulation_engine_spec: HDS-Gold V7.5.3
  thermal_diffusivity_alpha: 8e-5 m^2/s
  tim_thermal_conductivity_min: 50 W/m·K
semantic:
  alternative_parents: []
