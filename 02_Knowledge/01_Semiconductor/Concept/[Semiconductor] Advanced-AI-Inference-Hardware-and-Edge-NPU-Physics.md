...
object:
  description: '[Semiconductor] Advanced-AI-Inference-Hardware-and-Edge-NPU-Physics에
    관한 고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  compression_latency_improvement: 0.18
  dram_latency_ns: 112.5
  dram_power_reduction: 0.68
  energy_efficiency_tops_w: 9.24
  int8_area_efficiency_gain: 4.1
  kv_cache_dram_overhead: 0.42
  peak_performance_tops: 18.45
  quantization_loss_map: 1.24
  sparsity_gain_x: 1.68
  sram_bandwidth_tbs: 1.85
  sram_data_reuse_rate: 0.942
