...
object:
  ...
  tier: 1
properties:
  critical_process_threshold: 7 nm
  duv_overlay_accuracy: < 2 nm
  duv_scanning_speed: 600-800 mm/s
  euv_mirror_reflectivity: '0.7'
  euv_overlay_accuracy: < 1 nm
  euv_scanning_speed: 1000 mm/s+
  euv_wavelength: 13.5 nm
  kinematic_equation: V_mask = M * V_wafer
  stage_velocity_sync_error: ± 0.05%
semantic:
  alternative_parents: []
