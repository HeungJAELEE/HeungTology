...
object:
  description: '[Semiconductor] Specialty-Gases-and-Advanced-Precursors에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  ald_deposition_rate_range_angstrom_per_cycle: 0.5-2.0
  efv_shutdown_latency_seconds: '0.1'
  flash_point_threshold_celsius: < 0
  gas_leak_detection_limit_ppm: '0.1'
  ligand_decomposition_temp_threshold_celsius: '> 300'
  mfc_accuracy_percentage: ±1%
  purity_grade_range: 6N-9N
  purity_max_percentage: 99.9999999%
  tlv_twa_threshold_ppm: < 0.1
semantic:
  alternative_parents: []
