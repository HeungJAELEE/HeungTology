...
lineage:
  ...
  original_hash: 46f8e8bd556de3142cbed7f3503291f07f68e910aa13180b3b8343050a3e2811
metadata:
  date: '2026-05-16'
...
object:
  ...
  tier: 1
properties:
  bonding_failure_rate_above_threshold: 99.2%
  cmp_roughness_threshold_nm: '0.5'
  cu_annealing_temp_c: 200-400
  cu_thermal_expansion_coeff_per_k: '16.5e-6'
  hybrid_bonding_energy_per_bit_pj: <0.1
  hybrid_bonding_io_density_per_mm2: 10^5-10^6
  hybrid_bonding_parasitic_cap_ff: <1
  hybrid_bonding_pitch_um: 1-10
  reticle_limit_mm2: '858'
  theoretical_bonding_pitch_um: '0.1'
  theoretical_interconnect_energy_pj_bit: '0.01'
  theoretical_thermal_cond_wmk: '400'
  ucie_bandwidth_hybrid_tbps_mm: '>1'
  verified_bonding_pitch_um: 0.5-1.0
  verified_bonding_yield: 99.99%
  verified_interconnect_energy_pj_bit: 0.05-0.1
  verified_thermal_cond_wmk: 320-380
semantic:
  alternative_parents: []
