...
object:
  description: '[Semiconductor] semiconductor-equipment-core-components-and-subsystems에
    관한 고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  esc_he_back_pressure: 10-20 Torr
  esc_thermal_control_margin: ± 0.5°C
  matcher_tuning_time_target: < 1.0 sec
  matcher_tuning_time_threshold: 1.5 sec
  mfc_accuracy: ± 1%
  mfc_response_time: < 500ms
  reference_db_endpoint: SEM-EQP-COMP-2026-V6.3.7
  rf_gen_frequency: 13.56MHz, 400kHz
  rf_reflection_coeff_limit: 5.0%
  tmp_rotor_speed_min: 30,000 rpm
semantic:
  alternative_parents: []
