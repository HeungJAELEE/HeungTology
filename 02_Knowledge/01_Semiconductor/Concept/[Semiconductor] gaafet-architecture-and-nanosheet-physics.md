...
object:
  description: '[Semiconductor] gaafet-architecture-and-nanosheet-physics에 관한 고밀도
    지능 노드'
  object_type: Hardware
  tier: 1
properties:
  dibl_mv_v: '28'
  effective_drive_current_ma_um: '1.8'
  leakage_critical_threshold: '100'
  leakage_current_pa_um: '45'
  sheet_thickness_nm: '4.8'
  ss_warning_threshold: '70'
  subthreshold_swing_mv_dec: '62'
  threshold_voltage_v: '0.31'
  vth_deviation_threshold: '0.05'
  work_function_metal_angstrom: '17.2'
semantic:
  alternative_parents: []
