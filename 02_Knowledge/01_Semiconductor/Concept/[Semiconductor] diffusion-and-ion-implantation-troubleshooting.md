...
object:
  description: '[Semiconductor] diffusion-and-ion-implantation-troubleshooting에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  activation_rate_threshold: '> 95%'
  beam_stability_threshold: < 1.0%
  dose_precision_threshold: < ± 0.5%
  dose_uniformity_variance: + 0.4%
  external_ref_fab_yield_log: Fab-Yield-Log-v2026
  external_ref_lss_theory: LSS-Theory-v2
  external_ref_yield_log: Yield-Log-v2026
  junction_depth_tolerance: ± 5 nm
  junction_depth_variance: + 3 nm
  leakage_current_threshold: < 10 pA/μm²
  projected_range_variance: + 2 nm
  sheet_resistance_tolerance: ± 1.0%
  temp_stability_threshold: ± 0.2°C
  tilt_twist_angle_tolerance: ± 0.1°
  verified_activation_rate: 97.2%
semantic:
  alternative_parents: []
