...
object:
  description: '[Semiconductor] semiconductor-materials-and-equipment-master-guide에
    관한 고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  esc_clamping_force_verified: 100 kgf
  euv_lpp_power_verified: 250 W
  matching_speed_limit: 100ms
  mfc_flow_precision_limit: 0.5%
  precursor_purity_level: 9N
  reflected_power_limit: '0.01'
  vacuum_base_pressure_limit: 1e-8 Torr
semantic:
  alternative_parents: []
