...
object:
  description: '[Semiconductor] chemical-mechanical-planarization-cmp-slurry-mechanics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  copper_removal_rate: 3500 A/min
  dishing_amount_threshold: 10.0 nm
  down_force_psi_range: 2.0-5.0
  edge_pressure_adjustment_factor: 10%
  epd_accuracy_limit_sec: '1.0'
  oxide_removal_rate: 2500 A/min
  pad_lifetime_min_hrs: '500'
  preston_constant: k_p
  roughness_ra_limit: 3.0 A
  selectivity_metal_oxide_ratio: '50:1'
  slurry_deviation_threshold: 5%
  wiwnu_target: 1.0%
semantic:
  alternative_parents: []
