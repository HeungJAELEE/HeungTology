...
lineage:
  ...
  original_hash: 75a40d1f013d31a2f46669208f81424437fb7435632c613ef957fc85b650a816
metadata:
  date: '2026-05-16'
...
object:
  description: '[Semiconductor] silicon-photonics-and-optical-interconnects에 관한 고밀도
    지능 노드'
  object_type: Hardware
  tier: 1
properties:
  cu_bandwidth_density: 100 Gbps/mm
  cu_channel_count: '4'
  cu_energy_efficiency: 20 pJ/bit
  cu_modulation_rate: 100 GBaud
  cu_reach: < 1 m
  fiber_loss_coefficient: < 0.2 dB/km
  insertion_loss_total_theoretical: 1.5 dB
  insertion_loss_total_verified: 2.8 dB
  modulation_bandwidth_theoretical: 400 GBaud
  modulation_bandwidth_verified: 200 GBaud
  refractive_index_oxide: '1.45'
  refractive_index_silicon: '3.45'
  siph_bandwidth_density: '> 1 Tbps/mm'
  siph_channel_count: '128'
  siph_energy_efficiency: < 2 pJ/bit
  siph_insertion_loss: < 3 dB
  siph_modulation_rate: '> 200 GBaud'
  siph_reach: '> 100 m'
  system_power_efficiency_theoretical: 0.5 pJ/bit
  system_power_efficiency_verified: 1.8 pJ/bit
  waveguide_cross_section: 500x220 nm^2
  wdm_channel_density_theoretical: '256'
  wdm_channel_density_verified: '128'
semantic:
  alternative_parents: []
