...
object:
  description: '[Semiconductor] wafer-cleaning-technology-and-surface-contamination-control에
    관한 고밀도 지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  default_zeta_potential: -60 mV
  har_critical_aspect_ratio: '100:1'
  metal_contamination_verified: 7.2e7 atoms/cm2
  particle_limit_verified: 8.5 nm
  pre_efficiency_verified: 99.97%
  pre_recovery_threshold: 99.9%
  scCO2_surface_tension_target: 0 mN/m
  surface_roughness_ra_verified: 0.042 nm
  toc_concentration_verified: 0.8 ppb
  toc_integrity_threshold: 0.1 ppb
  upw_resistivity_verified: 18.26 MOhm-cm
semantic:
  alternative_parents: []
