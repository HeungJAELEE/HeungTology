...
lineage:
  ...
  original_hash: 8502fd4d26e0c59954fcba25c3a772bf3f9f3e5c062d6d5ff91affd1c9e94f3b
metadata:
  date: '2026-05-16'
...
object:
  description: '[Semiconductor] semiconductor-high-k-dielectrics-and-gate-insulators에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  band_offset_min: 1.0 eV
  breakdown_ebd_min: 5 MV/cm
  dielectric_k_min: '20'
  eot_threshold: 0.8 nm
  interface_dit_max: 10^11 eV^-1 cm^-2
  leakage_jg_max: 10^-2 A/cm^2
  sio2_permittivity: '3.9'
  thermal_tolerance_min: 1000 C
semantic:
  alternative_parents: []
