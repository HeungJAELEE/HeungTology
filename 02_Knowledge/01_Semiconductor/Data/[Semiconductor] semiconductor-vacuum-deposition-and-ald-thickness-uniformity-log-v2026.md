...
lineage:
  ...
  original_hash: 91e54c62dbbf90ade340fbf118e5c0aebce782a403602347752e5eee36571794
metadata:
  date: '2026-05-16'
...
object:
  description: '[Semiconductor] semiconductor-vacuum-deposition-and-ald-thickness-uniformity-log-v2026에
    관한 고밀도 지능 노드'
  object_type: Data
  tier: 1
properties:
  aspect_ratio_profile: '50:1'
  metrology_resolution: 0.1 Å
  physisorption_gpc_increase: 20%
  step_coverage_threshold: 99.0%
  theoretical_gpc: 1.00 Å
  thermal_deviation_threshold: -10°C
  thickness_deviation_limit: 1 Å
  uniformity_threshold: 1.00%
semantic:
  alternative_parents: []
