...
lineage:
  ...
  original_hash: 3933718a002b6a1a9402bd7400acd2faf7db28251bc229b9d5d04f855e4452de
metadata:
  date: '2026-05-16'
...
object:
  description: '[Semiconductor] semiconductor-fab-exhaust-and-scrubber-efficiency-log-v2026에
    관한 고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  dre_compliance_threshold: 99.0%
  exhaust_pressure_pa: '-250'
  fan_runtime_hr_yr: '8760'
  hf_alarm_threshold_ppm: '1.0'
  hf_outlet_conc_ppm_verified: '0.2'
  nozzle_scaling_blockage_ratio: '0.3'
  plasma_decomposition_temp_c: '1200'
  removal_efficiency_dre: 99.9%
  scrubber_water_ph_verified: '7.5'
semantic:
  alternative_parents: []
