...
object:
  description: '[Aerospace] satellite-mesh-network-and-orbital-mechanics에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  drift_threshold_km: 50
  eccentricity_threshold: 0.05
  end_to_end_latency_ms: 30
  isl_bandwidth_gbps: 10
  min_received_power_threshold: 0.01
  orbital_altitude_km: 550
  orbital_velocity_km_s: 7.6
  satellite_count_max: 10000
