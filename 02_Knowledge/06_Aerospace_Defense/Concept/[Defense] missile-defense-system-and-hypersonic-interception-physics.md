...
object:
  description: '[Defense] missile-defense-system-and-hypersonic-interception-physics에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  detection_range_km: 1000
  external_db_endpoint: missile-trajectory-and-interception-success-log-v2026
  interception_altitude_km: 20-150
  interception_speed_mach: 4-10
  radar_noise_threshold: 0.1
  reaction_time_sec_max: 120
  reentry_speed_mach_max: 20
  single_shot_pk_min: 0.9
semantic:
  alternative_parents: []
