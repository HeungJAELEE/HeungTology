...
object:
  description: '[Defense] directed-energy-weapons-dew-and-laser-physics에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  absorption_loss_max_db_km: 0.1
  beam_combination_efficiency_loss_pct: 15
  beam_precision_max_mm: 10
  carbon_fiber_ablation_delay_sec: 1
  cooldown_capacity_min_kw: 500
  defense_log_endpoint: defense-dew-laser-firing-and-interception-log-v2026
  dwell_time_max_sec: 2
  hpm_output_min_gw: 1
  laser_power_min_kw: 100
  shot_cost_max_usd: 1
  thermal_blooming_energy_loss_pct: 30
  tracking_bandwidth_min_hz: 1000
semantic:
  alternative_parents: []
