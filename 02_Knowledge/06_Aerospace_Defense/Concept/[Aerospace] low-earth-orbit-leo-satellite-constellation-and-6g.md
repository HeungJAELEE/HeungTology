...
lineage:
  ...
  original_hash: 2f2af64eda02006b17be363f8e627d49fbf6ed5bf851b4607ed91656580a1b41
metadata:
  date: '2026-05-16'
...
object:
  description: '[Aerospace] low-earth-orbit-leo-satellite-constellation-and-6g에 관한
    고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  beam_steering_deg: 60
  doppler_shift_critical_threshold_mhz: 1.0
  external_db_endpoint: satellite-signal-latency-and-constellation-health-v2026
  frequency_band_ghz: 26-40
  orbit_decay_risk_altitude_km: 300
  orbital_altitude_range_km: 550-1200
  orbital_altitude_tolerance_km: 50
  peak_data_rate_gbps: 10
  propagation_delay_ms_max: 10
  propagation_delay_tolerance_ms: 2
  satellite_velocity_ms: 7600
