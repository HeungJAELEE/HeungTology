...
lineage:
  ...
  original_hash: 175fea8de93f10d41639870e001571196261e8a02491cb9d9c42ac782c0b6e20
metadata:
  date: '2026-05-16'
...
object:
  description: '[Aerospace] aerospace-and-defense-intelligence-master-guide에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  decision_latency_max_s: 1.0
  decision_latency_tolerance_s: 0.1
  fidelity_engine_orbital_tolerance_m: 0.1
  hypersonic_speed_min_mach: 5.0
  hypersonic_speed_tolerance_mach: 0.1
  keplerian_delta_max_m: 1.0
  mro_accuracy_min_percent: 98.0
  mro_accuracy_tolerance_percent: 0.5
  scramjet_combustion_target_mach: 7.0
  uam_safety_sil_level: 4
semantic:
  alternative_parents: []
