...
object:
  description: '[Strategy] Autonomous-Defense-Systems-and-Robotic-Warfare에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  decision_latency_unit: ms
  human_in_the_loop_protocol: true
  target_classification_accuracy: 0.99
