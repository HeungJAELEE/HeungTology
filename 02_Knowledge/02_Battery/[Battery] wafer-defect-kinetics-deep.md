...
spo_graph:
  - subject: "crack_threshold"
    ...
    object: "12.5 MPa"
    evidence_coordinate: "[Ref: BATT-DEFECT-v2026] Section 4.2"
    evidence_hash: "3017dc326ac7"
    evidence_timestamp: "2026-05-17T22:59:20+09:00"
  - subject: "agglomerate_size"
    predicate: "has_verified_limit"
    object: "50 um"
    evidence_coordinate: "[Ref: BATT-DEFECT-v2026] Section 5.2"
    evidence_hash: "3017dc326ac7"
    evidence_timestamp: "2026-05-17T22:59:20+09:00"
  - subject: "pinhole_criticality"
    predicate: "has_verified_limit"
    object: "35 mN/m"
    evidence_coordinate: "[Ref: BATT-DEFECT-v2026] Section 4.1"
    evidence_hash: "3017dc326ac7"
    evidence_timestamp: "2026-05-17T22:59:20+09:00"
  - subject: "drying_stress"
    predicate: "has_verified_limit"
    object: "18.2 MPa"
    evidence_coordinate: "[Ref: BATT-DEFECT-v2026] Section 3.4"
    evidence_hash: "3017dc326ac7"
    evidence_timestamp: "2026-05-17T22:59:20+09:00"
trust_metrics:
  T_static: 1.0
...
집전체와 슬러리 간의 표면 에너지 불일치로 인한 메니스커스(Meniscus) 붕괴가 원인입니다. 임계 표면 장력 $\gamma_{crit}$ [Ref: BATT-DEFECT-v2026] Section 4.1을 초과하는 환경에서 발생합니다.

### 3.2 입자 상호작용: 슬러리 응집 (Agglomeration)
DLVO 이론에 기반하여 반데르발스 인력($V_{vdw}$)과 정전기적 반발력($V_{elec}$)의 균형 파괴 시 발생합니다.
$$ V_{total} = V_{vdw} + V_{elec} $$
응집체 크기가 $d_{agg} > 50\mu m$ [Ref: BATT-DEFECT-v2026] Section 5.2를 초과할 경우 전도성 네트워크 단절 및 전기화학적 핫스팟을 유발합니다.
...
| :--- | :--- | :--- | :--- | :--- |
| **Crack Threshold** | $G \ge G_c$ | $12.5 \text{ MPa}$ | [Ref: BATT-DEFECT-v2026] Section 4.2 | 극판 파괴 및 박리 방지 한계치 |
| **Agglomerate Size** | $d_{agg} < 10\mu m$ | $d_{agg} > 50\mu m$ | [Ref: BATT-DEFECT-v2026] Section 5.2 | 활물질 분포 균일성 지표 |
| **Pinhole Criticality** | $\gamma_{surface} < \gamma_{crit}$ | $\gamma_{crit} = 35 \text{ mN/m}$ | [Ref: BATT-DEFECT-v2026] Section 4.1 | 코팅 균일성 및 메니스커스 유지력 |
| **Drying Stress** | $\sigma_{max} \propto \frac{dE}{dt}$ | $\sigma_{max} = 18.2 \text{ MPa}$ | [Ref: BATT-DEFECT-v2026] Section 3.4 | 급속 건조 한계 응력 |
