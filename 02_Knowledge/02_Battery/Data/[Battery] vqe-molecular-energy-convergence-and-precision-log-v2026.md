...
object:
  description: '[Battery] vqe-molecular-energy-convergence-and-precision-log-v2026에
    관한 고밀도 지능 노드'
  object_type: Data
  tier: 1
properties:
  chemical_accuracy_threshold: 1.00 kcal/mol
  current_avg_convergence_cycles: '878.8'
  current_avg_energy_error: 1.24 kcal/mol
  reference_log_version: VQE_Log_v6.3.7
  reference_sop: SOP_vqe-molecular-hamiltonian-mapping
  target_convergence_cycles_limit: '500'
semantic:
  alternative_parents: []
