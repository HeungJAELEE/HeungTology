...
lineage:
  ...
  original_hash: 665acc42d3402cbefc3c9fc2ce38bbb543e7909be509b07ae8887477faa6a582
metadata:
  date: '2026-05-16'
  domain: 02_Battery
...
object:
  description: '[Battery] smart-grid-energy-balance-and-stability-audit-log-v2026에
    관한 고밀도 지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  frequency_stability_threshold: 0.02Hz
  grid_efficiency_actual: 96.8%
  peak_reduction_actual: 450MW
  renewable_curtailment_actual: 1.8%
  sgi_physical_integrity_target: 96.5%
  sgi_pulse_weight: '0.4'
  system_uptime: 99.999%
  voltage_fluctuation_actual: 1.2%
  vpp_latency_threshold: 100ms
  vpp_response_precision: 99.5%
semantic:
  alternative_parents: []
