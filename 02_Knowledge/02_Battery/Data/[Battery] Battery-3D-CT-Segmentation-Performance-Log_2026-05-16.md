...
object:
  description: '[Battery] Battery-3D-CT-Segmentation-Performance-Log_2026-05-16에 관한
    고밀도 지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  acceleration_engine: RTX acceleration parallel computing engine
  architecture: 3D U-Net
  dendrite_identification_resolution_actual: 8.5 um
  dendrite_identification_resolution_target: 10.0 um
  dice_coefficient_actual: 0.962
  dice_coefficient_target: 0.95
  false_negative_rate_actual: 0.12 %
  false_negative_rate_target: 0.50 %
  overlap_measurement_error_actual: 0.075 mm
  overlap_measurement_error_target: 0.100 mm
  volume_processing_time_actual: 7.2 min
  volume_processing_time_target: 10.0 min
semantic:
  alternative_parents: []
