...
object:
  description: '[Battery] Battery-SHAP-Sensor-Attribution-Audit-Log_2026-05-16에 관한
    고밀도 지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  additive_error_threshold: < 0.01 %
  charging_voltage_deviation: 15 mV
  internal_resistance: 1.25 mΩ
  module_temp: 48.2 °C
  shap_contribution_r_int: '+0.35'
  shap_contribution_temp: '+0.42'
semantic:
  alternative_parents: []
