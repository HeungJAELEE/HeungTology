...
object:
  description: '[Battery] Battery-Electrode-Defect-Density-and-Yield-Impact-Log_2026-05-16에
    관한 고밀도 지능 노드'
  object_type: Data
  tier: 1
properties:
  agglomerate_size_actual: < 2.5 μm
  agglomerate_size_limit: 5.0 μm
  defect_process_causal_correlation: '0.88'
  drying_crack_propagation_index_actual: '0.12'
  drying_crack_propagation_index_limit: '0.15'
  pinhole_density_actual: 0.042 /m²
  pinhole_density_limit: 0.050 /m²
  yield_loss_actual: 1.15%
  yield_loss_limit: 1.50%
semantic:
  alternative_parents: []
