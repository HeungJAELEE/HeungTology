...
object:
  description: AI 가속기 및 HBM4 적층 반도체의 열 트래핑(Thermal Trapping) 해소를 위한 다상 액침 냉각 및 미세
    유로 열전달 최적화 설계 명세
  object_type: Hardware
  tier: 1
properties:
  coolant_flow_rate: 18.5 L/min
  critical_heat_flux_limit: 214.5 W/cm^2
  external_log_endpoint: battery-ai-chip-thermal-log-v2026
  hbm4_junction_temperature: 78.2 °C
  hbm_vertical_thermal_resistance: 0.11 K/W
  max_surface_heat_flux: 214.5 W/cm^2
  system_pue: '1.04'
  tim2_thermal_conductivity: 14.2 W/m·K
semantic:
  alternative_parents: []
