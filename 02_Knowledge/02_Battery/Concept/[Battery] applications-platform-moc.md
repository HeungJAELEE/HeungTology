...
lineage:
  ...
  original_hash: c7bc2dc703ac9026c583fc12ff6e5a556d6de6e4dc19f5fbfd7c82ae599f64aa
metadata:
...
object:
  description: 배터리 셀 기술을 EV 플랫폼 및 ESS 시스템에 통합하여 가치를 극대화하기 위한 시스템 통합(SI) 및 그리드 지능 마스터
    가이드
  object_type: Hardware
  tier: 1
properties:
  bess_energy_efficiency: '> 85%'
  bess_max_c_rate: 1.0-2.0 C
  bess_response_time: < 20 ms
  bess_soh_cycle_life: 6000-10000
  bess_voltage_range: 1000-1500 V
  ev_energy_efficiency: '> 90%'
  ev_max_c_rate: 3.0-5.0 C
  ev_response_time: < 100 ms
  ev_soh_cycle_life: 1500-3000
  ev_voltage_range: 400-800 V
  v2g_energy_efficiency: '> 88%'
  v2g_max_c_rate: 0.5-1.0 C
  v2g_response_time: < 50 ms
  voltage_loss_reduction_ratio: 50% (800V vs 400V)
semantic:
  alternative_parents: []
