...
object:
  description: '[Battery] advanced-cell-form-factor-and-safety-integration에 관한 고밀도
    지능 노드'
  object_type: Hardware
  tier: 1
properties:
  cid_activation_integrity: 99.99%
  internal_ohmic_resistance_target: < 1.0 mOhm
  internal_ohmic_resistance_tolerance: ± 0.05 mOhm
  internal_ohmic_resistance_verified: 0.95 mOhm
  packaging_efficiency_target: '> 80%'
  packaging_efficiency_tolerance: ± 1.0%
  thermal_resistance_critical_threshold: 1.2 K/W
  thermal_resistance_target: < 1.0 K/W
  thermal_resistance_tolerance: ± 0.05 K/W
  thermal_resistance_verified: 0.98 K/W
  venting_pressure_threshold: 10-15 kgf/cm2
  venting_pressure_tolerance: ± 0.5 kgf/cm2
  venting_response_time_verified: 12-15 ms
  volumetric_energy_density_target: '> 700 Wh/L'
  volumetric_energy_density_tolerance: ± 10 Wh/L
  volumetric_energy_density_verified: 712 Wh/L
semantic:
  alternative_parents: []
