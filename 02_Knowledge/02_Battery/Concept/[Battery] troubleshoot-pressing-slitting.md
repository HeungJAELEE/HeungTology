...
object:
  ...
  tier: 1
properties:
  burr_diagnostic_threshold: 10 um
  burr_height_limit: 12 um
  design_density_target: ± 0.03 g/cc
  fidelity_engine_burr_tolerance: ± 1 um
  fidelity_engine_density_tolerance: ± 0.005 g/cc
  fidelity_engine_haz_tolerance: ± 5 um
  fidelity_engine_springback_tolerance: ± 0.5%
  fidelity_engine_straightness_tolerance: ± 0.1 mm
  haz_risk_threshold: 60 um
  haz_width_limit: 50 um
  roller_parallelism_limit: 2 um
  spring_back_limit: 5%
  web_straightness_limit: 1 mm/m
semantic:
  alternative_parents: []
