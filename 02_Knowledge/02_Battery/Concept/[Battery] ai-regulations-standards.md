...
object:
  description: EU AI Act 및 글로벌 표준에 따른 AI 시스템의 사회적/산업적 신뢰 품질(Trust Quality) 확보를 위한
    규제 준수 및 제약 조건 명세
  object_type: Concept
  tier: 1
properties:
  anonymization_level: 100%
  audit_cycle_months: 6-12
  bias_tolerance_delta: '0.05'
  carbon_footprint_limit: 10 g CO2/k-param
  differential_privacy_param: epsilon
  explainability_local_fidelity: '0.9'
  safety_latency_ms: '100'
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 02_Battery]]'
spo_graph:
- evidence_coordinate: '[데이터 부재] Section 1'
  intent: compliance_threshold
