...
object:
  ...
  tier: 1
properties:
  pipeline_architecture: finbert_llm_dual_core
  sentiment_final_formula: sum(intensity * confidence * omega)
  target_correlation_coefficient: 0.6
  target_f1_score: 0.85
  target_inference_latency_ms: 10
  target_throughput_art_sec: 1000
  weight_gov_policy: 0.4
  weight_prof_news: 0.3
  weight_social_media: 0.2
  weight_voice_call: 0.1
semantic:
  alternative_parents: []
