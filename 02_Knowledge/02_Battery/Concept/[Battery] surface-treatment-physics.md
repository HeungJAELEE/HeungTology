...
object:
  ...
  tier: 1
properties:
  adhesion_test_method: 180-degree peel test
  electrochemical_deposition_model: Butler-Volmer
  external_data_log: Battery-Surface-Energy-and-Adhesion-Strength-Log_2026-05-16
  peel_strength_threshold: 100 N/m
  roughness_wetting_model: Wenzel
  surface_energy_audit_tool: Dyne Pen
  surface_energy_threshold: 70 mN/m
  wetting_equilibrium_model: Young-Dupré
semantic:
  alternative_parents: []
