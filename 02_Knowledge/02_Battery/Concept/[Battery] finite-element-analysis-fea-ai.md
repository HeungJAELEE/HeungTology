...
lineage:
  ...
  original_hash: 01e5fad3b5499a1636f06a11aa4a680ef63a85ac09f1603cb5aea8f907cf7550
metadata:
  date: '2026-05-16'
  domain: 02_Battery
...
object:
  ...
  tier: 1
properties:
  max_rmse_threshold: 2.0%
  mesh_resolution_nodes: 10^5~10^7
  target_inference_latency: < 1.0s
  target_speedup_ratio: 100x~1,000x
  traditional_fea_complexity: O(n^3)
semantic:
  alternative_parents: []
