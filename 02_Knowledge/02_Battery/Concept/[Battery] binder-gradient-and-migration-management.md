...
object:
  ...
  tier: 1
properties:
  bottom_binder_deficit_threshold: 20%
  fidelity_engine_temp_tolerance: 0.5 C
  interfacial_resistance_limit: 0.1 ohm*cm^2
  peclet_critical_threshold: '1.5'
  reference_db_endpoint: Binder_Migration_RAG_V6.3.7_Tiered
  residual_solvent_limit: 100 ppm
  target_migration_index: '1.3'
  target_peclet_number: '1.0'
  target_peel_strength: 25 gf/mm
semantic:
  alternative_parents: []
