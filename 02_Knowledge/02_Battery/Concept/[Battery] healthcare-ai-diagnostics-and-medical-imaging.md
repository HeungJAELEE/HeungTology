...
object:
  description: '[Battery] healthcare-ai-diagnostics-and-medical-imaging에 관한 고밀도 지능
    노드'
  object_type: Hardware
  tier: 1
properties:
  biocompatibility_temp_threshold: < 40.0C
  diagnostic_latency_limit: < 1.0s
  diagnostic_reliability: '> 99.9%'
  leakage_current_detection_threshold: < 10uA
  voltage_sampling_precision: '>= 16-bit'
semantic:
  alternative_parents: []
