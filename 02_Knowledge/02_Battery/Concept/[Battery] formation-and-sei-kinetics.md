...
lineage:
  ...
  original_hash: 26a5a30807bf311ff2aff4bc3d3167f42657e9ea848e812a604775c85ce37a15
metadata:
  date: '2026-05-16'
  domain: 02_Battery
...
object:
  ...
  tier: 1
properties:
  aging_temp_tolerance: 0.5 C
  aging_temp_verified: 55.0 C
  fidelity_engine_version: V7.5.2
  formation_current_tolerance: 0.005 C
  formation_current_verified: 0.08 C
  gas_evolution_tolerance: 0.5 mL
  gas_evolution_verified: 14.2 mL/Ah
  high_ni_threshold: 90%+
  k_adj_threshold: 0.5 mV/h
  k_value_accuracy_unit: 0.1 mV
  k_value_tolerance: 0.01 mV/h
  k_value_verified: 0.32 mV/h
  sei_thickness_tolerance: 2 nm
  sei_thickness_verified: 22.4 nm
semantic:
  alternative_parents: []
