...
object:
  description: ISA-95 수직 통합 모델과 TSN(Time Sensitive Networking) 기반의 고신뢰성 초저지연 배터리 자율
    제조 스마트 팩토리 아키텍처 설계 명세
  object_type: Concept
  tier: 1
properties:
  buffer_queue_delay_tolerance: 0.2ms
  buffer_queue_delay_verified: 3.12ms
  external_db_endpoint: battery-smart-factory-oee-log-v2026
  oee_target: 88.0%
  oee_tolerance: 0.5%
  oee_verified: 89.2%
  packet_loss_tolerance: '1.0e-8'
  packet_loss_verified: '1.2e-7'
  quality_sensor_sampling_rate_tolerance: 0.1kHz
  quality_sensor_sampling_rate_verified: 2.5kHz
  realtime_process_throughput_tolerance: 1.0Gbps
  realtime_process_throughput_verified: 24.5Gbps
  tsn_sync_precision_tolerance: 0.05us
  tsn_sync_precision_verified: 0.82us
semantic:
  alternative_parents: []
