...
object:
  ...
  tier: 1
properties:
  bms_chip_throttling_threshold_celsius: 85
  bms_junction_temp_stable_limit_celsius: 65
  conduction_law: fourier_law
  convection_law: newton_cooling_law
  max_cell_temp_delta_celsius: 3
  max_pack_temperature_celsius: 45
semantic:
  alternative_parents: []
