...
object:
  ...
  tier: 1
properties:
  anode_reversible_capacity_verified: 542.0 mAh/g
  cathode_discharge_capacity_verified: 224.2 mAh/g
  data_source_endpoint: battery-high-nickel-cathode-and-silicon-anode-materials-log-v2026
  h2_h3_phase_transition_voltage_verified: 4.15 V
  max_lattice_strain_epsilon_c: -3.2%
  max_nano_silicon_particle_diameter: 120 nm
  ni_content_ratio: '0.90'
  sei_layer_average_thickness_verified: 28.5 nm
  si_volume_expansion_verified: 300.0 %
  silicon_youngs_modulus: 80 GPa
  swcnt_conductive_agent_content_verified: 0.10 wt%
semantic:
  alternative_parents: []
