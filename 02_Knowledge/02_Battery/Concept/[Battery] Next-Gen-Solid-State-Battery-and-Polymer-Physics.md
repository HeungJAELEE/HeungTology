...
object:
  ...
  tier: 1
properties:
  critical_current_density_ccd_target: '> 2.0 mA/cm2'
  glass_transition_temperature_tg_target: < -40 C
  interface_resistance_asr_target: < 10.0 Ohm-cm2
  ion_conductivity_sulfide_target: '> 10.0 mS/cm'
  stack_pressure_range: 1-10 MPa
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 02_Battery]]'
spo_graph:
- evidence_coordinate: '[데이터 부재] Section 1.2'
  intent: technical_threshold
  object: 10.0 mS/cm
  predicate: has_theoretical_limit
  subject: Solid Electrolyte
  weight: 0.9
- evidence_coordinate: '[데이터 부재] Section 2.1'
  intent: physical_dependency
