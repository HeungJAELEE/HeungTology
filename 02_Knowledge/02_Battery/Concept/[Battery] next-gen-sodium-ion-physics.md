...
object:
  description: 나트륨($Na^+$)의 큰 이온 반경($1.02 \text{ \AA}$)과 낮은 환원 전위에 따른 결정 격자 상전이 및
    알루미늄($Al$) 집전체 활용의 열역학적 분석 지능
  object_type: Concept
  tier: 1
properties:
  cathode_specific_capacity_verified: 120-140 mAh/g
  cost_reduction_threshold: 30%
  diffusion_coefficient_na_verified: 10^-12 to 10^-10 cm^2/s
  energy_density_cell_verified: 120-150 Wh/kg
  hard_carbon_d002_threshold: 0.37 nm
  na_ion_radius: 1.02 Å
  operating_temp_lower_limit: -40 °C
  reduction_potential: -2.71 V
semantic:
  alternative_parents: []
