...
object:
  description: 폐전자제품 및 배터리에서 고농도의 핵심 광물(Li, Ni, Co, REE)을 회수하기 위한 도시 광산 기술 및 자원 순환
    전략
  object_type: Data
  tier: 1
properties:
  natural_gold_concentration: 5g/t
  theoretical_carbon_reduction: 85%
  theoretical_gold_concentration: 500g/t
  theoretical_metal_purity: 99.99%
  verified_carbon_reduction: 70%
  verified_gold_concentration: 200-300g/t
  verified_metal_purity: 99.9%
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재] Page 1'
  intent: operational_verification
  object: 99.9%
...
|:---|:---:|:---:|:---|
| Gold Concentration (g/t) | 500g | 200-300g | [데이터 부재] |
| Metal Purity (%) | 99.99% | 99.9% | [데이터 부재] |
| Carbon Reduction (%) | 85% | 70% | [데이터 부재] |
