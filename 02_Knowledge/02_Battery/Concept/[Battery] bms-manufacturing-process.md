...
lineage:
  ...
  original_hash: ba4f4041ad498e74c5a790ce6f7df4946cc12cdfd049209f7a4360874bfd8b01
metadata:
  date: '2026-05-16'
  domain: 02_Battery
...
object:
  ...
  tier: 1
properties:
  coating_thickness_design: 125um
  compliance_standard: IPC-A-610 Class 3
  hi_pot_voltage_verified: '> 3.0kV'
  high_end_dpmo_target: < 10
  high_end_placement_accuracy: < +/-10um
  imc_thickness_threshold: 4um
  isolation_resistance_verified: '> 1000MOhm'
  low_end_dpmo_target: '> 500'
  low_end_placement_accuracy: '> +/-50um'
  spi_coverage_verified: 100 +/- 15%
  standard_dpmo_target: 50-100
  standard_placement_accuracy: < +/-30um
semantic:
  alternative_parents: []
