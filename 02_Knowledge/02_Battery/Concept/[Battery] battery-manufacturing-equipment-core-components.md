...
object:
  description: '[Battery] battery-manufacturing-equipment-core-components에 관한 고밀도
    지능 노드'
  object_type: Hardware
  tier: 1
properties:
  audit_health_tolerance: '0.02'
  fidelity_engine_audit_endpoint: DomainFidelityEngine_Audit
  formation_probe_contact_resistance_target: 1 mOhm
  hardware_rag_endpoint: Battery_Hardware_RAG_V6.3.7_Deterministic_Linkage
  mixing_shear_rate_target: 500 s-1
  roll_press_line_pressure_target: 1000 kgf/cm
  slot_die_gap_uniformity_target: 1um
  slot_die_lip_gap_tolerance: 1um
  winding_mandrel_run_out_target: 0.02 mm
semantic:
  alternative_parents: []
