...
object:
  ...
  tier: 1
properties:
  computational_complexity_verified: O(n^3)
  control_loop_frequency_verified: 10~100 Hz
  default_dt: '0.1'
  default_q_noise: 1e-5
  default_r_noise: 1e-3
  initial_error_covariance: '0.1'
  initial_soc_estimate: '0.8'
  initialization_time_verified: <10 sec
  lfp_voltage_plateau_range: 3.2~3.3 V
  soc_rmse_verified: 1.0~2.0%
  soh_capacity_error_verified: <3.0%
semantic:
  alternative_parents: []
