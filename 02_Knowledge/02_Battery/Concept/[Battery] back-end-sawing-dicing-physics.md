...
object:
  ...
  tier: 1
properties:
  chipping_size_blade_max: 10 um
  chipping_size_stealth_max: 1 um
  die_strength_ratio_stealth_min: '1.5'
  feed_speed_blade_range: 100-300 mm/s
  feed_speed_stealth_min: 500 mm/s
  industrial_standard_ref: SEMI-DICE-2026-S1.1
  kerf_width_blade_range: 30-50 um
  kerf_width_stealth_approx: 0 um
  laser_dynamics_ref: SEMI-DICE-2026-S1.3
  modified_layer_thickness_threshold: '0.2'
  spindle_vibration_max: 1.0 g
  theoretical_model_ref: SEMI-DICE-2026-S1.2
  thermal_haz_stealth: 0 um
semantic:
  alternative_parents: []
