...
object:
  description: 음극재의 결정성(Crystallinity) 제어 및 실리콘 기반 소재의 부피 팽창 억제를 위한 초고온 소성 및 정밀 표면
    개질 공정 마스터 가이드
  object_type: Algorithm
  tier: 1
properties:
  bet_specific_surface_area_measured: 1.5 ~ 4.0 m2/g
  bet_specific_surface_area_theoretical: 1.0 m2/g
  bet_specific_surface_area_tolerance: ± 0.5 m2/g
  carbon_purity_measured: '> 99.95 %'
  carbon_purity_theoretical: '> 99.99 %'
  carbon_purity_tolerance: ± 0.01 %
  graphitization_temperature_measured: 2800 ~ 3200 °C
  graphitization_temperature_theoretical: 3200 °C
  graphitization_temperature_tolerance: ± 50 °C
  specific_capacity_measured: 350 ~ 370 mAh/g
  specific_capacity_theoretical: 372 mAh/g
  specific_capacity_tolerance: ± 5 mAh/g
  tap_density_measured: 1.0 ~ 1.2 g/cc
  tap_density_theoretical: 1.25 g/cc
  tap_density_tolerance: ± 0.05 g/cc
semantic:
  alternative_parents: []
