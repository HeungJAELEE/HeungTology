...
object:
  ...
  tier: 1
properties:
  atomic_engineer_weight: 0.35
  ax_management_efficiency_multiplier: 3.0
  ax_process_sigma_improvement_rate: 0.2
  bms_intelligence_weight: 0.15
  bridge_engineer_annual_revenue_impact_krw: 15000000000
  bridge_engineer_rampup_reduction_months: 3
  experience_curve_normalization_limit: 10
  lithium_plating_ai_scarcity_index: 0.94
  passport_auditor_weight: 0.05
  physical_ai_pm_weight: 0.45
  recycling_kinetics_scarcity_index: 0.85
  senior_specialist_threshold: 0.5
  solid_state_interface_scarcity_index: 0.92
  standard_lib_ops_scarcity_index: 0.1
  supreme_strategic_threshold: 0.8
semantic:
  alternative_parents: []
