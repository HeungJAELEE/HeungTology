...
lineage:
  ...
  original_hash: 8788342e186b44f8ed73ef0aa4f59c99df7cc03b0e003143ec3b7c98be7b59a5
metadata:
  date: '2026-05-16'
  domain: 02_Battery
...
properties:
  ac_ir_tolerance: ± 10%
  dry_room_moisture_limit: 100 ppm
  electrolyte_wetting_rate_min: 99%
  formation_cycle_time: 24-48 hours
  formation_jig_pressure_uniformity: ± 5%
  ocv_drop_target: < 2.0 mV/day
  ocv_drop_trigger: '> 5.0 mV/day'
  ref_standard: BAT-PROC-V6
  tab_welding_pull_strength_min: 30 N
  vacuum_seal_leak_rate_max: 10^-3 Pa*m^3/s
semantic:
  alternative_parents: []
