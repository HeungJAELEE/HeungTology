...
lineage:
  ...
  original_hash: d623e69c4575ef7e43a0caf87d063faa7535bba50c0d17c6a9e4ac11322e2a8a
metadata:
  date: '2026-05-16'
  domain: 02_Battery
...
object:
  ...
  tier: 1
properties:
  capacity_standard_deviation_limit: 1%
  defect_escaping_target: < 10 ppm
  hds_gold_version: V7.5.2
  material_yield_verified_target: '> 98%'
  moisture_dew_point_target: <= -40 C
  moisture_threshold: -40
  mtbf_verified_target: '> 168 hrs'
  mttr_verified_target: < 2.0 hrs
  oee_threshold: 80.0
  oee_verified_target: '> 85%'
  safety_interlock_response_time: < 50 ms
