...
object:
  description: 다이 레벨 미세 회로와 패키지 리드 간의 연결을 위해 열, 압력, 초음파를 활용한 원자 레벨 융합 공정 및 금속 간 화합물(IMC)
    성장 제어 역학
  object_type: Concept
  tier: 1
properties:
  bonding_load: 45 +/- 1.0 gf
  bonding_temperature: 175 +/- 2.0 C
  imc_thickness: 0.8 ~ 1.2 um
  loop_height_deviation: +/- 2.0 um
  nsop_detection_latency: 10 ms
  pull_strength: '> 12 gf'
  shear_strength: '> 45 gf'
  ultrasonic_power: 120 +/- 0.5 kHz
semantic:
  alternative_parents: []
