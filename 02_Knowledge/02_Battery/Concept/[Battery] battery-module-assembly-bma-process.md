...
object:
  ...
  tier: 1
properties:
  cell_resistance_deviation_threshold: 0.1 mΩ
  cycle_time_limit: 30 sec/module
  insulation_leakage_current_limit: 10 μA @ 2 kV
  ir_matching_delta_target: ±0.05 mΩ
  ocv_matching_delta_target: ±1 mV
  robot_positioning_precision: ±50 μm
  surface_pressure_range: 0.5-2.0 MPa
  theoretical_ir_matching_limit: ±0.1 mΩ
  theoretical_ocv_matching_limit: ±2.0 mV
  theoretical_positioning_accuracy_limit: ±100 μm
  theoretical_pre_compression_range: 0.1-5.0 MPa
  theoretical_weld_porosity_limit: 3.0%
  weld_depth_variation_limit: ±5%
  weld_porosity_limit: 1%
semantic:
  alternative_parents: []
