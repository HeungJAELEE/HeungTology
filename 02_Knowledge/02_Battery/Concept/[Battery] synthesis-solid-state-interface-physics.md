...
object:
  description: 고체 전극과 고체 전해질 사이의 nm 스케일 계면에서 발생하는 화학-기계적 상호작용 및 공간 전하층(SCL) 형성 억제
    지능
  object_type: Concept
  tier: 1
properties:
  buffer_layer_thickness: 2 ~ 10 nm
  critical_current_density: '> 5.0 mA/cm2'
  effective_contact_area_ratio: '> 95%'
  exchange_current_density: '> 1.0 mA/cm2'
  interface_asr_resistance: < 5.0 Ohm cm2
  stack_pressure: 1 ~ 15 MPa
semantic:
  alternative_parents: []
