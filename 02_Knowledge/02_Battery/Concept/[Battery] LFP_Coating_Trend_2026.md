...
object:
  ...
  tier: 1
properties:
  compaction_std_ref: LFP_Compaction_Std
  electrode_porosity_theoretical: 20%
  electrode_porosity_verified: 25 +/- 2%
  hot_rolling_temp_threshold: '> 100°C'
  interface_adhesion_improvement: 20%
  lfp_compaction_density_theoretical: 2.2 g/cc
  lfp_compaction_density_verified: 2.5 g/cc
  porosity_spec_ref: Porosity_Spec
  precision_log_endpoint: battery-assembly-precision-log-v2026
  t_diff_threshold: < 5°C
  thermal_dynamics_manual_ref: Thermal_Dynamics_Manual
  verification_protocol_ref: Standard_Verification_Protocol
semantic:
  alternative_parents: []
