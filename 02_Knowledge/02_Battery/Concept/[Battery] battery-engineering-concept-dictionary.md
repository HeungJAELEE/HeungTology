...
object:
  ...
  tier: 1
properties:
  binder_swelling_threshold: < 10%
  isa95_latency_threshold: < 100 ms
  lims_quality_precision: ± 0.01%
  linkage_density_threshold: '> 90%'
  natural_frequency_range: 20-100 kHz
  ontology_specification: HDS-Gold V7.5.3
  power_law_index_range: 0.2-0.8
  viscosity_range: 1,000-10,000 cP
  welding_depth_range: 0.1-0.5 mm
semantic:
  alternative_parents: []
