...
object:
  ...
  tier: 1
properties:
  cpk_danger_threshold: 1.33
  inspection_log_endpoint: battery-qc-metrology-and-inspection-log-v2026
  leak_rate_critical_threshold: 1.0e-07
  leak_sensitivity_verified_atm_cc_s: 8.4e-09
  ocv_stability_verified_mv_day: 0.42
  spc_cpk_verified_index: 1.84
  thickness_accuracy_verified_um: 0.32
  ultrasonic_freq_verified_mhz: 7.5
  xray_res_limit_um: 50.0
  xray_resolution_verified_um: 38.5
semantic:
  alternative_parents: []
