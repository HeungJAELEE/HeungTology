...
object:
  description: GWh급 대용량 ESS의 안전 무결성과 경제적 수익성(Arbitrage)을 동시 최적화하기 위한 BMS-EMS 통합 제어
    계층 아키텍처
  object_type: Algorithm
  tier: 1
properties:
  balancing_efficiency_target: 10mV
  comm_reliability_plr_target: 1e-6
  frequency_droop_coefficient: K_f
  pfr_latency_target: 20ms
  sampling_rate_target: 10Hz
  soc_error_threshold: 5%
  soc_rmse_target: 2.0%
  soh_fidelity_target: 3.0%
  thermal_gradient_target: 5C
  virtual_inertia_coefficient: M
semantic:
  alternative_parents: []
