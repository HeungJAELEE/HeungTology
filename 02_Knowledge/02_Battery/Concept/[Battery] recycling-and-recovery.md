...
lineage:
  ...
  original_hash: 3900693484ee5c6ca91e64bd6ae8aa3a74d6ae6675f3e1327a07fc41212c4dbf
metadata:
  date: '2026-05-16'
  domain: 02_Battery
...
object:
  ...
  tier: 1
properties:
  acid_consumption_h2so4: 2.0-3.0 kg/kg
  carbon_footprint_dr: < 0.5 kg CO2/kg
  carbon_footprint_hydro: 1.2-1.5 kg CO2/kg
  eu_battery_regulation_ref: EU 2023/1542
  leaching_yield_90min: '> 90%'
  li_recovery_rate_target_dr: '> 90%'
  li_recovery_rate_target_hydro: '> 80%'
  ni_co_recovery_efficiency_dr: '> 98%'
  ni_co_recovery_efficiency_hydro: '> 95%'
  precursor_purity_battery_grade: '> 99.9%'
  verified_co_purity: 99.92%
  verified_leaching_temp: 82.4°C
  verified_li_recovery: 84.2%
  verified_ni_leaching_yield: 95.7%
semantic:
  alternative_parents: []
