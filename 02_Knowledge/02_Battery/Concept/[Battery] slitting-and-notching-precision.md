...
object:
  ...
  tier: 1
properties:
  laser_burr_height_max: 3.0um
  laser_edge_roughness_max: 1.5um
  laser_haz_width_max: 30um
  laser_line_speed_min: 200m/min
  laser_pitch_accuracy: 0.02mm
  mechanical_burr_height_max: 8.0um
  safety_integrity_crisis_threshold: 6.4um
  vacuum_dust_efficiency_min: 99.99%
semantic:
  alternative_parents: []
