...
lineage:
  ...
  original_hash: 6c9444fce60e73078a766a3d338384a360d209dbca112dc1f005de4a7ebc4219
metadata:
  date: '2026-05-16'
  domain: 02_Battery
...
object:
  ...
  tier: 1
properties:
  high_solid_content_threshold: '> 70%'
  high_speed_coating_threshold: '> 80 m/min'
  pdi_index_target_tier1: < 0.1
  pdi_index_tolerance: +/- 0.01
  shear_thinning_index_n_tier1: 0.3-0.5
  shear_thinning_tolerance: +/- 0.02
  tier1_solid_content: '> 75%'
  tier1_viscosity_variance: < +/- 0.5%
  tier2_solid_content: 70-73%
  tier2_viscosity_variance: < +/- 2.0%
  tier3_solid_content: 65-68%
  tier3_viscosity_variance: < +/- 5.0%
  yield_stress_target_tier1: '> 10 Pa'
  yield_stress_tolerance: +/- 1 Pa
  zeta_potential_target_tier1: '> 40 mV'
  zeta_potential_tolerance: +/- 2 mV
semantic:
  alternative_parents: []
