...
object:
  description: 전극 합제 밀도를 극대화하고 기공 구조를 최적화하기 위해 헤르츠 접촉 응력(Hertzian Stress) 기반의 초고압
    압착 공정을 제어하는 제조 지능
  object_type: Hardware
  tier: 1
properties:
  adhesion_force_threshold: '>= 20 gf/mm'
  gap_servo_accuracy: ± 1.0 um
  hertzian_contact_stress_formula: Pmax = 3F / (2πab)
  line_speed_range: 30 ~ 100 m/min
  max_roll_force: 100 ~ 1,000 Tons
  pore_tortuosity_threshold: < 3.0
  roll_diameter_range: 600 ~ 1,000 mm
  roll_flatness_accuracy: < 2.0 um
  roll_surface_hardness: '> 70 HRC'
  spring_back_model: Gap = Final / (1 + alpha)
semantic:
  alternative_parents: []
