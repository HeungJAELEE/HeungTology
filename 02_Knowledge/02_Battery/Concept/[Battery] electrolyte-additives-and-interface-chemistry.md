...
object:
  ...
  tier: 1
properties:
  additive_composition_threshold: < 5%
  flash_point_ideal: 180 C
  flash_point_verified: 155 C
  interface_stability_index_formula: gamma_sei = E_adhesion / (E_stress * sigma_ion)
  ionic_conductivity_ideal: 12.0 mS/cm
  ionic_conductivity_verified: 10.2 mS/cm
  moisture_content_ideal: 5 ppm
  moisture_content_verified: 18 ppm
  oxidation_potential_ideal: 4.8 V
  oxidation_potential_verified: 4.52 V
  sei_resistance_ideal: 2.0 ohm*cm^2
  sei_resistance_verified: 4.8 ohm*cm^2
semantic:
  alternative_parents: []
...
| :--- | :---: | :---: | :---: | :--- |
| **Ionic Conductivity** | $\sigma_{ion}$ | $12.0 \text{ mS/cm}$ | $10.2 \text{ mS/cm}$ | [데이터 부재] |
| **Voltage Window** | Oxidation Potential | $4.8 \text{ V}$ | $4.52 \text{ V}$ | [데이터 부재] |
| **SEI Resistance** | $R_{sei}$ | $2.0 \text{ \Omega\cdot cm}^2$ | $4.8 \text{ \Omega\cdot cm}^2$ | [데이터 부재] |
| **Flame Retardancy** | Flash Point | $180 ^\circ\text{C}$ | $155 ^\circ\text{C}$ | [데이터 부재] |
| **Moisture Content** | $H_2O$ ppm | $5 \text{ ppm}$ | $18 \text{ ppm}$ | [데이터 부재] |
