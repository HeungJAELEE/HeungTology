...
object:
  ...
  tier: 1
properties:
  cycle_life_target: '> 3,000 cycles'
  fast_charge_rate_target: < 15 min
  gravimetric_energy_density_target: '> 450 Wh/kg'
  lcos_target: < $50/MWh
  tr_trigger_temp_threshold: '> 250 °C'
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 02_Battery]]'
spo_graph:
- evidence_coordinate: '[데이터 부재] Section 1.1'
  intent: integrity_definition
