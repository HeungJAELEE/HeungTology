...
object:
  description: NCM811 하이니켈 셀의 화성 공정 dQ/dV 미분 용량 곡선 분석, SEI 형성 열역학 및 LLI/LAM 전기화학적
    열화 진단 이론 노드
  object_type: Algorithm
  tier: 1
properties:
  external_db_endpoint: '[[[Battery] battery-formation-dqdv-curve-analysis-v2026]]'
  lam_warning_capacity_retention: 0.85
  lam_warning_intensity_threshold: 0.85
  lli_warning_voltage_shift: 0.05
  peak_1_capacity_spec: 120.5
  peak_1_control_margin: 0.02
  peak_1_target_voltage: 3.72
  peak_2_capacity_spec: 45.2
  peak_2_control_margin: 0.03
  peak_2_target_voltage: 4.02
  peak_3_capacity_spec: 15.8
  peak_3_control_margin: 0.01
  peak_3_target_voltage: 4.2
  soh_healthy_threshold: 0.9
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 02_Battery]]'
spo_graph:
- evidence_coordinate: '[데이터 부재] Section 2.0'
  intent: physical_signature_mapping
...
- evidence_coordinate: '[데이터 부재] Section 4.2'
  intent: degradation_quantification
