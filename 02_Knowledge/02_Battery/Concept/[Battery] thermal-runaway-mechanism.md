...
object:
  ...
  tier: 1
properties:
  aerogel_thickness: 1.5mm
  barrier_thermal_conductivity: < 0.05 W/mK
  bms_fault_log_endpoint: battery-bms-fault-log-v2026
  delta_h_tr: 500-1000 kJ/kg
  h2_content: 30-50%
  heat_release_rate: '> 10 kW/cell'
  materials_chemistry_guide_endpoint: battery-materials-and-chemistry-master-guide
  oxygen_release_rate: '> 5 wt%'
  packaging_architecture_endpoint: Battery packaging-2.5d-cowos-architecture
  pouch_swelling_test_endpoint: battery-pouch-swelling-test-results-v2026
  quality_analytics_guide_endpoint: battery-quality-analytics-and-forensics-master-guide
  t_onset: '> 120°C'
  t_tr: '> 250°C'
  t_vent: 150-180°C
  theoretical_t_onset: 135°C
semantic:
  alternative_parents: []
