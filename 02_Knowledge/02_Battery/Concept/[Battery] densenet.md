...
object:
  description: 배터리 전극 표면의 미세 결함(Micro-cracks, Particle Contamination) 탐지를 위한 특징 재사용
    최적화 DenseNet 아키텍처
  object_type: Algorithm
  tier: 1
properties:
  coating_line_speed: 80mpm
  compression_theta: '0.5'
  densenet_121_parameters: 8.0M
  growth_rate: 32-48
  inference_latency_threshold: 30ms/frame
  input_resolution: 1024x1024
  min_defect_size: 10um
  pinhole_detection_accuracy: 98.5%
  standard_compliance: Manson-standard HDS-Gold
semantic:
  alternative_parents: []
