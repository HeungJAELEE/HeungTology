...
lineage:
  ...
  original_hash: d8c09a31af3a124c1291a21efddbdc8bfffae1b3a454caea88ba415b4e357fce
metadata:
  date: '2026-05-16'
  domain: 02_Battery
...
object:
  description: '[Battery] W13_prismatic-cell-vacuum-filling-optimization에 관한 고밀도 지능
    노드'
  object_type: Algorithm
  tier: 1
properties:
  base_pressure_target: 10 mbar
  filling_weight_tolerance: 0.5 g
  final_saturation_threshold: 99.5%
  pre_heating_temp_range: 40-60 C
  reference_db_endpoint: ENTITY-BAT-INJECTION-2026-V6.3.7
  vacuum_pulse_count: 3-5
  vacuum_target_mbar: 10.0
  wetting_limit_pct: 99.5
semantic:
  alternative_parents: []
