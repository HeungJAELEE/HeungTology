...
object:
  ...
  tier: 1
properties:
  convergence_logic_reinforcement: Bellman Equation
  convergence_logic_supervised: SGD / Adam
  convergence_logic_unsupervised: Global/Local Opt.
  generalization_gap_threshold: < 0.15
  regularization_reinforcement: Entropy Reg.
  regularization_supervised: L1, L2
  regularization_unsupervised: PCA
  supervised_complexity: O(n^2) ~ O(n log n)
  unsupervised_complexity: O(nk) ~ O(n^3)
semantic:
  alternative_parents: []
