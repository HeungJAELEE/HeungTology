...
object:
  ...
  tier: 1
properties:
  carbon_intensity_2031_target: 60% vs Virgin
  carbon_reduction_efficiency_verified: 60.0%
  dismantling_speed_2031_target: 15 min/pack
  li_recovery_rate_2031_target: 80%
  li_recovery_theoretical_limit: 95.0%
  ni_co_recovery_rate_2031_target: 95%
  ni_co_recovery_theoretical_limit: 99.0%
  passport_compliance_target: 100%
  precursor_purity_2031_target: 99.9%
  precursor_purity_theoretical_limit: 99.99%
  recycled_content_2031_target: 16-25%
  second_life_soh_threshold: 70%
semantic:
  alternative_parents: []
