...
lineage:
  ...
  original_hash: 6761e1e2d46fa4e9ac41b372c44c5cb3c6916c484e61120b5c7d10bc8249681f
metadata:
  date: '2026-05-16'
  domain: 02_Battery
...
object:
  ...
  tier: 1
properties:
  binary_encoding_threshold: 10 < C < 100
  complexity_reduction: O(C) -> O(1)
  one_hot_threshold: C < 10
  smoothing_coefficient_formula: n_c / (n_c + m)
  smoothing_parameter: m
  target_encoding_threshold: C > 100
semantic:
  alternative_parents: []
