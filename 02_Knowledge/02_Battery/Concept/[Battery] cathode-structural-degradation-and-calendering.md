...
lineage:
  ...
  original_hash: db61861fe178429ab18a07c9c3826e349a8c05a5e7ef3ffb07ba5f566786a8a7
metadata:
  date: '2026-05-16'
  domain: 02_Battery
...
object:
  description: '[Battery] cathode-structural-degradation-and-calendering에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  compact_density_polycrystalline: 3.4-3.6 g/cm3
  compact_density_single_crystal: 3.7-3.9 g/cm3
  external_db_reference: V6.3.7
  heated_roll_operation_temp: 80-130 C
  line_pressure_polycrystalline: 0.5-1.0 ton/cm
  line_pressure_single_crystal: 1.2-2.0 ton/cm
  p_max_deviation: ±2.4%
  porosity_polycrystalline: 25-30%
  porosity_single_crystal: 20-24%
  roll_diameter_polycrystalline: 600-800 mm
  roll_diameter_single_crystal: '>1000 mm'
  sigma_f_deviation: ±5.1%
  spring_back_polycrystalline: 5-10%
  spring_back_single_crystal: 3-7%
semantic:
  alternative_parents: []
