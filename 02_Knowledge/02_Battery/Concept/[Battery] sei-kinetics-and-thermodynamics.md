...
lineage:
  ...
  original_hash: a15a90a5d7353fb7c281b9b8a85b585c52414e478624a89483a78b9717b019b8
metadata:
  date: '2026-05-16'
  domain: 02_Battery
...
object:
  ...
  tier: 1
properties:
  elastic_modulus_range_gpa: 1-10
  exchange_current_density_range_a_cm2: 10^-4 to 10^-3
  growth_rate_model: sqrt(t)
  ionic_conductivity_range_s_cm: 10^-8 to 10^-7
  li_diffusion_coefficient_range_cm2_s: 10^-12 to 10^-10
  lumo_potential_threshold_ev: '> -1.0'
  sei_thickness_range_nm: 10-50
  si_anode_expansion_threshold_percent: '> 300'
  simulation_engine_version: HDS-Gold V7.5.2
  transfer_coefficient_alpha: '0.5'
semantic:
  alternative_parents: []
