...
object:
  ...
  tier: 1
properties:
  edge_uniformity_width_tol_mm: ±0.5
  external_db_refs:
  - BAT-SOP-01
  - BAT-SOP-02
  - BAT-SOP-03
  ...
  - RHEO-STD-V4
  - MASS-TRANS-M1
  loading_level_precision: ±1.0%
  mixing_energy_range_wh_kg: 50-150
  oven_humidity_dew_point_max_c: -40
  peclet_number_threshold: 1
  peel_strength_min_gf_mm: 10
  shear_rate_die_exit_s_inv: 100-500
  slurry_viscosity_range_cp: 2000-10000
  slurry_viscosity_trigger_delta: 15%
  solids_content_stability: ±0.5%
semantic:
  alternative_parents: []
