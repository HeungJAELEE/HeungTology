...
object:
  ...
  tier: 1
properties:
  boundary_layer_thickness_formula: sqrt(nu*L/U_inf)
  capillary_pressure_formula: 2*gamma*cos(theta)/r
  cleaning_mechanisms:
  - megasonic_high_frequency_vibration
  ...
  - dew_point_sensor
  - karl_fischer_method
  residual_moisture_limit: 10 ppm
