...
object:
  ...
  tier: 1
properties:
  high_nickel_threshold: '> 90%'
  lfp_energy_density: 160-200 Wh/kg
  lfp_t_onset: 270 °C
  ncm_energy_density: 300-350 Wh/kg
  ncm_t_onset: 210 °C
  nernst_equation: E = E^0 - (RT/nF)lnQ
  ssb_energy_density: '> 450 Wh/kg'
  ssb_t_onset: '> 400 °C'
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 02_Battery]]'
spo_graph:
- evidence_coordinate: '[데이터 부재] Table 2'
...
- evidence_coordinate: '[데이터 부재] Section 4'
  intent: computational_dependency
