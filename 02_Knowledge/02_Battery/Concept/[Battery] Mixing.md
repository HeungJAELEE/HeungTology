...
object:
  ...
  tier: 1
properties:
  blade_velocity_range: 5 ~ 25 m/s
  cathode_solid_content_range: 75% ~ 85%
  degassing_pressure_threshold: < 100 torr
  dynamic_viscosity_range: 2,000 ~ 6,000 cP
  fineness_of_grind_threshold: < 15 um
  flow_behavior_index_condition: n < 1
  process_cooling_temp_range: 20 ~ 30 C
  reference_id: BAT-MIXING-2026-V6
  verified_particle_size: 13.5 um
  verified_solid_content: 78.5%
  verified_viscosity: 4,250 cP
  water_based_anode_ph_range: 6.5 ~ 8.5
  zeta_potential_threshold: '> |30| mV'
semantic:
  alternative_parents: []
