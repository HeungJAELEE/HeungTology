...
object:
  description: '[Battery] form-factor-cylindrical-4680-engineering-deep-dive에 관한 고밀도
    지능 노드'
...
properties:
  cell_diameter: 46 mm
  cell_height: 80 mm
  energy_increase_factor: 5x
  internal_resistance_threshold: < 1.0 mOhm
  ir_loss_reduction: 95%
  max_core_temperature: 60°C
  min_weld_density: '1000'
  resistance_formula: rho_foil * L_width / (3 * t_foil * W_height)
  thermal_conductivity_model: sum(phi_i * k_i)
  volume_increase_factor: 5.5x
semantic:
  alternative_parents: []
