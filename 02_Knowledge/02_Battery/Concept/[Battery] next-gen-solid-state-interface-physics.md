...
object:
  ...
  tier: 1
properties:
  area_specific_resistance_target: 10 Ohm.cm^2
  buffer_affinity_potential: '0'
  critical_current_density_threshold: 5.0 mA/cm^2
  interface_ionic_conductivity_min: 10^-4 S/cm
  mechanical_stability_ratio: '> 1.8'
  scl_thickness_max: 5.0 nm
  stack_pressure_range: 5-20 MPa
  verified_ccd_rt: 5.2 mA/cm^2
  verified_elastic_modulus_sulfide: 22 GPa
  verified_interfacial_asr: 8.5 Ohm.cm^2
semantic:
  alternative_parents: []
