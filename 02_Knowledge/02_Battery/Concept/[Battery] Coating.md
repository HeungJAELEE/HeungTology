...
object:
  ...
  tier: 1
properties:
  capillary_number_range: 0.1~10
  capillary_number_tolerance: +/- 0.1
  coating_speed_min: 80 m/min
  coating_speed_tolerance: +/- 0.1 m/min
  high_end_alignment_accuracy: +/- 0.1mm
  high_end_loading_deviation: <+/- 0.3%
  high_speed_jitter_threshold: 100 m/min
  intermittent_lag_max: 0.1 ms
  intermittent_lag_tolerance: +/- 0.01 ms
  low_end_alignment_accuracy: +/- 1.0mm
  low_end_loading_deviation: <+/- 2.0%
  peclet_number_target: '1.0'
  peclet_number_tolerance: +/- 0.2
  standard_alignment_accuracy: +/- 0.5mm
  standard_loading_deviation: <+/- 1.0%
  verified_capillary_number_range: 0.1~5.0
  verified_peclet_number_limit: '2.0'
semantic:
  alternative_parents: []
