...
lineage:
  ...
  original_hash: cad1632d15d03f64eaba730f8b8ae4580334d138ab9b1ed8d2f8505b1e0f2c59
metadata:
  date: '2026-05-16'
  domain: 02_Battery
...
object:
  ...
  tier: 1
properties:
  clamping_force_high_precision: '>= 2000 Ton'
  coefficient_of_thermal_expansion: 2.3e-5 m/mK
  cycle_time_high_precision: 60-90 sec
  injection_speed_high_precision: 80-150 mm/s
  material_base: PA66 + GF30% / Specialty FR-Polymer
  mold_temperature_high_precision: 130-150 degC
  packing_pressure_high_precision: 1000-1500 bar
  part_weight_variance_high_precision: <= 0.2%
  target_warp: 0.5 mm
  warpage_tolerance_high_precision: +/- 0.2 mm
semantic:
  alternative_parents: []
