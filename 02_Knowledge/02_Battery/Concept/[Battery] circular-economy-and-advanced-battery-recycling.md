...
lineage:
  ...
  original_hash: ce7f6cf3117439fd9dee6271124bfc50cb2331cc938bf87f379cf1ada2d5a404
metadata:
  date: '2026-05-16'
  domain: 02_Battery
...
object:
  description: '[Battery] circular-economy-and-advanced-battery-recycling에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  carbon_benefit_threshold: 0.7
  carbon_reduction_rate_verified: 74.2
  data_traceability_verified: 100.0
  dataset_endpoint: battery-recycling-efficiency-log-v2026
  direct_regeneration_energy_reduction_actual: 82.5
  eu_recycled_material_ratio_verified: 12.5
  li_extraction_yield_actual: 92.5
  li_recovery_rate_verified: 92.5
  li_recovery_threshold: 0.9
  ni_co_extraction_yield_actual: 98.8
  ni_co_recovery_rate_verified: 98.8
  reference_doc: BATT-REC-STRAT-v2026
  regulatory_target_year: 2030
semantic:
  alternative_parents: []
