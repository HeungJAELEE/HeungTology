...
lineage:
  ...
  original_hash: 38b8178a9389084de4934164c92674671c5da44170bff9d2d050e59147b3f60e
metadata:
  date: '2026-05-16'
  domain: 02_Battery
...
object:
  description: 배터리 전극 표면 보호(ALD/CVD)를 위한 전구체(Precursor)와 기판 간의 흡착 에너지(Adsorption Energy)
    결정론적 물리 모델
  object_type: Concept
  tier: 1
properties:
  analyzer_version: HDS-Gold V7.6.2
  boltzmann_constant_ev_k: '8.617e-5'
  cycle_coverage_experimental: 35% to 45%
  desorption_barrier_dft: '> 5.0 eV'
  desorption_barrier_xps: '> 4.2 eV'
  h2o_metal_oxide_eads_range: -1.0 to -1.8 eV
  o3_carbon_fiber_eads_range: -3.0 to -4.5 eV
  sicl4_silicon_eads_range: -2.0 to -2.8 eV
  stability_threshold_ev: '-1.5'
  standard_specification: Manson-standard HDS-Gold
  ticl4_graphite_eads_range: -1.5 to -2.0 eV
  tma_adsorption_dft: -3.2 eV
  tma_adsorption_xps: -2.9 eV
  tma_li_ion_oxide_eads_range: -2.5 to -3.5 eV
semantic:
  alternative_parents: []
