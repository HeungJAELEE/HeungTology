...
object:
  description: 배터리 기가팩토리의 비가공 데이터를 산업 지능(Wisdom)으로 승격시켜 수율 및 ROI를 극대화하는 DIKW 가치 사슬
    모델
  object_type: Concept
  tier: 1
properties:
  entropy_audit_rsquared_threshold: 0.95
  legacy_data_integrity: 0.7
  legacy_scrap_cost_per_gwh_usd: 10000000
  legacy_ttm_months: 18
  legacy_yield: 0.85
  maturity_threshold_yield_gain_percent: 5
  optimization_synergy_coefficient: 1.5
  optimized_data_integrity: 0.999
  optimized_scrap_cost_per_gwh_usd: 2000000
  optimized_ttm_months: 6
  revenue_per_gwh_usd: 100000000
  standard_specification: Manson-standard HDS-Gold V7.6.2
  target_yield: 0.97
semantic:
  alternative_parents: []
