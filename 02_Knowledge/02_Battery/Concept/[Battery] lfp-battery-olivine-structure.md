...
object:
  description: 강한 $P-O$ 공유 결합을 지닌 올리빈 구조를 통해 열적 안정성을 확보하고, 나노 구조화를 통해 낮은 전자 전도성을 극복하기
    위한 LFP 소재 설계 지능
  object_type: Concept
  tier: 1
properties:
  anti_site_defect_limit: 1.0%
  anti_site_defect_verified: 0.75%
  bet_surface_area_verified: 16.5 m2/g
  i0_deviation_threshold: 20%
  li_diffusion_ideal: 1.0e-12 cm2/s
  li_diffusion_verified: 0.88e-12 cm2/s
  particle_size_d50_limit: 100 nm
  particle_size_d50_verified: 112 nm
  plateau_voltage_ideal: 3.40 V
  plateau_voltage_verified: 3.36 V
  voltage_drop_risk_threshold: 3.2 V
semantic:
  alternative_parents: []
...
| :--- | :---: | :---: | :---: | :--- |
| **Li Diffusion ($D_{Li}$)** | Ionic Conductivity | $1.0 \times 10^{-12} \text{ cm}^2/\text{s}$ | $0.88 \times 10^{-12} \text{ cm}^2/\text{s}$ | [데이터 부재] |
| **Plateau Voltage** | $V_{avg}$ @ $0.5\text{C}$ | $3.40 \text{ V}$ | $3.36 \text{ V}$ | [데이터 부재] |
| **Anti-site Defect** | $Fe$ on $Li$ site | $0.0 \%$ | $0.75 \%$ | [데이터 부재] |
| **Surface Area** | BET Specific Area | $20.0 \text{ m}^2/\text{g}$ | $16.5 \text{ m}^2/\text{g}$ | [데이터 부재] |
| **Particle Size ($D_{50}$)** | Domain Diameter | $< 100 \text{ nm}$ | $112 \text{ nm}$ | [데이터 부재] |
