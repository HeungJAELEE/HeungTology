...
object:
  ...
  tier: 1
properties:
  input_modalities: voltage, current, temperature
  long_term_prediction_window: 1 hour
  short_term_prediction_window: 10 minutes
  soc_prediction_rmse_threshold: 1.2%
semantic:
  alternative_parents: []
