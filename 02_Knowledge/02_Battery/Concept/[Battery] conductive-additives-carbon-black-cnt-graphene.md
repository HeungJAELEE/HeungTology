...
object:
  ...
  tier: 1
properties:
  carbon_black_wt_pct: 5-10%
  cnt_aspect_ratio: '>1000:1'
  cnt_phi_c_threshold: <1%
  cnt_wt_pct: 0.1-2%
  graphene_wt_pct: 1-3%
  percolation_threshold_model: sigma = sigma_0 * (phi - phi_c)^t
  swcnt_strain_limit: 300%
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재] Section 2'
  intent: mechanical_limit_specification
  object: 300 %
  predicate: measured_value
