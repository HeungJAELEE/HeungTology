...
object:
  ...
  tier: 1
properties:
  assembly_cycle_time_limit: < 3.0 s/cell
  contact_resistance_limit: < 0.1 mOhm
  hermeticity_leak_rate_limit: < 10^-8 Pa*m^3/s
  vent_rupture_pressure_range: 5.0-8.0 bar
  weld_depth_target: 0.5-0.8 mm
semantic:
  alternative_parents: []
