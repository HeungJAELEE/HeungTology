...
object:
  ...
  tier: 1
properties:
  benchmark_dataset_endpoint: w12-multimodal-bench-v2026
  context_window_size_k_tokens: 32.0
  cross_attention_density_actual: 0.88
  cross_attention_density_min: 0.85
  embedding_projection_dim: 1024
  hardware_target: Lenovo Legion 5, RTX 4060
  inference_latency_actual_ms: 284.5
  inference_latency_target_ms: 300.0
  kv_cache_compression_actual_percent: 62.4
  kv_cache_compression_min_percent: 60.0
  semantic_loss_improvement_rate: 0.285
  visual_token_compression_actual: 4.21
  visual_token_compression_min: 4.0
semantic:
  alternative_parents: []
