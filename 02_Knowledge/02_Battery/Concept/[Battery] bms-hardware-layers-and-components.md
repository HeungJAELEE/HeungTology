...
object:
  ...
  tier: 1
properties:
  active_balancing_current: 1A+
  afe_resolution: 16-bit
  afe_voltage_accuracy: ±1mV
  contactor_switching_life_min: 100,000 cycles
  current_sensor_accuracy: 0.5%
  current_sensor_range: ±1000A
  external_reference_db: BMS_Hardware_RAG_V6.3.7
  isolation_voltage_threshold: 2.5kVrms
  passive_balancing_current: 100mA
  precharge_resistor_range: 10-50 Ohm
  precharge_verification_tau: 3RC
  precharge_voltage_target: 0.95 Vbat
semantic:
  alternative_parents: []
