...
object:
  ...
  tier: 1
properties:
  communication_protocol: ZMQ
  degradation_accuracy_target: '> 95.0%'
  max_drawdown_target: < 10.0%
  optimization_objective: max_net_profit_minus_degradation_cost
  sharpe_ratio_target: '> 1.5'
  trading_latency_target: < 10.0ms
semantic:
  alternative_parents: []
