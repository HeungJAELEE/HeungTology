...
object:
  description: 수천 개의 셀 데이터를 수집, 처리하여 시스템의 기능 안전(ASIL-D)을 보장하고 에너지 거버넌스를 수행하는 계층적 제어
    아키텍처 설계 지능
...
properties:
  asil_rating: ASIL-D
  comm_speed_mbps: '> 2.0'
  fail_safe_failure_probability_per_hour: 10^-9
  failover_transition_time_ms: '10'
  isolation_barrier_vrms_kv: '> 2.5'
  max_packet_error_rate: 0.1%
  redundancy_parallel_factor: 1.5x
  system_availability_percentage: '> 99.999'
  voltage_measurement_error_mv: < ± 2
  wake_up_time_ms: < 50
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재] Section 1'
  intent: safety_standard_compliance
