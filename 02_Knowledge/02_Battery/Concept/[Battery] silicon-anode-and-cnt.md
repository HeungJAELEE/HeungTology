...
object:
  description: 실리콘의 격심한 부피 팽창($\sim 300\%$) 환경에서도 전기적 네트워크를 유지하기 위해 SWCNT를 활용한 탄성
    전도성 브릿지를 구축하는 나노 공학 지능
  object_type: Hardware
  tier: 1
properties:
  electrode_peel_strength: '> 30 gf/mm'
  mwcnt_aspect_ratio: 100 ~ 1,000
  mwcnt_conductivity_sm: 10^4 ~ 10^5
  mwcnt_dosage_wt: 1.0 ~ 3.0%
  mwcnt_elastic_modulus_tpa: '0.3'
  mwcnt_percolation_threshold: 1 ~ 2%
  mwcnt_tensile_strength_gpa: 10 ~ 30
  si_volume_expansion: 300%
  swcnt_aspect_ratio: '> 10,000'
  swcnt_conductivity_sm: 10^6 ~ 10^7
  swcnt_dosage_wt: 0.05 ~ 0.1%
  swcnt_elastic_modulus_tpa: '1.0'
  swcnt_percolation_threshold: < 0.1%
  swcnt_tensile_strength_gpa: '> 50'
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 02_Battery]]'
spo_graph:
- evidence_coordinate: '[데이터 부재] Section 1'
  intent: material_property_specification
  object: '> 10,000'
  predicate: measured_value
  subject: SWCNT Aspect Ratio
  weight: 0.9
- evidence_coordinate: '[데이터 부재] Section 2'
  intent: theoretical_benchmark
  object: 3,579 mAh/g
  predicate: measured_value
