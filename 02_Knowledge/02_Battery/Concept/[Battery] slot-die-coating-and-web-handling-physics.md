...
lineage:
  ...
  original_hash: a548116ec453c2b901e857c6de80a19fe0a79df0dc4f092bcb53f406d718f8e7
metadata:
  date: '2026-05-16'
  domain: 02_Battery
...
object:
  ...
  tier: 1
properties:
  air_entrainment_limit: 90.0 m/min
  capillary_number_limit: '1.0'
  coating_speed_min: 80.0 m/min
  dancer_roll_frequency: 5 Hz
  lip_gap_h: 200.0 um
  log_source: battery-coating-and-web-handling-log-v2026
  pressure_uniformity_target: 99.2%
  tension_deviation_threshold: 1.0 N/m
  thickness_deviation_limit: 1.5%
  verified_coating_speed: 85.0 m/min
  web_tension_target: 30.0 N/m
semantic:
  alternative_parents: []
