...
properties:
  binder_material: paa
  binding_energy_h_bond_kj_mol: 20-40
  critical_failure_mode: mud_crack
  min_adhesion_force_gf_mm: '20'
  min_thixotropy_recovery_percent: '90'
  pdi_range: 2.0-4.0
  rheology_model: krieger_dougherty
  solid_content_range_percent: 50-75
  viscosity_range_cp: 2,000-10,000
semantic:
  alternative_parents: []
