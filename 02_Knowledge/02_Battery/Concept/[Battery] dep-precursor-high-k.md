...
object:
  description: 고전압 리튬 이차 전지의 계면 안정성 확보를 위한 양극 활물질 표면 High-k 유전체 전구체 증착 속도론 및 물리 유전성
    체계
  object_type: Concept
  tier: 1
properties:
  ald_temperature_celsius: '180'
  breakdown_strength_mv_cm: '8.4'
  cathode_coverage_percent: '99.65'
  dielectric_constant_k: '9.2'
  film_thickness_nm: '1.85'
  growth_per_cycle_angstrom: '1.03'
  leakage_current_limit_a_cm2: '4.2e-8'
  performance_log_endpoint: battery-high-k-coating-performance-log-v2026
  pulse_time_s: '1.2'
  purge_time_s: '5.0'
  reference_log_id: high-k-dep-log-v2026
  vacuum_permittivity_f_m: '8.854e-12'
  voltage_threshold_v: '4.3'
semantic:
  alternative_parents: []
