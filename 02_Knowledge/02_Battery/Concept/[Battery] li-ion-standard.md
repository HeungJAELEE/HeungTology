...
object:
  ...
  tier: 1
properties:
  altitude_pressure_kpa: '11.6'
  impact_peak_force_kn: 13 +/- 0.7
  min_power_density_w_kg: '1000'
  overcharge_critical_voltage_v: '4.5'
  overcharge_target_voltage_iso12405: 1.2 * Vmax
  overcharge_target_voltage_un383: 2 * Vmax
  sei_theoretical_onset_temp_c: '90'
  short_circuit_res_iso12405_mohm: < 5 +/- 2
  short_circuit_res_un383_mohm: < 100
  soh_retention_threshold: '> 80%'
  thermal_range_iso12405_c: -40~80
  thermal_range_un383_c: -40~72
  vibration_freq_range_hz: 7~200
semantic:
  alternative_parents: []
