...
object:
  description: '[Battery] next-gen-battery-characterization-and-dq-dv-atlas에 관한 고밀도
    지능 노드'
  object_type: Data
  tier: 1
properties:
  deconvolution_variable_overpotential: eta_overpotential
  hard_carbon_peak_v_max: 0.1
  layered_oxide_peak_range_v:
  - 2.5
  - 4.0
  layered_oxide_stability_threshold_v: 4.0
  prussian_blue_peak_v:
  - 3.2
  - 3.6
semantic:
  alternative_parents: []
