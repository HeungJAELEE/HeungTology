...
object:
  object_type: "Concept"
  tier: 1
  description: '실리콘-탄소 복합체 및 인조 흑연 음극 활물질의 계면 SEI 확산 한계 성장 역학, 구형 나노 입자 내 확산 유도 응력 텐서 및 급속 충전 시 덴드라이트 Plating 임계 열역학 모델'
temporal:
