...
semantic:
  expected_queries:
    - "나트륨 이온 배터리(SIB)에서 $Na$가 $Al$과 합금화(Alloying) 반응을 일으키지 않아 음극 집전체로 $Al$을 사용 가능한 열역학적 근거는?"
    - "SIB 양극재의 $O3 \to P2$ 상전이 시 발생하는 비평형 격자 응력을 억제하기 위한 $Mg^{2+}$ 도핑의 수리적 모델은?"
  tags: ["#나트륨이온", "#SIB물리", "#상전이", "#알루미늄집전체", "#HDS-Gold"]

spo_graph:
  - subject: "Sodium Ion Radius"
    predicate: "measured_value"
    object: "1.02 Angstrom"
    evidence: "[Ref: Phys_Data_V7] Section 1"
  - subject: "Reduction Potential"
    predicate: "measured_value"
    object: "-2.71 V"
    evidence: "[Ref: Std_Electro] Section 2"
