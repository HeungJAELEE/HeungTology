...
object:
  object_type: "Concept"
  tier: 1
  description: '리튬이온 이차전지 전해액의 Onsager 다성분계 수송 계수, VTF 온도 의존성 전도 속도론, 다공성 전극 함침 Washburn 동역학 및 LiPF6 가수분해 HF 부식 화학 평형 모델'
temporal:
...
spo_graph:
  - subject: "Electrolyte_Liquid"
    ...
    evidence: "[Ref: Solvent_Log_V7] Section 2.1"
  - subject: "Wetting_Process"
    predicate: "modelled_by"
    object: "Porous_Washburn_Kinetics"
    evidence: "[Ref: Purity_Data] Section 3.1"
trust_metrics:
  T_static: 1.0
  decay_rate: 0.0
validation:
