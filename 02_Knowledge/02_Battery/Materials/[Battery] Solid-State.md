...
object:
  object_type: "Concept"
  tier: 1
  description: '차세대 전고체 배터리용 황화물/산화물계 고체 전해질의 격리 이온 Hopping 활성화 에너지 역학, 계면 공간전하층 Poisson-Boltzmann 분극 유도 정전위 수리식 및 리튬 전착 Monroe-Newman 역학 기준 수립'
temporal:
