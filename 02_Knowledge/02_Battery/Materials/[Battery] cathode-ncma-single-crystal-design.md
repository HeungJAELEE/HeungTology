...
| :--- | :--- | :--- | :--- |
| **Nickel Content** | High Capacity Agent ($Ni \ge 90\%$) | $90 \sim 94 \text{ mol}\%$ | [Ref: NCMA_Spec_2026] |
| **Aluminum Doping** | Structural Stabilizer ($Al$ Ion) | $1 \sim 3 \text{ mol}\%$ | [Ref: Lattice_Stability_Doc] |
| **Grain Size ($D_{50}$)** | Single Crystal Domain Diameter | $2 \sim 5 \mu\text{m}$ | [Ref: Morphological_Analysis] |
| **Micro-crack Den.** | Cracks/Surface Area (500 Cycles) | $\approx 0$ | [Ref: Cycle_Life_Log] |
| **Residual Li** | Surface $LiOH$ & $Li_2CO_3$ Concentration | $< 500 \text{ ppm}$ | [Ref: Surface_Chemistry_Report] |
| **Capacity Retention**| 1C/1C Cycle Life at $45^\circ\text{C}$ | $> 90\%$ (1k Cycles) | [Ref: Cycle_Life_Log] |
| **Thermal Onset** | DSC Exothermic Peak Temperature | $> 230^\circ\text{C}$ | [Ref: DSC_Safety_Test] |
| **Pressing Density**| Electrode Loading Support | $> 3.6 \text{ g/cc}$ | [Ref: Electrode_Eng_Manual] |
