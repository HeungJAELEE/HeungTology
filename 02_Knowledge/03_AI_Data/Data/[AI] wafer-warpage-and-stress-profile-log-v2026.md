...
object:
  ...
  tier: 1
properties:
  annealing_stress_range: 100-500 MPa
  back_grinding_warpage_limit: '> 150 um'
  bare_wafer_ttv_limit: < 0.5 um
  cmp_warpage_recovery_rate: 40%
  metal_dep_bow_range: 50-100 um
  mobility_shift_threshold: 5%
  nitride_dep_warpage_range: 30-60 um
  silicon_cte: 2.6e-6 /K
semantic:
  alternative_parents: []
