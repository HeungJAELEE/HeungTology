---
lineage:
  dataset_reference: ai-compute-infrastructure-and-accelerator-hardware
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] ai-compute-infrastructure-and-accelerator-hardware]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for ai-compute-infrastructure-and-accelerator-hardware
  object_type: Hardware
  tier: 1
properties:
  hbm_bandwidth_target_tbs: 1.2
  lpddr5x_efficiency_target_gbps_pin: 8.5
  memory_bound_balance_ratio_threshold: 0.3
  network_latency_threshold_ms: 50
  nvlink_interconnect_speed_target_gbs: 900
  smart_nic_data_transfer_target_gbps: 400
  tensor_core_compute_target_tflops: 2000
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 03_AI_Data]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: automated_knowledge_extraction
  object: Data
  predicate: auto_mapped
  subject: ai-compute-infrastructure-and-accelerator-hardware
  weight: 0.7
temporal:
