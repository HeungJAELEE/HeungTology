---
lineage:
  dataset_reference: semiconductor-cmp-planarization-and-removal-rate-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] semiconductor-cmp-planarization-and-removal-rate-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for semiconductor-cmp-planarization-and-removal-rate-log-v2026
  object_type: Data
  tier: 1
properties:
  dishing_depth_threshold_nm_max: 10.0
  down_force_psi_max: 5.0
  down_force_psi_min: 2.0
  epd_accuracy_timing_error_s_max: 1.0
  pad_service_life_hrs_min: 500
  preston_constant_kp: 0.0015
  removal_rate_target_angstrom_per_min_max: 3000
  removal_rate_target_angstrom_per_min_min: 1500
  roughness_ra_threshold_angstrom_max: 3.0
  selectivity_metal_oxide_ratio_min: 50.0
  wiwnu_threshold_percent_max: 2.0
semantic:
  alternative_parents: []
  is_instance_of: '[[ [03_AI_Data] [Concept] semiconductor-cmp-planarization-and-removal-rate-log-v2026]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: automated_semantic_classification
  object: Data
  predicate: auto_mapped
  subject: semiconductor-cmp-planarization-and-removal-rate-log-v2026
  weight: 1.0
temporal:
