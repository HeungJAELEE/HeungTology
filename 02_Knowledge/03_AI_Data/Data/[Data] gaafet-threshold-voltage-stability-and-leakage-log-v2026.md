---
Basic:
  id: "gaafet-threshold-voltage-stability-and-leakage-log-v2026-data"
...
Object:
  ...
  physical_model: "N/A"
Semantic:
  tags: '["#DataLog", "#Semiconductor", "#GAAFET", "#Nanosheet", "#Threshold_Voltage", "#Leakage_Current", "#Quantum_Confinement", "#HDS_Gold_v6_1", "#Device_Physics"]'
  is_part_of: '["[[[Semiconductor] semiconductor-fabrication-fundamentals", "Semiconductor nano-intelligence-substrate-and-atomistic-design-master-guide]"]'
  related_to: []
Dynamic:
...
| **I_off (Leakage)** | $80 \text{ pA/\mu m}$ | $45 \text{ pA/\mu m}$ | $\pm 2 \text{ pA}$ | 채널 하단 누설 전류의 완벽한 차단 무결성 |
...
| **Effective Drive Current** | $1.4 \text{ mA/\mu m}$ | $1.8 \text{ mA/\mu m}$ | $\pm 0.05 \text{ mA}$ | 단위 면적당 구동 전류 성능의 비약적 향상 |
