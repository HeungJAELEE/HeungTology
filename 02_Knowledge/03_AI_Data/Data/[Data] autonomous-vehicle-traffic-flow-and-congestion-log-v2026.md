...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] autonomous-vehicle-traffic-flow-and-congestion-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for autonomous-vehicle-traffic-flow-and-congestion-log-v2026
  object_type: Data
  tier: 1
properties:
  avg_speed_threshold_km_hr: 80.0
  critical_density_k_crit_verified_veh_km: 26.5
  free_flow_speed_u_f_verified_km_hr: 82.4
  max_capacity_q_max_verified_veh_hr_ln: 2150
  mean_speed_measured_km_hr: 82.4
  platooning_headway_s: 0.5
  traffic_density_measured_veh_km: 26.5
  traffic_flow_measured_veh_hr_ln: 2150
  travel_time_idx_measured: 1.12
  tti_max_threshold: 1.2
  v2x_latency_threshold_ms: 100.0
  v2x_success_rate: 0.9985
  wait_time_measured_s: 12.4
semantic:
  alternative_parents: []
  is_instance_of: '[[ [03_AI_Data] [Concept] autonomous-vehicle-traffic-flow-and-congestion-log-v2026]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: automated_metadata_indexing
  object: Data
