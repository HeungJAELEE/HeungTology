...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] missing-value-classification-logic]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for missing-value-classification-logic
  object_type: Concept
  tier: 1
properties:
  critical_temperature_threshold_celsius: 80
  hds_gold_version: V6.3.7
  littles_test_p_value_threshold: 0.05
  mice_max_iter: 10
  mice_random_state: 42
  missing_rate_threshold_percent: 30
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 03_AI_Data]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: domain_association
  object: Data
