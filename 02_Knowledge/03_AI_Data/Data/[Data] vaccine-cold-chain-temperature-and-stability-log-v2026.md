---
lineage:
  dataset_reference: vaccine-cold-chain-temperature-and-stability-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] vaccine-cold-chain-temperature-and-stability-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for vaccine-cold-chain-temperature-and-stability-log-v2026
  object_type: Data
  tier: 1
properties:
  excursion_duration_max_minutes: 5.0
  insulation_r_min_value: 10.0
  power_backup_min_hours: 12.0
  stability_index_min_percent: 98.0
  storage_temp_measured_celsius: -72.4
  storage_temp_target_nominal_celsius: -70.0
  storage_temp_target_tolerance_celsius: 5.0
  track_success_target_percent: 100.0
  urban_traffic_data_endpoint: urban-traffic-flow-and-congestion-index-log-v2026
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: vaccine-cold-chain-temperature-and-stability-log-v2026
  weight: 0.4
temporal:
