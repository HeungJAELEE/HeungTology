...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] quantum-key-distribution-qkd-quantum-bit-error-rate-qber-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for quantum-key-distribution-qkd-quantum-bit-error-rate-qber-log-v2026
  object_type: Data
  tier: 1
properties:
  bb84_qber_range_pct: 1.0-3.0
  cv_qkd_qber_range_pct: 5.0-8.0
  mdi_qkd_qber_range_pct: 2.0-4.0
  mean_photon_number_mu_range: 0.1-0.5
  qber_security_threshold: 0.11
  satellite_qkd_qber_range_pct: 5.0-10.0
  sifting_efficiency_approx: 0.5
  tf_qkd_qber_range_pct: 3.0-5.0
semantic:
  alternative_parents: []
