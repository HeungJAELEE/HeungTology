---
lineage:
  dataset_reference: Digital-Twin-Architecture-and-Real-time-Sync
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] Digital-Twin-Architecture-and-Real-time-Sync]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for Digital-Twin-Architecture-and-Real-time-Sync
  object_type: Concept
  tier: 1
properties:
  cost_reduction_target: 90%
  forecast_horizon_tier0: 1hr
  forecast_horizon_tolerance: 1min
  model_fidelity_tier0_min: 99.0%
  network_jitter_tier0_max: 5ms
  network_jitter_tolerance: 0.1ms
  rmsd_position_tier0_max: 0.1mm
  rmsd_position_tolerance: 0.01mm
  sync_efficiency_threshold: 98%
  sync_frequency_tier0_min: 1000Hz
  sync_latency_tier0_max: 50ms
  throughput_tier0_min: 1M eps
  throughput_tolerance: 100 eps
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: Digital-Twin-Architecture-and-Real-time-Sync
  weight: 1.0
temporal:
