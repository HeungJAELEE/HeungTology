...
object:
  description: '[AI] quantum-annealing-sampling-success-rate-log-v2026에 관한 고밀도 지능
    노드'
  object_type: Data
  tier: 1
properties:
  advantage2_min_qubits: 7000
  annealing_time_ta: adiabatic_evolution_duration_us
  chain_break_fraction: physical_qubit_coupling_failure_rate
  d_wave_2000q_qubits: 2048
  d_wave_advantage_qubits: 5640
  embedding_efficiency: hardware_graph_mapping_efficiency
  j_coupling_error: analog_noise_in_coupler_settings
  minimum_energy_gap: delta_min_mathematical_determinant
  success_probability_p: ground_state_discovery_ratio
semantic:
  alternative_parents: []
