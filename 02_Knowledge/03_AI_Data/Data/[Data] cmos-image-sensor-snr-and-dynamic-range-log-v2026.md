---
Basic:
  id: "cmos-image-sensor-snr-and-dynamic-range-log-v2026-data"
...
Object:
  ...
  physical_model: "N/A"
Semantic:
  tags: '["#DataLog", "#CMOS_Sensor", "#SNR", "#Dynamic_Range", "#HDR", "#Quantum_Efficiency", "#Digital_Retina", "#Computer_Vision", "#HDS_Gold_v6_1"]'
  is_part_of: '["Entity precision-optical-engineering-and-lens-design-fundamentals", "MOC 14_precision-hardware-and-metrology-intelligence-hub"]'
  related_to: []
Dynamic:
...
| 센서 유형 (Sensor Type) | 픽셀 크기 ($\mu m$) | 양자 효율 ($QE, \%$) | 다이내믹 레인지 ($dB$) | SNR Max ($dB$) | 공학적 의미 (Rationale V6.3.7) |
| :--- | :---: | :---: | :---: | :---: | :--- |
...
## 6. [스스로 체크 (Self-Check)]
1. **(원리)** 이미지 센서에서 픽셀 크기가 작아질수록(예: $0.6\mu m$), 왜 '다이내믹 레인지(Dynamic Range)'가 급격히 하락하게 되는가? (Full Well Capacity 관점에서의 인과 관계)
