...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] image-warping-perspective]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for image-warping-perspective
  object_type: Concept
  tier: 1
properties:
  dof_count: 8
  engine_specification: HDS-Gold V6.3.7
  h33_normalization_value: 1.0
  homography_matrix_dimension: 3x3
  interpolation_modes:
  - Lanczos4
  - Cubic
  max_warping_latency_ms: 3
  min_required_point_pairs: 4
  parallelism_preservation: false
  robust_estimation_algorithm: RANSAC
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 03_AI_Data]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: automated_knowledge_ingestion
  object: Data
