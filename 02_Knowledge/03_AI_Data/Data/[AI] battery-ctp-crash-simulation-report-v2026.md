...
object:
  ...
  tier: 1
properties:
  al7000_plastic_strain_ref: 20%
  cell_crush_force_limit: 30.0 kN
  crush_efficiency_limit: 70.0%
  impact_accel_limit: 45-65 G
  intrusion_depth_limit: 65.0 mm
  iscr_critical_force: 30 kN
  peak_force_limit: 150.0 kN
  plastic_strain_limit: 25.0%
  safety_gap_minimum: 20.0 mm
  sea_minimum_threshold: 15.0 kJ/kg
  simulation_time_step: 1ms
  stress_reduction_rate: 35%
semantic:
  alternative_parents: []
