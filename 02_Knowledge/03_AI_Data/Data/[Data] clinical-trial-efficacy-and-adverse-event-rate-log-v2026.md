---
lineage:
  dataset_reference: clinical-trial-efficacy-and-adverse-event-rate-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] clinical-trial-efficacy-and-adverse-event-rate-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for clinical-trial-efficacy-and-adverse-event-rate-log-v2026
  object_type: Data
  tier: 1
properties:
  adverse_event_rate_measured: 0.0245
  adverse_event_rate_threshold: 0.05
  audit_fidelity_status: MAXIMUM
  efficacy_improvement_measured: 0.885
  efficacy_improvement_threshold: 0.7
  odds_ratio_measured: 4.25
  odds_ratio_threshold: 1.0
  p_value_measured: 0.0024
  p_value_threshold: 0.05
  response_time_measured_days: 12.4
  response_time_threshold_days: 14.0
  retention_rate_measured: 0.962
  retention_rate_threshold: 0.9
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: clinical-trial-efficacy-and-adverse-event-rate-log-v2026
  weight: 1.0
temporal:
