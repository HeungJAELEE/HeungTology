...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] ultrasonic-welding-amplitude-and-bonding-strength-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for ultrasonic-welding-amplitude-and-bonding-strength-log-v2026
  object_type: Data
  tier: 1
properties:
  amplitude_precision_requirement_um: 30
  anvil_pressure_measured_mpa: 0.25
  anvil_pressure_target_range_mpa:
  - 0.2
  - 0.3
  bonding_strength_measured_n: 245
  bonding_strength_threshold_n: 200
  external_thickness_map_endpoint: battery-electrode-beta-ray-thickness-map-v2026
  interface_temperature_max_limit_c: 350
  interface_temperature_measured_c: 250
  ultrasonic_amplitude_measured_um: 28.5
  ultrasonic_amplitude_target_range_um:
  - 25.0
  - 32.0
  vibratory_frequency_measured_khz: 20.02
  vibratory_frequency_target_khz: 20.0
  vibratory_frequency_tolerance_khz: 0.1
  welding_energy_measured_j: 180
  welding_energy_target_range_j:
  - 150
  - 200
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  intent: system_automatic_mapping
  object: Data
