...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] wsn-packet-loss-ratio-and-latency-profile-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for wsn-packet-loss-ratio-and-latency-profile-log-v2026
  object_type: Data
  tier: 1
properties:
  channel_occupancy_threshold: 0.7
  latency_unit: ms
  packet_loss_ratio_unit: '%'
  rayleigh_fading_model: f(R) = (R/sigma^2) * exp(-R^2 / (2*sigma^2))
  retransmission_delay_multiplier: 5
  retransmission_trigger_count: 3
  rssi_unit: dBm
  snr_unit: dB
semantic:
  alternative_parents: []
