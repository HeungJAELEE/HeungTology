---
lineage:
  dataset_reference: display-oled-pixel-deposition-accuracy-and-luminance-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] display-oled-pixel-deposition-accuracy-and-luminance-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for display-oled-pixel-deposition-accuracy-and-luminance-log-v2026
  object_type: Data
  tier: 1
properties:
  color_purity_target_standard: BT.2020
  deposition_accuracy_measured_um: 0.8
  deposition_accuracy_target_um: 1.0
  fmm_thermal_expansion_sensitivity_k: 0.5
  luminance_degradation_limit_pct: 5.0
  luminance_uniformity_measured_pct: 98.5
  luminance_uniformity_target_pct: 98.0
  panel_flatness_measured_um: 15
  panel_flatness_target_um: 20
  pixel_defect_measured_ppm: 0.2
  pixel_defect_target_ppm: 0.5
  pixel_overlap_error_um: 0.5
  target_operational_hours: 100000
  temperature_imbalance_control_k: 0.1
  thickness_deviation_limit_pct: 1.0
  wvtr_measured_g_m2_d: 1.0e-06
  wvtr_target_g_m2_d: 1.0e-06
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 03_AI_Data]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: automatic_type_inference
  object: Data
  predicate: auto_mapped
  subject: display-oled-pixel-deposition-accuracy-and-luminance-log-v2026
  weight: 0.95
temporal:
