---
lineage:
  dataset_reference: high-cardinality-encoding
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] high-cardinality-encoding]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for high-cardinality-encoding
  object_type: Concept
  tier: 1
properties:
  dimension_compression_target: O(1) ~ O(log C)
  max_collision_rate: 0.01
  max_inference_lookup_latency_us: 1
  max_sparse_dense_ratio: 0.001
  min_cardinality_threshold: 1000
  min_mutual_info_gain: 0.85
  smoothing_m_range: 10-100
...
- evidence_coordinate: '[데이터 부재]'
  intent: data_transformation_mapping
  object: Data
  predicate: auto_mapped
  subject: high-cardinality-encoding
  weight: 0.9
temporal:
