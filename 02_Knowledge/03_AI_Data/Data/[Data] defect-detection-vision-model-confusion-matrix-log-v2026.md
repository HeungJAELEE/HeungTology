---
lineage:
  dataset_reference: defect-detection-vision-model-confusion-matrix-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] defect-detection-vision-model-confusion-matrix-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for defect-detection-vision-model-confusion-matrix-log-v2026
  object_type: Data
  tier: 1
properties:
  crack_recall_pct: 99.9
  defect_weight_factor: 100
  dimension_precision_pct: 99.9
  inference_latency_target_ms: 50
  lighting_lux_threshold: 500
  quantization_precision_loss_pct: 2
  quantization_speedup_multiplier: 4
  scratch_precision_pct: 98.2
  stain_precision_pct: 92.0
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: defect-detection-vision-model-confusion-matrix-log-v2026
  weight: 0.95
temporal:
