---
lineage:
  dataset_reference: tensorrt-optimization-engine-precision-loss-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] tensorrt-optimization-engine-precision-loss-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for tensorrt-optimization-engine-precision-loss-log-v2026
  object_type: Data
  tier: 1
properties:
  calibration_algorithm: Entropy Calibration v2
  dynamic_shapes_overhead_threshold_pct: 15
  engine_size_reduction_pct: 50-75
  fc_layer_quantization_impact_pct: 80
  histogram_outlier_threshold_pct: 0.001
  per_channel_accuracy_recovery_pct: 1.2
  winograd_algorithm_speedup_factor: 1.5
  workspace_size_gb: 1-4
semantic:
  alternative_parents: []
  is_instance_of: '[[ [03_AI_Data] [Concept] tensorrt-optimization-engine-precision-loss-log-v2026]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: automated_classification
  object: Data
  predicate: auto_mapped
  subject: tensorrt-optimization-engine-precision-loss-log-v2026
  weight: 0.95
temporal:
