...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] cpu-gpu-utilization-and-thermal-throttling-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for cpu-gpu-utilization-and-thermal-throttling-log-v2026
  object_type: Data
  tier: 1
properties:
  ...
  dynamic_power_model: P_dynamic = alpha * C * V^2 * f
  ...
  thermal_resistance_model: delta_T = P * R_theta
...
- evidence_coordinate: '[데이터 부재]'
  intent: system_performance_monitoring
  object: Data
