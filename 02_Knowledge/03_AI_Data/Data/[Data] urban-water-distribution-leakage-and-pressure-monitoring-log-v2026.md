---
lineage:
  dataset_reference: urban-water-distribution-leakage-and-pressure-monitoring-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] urban-water-distribution-leakage-and-pressure-monitoring-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for urban-water-distribution-leakage-and-pressure-monitoring-log-v2026
  object_type: Data
  tier: 1
properties:
  burst_events_per_km_yr: 0.02
  burst_events_target_max: 0.05
  external_db_endpoint: power-grid-stability-and-frequency-regulation-log-v2026
  grid_pressure_measured_bar: 3.54
  grid_pressure_target_max_bar: 4.0
  grid_pressure_target_min_bar: 3.0
  leak_detection_accuracy_measured_pct: 98.6
  leak_detection_accuracy_target_min_pct: 98.0
  mnf_anomaly_threshold_l_min: 500
  nrw_rate_measured_pct: 4.85
  nrw_rate_target_max_pct: 5.0
  pipe_vibration_measured_g: 0.012
  pipe_vibration_target_max_g: 0.05
  water_flow_m3_h: 12450
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: urban-water-distribution-leakage-and-pressure-monitoring-log-v2026
  weight: 0.95
temporal:
