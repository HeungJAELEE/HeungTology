---
lineage:
  dataset_reference: blast-furnace-iron-purity-and-slag-composition-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] blast-furnace-iron-purity-and-slag-composition-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for blast-furnace-iron-purity-and-slag-composition-log-v2026
  object_type: Data
  tier: 1
properties:
  blast_temp_measured_celsius: 1245
  blast_temp_target_celsius: 1200
  blast_temp_tolerance_celsius: 50
  coke_rate_measured_kg_per_ton: 385
  coke_rate_target_max_kg_per_ton: 400
  gibbs_free_energy_model: delta_g = delta_h - t * delta_s
  iron_purity_measured_pct: 94.5
  iron_purity_target_min_pct: 94.0
  mass_balance_model: m_in = m_out + m_slag + m_dust
  recovery_rate_measured_pct: 98.2
  recovery_rate_target_min_pct: 97.0
  silicon_content_measured_pct: 0.45
  silicon_content_target_max_pct: 0.6
  slag_basicity_measured: 1.24
  slag_basicity_target_range: 1.20 +/- 0.05
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: blast-furnace-iron-purity-and-slag-composition-log-v2026
  weight: 0.95
temporal:
