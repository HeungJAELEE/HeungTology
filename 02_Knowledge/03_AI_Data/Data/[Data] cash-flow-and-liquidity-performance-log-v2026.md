---
lineage:
  dataset_reference: cash-flow-and-liquidity-performance-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] cash-flow-and-liquidity-performance-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for cash-flow-and-liquidity-performance-log-v2026
  object_type: Data
  tier: 1
properties:
  bank_statement_format: MT940
  dio_cash_erosion_sensitivity: 10 days increase = $5M cash erosion
  fcf_formula: Operating Cash Flow - Capital Expenditures
  financing_target_flow_range: -1.0 to -2.0 M/mo
  free_cash_target_flow_range: 2.0 to 5.0 M/mo
  investing_target_flow_range: -3.0 to -7.0 M/mo
  min_closing_cash_buffer: 20.0M
  ocf_to_net_income_ratio_threshold: '> 1.0'
  operations_target_flow_range: 5.0 to 10.0 M/mo
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: cash-flow-and-liquidity-performance-log-v2026
  weight: 0.95
temporal:
