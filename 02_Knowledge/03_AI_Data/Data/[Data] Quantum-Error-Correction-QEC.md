...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] Quantum-Error-Correction-QEC]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for Quantum-Error-Correction-QEC
  object_type: Concept
  tier: 1
properties:
  code_distance_range: 3 - 21+
  decoding_latency_target: < 1us
  feedback_loop_cycle_time: < 10us
  logical_error_rate_suppression_target: < 10^-15
  per_gate_error_rate_threshold: 0.1% - 1.0%
  physical_to_logical_overhead_ratio: 1000:1 to 100:1
  readout_fidelity_min: '> 99.5%'
  threshold_theorem_relationship: P_log proportional to (P_phys/P_th)^((d+1)/2)
semantic:
  alternative_parents: []
