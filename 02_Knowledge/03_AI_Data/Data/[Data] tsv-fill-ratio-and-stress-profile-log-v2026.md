---
Basic:
  id: "tsv-fill-ratio-and-stress-profile-log-v2026-data"
...
Object:
  ...
  physical_model: "N/A"
Semantic:
  tags: '["#DataLog", "#TSV", "#Stress_Profile", "#Fill_Ratio", "#CTE_Mismatch", "#Copper_Pumping", "#KOZ", "#Reliability", "#3D_IC", "#HDS_Gold_v6_1"]'
  is_part_of: '["MOC 23_semiconductor-materials-and-advanced-packaging-intelligence-hub", "Entity through-silicon-via-tsv-electroplating-and-void-detection"]'
  related_to: []
Dynamic:
...
| 어닐링 온도 ($^\circ C$) | 비아 직경 ($\mu m$) | 충전율 (%) | 최대 잔류 응력 ($MPa$) | 구리 돌출 ($nm$) | 공학적 의미 (Rationale V6.3.7) |
| :--- | :---: | :---: | :---: | :---: | :--- |
...
- **Keep-Out Zone (KOZ) Radius:** TSV 응력에 의해 소자 특성이 $1\%$ 이상 변하는 반경 ($\mu m$).
...
2. **(수리)** 구리의 CTE가 $17 \text{ ppm/}^\circ C$, 실리콘이 $3 \text{ ppm/}^\circ C$, 온도 차이가 $300^\circ C$이다. $10 \mu m$ 깊이의 TSV에서 구리가 자유롭게 팽창한다면 이론적인 돌출 높이($nm$)는 얼마인가?
