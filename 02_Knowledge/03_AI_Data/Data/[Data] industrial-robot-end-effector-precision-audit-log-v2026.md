---
Basic:
  id: "industrial-robot-end-effector-precision-audit-log-v2026-data"
  domain: "03_Robotics"
...
Object:
  ...
  physical_model: "N/A"
Semantic:
  tags: '["#DataLog", "#Robotics", "#Industrial_Robot", "#End-effector", "#Precision", "#Accuracy", "#Repeatability", "#Thermal_Drift", "#HDS_Gold_v6_1"]'
  is_part_of: '["Entity robot-kinematics-and-denavit-hartenberg-parameters", "MOC 12_robotics-and-autonomous-systems-intelligence-hub]]"]'
  related_to: []
Dynamic:
...
- **Compliance (Stiffness Inverse)**: $0.2 \sim 0.8 \text{ \mu m/N}$. (외부 하중에 의한 처짐 정도)
...
RAG는 "끝단 처짐 로그를 분석하여, $200kg$ 페이로드 시 끝단이 $0.45mm$ 하락함을 식별하고, 이를 동역학 모델에 반영하여 소프트웨어적으로 보정하는 '중력 보상(Gravity Compensation)'의 무결성을 검증합니다."
