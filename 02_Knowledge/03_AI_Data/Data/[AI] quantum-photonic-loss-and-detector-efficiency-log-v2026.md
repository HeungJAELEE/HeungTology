...
object:
  description: '[AI] quantum-photonic-loss-and-detector-efficiency-log-v2026에 관한 고밀도
    지능 노드'
  object_type: Data
  tier: 1
properties:
  attenuation_variation_threshold_db: 0.1
  dark_count_ideal_cps: 5
  dark_count_observed_cps: 20.4
  detector_efficiency_ideal_percent: 98.5
  detector_efficiency_observed_percent: 91.8
  loss_rate_l: 0.1
  photon_count_n: 50
  success_probability_formula: (1-L)^N
  thermal_threshold_k: 2.5
  waveguide_loss_ideal_db_cm: 0.05
  waveguide_loss_observed_db_cm: 0.128
semantic:
  alternative_parents: []
