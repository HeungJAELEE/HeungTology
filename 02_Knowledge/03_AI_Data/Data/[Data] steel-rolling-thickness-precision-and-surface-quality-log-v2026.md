---
lineage:
  dataset_reference: steel-rolling-thickness-precision-and-surface-quality-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] steel-rolling-thickness-precision-and-surface-quality-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for steel-rolling-thickness-precision-and-surface-quality-log-v2026
  object_type: Data
  tier: 1
properties:
  flatness_index_measured: 99.4
  flatness_index_target_min: 98.0
  roll_wear_measured_mm: 0.12
  roll_wear_target_max_mm: 0.5
  rolling_force_kn: 25450
  rolling_load_model: P = 1.15 * k * w * L * Qp
  rolling_speed_measured_m_min: 1250
  rolling_speed_target_range_m_min: 1000-1500
  surface_roughness_measured_um: 0.45
  surface_roughness_target_max_um: 0.8
  thickness_dev_measured_mm: 0.028
  thickness_dev_target_max_mm: 0.05
  thickness_variation_model: delta_h = delta_S + (delta_P / M)
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: steel-rolling-thickness-precision-and-surface-quality-log-v2026
  weight: 1.0
temporal:
