...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] Computer-Vision]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for Computer-Vision
  object_type: Concept
  tier: 1
properties:
  augmentation_reliability_industrial: 85%
  confidence_threshold: '0.85'
  detection_accuracy_industrial: 92.4%
  detection_accuracy_theoretical: '> 98.5%'
  inference_latency_industrial: 15-25ms
  inference_latency_theoretical: < 10ms
  reject_arm_relay_pin: '5'
  segmentation_precision_industrial: 0.5-1.2px
  segmentation_precision_theoretical: 0.1px
semantic:
  alternative_parents: []
  is_instance_of: '[[ [03_AI_Data] [Concept] Computer-Vision]]'
spo_graph:
