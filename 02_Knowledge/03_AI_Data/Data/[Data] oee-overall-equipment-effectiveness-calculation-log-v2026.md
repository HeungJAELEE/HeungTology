---
lineage:
  dataset_reference: oee-overall-equipment-effectiveness-calculation-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] oee-overall-equipment-effectiveness-calculation-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for oee-overall-equipment-effectiveness-calculation-log-v2026
  object_type: Data
  tier: 1
properties:
  availability_formula: run_time / planned_time
  ict_parameter: ideal_cycle_time
  industry_average_oee_range:
  - 60.0
  - 75.0
  mtbf_parameter: mean_time_between_failures
  mttr_parameter: mean_time_to_repair
  oee_calculation_formula: availability * performance * quality
  performance_formula: (total_count * ict) / run_time
  quality_formula: good_count / total_count
  quality_loss_velocity_relationship: quadratic
  world_class_availability_threshold_percent: 90.0
  world_class_oee_threshold_percent: 85.0
  world_class_performance_threshold_percent: 95.0
  world_class_quality_threshold_percent: 99.9
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 03_AI_Data]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: knowledge_graph_initialization
  object: Data
  predicate: auto_mapped
  subject: oee-overall-equipment-effectiveness-calculation-log-v2026
  weight: 0.5
temporal:
