...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] pem-electrolyzer-hydrogen-production-rate-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for pem-electrolyzer-hydrogen-production-rate-log-v2026
  object_type: Data
  tier: 1
properties:
  current_density_threshold: 2 A/cm2
  faraday_efficiency_threshold: '> 95%'
  gas_crossover_shutdown_threshold: 2%
  h2_hhv_value: 39.4 kWh/kg
  h2_purity_threshold: '> 99.999%'
  operating_pressure: 30 bar
  pem_efficiency_hhv_range: 75-82%
  pem_power_consumption_range: 50-55 kWh/kg
  pem_production_rate_range: 20.0-50.0 Nm3/hr/m2
  pem_temp_range: 50-80 C
  response_time_threshold: 1s
semantic:
  alternative_parents: []
  is_instance_of: '[[ [03_AI_Data] [Concept] pem-electrolyzer-hydrogen-production-rate-log-v2026]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: empirical_validation_source
  object: Data
