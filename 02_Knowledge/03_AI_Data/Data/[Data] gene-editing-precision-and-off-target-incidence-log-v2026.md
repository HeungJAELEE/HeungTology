---
lineage:
  dataset_reference: gene-editing-precision-and-off-target-incidence-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] gene-editing-precision-and-off-target-incidence-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for gene-editing-precision-and-off-target-incidence-log-v2026
  object_type: Data
  tier: 1
properties:
  binding_energy_diff_threshold_kcal_mol: 10.0
  cell_toxicity_measured: 0.045
  cell_toxicity_target_max: 0.1
  editing_eff_measured: 0.942
  editing_eff_target_min: 0.9
  genomic_stab_measured: 9.8
  genomic_stab_target_min: 9.5
  hdr_success_measured: 0.82
  hdr_success_target_min: 0.75
  mismatch_count_threshold: 3
  off_target_inc_measured: 0
  off_target_inc_target: 0
  off_target_prob_threshold: 1.0e-06
  on_target_fid_measured: 0.9998
  on_target_fid_target_min: 0.999
  persistence_measured: 1.0
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: gene-editing-precision-and-off-target-incidence-log-v2026
  weight: 1.0
temporal:
