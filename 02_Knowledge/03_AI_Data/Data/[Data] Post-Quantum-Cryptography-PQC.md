---
lineage:
  dataset_reference: Post-Quantum-Cryptography-PQC
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] Post-Quantum-Cryptography-PQC]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for Post-Quantum-Cryptography-PQC
  object_type: Concept
  tier: 1
properties:
  ciphertext_size_range: 1088-1568 Bytes
  crypto_agility_mechanism: Dynamic Loading
  decryption_failure_probability: < 2^-128
  encryption_latency_threshold: < 50,000 Cycles
  fips_standard: FIPS 203
  problem_base: Module-LWE
  public_key_size_range: 1184-1568 Bytes
  security_level: Level 5 (AES-256 Equivalent)
  shor_algorithm_classical_complexity: e^{O(n^{1/3})}
  shor_algorithm_quantum_complexity: O(n^2 log n)
  standard_name: ML-KEM (Kyber)
semantic:
  alternative_parents: []
