...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] scibench-scientific-validation]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for scibench-scientific-validation
  object_type: Data
  tier: 1
properties:
  constant_error_threshold: 0.01%
  data_scope: 10+ Scientific Domains (Thermo, Fluid, Quantum)
  dataset_search_script: dataset_search_skill.py
  difficulty_level: Undergraduate to Advanced Research
  local_skill_path: python 03_Skills/garden/final_gold_total_audit.py
  target_engine: FidelityEngine
  validation_units: SI Units, Physical Constants, Derivations
semantic:
  alternative_parents: []
  is_instance_of: '[[ [03_AI_Data] [Concept] scibench-scientific-validation]]'
spo_graph:
