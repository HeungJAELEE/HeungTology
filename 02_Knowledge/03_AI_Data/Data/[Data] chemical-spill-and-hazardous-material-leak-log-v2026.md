...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] chemical-spill-and-hazardous-material-leak-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for chemical-spill-and-hazardous-material-leak-log-v2026
  object_type: Data
  tier: 1
properties:
  acid_alkali_containment_rate_pct: 100.0
  hazmat_waste_containment_rate_pct: 98.0
  max_response_time_toxic_gas_sec: 30
  oil_coolant_containment_rate_pct: 100.0
  orifice_leak_rate_formula: Q = Cd * A * sqrt(2 * rho * (Pin - Pout))
  solvent_voc_containment_rate_pct: 99.9
  solvent_voc_detection_ppm_range: 1-10
  toxic_gas_containment_rate_pct: 99.5
  toxic_gas_detection_threshold_ppm: 1.0
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 03_AI_Data]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: records_containment_performance_metrics
  object: Data
