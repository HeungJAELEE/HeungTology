...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] urban-mining-resource-recovery-yield-and-purity-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for urban-mining-resource-recovery-yield-and-purity-log-v2026
  object_type: Data
  tier: 1
properties:
  leaching_kinetics_shrinking_core_formula: 1 - (1-x)^(1/3) = k * t
  max_energy_intensity_kwh_kg: 5.0
  max_waste_residue_percentage: 5.0
  max_water_footprint_l_kg: 20.0
  min_carbon_reduction_percentage: 70.0
  min_eco_viability_index: 1.2
  primary_energy_avg_kwh_kg: 50.0
  purity_limit_threshold: 99.9
  purity_target_percentage: 99.9
  recycling_energy_savings_formula: eta_save = 1 - (sum_e_secondary / sum_e_primary)
  yield_target_percentage: 95.0
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 03_AI_Data]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: is_instance_of
  object: Data
