---
lineage:
  dataset_reference: openvino-model-quantization-and-inference-speed-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] openvino-model-quantization-and-inference-speed-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for openvino-model-quantization-and-inference-speed-log-v2026
  object_type: Data
  tier: 1
properties:
  kl_divergence_threshold: 0.05
  layer_fusion_ratio: 0.45
  layer_fusion_speedup_factor: 1.8
  memory_io_latency_impact_ratio: 0.4
  mixed_precision_accuracy_recovery_pct: 99
  mixed_precision_speed_loss_limit_pct: 5
  model_size_reduction_range_pct: 70-75
  npu_power_efficiency_vs_cpu_ratio: 0.2
  power_efficiency_fps_watt: 15-40
  warm_up_time_ms: 500-1000
semantic:
  alternative_parents: []
  is_instance_of: '[[ [03_AI_Data] [Concept] openvino-model-quantization-and-inference-speed-log-v2026]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: semantic_classification
  object: Data
  predicate: auto_mapped
  subject: openvino-model-quantization-and-inference-speed-log-v2026
  weight: 1.0
temporal:
