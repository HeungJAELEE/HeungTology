...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] sensor-data-sampling-rate-and-network-jitter-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for sensor-data-sampling-rate-and-network-jitter-log-v2026
  object_type: Data
  tier: 1
properties:
  critical_ptp_sync_error_us: 100
  environmental_sampling_hz_max: 1.0
  environmental_sampling_hz_min: 0.1
  high_speed_vib_max_jitter_ms: 0.1
  high_speed_vib_max_packet_loss_pct: 0.001
  high_speed_vib_sampling_hz_max: 50000
  high_speed_vib_sampling_hz_min: 10000
  jitter_snr_degradation_db: 10
  nyquist_sampling_condition: fs > 2 * fmax
  packet_loss_integrity_collapse_threshold_pct: 1.0
  process_sampling_hz_max: 100
  process_sampling_hz_min: 10
  servo_control_max_jitter_ms: 0.01
  servo_control_sampling_hz_max: 4000
  servo_control_sampling_hz_min: 1000
semantic:
  alternative_parents: []
