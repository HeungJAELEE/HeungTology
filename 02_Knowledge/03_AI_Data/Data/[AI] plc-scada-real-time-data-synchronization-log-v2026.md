...
lineage:
  ...
  original_hash: e0f23bff3c5e39210c4ada29dc4270de5c472e460bca44f2c18c0588fcb7f712
metadata:
  date: '2026-05-16'
  domain: 03_AI_Data
...
object:
  description: '[AI] plc-scada-real-time-data-synchronization-log-v2026에 관한 고밀도 지능
    노드'
  object_type: Data
  tier: 1
properties:
  ethercat_jitter_max: < 10us
  max_cpu_overhead_pct: < 20
  modbus_tcp_cycle_range: 50-200ms
  mqtt_sparkplug_b_tag_scale_min: 50000
  opc_ua_jitter_range: 1-5ms
  profinet_rt_jitter_max: < 100us
  ptp_offset_unit: ns
  report_by_exception_traffic_reduction_pct: 70
  soe_timestamp_error_threshold_ms: 100
  target_throughput_tps: '> 10,000'
