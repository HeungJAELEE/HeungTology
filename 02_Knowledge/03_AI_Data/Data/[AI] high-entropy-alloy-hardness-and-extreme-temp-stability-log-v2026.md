...
object:
  description: '[AI] high-entropy-alloy-hardness-and-extreme-temp-stability-log-v2026에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  configurational_entropy_range: 1.5-2.5
  extreme_temperature_limit: 1100°C
  fracture_toughness_min: 40 MPa*m^0.5
  lattice_distortion_index_range: 5.0-8.0%
  oxidation_rate_max_100h: 0.1 mg/cm2
  phase_stability_omega_min: '1.1'
  swelling_threshold_100dpa: 0.5 dpa
  vickers_hardness_min: 850 HV
  yield_strength_1600k_min: 550 MPa
semantic:
  alternative_parents: []
