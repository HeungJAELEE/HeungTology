...
lineage:
  ...
  original_hash: a7fb760dde03aaab77dedf30bfb190d06a3c226b7bc0b2b031775105774cd741
metadata:
  date: '2026-05-16'
  domain: 03_AI_Data
...
object:
  description: '[AI] collaborative-robot-cobot-safety-sensor-response-time-log-v2026에
    관한 고밀도 지능 노드'
  object_type: Data
  tier: 1
properties:
  capacitive_skin_response_time_ms: <1
  capacitive_skin_stop_distance_mm: <5
  flat_surface_speed_increase_pct: 20
  imu_response_time_ms: <2
  iso_15066_max_collision_force_n: 140
  joint_torque_response_time_ms: 5-20
  joint_torque_stop_distance_mm: 10-30
  laser_scanner_response_time_ms: 50-150
  laser_scanner_stop_distance_mm: 100-500
  predictive_stop_lookahead_sec: 0.5
  safety_standard: ISO 15066
  sensor_fusion_bottleneck_latency_ms: 10
