---
Basic:
  id: "flexible-display-bending-stress-and-fatigue-log-v2026-data"
...
Object:
  ...
  physical_model: "N/A"
Semantic:
  tags: '["#DataLog", "#Flexible_Display", "#Bending_Stress", "#Fatigue_Test", "#Foldable", "#Neutral_Plane", "#Delamination", "#Display_Reliability", "#HDS_Gold_v6_1"]'
  is_part_of: '["Entity oled-evaporation-process-and-fine-metal-mask-fmm", "MOC 51_next-gen-display-and-nano-photonics-hub"]'
  related_to: []
Dynamic:
...
2. **(수리)** 영률(Young's Modulus)이 $3 \text{ GPa}$인 폴리이미드 기판의 두께가 $100 \mu m$이고 곡률 반경 $5mm$로 굽혔을 때, 기판 최외곽에 걸리는 최대 응력($MPa$)은 얼마인가? (중립면이 정중앙에 있다고 가정)
