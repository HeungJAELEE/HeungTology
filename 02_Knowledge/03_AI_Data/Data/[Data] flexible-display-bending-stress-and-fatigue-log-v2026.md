---
lineage:
  dataset_reference: flexible-display-bending-stress-and-fatigue-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] flexible-display-bending-stress-and-fatigue-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for flexible-display-bending-stress-and-fatigue-log-v2026
  object_type: Data
  tier: 1
properties:
  bending_stress_model: sigma = E * (y / R)
  fixed_curved_max_stress_mpa: 25.0
  fixed_curved_radius_r: 1000
  fixed_curved_resistance_change_percent: 0.05
  in_folding_max_cycles: 200000
  in_folding_max_resistance_change_percent: 2.0
  in_folding_max_stress_mpa: 150.0
  in_folding_radius_mm: 1.5
  neutral_plane_target_stress_mpa: 0.0
  out_folding_max_cycles: 150000
  out_folding_max_resistance_change_percent: 3.5
  out_folding_max_stress_mpa: 120.0
  out_folding_radius_mm: 3.0
  rollable_max_cycles: 100000
  rollable_max_resistance_change_percent: 1.5
  rollable_max_stress_mpa: 80.0
  rollable_radius_mm: 5.0
  stretchable_min_cycles: 10000
  stretchable_min_resistance_change_percent: 10.0
semantic:
  alternative_parents: []
  is_instance_of: '[[ [03_AI_Data] [Concept] flexible-display-bending-stress-and-fatigue-log-v2026]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: type_inference
  object: Data
  predicate: auto_mapped
  subject: flexible-display-bending-stress-and-fatigue-log-v2026
  weight: 0.95
temporal:
...
본 로그는 패널의 총 두께를 줄이고 핵심 소자(OLED)를 중립면($y \approx 0$)에 배치함으로써, 곡률 반경이 $1.5\ \text{mm}$로 작아지더라도 실질 응력을 탄성 범위 내로 억제하는 수리적 근거를 제시합니다.
...
2. **(수리)** 영률(Young's Modulus)이 $3 \text{ GPa}$인 폴리이미드 기판의 두께가 $100 \mu\text{m}$이고 곡률 반경 $5\ \text{mm}$로 굽혔을 때, 기판 최외곽에 걸리는 최대 응력($MPa$)은 얼마인가? (중립면이 정중앙에 있다고 가정)
