...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] solid-state-battery-interface-impedance-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for solid-state-battery-interface-impedance-log-v2026
  object_type: Data
  tier: 1
properties:
  coated_interface_resistance_max_ohm_cm2: 5
  energy_density_penalty_at_50mpa_percent: 20
  equivalent_circuit_model_impedance_formula: Z(w) = Rb + Rgb/(1+(jwCgb)^alpha) +
    Rint/(1+(jwCint)^beta)
  nanocoating_rct_reduction_factor: 10
  oxide_llzo_conductivity_s_cm: 10^-3 ~ 10^-4
  polymer_peo_conductivity_s_cm: 10^-5 ~ 10^-6
  sulfide_lps_conductivity_s_cm: 10^-2 ~ 10^-3
semantic:
  alternative_parents: []
  is_instance_of: '[[ [03_AI_Data] [Concept] solid-state-battery-interface-impedance-log-v2026]]'
spo_graph:
