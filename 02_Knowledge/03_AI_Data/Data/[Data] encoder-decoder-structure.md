...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] encoder-decoder-structure]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for encoder-decoder-structure
  object_type: Concept
  tier: 1
properties:
  attention_heads_range: 8 ~ 64
  cross_attention_error_threshold: < 0.1
  d_model_range: 512 ~ 4096
  flops_per_token_estimate: 12 * N * d
  information_bottleneck_ratio: 1/8 ~ 1/4
  max_sequence_length_range: 2,048 ~ 128k
  min_inference_throughput: '> 50 tokens/s'
  vram_usage_overhead: 2 * Params
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 03_AI_Data]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: automated_structural_classification
  object: Data
