...
object:
  description: '[AI] solid-state-battery-interface-impedance-log-v2026에 관한 고밀도 지능
    노드'
  object_type: Data
  tier: 1
properties:
  coated_interface_resistance_max_ohm_cm2: 5
  critical_current_density_symbol: CCD
  interface_resistance_symbol: R_int
  ionic_conductivity_symbol: sigma
  linbo3_coating_rct_reduction_factor: 10
  oxide_llzo_conductivity_s_cm: 10^-3 ~ 10^-4
  oxide_llzo_pressure_mpa: 50 ~ 100
  oxide_llzo_resistance_ohm_cm2: 100 ~ 500
  polymer_peo_pressure_threshold_mpa: 5
  pressure_50mpa_energy_density_reduction_pct: 20
  sulfide_lps_conductivity_s_cm: 10^-2 ~ 10^-3
  sulfide_lps_resistance_ohm_cm2: 10 ~ 50
  warburg_impedance_context: ion_diffusion_coefficient
semantic:
  alternative_parents: []
