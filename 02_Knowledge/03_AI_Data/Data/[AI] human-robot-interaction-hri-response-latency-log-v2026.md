...
lineage:
  ...
  original_hash: 0ff1048a436817e4e9f59956ed542a5a1a361407d9d2cef1ff143acbf0acfcf1
metadata:
  date: '2026-05-16'
  domain: 03_AI_Data
...
object:
  description: '[AI] human-robot-interaction-hri-response-latency-log-v2026에 관한 고밀도
    지능 노드'
  object_type: Data
  tier: 1
properties:
  emotional_speed_reduction_rate: 0.3
  external_log_reference: urban-air-mobility-uam-noise-and-propulsion-efficiency-log-v2026
  inference_time_t_inf_ms: 45
  measured_gesture_accuracy: 0.984
  measured_interaction_fidelity: 96.8
  measured_response_latency_ms: 145
  measured_safety_buffer_m: 0.85
  measured_social_trust_index: 92.5
  measured_speech_lag_ms: 85
  nlu_noise_threshold_db: 70
  nlu_token_error_rate: 0.15
  target_gesture_accuracy: 0.98
  target_interaction_fidelity: 95.0
  target_response_latency_ms: 200
  target_safety_buffer_m: 0.5
  target_social_trust_index: 90.0
  target_speech_lag_ms: 150
semantic:
  alternative_parents: []
