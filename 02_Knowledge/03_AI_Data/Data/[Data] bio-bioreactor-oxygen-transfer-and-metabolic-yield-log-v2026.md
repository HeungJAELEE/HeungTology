---
lineage:
  dataset_reference: bio-bioreactor-oxygen-transfer-and-metabolic-yield-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] bio-bioreactor-oxygen-transfer-and-metabolic-yield-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for bio-bioreactor-oxygen-transfer-and-metabolic-yield-log-v2026
  object_type: Data
  tier: 1
properties:
  biomass_density_range: 40-60 g/L
  dissolved_o2_concentration_range: 30-40%
  kla_coefficient_range: 50-150 hr-1
  otr_model_formula: OTR = kLa * (C* - CL)
  our_consumption_rate_range: 10-40 mmol/L/h
  oxygen_solubility_c_star: 0.25 mmol/L
  power_number_range: 0.5-5.0
  product_yield_threshold: '> 0.45 g/g'
  shear_stress_tip_speed_max: < 1.5 m/s
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: bio-bioreactor-oxygen-transfer-and-metabolic-yield-log-v2026
  weight: 1.0
temporal:
