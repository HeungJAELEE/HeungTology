...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] semiconductor-plasma-etching-selectivity-and-cd-control-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for semiconductor-plasma-etching-selectivity-and-cd-control-log-v2026
  object_type: Concept
  tier: 1
properties:
  bias_voltage_range: 100-500 V
  cd_bias_threshold: < 1.0 nm
  chamber_pressure_range: 10-50 mTorr
  etch_rate_range: 2000-5000 A/min
  etch_rate_uniformity_threshold: < 2.0%
  ion_energy_relation: ER_perp proportional to sqrt(V_bias) * n_i
  mask_erosion_rate_threshold: < 100 A/min
...
semantic:
  alternative_parents: []
  is_instance_of: '[[ [03_AI_Data] [Concept] semiconductor-plasma-etching-selectivity-and-cd-control-log-v2026]]'
spo_graph:
