---
Basic:
  id: "flip-chip-underfill-void-and-delamination-log-v2026-data"
...
Object:
  ...
  physical_model: "N/A"
Semantic:
  tags: '["#DataLog", "#Underfill", "#Flip-Chip", "#Void", "#Delamination", "#CSAM", "#Adhesion", "#Packaging", "#Reliability", "#HDS_Gold_v6_1"]'
...
| 공정 방식 (Type) | 갭 높이 ($\mu m$) | 유동 시간 ($s$) | 보이드 면적 (%) | 접착 강도 ($MPa$) | 공학적 의미 (Rationale V6.3.7) |
| :--- | :---: | :---: | :---: | :---: | :--- |
