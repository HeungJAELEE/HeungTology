...
lineage:
  ...
  original_hash: 5ad9406b475e0fad83ecf7dbe24258b42d8f8d00e81a9d4a1c94bb655ec27129
metadata:
  date: '2026-05-16'
  domain: 03_AI_Data
...
object:
  description: '[AI] mri-ct-imaging-resolution-and-diagnostic-accuracy-log-v2026에
    관한 고밀도 지능 노드'
  object_type: Data
  tier: 1
properties:
  acquisition_time_min: 12.5
  acquisition_time_threshold_min: 15.0
  rad_dose_mSv: 2.1
  rad_dose_threshold_mSv: 3.0
  sensitivity_pct: 96.4
  sensitivity_threshold_pct: 95.0
  snr_db: 45.2
  snr_threshold_db: 40.0
  spatial_resolution_mm: 0.48
  spatial_resolution_threshold_mm: 0.5
  specificity_pct: 94.5
  specificity_threshold_pct: 94.0
semantic:
  alternative_parents: []
