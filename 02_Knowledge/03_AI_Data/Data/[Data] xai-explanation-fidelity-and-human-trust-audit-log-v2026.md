...
lineage:
  ...
  original_hash: b6b413600637d5e3349b0fdedc65c6058b1312b1122550986e7c83904c489706
metadata:
  date: '2026-05-16'
  domain: 03_AI_Data
...
object:
  description: '[Data] xai-explanation-fidelity-and-human-trust-audit-log-v2026에 관한
    고밀도 지능 노드'
  object_type: Data
  tier: 1
properties:
  ...
  contrast_ratio_threshold: 1.5
  faithfulness_threshold: 0.98
  fidelity_limit_default: 0.95
  pathway_visualization_threshold: 90.0
  specification_standard: HDS-Gold V6.3.7
  stability_score_threshold: 0.95
  trust_target_default: 40.0
  user_confidence_target: 45.0
  zero_hallucination_target: 100.0
semantic:
  alternative_parents: []
