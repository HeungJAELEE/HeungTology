---
lineage:
  dataset_reference: maintenance-work-order-history-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] maintenance-work-order-history-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for maintenance-work-order-history-v2026
  object_type: Data
  tier: 1
properties:
  avg_labor_hours_standard: 3.5 hr/wo
  emergency_rate_standard: 12%
  emergency_rate_target: < 5%
  maintenance_efficiency_formula: delta_mtbf / total_maintenance_cost
  mttr_standard: 1.8 hr
  mttr_target: < 1.5 hr
  pm_compliance_standard: 96.5%
  pm_compliance_target: '> 98%'
  spare_parts_availability_standard: 98.2%
  spare_parts_availability_target: '> 99%'
  spares_prediction_model: poisson_distribution
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: maintenance-work-order-history-v2026
  weight: 0.95
temporal:
