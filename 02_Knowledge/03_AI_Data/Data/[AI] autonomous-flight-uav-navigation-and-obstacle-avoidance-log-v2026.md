...
object:
  description: '[AI] autonomous-flight-uav-navigation-and-obstacle-avoidance-log-v2026에
    관한 고밀도 지능 노드'
  object_type: Data
  tier: 1
properties:
  battery_consumption_increase: 30%
  target_position_error: 0.8m
  target_reaction_time: 150ms
  urban_canyon_trajectory_deviation: 2m
  verified_detect_range: 120m
  verified_gps_hdop: '0.85'
  verified_nav_error_rms: 0.75m
  verified_path_adherence: 99.2%
  verified_reaction_time: 145ms
  verified_wind_resistance: 15.4m/s
