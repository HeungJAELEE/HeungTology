...
lineage:
  ...
  original_hash: 609780e4d680d392010e23f0cd0fd46e62c8797cf65bb8bce18248a13ac3f3f5
metadata:
  date: '2026-05-16'
  domain: 03_AI_Data
...
object:
  description: '[AI] advanced-alloy-tensile-strength-and-grain-size-log-v2026에 관한
    고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  cooling_rate_delta: 10C/s
  critical_low_temperature: -150C
  grain_size_standard: 5um
  tensile_strength_threshold: 2000MPa
  verified_avg_grain_size: 3.5um
  verified_elongation: 12.5%
  verified_fracture_toughness: 85MPa*m^1/2
  verified_hardness_hv: 650HV
  verified_tensile_strength: 2150MPa
  verified_yield_strength: 1850MPa
semantic:
  alternative_parents: []
