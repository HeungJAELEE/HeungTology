---
Basic:
  id: "chiplet-packaging-hybrid-bonding-alignment-accuracy-log-v2026-data"
...
Object:
  ...
  physical_model: "N/A"
Semantic:
  tags: '["#DataLog", "#Chiplet", "#Hybrid_Bonding", "#Packaging", "#Alignment", "#3D-IC", "#Interconnect", "#Semiconductor", "#TSV", "#HDS_Gold_v6_1"]'
  is_part_of: '["MOC 20_semiconductor-manufacturing-and-metrology-intelligence-hub", "Data wafer-warpage-and-stress-profile-log-v2026"]'
  related_to: []
Dynamic:
...
| 본딩 방식 (Method) | 패드 피치 ($\mu m$) | 정렬 정확도 ($nm$) | 본딩 강도 ($J/m^2$) | 보이드 밀도 (%) | 공학적 의미 (Rationale V6.3.7) |
| :--- | :---: | :---: | :---: | :---: | :--- |
