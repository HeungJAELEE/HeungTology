---
lineage:
  dataset_reference: vanadium-redox-flow-battery-vrfb-energy-density-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] vanadium-redox-flow-battery-vrfb-energy-density-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for vanadium-redox-flow-battery-vrfb-energy-density-log-v2026
  object_type: Data
  tier: 1
properties:
  energy_density_wh_l_range: 20-40
  extreme_concentration_electrolyte_m: 2.5
  faradays_law_energy_density_model: E_vol = 0.5 * C * F * delta_V
  high_concentration_electrolyte_m: 2.0
  mixed_acid_energy_density_wh_l_min: 35.0
  precipitation_risk_temperature_threshold_celsius: 45
  pumping_loss_pct_range: 2-5
  rebalancing_lifespan_years_min: 30.0
  round_trip_efficiency_rte_pct_range: 75-85
  stack_power_density_mw_cm2_range: 100-250
  standard_electrolyte_concentration_m: 1.5
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: vanadium-redox-flow-battery-vrfb-energy-density-log-v2026
  weight: 1.0
temporal:
