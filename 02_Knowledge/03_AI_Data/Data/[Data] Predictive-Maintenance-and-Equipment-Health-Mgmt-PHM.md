...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] Predictive-Maintenance-and-Equipment-Health-Mgmt-PHM]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for Predictive-Maintenance-and-Equipment-Health-Mgmt-PHM
  object_type: Concept
  tier: 1
properties:
  economic_loss_per_incident: ~$2.5M
  low_latency_threshold: <10ms
  max_unplanned_downtime: <1.0%
  physics_of_failure_laws:
  - Arrhenius
  - Paris' Law
  rul_prediction_confidence_interval: 95.0%
  target_asset_availability: 99.0%
semantic:
  alternative_parents: []
  is_instance_of: '[[ [03_AI_Data] [Concept] Predictive-Maintenance-and-Equipment-Health-Mgmt-PHM]]'
spo_graph:
