...
object:
  description: '[AI] exoskeleton-strength-amplification-and-metabolic-gain-log-v2026에
    관한 고밀도 지능 노드'
  object_type: Data
  tier: 1
properties:
  audit_log_endpoint: HDS_Gold_v6_1
  battery_efficiency: 10.5 hr/kWh
  emg_signal_log_endpoint: RAG-3.1
  ergonomic_rating: 9.2/10
  frame_deformation_log_endpoint: RAG-3.2
  heart_rate_reduction_verified: -45 bpm
  metabolic_gain_verified: 32.0%
  strength_amplification_verified: 12.5x
  sync_latency_threshold: 10 ms
