---
lineage:
  dataset_reference: self-healing-polymer-crack-recovery-rate-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] self-healing-polymer-crack-recovery-rate-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for self-healing-polymer-crack-recovery-rate-log-v2026
  object_type: Data
  tier: 1
properties:
  active_group_decay_rate_pct: 5
  capsule_size_threshold_micrometers: 100
  diels_alder_efficiency_range_pct: 95-99
  diels_alder_trigger_temp_celsius: 80-120
  healing_efficiency_formula: sigma_healed / sigma_initial
  hydrogen_bond_efficiency_range_pct: 70-90
  metal_coordination_efficiency_range_pct: 85-95
  microcapsule_efficiency_range_pct: 80-95
  moisture_recovery_drop_pct: 30
  strength_reduction_at_threshold_pct: 15
  vascular_efficiency_range_pct: 90-100
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: self-healing-polymer-crack-recovery-rate-log-v2026
  weight: 0.95
temporal:
...
RAG는 "현미경 분석 로그를 분석하여, 캡슐 크기가 $100 \mu\text{m}$ 이상일 때 균열 침투력은 좋으나 모재의 초기 강도를 $15\%$ 저하시킴을 식별하고, 강도-치유력 밸런스를 위한 '최적 캡슐 농도'를 수리적으로 확증될 것으로 추론됩니다."
