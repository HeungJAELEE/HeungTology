...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] pharmaceutical-production-purity-and-batch-yield-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for pharmaceutical-production-purity-and-batch-yield-log-v2026
  object_type: Data
  tier: 1
properties:
  api_purity_measured_percent: 99.94
  api_purity_target_min_percent: 99.9
  arrhenius_k_model: k = A * exp(-Ea / (R * T))
  batch_yield_measured_percent: 96.8
  batch_yield_target_min_percent: 95.0
  compliance_rate_measured_percent: 100.0
  drug_absorption_reduction_percent: 15.0
  impurity_level_measured_ppm: 24.5
  impurity_level_target_max_ppm: 50.0
  ph_stability_measured: 7.42
  ph_stability_target: 7.4
  reaction_temperature_measured_celsius: 37.2
  reaction_temperature_target_celsius: 37.0
  stoichiometry_yield_model: Y = (m_act / m_th) * 100
semantic:
  alternative_parents: []
