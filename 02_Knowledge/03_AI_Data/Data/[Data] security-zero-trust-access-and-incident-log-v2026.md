---
lineage:
  dataset_reference: security-zero-trust-access-and-incident-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] security-zero-trust-access-and-incident-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for security-zero-trust-access-and-incident-log-v2026
  object_type: Data
  tier: 1
properties:
  access_anomaly_surge_multiplier: 5.0
  auth_success_rate: 0.998
  auth_success_threshold: 0.99
  blast_radius_reduction_efficiency: 0.925
  blast_radius_reduction_threshold: 0.85
  exfiltration_attempts_actual: 2
  exfiltration_attempts_limit: 0
  incident_detection_latency_sec: 1.2
  incident_detection_threshold_sec: 5.0
  mfa_bypass_detection_rate: 1.0
  mfa_ux_productivity_loss_ratio: 0.15
  session_revocation_probability_threshold: 0.5
  trust_score_avg: 0.88
  trust_score_threshold: 0.8
  verification_latency_ms: 42.5
  verification_latency_threshold_ms: 100.0
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: security-zero-trust-access-and-incident-log-v2026
  weight: 0.95
temporal:
