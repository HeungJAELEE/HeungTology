---
lineage:
  dataset_reference: bio-health-pandemic-surveillance-and-response-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] bio-health-pandemic-surveillance-and-response-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for bio-health-pandemic-surveillance-and-response-log-v2026
  object_type: Data
  tier: 1
properties:
  bayesian_prediction_confidence_pct: 95.0
  case_fatality_rate_max_pct: 0.5
  critical_rt_threshold: 1.2
  default_bed_capacity: 10000
  genome_tracking_min_coverage_pct: 15.0
  hospital_bed_occupancy_max_pct: 80.0
  mutation_analysis_max_hrs: 12
  ppe_buffer_days_min: 90
  reproduction_no_target: 1.0
  social_compliance_min_pct: 90.0
  wastewater_leading_indicator_days: 7-10
  wastewater_viral_load_range: 10^2-10^7
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: bio-health-pandemic-surveillance-and-response-log-v2026
  weight: 0.5
temporal:
