...
lineage:
  ...
  original_hash: 4ef0a3dc6da396346dc6832868f5ff7f863f0347ec81b92ea3b6f7c59bee8b40
metadata:
  date: '2026-05-16'
  domain: 03_AI_Data
...
object:
  description: '[AI] urban-water-distribution-leakage-and-pressure-monitoring-log-v2026에
    관한 고밀도 지능 노드'
  object_type: Data
  tier: 1
properties:
  ...
  external_power_grid_log_endpoint: power-grid-stability-and-frequency-regulation-log-v2026
  grid_pressure_measured_bar: 3.54
  grid_pressure_target_max_bar: 4.0
  grid_pressure_target_min_bar: 3.0
  leak_detection_accuracy_measured_percent: 98.6
  leak_detection_accuracy_target_min_percent: 98.0
  leakage_flow_model_ql: C * A * sqrt(2g * P / (rho * g))
  nrw_rate_measured_percent: 4.85
  nrw_rate_target_max_percent: 5.0
  pipe_vibration_measured_g: 0.012
  pipe_vibration_target_max_g: 0.05
  water_flow_m3_h: 12450
  water_hammer_pressure_delta_p: rho * a * delta_v
semantic:
  alternative_parents: []
