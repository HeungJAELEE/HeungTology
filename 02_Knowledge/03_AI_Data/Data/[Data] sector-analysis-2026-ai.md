---
lineage:
  dataset_reference: sector-analysis-2026-ai
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] sector-analysis-2026-ai]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for sector-analysis-2026-ai
  object_type: Concept
  tier: 1
properties:
  actuator_torque_density_nm_kg: 15-30
  agentic_latency_threshold_ms: < 15
  engine_specification: HDS-Gold V6.3.7
  hbm4_memory_bandwidth_tbs: 1.5-2.0
  inference_cost_per_1m_tokens_usd: < 0.01
  optimized_attention_complexity: O(n)
  physical_ai_control_freq_hz: 100-500
  rack_power_density_kw: 120-200
  smr_output_mw: 300-600
  standard_attention_complexity: O(n^2)
  target_pue: <= 1.05
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: sector-analysis-2026-ai
  weight: 0.9
temporal:
