...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] thin-film-metrology-ellipsometry-thickness-accuracy-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for thin-film-metrology-ellipsometry-thickness-accuracy-log-v2026
  object_type: Data
  tier: 1
properties:
  ellipsometry_fundamental_equation: rho = tan(psi) * exp(i * delta)
  mse_critical_threshold: 10.0
  photoresist_refractive_index_range:
  - 1.6
  - 1.8
  polysilicon_refractive_index_range:
  - 3.8
  - 4.1
  refractive_index_chemical_sensitivity_delta: 0.05
  silicon_nitride_accuracy_range_angstrom:
  - 0.2
  - 0.5
  silicon_nitride_refractive_index_range:
  - 2.01
  - 2.1
  silicon_oxide_accuracy_threshold_angstrom: 0.1
  silicon_oxide_refractive_index_633nm: 1.457
  surface_roughness_mse_trigger_nm_rms: 1.0
  thickness_precision_1sigma_target_nm: 0.01
semantic:
  alternative_parents: []
