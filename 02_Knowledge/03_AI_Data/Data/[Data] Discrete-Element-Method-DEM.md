---
lineage:
  dataset_reference: Discrete-Element-Method-DEM
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] Discrete-Element-Method-DEM]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for Discrete-Element-Method-DEM
  object_type: Algorithm
  tier: 1
properties:
  cfd_dem_error_margin: 5%
  friction_coefficient_range: 0.1 ~ 0.8
  hds_gold_version: V6.3.7
  lacey_index_target: '> 0.95'
  poissons_ratio_range: 0.2 ~ 0.45
  restitution_coefficient_range: 0.1 ~ 0.9
  time_step_rayleigh_limit: < 20% of TR
  youngs_modulus_range: 10^6 ~ 10^9 Pa
semantic:
  alternative_parents: []
