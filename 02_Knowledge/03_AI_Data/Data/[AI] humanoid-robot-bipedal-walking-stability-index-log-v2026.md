...
lineage:
  ...
  original_hash: 2cc732c7cfb804c93f5b653ac295d4b4fb6172daa4b0eaf2d9ff1f5fe2247c92
metadata:
  date: '2026-05-16'
  domain: 03_AI_Data
...
object:
  description: '[AI] humanoid-robot-bipedal-walking-stability-index-log-v2026에 관한
    고밀도 지능 노드'
  object_type: Data
  tier: 1
properties:
  atlas_recovery_time_max_ms: 150
  fall_probability_increase_at_threshold: 0.4
  lipm_period_formula: T = sqrt(h/g)
  mpc_delay_threshold_ms: 10
  optimus_zmp_margin_cm: 5.0-8.0
  unitree_h1_walking_speed_kmh: 3.5-6.0
  zmp_margin_requirement: '> 0'
semantic:
  alternative_parents: []
