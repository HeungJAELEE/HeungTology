---
lineage:
  dataset_reference: model-quantization-and-edge-inference-speed-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] model-quantization-and-edge-inference-speed-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for model-quantization-and-edge-inference-speed-log-v2026
  object_type: Data
  tier: 1
properties:
  bert_int4_accuracy_drop_range: 1.0 ~ 3.0
  bert_int4_speedup_factor: 5.5
  lstm_int16_speedup_factor: 1.8
  mobilenet_int8_accuracy_drop_range: 0.5 ~ 1.5
  mobilenet_int8_speedup_factor: 2.5
  quantization_scale_parameter: s
  resnet50_int8_accuracy_drop_range: 0.2 ~ 0.5
  resnet50_int8_speedup_factor: 3.5
  simd_throughput_increase_ratio_32to8bit: 4.0
  yolov8_int8_accuracy_drop_range: 0.1 ~ 0.3
  yolov8_int8_speedup_factor: 4.2
  zero_point_parameter: z
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: model-quantization-and-edge-inference-speed-log-v2026
  weight: 0.95
temporal:
