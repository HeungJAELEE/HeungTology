...
measurement:
  ...
  precision: '0.0'
  unit: Accuracy** | Top-1 Accuracy | > 92%
  value: 1
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] emotion-recognition-augmentation]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for emotion-recognition-augmentation
  object_type: Concept
  tier: 1
properties:
  facial_keypoint_range: 68-468
  max_false_positive_rate: < 3%
  max_inference_latency_ms: 50
  min_audio_sampling_rate_khz: 16
  min_micro_expression_fps: 120
  modality_fusion_mechanism: multi-head cross-attention
  target_top_1_accuracy: '> 92%'
  valence_arousal_quantization_levels: 10
semantic:
  alternative_parents: []
  is_instance_of: '[[ [03_AI_Data] [Concept] emotion-recognition-augmentation]]'
spo_graph:
