...
object:
  description: '[AI] industry-edge-computing-data-offloading-efficiency-log-v2026에
    관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  bandwidth_saving_min_mbps: 20.0
  compression_ratio_min_pct: 90.0
  edge_limit_cpu_pct: 85.0
  edge_usage_max_pct: 70
  edge_usage_min_pct: 40
  energy_saving_min_mw: 50.0
  latency_gain_threshold_ms: 100
  min_latency_gain_ms: 50.0
  node_temp_max_celsius: 65
  offload_latency_max_ms: 15
  task_success_rate_min_pct: 99.9
semantic:
  alternative_parents: []
