---
lineage:
  dataset_reference: NVLink-Interconnect-Hardware
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] NVLink-Interconnect-Hardware]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for NVLink-Interconnect-Hardware
  object_type: Hardware
  tier: 1
properties:
  bandwidth_bottleneck_wait_threshold_pct: 30
  blackwell_aggregate_bw_gpu_min: 1.8 TB/s
  blackwell_bit_error_rate_max: 10^-12
  blackwell_max_gpu_domain: 576
  blackwell_modulation: PAM4 (112G)
  blackwell_p2p_latency_max: 100 ns
  blackwell_topology: NVSwitch (All-to-All)
  eye_height_formula: Vpp - 2 * Vnoise_peak
  p2p_latency_total_formula: L_total = L_prot + (Data_Size / Bandwidth) + (d/v)
  shannon_hartley_capacity_formula: C = n * B * log2(1 + SNR)
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 03_AI_Data]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: automated_system_classification
  object: Data
  predicate: auto_mapped
  subject: NVLink-Interconnect-Hardware
  weight: 0.5
temporal:
