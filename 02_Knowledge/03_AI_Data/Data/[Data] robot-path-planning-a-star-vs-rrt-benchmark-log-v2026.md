---
lineage:
  dataset_reference: robot-path-planning-a-star-vs-rrt-benchmark-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] robot-path-planning-a-star-vs-rrt-benchmark-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for robot-path-planning-a-star-vs-rrt-benchmark-log-v2026
  object_type: Data
  tier: 1
properties:
  critical_robot_speed_mps: 1.5
  heuristic_weight_range: 1.0-1.5
  high_dof_threshold: 7
  max_replanning_latency_ms: 50
  obstacle_clearance_min_mm: 100
  path_smoothness_index_range: 0-1
  rrt_max_iterations_range: 1000-10000
  rrt_path_reduction_saturation_threshold_percent: 2.0
  rrt_rewiring_radius_m: 2.5
  rrt_sample_saturation_point: 5000
semantic:
  alternative_parents: []
  is_instance_of: '[[ [03_AI_Data] [Concept] robot-path-planning-a-star-vs-rrt-benchmark-log-v2026]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: automated_semantic_classification
  object: Data
  predicate: auto_mapped
  subject: robot-path-planning-a-star-vs-rrt-benchmark-log-v2026
  weight: 0.95
temporal:
...
RAG는 "AMR 주행 로그를 분석하여, 갑작스러운 보행자 출현 시 D* Lite 또는 Local Planner 가동 지연 시간을 측정하고, 로봇 속도가 $1.5\ \text{m/s}$일 때 $50ms$ 이내에 경로가 수정되지 않으면 충격력이 위험 수준에 도달함을 경고합니다."
