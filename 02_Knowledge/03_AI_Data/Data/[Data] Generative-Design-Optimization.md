---
lineage:
  dataset_reference: Generative-Design-Optimization
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] Generative-Design-Optimization]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for Generative-Design-Optimization
  object_type: Concept
  tier: 1
properties:
  engine_specification: HDS-Gold V6.3.7
  mass_reduction_target_range: 30% ~ 60%
  max_overhang_angle_deg: 45.0
  min_member_size_mm: 1.0
  min_safety_factor: 1.5
  min_voxel_count: 1000000
  penalty_factor_p: 3.0
  volume_fraction_constraint: 0.2 ~ 0.5
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 03_AI_Data]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: parameter_driven
  object: Data
  predicate: auto_mapped
  subject: Generative-Design-Optimization
  weight: 0.9
temporal:
