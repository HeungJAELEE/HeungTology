...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] annual-operating-plan-aop-and-variance-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for annual-operating-plan-aop-and-variance-log-v2026
  object_type: Concept
  tier: 1
properties:
  actual_capex_variance_pct: -16.7
  actual_cogs_ratio: 0.643
  actual_cogs_variance_pct: 5.0
  actual_op_profit_variance_pct: -20.0
  actual_opex_variance_pct: -5.0
  actual_revenue_variance_pct: -2.0
  capex_utilization_rate_formula: (actual_capex_spend / approved_capex_budget) * 100
  degree_of_operating_leverage_formula: '% delta_operating_income / % delta_sales'
  operating_profit_variance_formula: (actual_op_profit - planned_op_profit) / planned_op_profit
    * 100
  plan_achievement_index_threshold: 1.0
  revenue_decomposition_formula: delta_r = delta_p * v_plan + p_plan * delta_v + mix_factor
  revenue_variance_formula: (actual_revenue - planned_revenue) / planned_revenue *
    100
semantic:
  alternative_parents: []
  is_instance_of: '[[ [03_AI_Data] [Concept] annual-operating-plan-aop-and-variance-log-v2026]]'
spo_graph:
