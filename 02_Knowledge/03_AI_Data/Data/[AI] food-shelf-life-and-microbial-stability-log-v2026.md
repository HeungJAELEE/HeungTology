...
object:
  description: '[AI] food-shelf-life-and-microbial-stability-log-v2026에 관한 고밀도 지능
    노드'
  object_type: Data
  tier: 1
properties:
  arrhenius_model_application: temperature_dependent_degradation
  gompertz_model_application: microbial_growth_prediction
  ...
  microbial_count_threshold: 1.0e5 CFU/g
  oxidation_rate_threshold: 10.0 meq/kg
  shelf_life_target: 12.0 days
  storage_temp_range: 0-5 C
  water_activity_threshold: 0.85 Aw
semantic:
  alternative_parents: []
