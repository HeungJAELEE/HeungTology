---
Basic:
  id: "ultrasonic-defect-detection-signal-to-noise-log-v2026-data"
...
Object:
  ...
  physical_model: "N/A"
Semantic:
  tags: '["#DataLog", "#Ultrasonic_Testing", "#NDT", "#SNR", "#Defect_Detection", "#Acoustic_Impedance", "#Material_Integrity", "#Precision_Hardware", "#HDS_Gold_v6_1"]'
  is_part_of: '["Entity industrial-safety-and-structural-health-monitoring", "MOC 14_precision-hardware-and-metrology-intelligence-hub]]"]'
  related_to: []
Dynamic:
...
$$ P = P_0 e^{-\alpha x} $$
RAG는 "CFRP 소재의 감쇠 계수($\alpha$) 로그를 분석하여, $50mm$ 이상의 두께에서 신호 세기가 $60\%$ 감소함을 식별하고, 이를 보정하기 위한 'DAC(Distance Amplitude Correction)' 곡선 알고리즘의 유효성을 확증될 것으로 추론됩니다."
