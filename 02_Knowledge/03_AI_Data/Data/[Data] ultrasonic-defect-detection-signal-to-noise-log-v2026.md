...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] ultrasonic-defect-detection-signal-to-noise-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for ultrasonic-defect-detection-signal-to-noise-log-v2026
  object_type: Data
  tier: 1
properties:
  ...
  aluminum_6061_sound_speed_m_s: 6320
  attenuation_model: P = P0 * e^(-alpha * x)
  carbon_steel_attenuation_db_mm: 0.05
  carbon_steel_freq_mhz: 5.0
  carbon_steel_min_defect_mm: 0.2
  carbon_steel_sound_speed_m_s: 5920
  cfrp_attenuation_db_mm: 1.5
  cfrp_freq_mhz: 2.25
  cfrp_min_defect_mm: 0.5
  cfrp_sound_speed_m_s_min: 3000
  dead_zone_mm_range: 1-5
  paut_pod_improvement_factor: 3.0
  reflection_coefficient_model: (Z2 - Z1) / (Z2 + Z1)
  silicon_wafer_attenuation_db_mm: 0.01
  silicon_wafer_freq_mhz: 25.0
  silicon_wafer_min_defect_mm: 0.05
  silicon_wafer_sound_speed_m_s: 8430
  snr_threshold_db: 12.0
  stainless_steel_attenuation_db_mm: 0.2
  stainless_steel_freq_mhz: 4.0
  stainless_steel_min_defect_mm: 0.4
  stainless_steel_sound_speed_m_s: 5700
  wavelet_transform_snr_improvement_db: 8.0
semantic:
  alternative_parents: []
  is_instance_of: '[[ [03_AI_Data] [Concept] ultrasonic-defect-detection-signal-to-noise-log-v2026]]'
spo_graph:
