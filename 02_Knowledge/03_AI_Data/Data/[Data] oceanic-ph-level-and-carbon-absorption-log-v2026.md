---
Basic:
  id: "oceanic-ph-level-and-carbon-absorption-log-v2026-data"
  domain: "118_Environmental_Engineering_and_Earth_Systems"
...
Object:
  ...
  physical_model: "N/A"
Semantic:
  tags: '["#DataLog", "#Environmental_Science", "#Oceanography", "#pH_Level", "#Carbon_Absorption", "#Climate_Change", "#Earth_Systems", "#HDS_Gold_v6_1"]'
  is_part_of: '["MOC 118-environmental-engineering-and-earth-systems-hub-moc", "MOC 102_environmental-engineering-and-climate-intelligence-hub", "Data permafrost-thaw-rate-and-methane-emission-log-v2026"]'
  related_to: []
Dynamic:
...
| **DIC (Carbon)** | $2,045 \text{ \mu mol/kg}$ | **HIGH** | $> 2,000$ | 해수에 녹아 있는 총 무기 탄소량 |
| **pCO2 (Ocean)** | $412.5 \text{ \mu atm}$ | **ACTIVE** | **N/A** | 해수 표면의 이산화탄소 분압 |
...
| **Total Alkalinity**| $2,350 \text{ \mu mol/kg}$ | **BUFFERED** | $> 2,300$ | 해수의 산 중화 능력 (완충 능력) |
