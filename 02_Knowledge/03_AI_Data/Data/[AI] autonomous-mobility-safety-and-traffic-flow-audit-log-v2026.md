...
lineage:
  ...
  original_hash: eccd0c6b9ae440284fdd49155c5f0a35d41c0b04a7768bbe6991660a916cc4ea
metadata:
  date: '2026-05-16'
  domain: 03_AI_Data
...
object:
  description: '[AI] autonomous-mobility-safety-and-traffic-flow-audit-log-v2026에
    관한 고밀도 지능 노드'
  object_type: Data
  tier: 1
properties:
  collision_prob_measured: 1e-7
  collision_prob_target: 1e-6
  disengagement_rate_measured: 0.002 /km
  disengagement_rate_target: 0.005 /km
  lidar_range_reduction_rate: '0.4'
  navigation_accuracy_measured: 1.5 cm
  navigation_accuracy_target: 3.0 cm
  precipitation_threshold: 30 mm/h
  safety_target_prob: '0.000001'
  traffic_density_measured: 120 veh/km
  traffic_density_target: 100 veh/km
  traffic_throughput_improvement: '2.0'
