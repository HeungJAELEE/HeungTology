---
lineage:
  dataset_reference: chemical-reactor-temperature-and-yield-efficiency-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] chemical-reactor-temperature-and-yield-efficiency-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for chemical-reactor-temperature-and-yield-efficiency-log-v2026
  object_type: Data
  tier: 1
properties:
  arrhenius_equation_model: k = A * exp(-Ea / (RT))
  byproduct_concentration_increase_percentage: 2.0
  catalyst_activity_measured: 0.942
  chemical_yield_measured_percentage: 98.85
  conversion_rate_measured_percentage: 99.42
  heat_flux_measured_kw_m2: 12.5
  pid_response_delay_seconds: 2.0
  reaction_pressure_measured_bar: 35.4
  reactor_temp_measured_celsius: 245.2
  target_temp_precision_celsius: 0.5
  target_yield_threshold_percentage: 98.5
  temperature_peak_celsius: 3.0
  yield_calculation_model: Y = (Np_actual / Np_theoretical) * 100
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: chemical-reactor-temperature-and-yield-efficiency-log-v2026
  weight: 0.3
temporal:
