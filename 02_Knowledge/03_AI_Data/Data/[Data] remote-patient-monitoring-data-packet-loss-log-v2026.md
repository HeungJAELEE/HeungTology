---
lineage:
  dataset_reference: remote-patient-monitoring-data-packet-loss-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] remote-patient-monitoring-data-packet-loss-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for remote-patient-monitoring-data-packet-loss-log-v2026
  object_type: Data
  tier: 1
properties:
  alarm_delay_jitter_threshold_ms: 50.0
  ber_threshold: 1.0e-09
  connection_measured_pct: 99.98
  connection_target_pct: 99.9
  e2e_latency_measured_ms: 84.5
  e2e_latency_target_ms: 150.0
  interpolation_error_packet_loss_threshold_pct: 2.0
  network_jitter_measured_ms: 12.5
  network_jitter_target_ms: 20.0
  packet_loss_measured_pct: 0.24
  packet_loss_target_pct: 0.5
  signal_snr_measured_db: 32.4
  signal_snr_target_db: 25.0
  throughput_measured_kbps: 256.0
  throughput_target_kbps: 128.0
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 03_AI_Data]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: automated_schema_classification
  object: Data
  predicate: auto_mapped
  subject: remote-patient-monitoring-data-packet-loss-log-v2026
  weight: 0.9
temporal:
