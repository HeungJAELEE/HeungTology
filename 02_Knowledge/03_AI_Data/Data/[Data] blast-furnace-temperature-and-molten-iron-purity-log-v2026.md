---
lineage:
  dataset_reference: blast-furnace-temperature-and-molten-iron-purity-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] blast-furnace-temperature-and-molten-iron-purity-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for blast-furnace-temperature-and-molten-iron-purity-log-v2026
  object_type: Data
  tier: 1
properties:
  carbon_content_pct: 4.58
  furnace_efficiency_pct: 94.2
  heat_balance_model: T_raft = (Q_in - Q_out) / sum(m_i * C_pi)
  hot_blast_temp_c: 1245
  molten_iron_temp_c: 1524
  reduction_rate_model: R = ((O_initial - O_final) / O_initial) * 100
  silicon_content_pct: 0.45
  slag_basicity: 1.25
  target_carbon_content_pct_range: 4.3-4.7
  target_furnace_efficiency_min_pct: 92.0
  target_molten_iron_temp_c_range: 1510-1530
  target_silicon_content_max_pct: 0.6
  target_slag_basicity_range: 1.2-1.3
  theoretical_raft_temp_c: 2250
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: blast-furnace-temperature-and-molten-iron-purity-log-v2026
  weight: 0.85
temporal:
