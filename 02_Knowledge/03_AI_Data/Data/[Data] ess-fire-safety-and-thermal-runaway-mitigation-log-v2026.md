---
lineage:
  dataset_reference: ess-fire-safety-and-thermal-runaway-mitigation-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] ess-fire-safety-and-thermal-runaway-mitigation-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for ess-fire-safety-and-thermal-runaway-mitigation-log-v2026
  object_type: Data
  tier: 1
properties:
  aerogel_max_effective_thermal_conductivity_wmk: 0.05
  arrhenius_model_parameters:
  - activation_energy_ea
  - gas_constant_r
  - reaction_enthalpy_delta_h
  energy_balance_parameters:
  - heat_generation_rate_q_gen
  - heat_loss_rate_q_loss
  gas_sensor_activation_temp_c: 70
  h2_explosion_threshold_pct: 4.0
  lfp_off_gas_lead_time_min: 10-20
  lfp_onset_temp_c_range: 150-210
  lfp_peak_temp_c_range: 400-600
  nmc_off_gas_lead_time_min: 5-15
  nmc_onset_temp_c_range: 120-160
  nmc_peak_temp_c_range: 800-1100
  smoke_sensor_activation_temp_c: 100
  target_thermal_propagation_delay_min: 60
  vrfb_peak_temp_c_max: 50
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: ess-fire-safety-and-thermal-runaway-mitigation-log-v2026
  weight: 1.0
temporal:
