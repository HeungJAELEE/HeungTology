---
lineage:
  dataset_reference: semiconductor-vacuum-deposition-and-ald-thickness-uniformity-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] semiconductor-vacuum-deposition-and-ald-thickness-uniformity-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for semiconductor-vacuum-deposition-and-ald-thickness-uniformity-log-v2026
  object_type: Data
  tier: 1
properties:
  ald_window_temp_range_celsius: 150 ~ 350
  gpc_saturation_model: GPC = GPC_max * (1 - e^(-k * t_exp))
  gpc_target_range_angstrom_per_cycle: 0.8 ~ 1.2
  knudsen_number_formula: Kn = lambda / d
  max_leakage_current_j_a_cm2: 1.0e-08
  max_uniformity_variation_percent: 1.5
  min_density_percent_of_bulk: 95
  min_step_coverage_percent: 99.0
  refractive_index_n_range: 1.46 ~ 3.5
  total_thickness_range_angstrom: 10 ~ 1000
  wafer_diameter_mm: 300
semantic:
  alternative_parents: []
  is_instance_of: '[[ [03_AI_Data] [Concept] semiconductor-vacuum-deposition-and-ald-thickness-uniformity-log-v2026]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: is_categorized_as
  object: Data
  predicate: auto_mapped
  subject: semiconductor-vacuum-deposition-and-ald-thickness-uniformity-log-v2026
  weight: 1.0
temporal:
...
## 1. [왜 배우는가? (Why)]]
원자를 한 층씩 쌓아 올린 박막이 웨이퍼 전체($300\ \text{mm}$) 영역에 $0.1 \AA$의 오차도 없이 고르게 퍼져 있을까요? 이 로그는 증착된 박막의 두께와 물성을 원자 수준에서 정밀 측정하여 기록한 '나노 코팅의 정밀 검사서'입니다. 이를 기록하고 배우는 이유는 미세한 두께 차이가 반도체 소자의 문턱 전압($V_{th}$) 변동이나 누설 전류 증대로 이어지는 것을 방지하기 위함이며, 복잡한 3차원 트렌치(Trench) 구조에서도 완벽한 보호막을 형성하는 '원자층 제어 지능(ALD Control Intelligence)'의 무결성을 확보하기 위함입니다. 원자로 건축물을 짓는 정밀 데이터입니다.
