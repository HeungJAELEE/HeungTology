...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] atomic-force-microscopy-afm-surface-characterization-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for atomic-force-microscopy-afm-surface-characterization-log-v2026
  object_type: Data
  tier: 1
properties:
  force_sensitivity_fmin_measured: 40 nN
  force_sensitivity_fmin_target: 10 pN
  probe_tip_precision_threshold: 1 nm
  probe_tip_radius_measured: 8 nm
  probe_tip_radius_target: 2.0 nm
  resonant_frequency_f0_measured: 320 kHz
  resonant_frequency_f0_target: 325 kHz
  scanning_speed_measured: 1.5 um/s
  surface_roughness_sq_limit: < 0.20 nm
  surface_roughness_sq_measured: 0.12 nm
  surface_roughness_sq_target: 0.05 nm
  vertical_resolution_threshold: 0.01 nm
  z_piezo_range_measured: 5 um
semantic:
  alternative_parents: []
  is_instance_of: '[[ [03_AI_Data] [Concept] atomic-force-microscopy-afm-surface-characterization-log-v2026]]'
spo_graph:
