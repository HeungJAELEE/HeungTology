---
lineage:
  dataset_reference: machine-vision-and-deep-learning-defect-detection-physics
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] machine-vision-and-deep-learning-defect-detection-physics]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for machine-vision-and-deep-learning-defect-detection-physics
  object_type: Concept
  tier: 1
properties:
  critical_confidence_threshold: 0.7
  critical_iou_threshold: 0.5
  detection_precision_min_ratio: 0.98
  frame_rate_operational_range_fps: 30-120
  inference_time_max_ms: 15
  optical_sharpness_degradation_limit: 0.3
  optical_sharpness_rejection_threshold: 100
  recall_min_ratio: 0.99
  resolution_operational_range_mp: 12-50
semantic:
  alternative_parents: []
  is_instance_of: '[[ [03_AI_Data] [Concept] machine-vision-and-deep-learning-defect-detection-physics]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: domain_classification
  object: Data
  predicate: auto_mapped
  subject: machine-vision-and-deep-learning-defect-detection-physics
  weight: 0.5
temporal:
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Resolution | $Res$ | $\infty$ (Diffraction Limit) | 12 ~ 50 [데이터 부재] | ±2 | Megapixels |
| Frame Rate | $FPS$ | Sensor Max Frequency | 30 ~ 120 [데이터 부재] | ±5 | frames/sec |
| Detection Precision | $Pre$ | 1.0 | > 0.98 [데이터 부재] | ±0.01 | ratio |
| Recall (Sensitivity) | $Rec$ | 1.0 | > 0.99 [데이터 부재] | ±0.005 | ratio |
| Inference Time | $t_{inf}$ | Hardware Min Latency | < 15 [데이터 부재] | ±2 | ms |
