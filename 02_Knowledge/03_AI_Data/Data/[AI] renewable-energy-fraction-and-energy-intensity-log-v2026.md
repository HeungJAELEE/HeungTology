...
object:
  description: '[AI] renewable-energy-fraction-and-energy-intensity-log-v2026에 관한
    고밀도 지능 노드'
  object_type: Data
  tier: 1
properties:
  energy_consumption_formula: E = E_fixed + SEC * Q
  ess_pf: 0.99
  grid_pf: 0.95
  grid_share_range: 30-60
  pf_critical_threshold: 0.9
  solar_intensity_range: 0.5-1.0
  solar_pf: 0.99
  solar_share_range: 10-30
  wind_intensity_range: 0.8-1.2
  wind_pf: 0.98
  wind_share_range: 5-15
semantic:
  alternative_parents: []
