---
lineage:
  dataset_reference: oled-pixel-brightness-uniformity-and-mura-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] oled-pixel-brightness-uniformity-and-mura-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for oled-pixel-brightness-uniformity-and-mura-log-v2026
  object_type: Data
  tier: 1
properties:
  cloud_mura_demura_deviation_pct: < 0.5
  cloud_mura_raw_deviation_pct: 2.0-5.0
  color_deviation_delta_uv_prime_threshold: < 0.003
  demura_bits_precision: 10-14
  line_mura_demura_deviation_pct: < 1.0
  line_mura_raw_deviation_pct: 3.0-8.0
  low_gray_mura_demura_deviation_pct: < 2.0
  low_gray_mura_raw_deviation_pct: 10.0-20.0
  low_grayscale_threshold_nits: '10'
  mura_contrast_target_pct: < 1.0
  peak_brightness_nits_range: 1000-4000
  red_luminance_temp_drift_pct_per_10c: '2'
  rubbing_mura_demura_deviation_pct: < 0.8
  rubbing_mura_raw_deviation_pct: 1.5-3.0
  spot_mura_demura_deviation_pct: < 1.5
  spot_mura_raw_deviation_pct: 5.0-15.0
  target_luminance_uniformity_pct: '95'
semantic:
  alternative_parents: []
  is_instance_of: '[[ [03_AI_Data] [Concept] oled-pixel-brightness-uniformity-and-mura-log-v2026]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: semantic_type_classification
  object: Data
  predicate: auto_mapped
  subject: oled-pixel-brightness-uniformity-and-mura-log-v2026
  weight: 1.0
temporal:
