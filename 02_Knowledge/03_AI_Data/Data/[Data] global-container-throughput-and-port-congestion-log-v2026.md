---
lineage:
  dataset_reference: global-container-throughput-and-port-congestion-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] global-container-throughput-and-port-congestion-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for global-container-throughput-and-port-congestion-log-v2026
  object_type: Data
  tier: 1
properties:
  audit_fidelity_status: maximum
  congestion_index_measured: 1.24
  congestion_index_target_max: 1.5
  dwell_time_measured_days: 4.2
  dwell_time_target_max_days: 5.0
  littles_law_formula: L = lambda * W
  slow_steaming_lead_time_increase_percent: 10.0
  throughput_measured_teu: 2450000
  throughput_target_min_teu: 2200000
  turnaround_measured_days: 1.8
  turnaround_target_max_days: 2.0
  utilization_measured_percent: 92.5
  utilization_model_formula: rho = lambda / mu
  utilization_target_max_percent: 95.0
  utilization_target_min_percent: 85.0
  wait_time_measured_days: 2.4
  wait_time_target_max_days: 3.0
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: global-container-throughput-and-port-congestion-log-v2026
  weight: 0.95
temporal:
