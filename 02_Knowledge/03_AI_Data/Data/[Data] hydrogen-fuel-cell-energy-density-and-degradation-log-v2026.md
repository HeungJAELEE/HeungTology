---
lineage:
  dataset_reference: hydrogen-fuel-cell-energy-density-and-degradation-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] hydrogen-fuel-cell-energy-density-and-degradation-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for hydrogen-fuel-cell-energy-density-and-degradation-log-v2026
  object_type: Data
  tier: 1
properties:
  cell_voltage_2a_cm2_mean: 0.68 V
  cold_start_time_mean: 22 sec
  degradation_rate_mean: 2.5 uV/hr
  ecsa_mean: 65 m^2/g
  h2_crossover_mean: 1.2 mA/cm^2
  peak_power_density_mean: 3.2 W/cm^2
  peak_power_density_target: '> 4.0 W/cm^2'
  pt_catalyst_loading_mean: 0.08 g/kW
  pt_catalyst_loading_target: < 0.05 g/kW
  stack_efficiency_mean: 58%
semantic:
  alternative_parents: []
  is_instance_of: '[[ [03_AI_Data] [Concept] hydrogen-fuel-cell-energy-density-and-degradation-log-v2026]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: automated_classification
  object: Data
  predicate: auto_mapped
  subject: hydrogen-fuel-cell-energy-density-and-degradation-log-v2026
  weight: 0.9
temporal:
