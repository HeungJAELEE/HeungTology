---
Basic:
  id: "factory-plc-logic-execution-latency-and-jitter-log-v2026-data"
  domain: "70_Industrial_Automation_and_Robotics_Control"
...
Object:
  ...
  physical_model: "N/A"
Semantic:
  tags: '["#DataLog", "#Automation", "#PLC", "#Industrial_Network", "#Jitter", "#Latency", "#TSN", "#Real-time_Control", "#HDS_Gold_v6_1"]'
  is_part_of: '["MOC 70_industrial-automation-and-robotics-control-hub", "MOC 129_smart-factory-and-industrial-iot-iiot-governance-hub", "Data industry-tsn-network-jitter-and-gcl-accuracy-log-v2026"]'
  related_to: []
Dynamic:
...
| **Network Jitter** | $4.2 \text{ \mu s}$ | **DETERMINISTIC**| $< 5.0 \text{ \mu s}$ | 패킷 도착 시간의 변동폭 (정밀 동기화 핵심) |
