...
object:
  description: '[AI] information-computing-quantum-computing-and-qkd-log-v2026에 관한
    고밀도 지능 노드'
  object_type: Data
  tier: 1
properties:
  cryo_temperature_range: 7-20mK
  gate_fidelity_range: 99.0-99.99%
  qkd_critical_distance: 100km
  qkd_key_rate_range: 1-100kbps
  qkd_qber_range: 0.1-5.0%
  qkd_qber_threshold: 11%
  quantum_acceleration_factor: 1000x
  quantum_volume_range: 2^6-2^20
  qubit_count_range: 50-1000
  t1_coherence_range: 50-300us
  t2_phase_range: 10-200us
semantic:
  alternative_parents: []
