---
lineage:
  dataset_reference: urban-traffic-flow-and-congestion-index-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] urban-traffic-flow-and-congestion-index-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for urban-traffic-flow-and-congestion-index-log-v2026
  object_type: Data
  tier: 1
properties:
  audit_fidelity: MAXIMUM
  civilization_congestion_threshold_percent: 15.0
  civilization_speed_threshold_km_h: 45.0
  congestion_index_percent: 18.5
  congestion_index_target_max: 20.0
  continuity_equation_applied: true
  greenshields_model_applied: true
  public_ratio_percent: 62.4
  public_ratio_target_min: 60.0
  signal_wait_sec: 45.2
  signal_wait_target_max: 60.0
  traffic_density_target_max: 40.0
  traffic_density_veh_km: 32.5
  traffic_flow_target_min: 1600
  traffic_flow_veh_hr: 1850
  travel_speed_km_h: 42.4
  travel_speed_target_min: 40.0
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: urban-traffic-flow-and-congestion-index-log-v2026
  weight: 0.7
temporal:
