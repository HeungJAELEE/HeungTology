---
Basic:
  id: "wafer-flatness-and-surface-roughness-metrology-log-v2026-data"
...
Object:
  ...
  physical_model: "N/A"
Semantic:
  tags: '["#DataLog", "#Wafer", "#Flatness", "#Roughness", "#SFQR", "#TTV", "#AFM", "#Semiconductor", "#Metrology", "#HDS_Gold_v6_1"]'
  is_part_of: '["MOC 23_semiconductor-materials-and-advanced-packaging-intelligence-hub", "Entity silicon-wafer-crystal-growth-and-oxygen-precipitation"]'
  related_to: []
Dynamic:
...
| 가공 단계 (Process) | SFQR ($nm$) | TTV ($\mu m$) | 거칠기 ($R_a, \text{\AA}$) | 워프 (Warp, $\mu m$) | 공학적 의미 (Rationale V6.3.7) |
| :--- | :---: | :---: | :---: | :---: | :--- |
...
- **TTV (Total Thickness Variation):** 웨이퍼 전체 두께의 최대-최소 차이 ($\mu m$).
- **Warp / Bow:** 웨이퍼 중심부의 휨 또는 전체적인 비틀림 정도 ($\mu m$).
