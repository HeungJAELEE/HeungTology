...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] fiber-tensile-strength-and-elongation-at-break-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for fiber-tensile-strength-and-elongation-at-break-log-v2026
  object_type: Data
  tier: 1
properties:
  crystallinity_threshold: 0.65
  elongation_measured_percent: 18.4
  elongation_non_uniformity_rate: 0.1
  elongation_target_threshold_percent: 15.0
  external_db_endpoint: urban-water-distribution-leakage-and-pressure-monitoring-log-v2026
  fiber_diameter_measured_um: 12.5
  fiber_diameter_target_range_um:
  - 10
  - 15
  fiber_tenacity_measured_cn_tex: 48.5
  fiber_tenacity_target_threshold_cn_tex: 45.0
  fracture_work_measured_j_g: 2.4
  fracture_work_target_threshold_j_g: 2.0
  humidity_induced_strength_reduction_rate: 0.05
  moisture_regain_measured_percent: 8.5
  moisture_regain_target_range_percent:
  - 7
  - 10
  orientation_factor_threshold: 0.85
  temperature_deviation_threshold_c: 5.0
  youngs_modulus_measured_gpa: 12.5
  youngs_modulus_target_threshold_gpa: 10.0
semantic:
  alternative_parents: []
