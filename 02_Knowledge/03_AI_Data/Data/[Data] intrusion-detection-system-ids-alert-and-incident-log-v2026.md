---
lineage:
  dataset_reference: intrusion-detection-system-ids-alert-and-incident-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] intrusion-detection-system-ids-alert-and-incident-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for intrusion-detection-system-ids-alert-and-incident-log-v2026
  object_type: Data
  tier: 1
properties:
  alarm_fatigue_threshold_daily_alerts: 1000
  alert_severity_levels:
  - Critical
  - High
  - Medium
  - Low
  command_injection_fpr_percent: 0.2
  command_injection_latency_range_ms: 5-15
  data_exfiltration_fpr_percent: 4.0
  data_exfiltration_latency_range_ms: 200-1000
  ddos_fpr_percent: 1.2
  ddos_latency_range_ms: 10-50
  lateral_movement_fpr_percent: 3.5
  lateral_movement_latency_range_ms: 100-500
  port_scanning_fpr_percent: 0.5
  port_scanning_latency_range_ms: 1-10
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: intrusion-detection-system-ids-alert-and-incident-log-v2026
  weight: 0.5
temporal:
