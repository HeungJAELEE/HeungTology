---
lineage:
  dataset_reference: sensor-fusion-kalman-filter-state-estimation-error-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] sensor-fusion-kalman-filter-state-estimation-error-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for sensor-fusion-kalman-filter-state-estimation-error-log-v2026
  object_type: Data
  tier: 1
properties:
  camera_radar_factor_graph_pos_error_cm: 25.0
  ekf_linearization_error_threshold_cm: 5
  fusion_rate_hz_range: 100-1000
  gnss_ins_ukf_pos_error_cm: 15.8
  gnss_ins_ukf_yaw_error_deg: 0.45
  kalman_gain_range: 0.0-1.0
  lidar_camera_deep_fusion_pos_error_cm: 3.5
  lidar_camera_deep_fusion_yaw_error_deg: 0.1
  lidar_imu_ekf_latency_ms: 1.5
  lidar_imu_ekf_pos_error_cm: 5.2
  lidar_imu_ekf_yaw_error_deg: 0.15
  state_vector_dof: 9
  target_position_error_threshold_cm: 10
semantic:
  alternative_parents: []
  is_instance_of: '[[ [03_AI_Data] [Concept] sensor-fusion-kalman-filter-state-estimation-error-log-v2026]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: automated_type_classification
  object: Data
  predicate: auto_mapped
  subject: sensor-fusion-kalman-filter-state-estimation-error-log-v2026
  weight: 1.0
temporal:
