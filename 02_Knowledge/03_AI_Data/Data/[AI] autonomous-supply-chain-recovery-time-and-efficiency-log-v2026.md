...
lineage:
  ...
  original_hash: 88b9affa552e3de27ec5e6c71e0ac83988fc4560e17357370ac8f38651b9298e
metadata:
  date: '2026-05-16'
  domain: 03_AI_Data
...
object:
  description: '[AI] autonomous-supply-chain-recovery-time-and-efficiency-log-v2026에
    관한 고밀도 지능 노드'
  object_type: Data
  tier: 1
properties:
  avg_efficiency_gain_pct: '38.3'
  avg_inventory_fill_pct: '91.0'
  avg_recovery_time_hr: '18.5'
  master_response_protocol: Master-Flow-v2026
  network_redundancy_symbol: R
  recovery_velocity_symbol: Vr
  reference_db: HDS_Gold_v6.1
  swarm_coordination_symbol: Sc
  theoretical_efficiency_gain_limit_pct: '95.0'
  theoretical_inventory_fill_limit_pct: '99.5'
  theoretical_recovery_time_limit_hr: '1.0'
  thermodynamic_efficiency_symbol: eta
semantic:
  alternative_parents: []
