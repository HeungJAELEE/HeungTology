---
Basic:
  id: "DATA-MFG-LASER-MACHINING-LOG-2026-V6"
...
| **Ablation Depth**| Depth ($\mu m$) | $1.0 \sim 100.0$ | 레이저 펄스당 제거되는 물질의 깊이 (정밀 조각 지표) |
| **Surface Rough.**| $Sa$ ($\mu m$) | $< 0.05$ | 가공 후 표면의 산술 평균 거칠기 (광학적/기계적 품질) |
| **HAZ Width** | Heat Zone ($\mu m$)| $< 2.0$ | 열 영향부 너비 (주변 조직의 열 손상 방지 무결성) |
