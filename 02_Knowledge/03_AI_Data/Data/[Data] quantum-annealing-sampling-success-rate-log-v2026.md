---
lineage:
  dataset_reference: quantum-annealing-sampling-success-rate-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] quantum-annealing-sampling-success-rate-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for quantum-annealing-sampling-success-rate-log-v2026
  object_type: Data
  tier: 1
properties:
  adiabatic_theorem_p_success_formula: 1 - exp(-delta_min^2 / (dDelta/dt))
  advantage2_qubits_min: 7000
  annealing_time_ta: ta
  chain_break_fraction: ratio of broken logical variable connections
  d_wave_2000q_qubits: 2048
  d_wave_advantage_qubits: 5640
  embedding_efficiency: mapping efficiency to hardware graph
  hybrid_solver_success_threshold: 95.0
  ising_hamiltonian_components:
  - A(s)
  - B(s)
  - h_i
  - J_ij
  minimum_energy_gap_delta_min: delta_min
  success_probability_p: P
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: quantum-annealing-sampling-success-rate-log-v2026
  weight: 0.95
temporal:
