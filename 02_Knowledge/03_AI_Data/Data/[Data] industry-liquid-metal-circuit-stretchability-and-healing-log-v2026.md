---
lineage:
  dataset_reference: industry-liquid-metal-circuit-stretchability-and-healing-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] industry-liquid-metal-circuit-stretchability-and-healing-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for industry-liquid-metal-circuit-stretchability-and-healing-log-v2026
  object_type: Data
  tier: 1
properties:
  cycle_stability_retention_percentage: 90.0
  healing_efficiency_percentage: 95.0
  healing_limit: 0.9
  healing_time_seconds: 1.0
  max_elongation_percentage: 400.0
  oxide_skin_thickness_nm: 1.0-3.0
  resistance_change_delta_r_r0: 2.0
  rho_target: 0.15
  surface_tension_mn_m: 400-600
  viscosity_mpa_s: 1.5-2.5
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: industry-liquid-metal-circuit-stretchability-and-healing-log-v2026
  weight: 1.0
temporal:
...
2. **EGaIn** 산화막의 **Thickness** ($nm$)가 $5\ \text{nm}$ 이상으로 두꺼워졌을 때, 자가 치유 과정에서 발생하는 **Contact Resistance** (접촉 저항)의 수리적 상승분은?
