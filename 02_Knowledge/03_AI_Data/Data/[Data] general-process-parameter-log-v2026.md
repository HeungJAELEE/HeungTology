...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] general-process-parameter-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for general-process-parameter-log-v2026
  object_type: Concept
  tier: 1
properties:
  correlation_analysis_method: cross_correlation
  flow_rate_resolution: 0.05 L/min
  flow_rate_sampling_period: 0.5 sec
  normalization_method: min_max_normalization
  power_consumption_resolution: 0.1 kW
  power_consumption_sampling_period: 5 sec
  pressure_resolution: 0.01 bar
  pressure_sampling_period: 0.1 sec
  temperature_resolution: 0.1 C
  temperature_sampling_period: 1 sec
  time_synchronization_protocol: ntp
  vibration_resolution: 0.01 g
  vibration_sampling_period: 0.001 sec
semantic:
  alternative_parents: []
