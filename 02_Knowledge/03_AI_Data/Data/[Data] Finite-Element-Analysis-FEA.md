...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] Finite-Element-Analysis-FEA]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for Finite-Element-Analysis-FEA
  object_type: Concept
  tier: 1
properties:
  coupled_physics: Bi-directional Thermo-Mechanical
  critical_safety_threshold: 1.2
  degrees_of_freedom: 10^6 ~ 10^8
  element_type: High-order (Quadratic) Tetra/Hexa Mesh
  hds_gold_standard: V6.3.7
  max_latency_per_iteration: < 120 min
  residual_tolerance: < 10^-6
  safety_factor_range: 1.5 ~ 3.0
  solver_type: Sparse Matrix Solver
  warning_safety_threshold: 1.5
  yield_criterion: Von Mises Stress
semantic:
  alternative_parents: []
