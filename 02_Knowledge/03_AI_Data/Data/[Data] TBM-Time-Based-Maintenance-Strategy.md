...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] TBM-Time-Based-Maintenance-Strategy]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for TBM-Time-Based-Maintenance-Strategy
  object_type: Concept
  tier: 1
properties:
  beta_shape_parameter: '> 1'
  mes_bridge_endpoint: mes_bridge.request_pm_downtime
  pm_cm_cost_ratio: '0.3'
  pm_threshold_db_endpoint: pm_master_db
  system_availability_eta_range: 0.92-0.98
  telemetry_source_endpoint: tool_monitor
semantic:
  alternative_parents: []
  is_instance_of: '[[ [03_AI_Data] [Concept] TBM-Time-Based-Maintenance-Strategy]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: categorical_definition
  object: Data
