---
lineage:
  dataset_reference: wafer-warpage-and-stress-profile-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] wafer-warpage-and-stress-profile-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for wafer-warpage-and-stress-profile-log-v2026
  object_type: Data
  tier: 1
properties:
  annealing_stress_range_mpa:
  - 100
  - 500
  back_grinding_warpage_min_um: 150
  bare_wafer_ttv_max_um: 0.5
  cmp_warpage_recovery_pct: 40.0
  metal_dep_bow_range_um:
  - 50
  - 100
  mobility_variation_threshold_pct: 5.0
  nitride_dep_warpage_range_um:
  - 30
  - 60
  silicon_cte_per_k: 2.6e-06
  stoney_equation_variables:
  - Es
  - ts
  - delta_kappa
  - nu_s
  - tf
  wafer_diameter_inch: 12
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: wafer-warpage-and-stress-profile-log-v2026
  weight: 0.95
temporal:
...
본 로그는 기판의 두께($t_s$)가 얇아질수록 동일한 응력에도 휨이 제곱에 비례하여 급증함을 입증하고, 이를 통해 $2\ \text{nm}$ 이하 소자를 위한 '박막 웨이퍼' 핸들링의 물리적 한계를 제시합니다.
