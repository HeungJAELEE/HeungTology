---
lineage:
  dataset_reference: network-intrusion-detection-and-packet-entropy-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] network-intrusion-detection-and-packet-entropy-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for network-intrusion-detection-and-packet-entropy-log-v2026
  object_type: Data
  tier: 1
properties:
  ...
  false_positive_rate_measured_percent: 0.004
  false_positive_rate_threshold_percent: 0.01
  latency_measured_ms: 1.2
  latency_threshold_max_ms: 2.0
  packet_entropy_measured_bits: 3.84
  packet_entropy_target_range_bits: 3.0-4.5
  throughput_measured_gbps: 45.2
  throughput_target_min_gbps: 40.0
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: network-intrusion-detection-and-packet-entropy-log-v2026
  weight: 0.95
temporal:
