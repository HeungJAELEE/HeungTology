...
lineage:
  ...
  original_hash: 17253ee2166acb01a65abf5a0ba80296eadba33d2061360626779aef2567465d
metadata:
  date: '2026-05-16'
  domain: 03_AI_Data
...
object:
  description: '[AI] ammonia-cracking-for-hydrogen-carrier-performance-log-v2026에
    관한 고밀도 지능 노드'
  object_type: Data
  tier: 1
properties:
  co_catalyst_temp_range: 500-650 C
  enthalpy_of_decomposition: 46.2 kJ/mol
  iso_standard_ref: ISO-22734
  nh3_residual_threshold_pemfc: 0.1 ppm
  ni_catalyst_temp_range: 600-750 C
  ni_conversion_efficiency: 95-99%
  ni_h2_recovery_rate: 85-92%
  ru_activation_energy_relative_reduction: 30%
  ru_catalyst_temp_range: 400-550 C
  ru_conversion_efficiency: '> 99.9%'
  ru_h2_recovery_rate: 90-95%
  ru_reaction_rate_multiplier: 5x
  solar_thermal_temp_threshold: '> 800 C'
  standard_h2_recovery_range: 85.0-95.0%
  thermodynamic_db_endpoint: NIST-JANAF
semantic:
  alternative_parents: []
