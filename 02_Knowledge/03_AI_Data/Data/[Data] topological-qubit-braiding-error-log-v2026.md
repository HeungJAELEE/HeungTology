...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] topological-qubit-braiding-error-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for topological-qubit-braiding-error-log-v2026
  object_type: Data
  tier: 1
properties:
  braiding_operator_phase_rotation_rad: pi/2
  hybrid_nanowire_braiding_error_rate_threshold: < 10^-4
  hybrid_nanowire_energy_gap_uev: 100 ~ 300
  hybrid_nanowire_operating_temp_mK: ~ 20
  non_adiabatic_transition_model: Landau-Zener
  quantum_hall_5_2_braiding_error_rate_threshold: < 10^-3
  quantum_hall_5_2_energy_gap_uev: 10 ~ 50
  topological_insulator_braiding_error_rate_threshold: < 10^-5
  topological_insulator_energy_gap_uev: 200 ~ 500
  topological_insulator_operating_temp_mK: ~ 100
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 03_AI_Data]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: automated_metadata_assignment
  object: Data
