...
lineage:
  ...
  original_hash: 345690f092ce06821246246e84f5e3adfd5a31c9600299d16aa895436b152a63
metadata:
  date: '2026-05-16'
  domain: 03_AI_Data
...
object:
  description: '[AI] autonomous-fail-safe-activation-and-latency-audit-log-v2026에
    관한 고밀도 지능 노드'
  object_type: Data
  tier: 1
properties:
  activation_latency_actual: 4.2 ms
  activation_latency_target: 5.0 ms
  brake_fidelity_actual: '0.998'
  brake_fidelity_target: '1.0'
  emergency_response_actual: 15 ms
  emergency_response_target: 20 ms
  fail_safe_integrity_status: MAXIMUM
  hardware_health_status: OPTIMAL
  override_success_rate: 100%
  recovery_fidelity_actual: 99.95%
  recovery_fidelity_target: 100.0%
  signal_redundancy_level: 3/3
semantic:
  alternative_parents: []
