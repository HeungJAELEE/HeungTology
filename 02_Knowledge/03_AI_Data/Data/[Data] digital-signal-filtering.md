...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] digital-signal-filtering]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for digital-signal-filtering
  object_type: Algorithm
  tier: 1
properties:
  group_delay_ms_max: 2
  max_buffer_size_kb: 10
  max_compute_cost_kops_per_sample: 100
  max_thd_percent: 0.1
  passband_ripple_db_max: 0.1
  snr_improvement_db_range:
  - 12
  - 25
  stopband_attenuation_db_min: 60
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 03_AI_Data]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: signal_conditioning
  object: Data
