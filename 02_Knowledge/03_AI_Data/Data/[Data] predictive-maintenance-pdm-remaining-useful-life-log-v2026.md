---
Basic:
  id: "predictive-maintenance-pdm-remaining-useful-life-log-v2026-data"
...
Object:
  ...
  physical_model: "N/A"
Semantic:
  tags: '["#DataLog", "#PdM", "#RUL", "#Predictive_Maintenance", "#Condition_Monitoring", "#Vibration_Analysis", "#Machine_Learning", "#Reliability", "#HDS_Gold_v6_1"]'
  is_part_of: '["MOC 16_smart-factory-and-industrial-ai-intelligence-hub", "Entity cyber-physical-system-cps-industrial-digital-twin"]'
  related_to: []
Dynamic:
...
2. **(수리)** 베어링의 균열 성장 속도가 $1 \mu m / 1,000 \text{ cycles}$이고 임계 균열 길이가 $2 \text{ mm}$ (현재 $1.2 \text{ mm}$)일 때, 초당 $50$번 회전하는 기계의 RUL(시간)은 얼마인가?
