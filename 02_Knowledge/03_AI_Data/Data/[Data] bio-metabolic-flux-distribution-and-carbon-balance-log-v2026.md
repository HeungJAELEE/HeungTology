...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] bio-metabolic-flux-distribution-and-carbon-balance-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for bio-metabolic-flux-distribution-and-carbon-balance-log-v2026
  object_type: Data
  tier: 1
properties:
  carbon_mass_balance_formula: sum(m_c_in) = sum(m_c_prod) + sum(m_c_by) + m_c_co2
    + dC_biomass/dt
  carbon_recovery_target_pct:
  - 98.0
  - 102.0
  fba_steady_state_condition: S * v = 0
  glucose_consumption_qs_g_g_h_range:
  - 0.5
  - 1.5
  growth_rate_mu_h_inv_range:
  - 0.1
  - 0.35
  max_byproduct_yield_g_g: 0.05
  pathway_ratio_min_pct: 45.0
  respiratory_quotient_range:
  - 1.0
  - 1.1
  tca_flux_energy_shunt_pct:
  - 20.0
  - 30.0
semantic:
  alternative_parents: []
