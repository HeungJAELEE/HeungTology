---
lineage:
  dataset_reference: carbon-nanotube-transistor-mobility-and-yield-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] carbon-nanotube-transistor-mobility-and-yield-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for carbon-nanotube-transistor-mobility-and-yield-log-v2026
  object_type: Data
  tier: 1
properties:
  ballistic_efficiency_mean_percent: 82
  ballistic_efficiency_target_percent: 90
  carrier_mobility_mean_cm2_vs: 550
  carrier_mobility_target_cm2_vs: 1000
  contact_resistance_mean_ohm_um: 150
  contact_resistance_target_ohm_um: 100
  device_density_mean_cnts_um: 120
  device_density_target_cnts_um: 200
  gate_leakage_mean_pa_um: 1.2
  gate_leakage_target_pa_um: 1.0
  on_off_ratio_mean: 10000000
  on_off_ratio_target: 100000000
  pd_contact_resistance_reduction_percent: 30
  s_cnt_purity_mean_percent: 99.995
  s_cnt_purity_target_percent: 99.999
  subthreshold_swing_mean_mv_dec: 65
  subthreshold_swing_target_mv_dec: 60
  vth_variation_limit_percent: 10
semantic:
  alternative_parents: []
  is_instance_of: '[[ [03_AI_Data] [Concept] carbon-nanotube-transistor-mobility-and-yield-log-v2026]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: semantic_classification
  object: Data
  predicate: auto_mapped
  subject: carbon-nanotube-transistor-mobility-and-yield-log-v2026
  weight: 1.0
temporal:
...
| **Contact Resistance**| $150 \Omega \cdot \mu\text{m}$ | $15 \Omega \cdot \mu\text{m}$ | $< 100$ | 금속 전극과 CNT 계면의 수리적 정합성 |
| **Ballistic Efficiency**| $82 \%$ | $3 \%$ | $> 90 \%$ | 산란 없는 탄동 수송의 양자역학적 무결성 |
| **Device Density** | $120 \text{ CNTs}/\mu\text{m}$ | $10 \text{ CNTs}/\mu\text{m}$ | $> 200$ | 단위 면적당 전류 구동력 확보 데이터 |
| **Gate Leakage** | $1.2 \text{ pA}/\mu\text{m}$ | $0.1 \text{ pA}/\mu\text{m}$ | $< 1.0$ | 미세 공정에서의 절연막 무결성 및 누설 |
