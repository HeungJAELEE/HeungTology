---
lineage:
  dataset_reference: server-and-network-performance-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] server-and-network-performance-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for server-and-network-performance-log-v2026
  object_type: Data
  tier: 1
properties:
  cpu_load_avg_pct: 52.5
  cpu_load_normal_range_pct: 40-70
  iops_avg_count: 125000
  iops_min_count: 100000
  jitter_threshold_ms: 5
  load_warning_threshold_pct: 80
  memory_util_avg_pct: 68.0
  memory_util_normal_range_pct: 50-80
  packet_loss_avg_pct: 0.0002
  packet_loss_max_pct: 0.001
  packet_loss_target_pct: 0
  robot_control_integrity_impact_pct: 20
  server_health_score_range: 0-1
  telemetry_sources:
  - Prometheus
  - Grafana
  - NetFlow
  throughput_avg_gbps: 15.2
  throughput_min_gbps: 10.0
  wait_time_formula: 1 / (mu - lambda)
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: server-and-network-performance-log-v2026
  weight: 1.0
temporal:
