---
lineage:
  dataset_reference: battery-lithium-plating-stripping-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] battery-lithium-plating-stripping-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for battery-lithium-plating-stripping-v2026
  object_type: Data
  tier: 1
properties:
  critical_current_density_unit: mA/cm^2
  dendrite_shape_factor_beta: geometric_shape_coefficient
  dq_dv_accuracy: 0.92
  plating_onset_potential_threshold: < 0 V
  stripping_overpotential_unit: mV
  tau_plateau_parameter: voltage_plateau_relaxation_time
semantic:
  alternative_parents: []
  is_instance_of: '[[ [03_AI_Data] [Concept] battery-lithium-plating-stripping-v2026]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: automated_entity_classification
  object: Data
  predicate: auto_mapped
  subject: battery-lithium-plating-stripping-v2026
  weight: 0.85
temporal:
