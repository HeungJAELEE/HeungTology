---
lineage:
  dataset_reference: peopleworks-patent-portfolio
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] peopleworks-patent-portfolio]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for peopleworks-patent-portfolio
  object_type: Concept
  tier: 1
properties:
  citation_index_tolerance: 2
  infringement_probability_threshold: 0.95
  min_forward_citations_5yr: 10
  min_global_jurisdictions: 3
  min_independent_claims: 5
  min_tech_longevity_years: 15
  pqi_high_end_threshold: 4.5
  pqi_low_end_threshold: 3.5
  pqi_standard_max: 4.5
  pqi_standard_min: 3.5
  tech_gap_formula: sum(novelty_score) / time_to_market
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 03_AI_Data]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: automated_structural_mapping
  object: Data
  predicate: auto_mapped
  subject: peopleworks-patent-portfolio
  weight: 0.3
temporal:
