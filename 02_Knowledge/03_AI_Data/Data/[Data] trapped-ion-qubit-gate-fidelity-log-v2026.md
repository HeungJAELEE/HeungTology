---
lineage:
  dataset_reference: trapped-ion-qubit-gate-fidelity-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] trapped-ion-qubit-gate-fidelity-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for trapped-ion-qubit-gate-fidelity-log-v2026
  object_type: Data
  tier: 1
properties:
  ba_gate_fidelity_min_percent: 99.95
  ca_gate_fidelity_percent: 99.8
  electrode_noise_fidelity_drop_percent: 2.0
  gate_error_threshold_percent: 0.01
  ground_state_probability_threshold: 0.95
  qccd_gate_fidelity_min_percent: 99.0
  single_qubit_fidelity_target_percent: 99.99
  sr_gate_fidelity_min_percent: 99.9
  vacuum_pressure_threshold_torr: 1.0e-11
  yb_gate_fidelity_min_percent: 99.9
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: trapped-ion-qubit-gate-fidelity-log-v2026
  weight: 1.0
temporal:
