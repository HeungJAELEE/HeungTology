---
lineage:
  dataset_reference: freight-cost-and-logistics-efficiency-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] freight-cost-and-logistics-efficiency-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for freight-cost-and-logistics-efficiency-log-v2026
  object_type: Data
  tier: 1
properties:
  air_cargo_kg_cost_max_usd: 8.0
  air_cargo_kg_cost_min_usd: 3.0
  air_cargo_kg_utilization_pct: 85.0
  carbon_efficiency_improvement_threshold: 0.15
  carbon_efficiency_utilization_target_range: 80-95%
  demurrage_target_cost_usd: 0
  ocean_fcl_40ft_cost_max_usd: 5000
  ocean_fcl_40ft_cost_min_usd: 2500
  ocean_fcl_40ft_utilization_pct: 95.0
  road_full_truck_cost_max_usd: 3.0
  road_full_truck_cost_min_usd: 1.5
  road_full_truck_utilization_pct: 92.0
  total_logistics_cost_model: TLC(Q) = (D/Q)F + (Q/2)H*v
  warehouse_storage_cost_max_usd: 25
  warehouse_storage_cost_min_usd: 10
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: freight-cost-and-logistics-efficiency-log-v2026
  weight: 1.0
temporal:
