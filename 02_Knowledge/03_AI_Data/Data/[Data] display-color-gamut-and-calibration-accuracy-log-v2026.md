---
lineage:
  dataset_reference: display-color-gamut-and-calibration-accuracy-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] display-color-gamut-and-calibration-accuracy-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for display-color-gamut-and-calibration-accuracy-log-v2026
  object_type: Data
  tier: 1
properties:
  bit_depth_options:
  ...
  - 10
  - 12
  blue_organic_degradation_rate_relative_rg: 0.2
  delta_e_expert_threshold: 1.0
  gamma_accuracy_deviation_threshold: 0.05
  hdr_luminance_threshold_nits: 1000
  target_delta_e_reduction: 3.5 to 0.8
  three_d_lut_size_range: 17^3-65^3
  white_point_error_uv_threshold: 0.002
semantic:
  alternative_parents: []
  is_instance_of: '[[ [03_AI_Data] [Concept] display-color-gamut-and-calibration-accuracy-log-v2026]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: automated_classification
  object: Data
  predicate: auto_mapped
  subject: display-color-gamut-and-calibration-accuracy-log-v2026
  weight: 0.7
temporal:
