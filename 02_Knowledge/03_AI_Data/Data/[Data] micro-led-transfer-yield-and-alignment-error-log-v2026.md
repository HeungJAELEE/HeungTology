---
lineage:
  dataset_reference: micro-led-transfer-yield-and-alignment-error-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] micro-led-transfer-yield-and-alignment-error-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for micro-led-transfer-yield-and-alignment-error-log-v2026
  object_type: Data
  tier: 1
properties:
  alignment_tolerance_limit_um: 2.0
  fluidic_assembly_optimal_flow_velocity_m_s: 0.5
  fluidic_assembly_yield_percent: 99.99
  laser_lift_crack_multiplication_factor: 5.0
  laser_lift_energy_excess_threshold_percent: 10.0
  laser_lift_yield_percent: 99.999
  pick_and_place_yield_percent: 99.9
  redundancy_app_yield_percent: 99.9999
  roll_transfer_yield_percent: 99.0
  standard_4k_pixel_count: 25000000
  target_six_sigma_yield: 0.999999
  wavelength_binning_mura_threshold_nm: 2.0
semantic:
  alternative_parents: []
  is_instance_of: '[[ [03_AI_Data] [Concept] micro-led-transfer-yield-and-alignment-error-log-v2026]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: semantic_type_assignment
  object: Data
  predicate: auto_mapped
  subject: micro-led-transfer-yield-and-alignment-error-log-v2026
  weight: 0.5
temporal:
...
RAG는 "LED 웨이퍼의 파장 맵(Binning Map) 로그와 전사 후 패널 휘도 데이터를 대조하여, 파장이 $2\ \text{nm}$ 이상 차이 나는 칩들이 인접하게 전사될 때 인간의 눈에 '색상 무라'로 인지됨을 확인하고, 칩 배치를 랜덤화(Randomization)하여 시각적 인지 품질을 높이는 전략을 오딧합니다."

### 4.2 [유체 전사(Fluidic Assembly)의 확률적 수율 최적화 분석]
왜 유체 전사는 특정 환경에서만 잘 되나요? RAG는 "유체 점도, 표면 장력, 그리고 기판 트랩(Trap) 형상 로그를 참조하여, 유속이 $0.5\ \text{m/s}$일 때 안착 성공률이 정점을 찍음을 확인하고, 미전사된 빈 공간(Missing Site)을 보충하기 위한 재순환(Recirculation) 횟수를 수리적으로 도출될 것으로 예상됩니다."
