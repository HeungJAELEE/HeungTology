---
Basic:
  id: "micro-led-transfer-yield-and-alignment-error-log-v2026-data"
...
Object:
  ...
  physical_model: "N/A"
Semantic:
  tags: '["#DataLog", "#Micro_LED", "#Mass_Transfer", "#Yield_Rate", "#Alignment_Error", "#LIFT", "#Fluidic_Assembly", "#Six_Sigma", "#HDS_Gold_v6_1"]'
...
| 전사 기법 (Method) | LED 크기 ($\mu m$) | 전사 수율 (%) | 정렬 오차 ($\mu m$) | 속도 (UPH, 백만) | 공학적 의미 (Rationale V6.3.7) |
| :--- | :---: | :---: | :---: | :---: | :--- |
...
- **Alignment Tolerance**: 설계 위치 대비 칩의 변위 허용치 ($< 2 \mu m$). (색 간섭 및 개구율 결정 지표)
