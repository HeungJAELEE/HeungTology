---
Basic:
  id: "DATA-MAT-PHONONIC-CRYSTAL-LOG-2026-V6"
  domain: "29_Advanced_Materials"
...
| **Lattice Const.**| $a$ ($\mu m$) | $500 \sim 5000$ | 포노닉 결정 단위 셀의 반복 간격 (차단 주파수 결정 요인) |
...
| **Unit Precision**| Tolerance ($\mu m$)| $< 10$ | 격자 구조의 가공 정밀도 (밴드갭 붕괴 방지 무결성) |
