---
lineage:
  dataset_reference: second-life-ev-battery-ess-performance-degradation-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] second-life-ev-battery-ess-performance-degradation-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for second-life-ev-battery-ess-performance-degradation-log-v2026
  object_type: Data
  tier: 1
properties:
  cell_imbalance_capacity_limitation_threshold: 15.0
  fast_charge_cycle_threshold: 500
  fast_charge_resistance_increase_multiplier: 3.0
  grade_a_cycles_range: 2000-3000
  grade_a_soh_range: 80-85%
  grade_b_soh_range: 75-80%
  grade_c_soh_range: 70-75%
  grade_d_soh_max: 70
  knee_point_math_condition: d2C/dn2 > epsilon
  thermal_runaway_heat_increase_multiplier: 2.0
  thermal_runaway_onset_temp_reduction_c: 20.0
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 03_AI_Data]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: entity_type_mapping
  object: Data
  predicate: auto_mapped
  subject: second-life-ev-battery-ess-performance-degradation-log-v2026
  weight: 0.7
temporal:
