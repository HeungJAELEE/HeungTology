...
object:
  description: '[AI] metaverse-spatial-computing-and-user-immersion-log-v2026에 관한
    고밀도 지능 노드'
  object_type: Data
  tier: 1
properties:
  ...
  frame_stability_measured_percent: 99.8
  frame_stability_target_percent: 99.5
  immersion_score_measured: 94.2
  immersion_score_target: 90.0
  mtp_latency_measured_ms: 11.5
  mtp_latency_target_ms: 12.0
  refresh_rate_measured_hz: 144
  refresh_rate_target_hz: 120
  spatial_audio_latency_measured_ms: 25.0
  spatial_audio_latency_target_ms: 30.0
  tracking_precision_measured_mm: 0.85
