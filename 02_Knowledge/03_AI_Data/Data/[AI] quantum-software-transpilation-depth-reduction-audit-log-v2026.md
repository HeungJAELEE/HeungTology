...
object:
  description: '[AI] quantum-software-transpilation-depth-reduction-audit-log-v2026에
    관한 고밀도 지능 노드'
  object_type: Data
  tier: 1
properties:
  audit_version: v2026
  external_reference_vault: Antigravity Vault
  qubit_coherence_time_parameter: T2
  target_depth_reduction_pct: 40.0
  target_gate_reduction_pct: 50.0
  target_swap_overhead_pct: 10.0
