...
object:
  description: '[AI] global-nb-iot-network-coverage-and-packet-success-log-v2026에
    관한 고밀도 지능 노드'
  object_type: Data
  tier: 1
properties:
  battery_drain_multiplier: 5
  log_version: v2026
  path_loss_db_per_distance_doubling: 12
  repetition_count_threshold: 32
  rssi_repetition_threshold_dbm: -120
semantic:
  alternative_parents: []
