---
Basic:
  id: "cryogenic-base-temperature-and-thermal-stability-log-v2026"
...
Object:
  ...
  physical_model: "N/A"
Semantic:
  tags: '["#Data", "#Quantum_Computing", "#Cryogenics", "#Thermal_Stability", "#Base_Temperature", "#Quantum_Hardware", "#Performance_Log", "#HDS_Gold_v6_1"]'
  is_part_of: '["MOC 21_quantum-computing-and-information-theory-hub", "[[SOP] quantum-hardware-cryogenic-cooling-and-stabilization-protocol]"]'
  related_to: []
Dynamic:
...
# [[[Data] cryogenic-base-temperature-and-thermal-stability-log-v2026
...
| **Thermal Drift** | Rate of temperature change over time | $< 2 \text{ \mu K/hr}$ | 며칠간의 연산 중에도 환경이 변하지 않음을 보여주는 안정성 |
| **Cooling Power** | Ability to remove heat from active gates | $250 \text{ \mu W}$ | 연산 중 발생하는 미세 열을 즉각 식혀주는 동역학 지능 |
