---
Basic:
  id: "transmon-qubit-coherence-and-gate-error-audit-log-v2026"
...
Object:
  ...
  physical_model: "N/A"
Semantic:
  tags: '["#Data", "#Quantum_Computing", "#Transmon", "#Coherence_Time", "#Gate_Error", "#Audit", "#Performance_Log", "#HDS_Gold_v6_1"]'
  is_part_of: '["MOC 30_quantum-intelligence-and-advanced-computing-hub", "Entity superconducting-transmon-circuits-and-microwave-control"]'
  related_to: []
Dynamic:
...
# [[[Data] transmon-qubit-coherence-and-gate-error-audit-log-v2026
...
| :--- | :--- | :--- | :--- |
| **T1 Relaxation** | Energy decay time from 1 to 0 state | $> 450 \text{ \mu s}$ | 정보를 잊지 않고 오랫동안 붙잡고 있음을 입증하는 물리 |
| **T2 Dephasing** | Quantum phase preservation time | $> 300 \text{ \mu s}$ | 연산 중 박자가 틀어지지 않음을 보여주는 지능 무결성 |
