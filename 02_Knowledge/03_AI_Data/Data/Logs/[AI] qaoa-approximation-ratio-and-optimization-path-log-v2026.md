...
lineage:
  ...
  original_hash: 7c44722348c0ed020619805089cbdfcdf72324f48f38dad674891525b7412b7b
metadata:
  date: '2026-05-16'
  domain: 03_AI_Data
...
object:
  description: '[AI] qaoa-approximation-ratio-and-optimization-path-log-v2026에 관한
    고밀도 지능 노드'
  object_type: Data
  tier: 1
properties:
  circuit_layer_parameter: P
  finance_500_approx_ratio: 0.85
  finance_500_opt_steps: 420
  finance_500_success_prob: 62.1
  grid_1000_approx_ratio: 0.78
  grid_1000_opt_steps: 1250
  grid_1000_success_prob: 45.0
  initial_angle_parameters:
  - beta
  - gamma
  logistics_100_approx_ratio: 0.92
  logistics_100_opt_steps: 85
  logistics_100_success_prob: 75.5
  master_qaoa_v2026_avg_approx_ratio: 0.884
  master_qaoa_v2026_avg_opt_steps: 442.5
  master_qaoa_v2026_avg_success_prob: 68.6
  max_cut_20_approx_ratio: 0.985
  max_cut_20_opt_steps: 15
  max_cut_20_success_prob: 92.0
  target_v6_3_7_max_opt_steps: 100
  target_v6_3_7_min_approx_ratio: 0.95
  target_v6_3_7_min_success_prob: 80.0
semantic:
  alternative_parents: []
