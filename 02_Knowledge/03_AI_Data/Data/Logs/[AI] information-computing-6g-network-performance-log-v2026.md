...
object:
  description: '[AI] information-computing-6g-network-performance-log-v2026에 관한 고밀도
    지능 노드'
  object_type: Data
  tier: 1
properties:
  ai_slicing_latency_threshold_ms: 0.1
  ai_slicing_reliability_target: 0.99999
  connection_density_per_km2: 10^6-10^7
  energy_efficiency_bits_j: 10^12-10^15
  irs_distance_extension_factor: 2.0
  irs_shadowing_improvement_db: 15.0
  latency_range_ms: 0.1-1.0
  mobility_max_km_h: 1000
  peak_rate_range_tbps: 0.1-1.0
  spectral_efficiency_bps_hz: 10-100
  thz_path_loss_db_m: 100-160
  user_rate_range_gbps: 1-10
semantic:
  alternative_parents: []
