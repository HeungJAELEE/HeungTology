...
object:
  description: '[AI] nano-metamaterial-refractive-index-and-optical-loss-log-v2026에
    관한 고밀도 지능 노드'
  object_type: Data
  tier: 1
properties:
  max_extinction_coefficient: 0.05
  min_transmittance_threshold: 90.0
  misalignment_error_threshold_nm: 10
  resonance_frequency_shift_ghz: 50
  standard_version: V6.3.7
  target_refractive_index: -1.2
  target_refractive_index_tolerance: 0.1
semantic:
  alternative_parents: []
