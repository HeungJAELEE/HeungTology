---
lineage:
  dataset_reference: waste-recycling-rate-and-material-recovery-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] waste-recycling-rate-and-material-recovery-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for waste-recycling-rate-and-material-recovery-log-v2026
  object_type: Data
  tier: 1
properties:
  chemicals_contamination_range_pct: 5-10
  chemicals_recovery_yield: 0.75
  chemicals_recycling_rate_range_pct: 50-80
  contamination_tensile_strength_degradation_threshold_pct: 5
  e_waste_contamination_range_pct: 2-5
  e_waste_recovery_yield: 0.9
  e_waste_recycling_rate_range_pct: 80-95
  hazardous_recovery_yield: 0.5
  hazardous_recycling_rate_range_pct: 30-60
  metals_contamination_max_pct: 0.5
  metals_recovery_yield: 0.98
  metals_recycling_rate_range_pct: 95-99
  plastics_contamination_range_pct: 1-3
  plastics_recovery_yield: 0.85
  plastics_recycling_rate_range_pct: 60-85
  resource_recovery_economic_value_model: V_rec = sum(M_in * Y_rec_i * P_market_i)
    - C_processing
  tensile_strength_reduction_impact_pct: 20
  zero_waste_to_landfill_target_pct: 99
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: waste-recycling-rate-and-material-recovery-log-v2026
  weight: 0.4
temporal:
