---
lineage:
  dataset_reference: rag-complete-master-guide
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] rag-complete-master-guide]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for rag-complete-master-guide
  object_type: Concept
  tier: 1
properties:
  chunk_size_actual_tokens: 768
  chunk_size_ideal_tokens: 512
  chunk_size_tolerance_tokens: 128
  external_metrics_endpoint: rag-retrieval-precision-and-hallucination-metrics-v2026
  faithfulness_score_actual: 0.97
  faithfulness_score_ideal: 1.0
  faithfulness_score_tolerance: 0.02
  lost_in_the_middle_k_threshold: 10
  retrieval_latency_actual_ms: 185
  retrieval_latency_ideal_ms: 150
  retrieval_latency_tolerance_ms: 20
  retrieval_relevance_threshold: 0.7
  target_knowledge_precision_ratio: 0.98
  top_k_actual: 7
  top_k_ideal: 5
  vector_dimension_dims: 1536
semantic:
  alternative_parents: []
  is_instance_of: '[[ [03_AI_Data] [Concept] rag-complete-master-guide]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: automated_knowledge_categorization
  object: Data
  predicate: auto_mapped
  subject: rag-complete-master-guide
  weight: 0.4
temporal:
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Chunk Size | $L_{chunk}$ | 512 [데이터 부재] | 768 [데이터 부재] | ±128 | tokens |
| Top-K Retrieval | $K$ | 5 [데이터 부재] | 7 [데이터 부재] | N/A | count |
| Vector Dimension | $d$ | 1536 [데이터 부재] | 1536 [데이터 부재] | N/A | dims |
| Retrieval Latency | $t_{ret}$ | < 150 [데이터 부재] | 185 [데이터 부재] | ±20 | ms |
| Faithfulness Score| $S_{faith}$ | 1.00 [데이터 부재] | 0.97 [데이터 부재] | ±0.02 | ratio |
...
본 규격은 `Data rag-retrieval-precision-and-hallucination-metrics-v2026` [데이터 부재]와 동기화되어, 지식 검색 정밀도를 98% 이상으로 유지하며, 모든 생성 답변에 대한 출처(Reference) 추적성을 보장한다.