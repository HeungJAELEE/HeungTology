---
Basic:
  id: "spectral-analysis-material-composition-log-v2026-data"
...
Object:
  ...
  physical_model: "N/A"
Semantic:
  tags: '["#DataLog", "#Spectroscopy", "#FTIR", "#Raman", "#XRF", "#XPS", "#Material_Science", "#Metrology", "#Chemical_Analysis", "#HDS_Gold_v6_1"]'
  is_part_of: '["Entity battery-next-gen-materials-and-chemical-synthesis", "MOC 14_precision-hardware-and-metrology-intelligence-hub]]"]'
  related_to: []
Dynamic:
...
| **Raman (Laser)** | 그래핀/CNT | $100 \text{ ppm}$ | $< 1 \mu m$ | G/D Peak Ratio | 결정성 및 스트레인(Strain) 분석 무결성 |
| **XRF (X-ray)** | 금속/슬러리 | $1 \text{ ppm}$ | $10 \sim 100 \mu m$ | Elemental % | 중금속 및 주요 원소 함량 정량 분석 데이터 |
