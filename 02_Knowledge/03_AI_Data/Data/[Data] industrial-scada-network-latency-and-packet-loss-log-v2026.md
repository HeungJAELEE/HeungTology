---
lineage:
  dataset_reference: industrial-scada-network-latency-and-packet-loss-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] industrial-scada-network-latency-and-packet-loss-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for industrial-scada-network-latency-and-packet-loss-log-v2026
  object_type: Data
  tier: 1
properties:
  availability_measured_percent: 99.999
  availability_target_percent: 99.99
  error_rate_measured_ber: 1.2e-09
  error_rate_target_ber: 1.0e-08
  littles_law_delay_model: L = lambda * W
  network_jitter_measured_ms: 0.8
  network_jitter_target_ms: 1.0
  packet_loss_measured_percent: 0.0008
  packet_loss_target_percent: 0.001
  rtt_latency_measured_ms: 4.2
  rtt_latency_target_ms: 5.0
  shannon_hartley_capacity_model: C = B * log2(1 + S/N)
  throughput_measured_mbps: 845.2
  throughput_target_mbps: 800.0
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: industrial-scada-network-latency-and-packet-loss-log-v2026
  weight: 1.0
temporal:
