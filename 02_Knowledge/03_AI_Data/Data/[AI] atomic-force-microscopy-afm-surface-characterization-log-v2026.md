...
lineage:
  ...
  original_hash: 024153ca8c39a01603d5cb66376380e61a99040ddd3b290610a5260bc3a8c4bc
metadata:
  date: '2026-05-16'
  domain: 03_AI_Data
...
object:
  description: '[AI] atomic-force-microscopy-afm-surface-characterization-log-v2026에
    관한 고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  cantilever_spring_constant_k: 40 N/m
  external_db_iso: ISO-25178
  external_db_nist: NIST-NMT
  force_sensitivity_measured: 40 nN
  force_sensitivity_theoretical: 10 pN
  force_slope: 150 N/m
  probe_precision: 1 nm
  probe_tip_radius_measured: 8 nm
  probe_tip_radius_target: < 10 nm
  probe_tip_radius_theoretical: 2.0 nm
  resonant_frequency_measured: 320 kHz
  resonant_frequency_target: 300-350 kHz
  resonant_frequency_theoretical: 325 kHz
  scanning_speed_measured: 1.5 um/s
  scanning_speed_target: < 2.0 um/s
  surface_roughness_sq_ideal: 0.05 nm
  surface_roughness_sq_measured: 0.12 nm
  surface_roughness_sq_target: < 0.20 nm
