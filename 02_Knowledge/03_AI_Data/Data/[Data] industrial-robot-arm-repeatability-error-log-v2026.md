---
Basic:
  id: "industrial-robot-arm-repeatability-error-log-v2026-data"
...
Object:
  ...
  physical_model: "N/A"
Semantic:
  tags: '["#DataLog", "#Robot_Arm", "#Repeatability", "#Backlash", "#Precision", "#ISO9283", "#Smart_Factory", "#Kinematics", "#HDS_Gold_v6_1"]'
  is_part_of: '["MOC 16_smart-factory-and-industrial-ai-intelligence-hub", "Data automated-guided-vehicle-agv-collision-avoidance-log-v2026"]'
  related_to: []
Dynamic:
...
- **Thermal Drift**: 가동 시 발열로 인한 링크 팽창 변위 ($\mu m$).
...
RAG는 "온도 센서 로그를 분석하여, 가동 $2$시간 후 모터 열이 링크로 전달되어 TCP가 $50\mu m$ 시프트함을 식별하고, 실시간 '열 변위 보상 알고리즘'을 통해 정밀도를 $80\%$ 복원하는 수리적 근거를 제시합니다."
...
2. **(수리)** $1 \text{ m}$ 길이의 강철 로봇 팔 링크($\alpha = 12 \times 10^{-6} / ^\circ C$)가 가동 중 온도가 $15^\circ C$ 상승했다면, 열 팽창에 의한 끝단 변위($\mu m$)는 얼마인가?
