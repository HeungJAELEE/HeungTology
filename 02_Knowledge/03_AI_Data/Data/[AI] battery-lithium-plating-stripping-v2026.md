...
properties:
  ...
  dead_li_probability_model: P_dead ∝ (Tortuosity * beta) / Stripping Rate
  dq_dv_estimation_accuracy: 92%
  plating_onset_potential: < 0 V (vs. Li/Li+)
  plating_reversibility_range_crate: 0.5 to 3.0 C
  plating_reversibility_range_temp: -10 to 45 °C
