---
lineage:
  dataset_reference: liquid-hydrogen-storage-boil-off-rate-bor-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] liquid-hydrogen-storage-boil-off-rate-bor-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for liquid-hydrogen-storage-boil-off-rate-bor-log-v2026
  object_type: Data
  tier: 1
properties:
  energy_density_increase_factor: 800
  latent_heat_of_vaporization_kj_kg: 446
  ortho_to_para_conversion_energy_kj_kg: 527
  para_conversion_integrity_threshold: 0.999
  reliquefaction_energy_efficiency_threshold: 0.15
  storage_temperature_celsius: -253
  storage_temperature_kelvin: 20
  stratification_pressure_threshold_bar: 6
  tank_design_pressure_bar_max: 10
  tank_design_pressure_bar_min: 1
semantic:
  alternative_parents: []
  is_instance_of: '[[ [03_AI_Data] [Concept] liquid-hydrogen-storage-boil-off-rate-bor-log-v2026]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: automated_classification
  object: Data
  predicate: auto_mapped
  subject: liquid-hydrogen-storage-boil-off-rate-bor-log-v2026
  weight: 1.0
temporal:
