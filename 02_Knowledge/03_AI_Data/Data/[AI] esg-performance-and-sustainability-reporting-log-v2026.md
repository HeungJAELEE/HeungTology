...
object:
  description: '[AI] esg-performance-and-sustainability-reporting-log-v2026에 관한 고밀도
    지능 노드'
  object_type: Data
  tier: 1
properties:
  board_attendance_rate_percent: 98.5
  cfi_formula: (Scope_1 + Scope_2 + Scope_3) / Revenue
  external_compliance_endpoint: international-standards-and-global-compliance-iso-iec-etc
  gender_pay_gap_percent: 1.5
  re100_rate_percent: 65.0
  resource_circularity_improvement_threshold: 0.4
  scope_1_2_emissions_tco2e: 12500
  target_esg_incidents: 0
