---
lineage:
  dataset_reference: imu-sensor-drift-and-bias-compensation-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] imu-sensor-drift-and-bias-compensation-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for imu-sensor-drift-and-bias-compensation-log-v2026
  object_type: Data
  tier: 1
properties:
  consumer_mems_accel_bias_mg_max: 5
  consumer_mems_accel_bias_mg_min: 2
  consumer_mems_arw_deg_sqrt_hr: 0.5
  consumer_mems_gyro_bias_deg_hr_max: 50
  consumer_mems_gyro_bias_deg_hr_min: 10
  consumer_mems_min_drift_m_hr: 1000
  gps_denial_threshold_sec: 30
  gyro_bias_temp_sensitivity_deg_hr_c: 5
  industrial_mems_accel_bias_mg: 0.5
  industrial_mems_arw_deg_sqrt_hr: 0.1
  industrial_mems_drift_m_hr_max: 200
  industrial_mems_drift_m_hr_min: 50
  industrial_mems_gyro_bias_deg_hr: 1.0
  lane_width_uncertainty_threshold_m: 1.5
  optimal_bias_estimation_tau_sec: 100
  tactical_fog_accel_bias_mg: 0.05
  tactical_fog_arw_deg_sqrt_hr: 0.002
  tactical_fog_gyro_bias_deg_hr: 0.01
  tactical_fog_max_drift_m_hr: 5.0
  temp_compensation_drift_reduction_rate: 0.8
  zupt_max_drift_m_hr: 10.0
semantic:
  alternative_parents: []
  is_instance_of: '[[ [03_AI_Data] [Concept] imu-sensor-drift-and-bias-compensation-log-v2026]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: semantic_classification
  object: Data
  predicate: auto_mapped
  subject: imu-sensor-drift-and-bias-compensation-log-v2026
  weight: 1.0
temporal:
