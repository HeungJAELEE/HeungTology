...
object:
  description: '[AI] agv-warehouse-path-optimization-efficiency-log-v2026에 관한 고밀도
    지능 노드'
  object_type: Data
  tier: 1
properties:
  collision_free_rate_target: '> 99.999%'
  forklift_efficiency_theoretical: 20%
  forklift_efficiency_verified: 15-25%
  forklift_rerouting_latency_ms: 100-300
  hybrid_swarm_rerouting_latency_ms: < 50
  hybrid_swarm_throughput_verified: '> 600 units/h'
  log_reference_endpoint: agv-log-2026
  model_reference_endpoint: Model_v1
  path_efficiency_ratio_target: '1.0'
  underride_rerouting_latency_ms: 50-150
  underride_throughput_theoretical: 400 units/h
  underride_throughput_verified: 300-500 units/h
semantic:
  alternative_parents: []
