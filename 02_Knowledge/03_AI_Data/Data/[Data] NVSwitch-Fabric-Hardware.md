...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] NVSwitch-Fabric-Hardware]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for NVSwitch-Fabric-Hardware
  object_type: Hardware
  tier: 1
properties:
  nvswitch_3_0_aggregate_bandwidth_tbs: 6.4
  nvswitch_3_0_gpus_per_pod: 256
  nvswitch_3_0_ports_count: 64
  nvswitch_4_0_aggregate_bandwidth_tbs: 13.6
  nvswitch_4_0_gpus_per_pod: 576
  nvswitch_4_0_ports_count: 72
  serdes_eye_diagram_model: eye_diagram_height_proportional_to_inverse_channel_loss
  simulator_default_link_speed_gbps: 200
  simulator_default_ports: 72
  sync_time_formula: T_sync = (D * (N-1)) / (N * BW) + L_fabric
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 03_AI_Data]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: defines_technical_specifications
  object: Data
