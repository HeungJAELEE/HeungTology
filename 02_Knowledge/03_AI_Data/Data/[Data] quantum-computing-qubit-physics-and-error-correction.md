...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] quantum-computing-qubit-physics-and-error-correction]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for quantum-computing-qubit-physics-and-error-correction
  object_type: Concept
  tier: 1
properties:
  f1q_gate_fidelity_min_ratio: 0.999
  f2q_gate_fidelity_min_ratio: 0.99
  fidelity_engine_coherence_warning_threshold_us: 20
  fidelity_engine_critical_avg_fidelity_threshold: 0.98
  operating_temperature_max_mK: 20
  surface_code_two_qubit_error_threshold: 0.01
  t1_relaxation_time_min_us: 100
  t2_dephasing_time_min_us: 50
semantic:
  alternative_parents: []
  is_instance_of: '[[ [03_AI_Data] [Concept] quantum-computing-qubit-physics-and-error-correction]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: thematic_classification
  object: Data
