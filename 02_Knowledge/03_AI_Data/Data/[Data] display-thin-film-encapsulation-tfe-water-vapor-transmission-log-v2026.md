...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] display-thin-film-encapsulation-tfe-water-vapor-transmission-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for display-thin-film-encapsulation-tfe-water-vapor-transmission-log-v2026
  object_type: Data
  tier: 1
properties:
  critical_bending_radius: 1.5 mm
  ficks_diffusion_law: J = -D * (dc/dx)
  hybrid_layer_lag_time_min: 2500 hr
  hybrid_layer_wvtr_limit: 1e-7 g/m^2/day
  max_pinhole_density: < 0.01 count/cm^2
  min_transmittance: '> 90%'
  target_panel_lifespan_years: 10
  target_wvtr_threshold: < 1e-6 g/m^2/day
  wvtr_permeability_model: WVTR = P * (delta_p / l)
semantic:
  alternative_parents: []
  is_instance_of: '[[ [03_AI_Data] [Concept] display-thin-film-encapsulation-tfe-water-vapor-transmission-log-v2026]]'
spo_graph:
