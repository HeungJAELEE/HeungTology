---
lineage:
  dataset_reference: employee-engagement-and-culture-survey-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] employee-engagement-and-culture-survey-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for employee-engagement-and-culture-survey-log-v2026
  object_type: Data
  tier: 1
properties:
  culture_alignment_measured: 94.0
  culture_alignment_target_min: 90.0
  engagement_score_measured: 88.5
  engagement_score_target_min: 85.0
  growth_mindset_measured: 85.0
  growth_mindset_target_min: 80.0
  innovation_model_equation: I = k * e^(lambda * S)
  innovation_multiplier_at_safety_9_1: 3.5
  leadership_trust_measured: 92.4
  leadership_trust_target_min: 90.0
  peer_collaboration_measured: 8.8
  peer_collaboration_target_min: 8.0
  productivity_eta_per_10_percent_engagement: 0.024
  productivity_increase_multiplier: 0.21
  productivity_model_equation: P = eta * E + P_base
  psychological_safety_measured: 9.1
  psychological_safety_target_min: 8.5
  turnover_reduction_multiplier: 0.4
  work_life_balance_measured: 82.5
  work_life_balance_target_min: 80.0
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: employee-engagement-and-culture-survey-log-v2026
  weight: 0.95
temporal:
