---
lineage:
  dataset_reference: medical-image-segmentation-3d
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] medical-image-segmentation-3d]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for medical-image-segmentation-3d
  object_type: Concept
  tier: 1
properties:
  dice_coefficient_target_range: 0.85 - 0.95
  hausdorff_distance_threshold_mm: 2.0
  isotropic_resample_resolution_mm3: 1.0 x 1.0 x 1.0
  max_inference_latency_sec: 5.0
  max_vram_usage_gb: 12.0
  standard_specification: HDS-Gold V6.3.7
  voxel_grid_size_options:
  - 128^3
  - 256^3
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  intent: automated_ontology_alignment
  object: Data
  predicate: auto_mapped
  subject: medical-image-segmentation-3d
  weight: 0.4
temporal:
