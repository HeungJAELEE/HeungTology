...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] robot-predictive-maintenance-vibration-analysis-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for robot-predictive-maintenance-vibration-analysis-log-v2026
  object_type: Data
  tier: 1
properties:
  analysis_window_duration: 1.0 sec
  bearing_defect_kurtosis_threshold: '> 5.5'
  crest_factor_threshold: '> 5'
  gear_chipping_kurtosis_threshold: '> 7.0'
  kurtosis_bearing_crack_trigger: 3.0 - 6.0
  lubrication_fail_frequency_min: 5 kHz
  resonance_mitigation_deceleration: 10%
  rms_velocity_range: 1.0 - 4.5 mm/s
  rul_prediction_error_max: 15%
  sampling_rate_min: 25.6 kHz
semantic:
  alternative_parents: []
  is_instance_of: '[[ [03_AI_Data] [Concept] robot-predictive-maintenance-vibration-analysis-log-v2026]]'
spo_graph:
