...
measurement:
  ...
  precision: '0.0'
  unit: -K (Annual), 10-Q (Quarterly), 8-K (Current Event) |
  value: 10
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] sec-edgar-financial-reports]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for sec-edgar-financial-reports
  object_type: Data
  tier: 1
properties:
  access_script: dataset_search_skill.py
  data_format: xbrl
  data_scope: all_us_listed_companies
  local_skill_path: python 03_skills/finance/capex_analyzer.py
  reporting_forms: 10_k, 10_q, 8_k
semantic:
  alternative_parents: []
  is_instance_of: '[[ [03_AI_Data] [Concept] sec-edgar-financial-reports]]'
spo_graph:
