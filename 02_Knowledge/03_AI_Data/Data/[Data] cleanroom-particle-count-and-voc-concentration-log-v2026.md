---
Basic:
  id: "cleanroom-particle-count-and-voc-concentration-log-v2026-data"
...
Object:
  ...
  physical_model: "N/A"
Semantic:
  tags: '["#DataLog", "#Cleanroom", "#Particle_Count", "#VOC", "#ISO14644", "#Differential_Pressure", "#ACH", "#Lithography", "#Semiconductor", "#HDS_Gold_v6_1"]'
  is_part_of: '["MOC 25_iot-and-smart-factory-sensing-infrastructure-intelligence-hub", "Entity environmental-sensor-array-temp-hum-voc-dust"]'
  related_to: []
Dynamic:
...
| 공정 구역 (Area) | ISO Class | 입자 수 (0.1$\mu m$) | VOC 농도 ($ppb$) | 차압 ($Pa$) | 공학적 의미 (Rationale V6.3.7) |
| :--- | :---: | :---: | :---: | :---: | :--- |
...
본 로그는 입자 크기($D$)가 작아질수록 허용 개수가 기하급수적으로 늘어남을 입증하고, '0.1 $\mu m$ 급 계측기' 도입의 물리적 근거를 제시합니다.
...
2. **(수리)** ISO 14644-1 수식에 따라 ISO Class 3 클린룸에서 $0.5 \ \mu m$ 이상의 입자 허용 한계 개수($#/m^3$)를 계산하시오.
