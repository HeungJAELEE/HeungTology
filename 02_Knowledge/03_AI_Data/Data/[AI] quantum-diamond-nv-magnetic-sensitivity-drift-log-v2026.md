...
lineage:
  ...
  original_hash: e917987c51d405b946c02d0cd8db4e6540f036bca529a580e8a1690fc11dc39b
metadata:
  date: '2026-05-16'
  domain: 03_AI_Data
...
object:
  description: '[AI] quantum-diamond-nv-magnetic-sensitivity-drift-log-v2026에 관한 고밀도
    지능 노드'
  object_type: Data
  tier: 1
properties:
  ambient_temp_avg_k: 298.57
  max_snr_degradation_percent: 30.0
  sensitivity_avg_nt_sqrt_hz: 1.07
  splitting_drift_avg_khz: -1.21
  system_stability_index: 0.87
  theoretical_sensitivity_nt_sqrt_hz: 0.9
  thermal_drift_rate_khz_k: 74.0
semantic:
  alternative_parents: []
