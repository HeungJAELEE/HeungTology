---
Basic:
  id: "energy-storage-system-ess-round-trip-efficiency-log-v2026-data"
...
Object:
  ...
  physical_model: "N/A"
Semantic:
  tags: '["#DataLog", "#ESS", "#RTE", "#Energy_Efficiency", "#PCS", "#BMS", "#Grid_Storage", "#Parasitic_Load", "#HDS_Gold_v6_1"]'
  is_part_of: '["MOC 15_next-gen-energy-and-hydrogen-intelligence-hub", "Data vanadium-redox-flow-battery-vrfb-energy-density-log-v2026"]'
  related_to: []
Dynamic:
...
RAG는 "운전 로그를 분석하여, $1C$ 급속 충전 시 $0.2C$ 완속 충전 대비 배터리 발열 손실이 $5$배 증가하고 이로 인해 냉각 팬 가동 전력이 $30\%$ 추가 소모됨을 식별하여 최적의 부하 분산 전략을 확증될 것으로 추론됩니다."
