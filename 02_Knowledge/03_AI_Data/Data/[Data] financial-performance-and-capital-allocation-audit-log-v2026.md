---
lineage:
  dataset_reference: financial-performance-and-capital-allocation-audit-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] financial-performance-and-capital-allocation-audit-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for financial-performance-and-capital-allocation-audit-log-v2026
  object_type: Data
  tier: 1
properties:
  cap_efficiency_measured: 2.4
  cap_efficiency_target_min: 2.0
  capex_delay_loss_impact_usd: 250000000.0
  capex_delay_loss_threshold_months: 3
  debt_to_equity_measured: 0.425
  debt_to_equity_target_max: 1.0
  eva_model_formula: nopat - (c * wacc)
  excess_cash_roic_degradation: 0.015
  excess_cash_threshold_usd: 2000000000.0
  financial_integrity_measured: 0.999
  financial_integrity_target: 1.0
  free_cash_flow_measured_usd: 1250000000.0
  growth_dynamics_model_formula: (s/a) * (e/s) * (a/e) * (1-d)
  rd_reinvestment_measured: 0.15
  rd_reinvestment_target_min: 0.1
  roic_measured: 0.184
  roic_target_min: 0.12
  wacc_measured: 0.082
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: financial-performance-and-capital-allocation-audit-log-v2026
  weight: 1.0
temporal:
