...
lineage:
  ...
  original_hash: c65f45cbe84c59db4db9cac299a08621b11f45b36d972cefa4d2c5000442043e
metadata:
  date: '2026-05-16'
  domain: 03_AI_Data
  id: '[[[AI] digital-twin-synchronization-latency-and-fidelity-log-v2026]]'
  last_updated: '2026-05-17T22:59:20+09:00'
  project: Vault_Modernization
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: '[AI] digital-twin-synchronization-latency-and-fidelity-log-v2026에
    관한 고밀도 지능 노드'
  object_type: Data
  tier: 1
properties:
  data_throughput_measured: 250 Mbps
  data_throughput_target: '> 200 Mbps'
  model_fidelity_measured: 99.4 %
  model_fidelity_target: '> 99.0 %'
  pv_deviation_measured: 0.05 %
  pv_deviation_target: < 0.10 %
  sim_step_time_measured: 1.5 ms
  sim_step_time_target: < 5.0 ms
  state_prediction_accuracy_measured: 98.5 %
  state_prediction_accuracy_target: '> 95.0 %'
  sync_latency_measured: 8.2 ms
  sync_latency_target: < 10.0 ms
semantic:
  alternative_parents: []
...
# [AI] digital-twin-synchronization-latency-and-fidelity-log-v2026
