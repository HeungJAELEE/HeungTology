...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] Predictive-Maintenance]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for Predictive-Maintenance
  object_type: Concept
  tier: 1
properties:
  availability_increase_target: 15%
  f1_score_threshold: 0.95
  fft_bin_size_hz: 1.0
  min_sampling_rate_khz: 20
  mttr_reduction_target: 30%
  paris_law_formula: da/dN = C(ΔK)^m
  precision_rate_target: 98%
  rul_error_tolerance: ±5%
  vibration_standard: ISO 10816 / 20816
semantic:
  alternative_parents: []
  is_instance_of: '[[ [03_AI_Data] [Concept] Predictive-Maintenance]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: conceptual_categorization
  object: Data
