...
measurement:
  ...
  precision: '0.0'
  unit: '% SEU Protection | sim 99.9% (MBU 취약) |'
  value: 100
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] radiation-hardened-ai-circuits]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for radiation-hardened-ai-circuits
  object_type: Concept
  tier: 1
properties:
  ecc_bit_correction_capability: 1
  see_fault_types:
  - seu
  - sel
  - mbu
  tmr_mathematical_model: Y = Vote(F1(I), F2(I), F3(I))
  tmr_resource_overhead_pct: 200.0
  tmr_theoretical_error_coverage_pct: 100.0
  tmr_verified_error_coverage_pct: 99.9
semantic:
  alternative_parents: []
  is_instance_of: '[[ [03_AI_Data] [Concept] radiation-hardened-ai-circuits]]'
spo_graph:
