...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] Vector-Database-and-High-Dimensional-Indexing]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for Vector-Database-and-High-Dimensional-Indexing
  object_type: Concept
  tier: 1
properties:
  exact_knn_complexity: O(N * D)
  hds_gold_specification: V7.8
  hnsw_complexity: O(log N * d)
  pq_compression_ratio_example: 48.0
  pq_space_reduction_percentage: 97.9
  small_world_path_length_scaling: ln N
  target_recall_threshold: 0.9
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 03_AI_Data]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: automated_entity_mapping
  object: Data
