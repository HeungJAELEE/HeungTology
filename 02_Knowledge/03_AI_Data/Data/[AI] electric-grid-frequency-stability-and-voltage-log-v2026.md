...
lineage:
  ...
  original_hash: 8f9175d6d1e603518a5f8b9bfe5d761beffeca8617954da3b4d5067a6994097c
metadata:
  date: '2026-05-16'
  domain: 03_AI_Data
...
object:
  description: '[AI] electric-grid-frequency-stability-and-voltage-log-v2026에 관한 고밀도
    지능 노드'
  object_type: Data
  tier: 1
properties:
  ...
  swing_equation_rocof_limit: 0.015 Hz/s
  target_bus_voltage: 154 +/- 1.5 kV
  target_freq_deviation: < 10.0 mHz
  target_grid_frequency: 60.0 +/- 0.05 Hz
  target_rocof: < 0.1 Hz/s
  target_voltage_thd: < 1.0 %
semantic:
  alternative_parents: []
