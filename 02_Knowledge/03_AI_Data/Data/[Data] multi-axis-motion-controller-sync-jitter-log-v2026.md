---
Basic:
  id: "multi-axis-motion-controller-sync-jitter-log-v2026-data"
  domain: "75_Robotics_Mechatronics_and_Advanced_Motion_Control"
...
Object:
  ...
  physical_model: "N/A"
Semantic:
  tags: '["#DataLog", "#Motion_Control", "#Mechatronics", "#Jitter", "#Synchronization", "#Interpolation", "#EtherCAT", "#Servo_Control", "#HDS_Gold_v6_1"]'
  is_part_of: '["MOC 75_robotics-mechatronics-and-advanced-motion-control-hub", "MOC 70_industrial-automation-and-robotics-control-hub", "Data factory-plc-logic-execution-latency-and-jitter-log-v2026"]'
  related_to: []
Dynamic:
...
| :--- | :---: | :---: | :---: | :--- |
| **Sync Jitter** | $0.85 \text{ \mu s}$ | **DETERMINISTIC**| $< 1.00 \text{ \mu s}$ | 축 간 명령 전달 시간의 불규칙한 변동폭 |
| **Interpol. Cycle** | $250 \text{ \mu s}$ | **HIGH-SPEED** | $< 500 \text{ \mu s}$ | 새로운 경로 좌표를 계산하고 갱신하는 주기 |
| **Axis Skew Error** | $1.2 \text{ \mu m}$ | **PRECISE** | $< 2.0 \text{ \mu m}$ | 동시 가동 축 간의 물리적 위치 편차 |
| **Velocity Ripple** | $0.05 \%$ | **SMOOTH** | $< 0.10 \%$ | 속도 명령 대비 실제 속도의 미세 진동 |
| **Response Latency**| $42 \text{ \mu s}$ | **ULTRA-FAST** | $< 100 \text{ \mu s}$ | 피드백 수신 후 제어 출력 반영까지의 시간 |
