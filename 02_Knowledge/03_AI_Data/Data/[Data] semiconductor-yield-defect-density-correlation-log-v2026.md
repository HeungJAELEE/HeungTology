---
lineage:
  dataset_reference: semiconductor-yield-defect-density-correlation-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] semiconductor-yield-defect-density-correlation-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for semiconductor-yield-defect-density-correlation-log-v2026
  object_type: Data
  tier: 1
properties:
  critical_defect_size_threshold_cd_ratio: 0.5
  defect_density_definition: average number of fatal defects per unit area (defects/cm^2)
  murphy_yield_model: Y_Murphy = ((1 - e^(-A * D0)) / (A * D0))^2
  pattern_defect_frequency_multiplier: 3.0
  poisson_yield_model: Y_Poisson = e^(-A * D0)
  target_defect_density_28nm_max: 0.05
  target_defect_density_2nm_range: 0.20-0.30
  target_defect_density_3nm_range: 0.10-0.20
  target_defect_density_7nm_range: 0.05-0.10
  target_defect_density_hbm_range: 0.10-0.15
  yield_definition: ratio of passing chips to total wafers
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: semiconductor-yield-defect-density-correlation-log-v2026
  weight: 0.95
temporal:
