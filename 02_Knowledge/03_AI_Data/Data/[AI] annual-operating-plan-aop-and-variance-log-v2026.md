...
lineage:
  ...
  original_hash: 14ddf61202cee8a9a5961af673379ca5e8049299f3c78ef3493c76092672dae4
metadata:
  date: '2026-05-16'
  domain: 03_AI_Data
  id: '[[[AI] annual-operating-plan-aop-and-variance-log-v2026]]'
  last_updated: '2026-05-17T22:59:20+09:00'
  project: Vault_Modernization
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: '[AI] annual-operating-plan-aop-and-variance-log-v2026에 관한 고밀도 지능 노드'
  object_type: Data
  tier: 1
properties:
  actual_capex: 25M
  ...
  actual_opex: 19M
  actual_revenue: 98M
  capex_utilization_rate_pct: 83.3
  cogs_variance_pct: 5.0
  dol_model_impact_threshold: 5% revenue drop -> 20% op profit collapse
  op_profit_variance_pct: -20.0
  opex_variance_pct: -5.0
  plan_achievement_index_target: 1.0
  planned_capex: 30M
  planned_cogs: 60M
...
# [AI] annual-operating-plan-aop-and-variance-log-v2026
...
| :--- | :---: | :---: | :---: | :--- | :--- |
| **Revenue** | $\$100\text{M}$ [Ref: AOP-P] | $\$98\text{M}$ [Ref: P&L-A] | $-2.0\%$ | Volume Drop | 시장 수요 대응 및 영업 무결성 로그 |
| **COGS** | $\$60\text{M}$ [Ref: AOP-P] | $\$63\text{M}$ [Ref: P&L-A] | $+5.0\%$ | Raw Mat Price | 제조 원가 관리 및 생산 무결성 지표 |
| **OPEX** | $\$20\text{M}$ [Ref: AOP-P] | $\$19\text{M}$ [Ref: P&L-A] | $-5.0\%$ | Efficiency | 판관비 통제 및 운영 무결성 데이터 |
| **Op Profit** | $\$20\text{M}$ [Ref: AOP-P] | $\$16\text{M}$ [Ref: P&L-A] | $-20.0\%$ | Mixed Factor | 최종 경영 성과 및 수익 무결성 로그 |
| **CAPEX** | $\$30\text{M}$ [Ref: AOP-P] | $\$25\text{M}$ [Ref: P&L-A] | $-16.7\%$ | Delay in EQ | 미래 성장 투자 및 자산 무결성 지표 |
