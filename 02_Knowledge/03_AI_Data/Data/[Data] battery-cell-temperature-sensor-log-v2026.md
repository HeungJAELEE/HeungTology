...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] battery-cell-temperature-sensor-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for battery-cell-temperature-sensor-log-v2026
  object_type: Data
  tier: 1
properties:
  cell_temp_target_range_c: 25~65
  max_hysteresis_error_c: 0.2
  max_rise_rate_c_min: 5.0
  max_sensor_response_time_s: 2.0
  max_temp_gradient_c: 5.0
  min_cooling_efficiency_pct: 85.0
  ntc_resistance_kohm: 10 +/- 1%
  steinhart_hart_a_default: 0.001
  steinhart_hart_b_default: 0.0002
  steinhart_hart_c_default: 1.0e-07
  temp_resolution_c: 0.1
  verified_cooling_efficiency_pct: 87.2
  verified_ntc_accuracy_pct: 1.2
  verified_response_time_s: 1.8 +/- 0.2
semantic:
  alternative_parents: []
  is_instance_of: '[[ [03_AI_Data] [Concept] battery-cell-temperature-sensor-log-v2026]]'
spo_graph:
