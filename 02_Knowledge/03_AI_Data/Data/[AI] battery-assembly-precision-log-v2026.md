...
object:
  ...
  tier: 1
properties:
  case_gap_limit: 0.05 mm
  case_gap_verified: 0.2 mm
  critical_misalignment_threshold: 0.35 mm
  low_voltage_defect_reduction_rate: 95%
  lvdt_measurement_resolution: 0.001 mm
  misalignment_cycle_period: 5000 cycles
  stacking_alignment_limit: 0.3 mm
  stacking_alignment_verified: 0.1 mm
  tab_welding_offset_limit: 0.15 mm
  tab_welding_offset_verified: 0.05 mm
  winding_tension_limit: 25 N ± 2 N
  winding_tension_verified: 25 N ± 1.5 N
semantic:
  alternative_parents: []
