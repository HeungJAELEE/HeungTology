...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] collaborative-robot-cobot-safety-sensor-response-time-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for collaborative-robot-cobot-safety-sensor-response-time-log-v2026
  object_type: Data
  tier: 1
properties:
  capacitive_skin_response_time_ms_max: 1
  collision_force_limit_n: 140
  imu_response_time_ms_max: 2
  joint_torque_response_time_ms_range:
  - 5
  - 20
  laser_scanner_response_time_ms_range:
  - 50
  - 150
  sensor_fusion_latency_increase_ms: 10
  stopping_distance_model: d = (1/2 * m * v^2) / (F_brake - m * g * sin(theta)) +
    v * t_response
  surface_flatness_velocity_increase_pct: 20
  vision_ai_response_time_ms_range:
  - 30
  - 80
semantic:
  alternative_parents: []
