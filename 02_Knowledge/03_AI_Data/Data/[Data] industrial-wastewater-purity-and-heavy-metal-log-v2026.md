---
lineage:
  dataset_reference: industrial-wastewater-purity-and-heavy-metal-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] industrial-wastewater-purity-and-heavy-metal-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for industrial-wastewater-purity-and-heavy-metal-log-v2026
  object_type: Data
  tier: 1
properties:
  cod_measured_mg_l: 18.5
  cod_target_max_mg_l: 20.0
  freundlich_model_parameters:
  - k
  - c
  - n
  metal_conc_measured_ppb: 4.2
  metal_conc_target_max_ppb: 10.0
  oxidation_reduction_rate_parameters:
  - k
  - c_ox
  - c_org
  - a
  - b
  ph_level_measured: 7.25
  ph_target_range: 7.0 +/- 0.5
  removal_eff_measured_pct: 99.94
  removal_eff_target_min_pct: 99.9
  total_nitrogen_measured_mg_l: 4.8
  total_nitrogen_target_max_mg_l: 5.0
  turbidity_measured_ntu: 0.45
  turbidity_target_max_ntu: 1.0
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: industrial-wastewater-purity-and-heavy-metal-log-v2026
  weight: 0.9
temporal:
