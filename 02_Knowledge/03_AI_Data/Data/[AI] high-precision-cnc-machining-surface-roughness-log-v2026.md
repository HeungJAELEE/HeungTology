...
lineage:
  ...
  original_hash: f1cb8a7dc3f6cbe3b7de5db119640f93c70c0e2b2efd8d50e393041162bf93da
metadata:
  date: '2026-05-16'
  domain: 03_AI_Data
  id: '[[[AI] high-precision-cnc-machining-surface-roughness-log-v2026]]'
  last_updated: '2026-05-17T22:59:20+09:00'
  project: Vault_Modernization
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: '[AI] high-precision-cnc-machining-surface-roughness-log-v2026에 관한
    고밀도 지능 노드'
  object_type: Data
  tier: 1
properties:
  coolant_temp_increase_celsius: 50
  cutting_speed_measured: 245m/min
  cutting_speed_target_range: 200-300m/min
  dimensional_error_measured: 1.4µm
  dimensional_error_target_max: 2.0µm
  external_qa_log_endpoint: automated-quality-assurance-and-defect-detection-log-v2026
  feed_rate_measured: 0.12mm/rev
  feed_rate_target_range: 0.10-0.15mm/rev
  resonance_frequency_khz: 2.4
  roughness_ra_measured: 0.18µm
  roughness_ra_target_max: 0.20µm
  tool_tip_radius_r: 0.8mm
  tool_wear_index_measured: 12.5
  tool_wear_index_target_max: 30.0
  vibration_g_measured: 0.02G
  vibration_g_target_max: 0.05G
semantic:
  alternative_parents: []
...
# [AI] high-precision-cnc-machining-surface-roughness-log-v2026
