---
lineage:
  dataset_reference: Multiphysics-Simulation-Fusion
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Data] Multiphysics-Simulation-Fusion]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Data node for Multiphysics-Simulation-Fusion
  object_type: Concept
  tier: 1
properties:
  energy_conservation_delta_e: ~ 0
  engine_standard: HDS-Gold V6.3.7
  l2_norm_residual_threshold: < 10^-5
  mapping_error_threshold: < 1.0%
  min_dof_nodes: 10^7
  model_fidelity_r2_min: 0.98
  pinn_inference_max_ms: 100
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 03_AI_Data]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: cross_domain_mapping
  object: Data
  predicate: auto_mapped
  subject: Multiphysics-Simulation-Fusion
  weight: 0.9
temporal:
