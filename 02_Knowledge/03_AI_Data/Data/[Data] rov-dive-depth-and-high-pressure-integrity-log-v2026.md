---
Basic:
  id: "rov-dive-depth-and-high-pressure-integrity-log-v2026-data"
...
Object:
  ...
  physical_model: "N/A"
Semantic:
  tags: '["#DataLog", "#Robotics", "#Marine_Engineering", "#Deep-sea", "#ROV", "#AUV", "#High-pressure", "#Structural_Integrity", "#HDS_Gold_v6_1"]'
  is_part_of: '["MOC 34_future-frontier-deep-sea-intelligence-and-marine-ops-hub", "MOC 26_autonomous-systems-and-robotics-hub", "Entity deep-sea-exploration-robotics-and-high-pressure-physics"]'
  related_to: []
Dynamic:
...
| **Hull Microstrain**| $450 \text{ \mu\epsilon}$ | **STABLE** | $< 800 \text{ \mu\epsilon}$ | 티타늄 선체의 미세 변형률 (안전도) |
