---
Basic:
  id: "urban-air-quality-pm2-5-and-voc-index-log-v2026-data"
  domain: "112_Environmental_Engineering_and_Pollution_Control"
...
Object:
  ...
  physical_model: "N/A"
Semantic:
  tags: '["#DataLog", "#Environmental", "#Air_Quality", "#PM2.5", "#VOC", "#Pollution_Control", "#Smart_City", "#HDS_Gold_v6_1"]'
  is_part_of: '["MOC 107_environmental-engineering-and-pollution-control-hub", "MOC 102_environmental-engineering-and-climate-intelligence-hub", "Data industrial-wastewater-purity-and-heavy-metal-log-v2026"]'
  related_to: []
Dynamic:
...
| :--- | :---: | :---: | :---: | :--- |
| **PM2.5 Conc.** | $8.4 \text{ \mu g/m}^3$ | **CLEAN** | $< 12.0 \text{ \mu g/m}^3$ | 초미세먼지 농도 (폐 깊숙이 침투하는 입자) |
