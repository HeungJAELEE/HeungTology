---
lineage:
  dataset_reference: neural-interface-signal-stability-and-decoding-accuracy-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] neural-interface-signal-stability-and-decoding-accuracy-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for neural-interface-signal-stability-and-decoding-accuracy-log-v2026
  object_type: Data
  tier: 1
properties:
  accuracy_loss_threshold: 5%
  gliosis_reduction_rate_polymer: 40%
  impedance_critical_threshold_kohm: '200'
  performance_degradation_limit: 0.1%
  rem_sleep_performance_drop: 8%
  signal_lifespan_multiplier_polymer: 2x
  target_decoding_accuracy: '> 99.0%'
  target_impedance_kohm: < 200
  target_snr_db: '> 15.0'
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: neural-interface-signal-stability-and-decoding-accuracy-log-v2026
  weight: 1.0
temporal:
...
# [Concept] Neural Interface Signal Stability And Decoding Accuracy Log V2026
