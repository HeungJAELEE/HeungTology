---
lineage:
  dataset_reference: OPC-UA-Interoperability-Standard-for-Industry-4-0
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] OPC-UA-Interoperability-Standard-for-Industry-4-0]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for OPC-UA-Interoperability-Standard-for-Industry-4-0
  object_type: Concept
  tier: 1
properties:
  encryption_standard: AES-256/RSA-4k
  fidelity_engine_jitter_tolerance_us: 1
  fidelity_engine_throughput_tolerance_mbps: 5
  high_end_latency_limit_ms: 1.0
  high_end_semantic_consistency: 1.0
  information_entropy_formula: I = -sum(p_i * log2(p_i))
  low_end_latency_threshold_ms: 500.0
  low_end_semantic_consistency_threshold: 0.7
  node_density_threshold: 100000
  packet_jitter_limit_us: 10
  standard_latency_range_ms: 10-100
  standard_semantic_consistency_threshold: 0.9
  throughput_minimum_mbps: 100
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: OPC-UA-Interoperability-Standard-for-Industry-4-0
  weight: 0.95
temporal:
...
# [Concept] Opc Ua Interoperability Standard For Industry 4 0
