...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] steel-rolling-thickness-precision-and-surface-quality-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for steel-rolling-thickness-precision-and-surface-quality-log-v2026
  object_type: Data
  tier: 1
properties:
  flatness_index_target: '98.0'
  measured_surface_roughness: 0.45 um
  measured_thickness_deviation: 0.028 mm
  roll_wear_target: 0.50 mm
  rolling_force: 25,450 kN
  rolling_speed_measured: 1,250 m/min
  rolling_speed_target_range: 1,000-1,500 m/min
  surface_roughness_target: 0.80 um
  surface_roughness_threshold: 0.5 um
  thickness_deviation_target: 0.050 mm
  thickness_precision_threshold: 0.03 mm
semantic:
  alternative_parents: []
...
# [Concept] Steel Rolling Thickness Precision And Surface Quality Log V2026
