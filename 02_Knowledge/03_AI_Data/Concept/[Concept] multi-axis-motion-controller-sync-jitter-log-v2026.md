---
lineage:
  dataset_reference: multi-axis-motion-controller-sync-jitter-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] multi-axis-motion-controller-sync-jitter-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for multi-axis-motion-controller-sync-jitter-log-v2026
  object_type: Data
  tier: 1
properties:
  axis_skew_error_measured: 1.2um
  axis_skew_error_target: <2.0um
  cpu_load_measured: 45.2%
  cpu_load_target: <70.0%
  external_latency_log_endpoint: factory-plc-logic-execution-latency-and-jitter-log-v2026
  interpolation_cycle_measured: 250us
  interpolation_cycle_target: <500us
  response_latency_measured: 42us
  response_latency_target: <100us
  sync_jitter_measured: 0.85us
  sync_jitter_target: <1.00us
  velocity_ripple_measured: 0.05%
  velocity_ripple_target: <0.10%
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: multi-axis-motion-controller-sync-jitter-log-v2026
  weight: 1.0
temporal:
...
# [Concept] Multi Axis Motion Controller Sync Jitter Log V2026
