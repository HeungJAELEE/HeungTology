...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] oled-pixel-brightness-uniformity-and-mura-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for oled-pixel-brightness-uniformity-and-mura-log-v2026
  object_type: Data
  tier: 1
properties:
  cloud_mura_demura_deviation: <0.5%
  cloud_mura_jnd: 1.8
  cloud_mura_raw_deviation: 2.0-5.0%
  color_deviation_threshold: <0.003
  demura_bits_precision: 10-14 bit
  line_mura_demura_deviation: <1.0%
  line_mura_jnd: 4.2
  line_mura_raw_deviation: 3.0-8.0%
  low_gray_mura_demura_deviation: <2.0%
  low_gray_mura_jnd: 5.5
  low_gray_mura_raw_deviation: 10.0-20.0%
  low_grayscale_correction_gain: 2.0
  low_grayscale_jnd_multiplier: 5.0
  low_grayscale_luminance_threshold: 10 nits
  mura_contrast_target: <1%
  peak_brightness_hdr: 1000-4000 nits
  rubbing_mura_demura_deviation: <0.8%
  rubbing_mura_jnd: 2.1
  rubbing_mura_raw_deviation: 1.5-3.0%
  spot_mura_demura_deviation: <1.5%
  spot_mura_jnd: 3.5
  spot_mura_raw_deviation: 5.0-15.0%
  target_uniformity_threshold: '>95%'
  temp_drift_red_luminance_loss: 2% per 10C rise
semantic:
  alternative_parents: []
  is_instance_of: '[[ [MOC] 03_AI_Data]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: quality_baseline_definition
  object: Concept
...
# [Concept] Oled Pixel Brightness Uniformity And Mura Log V2026
