---
lineage:
  dataset_reference: healthcare-wearable-biosensor-signal-integrity-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] healthcare-wearable-biosensor-signal-integrity-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for healthcare-wearable-biosensor-signal-integrity-log-v2026
  object_type: Data
  tier: 1
properties:
  battery_power_limit_uw: < 500
  cloud_sync_latency_ms: < 100
  cmrr_target_db: '> 100.0'
  contact_impedance_limit_kohm: < 10.0
  engine_impedance_limit_kohm: '50.0'
  engine_snr_threshold: '30.0'
  motion_artifact_intensity_limit: < 0.05
  resolution_bit_depth: 16-24
  sampling_frequency_hz: 250-1000
  snr_target_db: '> 40.0'
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: healthcare-wearable-biosensor-signal-integrity-log-v2026
  weight: 1.0
temporal:
...
# [Concept] Healthcare Wearable Biosensor Signal Integrity Log V2026
...
3. **Common Mode Rejection Ratio** (CMRR)가 $100dB$일 때, $1\ \text{V}$의 공통 모드 노이즈가 유입될 경우 출력에 나타나는 노이즈의 수리적 크기는?
