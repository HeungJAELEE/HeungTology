---
lineage:
  dataset_reference: ess-thermal-management-and-hvac-power-consumption-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] ess-thermal-management-and-hvac-power-consumption-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for ess-thermal-management-and-hvac-power-consumption-log-v2026
  object_type: Data
  tier: 1
properties:
  air_cooled_cop: 2.5-3.5
  air_cooled_delta_t: 5-8C
  air_cooled_hvac_power_ratio: 5-10%
  air_cooled_target_temp: 25+/-5C
  critical_ambient_temp_threshold: 35C
  hvac_load_spike_multiplier: '2.0'
  immersion_cooled_cop: 6.0-7.5
  immersion_cooled_delta_t: <1C
  immersion_cooled_hvac_power_ratio: 2-4%
  immersion_cooled_target_temp: 20+/-1C
  liquid_cooled_cop: 4.0-5.5
  liquid_cooled_delta_t: 1-3C
  liquid_cooled_hvac_power_ratio: 3-6%
  liquid_cooled_target_temp: 23+/-2C
  recommended_target_temperature_range: 15-30C
  rte_drop_at_critical_temp: 4%
  soh_reduction_rate_at_threshold: 25%
  thermal_gradient_life_impact_threshold: 5C
  thermal_storage_delta_t: 2-4C
  thermal_storage_hvac_power_ratio: 2-5%
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: ess-thermal-management-and-hvac-power-consumption-log-v2026
  weight: 0.9
temporal:
...
# [Concept] Ess Thermal Management And Hvac Power Consumption Log V2026
