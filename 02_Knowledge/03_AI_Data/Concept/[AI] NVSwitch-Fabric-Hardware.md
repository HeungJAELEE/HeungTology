...
lineage:
  ...
  original_hash: 52d3b427e45ef2f8d09202d45df23f28731ecc78f66d782b9fbe9f226fd3108e
metadata:
  date: '2026-05-16'
  domain: 03_AI_Data
  id: '[[[AI] NVSwitch-Fabric-Hardware]]'
  last_updated: '2026-05-17T22:59:20+09:00'
  project: Vault_Modernization
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: '[AI] NVSwitch-Fabric-Hardware에 관한 고밀도 지능 노드'
  object_type: Hardware
  tier: 1
properties:
  default_link_speed_gbps: 200
  eye_diagram_height_relation: 1 / channel_loss
  nvswitch_3_0_aggregate_bandwidth_tbs: 6.4
  nvswitch_3_0_gpus_per_pod: 256
  nvswitch_3_0_ports_per_switch: 64
  nvswitch_4_0_aggregate_bandwidth_tbs: 13.6
  nvswitch_4_0_gpus_per_pod: 576
  nvswitch_4_0_ports_per_switch: 72
  sharp_version_3: NVSwitch 3.0
  sharp_version_4: NVSwitch 4.0+
  t_sync_model: (D * (N-1)) / (N * BW) + L_fabric
semantic:
  alternative_parents: []
