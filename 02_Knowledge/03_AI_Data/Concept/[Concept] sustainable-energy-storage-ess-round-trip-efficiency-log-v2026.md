---
lineage:
  dataset_reference: sustainable-energy-storage-ess-round-trip-efficiency-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] sustainable-energy-storage-ess-round-trip-efficiency-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for sustainable-energy-storage-ess-round-trip-efficiency-log-v2026
  object_type: Data
  tier: 1
properties:
  annual_degradation_measured: 0.45%/yr
  annual_degradation_target: < 0.60%/yr
  daily_self_discharge_measured: 0.15%/day
  daily_self_discharge_target: < 0.20%/day
  degradation_model: Arrhenius_model
  efficiency_model: eta_RTE = (E_out / E_in) * 100
  external_db_smart_grid: smart-grid-load-balancing-and-curtailment-log-v2026
  external_db_space_weather: space-weather-solar-flare-and-radiation-intensity-log-v2026
  response_time_measured: 25 ms
  response_time_target: < 100 ms
  round_trip_efficiency_measured: 91.5%
  round_trip_efficiency_target: '> 90.0%'
  storage_capacity: 500 MWh
  temperature_stability_measured: 25.4°C
  temperature_stability_target: 25 ± 2°C
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: sustainable-energy-storage-ess-round-trip-efficiency-log-v2026
  weight: 0.9
temporal:
...
# [Concept] Sustainable Energy Storage Ess Round Trip Efficiency Log V2026
