---
lineage:
  dataset_reference: grid-frequency-regulation-and-response-time-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] grid-frequency-regulation-and-response-time-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for grid-frequency-regulation-and-response-time-log-v2026
  object_type: Data
  tier: 1
properties:
  bess_frequency_range_hz: 60.00 +/- 0.01
  bess_ramp_rate_mw_s: '> 100'
  bess_response_time_ms: < 20
  deadband_hz: 0.02
  demand_response_frequency_range_hz: 60.00 +/- 0.05
  ffr_trigger_limit_ms: 100
  gas_turbine_response_time_min: 1-5
  max_allowable_communication_latency_ms: 200
  pumped_hydro_response_time_s: 10-30
  rocof_critical_threshold_hz_s: 0.5
  standard_grid_frequency_hz: 60.0
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: grid-frequency-regulation-and-response-time-log-v2026
  weight: 1.0
temporal:
...
# [Concept] Grid Frequency Regulation And Response Time Log V2026
