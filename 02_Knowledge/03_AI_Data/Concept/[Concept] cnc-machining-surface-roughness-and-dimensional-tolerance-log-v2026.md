---
lineage:
  dataset_reference: cnc-machining-surface-roughness-and-dimensional-tolerance-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] cnc-machining-surface-roughness-and-dimensional-tolerance-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for cnc-machining-surface-roughness-and-dimensional-tolerance-log-v2026
  object_type: Data
  tier: 1
properties:
  dimensional_tolerance_target: 2.0um
  external_data_hub: precision-engineering-and-nanometrology-mastery-hub
  feed_rate_f: 0.05mm/rev
  flatness_error_target: 5.0um
  spindle_runout_target: 1.0um
  surface_roughness_target_ra: 0.10um
  temperature_control_point: 20C
  temperature_tolerance: 0.1C
  tool_tip_radius_re: 0.4mm
  tool_wear_index_threshold: '0.30'
  tool_wear_offset_threshold: 10um
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: cnc-machining-surface-roughness-and-dimensional-tolerance-log-v2026
  weight: 0.5
temporal:
...
# [Concept] Cnc Machining Surface Roughness And Dimensional Tolerance Log V2026
