...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] quantum-state-tomography-reconstruction-fidelity-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for quantum-state-tomography-reconstruction-fidelity-log-v2026
  object_type: Data
  tier: 1
properties:
  ...
  theoretical_fidelity_limit: '1.0000'
semantic:
  alternative_parents: []
...
# [Concept] Quantum State Tomography Reconstruction Fidelity Log V2026
