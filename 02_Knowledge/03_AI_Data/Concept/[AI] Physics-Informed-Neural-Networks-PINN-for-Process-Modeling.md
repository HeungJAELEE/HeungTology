...
lineage:
  ...
  original_hash: a594b8464f31dd3771715545565e82c7da8c7c3f520c3b353d043d22225458df
metadata:
  date: '2026-05-16'
  domain: 03_AI_Data
...
object:
  description: '[AI] Physics-Informed-Neural-Networks-PINN-for-Process-Modeling에 관한
    고밀도 지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  data_efficiency_reduction_factor: '0.01'
  extrapolation_error_threshold: '0.05'
  extreme_temperature_reference: 1000C
  physical_consistency_range: 0.95-0.99
  sample_size_reduction_percentage: 99%
semantic:
  alternative_parents: []
