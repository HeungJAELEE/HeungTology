---
lineage:
  dataset_reference: iot-device-battery-life-and-energy-harvesting-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] iot-device-battery-life-and-energy-harvesting-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for iot-device-battery-life-and-energy-harvesting-log-v2026
  object_type: Data
  tier: 1
properties:
  energy_neutrality_condition: harvested_power >= consumed_power
  indoor_solar_efficiency_percent: 15~25
  indoor_solar_harvested_power_uW: 10~100
  rf_harvesting_efficiency_percent: 40~60
  rf_harvesting_harvested_power_uW: 1~10
  self_discharge_acceleration_factor: 2x
  temp_increase_threshold: 10C
  thermal_generation_threshold_delta_t: 10C
  thermal_power_gain_ratio: 5x
  thermal_teg_efficiency_percent: 5~8
  thermal_teg_harvested_power_uW: 50~500
  vibration_piezo_efficiency_percent: 30~40
  vibration_piezo_harvested_power_uW: 5~50
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: iot-device-battery-life-and-energy-harvesting-log-v2026
  weight: 1.0
temporal:
...
# [Concept] Iot Device Battery Life And Energy Harvesting Log V2026
