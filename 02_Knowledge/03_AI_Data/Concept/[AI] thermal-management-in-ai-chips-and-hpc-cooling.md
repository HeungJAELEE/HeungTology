...
object:
  ...
  tier: 1
properties:
  coolant_flow_rate_range: 1.5-3.0 L/min
  critical_throttling_temp: 100 °C
  junction_temperature_limit: 85 °C
  pue_threshold: '1.1'
  tdp_range: 300-700 W
  thermal_resistance_limit: 0.1 K/W
  thermal_resistance_reject_threshold: 0.15 K/W
  verified_max_tdp: 650 W
  verified_min_tj: 82 °C
  warning_throttling_temp: 85 °C
semantic:
  alternative_parents: []
