---
lineage:
  dataset_reference: food-shelf-life-and-microbial-stability-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] food-shelf-life-and-microbial-stability-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for food-shelf-life-and-microbial-stability-log-v2026
  object_type: Data
  tier: 1
properties:
  max_microbial_count: 1.0e5 CFU/g
  max_oxidation_rate: 10.0 meq/kg
  max_water_activity: 0.85 Aw
  measured_microbial_count: 4.2e3 CFU/g
  measured_oxidation_rate: 2.4 meq/kg
  measured_ph_level: '4.5'
  measured_shelf_life: 14.5 days
  measured_storage_temp: 4.2 C
  measured_water_activity: 0.82 Aw
  min_shelf_life: 12.0 days
  storage_temp_range: 0-5 C
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: food-shelf-life-and-microbial-stability-log-v2026
  weight: 1.0
temporal:
...
# [Concept] Food Shelf Life And Microbial Stability Log V2026
