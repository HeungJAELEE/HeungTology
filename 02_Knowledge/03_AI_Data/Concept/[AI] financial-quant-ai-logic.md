...
lineage:
  ...
  original_hash: a3a023a67bdaa79ea37ff9ee3a562edd82c7ce448fc99630b210cefcb9436551
metadata:
  date: '2026-05-16'
  domain: 03_AI_Data
...
object:
  ...
  tier: 1
properties:
  backtest_latency_threshold: < 10 ms/cycle
  beta_market_threshold: < 0.3
  information_ratio_threshold: '> 0.5'
  max_drawdown_threshold: < 10%
  risk_free_rate: '0.03'
  sharpe_ratio_threshold: '> 1.5'
  turnover_rate_threshold: < 5% /day
  var_95_threshold: < 2%
