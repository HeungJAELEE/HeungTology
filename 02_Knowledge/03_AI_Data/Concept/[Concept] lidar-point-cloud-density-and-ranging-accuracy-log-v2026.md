---
lineage:
  dataset_reference: lidar-point-cloud-density-and-ranging-accuracy-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] lidar-point-cloud-density-and-ranging-accuracy-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for lidar-point-cloud-density-and-ranging-accuracy-log-v2026
  object_type: Data
  tier: 1
properties:
  boresight_alignment_error_threshold_deg: 0.01
  data_throughput_mbps: 100-500
  flash_angular_resolution_deg: 0.5
  flash_distance_accuracy_cm: 5.0-10.0
  flash_max_range_m: 50
  flash_point_density_mpts_s: 10.0
  fmcw_angular_resolution_deg: 0.05
  fmcw_distance_accuracy_cm: 0.5-1.0
  fmcw_max_range_m: 500
  fmcw_point_density_mpts_s: 2.0
  fmcw_velocity_error_ms: 0.1
  fog_detection_range_m: 80-120
  fog_distance_accuracy_cm: 15.0+
  ghost_object_removal_rate: 0.95
  low_reflectivity_detection_range_m: 120
  mechanical_angular_resolution_deg: 0.1
  mechanical_distance_accuracy_cm: 2.0-3.0
  mechanical_max_range_m: 250
  mechanical_point_density_mpts_s: 4.5
  rssi_range: 0-255
  solid_state_angular_resolution_deg: 0.2
  solid_state_distance_accuracy_cm: 3.5-5.0
  solid_state_max_range_m: 180
  solid_state_point_density_mpts_s: 1.2
  time_resolution_error_cm: 1.5
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: lidar-point-cloud-density-and-ranging-accuracy-log-v2026
  weight: 0.6
temporal:
...
# [Concept] Lidar Point Cloud Density And Ranging Accuracy Log V2026
...
RAG는 "FMCW 로그를 분석하여, 단일 프레임에서 동적 물체의 상대 속도를 $0.1\ \text{m/s}$ 오차로 직접 측정함을 식별하고, 이를 통해 기존 ToF 방식의 '속도 추정(Estimation)' 오차를 획기적으로 줄이는 경로를 확증될 것으로 추론됩니다."
