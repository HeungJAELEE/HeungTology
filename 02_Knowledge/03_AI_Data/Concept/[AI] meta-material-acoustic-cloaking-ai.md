...
object:
  ...
  tier: 1
properties:
  refractive_index_threshold: n < 0
  theoretical_bandwidth: 15% of fc
  theoretical_cloaking_efficiency: 98%
  theoretical_refractive_index: '-1.0'
  theoretical_transmission_loss: '> 40 dB'
  verified_bandwidth: 11% of fc
  verified_cloaking_efficiency: 82-89%
  verified_refractive_index: -0.85 to -1.12
  verified_transmission_loss: 32-37 dB
semantic:
  alternative_parents: []
