---
lineage:
  dataset_reference: grid-scale-inverter-efficiency-and-thd-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] grid-scale-inverter-efficiency-and-thd-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for grid-scale-inverter-efficiency-and-thd-log-v2026
  object_type: Data
  tier: 1
properties:
  central_inverter_efficiency_euro: 98.5-99.0%
  central_inverter_thd_range: 1.5-2.5%
  grid_frequency: 60Hz/50Hz
  micro_inverter_efficiency_euro: 96-97.5%
  micro_inverter_thd_range: 3.0-5.0%
  sic_switching_loss_reduction_ratio: 70%
  storage_inverter_efficiency_euro: 97-98.5%
  storage_inverter_thd_range: 2.0-3.0%
  string_inverter_efficiency_euro: 99.0-99.5%
  string_inverter_thd_limit: <1.0%
  target_solid_state_transformer_efficiency: 99%
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: grid-scale-inverter-efficiency-and-thd-log-v2026
  weight: 0.9
temporal:
...
# [Concept] Grid Scale Inverter Efficiency And Thd Log V2026
