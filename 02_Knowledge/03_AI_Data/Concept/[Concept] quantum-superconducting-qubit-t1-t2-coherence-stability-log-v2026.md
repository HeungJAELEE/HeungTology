...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] quantum-superconducting-qubit-t1-t2-coherence-stability-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for quantum-superconducting-qubit-t1-t2-coherence-stability-log-v2026
  object_type: Data
  tier: 1
properties:
  cz_gate_crosstalk_limit: 0.05%
  one_qubit_gate_fidelity_verified: 99.94%
  operation_temp_verified: 14.2 mK
  readout_fidelity_verified: 99.42%
  t1_relaxation_target: '> 200.0 us'
  t1_relaxation_tolerance: ±15.0 us
  t1_relaxation_verified: 245.0 us
  t2_dephasing_target: '> 150.0 us'
  t2_dephasing_tolerance: ±10.0 us
...
# [Concept] Quantum Superconducting Qubit T1 T2 Coherence Stability Log V2026
