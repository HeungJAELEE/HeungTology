...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] global-supply-chain-logistics-and-lead-time-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for global-supply-chain-logistics-and-lead-time-log-v2026
  object_type: Data
  tier: 1
properties:
  avg_lead_time_measured: 12.4 days
  avg_lead_time_target: < 14.0 days
  external_db_endpoint: global-trade-vessel-congestion-and-throughput-log-v2026
  fulfillment_rate_measured: 98.5%
  fulfillment_rate_target: '> 98.0%'
  logistics_cost_measured: 4.2 USD/u
  logistics_cost_target: < 5.0 USD/u
  on_time_delivery_measured: 99.2%
  on_time_delivery_target: '> 99.0%'
  scm_volatility_measured: '12.5'
  scm_volatility_target: < 15.0
  transit_latency_measured: 4.5 hours
  transit_latency_target: < 6.0 hours
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 03_AI_Data]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: entity_mapping
  object: Concept
...
# [Concept] Global Supply Chain Logistics And Lead Time Log V2026
