---
lineage:
  dataset_reference: industry-digital-twin-real-time-sync-latency-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] industry-digital-twin-real-time-sync-latency-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for industry-digital-twin-real-time-sync-latency-log-v2026
  object_type: Data
  tier: 1
properties:
  channel_capacity_formula: C = B * log2(1 + S/N)
  compute_delay_threshold_ms: 5.0
  engine_specification: HDS-Gold V6.3.7
  jitter_threshold_ms: 0.5
  network_latency_threshold_ms: 3.0
  packet_loss_threshold_percent: 0.001
  sync_drift_formula: delta_x = v * tau_total
  sync_error_threshold_mm: 1.0
  throughput_threshold_mbps: 50.0
  total_latency_threshold_ms: 10.0
  update_frequency_threshold_hz: 500
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 03_AI_Data]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: initial_categorization
  object: Concept
  predicate: auto_mapped
  subject: industry-digital-twin-real-time-sync-latency-log-v2026
  weight: 0.3
temporal:
...
# [Concept] Industry Digital Twin Real Time Sync Latency Log V2026
