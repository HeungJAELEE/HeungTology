...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] last-mile-delivery-route-optimization-and-latency-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for last-mile-delivery-route-optimization-and-latency-log-v2026
  object_type: Data
  tier: 1
properties:
  avg_delivery_time: 45.8 min
  avg_delivery_time_target: 50.0 min
  delivery_latency: 12.5 sec
  delivery_latency_target: 30.0 sec
  delivery_success_rate: 99.2%
  delivery_success_target: 98.0%
  delivery_success_threshold: 98%
  drop_off_time: 1.5 min
  drop_off_time_target: 2.0 min
  fuel_per_delivery: 0.12 L
  fuel_per_delivery_target: 0.15 L
  logistics_cost_share: 50%
  route_efficiency_index: '0.94'
  route_efficiency_target: '0.90'
  route_efficiency_threshold: 95%
semantic:
  alternative_parents: []
...
# [Concept] Last Mile Delivery Route Optimization And Latency Log V2026
