...
object:
  description: '[AI] OPC-UA-Interoperability-Standard-for-Industry-4-0에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  encryption_standard: AES-256/RSA-4k
  entropy_formula: I = -sum(p_i * log2(p_i))
  fidelity_engine_jitter_tolerance_us: 1
  fidelity_engine_throughput_tolerance_mbps: 5
  high_end_latency_limit_ms: 1.0
  high_end_node_density_min: 100000
  high_end_packet_jitter_limit_us: 10
  high_end_semantic_consistency: 1.0
  high_end_throughput_min_mbps: 100
  low_end_latency_min_ms: 500
  low_end_semantic_consistency_min: 0.7
  standard_latency_range_ms: 10-100
  standard_semantic_consistency_min: 0.9
semantic:
  alternative_parents: []
