...
lineage:
  ...
  original_hash: 0a6f1dcfd5adf956a2d7f1ec3b4837614a05bf14a07390a88636ceab4f0e9b2c
metadata:
  date: '2026-05-16'
  domain: 03_AI_Data
...
object:
  ...
  tier: 1
properties:
  critical_affinity_threshold: 50.0
  cycle_time_days: 22.4
  cycle_time_normalization_factor: 60.0
  de_novo_affinity_nm: 14.5
  ligand_binding_success_rate: 91.2
  log_endpoint: ai-synthetic-biology-protein-design-log-v2026
  logic_reliability_ratio: 0.82
  rmsd_target: 1.0
  rmsd_verified: 1.15
  sequence_recovery_rate: 84.5
  warning_rmsd_threshold: 1.5
semantic:
  alternative_parents: []
