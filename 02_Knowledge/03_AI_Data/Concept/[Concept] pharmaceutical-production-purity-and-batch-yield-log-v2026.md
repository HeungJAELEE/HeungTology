---
lineage:
  dataset_reference: pharmaceutical-production-purity-and-batch-yield-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] pharmaceutical-production-purity-and-batch-yield-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for pharmaceutical-production-purity-and-batch-yield-log-v2026
  object_type: Data
  tier: 1
properties:
  api_purity_measured: 99.94%
  api_purity_target: '> 99.90%'
  audit_fidelity: MAXIMUM
  batch_yield_measured: 96.8%
  batch_yield_target: '> 95.0%'
  compliance_measured: 100.0%
  compliance_target: 100.0%
  impurity_level_measured: 24.5 ppm
  impurity_level_target: < 50.0 ppm
  ph_stability_measured: '7.42'
  ph_stability_target: 7.40 ± 0.1
  reactor_temp_measured: 37.2 °C
  reactor_temp_target: 37.0 ± 0.5 °C
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: pharmaceutical-production-purity-and-batch-yield-log-v2026
  weight: 1.0
temporal:
...
# [Concept] Pharmaceutical Production Purity And Batch Yield Log V2026
