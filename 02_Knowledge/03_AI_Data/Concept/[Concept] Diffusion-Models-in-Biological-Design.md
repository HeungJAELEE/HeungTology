...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] Diffusion-Models-in-Biological-Design]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for Diffusion-Models-in-Biological-Design
  object_type: Algorithm
  tier: 1
properties:
  de_novo_success_rate_generative: 10-30%
  de_novo_success_rate_random: < 0.1%
  design_latency_inference: < 10^2 seconds
  design_latency_trial_error: 10^6 hours
  plddt_high_confidence_threshold: '80.0'
