---
lineage:
  dataset_reference: cpu-gpu-utilization-and-thermal-throttling-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] cpu-gpu-utilization-and-thermal-throttling-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for cpu-gpu-utilization-and-thermal-throttling-log-v2026
  object_type: Data
  tier: 1
properties:
  clock_speed_measured: 4.85GHz
  cpu_usage_measured: 88.5%
  cpu_usage_target: 70-90%
  gpu_load_measured: 92.4%
  gpu_load_target: '>90.0%'
  mem_bw_usage_measured: 72.5%
  mem_bw_usage_target: <80.0%
  package_temp_measured: 78.5C
  package_temp_target: <85.0C
  peak_power_surge_threshold: 30%
  throttling_duration_measured: 0.25s
  throttling_duration_target: <1.00s
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: cpu-gpu-utilization-and-thermal-throttling-log-v2026
  weight: 0.9
temporal:
...
# [Concept] Cpu Gpu Utilization And Thermal Throttling Log V2026
