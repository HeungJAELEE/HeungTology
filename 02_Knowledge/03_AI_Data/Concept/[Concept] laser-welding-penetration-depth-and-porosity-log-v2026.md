...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] laser-welding-penetration-depth-and-porosity-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for laser-welding-penetration-depth-and-porosity-log-v2026
  object_type: Data
  tier: 1
properties:
  haz_width_measured: 0.2 mm
  haz_width_target: < 0.3 mm
  laser_power_density_measured: 1.2 MW/cm^2
  laser_power_density_target: '> 1.0 MW'
  max_porosity_threshold: 1 %
  melt_pool_stability_measured: '0.98'
  melt_pool_stability_target: '> 0.95'
  penetration_depth_measured: 4.5 mm
  penetration_depth_target: 4.2-4.8 mm
  penetration_precision_threshold: 0.1 mm
  porosity_fraction_measured: 0.8 %
  porosity_fraction_target: < 1.5 %
  welding_speed_measured: 3.5 m/min
  welding_speed_target: 3.0-4.0 m/min
semantic:
  alternative_parents: []
...
# [Concept] Laser Welding Penetration Depth And Porosity Log V2026
