...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] semiconductor-wafer-defect-map-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for semiconductor-wafer-defect-map-v2026
  object_type: Data
  tier: 1
properties:
  cluster_index_alpha: 0.8 ~ 1.2
  critical_defects_limit: < 120 pts / 12" Wafer
  defect_density_d0: < 0.005 /cm^2
  killer_rate_pkill: '> 85.0%'
  metrology_sensitivity_nm: 8.0 ~ 12.0
  normalized_entropy_hn: '> 0.92'
  process_node: 3nm GAA
  signature_fidelity_f: '> 0.98'
  yield_analysis_latency_sec: < 45
semantic:
  alternative_parents: []
...
# [Concept] Semiconductor Wafer Defect Map V2026
