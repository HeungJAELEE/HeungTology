---
lineage:
  dataset_reference: wearable-sensor-biosignal-accuracy-and-drift-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] wearable-sensor-biosignal-accuracy-and-drift-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for wearable-sensor-biosignal-accuracy-and-drift-log-v2026
  object_type: Data
  tier: 1
properties:
  adaptive_filter_model: s_hat = w^T (s + n)
  artifact_ratio_measured: 42.0 dB
  artifact_ratio_target: '>35.0 dB'
  battery_index_measured: '92.4'
  battery_index_target: '>85.0'
  beer_lambert_model: A = ln(I0 / I) = epsilon * c * l
  hr_accuracy_measured: 99.2%
  hr_accuracy_target: '>98.0%'
  sampling_rate_measured: 250 Hz
  sampling_rate_target: '>100 Hz'
  signal_drift_measured: 0.002 /hr
  signal_drift_target: <0.010
  spo2_error_measured: 0.85%
  spo2_error_target: <1.00%
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: wearable-sensor-biosignal-accuracy-and-drift-log-v2026
  weight: 0.5
temporal:
...
# [Concept] Wearable Sensor Biosignal Accuracy And Drift Log V2026
