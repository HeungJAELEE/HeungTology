---
lineage:
  dataset_reference: harmonic-distortion-and-voltage-sag-event-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] harmonic-distortion-and-voltage-sag-event-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for harmonic-distortion-and-voltage-sag-event-log-v2026
  object_type: Data
  tier: 1
properties:
  critical_k_factor_threshold: 13
  eddy_current_loss_multiplier: 10
  itic_safe_threshold_example: 70% voltage for 20ms
  magnetic_switch_dropout_duration: 0.1s
  magnetic_switch_dropout_voltage: 50%
  thd_current_threshold: 20.0%
  thd_voltage_threshold: 5.0%
  transient_duration_threshold: < 1ms
  transient_voltage_range: 500-2000%
  voltage_recovery_tolerance: ±10%
  voltage_sag_duration_range: 10-1000ms
  voltage_sag_intensity_range: 10-90%
  voltage_swell_duration_range: 10-1000ms
  voltage_swell_intensity_range: 110-150%
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: harmonic-distortion-and-voltage-sag-event-log-v2026
  weight: 0.9
temporal:
...
# [Concept] Harmonic Distortion And Voltage Sag Event Log V2026
