...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] RAG-Embedding-and-Dense-Retrieval]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for RAG-Embedding-and-Dense-Retrieval
  object_type: Algorithm
  tier: 1
properties:
  bge_m3_cosine_threshold: 0.65
  bge_m3_dimension: 1024
  bge_m3_latency_target_ms: 15.0
  healthy_avg_cosine_sim_range: 0.65-0.95
  healthy_mrr_at_5_threshold: 0.75
  healthy_noise_intrusion_threshold: 0.15
  healthy_retrieval_latency_ms: 50.0
  minilm_l6_cosine_threshold: 0.55
  minilm_l6_dimension: 384
  minilm_l6_latency_target_ms: 5.0
  oov_cosine_threshold: 0.25
  oov_mrr_at_5_threshold: 0.4
  openai_v3_cosine_threshold: 0.7
  openai_v3_dimension: 1536
  openai_v3_latency_target_ms: 80.0
  semantic_drift_cosine_threshold: 0.45
  semantic_drift_latency_ms: 150.0
  semantic_drift_mrr_at_5_threshold: 0.6
  semantic_drift_noise_threshold: 0.35
semantic:
  alternative_parents: []
