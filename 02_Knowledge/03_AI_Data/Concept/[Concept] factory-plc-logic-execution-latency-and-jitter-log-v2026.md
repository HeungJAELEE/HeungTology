...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] factory-plc-logic-execution-latency-and-jitter-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for factory-plc-logic-execution-latency-and-jitter-log-v2026
  object_type: Data
  tier: 1
properties:
  bus_utilization_measured: 48.5%
  bus_utilization_target: < 60.0%
  gcl_precision_measured: 99.99%
  gcl_precision_target: '> 99.95%'
  network_jitter_measured: 4.2us
  network_jitter_target: < 5.0us
  packet_loss_measured: 0.0002%
  packet_loss_target: < 0.0010%
  plc_cycle_time_measured: 0.95ms
  plc_cycle_time_target: < 1.00ms
  tsn_sync_accuracy_measured: 45ns
  tsn_sync_accuracy_target: < 100ns
semantic:
  alternative_parents: []
...
# [Concept] Factory Plc Logic Execution Latency And Jitter Log V2026
