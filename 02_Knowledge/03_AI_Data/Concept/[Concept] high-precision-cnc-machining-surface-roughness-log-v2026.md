---
lineage:
  dataset_reference: high-precision-cnc-machining-surface-roughness-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] high-precision-cnc-machining-surface-roughness-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for high-precision-cnc-machining-surface-roughness-log-v2026
  object_type: Data
  tier: 1
properties:
  chatter_resonant_frequency: 2.4kHz
  coolant_temp_increase_threshold: 50C
  measured_cutting_speed: 245m/min
  measured_dimensional_error: 1.4um
  measured_feed_rate: 0.12mm/rev
  measured_roughness_ra: 0.18um
  measured_tool_wear: '12.5'
  measured_vibration: 0.02G
  referenced_log_endpoint: automated-quality-assurance-and-defect-detection-log-v2026
  target_cutting_speed_range: 200-300m/min
  target_dimensional_error: 2.0um
  target_feed_rate_range: 0.10-0.15mm/rev
  target_roughness_ra: 0.20um
  target_tool_wear_limit: '30.0'
  target_vibration_limit: 0.05G
  tool_radius_r: 0.8mm
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: high-precision-cnc-machining-surface-roughness-log-v2026
  weight: 0.9
temporal:
...
# [Concept] High Precision Cnc Machining Surface Roughness Log V2026
...
| :--- | :---: | :---: | :---: | :--- |
| **Roughness (Ra)** | $0.18 \text{ \mu\text{m}}$ | **EXCELLENT** | $< 0.20 \text{ \mu\text{m}}$ | 가공 표면의 평균 거칠기 (평탄도 지표) |
...
| **Dimensional Err**| $1.4 \text{ \mu\text{m}}$ | **PRECISE** | $< 2.0 \text{ \mu\text{m}}$ | 설계 치수 대비 실제 가공 치수의 오차 |
