...
lineage:
  ...
  original_hash: 1b9bea9a0844c58ab78e2e386e89acb8be85098774f3045a440ae05eaba3e38e
metadata:
  date: '2026-05-16'
  domain: 03_AI_Data
  id: '[[[AI] Generative-Design-Optimization]]'
  last_updated: '2026-05-17T22:59:20+09:00'
  project: Vault_Modernization
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: '[AI] Generative-Design-Optimization에 관한 고밀도 지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  engine_version: HDS-Gold V6.3.7
  mass_reduction_target: 30%-60%
  min_member_size: 1.0mm
  min_safety_factor: '1.5'
  min_voxel_count: 10^6
  overhang_angle_limit: 45deg
  simp_power: '3'
