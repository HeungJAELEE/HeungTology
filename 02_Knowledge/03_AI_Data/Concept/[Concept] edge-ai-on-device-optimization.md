...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] edge-ai-on-device-optimization]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for edge-ai-on-device-optimization
  object_type: Algorithm
  tier: 1
properties:
  actual_io_memory_reduction_pct: 68.12
  actual_model_sparsity_pct: 85.24
  actual_quantization_accuracy_drop_pct: 0.24
  actual_rag_inference_latency_ms: 82.4
  actual_speedup_ratio: 4.15
  actual_temperature_scale_factor: 4.0
  max_accuracy_drop_pct: 0.5
  max_latency_ms: 100
  validation_dataset_endpoint: on-device-llm-quantization-accuracy-drop-log-v2026
semantic:
  alternative_parents: []
...
# [Concept] Edge Ai On Device Optimization
