---
lineage:
  dataset_reference: lithium-iron-phosphate-lfp-ess-cycle-life-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] lithium-iron-phosphate-lfp-ess-cycle-life-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for lithium-iron-phosphate-lfp-ess-cycle-life-log-v2026
  object_type: Data
  tier: 1
properties:
  capacity_retention_threshold: 80%
  deep_cycle_life: 3,000-5,000
  fast_charge_cycle_life: 2,500-4,000
  high_temp_cycle_life: 2,000-4,000
  idle_storage_life: 10-20 years
  soh_range: 0-100%
  standard_cycle_life: 6,000-10,000
  target_metric: lcos
  temp_degradation_factor: 2x per 10C
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 03_AI_Data]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: empirical_baseline
  object: Concept
  predicate: auto_mapped
  subject: lithium-iron-phosphate-lfp-ess-cycle-life-log-v2026
  weight: 0.9
temporal:
...
# [Concept] Lithium Iron Phosphate Lfp Ess Cycle Life Log V2026
