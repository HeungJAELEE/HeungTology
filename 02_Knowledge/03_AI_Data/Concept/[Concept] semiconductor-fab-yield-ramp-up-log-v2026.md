...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] semiconductor-fab-yield-ramp-up-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for semiconductor-fab-yield-ramp-up-log-v2026
  object_type: Data
  tier: 1
properties:
  chip_area_range: 0.5 to 2.5
  cpgd_cost_threshold: 10.0
  critical_layer_count: 60 to 120
  cycle_time_threshold: 1.5
  defect_density_threshold: 0.05
  learning_index_range: 0.3 to 0.5
  learning_model: Y(n) = Y0 * n^b
  murphy_model: Y = [(1 - e^(-A * D0)) / (A * D0)]^2
  poisson_model: Y = e^(-A * D0)
  target_yield: 0.92
  weekly_yield_target: 15% to 92%
  wpm_volume_range: 10,000 to 100,000
semantic:
  alternative_parents: []
...
# [Concept] Semiconductor Fab Yield Ramp Up Log V2026
