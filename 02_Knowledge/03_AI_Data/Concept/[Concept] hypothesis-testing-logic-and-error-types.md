---
lineage:
  dataset_reference: hypothesis-testing-logic-and-error-types
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] hypothesis-testing-logic-and-error-types]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for hypothesis-testing-logic-and-error-types
  object_type: Algorithm
  tier: 1
properties:
  cohen_d_medium_threshold: '0.5'
  confidence_level: '0.95'
  critical_value_z_score: '1.96'
  engine_specification: HDS-Gold V6.3.7
  p_value_threshold: '0.05'
  significance_alpha: '0.05'
  standard_error_formula: sigma / sqrt(n)
  statistical_power_threshold: '0.80'
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: hypothesis-testing-logic-and-error-types
  weight: 0.9
temporal:
...
# [Concept] Hypothesis Testing Logic And Error Types
