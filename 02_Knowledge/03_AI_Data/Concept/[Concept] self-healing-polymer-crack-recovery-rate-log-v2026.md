...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] self-healing-polymer-crack-recovery-rate-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for self-healing-polymer-crack-recovery-rate-log-v2026
  object_type: Data
  tier: 1
properties:
  active_group_decay_per_cycle: 5%
  capsule_size_threshold: 100μm
  capsule_strength_reduction_rate: 15%
  diels_alder_trigger_temp: 80-120°C
  healing_efficiency_formula: sigma_healed / sigma_initial
  min_healing_efficiency_target: 90%
  moisture_recovery_rate_drop: 30%
semantic:
  alternative_parents: []
...
# [Concept] Self Healing Polymer Crack Recovery Rate Log V2026
