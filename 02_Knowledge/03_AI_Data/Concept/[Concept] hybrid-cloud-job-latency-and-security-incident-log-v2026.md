...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] hybrid-cloud-job-latency-and-security-incident-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for hybrid-cloud-job-latency-and-security-incident-log-v2026
  object_type: Data
  tier: 1
properties:
  api_error_rate_limit_pct: 0.1
  api_error_rate_pct: 0.04
  auth_failure_count: 1420
  breach_attempt_count: 0
  channel_uptime_limit_pct: 99.99
  channel_uptime_pct: 99.995
  job_queue_time_limit_s: 10.0
  job_queue_time_s: 4.8
  network_latency_limit_ms: 50.0
  network_latency_ms: 42.5
  packet_loss_rate_threshold: 1.0e-06
  sync_drift_limit_ms: 2.0
  sync_drift_ms: 0.8
  sync_integrity_threshold_ms: 1.0
semantic:
  alternative_parents: []
...
# [Concept] Hybrid Cloud Job Latency And Security Incident Log V2026
