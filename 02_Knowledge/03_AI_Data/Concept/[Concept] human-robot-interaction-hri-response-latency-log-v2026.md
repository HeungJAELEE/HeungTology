---
lineage:
  dataset_reference: human-robot-interaction-hri-response-latency-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] human-robot-interaction-hri-response-latency-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for human-robot-interaction-hri-response-latency-log-v2026
  object_type: Data
  tier: 1
properties:
  emotional_adaptation_deceleration: 30%
  gesture_accuracy_measured: 98.4%
  gesture_accuracy_target: '> 98.0%'
  inference_time_t_inf: 45ms
  interaction_fidelity_measured: '96.8'
  interaction_fidelity_target: '> 95.0'
  nlu_error_rate_at_threshold: 15%
  nlu_noise_threshold: 70dB
  resp_latency_measured: 145ms
  resp_latency_target: < 200ms
  safety_buffer_measured: 0.85m
  safety_buffer_target: '> 0.50m'
  social_trust_measured: '92.5'
  social_trust_target: '> 90.0'
  speech_lag_measured: 85ms
  speech_lag_target: < 150ms
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: human-robot-interaction-hri-response-latency-log-v2026
  weight: 0.5
temporal:
...
# [Concept] Human Robot Interaction Hri Response Latency Log V2026
