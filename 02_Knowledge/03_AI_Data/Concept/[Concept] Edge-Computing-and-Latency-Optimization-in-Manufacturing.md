---
lineage:
  dataset_reference: Edge-Computing-and-Latency-Optimization-in-Manufacturing
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] Edge-Computing-and-Latency-Optimization-in-Manufacturing]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for Edge-Computing-and-Latency-Optimization-in-Manufacturing
  object_type: Concept
  tier: 1
properties:
  control_logic: edge_based_anomaly_detection
  max_latency_threshold: 10ms
  processing_batch_size: '1000'
  sensor_sampling_frequency: 1kHz
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: Edge-Computing-and-Latency-Optimization-in-Manufacturing
  weight: 0.9
temporal:
...
# [Concept] Edge Computing And Latency Optimization In Manufacturing
