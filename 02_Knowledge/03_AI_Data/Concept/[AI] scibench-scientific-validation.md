...
lineage:
  ...
  original_hash: 5a6b3201bf627d423ea2a6edf21b31cfba495a026cb1fcf01114784237291a8c
metadata:
  date: '2026-05-16'
  domain: 03_AI_Data
  id: '[[[AI] scibench-scientific-validation]]'
  last_updated: '2026-05-17T22:59:20+09:00'
  project: Vault_Modernization
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: '[AI] scibench-scientific-validation에 관한 고밀도 지능 노드'
  object_type: Data
  tier: 1
properties:
  constant_error_threshold: 0.01%
  data_scope: 10+ Scientific Domains (Thermo, Fluid, Quantum)
  difficulty_level: Undergraduate to Advanced Research
  internal_engine: FidelityEngine
  local_skill_path: 03_Skills/garden/final_gold_total_audit.py
  search_skill_path: dataset_search_skill.py
  source_references:
  - Google-SciBench-Repo
  - MIT-OCW-Data
  validation_units: SI Units
semantic:
  alternative_parents: []
...
# [AI] scibench-scientific-validation
...
| **Validation Units** | SI Units, Physical Constants, Derivations | [Ref: Google-SciBench-Repo] |
| **Difficulty Level** | Undergraduate to Advanced Research | [Ref: MIT-OCW-Data] |
