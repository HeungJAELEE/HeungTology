...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] Neuromorphic-Computing]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for Neuromorphic-Computing
  object_type: Concept
  tier: 1
properties:
  dvs_dynamic_range: '> 120 dB'
  energy_per_op_sop: < 1 pJ/SOP
  lif_tau_m: '20.0'
  lif_v_reset: '0.0'
  lif_v_threshold: '1.0'
  local_reaction_time: < 1 ms
  synapse_density: '> 10^9 per chip'
semantic:
  alternative_parents: []
