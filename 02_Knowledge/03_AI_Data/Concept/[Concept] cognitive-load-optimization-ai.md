...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] cognitive-load-optimization-ai]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for cognitive-load-optimization-ai
  object_type: Algorithm
  tier: 1
properties:
  detection_sensitivity_theoretical: 0.95
  detection_sensitivity_verified: 0.82
  dropout_rate: 0.2
  response_latency_theoretical_max: 10ms
  response_latency_verified: 42ms
  snr_theoretical_min: 60dB
  snr_verified: 41dB
  state_classification_accuracy_theoretical: 98.5%
  state_classification_accuracy_verified: 87.2%
semantic:
  alternative_parents: []
...
# [Concept] Cognitive Load Optimization Ai
