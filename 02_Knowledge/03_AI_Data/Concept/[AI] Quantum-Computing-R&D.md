...
object:
  ...
  tier: 1
properties:
  cryogenic_temp_limit: < 20 mK
  gate_fidelity_threshold: '> 99.9%'
  physical_qubit_count_min: '1000'
  pipeline_spec_version: HDS-Gold V6.3.7
  qec_fidelity_requirement: 99.9%
  qpu_gpu_latency_threshold: < 10 us
  quantum_volume_target: '> 2^10'
  speedup_factor: exponential
  t1_relaxation_threshold: '> 100 us'
  t2_dephasing_threshold: '> 50 us'
semantic:
  alternative_parents: []
