---
lineage:
  dataset_reference: dikw-pyramid-value-creation
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] dikw-pyramid-value-creation]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for dikw-pyramid-value-creation
  object_type: Concept
  tier: 1
properties:
  contextualization_rate_threshold: '> 99%'
  info_gain_threshold: '> 2.5 bits'
  linkage_quality_threshold: '> 0.8'
  overheat_pattern_threshold: 65.0
  pattern_precision_threshold: '> 95%'
  raw_symbol_count_threshold: '> 10^9 events/day'
  roi_impact_threshold: '> 15%'
  sdr_ratio_threshold: '> 1:1,000'
  wisdom_delay_threshold: < 100 ms
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: dikw-pyramid-value-creation
  weight: 1.0
temporal:
...
# [Concept] Dikw Pyramid Value Creation
