---
lineage:
  dataset_reference: Quantum-Communication-QKD
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] Quantum-Communication-QKD]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for Quantum-Communication-QKD
  object_type: Concept
  tier: 1
properties:
  dark_count_rate: 100 Hz
  detection_efficiency: 0.8
  key_refresh_interval: 1 min
  max_fiber_link_range: 100-200 km
  qber_threshold: 0.11
  repetition_rate: 1.0-2.5 GHz
  secure_key_rate_50km: 100 kbps
  standard_protocol: BB84 / Decoy-state
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: Quantum-Communication-QKD
  weight: 1.0
temporal:
...
# [Concept] Quantum Communication Qkd
