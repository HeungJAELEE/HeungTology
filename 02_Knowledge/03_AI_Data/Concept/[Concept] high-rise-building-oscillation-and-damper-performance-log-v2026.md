...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] high-rise-building-oscillation-and-damper-performance-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for high-rise-building-oscillation-and-damper-performance-log-v2026
  object_type: Data
  tier: 1
properties:
  max_acceleration_comfort_threshold: 15.0milli-g
  max_oscillation_amplitude_threshold: 50.0mm
  measured_acceleration: 12.5milli-g
  measured_damper_efficiency: 94.2%
  measured_damping_ratio: 2.45%
  measured_natural_frequency: 0.125Hz
  measured_oscillation_amplitude: 32.4mm
  measured_wind_speed: 24.5m/s
  min_damper_efficiency_threshold: 90.0%
  min_damping_ratio_threshold: 2.0%
  natural_frequency_target_range: 0.1-0.3Hz
semantic:
  alternative_parents: []
...
# [Concept] High Rise Building Oscillation And Damper Performance Log V2026
