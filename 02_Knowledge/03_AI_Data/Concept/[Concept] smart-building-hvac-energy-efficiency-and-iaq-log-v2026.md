---
lineage:
  dataset_reference: smart-building-hvac-energy-efficiency-and-iaq-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] smart-building-hvac-energy-efficiency-and-iaq-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for smart-building-hvac-energy-efficiency-and-iaq-log-v2026
  object_type: Data
  tier: 1
properties:
  air_exchange_ach_measured: 0.58
  air_exchange_ach_target_range: 0.5-0.7
  energy_intensity_measured_kwh_m2: 124.5
  energy_intensity_target_max_kwh_m2: 150.0
  filter_dp_measured_pa: 120
  filter_dp_target_max_pa: 250
  global_building_carbon_emission_ratio: 0.3
  humidity_energy_impact_ratio: 1.5
  hvac_cop_measured: 4.82
  hvac_cop_target_min: 4.5
  indoor_co2_measured_ppm: 745
  indoor_co2_target_max_ppm: 800
  temp_error_measured_celsius: 0.15
  temp_error_target_max_celsius: 0.5
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 03_AI_Data]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: initial_type_mapping
  object: Concept
  predicate: auto_mapped
  subject: smart-building-hvac-energy-efficiency-and-iaq-log-v2026
  weight: 0.5
temporal:
...
# [Concept] Smart Building Hvac Energy Efficiency And Iaq Log V2026
