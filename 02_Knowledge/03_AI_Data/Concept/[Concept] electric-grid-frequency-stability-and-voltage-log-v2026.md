---
lineage:
  dataset_reference: electric-grid-frequency-stability-and-voltage-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] electric-grid-frequency-stability-and-voltage-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for electric-grid-frequency-stability-and-voltage-log-v2026
  object_type: Data
  tier: 1
properties:
  bus_voltage_target: 154 +/- 1.5 kV
  freq_deviation_threshold: 10.0 mHz
  frequency_nadir_example: 59.2 Hz
  grid_frequency_target: 60.0 +/- 0.05 Hz
  measured_bus_voltage: 154.2 kV
  measured_freq_deviation: 2.0 mHz
  measured_grid_frequency: 60.002 Hz
  measured_reactive_power: 45.2 MVAR
  measured_rocof: 0.015 Hz/s
  measured_voltage_thd: 0.85%
  rocof_threshold: 0.1 Hz/s
  voltage_thd_threshold: 1.0%
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: electric-grid-frequency-stability-and-voltage-log-v2026
  weight: 1.0
temporal:
...
# [Concept] Electric Grid Frequency Stability And Voltage Log V2026
