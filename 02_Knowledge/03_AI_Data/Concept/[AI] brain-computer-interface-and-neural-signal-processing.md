...
lineage:
  ...
  original_hash: d1f195a55b5b7990aa3b0a9aaabe7ac5dffbb0f1c14f53e30a9863c004f633b0
metadata:
  date: '2026-05-16'
  domain: 03_AI_Data
  id: '[[[AI] brain-computer-interface-and-neural-signal-processing]]'
  last_updated: '2026-05-17T22:59:20+09:00'
  project: Vault_Modernization
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: '[AI] brain-computer-interface-and-neural-signal-processing에 관한 고밀도
    지능 노드'
  object_type: Concept
  tier: 1
properties:
  channel_count_range: 128-1024
  data_endpoint: bci-decoding-accuracy-and-bit-rate-log-v2026
  decoding_accuracy_min: 90%
  execution_reliability_target: 99%
  info_transfer_rate_min: 5.0 bits/sec
  latency_max: 50 ms
  power_line_noise_frequency: 60 Hz
  sampling_rate_min: 1000 Hz
  snr_critical_threshold: 5 dB
  snr_warning_threshold: 15 dB
  target_itr_threshold: 4.0 bps
semantic:
  alternative_parents: []
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Sampling Rate | $f_s$ | $\infty$ | $> 1000$ | Hz | [Ref: ISO-BCI-2026] |
| Channel Count | $N_{ch}$ | $\infty$ | $128 \sim 1024$ | count | [Ref: ISO-BCI-2026] |
| Decoding Accuracy | $ACC$ | $100$ | $> 90$ | % | [Ref: ISO-BCI-2026] |
| Info Transfer Rate | $ITR$ | $\infty$ | $> 5.0$ | bits/sec | [Ref: ISO-BCI-2026] |
| Latency | $\tau$ | $0$ | $< 50$ | ms | [Ref: ISO-BCI-2026] |
