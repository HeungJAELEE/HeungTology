---
lineage:
  dataset_reference: digital-signal-filtering
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] digital-signal-filtering]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for digital-signal-filtering
  object_type: Concept
  tier: 1
properties:
  compute_cost_max: 100 kOps/sample
  engine_specification: HDS-Gold V6.3.7
  group_delay_max: 2 ms
  memory_usage_max: 10 KB
  passband_ripple_max: 0.1 dB
  phase_linearity_target: '0'
  snr_improvement_range: 12-25 dB
  stopband_attenuation_min: 60 dB
  thd_max: 0.1%
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: digital-signal-filtering
  weight: 1.0
temporal:
...
# [Concept] Digital Signal Filtering
