...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] ess-round-trip-efficiency-and-self-discharge-rate-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for ess-round-trip-efficiency-and-self-discharge-rate-log-v2026
  object_type: Data
  tier: 1
properties:
  avg_auxiliary_load_impact: 5%
  current_resistance_loss_scaling: 2x current -> 4x resistance loss -> 2-3% RTE drop
  lead_acid_auxiliary_load_ratio: 1-2%
  lead_acid_pcs_efficiency: 95.0%
  lead_acid_rte_range: 70-85%
  lead_acid_self_discharge_rate: 5-10%
  lfp_auxiliary_load_ratio: 2-4%
  lfp_pcs_efficiency: 97.5%
  lfp_rte_range: 88-94%
  lfp_self_discharge_rate: 1-3%
  na_ion_auxiliary_load_ratio: 2-4%
  na_ion_pcs_efficiency: 97.0%
  na_ion_rte_range: 85-92%
  na_ion_self_discharge_rate: 3-6%
  nmc_auxiliary_load_ratio: 3-5%
  nmc_pcs_efficiency: 98.0%
  nmc_rte_range: 90-95%
  nmc_self_discharge_rate: 2-5%
  temp_discharge_acceleration_factor: 2x per 10C increase
  vrfb_auxiliary_load_ratio: 5-10%
  vrfb_pcs_efficiency: 96.0%
  vrfb_rte_range: 70-80%
  vrfb_self_discharge_rate: minimal
semantic:
  alternative_parents: []
...
# [Concept] Ess Round Trip Efficiency And Self Discharge Rate Log V2026
