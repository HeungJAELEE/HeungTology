...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] semiconductor-yield-defect-density-correlation-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for semiconductor-yield-defect-density-correlation-log-v2026
  object_type: Data
  tier: 1
properties:
  critical_defect_threshold_percentage: 50%_of_CD
  defect_density_unit: defects/cm^2
  hbm_defect_density_range: 0.10-0.15
  node_28nm_defect_density_max: '0.05'
  node_2nm_defect_density_range: 0.20-0.30
  node_3nm_defect_density_range: 0.10-0.20
  node_7nm_defect_density_range: 0.05-0.10
  yield_model_murphy: ((1 - e^(-A * D0)) / (A * D0))^2
  yield_model_poisson: e^(-A * D0)
  yield_unit: percentage
semantic:
  alternative_parents: []
...
# [Concept] Semiconductor Yield Defect Density Correlation Log V2026
