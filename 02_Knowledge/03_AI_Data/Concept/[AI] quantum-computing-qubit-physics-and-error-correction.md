...
object:
  description: '[AI] quantum-computing-qubit-physics-and-error-correction에 관한 고밀도
    지능 노드'
  object_type: Hardware
  tier: 1
properties:
  antigravity_vault_endpoint: Antigravity Vault
  avg_gate_fidelity_favg: 0.9945
  cryogenic_control_standard_endpoint: Cryogenic Control Logic Standard
  dephasing_time_t2: 50
  one_qubit_gate_fidelity_f1q: 0.999
  operating_temperature_tmk: 20
  qubit_coherence_log_endpoint: qubit-coherence-time-and-gate-fidelity-log-v2026
  relaxation_time_t1: 100
