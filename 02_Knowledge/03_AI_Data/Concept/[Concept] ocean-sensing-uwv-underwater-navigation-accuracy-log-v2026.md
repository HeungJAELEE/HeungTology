---
lineage:
  dataset_reference: ocean-sensing-uwv-underwater-navigation-accuracy-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] ocean-sensing-uwv-underwater-navigation-accuracy-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for ocean-sensing-uwv-underwater-navigation-accuracy-log-v2026
  object_type: Data
  tier: 1
properties:
  acoustic_snr_measured: 25.4dB
  acoustic_snr_target: '> 20.0dB'
  drift_rate_measured: 0.05m/h
  drift_rate_target: < 0.10m/h
  dvl_accuracy_measured: 99.1%
  dvl_accuracy_target: '> 98.5%'
  external_db_endpoint: desalination-water-purity-and-energy-consumption-log-v2026
  nav_error_rms_measured: 0.82m
  nav_error_rms_target: < 1.00m
  sound_velocity_nominal: 1524m/s
  uwv_depth_current: 4500m
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: ocean-sensing-uwv-underwater-navigation-accuracy-log-v2026
  weight: 0.5
temporal:
...
# [Concept] Ocean Sensing Uwv Underwater Navigation Accuracy Log V2026
