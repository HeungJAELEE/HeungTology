...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] blast-furnace-iron-purity-and-slag-composition-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for blast-furnace-iron-purity-and-slag-composition-log-v2026
  object_type: Data
  tier: 1
properties:
  blast_temp_measured: 1245 C
  blast_temp_target: 1200 +/- 50 C
  coke_rate_measured: 385 kg/ton
  coke_rate_target: < 400 kg/ton
  gibbs_free_energy_formula: delta_g = delta_h - t * delta_s
  iron_purity_measured: 94.5%
  iron_purity_target: '> 94.0%'
  mass_balance_formula: m_in = m_out + m_slag + m_dust
  recovery_rate_measured: 98.2%
  recovery_rate_target: '> 97.0%'
  silicon_content_measured: 0.45%
  silicon_content_target: < 0.60%
  slag_basicity_measured: '1.24'
  slag_basicity_target: 1.20 +/- 0.05
semantic:
  alternative_parents: []
...
# [Concept] Blast Furnace Iron Purity And Slag Composition Log V2026
