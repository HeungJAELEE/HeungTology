...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] financial-sentiment-analysis-sota-2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for financial-sentiment-analysis-sota-2026
  object_type: Algorithm
  tier: 1
properties:
  base_model_endpoint: yiyanghkust/finbert-tone
  end_to_end_latency: < 50 ms
  f1_score_tone: '> 92%'
  faiss_search_latency: < 5 ms
  llm_context_window: 128k tokens
  max_processing_rate: '> 1,000 msg/s'
  metaphor_detection_accuracy: '> 85%'
  quantization_format: INT4
  signal_validity_threshold: '0.85'
semantic:
  alternative_parents: []
...
# [Concept] Financial Sentiment Analysis Sota 2026
