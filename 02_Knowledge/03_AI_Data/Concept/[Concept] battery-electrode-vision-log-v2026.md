...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] battery-electrode-vision-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for battery-electrode-vision-log-v2026
  object_type: Data
  tier: 1
properties:
  classification_accuracy_limit: 95%
  defect_detection_size_limit: 10um
  defect_detection_size_standard: 20um
  false_negative_rate_limit: 0.05%
  false_positive_rate_limit: 2.0%
  lighting_uniformity_deviation_limit: 5%
  lighting_variation_limit: 3%
  line_speed_limit: 120m/min
  line_speed_standard: 80m/min
  marking_delay_limit: 10ms
semantic:
  alternative_parents: []
...
# [Concept] Battery Electrode Vision Log V2026
