...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] global-industrial-standards-iso-semi]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for global-industrial-standards-iso-semi
  object_type: Data
  tier: 1
properties:
  core_standards: SEMI S2, S8, E47.1, ISO 9001, 14001
  data_scope: SEMI, ISO, IATF
  interface_standard: SEMI E-Series
  local_skill_endpoint: industrial_intel_skill.py
  quality_audit_standard: IATF 16949
semantic:
  alternative_parents: []
...
# [Concept] Global Industrial Standards Iso Semi
