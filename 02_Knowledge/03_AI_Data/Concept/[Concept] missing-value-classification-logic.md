---
lineage:
  dataset_reference: missing-value-classification-logic
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] missing-value-classification-logic]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for missing-value-classification-logic
  object_type: Algorithm
  tier: 1
properties:
  critical_temp_threshold_celsius: 80
  littles_test_p_threshold: 0.05
  mice_max_iter: 10
  mice_random_state: 42
  missing_rate_threshold: 0.3
  sparsity_index_formula: 1 - (non_null / total)
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: missing-value-classification-logic
  weight: 0.7
temporal:
...
# [Concept] Missing Value Classification Logic
