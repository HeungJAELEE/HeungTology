---
lineage:
  dataset_reference: nano-lithography-mask-precision-and-defect-rate-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] nano-lithography-mask-precision-and-defect-rate-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for nano-lithography-mask-precision-and-defect-rate-log-v2026
  object_type: Data
  tier: 1
properties:
  cd_uniformity_measured: 0.65 nm
  cd_uniformity_target: < 1.00 nm
  cleanliness_index_measured: '99.98'
  cleanliness_index_target: '> 99.90'
  defect_density_measured: 0.0042 /cm^2
  defect_density_target: < 0.0050 /cm^2
  euv_wavelength: 13.5 nm
  meef_limit: '1.5'
  phase_error_measured: 0.12 deg
  phase_error_target: < 0.50 deg
  placement_error_measured: 0.78 nm
  placement_error_target: < 1.00 nm
  resolution_threshold: 10 nm
  transmission_efficiency_measured: 94.5%
  transmission_efficiency_target: '> 92.0%'
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: nano-lithography-mask-precision-and-defect-rate-log-v2026
  weight: 1.0
temporal:
...
# [Concept] Nano Lithography Mask Precision And Defect Rate Log V2026
