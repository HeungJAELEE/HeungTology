---
lineage:
  dataset_reference: jet-engine-thrust-and-turbine-inlet-temperature-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] jet-engine-thrust-and-turbine-inlet-temperature-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for jet-engine-thrust-and-turbine-inlet-temperature-log-v2026
  object_type: Data
  tier: 1
properties:
  audit_fidelity: MAXIMUM
  compressor_pressure_ratio_measured: '45.2'
  compressor_pressure_ratio_target: 40.0 - 50.0
  core_speed_measured: 12,450 RPM
  core_speed_target: 12,000 ± 500 RPM
  net_thrust_measured: 154.5 kN
  net_thrust_target: '> 150.0 kN'
  specific_fuel_consumption_measured: 12.4 kg/kN-h
  specific_fuel_consumption_target: < 13.0 kg/kN-h
  thermal_efficiency_measured: 48.2%
  thermal_efficiency_target: '> 45.0%'
  turbine_inlet_temperature_measured: 1,685 °C
  turbine_inlet_temperature_target: 1,650 ± 50 °C
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: jet-engine-thrust-and-turbine-inlet-temperature-log-v2026
  weight: 1.0
temporal:
...
# [Concept] Jet Engine Thrust And Turbine Inlet Temperature Log V2026
