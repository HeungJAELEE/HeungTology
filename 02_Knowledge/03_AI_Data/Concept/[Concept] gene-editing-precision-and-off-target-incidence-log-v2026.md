...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] gene-editing-precision-and-off-target-incidence-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for gene-editing-precision-and-off-target-incidence-log-v2026
  object_type: Data
  tier: 1
properties:
  binding_energy_threshold: 10 kcal/mol
  cell_toxicity: 4.5%
  editing_efficiency: 94.2%
  genomic_stability: 9.8/10
  hdr_success_rate: 82.0%
  mismatch_threshold: 3
  off_target_incidence: 0 cases
  off_target_probability_limit: 10^-6
  on_target_fidelity: 99.98%
  persistence: 100.0%
semantic:
  alternative_parents: []
...
# [Concept] Gene Editing Precision And Off Target Incidence Log V2026
