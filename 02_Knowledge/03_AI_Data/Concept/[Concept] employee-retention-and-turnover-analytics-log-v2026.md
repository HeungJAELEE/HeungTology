...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] employee-retention-and-turnover-analytics-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for employee-retention-and-turnover-analytics-log-v2026
  object_type: Data
  tier: 1
properties:
  avg_tenure_measured: 6.4 years
  avg_tenure_target: '> 5.0 years'
  knowledge_debt_senior_estimate: $1.2M
  pay_increase_attrition_coefficient: 10% increase -> 15% P_quit decrease
  promotion_rate_measured: 12.5%
  promotion_rate_target: '> 10.0%'
  regrettable_loss_measured: 2 cases
  regrettable_loss_target: 0 cases
  replacement_cost: $420K
  retention_rate_measured: 96.2%
  retention_rate_target: '> 95.0%'
  training_hours_measured: 84 hr/yr
  training_hours_target: '> 80 hr/yr'
  training_threshold_retention_boost: 100hr/yr -> 60% lower turnover
  turnover_rate_measured: 3.8%
  turnover_rate_target: < 5.0%
semantic:
  alternative_parents: []
...
# [Concept] Employee Retention And Turnover Analytics Log V2026
