...
properties:
  ...
  local_skill_endpoint: python 03_skills/antigravity_native/chemical_intelligence_skill.py
  model_support: gnn (graph neural networks)
  research_source: meta-ai-research
  source_reference: ocp-dataset-v2
semantic:
  alternative_parents: []
