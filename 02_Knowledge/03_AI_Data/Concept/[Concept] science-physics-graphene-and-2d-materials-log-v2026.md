...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] science-physics-graphene-and-2d-materials-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for science-physics-graphene-and-2d-materials-log-v2026
  object_type: Data
  tier: 1
properties:
  ballistic_transport_mobility_threshold: 1,000,000
  ballistic_transport_temp_threshold: 4K
  dirac_point_range: -10 ~ +10 V
  id_ig_ratio_range: 0.01 ~ 0.5
  mobility_range: 10,000 ~ 200,000 cm^2/Vs
  sheet_resistance_range: 100 ~ 1,000 ohm/sq
  single_layer_fwhm_threshold: 30nm
  single_layer_id_ig_threshold: '2.0'
  single_layer_probability: 99%
  tensile_strength_range: 100 ~ 130 GPa
  thermal_conductivity_range: 2,000 ~ 5,000 W/mK
  thickness_range: 0.34 ~ 3.4 nm
  transparency_range: 90 ~ 97.7%
semantic:
  alternative_parents: []
...
# [Concept] Science Physics Graphene And 2D Materials Log V2026
