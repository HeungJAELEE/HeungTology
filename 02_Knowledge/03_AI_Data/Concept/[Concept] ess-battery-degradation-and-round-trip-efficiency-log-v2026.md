...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] ess-battery-degradation-and-round-trip-efficiency-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for ess-battery-degradation-and-round-trip-efficiency-log-v2026
  object_type: Data
  tier: 1
properties:
  critical_dod_limit: 100%
  measured_cell_delta_v: 12.0mV
  measured_internal_resistance: 1.42mOhm
  measured_rt_efficiency: 92.5%
  measured_soh: 94.2%
  target_cell_delta_v: 50.0mV
  target_dod_range: 10-90%
  target_internal_resistance: 2.00mOhm
  target_rt_efficiency: 90.0%
  target_soh: 80.0%
  thermal_runaway_resistance_increase_threshold: 20%
  thermal_runaway_temp_threshold: 60C
semantic:
  alternative_parents: []
...
# [Concept] Ess Battery Degradation And Round Trip Efficiency Log V2026
