...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] industrial-scada-network-latency-and-packet-loss-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for industrial-scada-network-latency-and-packet-loss-log-v2026
  object_type: Data
  tier: 1
properties:
  availability_target: '> 99.99 %'
  error_rate_target: < 10^-8
  measured_availability: 99.999 %
  measured_error_rate: 1.2 x 10^-9
  measured_network_jitter: 0.8 ms
  measured_packet_loss: 0.0008 %
  measured_rtt_latency: 4.2 ms
  measured_throughput: 845.2 Mbps
  network_jitter_target: < 1.0 ms
  packet_loss_target: < 0.001 %
  rtt_latency_target: < 5.0 ms
  throughput_target: '> 800.0 Mbps'
semantic:
  alternative_parents: []
...
# [Concept] Industrial Scada Network Latency And Packet Loss Log V2026
