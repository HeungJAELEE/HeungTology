---
lineage:
  dataset_reference: smart-grid-load-balancing-and-frequency-stability-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] smart-grid-load-balancing-and-frequency-stability-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for smart-grid-load-balancing-and-frequency-stability-log-v2026
  object_type: Data
  tier: 1
properties:
  ace_control_error_threshold: 50.0 MW
  ess_response_time_threshold: 0.50 s
  freq_deviation_threshold: 0.10 Hz
  grid_frequency_target: 60.0 +/- 0.1 Hz
  load_forecast_error_threshold: 3.0 %
  measured_ace: 12.5 MW
  measured_ess_response: 0.25 s
  measured_freq_deviation: 0.02 Hz
  measured_grid_frequency: 60.02 Hz
  measured_load_forecast_error: 1.42 %
  measured_renewable_penetration: 34.5 %
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: smart-grid-load-balancing-and-frequency-stability-log-v2026
  weight: 0.9
temporal:
...
# [Concept] Smart Grid Load Balancing And Frequency Stability Log V2026
