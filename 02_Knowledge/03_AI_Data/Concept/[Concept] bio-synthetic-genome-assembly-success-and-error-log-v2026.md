---
lineage:
  dataset_reference: bio-synthetic-genome-assembly-success-and-error-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] bio-synthetic-genome-assembly-success-and-error-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for bio-synthetic-genome-assembly-success-and-error-log-v2026
  object_type: Data
  tier: 1
properties:
  gc_content_hairpin_threshold: 0.7
  junction_success_probability_p: 0.95
  tm_calculation_formula: 64.9 + (41 * (yG + zC - 16.4)) / (wA + xT + yG + zC)
  tm_deviation_threshold_celsius: 2.0
  total_success_probability_formula: p^(N-1)
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: bio-synthetic-genome-assembly-success-and-error-log-v2026
  weight: 1.0
temporal:
...
# [Concept] Bio Synthetic Genome Assembly Success And Error Log V2026
