...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] Tensor-Core-Arithmetic-Hardware]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for Tensor-Core-Arithmetic-Hardware
  object_type: Hardware
  tier: 1
properties:
  accumulation_precision: FP32
  fp8_dense_tflops: '>= 10,000'
  mma_operation_logic: D = A * B + C
  structured_sparsity_ratio: '2:4'
  supported_formats: FP8, BF16, TF32, INT8
...
# [Concept] Tensor Core Arithmetic Hardware
