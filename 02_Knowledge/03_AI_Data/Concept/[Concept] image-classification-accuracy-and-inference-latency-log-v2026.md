---
lineage:
  dataset_reference: image-classification-accuracy-and-inference-latency-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] image-classification-accuracy-and-inference-latency-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for image-classification-accuracy-and-inference-latency-log-v2026
  object_type: Data
  tier: 1
properties:
  coral_edge_tpu_int8_inference_latency_ms: 4.5
  coral_edge_tpu_int8_top1_accuracy: 96.5%
  jetson_orin_nano_fp16_inference_latency_ms: 8.2
  jetson_orin_nano_fp16_top1_accuracy: 98.5%
  max_inference_jitter_threshold_ms: 5
  max_quantization_accuracy_loss_threshold: 0.5%
  min_quantization_speedup_factor: 4
  rtx_4060_fp32_inference_latency_ms: 12.5
  rtx_4060_fp32_top1_accuracy: 99.2%
  rtx_4060_int8_inference_latency_ms: 2.8
  rtx_4060_int8_top1_accuracy: 98.9%
  tesla_h100_fp32_inference_latency_ms: 45.0
  tesla_h100_fp32_top1_accuracy: 99.8%
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: image-classification-accuracy-and-inference-latency-log-v2026
  weight: 0.7
temporal:
...
# [Concept] Image Classification Accuracy And Inference Latency Log V2026
