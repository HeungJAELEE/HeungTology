---
lineage:
  dataset_reference: industry-hts-magnet-critical-current-and-quench-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] industry-hts-magnet-critical-current-and-quench-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for industry-hts-magnet-critical-current-and-quench-log-v2026
  object_type: Data
  tier: 1
properties:
  coil_temperature_range_kelvin: 20-77
  critical_current_range_amps: 250-1500
  energy_margin_min_jcc: 5.0
  ic_limit_default: 1200.0
  insulation_resistance_min_gohm: 1.0
  magnetic_field_range_tesla: 3.5-15.0
  quench_threshold_mv_default: 100.0
  quench_velocity_range_ms: 0.01-1.0
  stored_energy_range_kj: 10-500
  voltage_threshold_mv: 100
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: industry-hts-magnet-critical-current-and-quench-log-v2026
  weight: 0.5
temporal:
...
# [Concept] Industry Hts Magnet Critical Current And Quench Log V2026
