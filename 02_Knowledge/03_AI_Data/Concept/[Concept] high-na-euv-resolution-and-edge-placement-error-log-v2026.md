---
lineage:
  dataset_reference: high-na-euv-resolution-and-edge-placement-error-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] high-na-euv-resolution-and-edge-placement-error-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for high-na-euv-resolution-and-edge-placement-error-log-v2026
  object_type: Data
  tier: 1
properties:
  anamorphic_ratio_x: 4
  anamorphic_ratio_y: 8
  dose_compensation_increase: 0.2
  high_na: 0.55
  high_na_cdu_3sigma_nm: 0.4
  high_na_epe_total_budget_nm: 1.8
  high_na_focus_window_nm: 45
  high_na_opc_residual_nm: 0.2
  high_na_overlay_global_nm: 0.6
  high_na_resolution_limit_nm: 8.0
  high_na_stochastic_error_nm: 0.4
  lambda_nm: 13.5
  low_na: 0.33
  low_na_cdu_3sigma_nm: 1.0
  low_na_epe_total_budget_nm: 3.5
  low_na_focus_window_nm: 120
  low_na_opc_residual_nm: 0.5
  low_na_overlay_global_nm: 1.2
  low_na_resolution_limit_nm: 13.5
  low_na_stochastic_error_nm: 0.8
  stochastic_contribution_threshold: 0.3
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: high-na-euv-resolution-and-edge-placement-error-log-v2026
  weight: 0.9
temporal:
...
# [Concept] High Na Euv Resolution And Edge Placement Error Log V2026
