---
lineage:
  dataset_reference: bci-neural-bandwidth-and-decoding-fidelity-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] bci-neural-bandwidth-and-decoding-fidelity-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for bci-neural-bandwidth-and-decoding-fidelity-log-v2026
  object_type: Data
  tier: 1
properties:
  decoding_accuracy: 99.7%
  decoding_accuracy_threshold: '> 95.0%'
  decoding_drift_correction_time: 0.5 ms
  electrode_density: 1024 channels
  interference_immunity: '0.98'
  interference_immunity_threshold: '> 0.90'
  itr: 12.4 bits/s
  itr_threshold: '> 5.0 bits/s'
  latency_variance: 0.45 ms
  latency_variance_threshold: < 1.0 ms
  neural_bandwidth: 520 Mbps
  neural_bandwidth_threshold: '> 100 Mbps'
  power_stability: 3.30 +/- 0.01 V
  power_stability_threshold: +/- 0.05 V
  signal_snr: 18.5 dB
  signal_snr_threshold: '> 12.0 dB'
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: bci-neural-bandwidth-and-decoding-fidelity-log-v2026
  weight: 0.7
temporal:
...
# [Concept] Bci Neural Bandwidth And Decoding Fidelity Log V2026
