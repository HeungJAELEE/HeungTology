...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] synthetic-biology-protein-design-ai]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for synthetic-biology-protein-design-ai
  object_type: Algorithm
  tier: 1
properties:
  backbone_rmsd: 0.86
  compute_log_source: protein-folding-simulation-accuracy-and-compute-log-v2026
  de_novo_binding_affinity_kd: 12.4
  genetic_circuit_noise_suppression_ratio: 0.88
  ligand_binding_success_rate: 93.15
  sequence_recovery_rate: 86.42
  wet_lab_synthesis_cycle_dbt: 21.8
semantic:
  alternative_parents: []
...
# [Concept] Synthetic Biology Protein Design Ai
