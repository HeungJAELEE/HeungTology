...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] CBM-Condition-Based-Maintenance-Logic]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for CBM-Condition-Based-Maintenance-Logic
  object_type: Algorithm
  tier: 1
properties:
  acoustic_emission_frequency_range: 20kHz-100kHz
  actual_maintenance_cost_reduction: 25-35%
  actual_rul_error_rate: 12-18%
  critical_rul_estimate: 48h
  field_failure_detection_lead_time: 0.75 * (P -> F)
  hi_critical_threshold: 60.0
  hi_degradation_threshold: 85.0
  hi_thermal_weight: 0.3
  hi_vibration_weight: 0.7
  theoretical_maintenance_cost_reduction: 45%
  theoretical_rul_error_rate: 2%
semantic:
  alternative_parents: []
...
# [Concept] Cbm Condition Based Maintenance Logic
