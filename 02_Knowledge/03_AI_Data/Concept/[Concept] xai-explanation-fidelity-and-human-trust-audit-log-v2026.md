---
lineage:
  dataset_reference: xai-explanation-fidelity-and-human-trust-audit-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] xai-explanation-fidelity-and-human-trust-audit-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for xai-explanation-fidelity-and-human-trust-audit-log-v2026
  object_type: Data
  tier: 1
properties:
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: xai-explanation-fidelity-and-human-trust-audit-log-v2026
  weight: 0.7
temporal:
...
# [Concept] Xai Explanation Fidelity And Human Trust Audit Log V2026
...
| :--- | :--- | :--- | :--- |
| **Expl. Fidelity** | 1.000 | 0.985 [데이터 부재] | Accuracy of explanation vs internal logic |
| **Trust Index** | 0.500 | > 0.450 [데이터 부재] | Post-XAI user confidence delta |
| **Decision Align.** | 1.000 | 0.992 [데이터 부재] | Consistency between reasoning and result |
| **Compreh. Lat.** | 0.000 | < 500 ms [데이터 부재] | Cognitive processing delay for human |
| **Counterfac. Con.**| 1.000 | 0.978 [데이터 부재] | Logic stability under perturbation |
| **Logic Transp.** | 1.000 | 0.920 [데이터 부재] | Neural path visibility coefficient |
