...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] mri-ct-imaging-resolution-and-diagnostic-accuracy-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for mri-ct-imaging-resolution-and-diagnostic-accuracy-log-v2026
  object_type: Data
  tier: 1
properties:
  acquisition_time_measured: 12.5min
  acquisition_time_target: <15.0min
  audit_fidelity: MAXIMUM
  radiation_dose_ct_measured: 2.1mSv
  radiation_dose_ct_target: <3.0mSv
  sensitivity_measured: 96.4%
  sensitivity_target: '>95.0%'
  snr_measured: 45.2dB
  snr_target: '>40.0dB'
  spatial_resolution_measured: 0.48mm
  spatial_resolution_target: <0.50mm
  specificity_measured: 94.5%
  specificity_target: '>94.0%'
semantic:
  alternative_parents: []
...
# [Concept] Mri Ct Imaging Resolution And Diagnostic Accuracy Log V2026
