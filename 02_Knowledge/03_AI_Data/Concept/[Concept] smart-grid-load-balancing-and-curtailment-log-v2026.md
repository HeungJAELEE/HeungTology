---
lineage:
  dataset_reference: smart-grid-load-balancing-and-curtailment-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] smart-grid-load-balancing-and-curtailment-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for smart-grid-load-balancing-and-curtailment-log-v2026
  object_type: Data
  tier: 1
properties:
  balancing_efficiency_measured: 98.4%
  balancing_efficiency_target: '> 98.0%'
  curtailment_measured: 1.25 MWh
  curtailment_target: < 2.0 MWh
  grid_frequency_measured: 60.02 Hz
  grid_frequency_target: 60.0 +/- 0.1 Hz
  peak_reduction_measured: 15.8%
  peak_reduction_target: '> 15.0%'
  solar_irradiance_variation_threshold: 50%/sec
  voltage_index_measured: '0.992'
  voltage_index_target: 0.95 ~ 1.05
  vpp_response_measured: 450 ms
  vpp_response_target: < 1000 ms
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: smart-grid-load-balancing-and-curtailment-log-v2026
  weight: 0.5
temporal:
...
# [Concept] Smart Grid Load Balancing And Curtailment Log V2026
