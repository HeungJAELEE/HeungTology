...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] road-bridge-structural-health-and-load-test-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for road-bridge-structural-health-and-load-test-log-v2026
  object_type: Data
  tier: 1
properties:
  capacity_index_measured: '1.15'
  capacity_index_target_min: '1.00'
  corrosion_rate_measured: 0.002 mm/yr
  corrosion_rate_target_max: 0.005 mm/yr
  damping_ratio_measured: 2.1%
  damping_ratio_target_min: 2.0%
  frequency_error_tolerance: 0.1 Hz
  frequency_maintenance_threshold: '0.95'
  max_deflection_measured: 124.5 mm
  max_deflection_target_max: 150.0 mm
  natural_frequency_measured: 2.45 Hz
  natural_frequency_target_min: 2.40 Hz
  strain_level_measured: 420 microepsilon
  strain_level_target_max: 500 microepsilon
semantic:
  alternative_parents: []
...
# [Concept] Road Bridge Structural Health And Load Test Log V2026
