---
lineage:
  dataset_reference: oceanic-ph-level-and-carbon-absorption-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] oceanic-ph-level-and-carbon-absorption-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for oceanic-ph-level-and-carbon-absorption-log-v2026
  object_type: Data
  tier: 1
properties:
  carbon_flux: 2.45 mol/m2yr
  dic_carbon: 2045 umol/kg
  min_annual_carbon_absorption: 2.5 PgC
  min_ph_threshold: '8.05'
  ocean_ph: '8.08'
  pco2_ocean: 412.5 uatm
  sea_surface_temp: 18.5 C
  target_carbon_flux: '> 2.0 mol/m2yr'
  target_dic_carbon: '> 2000 umol/kg'
  target_ocean_ph: 8.1 +/- 0.05
  target_sea_surface_temp: 18.0 +/- 1.0 C
  target_total_alkalinity: '> 2300 umol/kg'
  temp_carbon_absorption_loss: 0.1 PgC per 1 degree C
  temp_solubility_reduction_rate: 4% per 1 degree C
  total_alkalinity: 2350 umol/kg
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: oceanic-ph-level-and-carbon-absorption-log-v2026
  weight: 0.8
temporal:
...
# [Concept] Oceanic Ph Level And Carbon Absorption Log V2026
