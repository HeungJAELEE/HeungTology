...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] hydrogen-fuel-cell-stack-voltage-and-efficiency-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for hydrogen-fuel-cell-stack-voltage-and-efficiency-log-v2026
  object_type: Data
  tier: 1
properties:
  cell_voltage_min_threshold: 0.7 V
  coolant_temp_measured: 75.2 C
  coolant_temp_target: 70-80 C
  current_density_measured: 1.2 A/cm^2
  current_density_target: '> 1.0 A/cm^2'
  energy_efficiency_measured: 62.4%
  energy_efficiency_target: '> 60.0%'
  external_oee_log_endpoint: manufacturing-mes-equipment-oee-log-v2026
  h2_consumption_measured: 6.8 kg/h
  h2_consumption_target: < 7.5 kg/h
  power_output_measured: 95.5 kW
  power_output_target: '> 90.0 kW'
  stack_voltage_measured: 350 V
  stack_voltage_target: 320-380 V
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 03_AI_Data]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: class_assignment
  object: Concept
...
# [Concept] Hydrogen Fuel Cell Stack Voltage And Efficiency Log V2026
