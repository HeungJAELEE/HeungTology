...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] hydrogen-fuel-cell-energy-density-and-degradation-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for hydrogen-fuel-cell-energy-density-and-degradation-log-v2026
  object_type: Data
  tier: 1
properties:
  cell_voltage_target_2a_cm2: '> 0.72 V'
  cold_start_time_target: < 10 sec
  degradation_rate_target: < 1.0 uV/hr
  ecsa_target: '> 80 m^2/g'
  flooding_recovery_rate: 15%
  h2_crossover_target: < 2.0 mA/cm^2
  lifetime_target_hours: 30000
  peak_power_density_target: '> 4.0 W/cm^2'
  pt_catalyst_loading_target: < 0.05 g/kW
  stack_efficiency_target: '> 65%'
  voltage_drop_limit_10k_hours: 10%
semantic:
  alternative_parents: []
...
# [Concept] Hydrogen Fuel Cell Energy Density And Degradation Log V2026
