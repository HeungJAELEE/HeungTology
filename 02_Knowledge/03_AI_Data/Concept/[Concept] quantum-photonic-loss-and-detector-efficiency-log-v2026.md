...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] quantum-photonic-loss-and-detector-efficiency-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for quantum-photonic-loss-and-detector-efficiency-log-v2026
  object_type: Data
  tier: 1
properties:
  attenuation_fluctuation_threshold: 0.1 dB
  dark_count_theoretical: < 5 cps
  dark_count_verified: 20.4 cps
  detector_efficiency_theoretical: 98.5%
  detector_efficiency_verified: 91.8%
  loss_rate_l_example: 0.1
  photon_system_size_n: 50
  success_probability_formula: (1-L)^N
  success_probability_p_example: 0.0051
  thermal_fluctuation_threshold: 2.5 K
  waveguide_loss_theoretical: 0.05 dB/cm
  waveguide_loss_verified: 0.128 dB/cm
semantic:
  alternative_parents: []
...
# [Concept] Quantum Photonic Loss And Detector Efficiency Log V2026
