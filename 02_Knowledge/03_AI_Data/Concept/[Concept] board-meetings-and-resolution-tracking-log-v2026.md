---
lineage:
  dataset_reference: board-meetings-and-resolution-tracking-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] board-meetings-and-resolution-tracking-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for board-meetings-and-resolution-tracking-log-v2026
  object_type: Data
  tier: 1
properties:
  decision_depth_index_formula: sum(T_i * W_i)
  execution_lag_formula: t_c - t_0
  information_package_latency_threshold_days: 7
  quorum_compliance_rate_target_percent: 100
  strategic_agility_decline_per_month_lag: 0.15
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: board-meetings-and-resolution-tracking-log-v2026
  weight: 0.9
temporal:
...
# [Concept] Board Meetings And Resolution Tracking Log V2026
