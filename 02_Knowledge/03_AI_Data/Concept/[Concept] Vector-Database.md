...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] Vector-Database]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for Vector-Database
  object_type: Concept
  tier: 1
properties:
  engine_version: HDS-Gold V6.3.7
  filtering_strategy: pre-filtering
  hnsw_search_complexity: O(log N)
  indexing_speed_threshold: 5000 vectors/s
  max_dimension_support: '1536'
  qps_threshold: '1000'
  quantization_ratio_range: 4:1-16:1
  recall_rate_threshold: 95%
  scalability_limit: billions
  search_latency_threshold: 10ms
semantic:
  alternative_parents: []
