---
lineage:
  dataset_reference: smart-factory-iiot-sensor-latency-and-data-packet-loss-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] smart-factory-iiot-sensor-latency-and-data-packet-loss-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for smart-factory-iiot-sensor-latency-and-data-packet-loss-log-v2026
  object_type: Data
  tier: 1
properties:
  edge_processing_time_measured: 2.5ms
  edge_processing_time_target: <5.0ms
  max_ber_threshold: 10^-9
  min_snr_threshold: 30dB
  network_jitter_measured: 45us
  network_jitter_target: <100us
  network_latency_measured: 0.85ms
  network_latency_target: <1.0ms
  packet_loss_rate_measured: 0.0002%
  packet_loss_rate_target: <0.001%
  sync_accuracy_measured: 100ns
  sync_accuracy_target: <500ns
  throughput_measured: 850Mbps
  throughput_target: '>500Mbps'
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: smart-factory-iiot-sensor-latency-and-data-packet-loss-log-v2026
  weight: 0.7
temporal:
...
# [Concept] Smart Factory Iiot Sensor Latency And Data Packet Loss Log V2026
