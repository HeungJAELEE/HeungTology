...
object:
  description: '[AI] mcp-opencrab-functional-blueprint-and-dataset-list에 관한 고밀도 지능
    노드'
  object_type: Data
  tier: 1
properties:
  battery_cycle_log_source: NASA/MIT
  chemical_structure_endpoints: ChEMBL/PubChem API
  discovery_script: v637_quarantine_scanner.py
  graph_mapping_skill: graphify-skill.md
  graph_topology_engine: Neo4j
  korean_instruction_set: KoAlpaca
  nemotron_model_version: Nemotron-3 8B
  semiconductor_material_source: NIST/Materials Project
semantic:
  alternative_parents: []
