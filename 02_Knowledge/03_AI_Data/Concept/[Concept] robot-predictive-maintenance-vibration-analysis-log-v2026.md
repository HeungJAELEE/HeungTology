---
lineage:
  dataset_reference: robot-predictive-maintenance-vibration-analysis-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] robot-predictive-maintenance-vibration-analysis-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for robot-predictive-maintenance-vibration-analysis-log-v2026
  object_type: Data
  tier: 1
properties:
  analysis_window: 1.0 sec
  bearing_defect_kurtosis: '> 5.5'
  bearing_defect_peak_g: 3.5-6.0
  crest_factor_threshold: '> 5'
  gear_chipping_kurtosis: '> 7.0'
  gear_chipping_peak_g: 8.0-15.0
  lubrication_fail_freq_threshold: '> 5 kHz'
  lubrication_fail_kurtosis: 4.0-5.0
  lubrication_fail_peak_g: 0.8-1.5
  misalignment_kurtosis: 3.5-4.5
  misalignment_peak_g: 1.2-2.5
  normal_state_kurtosis: '3.0'
  normal_state_peak_g: < 0.5
  resonance_speed_reduction_rate: 10%
  rms_velocity_range: 1.0-4.5 mm/s
  rul_prediction_error_threshold: < 15%
  sampling_rate_min: 25.6 kHz
semantic:
  alternative_parents: []
  is_instance_of: '[[ [MOC] 03_AI_Data]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: data_schema_definition
  object: Concept
  predicate: auto_mapped
  subject: robot-predictive-maintenance-vibration-analysis-log-v2026
  weight: 0.9
temporal:
...
# [Concept] Robot Predictive Maintenance Vibration Analysis Log V2026
