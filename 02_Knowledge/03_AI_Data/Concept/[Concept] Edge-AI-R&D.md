...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] Edge-AI-R&D]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for Edge-AI-R&D
  object_type: Concept
  tier: 1
properties:
  inference_latency_max: 10ms
  inference_throughput_min: 30FPS
  memory_footprint_max: 100MB
  optimization_toolkits: OpenVINO, TensorRT
  optimizer_version: HDS-Gold V6.3.7
  power_consumption_max: 500mW
  pruning_ratio_range: 50-90%
  qat_accuracy_loss_max: 1%
  uplink_bandwidth_reduction_min: 95%
  weight_precision_bits: 4-8
semantic:
  alternative_parents: []
