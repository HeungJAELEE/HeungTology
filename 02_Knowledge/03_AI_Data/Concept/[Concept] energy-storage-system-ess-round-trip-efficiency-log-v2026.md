...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] energy-storage-system-ess-round-trip-efficiency-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for energy-storage-system-ess-round-trip-efficiency-log-v2026
  object_type: Data
  tier: 1
properties:
  battery_intrinsic_efficiency: 95%
  c_rate_heat_loss_multiplier_1c_vs_02c: 5x
  cooling_power_increase_at_1c: 30%
  dod_integrity_range: 80-95%
  flow_battery_rte_range: 72.0-78.0%
  li_ion_rte_range: 88.0-92.5%
  liquid_air_rte_range: 50.0-60.0%
  na_ion_rte_range: 85.0-88.0%
  parasitic_load_ratio: 3-5%
  ri_increase_efficiency_drop_ratio: 2x_ri_to_4pct_drop
...
# [Concept] Energy Storage System Ess Round Trip Efficiency Log V2026
