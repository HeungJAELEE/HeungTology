---
lineage:
  dataset_reference: work-in-progress-wip-and-production-cycle-time-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] work-in-progress-wip-and-production-cycle-time-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for work-in-progress-wip-and-production-cycle-time-log-v2026
  object_type: Data
  tier: 1
properties:
  assembly_takt_time_s: 50
  little_law_formula: L=lambda*W
  packaging_takt_time_s: 50
  queuing_model: M/M/1
  smt_line_takt_time_s: 0.5
  takt_time_formula: Net Available Time / Customer Demand Quantity
  testing_takt_time_s: 50
  utilization_threshold_rho: 0.9
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: work-in-progress-wip-and-production-cycle-time-log-v2026
  weight: 1.0
temporal:
...
# [Concept] Work In Progress Wip And Production Cycle Time Log V2026
