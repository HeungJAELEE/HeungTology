---
lineage:
  dataset_reference: litigation-and-legal-dispute-tracking-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] litigation-and-legal-dispute-tracking-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for litigation-and-legal-dispute-tracking-log-v2026
  object_type: Data
  tier: 1
properties:
  contract_provision_m: 1.6
  contract_win_rate: 0.92
  expected_legal_loss_formula: P * L + C
  ip_patent_provision_m: 7.5
  ip_patent_win_rate: 0.85
  labor_provision_m: 1.2
  labor_win_rate: 0.75
  product_liability_provision_m: 2.0
  product_liability_win_rate: 0.8
  regulatory_provision_m: 6.0
  regulatory_win_rate: 0.6
  settlement_threshold_win_rate: 0.7
  target_win_rate: 0.8
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: litigation-and-legal-dispute-tracking-log-v2026
  weight: 1.0
temporal:
...
# [Concept] Litigation And Legal Dispute Tracking Log V2026
