---
lineage:
  dataset_reference: interferometer-wafer-flatness-measurement-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] interferometer-wafer-flatness-measurement-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for interferometer-wafer-flatness-measurement-log-v2026
  object_type: Data
  tier: 1
properties:
  cd_variance_increase_pct: '15'
  grazing_effective_wavelength_target_um: '10'
  he_ne_laser_wavelength_nm: '632.8'
  measurement_range_extension_factor: '20'
  phase_shift_resolution: lambda/1000
  spatial_resolution_um: < 50
  tir_range_um: 0.1-2.0
  tir_threshold_um: '0.3'
semantic:
  alternative_parents: []
  is_instance_of: '[[ [MOC] 03_AI_Data]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: initial_knowledge_mapping
  object: Concept
  predicate: auto_mapped
  subject: interferometer-wafer-flatness-measurement-log-v2026
  weight: 0.9
temporal:
...
# [Concept] Interferometer Wafer Flatness Measurement Log V2026

## 1. [왜 배우는가? (Why: The Geometry of Perfect Plane)]]
반도체 미세 공정에서 노광 장비의 초점 심도(Depth of Focus)는 수백 나노미터에 불과합니다. 만약 $300\ \text{mm}$ 웨이퍼 전체의 평탄도가 확보되지 않는다면, 웨이퍼의 중심은 초점이 맞지만 가장자리는 흐릿해져 패턴 형성이 불가능해집니다. **간섭계 웨이퍼 평탄도 실측 로그**는 빛의 파동 간섭 현상을 이용하여 웨이퍼 전면의 굴곡을 등고선처럼 시각화하고 기록한 '광학적 평면 품질 성적표'입니다. 
