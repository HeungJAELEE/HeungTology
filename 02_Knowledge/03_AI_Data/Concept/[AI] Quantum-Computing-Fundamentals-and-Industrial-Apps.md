...
lineage:
  ...
  original_hash: e7681a90d8f7d82548684ab97bbce2f3685b669692f3ec05dd1d89a7513676d8
metadata:
  date: '2026-05-16'
  domain: 03_AI_Data
...
object:
  description: '[AI] Quantum-Computing-Fundamentals-and-Industrial-Apps에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  classical_baseline_time_years: 10^4
  coherence_time_t2_theoretical: infinity
  coherence_time_t2_verified_s: 10^-6 ~ 10^-3
  gate_error_rate_theoretical: < 10^-15
  gate_error_rate_verified: 10^-3
  quantum_measurement_shots: '1024'
  quantum_supremacy_benchmark_time_s: '200'
  qubit_scaling_theoretical: 10^6
  qubit_scaling_verified: 50 ~ 1000
semantic:
  alternative_parents: []
