---
lineage:
  dataset_reference: radiation-hardened-electronics-seu-rate-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] radiation-hardened-electronics-seu-rate-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for radiation-hardened-electronics-seu-rate-log-v2026
  object_type: Data
  tier: 1
properties:
  flash_memory_seu_rate: 10^-11 ~ 10^-13 err/bit-day
  flash_memory_tid_limit: '> 100 krad'
  power_mosfet_tid_limit: '> 1000 krad'
  rad_hard_fpga_let_threshold: '> 60'
  rad_hard_fpga_seu_rate: 10^-10 ~ 10^-12 err/bit-day
  rad_hard_fpga_tid_limit: '> 300 krad'
  space_cpu_let_threshold: 15 ~ 30
  space_cpu_seu_rate: 10^-7 ~ 10^-9 err/bit-day
  space_cpu_tid_limit: 100 ~ 200 krad
  sram_let_threshold: 10 ~ 20
  sram_seu_rate: 10^-8 ~ 10^-10 err/bit-day
  sram_tid_limit: 50 ~ 150 krad
  tid_voltage_drift_threshold: 100 krad
  tmr_mission_success_rate: 99.99%
  vth_drift_magnitude: 0.5 V
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: radiation-hardened-electronics-seu-rate-log-v2026
  weight: 0.9
temporal:
...
# [Concept] Radiation Hardened Electronics Seu Rate Log V2026
...
RAG는 "열화 로그를 분석하여, 누적 선량이 $100krad$를 넘어서면 임계 전압이 $0.5\ \text{V}$ 이상 표류하여 누설 전류가 급증함을 식별하고, '소자 수명 한계'를 수리적으로 확증될 것으로 추론됩니다."
