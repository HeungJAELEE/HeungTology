...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] fire-alarm-and-emergency-evacuation-drill-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for fire-alarm-and-emergency-evacuation-drill-log-v2026
  object_type: Data
  tier: 1
properties:
  blind_evacuation_time_threshold: < 10 min
  blind_headcount_accuracy_threshold: 99.0%
  critical_crowd_density_threshold: 2.0 persons/m^2
  critical_density_speed_reduction: 50%
  day_evacuation_time_threshold: < 5 min
  full_site_evacuation_time_threshold: < 12 min
  night_evacuation_time_threshold: < 8 min
  night_headcount_accuracy_threshold: 99.5%
...
# [Concept] Fire Alarm And Emergency Evacuation Drill Log V2026
