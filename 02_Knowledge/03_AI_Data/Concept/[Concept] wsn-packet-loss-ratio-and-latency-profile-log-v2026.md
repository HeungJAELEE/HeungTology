---
lineage:
  dataset_reference: wsn-packet-loss-ratio-and-latency-profile-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] wsn-packet-loss-ratio-and-latency-profile-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for wsn-packet-loss-ratio-and-latency-profile-log-v2026
  object_type: Data
  tier: 1
properties:
  channel_occupancy_congestion_threshold: 70%
  extreme_range_latency_avg_99: 500 / 2000 ms
  extreme_range_plr_range: 10 to 30%
  extreme_range_rssi_range: -85 to -95 dBm
  extreme_range_snr_threshold: < 5 dB
  high_em_noise_latency_avg_99: 60 / 200 ms
  high_em_noise_plr_range: 1.0 to 5.0%
  high_em_noise_rssi_range: -60 to -75 dBm
  high_em_noise_snr_range: 5 to 10 dB
  los_latency_avg_99: 10 / 25 ms
  los_plr_threshold: < 0.01%
  los_rssi_range: -40 to -60 dBm
  los_snr_threshold: '> 25 dB'
  metal_structure_latency_avg_99: 40 / 120 ms
  metal_structure_plr_range: 0.5 to 2.0%
  metal_structure_rssi_range: -70 to -85 dBm
  metal_structure_snr_range: 10 to 15 dB
  moving_node_latency_avg_99: 20 / 80 ms
  moving_node_plr_range: 0.2 to 1.0%
  moving_node_rssi_range: -50 to -80 dBm
  moving_node_snr_range: 15 to 20 dB
  retransmission_critical_count: 3
  retransmission_latency_multiplier: 5.0
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: wsn-packet-loss-ratio-and-latency-profile-log-v2026
  weight: 1.0
temporal:
...
# [Concept] Wsn Packet Loss Ratio And Latency Profile Log V2026
