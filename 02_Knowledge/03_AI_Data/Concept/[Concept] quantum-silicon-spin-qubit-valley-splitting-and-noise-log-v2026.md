...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] quantum-silicon-spin-qubit-valley-splitting-and-noise-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for quantum-silicon-spin-qubit-valley-splitting-and-noise-log-v2026
  object_type: Data
  tier: 1
properties:
  charge_noise_theoretical_limit: 0.5 uV/sqrt(Hz)
  charge_noise_verified_avg: 1.26 uV/sqrt(Hz)
  coherence_reduction_threshold_charge_noise: 1.0 uV/sqrt(Hz)
  coherence_time_theoretical_limit: 100 ms
  coherence_time_verified_avg: 18.64 ms
  thermal_instability_threshold_valley_splitting: 0.5 meV
  valley_splitting_theoretical_limit: 1.0 meV
  valley_splitting_verified_avg: 0.544 meV
semantic:
  alternative_parents: []
...
# [Concept] Quantum Silicon Spin Qubit Valley Splitting And Noise Log V2026
