---
lineage:
  dataset_reference: quantum-key-distribution-qkd-quantum-bit-error-rate-qber-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] quantum-key-distribution-qkd-quantum-bit-error-rate-qber-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for quantum-key-distribution-qkd-quantum-bit-error-rate-qber-log-v2026
  object_type: Data
  tier: 1
properties:
  bb84_qber_range: 1.0-3.0%
  bb84_skr_range: 100k-1M bps
  bb84_transmission_distance: ~100km
  cv_qkd_qber_range: 5.0-8.0%
  cv_qkd_skr_min: 10M bps
  cv_qkd_transmission_distance: ~50km
  mdi_qkd_qber_range: 2.0-4.0%
  mdi_qkd_skr_range: 10k-100k bps
  mdi_qkd_transmission_distance: ~400km
  mean_photon_number_range: 0.1-0.5
  qber_model_equation: e_detector + e_optical + e_eavesdrop
  qber_security_threshold: 11%
  satellite_qkd_qber_range: 5.0-10.0%
  satellite_qkd_skr_range: 1k-10k bps
  satellite_qkd_transmission_distance: 1200km+
  sifting_efficiency_approx: '0.5'
  tf_qkd_qber_range: 3.0-5.0%
  tf_qkd_skr_range: 100-1k bps
  tf_qkd_transmission_distance: ~500km
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: quantum-key-distribution-qkd-quantum-bit-error-rate-qber-log-v2026
  weight: 0.9
temporal:
...
# [Concept] Quantum Key Distribution Qkd Quantum Bit Error Rate Qber Log V2026
