---
lineage:
  dataset_reference: DPU-Infrastructure-Accelerator
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] DPU-Infrastructure-Accelerator]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for DPU-Infrastructure-Accelerator
  object_type: Hardware
  tier: 1
properties:
  arm_cores: 16x_A78AE
  cpu_savings_percentage: 25-35%
  ipsec_tls_line_rate_gbps: '400'
  l_rdma_formula: L_prop + L_fabric + L_NIC_proc
  latency_cpu_ns: 5000
  latency_dpu_ns: 50
  nvme_of_iops: '>= 5M'
  rdma_protocol_version: v2
  t_process_formula: T_parsing + T_lookup + T_encap
  throughput_gbps: '>= 400'
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  intent: initial_type_classification
  object: Concept
  predicate: auto_mapped
  subject: DPU-Infrastructure-Accelerator
  weight: 0.5
temporal:
...
# [Concept] Dpu Infrastructure Accelerator
