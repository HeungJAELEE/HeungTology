---
lineage:
  dataset_reference: satellite-constellation-positional-accuracy-and-latency-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] satellite-constellation-positional-accuracy-and-latency-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for satellite-constellation-positional-accuracy-and-latency-log-v2026
  object_type: Data
  tier: 1
properties:
  battery_level_measured: 92%
  battery_level_target: '> 80%'
  external_audit_log_endpoint: planetary-boundary-compliance-and-sovereignty-audit-log-v2026
  isl_link_rate_measured: 12.5Gbps
  isl_link_rate_target: '> 10.0Gbps'
  orbital_drift_measured: 5.2m/day
  orbital_drift_target: < 10.0m
  positional_error_measured: 0.85m
  positional_error_target: < 1.00m
  satellite_altitude: 550km
  signal_latency_measured: 28.5ms
  signal_latency_target: < 35.0ms
  snr_measured: 24.5dB
  snr_target: '> 20.0dB'
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: satellite-constellation-positional-accuracy-and-latency-log-v2026
  weight: 1.0
temporal:
...
# [Concept] Satellite Constellation Positional Accuracy And Latency Log V2026
