...
lineage:
  ...
  original_hash: 7c7ea5e2e5dd70a89160b4dc85b78c95cd33eff40f52e962f08cc65720a1a477
metadata:
  date: '2026-05-16'
  domain: 03_AI_Data
...
object:
  ...
  tier: 1
properties:
  edge_rag_latency_target: 100ms
  edge_rag_latency_verified: 85ms-145ms
  external_knowledge_log_endpoint: Data general-process-parameter-log-v2026
  pruning_density_target: 0.1%
  pruning_sparsity_verified: 0.5%-10.0%
  qat_accuracy_drop_limit: 0.5%
  quantization_speedup_theoretical: 4.0x
  quantization_speedup_verified: 3.8x-4.2x
semantic:
  alternative_parents: []
