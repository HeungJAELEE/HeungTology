---
lineage:
  dataset_reference: hvdc-transmission-loss-and-voltage-stability-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] hvdc-transmission-loss-and-voltage-stability-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for hvdc-transmission-loss-and-voltage-stability-log-v2026
  object_type: Data
  tier: 1
properties:
  air_insulation_breakdown_strength: 30 kV/cm
  converter_station_efficiency_threshold: 98.5%
  lcc_tech_component: Thyristor
  submarine_cable_thermal_limit_factor: 0.8
  transmission_loss_formula: P_loss = I^2 * R
  uhvdc_voltage_standard: 1100 kV
  vsc_tech_component: IGBT
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: hvdc-transmission-loss-and-voltage-stability-log-v2026
  weight: 0.9
temporal:
...
# [Concept] Hvdc Transmission Loss And Voltage Stability Log V2026
