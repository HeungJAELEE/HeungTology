---
lineage:
  dataset_reference: pem-electrolyzer-hydrogen-production-rate-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] pem-electrolyzer-hydrogen-production-rate-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for pem-electrolyzer-hydrogen-production-rate-log-v2026
  object_type: Data
  tier: 1
properties:
  ael_efficiency_hhv: 65-75%
  ael_power_consumption: 55-65 kWh/kg
  ael_production_rate: 5.0-15.0 Nm3/hr/m2
  ael_temp_range: 60-90 C
  critical_current_density: 2 A/cm2
  electron_count: 2
  faraday_efficiency_threshold: '0.95'
  h2_purity_threshold: '0.99999'
  high_pressure_operation: 30 bar
  hydrogen_hhv: 39.4 kWh/kg
  pem_efficiency_hhv: 75-82%
  pem_power_consumption: 50-55 kWh/kg
  pem_production_rate: 20.0-50.0 Nm3/hr/m2
  pem_temp_range: 50-80 C
  safety_shutdown_threshold_h2_in_o2: '0.02'
  soec_efficiency_hhv: 85-95%
  soec_power_consumption: 35-45 kWh/kg
  soec_production_rate: 100.0+ Nm3/hr/m2
  soec_temp_range: 600-850 C
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: pem-electrolyzer-hydrogen-production-rate-log-v2026
  weight: 0.5
temporal:
...
# [Concept] Pem Electrolyzer Hydrogen Production Rate Log V2026
