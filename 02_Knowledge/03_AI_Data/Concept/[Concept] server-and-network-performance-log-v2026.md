...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] server-and-network-performance-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for server-and-network-performance-log-v2026
  object_type: Data
  tier: 1
properties:
  cpu_load_normal_range: 40-70%
  cpu_load_warning_threshold: 80%
  jitter_threshold_ms: '5'
  memory_util_normal_range: 50-80%
  network_throughput_min_gbps: '10.0'
  packet_loss_max_percent: '0.001'
  server_health_score_range: 0-1
  storage_iops_min_count: 100K
semantic:
  alternative_parents: []
...
# [Concept] Server And Network Performance Log V2026
