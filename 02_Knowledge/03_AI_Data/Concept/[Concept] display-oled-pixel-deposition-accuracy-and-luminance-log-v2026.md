...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] display-oled-pixel-deposition-accuracy-and-luminance-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for display-oled-pixel-deposition-accuracy-and-luminance-log-v2026
  object_type: Data
  tier: 1
properties:
  color_purity_r: (0.68, 0.32)
  color_purity_standard: BT.2020
  deposition_accuracy: ±0.8 um
  deposition_accuracy_target: < 1.0 um
  luminance_degradation_limit: 5%
  luminance_uniformity: 98.5%
  luminance_uniformity_target: '> 98.0%'
  panel_flatness: 15 um
  panel_flatness_target: < 20 um
  pixel_defect_rate: 0.2 PPM
  pixel_defect_target: < 0.5 PPM
  temp_imbalance_threshold: 0.1K
...
# [Concept] Display Oled Pixel Deposition Accuracy And Luminance Log V2026
