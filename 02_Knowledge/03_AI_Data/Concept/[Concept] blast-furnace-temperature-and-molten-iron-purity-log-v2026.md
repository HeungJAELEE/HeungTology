...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] blast-furnace-temperature-and-molten-iron-purity-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for blast-furnace-temperature-and-molten-iron-purity-log-v2026
  object_type: Data
  tier: 1
properties:
  carbon_content_measured: 4.58%
  carbon_content_target: 4.3-4.7%
  furnace_efficiency_measured: 94.2%
  furnace_efficiency_threshold: 92.0%
  hot_blast_temp_measured: 1245°C
  hot_blast_temp_target: 1200-1300°C
  molten_iron_temp_measured: 1524°C
  molten_iron_temp_target: 1510-1530°C
  optimal_carbon_content_threshold: 4.5%
  optimal_molten_iron_temp_baseline: 1520±10°C
  silicon_content_measured: 0.45%
  silicon_content_threshold: 0.60%
  slag_basicity_measured: '1.25'
  slag_basicity_target: 1.2-1.3
  t_raft_target: 2250°C
semantic:
  alternative_parents: []
...
# [Concept] Blast Furnace Temperature And Molten Iron Purity Log V2026
