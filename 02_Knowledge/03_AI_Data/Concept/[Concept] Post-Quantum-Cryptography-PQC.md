...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] Post-Quantum-Cryptography-PQC]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for Post-Quantum-Cryptography-PQC
  object_type: Algorithm
  tier: 1
properties:
  ciphertext_size_bytes: 1088-1568
  classical_complexity: e^{o(n^{1/3})}
  decryption_failure_probability: < 2^-128
  enc_latency_cpu_cycles: < 50000
  problem_base: module_lwe
  public_key_length_bytes: 1184-1568
  security_level_equivalent: aes_256
  security_level_rank: level_5
  shor_algorithm_quantum_complexity: o(n^2 log n)
  standard_name: fips_203
semantic:
  alternative_parents: []
