---
lineage:
  dataset_reference: interferometry-based-nanometrology-resolution-and-uncertainty-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] interferometry-based-nanometrology-resolution-and-uncertainty-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for interferometry-based-nanometrology-resolution-and-uncertainty-log-v2026
  object_type: Data
  tier: 1
properties:
  correction_model: edlen_formula
  env_vibration: 0.02 um/s
  laser_stability: 10^-10
  laser_wavelength: 632.8 nm
  meas_resolution: 0.05 nm
  meas_uncertainty: 0.8 nm
  optical_path_diff: 50 um
  phase_shift_acc: 0.01 deg
  target_resolution: 0.10 nm
  target_uncertainty: 1.5 nm
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: interferometry-based-nanometrology-resolution-and-uncertainty-log-v2026
  weight: 1.0
temporal:
...
# [Concept] Interferometry Based Nanometrology Resolution And Uncertainty Log V2026
