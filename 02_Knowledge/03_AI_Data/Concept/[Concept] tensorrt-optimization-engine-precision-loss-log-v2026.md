...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] tensorrt-optimization-engine-precision-loss-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for tensorrt-optimization-engine-precision-loss-log-v2026
  object_type: Data
  tier: 1
properties:
  calibration_algorithm: Entropy Calibration v2
  dynamic_shapes_overhead_pct: < 15
  ...
  winograd_algorithm_efficiency_gain: 1.5x
...
# [Concept] Tensorrt Optimization Engine Precision Loss Log V2026
