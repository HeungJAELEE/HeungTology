...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] lead-time-and-on-time-delivery-otd-performance-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for lead-time-and-on-time-delivery-otd-performance-log-v2026
  object_type: Data
  tier: 1
properties:
  consolidated_global_hubs_difot: 91.0%
  consolidated_global_hubs_lead_time: 10-20d
  consolidated_global_hubs_otd: 94%
  external_data_sources: AIS, ADS-B, customs_clearance_systems
  mto_sea_air_difot: 93.0%
  mto_sea_air_lead_time: 14-21d
  mto_sea_air_otd: 96%
  otd_credit_debt_threshold: 95%
  regional_truck_difot: 97.5%
  regional_truck_lead_time: 1-3d
  regional_truck_otd: 98.0%
  stock_sea_difot: 88.0%
  stock_sea_lead_time: 30-45d
  stock_sea_otd: 92%
  transit_cost_increase_per_sigma_day: 10%
  urgent_air_difot: 98.5%
  urgent_air_lead_time: 2-5d
  urgent_air_otd: 99.5%
semantic:
  alternative_parents: []
...
# [Concept] Lead Time And On Time Delivery Otd Performance Log V2026
