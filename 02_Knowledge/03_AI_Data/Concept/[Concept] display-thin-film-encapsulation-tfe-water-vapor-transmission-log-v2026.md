---
lineage:
  dataset_reference: display-thin-film-encapsulation-tfe-water-vapor-transmission-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] display-thin-film-encapsulation-tfe-water-vapor-transmission-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for display-thin-film-encapsulation-tfe-water-vapor-transmission-log-v2026
  object_type: Data
  tier: 1
properties:
  critical_bending_radius: 1.5mm
  flexibility_radius_hybrid: 1.0 mm
  lag_time_hybrid: 2500 hr
  minimum_transmittance: '> 90%'
  pinhole_density_threshold: < 0.01 count/cm^2
  target_wvtr: < 10^-6 g/m^2/day
  wvtr_dam_and_fill: 1x10^-3 g/m^2/d
  wvtr_hybrid: 1x10^-7 g/m^2/d
  wvtr_inorganic_film: 1x10^-4 g/m^2/d
  wvtr_inorganic_single: 1x10^-5 g/m^2/d
  wvtr_multi_layer: 5x10^-6 g/m^2/d
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: display-thin-film-encapsulation-tfe-water-vapor-transmission-log-v2026
  weight: 1.0
temporal:
...
# [Concept] Display Thin Film Encapsulation Tfe Water Vapor Transmission Log V2026
...
왜 접었다 펴면 화면이 죽나요? RAG는 "반복 굽힘 테스트 로그와 WVTR 변화 데이터를 대조하여, 곡률 반경 $1.5\ \text{mm}$ 이하에서 무기막에 미세 균열이 발생하고 이로 인해 WVTR이 $2$배 급증함을 확인하고, 유기막의 연성(Ductility) 강화를 통한 응력 분산 처방을 내립니다."
