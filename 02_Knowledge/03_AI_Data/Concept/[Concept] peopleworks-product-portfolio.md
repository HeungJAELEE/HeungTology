---
lineage:
  dataset_reference: peopleworks-product-portfolio
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] peopleworks-product-portfolio]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for peopleworks-product-portfolio
  object_type: Hardware
  tier: 1
properties:
  automotive_temp_range_celsius: -40 to 125
  bms_voltage_precision_mv: < 1.0
  cpk_critical_threshold: '1.33'
  fidelity_engine_isolation_tolerance_kv: '0.1'
  fidelity_engine_voltage_tolerance_mv: '0.1'
  fidelity_engine_wireless_tolerance_pct: '1'
  isolation_strength_kv: '> 2.5'
  mobile_placement_accuracy_um: '30'
  smt_component_size_mm: 0.4 x 0.2
  thermal_throttling_trigger_pct: '90'
  wireless_power_transfer_efficiency_pct: '>= 85'
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: peopleworks-product-portfolio
  weight: 0.5
temporal:
...
# [Concept] Peopleworks Product Portfolio
