...
object:
  ...
  tier: 1
properties:
  balancing_ratio_alpha: 0.1-0.9
  distillation_temperature_range: 2.0-5.0
  engine_spec_version: HDS-Gold V6.3.7
  latency_improvement_factor: 5-20
  max_accuracy_drop_pct: '2.0'
  max_power_consumption_w: '15'
  max_vram_usage_mb: '256'
  min_throughput_fps: '60'
  model_size_reduction_ratio: 10-50
semantic:
  alternative_parents: []
