...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] perovskite-pce-efficiency-and-encapsulation-lifetime-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for perovskite-pce-efficiency-and-encapsulation-lifetime-log-v2026
  object_type: Data
  tier: 1
properties:
  charge_bottleneck_efficiency_loss: 15%
  current_matching_error_threshold: 5%
  perovskite_single_bandgap: 1.55 eV
  perovskite_single_jsc: 25.8 mA/cm2
  perovskite_single_pce: 26.2%
  perovskite_single_t80_lifetime: 5,000 hr
  shockley_queisser_limit: 33.7%
  tandem_bandgap: 1.7/1.1 eV
  tandem_jsc: 19.5 mA/cm2
  tandem_pce: 33.5%
  tandem_t80_lifetime: 20,000 hr
  target_ff: '> 0.85'
  target_pce: '> 35.0%'
  target_t80_lifetime: '> 10^5 hr'
  target_voc: '> 2.0 V'
  target_wvtr: 10^-7 g/m2/day
  wvtr_seal: 10^-6 g/m2/day
semantic:
  alternative_parents: []
...
# [Concept] Perovskite Pce Efficiency And Encapsulation Lifetime Log V2026
