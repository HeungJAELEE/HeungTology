...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] ocean-current-velocity-and-tidal-energy-potential-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for ocean-current-velocity-and-tidal-energy-potential-log-v2026
  object_type: Data
  tier: 1
properties:
  betz_limit: 59.3%
  critical_tidal_range_threshold: 5.0 m
  critical_velocity_threshold: 2.5 m/s
  current_velocity_measured: 2.84 m/s
  current_velocity_target: '> 2.00 m/s'
  growth_factor_measured: 1.2%
  growth_factor_target: < 5.0%
  power_potential_measured: 42.5 MW
  power_potential_target: '> 30.0 MW'
  salinity_level_measured: 34.8 PSU
  tidal_range_measured: 8.45 m
  tidal_range_target: '> 5.00 m'
  turbine_efficiency_measured: 38.2%
  turbine_efficiency_target: '> 35.0%'
semantic:
  alternative_parents: []
...
# [Concept] Ocean Current Velocity And Tidal Energy Potential Log V2026
