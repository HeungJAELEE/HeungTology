---
lineage:
  dataset_reference: critical-dimension-scanning-electron-microscope-cd-sem-precision-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] critical-dimension-scanning-electron-microscope-cd-sem-precision-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for critical-dimension-scanning-electron-microscope-cd-sem-precision-log-v2026
  object_type: Data
  tier: 1
properties:
  after_dev_accel_voltage: 300-500 V
  after_dev_precision_1sigma: 0.2-0.4 nm
  after_dev_resolution: 1.2-1.8 nm
  after_etch_accel_voltage: 500-1000 V
  after_etch_precision_1sigma: 0.1-0.3 nm
  after_etch_resolution: 0.8-1.2 nm
  contact_hole_accel_voltage: 800-1500 V
  contact_hole_precision_1sigma: 0.3-0.5 nm
  contact_hole_resolution: 1.0-1.5 nm
  de_broglie_wavelength_at_500v: 0.05 nm
  edge_effect_error_ratio: 70%
  multi_layer_overlay_precision_1sigma: 0.5-1.0 nm
  next_gen_eb_accel_voltage: '> 2000 V'
  next_gen_eb_precision_1sigma: < 0.1 nm
  next_gen_eb_resolution: < 0.8 nm
  pr_shrinkage_per_measurement: 0.1 nm
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: critical-dimension-scanning-electron-microscope-cd-sem-precision-log-v2026
  weight: 0.5
temporal:
...
# [Concept] Critical Dimension Scanning Electron Microscope Cd Sem Precision Log V2026
...
재면 잴수록 왜 작아지나요? RAG는 "노출 횟수별 CD 변화 로그와 전자 빔 도즈(Dose) 데이터를 대조하여, 유기물 PR이 전자 충격으로 탄화(Carbonization)되어 매 측정마다 $0.1\ \text{nm}$씩 수축함을 식별하고, '선형 외삽 보정(Extrapolation)' 무결성을 오딧합니다."
