...
object:
  ...
  tier: 1
properties:
  availability_lower_bound: 0.92
  availability_upper_bound: 0.98
  beta_wear_out_threshold: 1.0
  endpoint_mes_bridge: mes_bridge
  endpoint_pm_master_db: pm_master_db
  endpoint_tool_monitor: tool_monitor
  maintenance_cost_ratio_pm_cm: 0.3
  reliability_target_formula: P(f) < epsilon
semantic:
  alternative_parents: []
