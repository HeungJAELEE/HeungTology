...
object:
  ...
  tier: 1
properties:
  design_latency_classical: 10^6 hours
  design_latency_diffusion: < 10^2 seconds
  plddt_high_confidence_threshold: '80.0'
  plddt_ideal: '100.0'
  protein_search_space_theoretical: 10^300
  protein_search_space_verified: 10^n (manifold-constrained)
  success_rate_generative: 10-30%
  success_rate_random: < 0.1%
semantic:
  alternative_parents: []
