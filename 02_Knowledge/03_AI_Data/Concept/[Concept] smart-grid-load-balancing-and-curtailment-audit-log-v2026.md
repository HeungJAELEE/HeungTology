---
lineage:
  dataset_reference: smart-grid-load-balancing-and-curtailment-audit-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] smart-grid-load-balancing-and-curtailment-audit-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for smart-grid-load-balancing-and-curtailment-audit-log-v2026
  object_type: Data
  tier: 1
properties:
  curtailment_rate_measured_pct: 1.85
  curtailment_rate_target_pct: 2.0
  dr_success_rate_measured_pct: 97.2
  dr_success_rate_target_pct: 95.0
  ess_utilization_measured_pct: 88.5
  ess_utilization_target_pct: 80.0
  grid_efficiency_measured_pct: 94.5
  grid_efficiency_target_pct: 93.0
  load_peak_measured_mw: 850
  load_peak_target_mw: 900
  peak_shaving_amount_mw: 50
  price_signal_response_measured_ms: 1.2
  price_signal_response_target_ms: 5.0
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: smart-grid-load-balancing-and-curtailment-audit-log-v2026
  weight: 0.5
temporal:
...
# [Concept] Smart Grid Load Balancing And Curtailment Audit Log V2026
