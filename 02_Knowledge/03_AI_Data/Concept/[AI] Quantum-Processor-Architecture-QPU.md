...
lineage:
  ...
  original_hash: dd84cec3080b17077c1b3339b4ce6f24d65e6e853bc40a3844bdeec1d31bf664
metadata:
  date: '2026-05-16'
  domain: 03_AI_Data
...
object:
  ...
  tier: 1
properties:
  connectivity_topology: heavy_hex_grid
  control_frequency_range: 4-8GHz
  cooling_power_range: 10-100uW
  crosstalk_max: 0.1%
  gate_delay_max: 50ns
  operating_temperature: 20mK
  physical_qubit_target: '1000'
  quantum_volume_formula: log2 VQ = min(n, 1/epsilon)
  quantum_volume_min: 2^10
  readout_fidelity_min: 99.5%
  specification_standard: HDS-Gold V6.3.7
  transmon_hamiltonian: H = 4Ec(n-ng)^2 - Ej cos phi
semantic:
  alternative_parents: []
