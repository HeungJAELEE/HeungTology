...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] sync_wiki_to_gdrive]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for sync_wiki_to_gdrive
  object_type: Algorithm
  tier: 1
properties:
  api_overhead_constant: 0.45s
  auth_delay_verified: 1.15s
  backup_frequency_verified: 12.0 hours
  compression_efficiency_verified: 78.2%
  network_bandwidth_verified: 42.5 Mbps
  performance_log_endpoint: gdrive-backup-performance-log-v2026
  rto_limit: 1 hour
  transfer_integrity_verified: 100.0%
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 03_AI_Data]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: conceptual_classification
  object: Concept
