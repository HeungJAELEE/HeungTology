...
object:
  ...
  tier: 1
properties:
  high_end_response_time_s: 0.1
  high_end_rte_threshold: 0.92
  high_voltage_threshold_v: 1500
  isolation_resistance_min_m_ohm: 1000
  isolation_resistance_tolerance_m_ohm: 50
  low_end_response_time_s: 2.0
  low_end_rte_threshold: 0.82
  smt_precision_target_um: 10
  smt_precision_tolerance_um: 2
  standard_response_time_s: 0.5
  standard_rte_range: 0.88-0.90
  thermal_range_max_c: 85
  thermal_range_min_c: -40
  thermal_tolerance_c: 1
  uptime_ratio_target: 0.999
  uptime_ratio_tolerance: 0.0005
semantic:
  alternative_parents: []
