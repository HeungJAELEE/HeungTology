...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] Generative-AI]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for Generative-AI
  object_type: Concept
  tier: 1
properties:
  clip_score_threshold: '> 0.30'
  context_window_range: 128K ~ 1M+
  decoding_temperature_default: '0.7'
  decoding_top_p_default: '0.9'
  engine_version: HDS-Gold V6.3.7
  fid_threshold: < 15.0
  inference_speed_threshold: '> 50 TPS'
