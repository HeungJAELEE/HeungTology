---
lineage:
  dataset_reference: microgrid-energy-management-system-ems-dispatch-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] microgrid-energy-management-system-ems-dispatch-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for microgrid-energy-management-system-ems-dispatch-log-v2026
  object_type: Data
  tier: 1
properties:
  bess_absorption_rate_threshold_pct: 90
  black_start_transition_time_max_ms: 500
  grid_connected_renewable_share_pct: 20-40
  island_mode_renewable_share_pct: 60-80
  island_mode_transition_time_max_ms: 100
  microgrid_cluster_renewable_share_pct: 50-70
  prediction_error_impact_threshold_pct: 10
  prediction_error_island_duration_reduction_hr: 2
  voltage_fluctuation_stability_threshold_pct: 3
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 03_AI_Data]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: initial_semantic_assignment
  object: Concept
  predicate: auto_mapped
  subject: microgrid-energy-management-system-ems-dispatch-log-v2026
  weight: 0.5
temporal:
...
# [Concept] Microgrid Energy Management System Ems Dispatch Log V2026
