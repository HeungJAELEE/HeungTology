...
lineage:
  ...
  original_hash: c58e0dc4d564a75ea84c2f73ab0c5b847ee37bb79dc33e3c89002679ba9048ac
metadata:
  date: '2026-05-16'
  domain: 03_AI_Data
  id: '[[[AI] digital-signal-filtering]]'
  last_updated: '2026-05-17T22:59:20+09:00'
  project: Vault_Modernization
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: '[AI] digital-signal-filtering에 관한 고밀도 지능 노드'
  object_type: Algorithm
  tier: 1
properties:
  group_delay_deviation: approx 0
  group_delay_limit: <= 2 ms
  max_compute_cost: < 100 kOps/sample
  max_memory_usage: < 10 KB
  passband_ripple: <= 0.1 dB
  snr_improvement_target: 12-25 dB
