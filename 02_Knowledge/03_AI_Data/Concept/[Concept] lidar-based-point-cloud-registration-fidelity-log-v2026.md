---
lineage:
  dataset_reference: lidar-based-point-cloud-registration-fidelity-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] lidar-based-point-cloud-registration-fidelity-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for lidar-based-point-cloud-registration-fidelity-log-v2026
  object_type: Data
  tier: 1
properties:
  drift_per_100m: 5cm
  flash_lidar_rmse: 3.0~5.0cm
  fmcw_rmse: 0.2~1.0cm
  loop_closure_convergence_threshold: 1cm
  mechanical_spin_rmse: 1.0~3.0cm
  mms_rmse: <0.5cm
  scan_frequency_range: 10~25Hz
  solid_state_rmse: 0.5~2.0cm
  target_angular_precision: 0.1deg
  target_linear_precision: 1cm
  weather_noise_rmse_multiplier: 3x
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: lidar-based-point-cloud-registration-fidelity-log-v2026
  weight: 0.7
temporal:
...
# [Concept] Lidar Based Point Cloud Registration Fidelity Log V2026
