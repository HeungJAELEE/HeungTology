---
lineage:
  dataset_reference: chemical-spill-and-hazardous-material-leak-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] chemical-spill-and-hazardous-material-leak-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for chemical-spill-and-hazardous-material-leak-log-v2026
  object_type: Data
  tier: 1
properties:
  acid_alkali_containment_success_rate: 1.0
  acid_alkali_response_time_limit_min: 1
  hazmat_waste_containment_success_rate: 0.98
  hazmat_waste_response_time_limit_min: 10
  leak_concentration_unit: ppm
  leak_rate_formula: Q = Cd * A * sqrt(2 * rho * (Pin - Pout))
  oil_coolant_containment_success_rate: 1.0
  oil_coolant_response_time_limit_min: 5
  toxic_gas_containment_success_rate: 0.995
  toxic_gas_detection_threshold_ppm: <1
  toxic_gas_response_time_limit_sec: 30
  voc_containment_success_rate: 0.999
  voc_detection_threshold_ppm: 1-10
  voc_emission_unit: kg/yr
  voc_response_time_limit_min: 2
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: chemical-spill-and-hazardous-material-leak-log-v2026
  weight: 1.0
temporal:
...
# [Concept] Chemical Spill And Hazardous Material Leak Log V2026
