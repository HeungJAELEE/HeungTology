...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] battery-global-passport-compliance-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for battery-global-passport-compliance-log-v2026
  object_type: Data
  tier: 1
properties:
  carbon_emission_price: 80 USD/ton
  carbon_footprint_range: 55-85 kgCO2eq/kWh
  carbon_footprint_threshold: 65 kgCO2e/kWh
  carbon_reduction_target: 25%
  cobalt_current_avg: 12.5%
  cobalt_target_2026: 6%
  cobalt_target_2031: 16%
  external_certification_body: RMI
  lead_current_avg: 98.2%
  lead_target_2026: 85%
  lithium_current_avg: 4.2%
  lithium_target_2031: 6%
  nickel_current_avg: 8.4%
  nickel_target_2026: 6%
  raw_material_emission_contribution: 60%
semantic:
  alternative_parents: []
...
# [Concept] Battery Global Passport Compliance Log V2026
