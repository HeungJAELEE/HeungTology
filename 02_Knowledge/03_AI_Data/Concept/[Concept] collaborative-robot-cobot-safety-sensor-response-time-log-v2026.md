---
lineage:
  dataset_reference: collaborative-robot-cobot-safety-sensor-response-time-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] collaborative-robot-cobot-safety-sensor-response-time-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for collaborative-robot-cobot-safety-sensor-response-time-log-v2026
  object_type: Data
  tier: 1
properties:
  capacitive_skin_response_time_ms: <1
  capacitive_skin_stopping_distance_mm: <5
  collision_force_max_n: 140
  dual_channel_imu_response_time_ms: <2
  iso_standard_reference: ISO 15066
  joint_torque_response_time_ms: 5-20
  joint_torque_stopping_distance_mm: 10-30
  laser_scanner_response_time_ms: 50-150
  laser_scanner_stopping_distance_mm: 100-500
  sensor_fusion_latency_increase_ms: 10
  vision_ai_response_time_ms: 30-80
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: collaborative-robot-cobot-safety-sensor-response-time-log-v2026
  weight: 1.0
temporal:
...
# [Concept] Collaborative Robot Cobot Safety Sensor Response Time Log V2026
