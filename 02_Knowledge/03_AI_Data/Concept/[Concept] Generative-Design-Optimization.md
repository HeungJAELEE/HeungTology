...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] Generative-Design-Optimization]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for Generative-Design-Optimization
  object_type: Concept
  tier: 1
properties:
  compliance_objective: minimize
  engine_specification: HDS-Gold V6.3.7
  mass_reduction_target: 30%-60%
  max_overhang_angle_deg: 45
  min_member_size_mm: 1.0
  min_safety_factor: 1.5
  min_voxel_count: 1000000
  simp_penalty_power: 3
  volume_fraction_range: 0.2-0.5
semantic:
  alternative_parents: []
...
# [Concept] Generative Design Optimization
