---
lineage:
  dataset_reference: chiplet-packaging-hybrid-bonding-alignment-accuracy-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] chiplet-packaging-hybrid-bonding-alignment-accuracy-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for chiplet-packaging-hybrid-bonding-alignment-accuracy-log-v2026
  object_type: Data
  tier: 1
properties:
  annealing_temperature_celsius: '250'
  cow_alignment_accuracy_nm: 150-300
  cow_bonding_strength_j_m2: 8.0-12.0
  cow_pad_pitch_um: 5.0-10.0
  cow_void_density_pct: <0.5
  critical_alignment_threshold_nm: '100'
  critical_void_growth_threshold_pct: '1.0'
  optical_io_alignment_accuracy_nm: 100-200
  resistance_increase_threshold_ratio: '0.2'
  ultra_fine_alignment_accuracy_nm: <50
  ultra_fine_bonding_strength_j_m2: '>20.0'
  w2w_alignment_accuracy_nm: 50-150
  w2w_bonding_strength_j_m2: '>15.0'
  w2w_pad_pitch_um: 1.0-5.0
  w2w_void_density_pct: <0.1
  warpage_induced_error_nm: '>200'
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: chiplet-packaging-hybrid-bonding-alignment-accuracy-log-v2026
  weight: 0.9
temporal:
...
# [Concept] Chiplet Packaging Hybrid Bonding Alignment Accuracy Log V2026
...
왜 웨이퍼 끝부분은 정렬이 안 맞나요? RAG는 "웨이퍼 Warpage 로그와 본딩 오차 맵을 대조하여, 웨이퍼 중심 대비 가장자리의 휨 오차가 본딩 시 시각적 왜곡(Run-out Error)을 유발하여 정렬 오차를 $200\ \text{nm}$ 이상 증가시킴을 식별하고, '능동 뒤틀림 보정' 무결성을 오딧합니다.
