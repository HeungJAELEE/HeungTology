...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] NVLink-Interconnect-Hardware]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for NVLink-Interconnect-Hardware
  object_type: Hardware
  tier: 1
properties:
  aggregate_bandwidth_per_gpu: '>= 1.8 TB/s'
  bit_error_rate_threshold: <= 10^-12
  comm_sync_wait_threshold: '0.3'
  max_gpu_domain_size: 576 GPUs
  modulation_scheme: PAM4 (112G)
  p2p_latency_threshold: <= 100 ns
  sharp_support: in_network_computing
semantic:
  alternative_parents: []
...
# [Concept] Nvlink Interconnect Hardware
