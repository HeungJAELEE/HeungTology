...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] quantum-dot-photoluminescence-efficiency-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for quantum-dot-photoluminescence-efficiency-log-v2026
  object_type: Data
  tier: 1
properties:
  blue_emitting_qd_qy: 75.0%
  fwhm_standard_range: 20-40nm
  inp_znse_zns_green_qy: 92.5%
  inp_znse_zns_red_qy: 94.0%
  perovskite_cspbx3_green_qy: 98.0%
  rec_2020_coverage_target: 95%
  size_deviation_tolerance: 5%
  target_quantum_yield: '>90%'
  thermal_quenching_threshold: <10% at 80C
semantic:
  alternative_parents: []
  is_instance_of: '[[ [MOC] 03_AI_Data]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: semantic_refinement
  object: Concept
...
# [Concept] Quantum Dot Photoluminescence Efficiency Log V2026
