---
lineage:
  dataset_reference: display-quantum-dot-optical-performance-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] display-quantum-dot-optical-performance-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for display-quantum-dot-optical-performance-log-v2026
  object_type: Data
  tier: 1
properties:
  absorbance_range: 10^5-10^6 cm^-1
  ...
  size_distribution_range: 2.0-10.0 nm
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: display-quantum-dot-optical-performance-log-v2026
  weight: 0.9
temporal:
...
# [Concept] Display Quantum Dot Optical Performance Log V2026
...
| :--- | :--- | :--- | :--- |
| **Quantum Yield** | $85 \sim 98 \%$ [데이터 부재] | $\pm 0.1 \%$ [데이터 부재] | 흡수 광자 대비 발광 광자 비율 |
| **FWHM** | $18 \sim 35 \text{ nm}$ [데이터 부재] | $\pm 0.1 \text{ nm}$ [데이터 부재] | 발광 스펙트럼 반치폭 |
| **Peak Wav.** | $450 \sim 650 \text{ nm}$ [데이터 부재] | $\pm 0.5 \text{ nm}$ [데이터 부재] | R/G/B 파장 구현 정확도 |
| **PL Lifetime** | $10 \sim 100 \text{ ns}$ [데이터 부재] | $\pm 0.1 \text{ ns}$ [데이터 부재] | 여기 상태 전이 시간 |
| **Stability (85C)**| $> 1,000 \text{ hrs}$ [데이터 부재] | Continuous [데이터 부재] | 고온 가속 수명 시험 ($L/L_0$) |
| **Absorbance** | $10^5 \sim 10^6 \text{ cm}^{-1}$ [데이터 부재] | $\pm 10^3 \text{ cm}^{-1}$ [데이터 부재] | 청색 광원 흡광 계수 |
| **Size Dist.** | $2.0 \sim 10.0 \text{ nm}$ [데이터 부재] | $\pm 0.1 \text{ nm}$ [데이터 부재] | 나노 입자 크기 균일도 |
| **Color Shift** | $\Delta u'v' < 0.005$ [데이터 부재] | $\pm 0.0001$ [데이터 부재] | 색 좌표 이동 정밀도 |

### 2.2 [이론치 vs 검증치 대조 (Theoretical vs. Verified)]

| 파라미터 (Parameter) | 이론치 (Theoretical) | 검증치 (Verified) | 편차 (Variance) |
| :--- | :--- | :--- | :--- |
| **Quantum Yield** | $100 \%$ | $85 \sim 98 \%$ [데이터 부재] | $\le 15\%$ |
| **FWHM** | $< 10 \text{ nm}$ | $18 \sim 35 \text{ nm}$ [데이터 부재] | $+8 \sim 25 \text{ nm}$ |
| **Color Shift ($\Delta u'v'$)** | $0.000$ | $< 0.005$ [데이터 부재] | $< 0.005$ |
| **Stability (85C)** | $\infty$ | $> 1,000 \text{ hrs}$ [데이터 부재] | N/A |
