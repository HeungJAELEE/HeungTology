---
lineage:
  dataset_reference: photonics-quantum-computing-squeezed-state-purity-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] photonics-quantum-computing-squeezed-state-purity-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for photonics-quantum-computing-squeezed-state-purity-log-v2026
  object_type: Data
  tier: 1
properties:
  cluster_state_modes_min: 1000000
  homodyne_efficiency_target: 0.9
  opo_photon_loss_db: <0.1
  opo_purity: 0.98-0.99
  opo_squeezing_db: 12-15
  photon_loss_complexity_threshold: 0.5
  ppln_photon_loss_db: 0.5-1.0
  ppln_purity: 0.95-0.97
  ppln_squeezing_db: 8-12
  silicon_nitride_photon_loss_db: 1.0-2.0
  silicon_nitride_purity: 0.90-0.95
  silicon_nitride_squeezing_db: 3-6
  squeezing_variance_model: exp(-2r)
  uncertainty_principle_area_min: 1.0
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: photonics-quantum-computing-squeezed-state-purity-log-v2026
  weight: 1.0
temporal:
...
# [Concept] Photonics Quantum Computing Squeezed State Purity Log V2026
