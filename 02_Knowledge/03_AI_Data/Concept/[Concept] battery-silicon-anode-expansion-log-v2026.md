...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] battery-silicon-anode-expansion-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for battery-silicon-anode-expansion-log-v2026
  object_type: Data
  tier: 1
properties:
  binder_modulus_threshold: '> 5 GPa'
  cell_swelling_allowance: 15-25%
  critical_particle_size_d50: 50-150 nm
  lithiation_volume_expansion_factor: 3.8x
  nano_wire_si_initial_efficiency: 85%
  pure_si_specific_capacity: '> 3,500 mAh/g'
  sei_destruction_rate: 35%
  si_c_initial_efficiency: 88%
  si_c_specific_capacity_range: 450-1,200 mAh/g
  si_ox_initial_efficiency: 82%
  theoretical_volume_expansion: 400%
  yolk_shell_si_initial_efficiency: 84%
semantic:
  alternative_parents: []
...
# [Concept] Battery Silicon Anode Expansion Log V2026
