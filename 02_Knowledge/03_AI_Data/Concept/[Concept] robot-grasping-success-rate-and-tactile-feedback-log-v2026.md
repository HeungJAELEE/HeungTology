---
lineage:
  dataset_reference: robot-grasping-success-rate-and-tactile-feedback-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] robot-grasping-success-rate-and-tactile-feedback-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for robot-grasping-success-rate-and-tactile-feedback-log-v2026
  object_type: Data
  tier: 1
properties:
  force_torque_feedback_axis: 6
  friction_coefficient_empty_can: 0.3
  friction_coefficient_glass_bottle: 0.35
  friction_coefficient_oily_plastic: 0.12
  friction_coefficient_polished_steel: 0.25
  friction_coefficient_rubber_ball: 0.85
  grasp_robustness_index_range: 0 ~ 1
  incipient_slip_frequency_band: 100 ~ 500Hz
  pressure_resolution: 0.5mm Matrix
  slip_compensation_force_increase: 15%
  slip_detection_latency_threshold: < 5ms
  slip_reaction_time_limit: 2ms
  tactile_sensitivity_range: 0.05N ~ 0.1N
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: robot-grasping-success-rate-and-tactile-feedback-log-v2026
  weight: 1.0
temporal:
...
# [Concept] Robot Grasping Success Rate And Tactile Feedback Log V2026
