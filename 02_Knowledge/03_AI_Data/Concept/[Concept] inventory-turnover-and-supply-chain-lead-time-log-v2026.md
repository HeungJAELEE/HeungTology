---
lineage:
  dataset_reference: inventory-turnover-and-supply-chain-lead-time-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] inventory-turnover-and-supply-chain-lead-time-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for inventory-turnover-and-supply-chain-lead-time-log-v2026
  object_type: Data
  tier: 1
properties:
  avg_lead_time: l
  critical_parts_lead_time_days: 15-45
  critical_parts_stockout_rate_percent: 0.1
  critical_parts_turnover: 2-5
  demand_variability: sigma_d
  finished_goods_lead_time_days: 7-20
  finished_goods_stockout_rate_percent: 1.2
  finished_goods_turnover: 8-15
  lead_time_variability: sigma_l
  mro_supplies_lead_time_days: 3-10
  mro_supplies_stockout_rate_percent: 5.0
  mro_supplies_turnover: 3-6
  raw_materials_lead_time_days: 30-60
  raw_materials_stockout_rate_percent: 2.5
  raw_materials_turnover: 4-8
  safety_stock_model: Z * sqrt(L * sigma_D^2 + D^2 * sigma_L^2)
  service_level_coefficient: z
  wip_lead_time_days: 1-5
  wip_stockout_rate_percent: 0.5
  wip_turnover: 12-25
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: inventory-turnover-and-supply-chain-lead-time-log-v2026
  weight: 0.3
temporal:
...
# [Concept] Inventory Turnover And Supply Chain Lead Time Log V2026
