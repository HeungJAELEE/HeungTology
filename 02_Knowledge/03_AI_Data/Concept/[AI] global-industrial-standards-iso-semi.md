...
properties:
  ...
  external_db_iso: iso-standards-db
  external_db_semi: semi-global-hub
  local_skill_endpoint: 03_skills/antigravity_native/industrial_intel_skill.py
  quality_standard_auto: iatf 16949
  target_precision_level: angstrom
semantic:
  alternative_parents: []
