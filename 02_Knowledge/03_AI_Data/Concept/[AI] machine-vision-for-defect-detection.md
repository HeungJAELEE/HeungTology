...
lineage:
  ...
  original_hash: 1c3e9fb09fb62c5d3eca4a1b619ea7ef02ace62f7cdeaa536c10149e1dd2a0c0
metadata:
  date: '2026-05-16'
  domain: 03_AI_Data
...
object:
  ...
  tier: 1
properties:
  data_log_endpoint: Data general-process-parameter-log-v2026
  detection_speed: '> 60 fps'
  end_to_end_latency: < 20 ms
  f1_score_threshold: '> 0.99'
  minimum_detectable_defect_size: < 10 um
  robustness_stability: '> 95%'
semantic:
  alternative_parents: []
