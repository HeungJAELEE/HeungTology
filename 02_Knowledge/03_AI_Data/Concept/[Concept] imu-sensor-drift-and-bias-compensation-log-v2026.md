...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] imu-sensor-drift-and-bias-compensation-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for imu-sensor-drift-and-bias-compensation-log-v2026
  object_type: Data
  tier: 1
properties:
  consumer_accel_bias_max_mg: 5
  consumer_gyro_bias_max_deg_hr: 50
  gps_loss_uncertainty_threshold_s: 30
  industrial_accel_bias_mg: 0.5
  industrial_gyro_bias_deg_hr: 1.0
  optimal_bias_estimation_time_tau_best_s: 100
  position_uncertainty_limit_m: 1.5
  tactical_accel_bias_mg: 0.05
  tactical_gyro_bias_deg_hr: 0.01
  temp_gyro_bias_slope_deg_hr_per_c: 0.1
  thermal_bias_reduction_factor: 10
  thermal_compensation_drift_reduction_rate: 0.8
  zupt_drift_limit_m_hr: 10.0
semantic:
  alternative_parents: []
...
# [Concept] Imu Sensor Drift And Bias Compensation Log V2026
