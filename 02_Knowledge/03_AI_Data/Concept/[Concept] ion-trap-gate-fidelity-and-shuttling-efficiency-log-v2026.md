---
lineage:
  dataset_reference: ion-trap-gate-fidelity-and-shuttling-efficiency-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] ion-trap-gate-fidelity-and-shuttling-efficiency-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for ion-trap-gate-fidelity-and-shuttling-efficiency-log-v2026
  object_type: Data
  tier: 1
properties:
  coherence_t2_mean: 420 sec
  cryogenic_threshold_temperature: 4K
  heating_rate_mean: 0.85 q/s
  heating_rate_scaling_law: d^-4
  lamb_dicke_parameter_optimal: 0.05-0.15
  shuttling_efficiency_reduction_threshold: 0.1%
  shuttling_speed_mean: 15 m/s
  shuttling_success_mean: 99.9995%
  single_qubit_fidelity_mean: 99.998%
  spam_error_mean: 0.045%
  two_qubit_fidelity_mean: 99.965%
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 03_AI_Data]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: empirical_performance_metric
  object: Concept
  predicate: auto_mapped
  subject: ion-trap-gate-fidelity-and-shuttling-efficiency-log-v2026
  weight: 0.95
temporal:
...
# [Concept] Ion Trap Gate Fidelity And Shuttling Efficiency Log V2026
