...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] semiconductor-euv-source-and-optical-fidelity-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for semiconductor-euv-source-and-optical-fidelity-log-v2026
  object_type: Data
  tier: 1
properties:
  conversion_efficiency_measured_pct: 6.2
  conversion_efficiency_target_pct: 6.0
  droplet_frequency_measured_khz: 50.2
  droplet_frequency_target_khz: 50.0
  droplet_position_error_threshold_um: 5
  euv_wavelength_nm: 13.5
  mirror_reflectivity_measured_pct: 69.8
  mirror_reflectivity_target_pct: 69.0
  plasma_temperature_measured_ev: 35.4
  plasma_temperature_range_ev: 30-40
  reflectivity_drop_threshold_pct: 1.0
  source_power_measured_w: 285.4
  source_power_target_w: 250.0
  wavefront_error_measured_nm: 0.015
  wavefront_error_target_nm: 0.02
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 03_AI_Data]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: type_categorization
  object: Concept
...
# [Concept] Semiconductor Euv Source And Optical Fidelity Log V2026
