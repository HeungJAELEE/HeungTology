...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] smart-factory-energy-consumption-optimization-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for smart-factory-energy-consumption-optimization-log-v2026
  object_type: Data
  tier: 1
properties:
  compressed_air_power_proportion: 10-20%
  cost_reduction_via_shift: 20%
  energy_autonomy_target: 30%
  fan_motor_power_pressure_exponent: '1.5'
  hvac_power_proportion: 20-40%
  lighting_power_proportion: 1-5%
  motor_power_proportion: 40-60%
  peak_demand_reduction_range: 5%-20%
  power_factor_integrity_threshold: '0.95'
  robot_conveyor_power_proportion: 5-15%
  sec_unit: kWh/unit
semantic:
  alternative_parents: []
...
# [Concept] Smart Factory Energy Consumption Optimization Log V2026
