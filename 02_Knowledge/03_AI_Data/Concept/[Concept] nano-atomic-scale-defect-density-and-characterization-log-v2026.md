---
lineage:
  dataset_reference: nano-atomic-scale-defect-density-and-characterization-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] nano-atomic-scale-defect-density-and-characterization-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for nano-atomic-scale-defect-density-and-characterization-log-v2026
  object_type: Data
  tier: 1
properties:
  boltzmann_constant: 8.617e-5 eV/K
  burgers_vector_range: 2.5-5.0 A
  dislocation_density_threshold: < 10^4 cm^-2
  formation_energy_range: 1.5-3.0 eV
  impurity_level_threshold: < 1.0 ppb
  lattice_constant_si: 5.43 A
  lattice_strain_threshold: < 0.1%
  resolution_limit_threshold: < 0.5 A
  vacancy_density_threshold: < 10^12 cm^-3
  xrd_fwhm_threshold: < 20.0 arcsec
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: nano-atomic-scale-defect-density-and-characterization-log-v2026
  weight: 1.0
temporal:
...
# [Concept] Nano Atomic Scale Defect Density And Characterization Log V2026
