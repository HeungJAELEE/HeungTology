...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] chemical-reactor-temperature-and-yield-efficiency-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for chemical-reactor-temperature-and-yield-efficiency-log-v2026
  object_type: Data
  tier: 1
properties:
  catalyst_activity: '0.942'
  catalyst_activity_target: '> 0.900'
  chemical_yield: 98.85%
  chemical_yield_target: '> 98.00%'
  conversion_rate: 99.42%
  conversion_rate_target: '> 99.00%'
  heat_flux: 12.5 kW/m2
  minimum_civilization_yield_threshold: 98.5%
  reaction_pressure: 35.4 bar
  reaction_pressure_target: 30.0 - 40.0 bar
  reactor_temp: 245.2 C
  reactor_temp_target: 245.0 +/- 1.0 C
  temperature_precision_threshold: 0.5 C
semantic:
  alternative_parents: []
...
# [Concept] Chemical Reactor Temperature And Yield Efficiency Log V2026
