...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] human-in-the-loop-rag-strategy]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for human-in-the-loop-rag-strategy
...
properties:
  ...
  hallucination_decrease_threshold: 95%
  human_action_latency_max: 10s
  hybrid_reranking_score_formula: w_ai * sim(Q, D) + w_h * Interaction
...
# [Concept] Human In The Loop Rag Strategy
