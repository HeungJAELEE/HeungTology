...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] remote-patient-monitoring-data-packet-loss-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for remote-patient-monitoring-data-packet-loss-log-v2026
  object_type: Data
  tier: 1
properties:
  connection_reliability_target: '> 99.90%'
  e2e_latency_target: < 150.0ms
  interpolation_error_threshold: 2%
  max_bit_error_rate: 1e-9
  measured_connection: 99.98%
  measured_jitter: 12.5ms
  measured_latency: 84.5ms
  measured_packet_loss: 0.24%
  measured_snr: 32.4dB
  measured_throughput: 256.0kbps
  network_jitter_target: < 20.0ms
  packet_loss_target: < 0.50%
  signal_snr_target: '> 25.0dB'
  throughput_target: '> 128.0kbps'
semantic:
  alternative_parents: []
...
# [Concept] Remote Patient Monitoring Data Packet Loss Log V2026
