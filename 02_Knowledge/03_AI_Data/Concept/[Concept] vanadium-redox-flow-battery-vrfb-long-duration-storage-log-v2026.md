...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] vanadium-redox-flow-battery-vrfb-long-duration-storage-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for vanadium-redox-flow-battery-vrfb-long-duration-storage-log-v2026
  object_type: Data
  tier: 1
properties:
  hybrid_flow_rte_range: 75-82%
  internal_resistance_increase_threshold: 0.2
  medium_system_rte_range: 70-78%
  pumping_loss_rte_impact: 0.05
  small_stack_rte_range: 75-80%
  target_system_lifespan_years: 20
  utility_scale_energy_min_kwh: 10000
  utility_scale_power_min_kw: 24
  utility_scale_rte_range: 65-75%
  voltage_model_basis: nernst_equation
semantic:
  alternative_parents: []
...
# [Concept] Vanadium Redox Flow Battery Vrfb Long Duration Storage Log V2026
