---
lineage:
  dataset_reference: lidar-and-camera-fusion-obstacle-detection-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] lidar-and-camera-fusion-obstacle-detection-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for lidar-and-camera-fusion-obstacle-detection-log-v2026
  object_type: Data
  tier: 1
properties:
  forklift_dist_error_cm: 10~30
  forklift_dist_range_m: 5~50
  forklift_latency_ms: 50~80
  forklift_map: '> 97.5'
  kalman_filter_uncertainty_reduction_rate: 30%
  low_light_dist_error_cm: 5~15
  low_light_dist_range_m: 1~10
  low_light_latency_ms: 60~100
  low_light_map: '> 95.0'
  pallet_box_dist_error_cm: 0.5~2
  pallet_box_dist_range_m: 0.5~5
  pallet_box_latency_ms: 20~40
  pallet_box_map: '> 99.9'
  person_dynamic_dist_error_cm: 3~8
  person_dynamic_dist_range_m: 1~20
  person_dynamic_latency_ms: 40~60
  person_dynamic_map: '> 98.0'
  person_static_dist_error_cm: 1~3
  person_static_dist_range_m: 1~10
  person_static_latency_ms: 30~50
  person_static_map: '> 99.5'
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: lidar-and-camera-fusion-obstacle-detection-log-v2026
  weight: 0.9
temporal:
...
# [Concept] Lidar And Camera Fusion Obstacle Detection Log V2026
