...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] Materials-Informatics]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for Materials-Informatics
  object_type: Concept
  tier: 1
properties:
  descriptor_dimension_range: 128-512
  dft_speedup_factor: 1,000x - 10,000x
  experimental_validation_hit_rate: '> 30%'
  gnn_message_passing_depth: 3-6 layers
  rmse_formation_energy_threshold: < 0.05 eV/atom
  screening_speed_threshold: '> 10^6 compounds/sec'
semantic:
  alternative_parents: []
