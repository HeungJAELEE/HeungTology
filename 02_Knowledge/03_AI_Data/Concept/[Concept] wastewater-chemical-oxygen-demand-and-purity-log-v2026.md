---
lineage:
  dataset_reference: wastewater-chemical-oxygen-demand-and-purity-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] wastewater-chemical-oxygen-demand-and-purity-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for wastewater-chemical-oxygen-demand-and-purity-log-v2026
  object_type: Data
  tier: 1
properties:
  bod_measured: 4.2 mg/L
  bod_target: < 10.0 mg/L
  cod_bod_ratio_threshold: '5.0'
  cod_measured: 18.4 mg/L
  cod_target: < 20.0 mg/L
  effluent_flow: 12,500 m3/d
  monod_growth_rate_model: mu = mu_max * (S / (Ks + S))
  oxygen_transfer_model: dC/dt = KLa * (Cs - C)
  removal_efficiency_measured: 96.5%
  removal_efficiency_target: '> 90.0%'
  shock_load_ph_threshold: '5.0'
  tss_measured: 2.5 mg/L
  tss_target: < 10.0 mg/L
  water_purity_measured: 99.4%
  water_purity_target: '> 98.0%'
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: wastewater-chemical-oxygen-demand-and-purity-log-v2026
  weight: 0.7
temporal:
...
# [Concept] Wastewater Chemical Oxygen Demand And Purity Log V2026
