...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] atomic-layer-etch-ale-selectivity-and-uniformity-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for atomic-layer-etch-ale-selectivity-and-uniformity-log-v2026
  object_type: Data
  tier: 1
properties:
  defect_reduction_rate: 90%
  har_diffusion_limit: '50:1'
  ion_energy_window_theoretical: 20~50eV
  ion_energy_window_verified: 25~45eV
  low_k_epc: 3.0~6.0 A/cycle
  low_k_wiwnu: <3%
  metal_epc: 0.5~2.0 A/cycle
  metal_selectivity: '>100:1'
  metal_wiwnu: <1.5%
  saturation_time_verified: 1.2 * t_min
  si3n4_epc: 1.5~4.0 A/cycle
  si3n4_ox_selectivity: '>20:1'
  si3n4_wiwnu: <2%
  si_epc: 1.0~3.0 A/cycle
  si_wiwnu: <1%
  sio2_epc: 2.0~5.0 A/cycle
  sio2_si_selectivity: '>50:1'
  sio2_wiwnu: <2%
semantic:
  alternative_parents: []
...
# [Concept] Atomic Layer Etch Ale Selectivity And Uniformity Log V2026
