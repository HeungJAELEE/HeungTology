...
lineage:
  ...
  original_hash: 11c5450eb2dd4207baff4c9bd40d166f80b249cd82c44b115efa6a18fda2dedd
metadata:
  date: '2026-05-16'
  domain: 03_AI_Data
  id: '[[[AI] Data-Pipeline]]'
...
object:
  description: '[AI] Data-Pipeline에 관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  ingestion_tech: Apache Kafka / CDC
  orchestration_tech: Airflow / Dagster
  processing_tech: Apache Flink / Spark
  schedule_interval: '@daily'
  storage_tech: Data Lakehouse (Iceberg)
  transformation_tech: dbt
semantic:
  alternative_parents: []
