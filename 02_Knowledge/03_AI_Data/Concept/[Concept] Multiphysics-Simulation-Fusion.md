...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] Multiphysics-Simulation-Fusion]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for Multiphysics-Simulation-Fusion
  object_type: Concept
  tier: 1
properties:
  convergence_tolerance: < 10^-5
  dof_scaling_nodes: '> 10^7'
  energy_conservation_delta: '0'
  engine_version: HDS-Gold V6.3.7
  mapping_error_threshold: < 1.0%
  model_fidelity_r2: '> 0.98'
  pinn_inference_speed: < 100ms
semantic:
  alternative_parents: []
...
# [Concept] Multiphysics Simulation Fusion
