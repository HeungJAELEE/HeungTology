---
lineage:
  dataset_reference: transport-condition-and-cargo-integrity-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] transport-condition-and-cargo-integrity-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for transport-condition-and-cargo-integrity-log-v2026
  object_type: Data
  tier: 1
properties:
  critical_vibration_limit: 1.5G for 10 hours
  humidity_deviation_threshold: < 0.5%
  humidity_target_range: 30-60%
  light_door_target: 0
  max_g_force_threshold: 2.0G
  mkt_model_basis: Arrhenius Equation
  shock_deviation_threshold: < 0.2%
  temperature_deviation_threshold: < 0.1%
  tilt_angle_threshold: 10deg
  tilt_deviation_threshold: < 0.05%
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: transport-condition-and-cargo-integrity-log-v2026
  weight: 1.0
temporal:
...
# [Concept] Transport Condition And Cargo Integrity Log V2026
