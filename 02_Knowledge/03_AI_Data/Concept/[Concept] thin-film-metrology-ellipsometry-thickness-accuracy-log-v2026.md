---
lineage:
  dataset_reference: thin-film-metrology-ellipsometry-thickness-accuracy-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] thin-film-metrology-ellipsometry-thickness-accuracy-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for thin-film-metrology-ellipsometry-thickness-accuracy-log-v2026
  object_type: Data
  tier: 1
properties:
  photoresist_mse_limit: < 3.0
  photoresist_refractive_index_range: 1.6-1.8
  polysilicon_mse_limit: < 5.0
  polysilicon_refractive_index_range: 3.8-4.1
  si_nitride_mse_limit: < 2.0
  si_nitride_refractive_index_range: 2.01-2.10
  si_nitride_refractive_index_shift: '0.05'
  si_oxide_mse_limit: < 1.0
  si_oxide_refractive_index: '1.457'
  surface_roughness_mse_spike_value: '10'
  surface_roughness_mse_threshold: 1nm (rms)
  thickness_precision_1_sigma_target: < 0.01 nm
  ultra_thin_thickness_range: 0.1-2.0nm
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: thin-film-metrology-ellipsometry-thickness-accuracy-log-v2026
  weight: 1.0
temporal:
...
# [Concept] Thin Film Metrology Ellipsometry Thickness Accuracy Log V2026
