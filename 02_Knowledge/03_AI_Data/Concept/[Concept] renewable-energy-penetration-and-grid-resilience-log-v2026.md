---
lineage:
  dataset_reference: renewable-energy-penetration-and-grid-resilience-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] renewable-energy-penetration-and-grid-resilience-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for renewable-energy-penetration-and-grid-resilience-log-v2026
  object_type: Data
  tier: 1
properties:
  buffer_ratio: 25.8%
  external_audit_log_endpoint: smart-grid-energy-balance-and-stability-audit-log-v2026
  grid_carbon_intensity: 42 gCO2/kWh
  hosting_capacity: 12.5 TW
  renewable_penetration_rate: 82.4%
  resilience_index: '0.985'
  restoration_time: 85ms
  voltage_variation_limit: 1.5%
  wind_cut_out_speed: 25m/s
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: renewable-energy-penetration-and-grid-resilience-log-v2026
  weight: 0.5
temporal:
...
# [Concept] Renewable Energy Penetration And Grid Resilience Log V2026
