...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] Discrete-Element-Method-DEM]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for Discrete-Element-Method-DEM
  object_type: Algorithm
  tier: 1
properties:
  cfd_dem_coupling_error_margin: 5%
  friction_coefficient: 0.1 ~ 0.8
  poissons_ratio: 0.2 ~ 0.45
  restitution_coefficient: 0.1 ~ 0.9
  target_lacey_index: '> 0.95'
  time_step_threshold: < 20% of Rayleigh Limit
  youngs_modulus_pa: 10^6 ~ 10^9
semantic:
  alternative_parents: []
...
# [Concept] Discrete Element Method Dem
