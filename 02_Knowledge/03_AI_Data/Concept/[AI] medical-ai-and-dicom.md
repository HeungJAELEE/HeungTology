...
properties:
  ...
  hu_air_reference: -1000
  hu_water_reference: 0
  inference_latency_threshold: < 100 ms/frame
  lung_window_level: -600
  lung_window_width: 1500
  pixel_depth_range: 12-16 bits
  pixel_spacing_threshold: < 0.5 mm/pixel
  slice_thickness_range: 0.5-5.0 mm
semantic:
  alternative_parents: []
