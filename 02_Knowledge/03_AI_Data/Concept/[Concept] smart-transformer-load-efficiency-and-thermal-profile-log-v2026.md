---
lineage:
  dataset_reference: smart-transformer-load-efficiency-and-thermal-profile-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] smart-transformer-load-efficiency-and-thermal-profile-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for smart-transformer-load-efficiency-and-thermal-profile-log-v2026
  object_type: Data
  tier: 1
properties:
  design_hotspot_temp_c: 110
  dga_c2h4_fault_type: high_temperature_overheating
  dga_h2_fault_type: partial_discharge
  harmonic_induced_temp_increase_c: 15
  insulation_material: cellulose
  kelvin_conversion_constant: 273.15
  life_reduction_multiplier: 2
  life_reduction_temp_threshold_c: 6
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: smart-transformer-load-efficiency-and-thermal-profile-log-v2026
  weight: 0.7
temporal:
...
# [Concept] Smart Transformer Load Efficiency And Thermal Profile Log V2026
