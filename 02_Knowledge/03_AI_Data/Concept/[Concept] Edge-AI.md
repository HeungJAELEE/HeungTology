...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] Edge-AI]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for Edge-AI
  object_type: Concept
  tier: 1
properties:
  boot_latency_threshold: 100 ms
  compression_ratio_range: 4x-10x
  inference_precision: INT8/FP16
  npu_utilization_target: 80%
  offline_capability_target: 100%
  post_quantization_accuracy_loss_limit: 1.0%
  power_efficiency_threshold: 5.0 TOPS/W
  runtime_memory_limit: 256 MB
semantic:
  alternative_parents: []
