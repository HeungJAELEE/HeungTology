---
lineage:
  dataset_reference: distillation-column-purity-and-energy-consumption-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] distillation-column-purity-and-energy-consumption-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for distillation-column-purity-and-energy-consumption-log-v2026
  object_type: Data
  tier: 1
properties:
  bottoms_purity_measured: 98.54%
  bottoms_purity_target: '> 98.00%'
  column_delta_p_measured: 12.5 mbar
  column_delta_p_target: < 20.0 mbar
  distillate_purity_measured: 99.96%
  distillate_purity_target: '> 99.95%'
  energy_per_ton_measured: 1.15 GJ/t
  energy_per_ton_target: < 1.25 GJ/t
  feed_flow_rate: 450 t/h
  process_energy_share: 40%
  reboiler_load_model: Qr_proportional_to_R_plus_1
  reflux_ratio_measured: '1.85'
  reflux_ratio_target: 1.7-2.0
  theoretical_min_stages_model: fenske_equation
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: distillation-column-purity-and-energy-consumption-log-v2026
  weight: 0.7
temporal:
...
# [Concept] Distillation Column Purity And Energy Consumption Log V2026
