...
lineage:
  ...
  original_hash: b7639072b42d41a4e5a0f3e3aaa14415b5ad0565d0041d4479c4edcdcb788b85
metadata:
  date: '2026-05-16'
  domain: 03_AI_Data
...
object:
  description: '[AI] Predictive-Maintenance에 관한 고밀도 지능 노드'
  object_type: Concept
  tier: 1
properties:
  availability_increase_target: 15%
  diagnostics_engine_version: HDS-Gold V6.3.7
  fault_diagnosis_f1_score_min: '0.95'
  fft_bin_size: 1.0Hz
  mttr_reduction_target: 30%
  precision_rate_min: 98%
  rul_error_threshold: ±5%
  sampling_rate_min: 20kHz
