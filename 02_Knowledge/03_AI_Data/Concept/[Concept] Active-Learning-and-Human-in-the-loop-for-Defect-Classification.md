...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] Active-Learning-and-Human-in-the-loop-for-Defect-Classification]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for Active-Learning-and-Human-in-the-loop-for-Defect-Classification
  object_type: Algorithm
  tier: 1
properties:
  labeling_ratio_verified: 0.1
  labeling_reduction_factor: 10.0
  log_stability_epsilon: 1.0e-10
  min_model_accuracy: 0.9
  query_batch_size: 50
semantic:
  alternative_parents: []
