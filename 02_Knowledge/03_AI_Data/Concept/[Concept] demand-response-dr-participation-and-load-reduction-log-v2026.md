---
lineage:
  dataset_reference: demand-response-dr-participation-and-load-reduction-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] demand-response-dr-participation-and-load-reduction-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for demand-response-dr-participation-and-load-reduction-log-v2026
  object_type: Data
  tier: 1
properties:
  ac_refusal_rate_increase: 50%
  commercial_capacity_range: 0.1~1.0 MW/unit
  commercial_compliance_rate_range: 85~95%
  commercial_response_time_range: 5~30 min
  ev_charging_capacity_range: 0.007~0.05 MW/unit
  ev_charging_compliance_rate_range: '> 98%'
  ev_charging_response_time_range: < 5 min
  industrial_capacity_range: 5~50 MW/unit
  industrial_compliance_rate_range: 95~100%
  industrial_price_elasticity_20pct_incentive: 5% increase
  industrial_response_time_range: 15~60 min
  residential_capacity_range: 0.001~0.005 MW/unit
  residential_compliance_rate_range: 70~85%
  residential_price_elasticity_20pct_incentive: 15% increase
  residential_response_time_range: < 1 min
  temp_threshold_ac_refusal: 28C
  vpp_capacity_range: 10~100 MW/unit
  vpp_compliance_rate_range: 90~98%
  vpp_response_time_range: 1~10 min
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: demand-response-dr-participation-and-load-reduction-log-v2026
  weight: 0.7
temporal:
...
# [Concept] Demand Response Dr Participation And Load Reduction Log V2026
