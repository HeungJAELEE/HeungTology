---
lineage:
  dataset_reference: industry-laser-precision-machining-and-surface-texture-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] industry-laser-precision-machining-and-surface-texture-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for industry-laser-precision-machining-and-surface-texture-log-v2026
  object_type: Data
  tier: 1
properties:
  ablation_depth_range: 1.0-100.0 um
  contact_angle_threshold: '> 150.0 deg'
  fluence_range: 0.5-5.0 J/cm2
  haz_width_threshold: < 2.0 um
  overlap_rate_range: 50-80%
  pulse_width_range: 200-800 fs
  scan_speed_range: 500-2000 mm/s
  surface_roughness_threshold: < 0.05 um
  threshold_fluence: 0.3 J/cm2
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: industry-laser-precision-machining-and-surface-texture-log-v2026
  weight: 0.9
temporal:
...
# [Concept] Industry Laser Precision Machining And Surface Texture Log V2026
