---
lineage:
  dataset_reference: pid-control-loop-settling-time-and-overshoot-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] pid-control-loop-settling-time-and-overshoot-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for pid-control-loop-settling-time-and-overshoot-log-v2026
  object_type: Data
  tier: 1
properties:
  measured_gain_margin: 12.5 dB
  measured_overshoot: 1.8%
  measured_phase_margin: 62.5 deg
  measured_rise_time: 1.5 sec
  measured_settling_time: 4.2 sec
  measured_steady_state_error: 0.02%
  optimal_damping_ratio: 0.7-0.8
  target_gain_margin: '> 10.0 dB'
  target_overshoot: < 2.0%
  target_phase_margin: '> 60.0 deg'
  target_rise_time: < 2.0 sec
  target_settling_time: < 5.0 sec
  target_steady_state_error: < 0.05%
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: pid-control-loop-settling-time-and-overshoot-log-v2026
  weight: 0.5
temporal:
...
# [Concept] Pid Control Loop Settling Time And Overshoot Log V2026
