---
lineage:
  dataset_reference: product-cost-and-margin-analysis-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] product-cost-and-margin-analysis-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for product-cost-and-margin-analysis-log-v2026
  object_type: Data
  tier: 1
properties:
  entry_cost_structure_dm_dl_oh: 60/10/30
  entry_margin_rate: 10.0
  entry_revenue_share: 20.0
  expected_profit_integrity_improvement: 12.0
  high_end_cost_structure_dm_dl_oh: 20/30/50
  high_end_margin_rate: 45.0
  high_end_revenue_share: 25.0
  high_margin_threshold: 30.0
  mid_range_cost_structure_dm_dl_oh: 40/20/40
  mid_range_margin_rate: 25.0
  mid_range_revenue_share: 50.0
  product_mix_adjustment_target: 5.0
  special_cost_structure_dm_dl_oh: 30/50/20
  special_margin_rate: 15.0
  special_revenue_share: 5.0
  target_loss_making_sku_count: 0
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: product-cost-and-margin-analysis-log-v2026
  weight: 1.0
temporal:
...
# [Concept] Product Cost And Margin Analysis Log V2026
