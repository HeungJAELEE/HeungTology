...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] battery-ctp-crash-simulation-report-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for battery-ctp-crash-simulation-report-v2026
  object_type: Data
  tier: 1
properties:
  al_7000_plastic_deformation_rate: 20%
  crush_efficiency_limit: 70.0%
  crush_efficiency_verified: 76.2%
  crush_force_limit: 30.0 kN
  crush_force_verified: 22.4 kN
  impact_accel_limit: 45-65 G
  impact_accel_verified: 52.4 G
  internal_stress_reduction: 35%
  intrusion_depth_limit: 65.0 mm
  intrusion_depth_verified: 42.8 mm
  is_critical_load_threshold: 30 kN
  peak_force_limit: 150.0 kN
  peak_force_verified: 131.0 kN
  plastic_strain_limit: 25.0%
  plastic_strain_verified: 18.7%
  safety_gap_limit: 20.0 mm
  safety_gap_verified: 24.5 mm
  sea_limit: 15.0 kJ/kg
  sea_verified: 18.2 kJ/kg
semantic:
  alternative_parents: []
...
# [Concept] Battery Ctp Crash Simulation Report V2026
