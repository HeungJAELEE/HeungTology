---
lineage:
  dataset_reference: humanoid-robot-bipedal-walking-stability-index-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] humanoid-robot-bipedal-walking-stability-index-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for humanoid-robot-bipedal-walking-stability-index-log-v2026
  object_type: Data
  tier: 1
properties:
  atlas_recovery_time_max: 150ms
  digit_zmp_margin_range: 4.0-7.0cm
  hrp5p_zmp_margin_range: 8.0-12.0cm
  lipm_period_formula: T = sqrt(h/g)
  mpc_critical_latency_threshold: 10ms
  mpc_failure_probability_increase: '0.4'
  optimus_gen2_zmp_margin_range: 5.0-8.0cm
  unitree_h1_max_speed: 6.0km/h
  zmp_margin_threshold: '> 0'
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 03_AI_Data]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: initial_semantic_categorization
  object: Concept
  predicate: auto_mapped
  subject: humanoid-robot-bipedal-walking-stability-index-log-v2026
  weight: 0.5
temporal:
...
# [Concept] Humanoid Robot Bipedal Walking Stability Index Log V2026
