---
lineage:
  dataset_reference: bio-metabolic-flux-distribution-and-carbon-balance-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] bio-metabolic-flux-distribution-and-carbon-balance-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for bio-metabolic-flux-distribution-and-carbon-balance-log-v2026
  object_type: Data
  tier: 1
properties:
  byproduct_yield_max: 0.05
  carbon_recovery_max: 1.02
  carbon_recovery_min: 0.98
  carbon_recovery_tolerance: 5.0
  energy_shunt_max: 0.3
  energy_shunt_min: 0.2
  glucose_consumption_rate_max: 1.5
  glucose_consumption_rate_min: 0.5
  growth_rate_max: 0.35
  growth_rate_min: 0.1
  pathway_ratio_threshold: 0.45
  respiratory_quotient_max: 1.1
  respiratory_quotient_min: 1.0
  target_carbon_recovery: 100.0
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: bio-metabolic-flux-distribution-and-carbon-balance-log-v2026
  weight: 1.0
temporal:
...
# [Concept] Bio Metabolic Flux Distribution And Carbon Balance Log V2026
