...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] high-cardinality-encoding]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for high-cardinality-encoding
  object_type: Concept
  tier: 1
properties:
  compression_efficiency: O(1) to O(log C)
  max_hashing_collision_rate: '0.01'
  max_lookup_latency: 1us
  max_sparse_dense_ratio: '0.001'
  min_cardinality_threshold: '1000'
  min_mutual_info_gain: '0.85'
  smoothing_weight_range: 10-100
semantic:
  alternative_parents: []
...
# [Concept] High Cardinality Encoding
