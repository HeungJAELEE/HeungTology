---
lineage:
  dataset_reference: medical-ai-and-dicom
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] medical-ai-and-dicom]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for medical-ai-and-dicom
  object_type: Concept
  tier: 1
properties:
  bone_window_level: 400
  bone_window_width: 1800
  hounsfield_unit_range: -1000 to +3000
  hu_formula: 1000 * (mu - mu_water) / (mu_water - mu_air)
  inference_latency_threshold_ms: 100
  lung_window_level: -600
  lung_window_width: 1500
  pixel_depth_range_bits: 12-16
  pixel_spacing_threshold_mm: 0.5
  rescale_formula: HU = (Pixel_raw * Slope) + Intercept
  slice_thickness_range_mm: 0.5-5.0
  windowing_formula: clip((HU - (L - W/2)) / W * 255, 0, 255)
semantic:
  alternative_parents: []
