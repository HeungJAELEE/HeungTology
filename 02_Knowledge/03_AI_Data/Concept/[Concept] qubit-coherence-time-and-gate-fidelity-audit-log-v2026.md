...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] qubit-coherence-time-and-gate-fidelity-audit-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for qubit-coherence-time-and-gate-fidelity-audit-log-v2026
  object_type: Data
  tier: 1
properties:
  dilution_refrigerator_temp_range: 15mK-20mK
  gate_error_rate_threshold: 0.10%
  quantum_advantage_coherence_threshold: 200us
  readout_fidelity_threshold: 99.0%
  target_1q_fidelity: 99.995%
  target_2q_fidelity: 99.90%
  target_t1_threshold: 200.0us
  target_t2_threshold: 150.0us
  thermal_excitation_t1_reduction_rate: 15%
semantic:
  alternative_parents: []
  is_instance_of: '[[[MOC] 03_AI_Data]]'
spo_graph:
- evidence_coordinate: '[데이터 부재]'
  intent: hardware_performance_audit
  object: Concept
...
# [Concept] Qubit Coherence Time And Gate Fidelity Audit Log V2026
