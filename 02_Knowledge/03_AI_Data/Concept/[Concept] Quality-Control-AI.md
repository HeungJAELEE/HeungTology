...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] Quality-Control-AI]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for Quality-Control-AI
  object_type: Algorithm
  tier: 1
properties:
  anomaly_score_formula: '||x - f_{dec}(f_{enc}(x))||^2'
  data_retention_period: '> 5 Years'
  default_inspection_threshold: '0.85'
  hds_gold_standard_version: V6.3.7
  inference_latency_threshold: < 50ms
  min_detectable_defect_size: < 5um
  over_kill_ratio_threshold: < 0.5%
  pixel_density_threshold: '> 20MPixels'
  recall_sensitivity_threshold: '> 99.9%'
  throughput_uph_threshold: '> 10,000'
semantic:
  alternative_parents: []
