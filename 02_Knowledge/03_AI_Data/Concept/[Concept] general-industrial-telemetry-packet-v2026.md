---
lineage:
  dataset_reference: general-industrial-telemetry-packet-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] general-industrial-telemetry-packet-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for general-industrial-telemetry-packet-v2026
  object_type: Data
  tier: 1
properties:
  bandwidth_usage_limit: 80%
  jitter_limit: 5ms
  max_payload_size: 1024B
  packet_loss_rate_limit: 0.1%
  standard_bandwidth_usage: 45%
  standard_jitter: 2ms
  standard_packet_loss_rate: 0.01%
  standard_payload_size: 256B
  standard_transmission_latency: 15ms
  timestamp_accuracy_limit: 1ms
  transmission_latency_limit: 50ms
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: general-industrial-telemetry-packet-v2026
  weight: 1.0
temporal:
...
# [Concept] General Industrial Telemetry Packet V2026
