...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] vanadium-redox-flow-battery-vrfb-energy-density-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for vanadium-redox-flow-battery-vrfb-energy-density-log-v2026
  object_type: Data
  tier: 1
properties:
  energy_density_range: 20-40 Wh/L
  extreme_concentration_electrolyte: 2.5M
  high_concentration_electrolyte: 2.0M
  precipitation_temp_threshold: 45C
  pumping_loss_ratio: 2-5%
  round_trip_efficiency_range: 75-85%
  stack_power_density_range: 100-250 mW/cm^2
  standard_electrolyte_concentration: 1.5M
  theoretical_energy_density_formula: E_vol = 1/2 * C * F * delta_V
semantic:
  alternative_parents: []
...
# [Concept] Vanadium Redox Flow Battery Vrfb Energy Density Log V2026
