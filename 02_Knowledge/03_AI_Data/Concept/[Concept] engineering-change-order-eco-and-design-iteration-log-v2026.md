...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] engineering-change-order-eco-and-design-iteration-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for engineering-change-order-eco-and-design-iteration-log-v2026
  object_type: Data
  tier: 1
properties:
  compliance_iteration_count: 1-3
  compliance_lead_time_days: 5-10
  convergence_coefficient: alpha
  convergence_model: e_n = alpha^n * e_0
  cost_growth_coefficient: lambda
  cost_red_iteration_count: 5-10
  cost_red_lead_time_days: 10-20
  design_iteration_parameter: n
  eco_cost_model: C_eco = C_design + C_scrap + C_tooling * e^(lambda * t)
  fit_iteration_count: 10-20
  fit_lead_time_days: 2-4
  form_iteration_count: 5-15
  form_lead_time_days: 3-5
  function_iteration_count: 20-50
  function_lead_time_days: 7-14
  rft_metric: right_first_time_rate
semantic:
  alternative_parents: []
...
# [Concept] Engineering Change Order Eco And Design Iteration Log V2026
