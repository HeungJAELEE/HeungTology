...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] LLM]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for LLM
  object_type: Algorithm
  tier: 1
properties:
  attention_complexity: O(N^2) -> O(N)
  context_window_size: 128K ~ 2M
  engine_spec_version: HDS-Gold V6.3.7
  min_inference_throughput: '> 100 tokens/s'
  model_size_params: 7B ~ 1.8T+
  moe_experts_count: 8 ~ 16
  positional_embedding: RoPE
  precision_modes: BF16 / INT4 ~ INT8
  vocabulary_size: 32K ~ 128K
semantic:
  alternative_parents: []
