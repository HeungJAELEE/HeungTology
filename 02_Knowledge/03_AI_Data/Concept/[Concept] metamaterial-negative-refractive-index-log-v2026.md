---
lineage:
  dataset_reference: metamaterial-negative-refractive-index-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] metamaterial-negative-refractive-index-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for metamaterial-negative-refractive-index-log-v2026
  object_type: Data
  tier: 1
properties:
  dielectric_loss_db_unit: < 0.1
  dielectric_unit_cell_nm: 100-300
  diffraction_limit: lambda/2
  fishnet_freq_range: 1-10 THz
  fishnet_loss_db_unit: 1.0-2.5
  fishnet_refractive_index_range: -0.5 to -1.2
  fishnet_unit_cell_nm: '10000'
  fom_formula: '|Re(n)|/Im(n)'
  hyperbolic_loss_db_unit: 5.0-10.0
  hyperbolic_unit_cell_nm: 50-200
  operating_bandwidth: 5%-20%
  refractive_index_formula: -sqrt(epsilon * mu)
  srr_freq_range: 10-100 GHz
  srr_loss_db_unit: 0.2-0.5
  srr_refractive_index_range: -1.5 to -3.0
  srr_unit_cell_nm: '1000000'
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: metamaterial-negative-refractive-index-log-v2026
  weight: 1.0
temporal:
...
# [Concept] Metamaterial Negative Refractive Index Log V2026
