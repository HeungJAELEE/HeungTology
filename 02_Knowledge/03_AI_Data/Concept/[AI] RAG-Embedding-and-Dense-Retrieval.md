...
object:
  ...
  tier: 1
properties:
  cosine_score_normalization: 0-1
  index_types: HNSW, FAISS
  map_at_10_threshold: 0.85
  memory_overhead_per_1m_vectors_range_gb: 1.5-4.0
  model_size_range_mb: 300-1000
  query_time_max_ms: 100
  search_complexity_hnsw: O(log N)
  throughput_min_qps: 500
  vector_dimension_range: 768-1536
semantic:
  alternative_parents: []
