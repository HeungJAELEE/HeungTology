...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] tech-war-export-control-impact-analysis-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for tech-war-export-control-impact-analysis-log-v2026
  object_type: Data
  tier: 1
properties:
  advanced_logic_chip_investment_usd_bn: 35.0
  advanced_logic_chip_rev_loss_pct: 12.0
  ai_gpu_investment_usd_bn: 45.0
  ai_gpu_rev_loss_pct: 15.4
  compliance_cost_index_usd: 10M-500M
  eda_investment_usd_bn: 12.4
  eda_rev_loss_pct: 8.2
  entity_list_count_range: 1,000-5,000
  euv_lithography_investment_usd_bn: 80.5
  euv_lithography_rev_loss_pct: 22.5
  gaafet_investment_usd_bn: 18.5
  gaafet_rev_loss_pct: 5.5
  localization_rate_range: 20-80%
  market_share_benefit_multiplier: 1.5
  splinternet_compatibility_cost_increase: 15%
semantic:
  alternative_parents: []
...
# [Concept] Tech War Export Control Impact Analysis Log V2026
