...
object:
  ...
  tier: 1
properties:
  inference_latency_threshold: 10ms
  inference_throughput_threshold: 30fps
  max_quantization_error: 1%
  memory_footprint_threshold: 100MB
  optimization_toolkits: OpenVINO, TensorRT
  power_consumption_threshold: 500mW
  pruning_ratio_range: 50-90%
  uplink_bandwidth_reduction: '>95%'
  weight_precision_range: 4-8bits
semantic:
  alternative_parents: []
