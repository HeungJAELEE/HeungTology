...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] global-container-throughput-and-port-congestion-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for global-container-throughput-and-port-congestion-log-v2026
  object_type: Data
  tier: 1
properties:
  congestion_index_measured: '1.24'
  congestion_index_target: < 1.50
  dwell_time_measured: 4.2 days
  dwell_time_target: < 5.0 days
  min_annual_throughput_threshold: 20,000,000 TEU
  slow_steaming_lead_time_increase: 10%
  throughput_measured: 2,450,000 TEU
  throughput_target: '> 2,200,000 TEU'
  turnaround_measured: 1.8 days
  turnaround_target: < 2.0 days
  utilization_measured: 92.5%
  utilization_target: 85.0-95.0%
  wait_time_measured: 2.4 days
  wait_time_target: < 3.0 days
semantic:
  alternative_parents: []
...
# [Concept] Global Container Throughput And Port Congestion Log V2026
