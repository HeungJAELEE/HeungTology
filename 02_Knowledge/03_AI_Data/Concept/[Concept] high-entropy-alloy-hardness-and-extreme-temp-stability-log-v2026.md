---
lineage:
  dataset_reference: high-entropy-alloy-hardness-and-extreme-temp-stability-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] high-entropy-alloy-hardness-and-extreme-temp-stability-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for high-entropy-alloy-hardness-and-extreme-temp-stability-log-v2026
  object_type: Data
  tier: 1
properties:
  configurational_entropy_r: 1.5 ~ 2.5
  fracture_toughness_kic: '> 40 MPa*m^0.5'
  lattice_distortion_delta_index: 5.0 ~ 8.0
  oxidation_rate_100h: < 0.1 mg/cm^2
  phase_stability_omega_parameter: '> 1.1'
  radiation_swelling_100dpa: < 0.5
  vickers_hardness: '> 850 HV'
  yield_strength_1600k: '> 550 MPa'
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: high-entropy-alloy-hardness-and-extreme-temp-stability-log-v2026
  weight: 0.9
temporal:
...
# [Concept] High Entropy Alloy Hardness And Extreme Temp Stability Log V2026
