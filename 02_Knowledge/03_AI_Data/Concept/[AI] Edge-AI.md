...
properties:
  ...
  max_accuracy_loss_post_quantization: 1.0%
  max_boot_latency: 100 ms
  max_runtime_memory: 256 MB
  min_npu_utilization: 80%
  min_power_efficiency: 5.0 TOPS/W
  model_compression_ratio: 4x-10x
  network_dependency: 100% local
  qat_engine_specification: HDS-Gold V6.3.7
semantic:
  alternative_parents: []
