---
lineage:
  dataset_reference: solid-state-battery-interface-impedance-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] solid-state-battery-interface-impedance-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for solid-state-battery-interface-impedance-log-v2026
  object_type: Data
  tier: 1
properties:
  coated_ccd: '> 10.0 mA/cm^2'
  coated_interface_resistance: < 5 Ohm*cm^2
  high_pressure_energy_density_loss: 20%
  high_pressure_threshold_mpa: 50
  hybrid_ccd: '> 5.0 mA/cm^2'
  hybrid_interface_resistance: < 20 Ohm*cm^2
  hybrid_ionic_conductivity: '>= 10^-3 S/cm'
  oxide_llzo_ccd: 0.5 to 1.0 mA/cm^2
  oxide_llzo_interface_resistance: 100 to 500 Ohm*cm^2
  oxide_llzo_ionic_conductivity: 10^-3 to 10^-4 S/cm
  oxide_llzo_stacking_pressure: 50 to 100 MPa
  polymer_peo_ccd: 0.2 to 0.5 mA/cm^2
  polymer_peo_interface_resistance: 50 to 200 Ohm*cm^2
  polymer_peo_ionic_conductivity: 10^-5 to 10^-6 S/cm
  polymer_peo_stacking_pressure: < 5 MPa
  sulfide_lps_ccd: 3.0 to 5.0 mA/cm^2
  sulfide_lps_interface_resistance: 10 to 50 Ohm*cm^2
  sulfide_lps_ionic_conductivity: 10^-2 to 10^-3 S/cm
  sulfide_lps_stacking_pressure: 10 to 30 MPa
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: solid-state-battery-interface-impedance-log-v2026
  weight: 1.0
temporal:
...
# [Concept] Solid State Battery Interface Impedance Log V2026
