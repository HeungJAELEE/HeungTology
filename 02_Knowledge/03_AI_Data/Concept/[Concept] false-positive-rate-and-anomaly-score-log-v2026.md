---
lineage:
  dataset_reference: false-positive-rate-and-anomaly-score-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] false-positive-rate-and-anomaly-score-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for false-positive-rate-and-anomaly-score-log-v2026
  object_type: Data
  tier: 1
properties:
  ...
  chemical_tank_vae_fpr: 0.5-1.5
  hydraulic_pump_autoencoder_auc: 0.88-0.96
  hydraulic_pump_autoencoder_fpr: 2.0-4.0
  imminent_failure_prediction_window: 30min
  mahalanobis_distance_fpr_reduction: 20%
  robot_joint_lstm_ae_auc: 0.90-0.97
  robot_joint_lstm_ae_fpr: 1.0-2.5
  rotary_motor_iso_forest_auc: 0.92-0.98
  rotary_motor_iso_forest_fpr: 1.5-3.0
  smt_line_cnn_ad_auc: 0.85-0.93
  smt_line_cnn_ad_fpr: 3.0-6.0
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: false-positive-rate-and-anomaly-score-log-v2026
  weight: 1.0
temporal:
...
# [Concept] False Positive Rate And Anomaly Score Log V2026
