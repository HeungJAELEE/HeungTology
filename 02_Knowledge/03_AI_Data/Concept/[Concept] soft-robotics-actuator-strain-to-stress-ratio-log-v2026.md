---
lineage:
  dataset_reference: soft-robotics-actuator-strain-to-stress-ratio-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] soft-robotics-actuator-strain-to-stress-ratio-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for soft-robotics-actuator-strain-to-stress-ratio-log-v2026
  object_type: Data
  tier: 1
properties:
  actuation_cycle_life: 10^4 to 10^6
  dea_max_strain: 100-300%
  dea_maxwell_stress_model: P = epsilon_0 * epsilon_r * (V/d)^2
  eap_max_strain: 10-50%
  hydrogel_max_strain: '>500%'
  hysteresis_overshoot_threshold: 10%
  max_strain_range: 100% to 500%+
  neo_hookean_energy_density_model: W = (G/2) * (lambda1^2 + lambda2^2 + lambda3^2
    - 3)
  pam_max_strain: 20-40%
  self_healing_life_extension_factor: 5x
  sma_max_strain: 5-8%
  youngs_modulus_range: 10 kPa to 10 MPa
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: soft-robotics-actuator-strain-to-stress-ratio-log-v2026
  weight: 1.0
temporal:
...
# [Concept] Soft Robotics Actuator Strain To Stress Ratio Log V2026
