...
object:
  ...
  tier: 1
properties:
  aggregate_bandwidth_blackwell: 1.8 TB/s
  bandwidth_bottleneck_threshold: 0.3
  bit_error_rate_threshold: 1e-12
  max_gpu_domain_size: 576
  modulation_scheme: PAM4
  modulation_speed: 112G
  p2p_latency_blackwell: 100 ns
  shannon_hartley_expansion_formula: C = n * B * log2(1 + SNR)
  total_latency_formula: L_total = L_prot + (Data Size / Bandwidth) + (d / v)
semantic:
  alternative_parents: []
