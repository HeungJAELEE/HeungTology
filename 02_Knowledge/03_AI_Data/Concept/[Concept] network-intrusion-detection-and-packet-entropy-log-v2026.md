...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] network-intrusion-detection-and-packet-entropy-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for network-intrusion-detection-and-packet-entropy-log-v2026
  object_type: Data
  tier: 1
properties:
  anomaly_score_measured: '12.5'
  anomaly_score_threshold: '50.0'
  anomaly_threshold_formula: tau = mu + k * sigma
  avg_packet_size: 1,250 Bytes
  false_positive_rate_measured: 0.004%
  false_positive_rate_target: < 0.010%
  latency_measured: 1.2 ms
  latency_target: < 2.0 ms
  packet_entropy_measured: 3.84 bits
  packet_entropy_target_range: 3.0 ~ 4.5 bits
  shannon_entropy_formula: H = -sum(pi * log2(pi))
  throughput_measured: 45.2 Gbps
  throughput_target: '> 40.0 Gbps'
semantic:
  alternative_parents: []
...
# [Concept] Network Intrusion Detection And Packet Entropy Log V2026
