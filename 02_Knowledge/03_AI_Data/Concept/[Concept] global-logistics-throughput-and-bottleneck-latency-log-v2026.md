---
lineage:
  dataset_reference: global-logistics-throughput-and-bottleneck-latency-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] global-logistics-throughput-and-bottleneck-latency-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for global-logistics-throughput-and-bottleneck-latency-log-v2026
  object_type: Data
  tier: 1
properties:
  bottleneck_latency_measured: 4.2 hr
  bottleneck_latency_target: < 6.0 hr
  congestion_index_measured: '0.12'
  congestion_index_target: < 0.15
  container_fidelity: 99.99%
  external_weather_log_endpoint: rov-dive-depth-and-high-pressure-integrity-log-v2026
  logistics_throughput_measured: 1.58 M TEU/d
  logistics_throughput_target: '> 1.50 M TEU/d'
  supply_chain_velocity_measured: 12.5 km/h
  supply_chain_velocity_target: '> 10.0 km/h'
  utilization_rate_threshold: '0.8'
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: global-logistics-throughput-and-bottleneck-latency-log-v2026
  weight: 1.0
temporal:
...
# [Concept] Global Logistics Throughput And Bottleneck Latency Log V2026
