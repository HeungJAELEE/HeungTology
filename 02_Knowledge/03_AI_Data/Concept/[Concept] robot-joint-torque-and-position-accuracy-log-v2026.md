---
lineage:
  dataset_reference: robot-joint-torque-and-position-accuracy-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] robot-joint-torque-and-position-accuracy-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for robot-joint-torque-and-position-accuracy-log-v2026
  object_type: Data
  tier: 1
properties:
  end_effector_accuracy_mm: 0.05
  end_effector_repeatability_mm: 0.01
  j1_dynamic_error_range_mm: 0.15-0.30
  j1_max_torque_range_nm: 2500-5000
  j1_resolution_pulses_rev: 2^20
  j1_settle_time_range_ms: 200-400
  j2_dynamic_error_range_mm: 0.10-0.25
  j2_max_torque_range_nm: 2000-4000
  j2_resolution_pulses_rev: 2^20
  j2_settle_time_range_ms: 150-300
  j3_dynamic_error_range_mm: 0.08-0.15
  j3_max_torque_range_nm: 1000-2500
  j3_resolution_pulses_rev: 2^19
  j3_settle_time_range_ms: 100-200
  j4_j6_dynamic_error_range_mm: 0.02-0.05
  j4_j6_max_torque_range_nm: 50-300
  j4_j6_resolution_pulses_rev: 2^18
  j4_j6_settle_time_range_ms: 50-100
  theoretical_position_error_limit_mm: 0.005
  thermal_drift_threshold_mm: 0.1
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: robot-joint-torque-and-position-accuracy-log-v2026
  weight: 1.0
temporal:
...
# [Concept] Robot Joint Torque And Position Accuracy Log V2026
