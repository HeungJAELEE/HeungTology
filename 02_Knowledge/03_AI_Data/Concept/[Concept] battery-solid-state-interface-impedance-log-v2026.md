---
lineage:
  dataset_reference: battery-solid-state-interface-impedance-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] battery-solid-state-interface-impedance-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for battery-solid-state-interface-impedance-log-v2026
  object_type: Data
  tier: 1
properties:
  composite_ccd: 1.2 mA/cm2
  composite_conductivity: 2.5e-3 S/cm
  composite_interface_resistance: 30 Ohm cm2
  critical_current_density_threshold: '> 1.0 mA/cm2'
  interface_impedance_contribution_ratio: '0.85'
  interface_thickness_range_nm: 5-20
  linbo3_coating_optimal_thickness_nm: '5'
  operating_pressure_range_mpa: 10-30
  oxide_ccd: 0.8 mA/cm2
  oxide_conductivity: 1.0e-3 S/cm
  oxide_interface_resistance: 85 Ohm cm2
  polymer_ccd: 0.5 mA/cm2
  polymer_conductivity: 1.0e-5 S/cm
  polymer_interface_resistance: 45 Ohm cm2
  sulfide_ccd: 1.5 mA/cm2
  sulfide_conductivity: 1.2e-2 S/cm
  sulfide_interface_resistance: 15 Ohm cm2
  voltage_window_v: 0-4.5
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: battery-solid-state-interface-impedance-log-v2026
  weight: 1.0
temporal:
...
# [Concept] Battery Solid State Interface Impedance Log V2026
