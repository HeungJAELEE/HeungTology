---
lineage:
  dataset_reference: memristor-vmm-computation-error-and-latency-audit-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] memristor-vmm-computation-error-and-latency-audit-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for memristor-vmm-computation-error-and-latency-audit-log-v2026
  object_type: Data
  tier: 1
properties:
  bit_resolution_mean: 5.2 bits
  bit_resolution_target: '> 6 bits'
  cycle_variability_mean: 2.5%
  cycle_variability_target: < 1.5%
  energy_per_mac_mean: 1.2 fJ
  energy_per_mac_target: < 1.0 fJ
  ir_drop_formula: V_actual = V_in - sum(I_i * r_line)
  lrs_hrs_ratio_mean: '150:1'
  lrs_hrs_ratio_target: '> 100:1'
  non_linearity_mean: '1.4'
  non_linearity_target: < 1.0
  retention_drift_formula: delta_R proportional to t^nu
  stdp_symmetry_mean: '0.88'
  stdp_symmetry_target: '> 0.95'
  stdp_weight_change_formula: delta_w = A * exp(-delta_t / tau)
  vmm_rmse_error_mean: 1.25%
  vmm_rmse_error_target: < 1.0%
  write_latency_mean: 45 ns
  write_latency_target: < 30 ns
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: memristor-vmm-computation-error-and-latency-audit-log-v2026
  weight: 0.9
temporal:
...
# [Concept] Memristor Vmm Computation Error And Latency Audit Log V2026
