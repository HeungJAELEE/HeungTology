---
lineage:
  dataset_reference: high-voltage-transformer-insulation-and-partial-discharge-log-v2026
...
metadata:
  ...
  date: '2026-05-24'
  domain: 03_AI_Data
  id: '[[ [03_AI_Data] [Concept] high-voltage-transformer-insulation-and-partial-discharge-log-v2026]]'
  last_updated: '2026-05-24T02:50:00+09:00'
  project: Antigravity_SDF_Core
  revision: r1
  version: v7.9_Enterprise_Node
object:
  description: Auto-parsed Concept node for high-voltage-transformer-insulation-and-partial-discharge-log-v2026
  object_type: Data
  tier: 1
properties:
  arc_threshold_temp: 700 °C
  hotspot_temp_target: < 95.0 °C
  insulation_resistance_target: '> 100.0 GΩ'
  measured_hotspot_temp: 84.5 °C
  measured_insulation_resistance: 124.5 GΩ
  ...
  moisture_content_target: < 10.0 ppm
  oil_strength_target: '> 60.0 kV'
  partial_discharge_target: < 100.0 pC
  tan_delta_target: < 0.0050
semantic:
  alternative_parents: []
...
- evidence_coordinate: '[데이터 부재]'
  ...
  subject: high-voltage-transformer-insulation-and-partial-discharge-log-v2026
  weight: 1.0
temporal:
...
# [Concept] High Voltage Transformer Insulation And Partial Discharge Log V2026
