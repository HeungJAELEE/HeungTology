...
object:
  description: '[Life Science & Healthcare] bio-synthetic-genome-assembly-success-and-error-log-v2026에
    관한 고밀도 지능 노드'
  object_type: Data
  tier: 1
properties:
  average_fragment_count: 13
  average_success_rate_percent: 74.64
  gc_content_threshold_percent: 70
  standard_version: Genome Assembly Std v2026
  success_probability_math_model: p^(N-1)
semantic:
  alternative_parents: []
