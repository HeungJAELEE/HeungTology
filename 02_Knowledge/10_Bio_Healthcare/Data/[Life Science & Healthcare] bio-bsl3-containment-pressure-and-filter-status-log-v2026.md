...
object:
  description: '[Life Science & Healthcare] bio-bsl3-containment-pressure-and-filter-status-log-v2026에
    관한 고밀도 지능 노드'
  object_type: Data
  tier: 1
properties:
  avg_air_exchanges_ach: 9.58
  avg_filter_drop_mmh2o: 14.28
  avg_lab_pressure_pa: -32.66
  door_open_duration_threshold_s: 30
  pressure_spike_risk_threshold_pa: -10
  security_standard: BSL-3 Security Std v2026
semantic:
  alternative_parents: []
