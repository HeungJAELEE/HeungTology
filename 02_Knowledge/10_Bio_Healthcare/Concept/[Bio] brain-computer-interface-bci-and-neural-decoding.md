...
object:
  description: '[Bio] brain-computer-interface-bci-and-neural-decoding에 관한 고밀도 지능
    노드'
  object_type: Concept
  tier: 1
properties:
  decoding_accuracy_verified_pct: 92.4
  decoding_latency_verified_ms: 38.5
  dof_verified_axes: 8.0
  electrode_life_verified_years: 3.2
  external_db_endpoint: bci-neural-signal-log-v2026
  neural_bandwidth_verified_bps: 124.5
  signal_snr_limit_db: 15.0
  signal_snr_verified_db: 18.2
semantic:
  alternative_parents: []
