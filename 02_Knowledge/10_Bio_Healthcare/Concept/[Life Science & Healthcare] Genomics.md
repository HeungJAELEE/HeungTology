...
object:
  ...
  tier: 1
properties:
  cfdna_concentration_ng_ml: 5-50
  data_per_run_tb: 1.0-5.0
  genome_coverage_threshold_pct: 99
  long_read_length_kb: 10-100
  q30_score_threshold_pct: 85
  q_threshold_value: 30
  sample_to_result_turnaround_h: 24
  seq_depth_target_x: 30-100
  variant_detection_sensitivity_pct: 99.5
semantic:
  alternative_parents: []
