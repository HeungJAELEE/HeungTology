...
object:
  ...
  tier: 1
properties:
  binding_affinity_kd_nm: 1.42
  editing_efficiency_verified: 74.2
  fidelity_warning_threshold: 0.7
  genomic_editing_log_endpoint: genomic-editing-log-v2026
  hdr_nhej_ratio_verified: 0.38
  lnp_delivery_eff_verified: 52.4
  lnp_surface_charge_threshold_mv: 15
  off_target_critical_limit: 0.1
  off_target_rate_verified: 0.042
  off_target_safe_limit: 0.01
  on_target_precision_verified: 99.1
semantic:
  alternative_parents: []
