...
object:
  ...
  tier: 1
properties:
  brain_tissue_thermal_damage_threshold_celsius: 2
  cooling_mode_trigger_temperature_celsius: 38.5
  electrode_material: polyimide
  max_safe_device_temperature_celsius: 39
  signal_latency_target_ms: 1
semantic:
  alternative_parents: []
