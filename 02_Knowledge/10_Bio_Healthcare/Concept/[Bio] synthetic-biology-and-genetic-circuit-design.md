...
object:
  ...
  tier: 1
properties:
  external_data_endpoint: genetic-circuit-expression-and-stability-log-v2026
  hill_coefficient_n: 1.5 ~ 4.0
  hill_coefficient_tolerance: ±0.5
  max_circuit_size_nodes: 15
  metabolic_burden_threshold: 0.3
  protein_half_life_t_12: 10 ~ 120 min
  protein_half_life_tolerance: ±10
  transcription_rate_k_tx: 0.01 ~ 0.5 min^-1
  transcription_rate_tolerance: ±0.05
  transformation_efficiency_eta_min: 10^7 CFU/ug
  transformation_efficiency_tolerance: ±10^6
semantic:
  alternative_parents: []
