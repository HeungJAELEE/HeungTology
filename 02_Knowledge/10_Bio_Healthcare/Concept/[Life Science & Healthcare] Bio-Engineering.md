...
lineage:
  ...
  original_hash: affb07b17fcb6cc764c210123ea0031c47714229478eaf4f475b8c7568a6438c
metadata:
  date: '2026-05-16'
...
object:
  ...
  tier: 1
properties:
  bioreactor_volume_l_range: 1,000-100,000
  crispr_efficiency_threshold: '> 85%'
  dna_synthesis_speed_threshold: '> 50,000 bp/day'
  genetic_design_engine_version: HDS-Gold V6.3.7
  host_cell_viability_threshold_percent: '> 90%'
  metabolic_flux_threshold_mmol_gdw_h: '> 1.0'
  michaelis_menten_equation: v = (Vmax * [S]) / (Km + [S])
  protein_yield_target_g_l: 10-50
  sequence_error_rate_threshold: < 0.01 per kbp
  transfection_efficiency_threshold_percent: '> 70%'
semantic:
  alternative_parents: []
