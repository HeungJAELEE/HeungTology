...
object:
  ...
  tier: 1
properties:
  clinical_latency_max_hrs: 48
  ctdna_detection_limit_max_percent: 0.01
  data_size_per_patient_gb_range: 100-300
  gpu_alignment_speedup_factor: 50
  prs_accuracy_min_auc: 0.85
  prs_mathematical_model: sum(beta_i * G_i)
  sequencing_depth_min_x: 30
  variant_recall_min_percent: 99.9
semantic:
  alternative_parents: []
