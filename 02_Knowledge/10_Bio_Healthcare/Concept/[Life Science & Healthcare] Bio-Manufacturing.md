...
lineage:
  ...
  original_hash: 01d4bd6ee4b5429df17a31cb25757205cca896a800eff0a4d4445e26aca520dd
metadata:
  date: '2026-05-16'
...
object:
  ...
  tier: 1
properties:
  cip_sip_cycle_time_limit: < 12 hours
  default_reactor_volume: 1000 L
  filtration_flux_threshold: '> 50 L/m^2h'
  host_cell_protein_limit: < 100 ppm
  kla_target: 50 ~ 150 h^-1
  mixing_homogeneity_limit: < 30 s
  oxygen_saturation_c_star: 8.5 mg/L
  purification_recovery_threshold: '> 80%'
  titer_target: 5 ~ 15 g/L
  vcd_target: 10^7 ~ 10^8 cells/mL
semantic:
  alternative_parents: []
