...
object:
  ...
  tier: 1
properties:
  cell_purity_min_pct: 99
  differentiation_efficiency_min_pct: 80
  doubling_time_range_h: 24-36
  necrosis_threshold: 0.65
  organoid_diameter_range_um: 200-500
  pluripotency_marker_exp_min_pct: 95
  post_thaw_viability_min_pct: 85
  printing_resolution_max_um: 50
  scaffold_pore_size_um: 100-300
  target_marker_ratio: 0.85
semantic:
  alternative_parents: []
