...
object:
  ...
  tier: 1
properties:
  channel_precision_um: 3.2
  critical_relevance_threshold_pct: 80.0
  drug_correlation_pct: 88.5
  fidelity_engine_version: V7.5.3
  flow_rate_precision_pct: 0.82
  multi_organ_connectivity_count: 6.0
  physiol_relevance_pct: 92.4
  reference_log_endpoint: bio-organ-on-a-chip-and-bio-simulation-log-v2026
  tissue_longevity_days: 45.0
  warning_longevity_threshold_days: 21
semantic:
  alternative_parents: []
